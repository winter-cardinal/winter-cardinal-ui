...
* Input
    ...
    * [Boolean input](./input/boolean.html)
* Layout
...
* Menu
    ...
    * [Select](./menu/select.html)
    * [Side menu](./menu/sided.html)
    * [Side menu with a gray background](./menu/sided-gray.html)
    * [No selection](./menu/sided-selection-none.html)
    * [Single selection](./menu/sided-selection-single.html)
    * [Spacing](./menu/sided-with-space.html)
* Multi select
...
* Table
    ...
    * Cell
        ...
        * [Editable cell](./table\cell/editable.html)
    ...
    * Column
        ...
        * [Custom column width](./table\column/width-custom.html)
        * [Fixed column width](./table\column/width-fixed.html)
    * Data
