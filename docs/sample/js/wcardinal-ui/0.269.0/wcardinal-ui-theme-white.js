...
(function () {
    ...
    ***************************************************************************** */
    ...
    var DThemeWhiteDiagramEditor = /** @class */ (function (_super) {
        ...
        DThemeWhiteDiagramEditor.prototype.isSnapperEnabled = function () {
            return true;
        };
        DThemeWhiteDiagramEditor.prototype.isSnapperGridVisible = function () {
            return true;
        };
        DThemeWhiteDiagramEditor.prototype.isSnapperGridEnabled = function () {
            return true;
        };
        DThemeWhiteDiagramEditor.prototype.getSnapperGridSize = function () {
            return 10;
        };
        DThemeWhiteDiagramEditor.prototype.isSnapperTargetVisible = function () {
            return true;
        };
        DThemeWhiteDiagramEditor.prototype.isSnapperTargetEnabled = function () {
            return true;
        };
