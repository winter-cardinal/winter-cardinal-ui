...
(function () {
    ...
    ***************************************************************************** */
    ...
    var DThemeDarkDiagramEditor = /** @class */ (function (_super) {
        ...
        DThemeDarkDiagramEditor.prototype.isSnapperEnabled = function () {
            return true;
        };
        DThemeDarkDiagramEditor.prototype.isSnapperGridVisible = function () {
            return true;
        };
        DThemeDarkDiagramEditor.prototype.isSnapperGridEnabled = function () {
            return true;
        };
        DThemeDarkDiagramEditor.prototype.getSnapperGridSize = function () {
            return 10;
        };
        DThemeDarkDiagramEditor.prototype.isSnapperTargetVisible = function () {
            return true;
        };
        DThemeDarkDiagramEditor.prototype.isSnapperTargetEnabled = function () {
            return true;
        };
