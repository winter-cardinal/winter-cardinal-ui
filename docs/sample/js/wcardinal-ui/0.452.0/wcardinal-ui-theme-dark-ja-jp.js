...
(function (pixi_js) {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpPickerColor extends DThemeDarkPickerColor {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpPickerColor = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDialogColor = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpButtonColor = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpPickerColorGradient = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDialogColorGradient = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpButtonColorGradient = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpPickerTime extends DThemeDarkPickerTime {
        getHoursOptions() {
            return {
                width: 100,
                title: "時"
    ...
    class DThemeDarkJaJpPickerDatetime extends DThemeDarkJaJpPickerTime {
        getDayLabels() {
            return DAY_LABELS;
        }
        getLabelFormatter() {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpPickerDate extends DThemeDarkJaJpPickerDatetime {
        getMask() {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpPickerTime = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpPickerDatetime = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpPickerDate = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDialogDate = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpButtonDate = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDialogDatetime = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpButtonDatetime = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpDialogSelect extends DThemeDarkDialogSelect {
        getDismissLabel() {
            return "なし";
        }
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDialogSelect = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpButtonSelect = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDialogTime = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpButtonTime = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpButtonAll = () => {
    ...
    class EThemeDarkJaJpShapePointsFormatter extends EThemeDarkShapePointsFormatter {
        getCurveSplineLabel() {
            return "スプライン曲線";
        }
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpShapePointsFormatter = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDiagram = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpDiagramEditor extends DThemeDarkDiagramEditor {
        getBaseLayerLabel() {
            return "ベースレイヤー";
        }
    }
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDiagramEditor = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpDialogLayeredFooter extends DThemeDarkDialogLayeredFooter {
        getButtonOk() {
            return "OK";
        }
        getButtonCancel() {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDialogLayered = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpDialogConfirm extends DThemeDarkDialogConfirm {
        getFooter() {
            return {
                button: {
                    ok: "はい",
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDialogConfirm = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpDialogConfirmDelete extends DThemeDarkJaJpDialogConfirm {
        getMessage() {
            return "このデータを削除しますか？";
        }
    }
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDialogConfirmDelete = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpDialogConfirmDiscard extends DThemeDarkJaJpDialogConfirm {
        getMessage() {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDialogConfirmDiscard = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpDialogMessage extends DThemeDarkDialogMessage {
        getFooter() {
            return {
                button: {
                    ok: "OK",
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDialogMessage = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const dThemeDarkJaJpDialogProcessingMessage = (state) => {
        if (state.isSucceeded) {
            return "正常に処理されました";
        }
    ...
    class DThemeDarkJaJpDialogProcessing extends DThemeDarkDialogProcessing {
        getFooter() {
            return {
                button: {
                    ok: "OK",
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDialogProcessing = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpDialogSaveAs extends DThemeDarkDialogSaveAs {
        getFooter() {
            return {
                button: {
                    ok: "保存",
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDialogSaveAs = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpDialogAll = () => {
        loadThemeDarkJaJpDialogColorGradient();
        loadThemeDarkJaJpDialogColor();
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpInputBooleanButtonOff extends DThemeDarkInputBooleanButtonOff {
        newTextValue() {
            return "OFF";
        }
    }
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpInputBooleanButtonOn extends DThemeDarkInputBooleanButtonOn {
        newTextValue() {
            return "ON";
        }
    }
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpInputBoolean = () => {
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpInputAll = () => {
    ...
    class DThemeDarkJaJpLink extends DThemeDarkLink {
        getLabelOpenLink() {
            return "開く";
        }
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpNoteError extends DThemeDarkNoteError {
        newTextValue() {
            return "異常が発生しました";
        }
    }
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpNoteNoItemsFound extends DThemeDarkNoteNoItemsFound {
        newTextValue() {
            return "アイテムはありません";
        }
    }
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpNoteSearching extends DThemeDarkNoteSearching {
        newTextValue() {
            return "検索中です";
        }
    }
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    class DThemeDarkJaJpIndicatorProcessing extends DThemeDarkIndicatorProcess {
        newProcessTextValue() {
            return dThemeDarkJaJpDialogProcessingMessage;
        }
    }
     ...
     * SPDX-License-Identifier: Apache-2.0
     */
    const loadThemeDarkJaJpIndicatorProcessing = () => {
