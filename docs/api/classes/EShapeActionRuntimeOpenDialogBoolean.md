[Winter Cardinal UI - v0.310.1](../index.md) / EShapeActionRuntimeOpenDialogBoolean
...
• **new EShapeActionRuntimeOpenDialogBoolean**(`value`)
...
▸ `Protected` **open**(`shape`, `target`, `initial`, `step`, `min`, `max`): `Promise`<`boolean`\>
