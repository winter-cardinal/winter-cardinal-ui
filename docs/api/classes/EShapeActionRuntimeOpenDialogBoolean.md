[Winter Cardinal UI - v0.407.0](../index.md) / EShapeActionRuntimeOpenDialogBoolean
...
- [`EShapeActionRuntimeOpenDialog`](EShapeActionRuntimeOpenDialog.md)\<`boolean`\>
...
- [constructor](EShapeActionRuntimeOpenDialogBoolean.md#constructor)

### Properties

- [condition](EShapeActionRuntimeOpenDialogBoolean.md#condition)
- [initial](EShapeActionRuntimeOpenDialogBoolean.md#initial)
- [isOpened](EShapeActionRuntimeOpenDialogBoolean.md#isopened)
- [max](EShapeActionRuntimeOpenDialogBoolean.md#max)
- [min](EShapeActionRuntimeOpenDialogBoolean.md#min)
- [onInputAction](EShapeActionRuntimeOpenDialogBoolean.md#oninputaction)
- [reset](EShapeActionRuntimeOpenDialogBoolean.md#reset)
- [step](EShapeActionRuntimeOpenDialogBoolean.md#step)
- [target](EShapeActionRuntimeOpenDialogBoolean.md#target)
- [DIALOG](EShapeActionRuntimeOpenDialogBoolean.md#dialog)

### Methods

- [execute](EShapeActionRuntimeOpenDialogBoolean.md#execute)
- [initialize](EShapeActionRuntimeOpenDialogBoolean.md#initialize)
- [onBlur](EShapeActionRuntimeOpenDialogBoolean.md#onblur)
- [onClick](EShapeActionRuntimeOpenDialogBoolean.md#onclick)
- [onDblClick](EShapeActionRuntimeOpenDialogBoolean.md#ondblclick)
- [onDown](EShapeActionRuntimeOpenDialogBoolean.md#ondown)
- [onDowning](EShapeActionRuntimeOpenDialogBoolean.md#ondowning)
- [onFocus](EShapeActionRuntimeOpenDialogBoolean.md#onfocus)
- [onKeyDown](EShapeActionRuntimeOpenDialogBoolean.md#onkeydown)
- [onKeyUp](EShapeActionRuntimeOpenDialogBoolean.md#onkeyup)
- [onMove](EShapeActionRuntimeOpenDialogBoolean.md#onmove)
- [onOut](EShapeActionRuntimeOpenDialogBoolean.md#onout)
- [onOver](EShapeActionRuntimeOpenDialogBoolean.md#onover)
- [onPressed](EShapeActionRuntimeOpenDialogBoolean.md#onpressed)
- [onRender](EShapeActionRuntimeOpenDialogBoolean.md#onrender)
- [onResize](EShapeActionRuntimeOpenDialogBoolean.md#onresize)
- [onRightClick](EShapeActionRuntimeOpenDialogBoolean.md#onrightclick)
- [onRightDown](EShapeActionRuntimeOpenDialogBoolean.md#onrightdown)
- [onRightDowning](EShapeActionRuntimeOpenDialogBoolean.md#onrightdowning)
- [onRightPressed](EShapeActionRuntimeOpenDialogBoolean.md#onrightpressed)
- [onRightUnpressed](EShapeActionRuntimeOpenDialogBoolean.md#onrightunpressed)
- [onRightUp](EShapeActionRuntimeOpenDialogBoolean.md#onrightup)
- [onRightUpOutside](EShapeActionRuntimeOpenDialogBoolean.md#onrightupoutside)
- [onUnpressed](EShapeActionRuntimeOpenDialogBoolean.md#onunpressed)
- [onUp](EShapeActionRuntimeOpenDialogBoolean.md#onup)
- [onUpOutside](EShapeActionRuntimeOpenDialogBoolean.md#onupoutside)
- [open](EShapeActionRuntimeOpenDialogBoolean.md#open)

## Constructors

### constructor

• **new EShapeActionRuntimeOpenDialogBoolean**(`value`): [`EShapeActionRuntimeOpenDialogBoolean`](EShapeActionRuntimeOpenDialogBoolean.md)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open-dialog-boolean.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open-dialog-boolean.ts#L17)
...
• `Protected` **initial**: [`EShapeActionExpression`](../index.md#eshapeactionexpression)\<`boolean`\>
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open-dialog-boolean.ts:15](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open-dialog-boolean.ts#L15)
...
▪ `Static` `Protected` `Optional` **DIALOG**: [`DDialogInputBoolean`](DDialogInputBoolean.md)\<[`DThemeDialogInputBoolean`](../interfaces/DThemeDialogInputBoolean.md), [`DDialogInputBooleanOptions`](../interfaces/DDialogInputBooleanOptions.md)\<[`DThemeDialogInputBoolean`](../interfaces/DThemeDialogInputBoolean.md)\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open-dialog-boolean.ts:14](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open-dialog-boolean.ts#L14)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open-dialog-boolean.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open-dialog-boolean.ts#L22)
