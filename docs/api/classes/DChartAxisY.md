[Winter Cardinal UI - v0.199.0](../index.md) / DChartAxisY
...
[src/main/typescript/wcardinal/ui/d-chart-axis-y.ts:19](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.199.0/src/main/typescript/wcardinal/ui/d-chart-axis-y.ts#L19)
