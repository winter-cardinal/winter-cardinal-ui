[Winter Cardinal UI - v0.374.0](../index.md) / DPaginationButtonNext
...
- [newPadding](DPaginationButtonNext.md#newpadding)
- [newText](DPaginationButtonNext.md#newtext)
...
• **new DPaginationButtonNext**\<`THEME`, `OPTIONS`\>(`options?`): [`DPaginationButtonNext`](DPaginationButtonNext.md)\<`THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DPaginationButtonNext`](DPaginationButtonNext.md)\<`THEME`, `OPTIONS`\>
