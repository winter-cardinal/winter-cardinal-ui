[Winter Cardinal UI - v0.310.1](../index.md) / DPaginationButtonNext
...
- [\_isGrouped](DPaginationButtonNext.md#_isgrouped)
...
- [isGrouped](DPaginationButtonNext.md#isgrouped)
...
- [activate](DPaginationButtonNext.md#activate)
...
- [onPress](DPaginationButtonNext.md#onpress)
...
- [onUnpress](DPaginationButtonNext.md#onunpress)
...
[src/main/typescript/wcardinal/ui/d-pagination-button-next.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-pagination-button-next.ts#L18)
