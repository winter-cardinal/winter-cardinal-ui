[Winter Cardinal UI - v0.407.0](../index.md) / DMenuItem
...
[src/main/typescript/wcardinal/ui/d-menu-item.ts:42](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-item.ts#L42)
...
▸ **setFocused**(`isFocused`): [`DMenuItem`](DMenuItem.md)\<`VALUE`, `THEME`, `OPTIONS`\>
