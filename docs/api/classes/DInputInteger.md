[Winter Cardinal UI - v0.167.0](../index.md) / DInputInteger
...
- [\_images](DInputInteger.md#_images)
- [\_isOverflowMaskEnabled](DInputInteger.md#_isoverflowmaskenabled)
- [\_isTextVisible](DInputInteger.md#_istextvisible)
...
- [\_textAlign](DInputInteger.md#_textalign)
- [\_textAlpha](DInputInteger.md#_textalpha)
- [\_textColor](DInputInteger.md#_textcolor)
- [\_textFormatter](DInputInteger.md#_textformatter)
- [\_textStyle](DInputInteger.md#_textstyle)
- [\_textValue](DInputInteger.md#_textvalue)
- [\_textValueComputed](DInputInteger.md#_textvaluecomputed)
...
- [computeTextValue](DInputInteger.md#computetextvalue)
...
- [createOrUpdateText](DInputInteger.md#createorupdatetext)
- [createText](DInputInteger.md#createtext)
...
- [getTextAlpha](DInputInteger.md#gettextalpha)
- [getTextColor](DInputInteger.md#gettextcolor)
...
- [hideText](DInputInteger.md#hidetext)
...
- [newImages](DInputInteger.md#newimages)
...
- [onTextChange](DInputInteger.md#ontextchange)
...
- [showText](DInputInteger.md#showtext)
...
- [toImageOptions](DInputInteger.md#toimageoptions)
...
- [updateText](DInputInteger.md#updatetext)
- [updateTextAndImage](DInputInteger.md#updatetextandimage)
- [updateTextColor](DInputInteger.md#updatetextcolor)
- [updateTextPosition](DInputInteger.md#updatetextposition)
- [updateTextValue](DInputInteger.md#updatetextvalue)
...
• **new DInputInteger**<`THEME`, `OPTIONS`\>(`options?`)

#### Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeInputInteger`](../interfaces/DThemeInputInteger.md)<`THEME`\> = [`DThemeInputInteger`](../interfaces/DThemeInputInteger.md) |
| `OPTIONS` | extends [`DInputIntegerOptions`](../interfaces/DInputIntegerOptions.md)<`THEME`, `OPTIONS`\> = [`DInputIntegerOptions`](../interfaces/DInputIntegerOptions.md)<`THEME`\> |
...
[src/main/typescript/wcardinal/ui/d-input-integer.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-input-integer.ts#L17)
...
▸ `Protected` **setFocused**(`isFocused`): [`DInputInteger`](DInputInteger.md)<`THEME`, `OPTIONS`\>
