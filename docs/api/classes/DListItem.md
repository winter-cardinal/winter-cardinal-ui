[Winter Cardinal UI - v0.374.0](../index.md) / DListItem
...
- [link](DListItem.md#link)
- [options](DListItem.md#options)
...
- [activate](DListItem.md#activate)
...
- [newLink](DListItem.md#newlink)
- [newPadding](DListItem.md#newpadding)
- [newText](DListItem.md#newtext)
...
• **new DListItem**\<`VALUE`, `THEME`, `OPTIONS`\>(`data`, `options?`): [`DListItem`](DListItem.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeListItem`](../interfaces/DThemeListItem.md) = [`DThemeListItem`](../interfaces/DThemeListItem.md) |
| `OPTIONS` | extends [`DListItemOptions`](../interfaces/DListItemOptions.md)\<`VALUE`, `THEME`, `any`\> = [`DListItemOptions`](../interfaces/DListItemOptions.md)\<`VALUE`, `THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:274](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-list-item.ts#L274)
...
▸ **setFocused**(`isFocused`): [`DListItem`](DListItem.md)\<`VALUE`, `THEME`, `OPTIONS`\>
