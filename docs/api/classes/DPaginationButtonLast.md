[Winter Cardinal UI - v0.374.0](../index.md) / DPaginationButtonLast
...
- [newPadding](DPaginationButtonLast.md#newpadding)
- [newText](DPaginationButtonLast.md#newtext)
...
• **new DPaginationButtonLast**\<`THEME`, `OPTIONS`\>(`options?`): [`DPaginationButtonLast`](DPaginationButtonLast.md)\<`THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DPaginationButtonLast`](DPaginationButtonLast.md)\<`THEME`, `OPTIONS`\>
