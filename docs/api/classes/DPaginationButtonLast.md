[Winter Cardinal UI - v0.310.1](../index.md) / DPaginationButtonLast
...
- [\_isGrouped](DPaginationButtonLast.md#_isgrouped)
...
- [isGrouped](DPaginationButtonLast.md#isgrouped)
...
- [activate](DPaginationButtonLast.md#activate)
...
- [onPress](DPaginationButtonLast.md#onpress)
...
- [onUnpress](DPaginationButtonLast.md#onunpress)
...
[src/main/typescript/wcardinal/ui/d-pagination-button-last.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-pagination-button-last.ts#L18)
