[Winter Cardinal UI - v0.414.0](../index.md) / DMenuItemBase
...
- [\_boundsID](DMenuItemBase.md#_boundsid)
- [\_boundsRect](DMenuItemBase.md#_boundsrect)
...
- [\_enabledFilters](DMenuItemBase.md#_enabledfilters)
- [\_image](DMenuItemBase.md#_image)
- [\_lastDownPoint](DMenuItemBase.md#_lastdownpoint)
- [\_lastSortedIndex](DMenuItemBase.md#_lastsortedindex)
- [\_localBounds](DMenuItemBase.md#_localbounds)
- [\_localBoundsRect](DMenuItemBase.md#_localboundsrect)
...
- [activate](DMenuItemBase.md#activate)
...
- [containerUpdateTransform](DMenuItemBase.md#containerupdatetransform)
...
- [disableTempParent](DMenuItemBase.md#disabletempparent)
- [displayObjectUpdateTransform](DMenuItemBase.md#displayobjectupdatetransform)
- [emit](DMenuItemBase.md#emit)
- [enableTempParent](DMenuItemBase.md#enabletempparent)
...
- [getImage](DMenuItemBase.md#getimage)
- [getLayouter](DMenuItemBase.md#getlayouter)
...
- [getText](DMenuItemBase.md#gettext)
...
- [newOverflowMask](DMenuItemBase.md#newoverflowmask)
- [newPadding](DMenuItemBase.md#newpadding)
- [newText](DMenuItemBase.md#newtext)
...
- [onClick](DMenuItemBase.md#onclick)
...
- [onReflowTextAndImage](DMenuItemBase.md#onreflowtextandimage)
...
• **new DMenuItemBase**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DMenuItemBase`](DMenuItemBase.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-menu-item-base.ts:96](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-menu-item-base.ts#L96)
...
[src/main/typescript/wcardinal/ui/d-menu-item-base.ts:33](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-menu-item-base.ts#L33)
...
[src/main/typescript/wcardinal/ui/d-menu-item-base.ts:73](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-menu-item-base.ts#L73)
