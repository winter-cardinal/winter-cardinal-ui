[Winter Cardinal UI - v0.200.0](../index.md) / DThemeWhiteNoteNoItemsFound
...
- [getPaddingRight](DThemeWhiteNoteNoItemsFound.md#getpaddingright)
...
• **new DThemeWhiteNoteNoItemsFound**()
...
[src/main/typescript/wcardinal/ui/theme/white/d-theme-white-note-no-items-found.ts:10](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.200.0/src/main/typescript/wcardinal/ui/theme/white/d-theme-white-note-no-items-found.ts#L10)
