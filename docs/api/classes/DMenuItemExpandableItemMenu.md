[Winter Cardinal UI - v0.407.0](../index.md) / DMenuItemExpandableItemMenu
...
[src/main/typescript/wcardinal/ui/d-menu-item-expandable-item-menu.ts:13](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-item-expandable-item-menu.ts#L13)
...
▸ **setFocused**(`isFocused`): [`DMenuItemExpandableItemMenu`](DMenuItemExpandableItemMenu.md)\<`VALUE`, `THEME`, `OPTIONS`\>
