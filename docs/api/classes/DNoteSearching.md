[Winter Cardinal UI - v0.407.0](../index.md) / DNoteSearching
...
- [\_boundsID](DNoteSearching.md#_boundsid)
- [\_boundsRect](DNoteSearching.md#_boundsrect)
...
- [\_enabledFilters](DNoteSearching.md#_enabledfilters)
- [\_image](DNoteSearching.md#_image)
- [\_lastDownPoint](DNoteSearching.md#_lastdownpoint)
- [\_lastSortedIndex](DNoteSearching.md#_lastsortedindex)
- [\_localBounds](DNoteSearching.md#_localbounds)
- [\_localBoundsRect](DNoteSearching.md#_localboundsrect)
...
- [containerUpdateTransform](DNoteSearching.md#containerupdatetransform)
...
- [disableTempParent](DNoteSearching.md#disabletempparent)
- [displayObjectUpdateTransform](DNoteSearching.md#displayobjectupdatetransform)
- [emit](DNoteSearching.md#emit)
- [enableTempParent](DNoteSearching.md#enabletempparent)
...
- [getImage](DNoteSearching.md#getimage)
- [getLayouter](DNoteSearching.md#getlayouter)
...
- [getText](DNoteSearching.md#gettext)
...
- [newOverflowMask](DNoteSearching.md#newoverflowmask)
...
- [onReflowTextAndImage](DNoteSearching.md#onreflowtextandimage)
...
[src/main/typescript/wcardinal/ui/d-note-searching.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-note-searching.ts#L17)
