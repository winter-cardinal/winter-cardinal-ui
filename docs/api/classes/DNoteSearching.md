[Winter Cardinal UI - v0.374.0](../index.md) / DNoteSearching
...
- [newPadding](DNoteSearching.md#newpadding)
- [newText](DNoteSearching.md#newtext)
...
• **new DNoteSearching**\<`THEME`, `OPTIONS`\>(`options?`): [`DNoteSearching`](DNoteSearching.md)\<`THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DNoteSearching`](DNoteSearching.md)\<`THEME`, `OPTIONS`\>
