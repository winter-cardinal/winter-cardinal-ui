[Winter Cardinal UI - v0.160.0](../index.md) / DMenuSidedContent

# Class: DMenuSidedContent<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeMenuSidedContent`](../interfaces/DThemeMenuSidedContent.md) = [`DThemeMenuSidedContent`](../interfaces/DThemeMenuSidedContent.md) |
| `OPTIONS` | extends [`DMenuSidedContentOptions`](../interfaces/DMenuSidedContentOptions.md)<`THEME`\> = [`DMenuSidedContentOptions`](../interfaces/DMenuSidedContentOptions.md)<`THEME`\> |
...
- [constructor](DMenuSidedContent.md#constructor)

### Properties

- [\_accessibleActive](DMenuSidedContent.md#_accessibleactive)
- [\_accessibleDiv](DMenuSidedContent.md#_accessiblediv)
- [\_auto](DMenuSidedContent.md#_auto)
- [\_background](DMenuSidedContent.md#_background)
- [\_border](DMenuSidedContent.md#_border)
- [\_bounds](DMenuSidedContent.md#_bounds)
- [\_clearType](DMenuSidedContent.md#_cleartype)
- [\_corner](DMenuSidedContent.md#_corner)
- [\_cornerAdjust](DMenuSidedContent.md#_corneradjust)
- [\_cursor](DMenuSidedContent.md#_cursor)
- [\_destroyed](DMenuSidedContent.md#_destroyed)
- [\_direction](DMenuSidedContent.md#_direction)
- [\_lastDownPoint](DMenuSidedContent.md#_lastdownpoint)
- [\_lastSortedIndex](DMenuSidedContent.md#_lastsortedindex)
- [\_margin](DMenuSidedContent.md#_margin)
- [\_mask](DMenuSidedContent.md#_mask)
- [\_multiplicity](DMenuSidedContent.md#_multiplicity)
- [\_options](DMenuSidedContent.md#_options)
- [\_outline](DMenuSidedContent.md#_outline)
- [\_padding](DMenuSidedContent.md#_padding)
- [\_reflowable](DMenuSidedContent.md#_reflowable)
- [\_reverse](DMenuSidedContent.md#_reverse)
- [\_shortcuts](DMenuSidedContent.md#_shortcuts)
- [\_snippet](DMenuSidedContent.md#_snippet)
- [\_tempDisplayObjectParent](DMenuSidedContent.md#_tempdisplayobjectparent)
- [\_title](DMenuSidedContent.md#_title)
- [\_zIndex](DMenuSidedContent.md#_zindex)
- [accessible](DMenuSidedContent.md#accessible)
- [accessibleChildren](DMenuSidedContent.md#accessiblechildren)
- [accessibleHint](DMenuSidedContent.md#accessiblehint)
- [accessiblePointerEvents](DMenuSidedContent.md#accessiblepointerevents)
- [accessibleTitle](DMenuSidedContent.md#accessibletitle)
- [accessibleType](DMenuSidedContent.md#accessibletype)
- [alpha](DMenuSidedContent.md#alpha)
- [angle](DMenuSidedContent.md#angle)
- [buttonMode](DMenuSidedContent.md#buttonmode)
- [cacheAsBitmap](DMenuSidedContent.md#cacheasbitmap)
- [children](DMenuSidedContent.md#children)
- [cursor](DMenuSidedContent.md#cursor)
- [filterArea](DMenuSidedContent.md#filterarea)
- [filters](DMenuSidedContent.md#filters)
- [hitArea](DMenuSidedContent.md#hitarea)
- [interactive](DMenuSidedContent.md#interactive)
- [interactiveChildren](DMenuSidedContent.md#interactivechildren)
- [isMask](DMenuSidedContent.md#ismask)
- [isSprite](DMenuSidedContent.md#issprite)
- [localTransform](DMenuSidedContent.md#localtransform)
- [mask](DMenuSidedContent.md#mask)
- [name](DMenuSidedContent.md#name)
- [parent](DMenuSidedContent.md#parent)
- [pivot](DMenuSidedContent.md#pivot)
- [renderable](DMenuSidedContent.md#renderable)
- [rotation](DMenuSidedContent.md#rotation)
- [sortDirty](DMenuSidedContent.md#sortdirty)
- [sortableChildren](DMenuSidedContent.md#sortablechildren)
- [transform](DMenuSidedContent.md#transform)
- [visible](DMenuSidedContent.md#visible)
- [worldAlpha](DMenuSidedContent.md#worldalpha)
- [worldTransform](DMenuSidedContent.md#worldtransform)
- [worldVisible](DMenuSidedContent.md#worldvisible)
- [zIndex](DMenuSidedContent.md#zindex)
- [CORNER\_ADJUST\_WORK](DMenuSidedContent.md#corner_adjust_work)
- [WORK\_CONTAINS\_POINT](DMenuSidedContent.md#work_contains_point)

### Accessors

- [background](DMenuSidedContent.md#background)
- [border](DMenuSidedContent.md#border)
- [corner](DMenuSidedContent.md#corner)
- [height](DMenuSidedContent.md#height)
- [margin](DMenuSidedContent.md#margin)
- [multiplicity](DMenuSidedContent.md#multiplicity)
- [outline](DMenuSidedContent.md#outline)
- [padding](DMenuSidedContent.md#padding)
- [position](DMenuSidedContent.md#position)
- [reflowable](DMenuSidedContent.md#reflowable)
- [scale](DMenuSidedContent.md#scale)
- [shadow](DMenuSidedContent.md#shadow)
- [skew](DMenuSidedContent.md#skew)
- [snippet](DMenuSidedContent.md#snippet)
- [state](DMenuSidedContent.md#state)
- [theme](DMenuSidedContent.md#theme)
- [title](DMenuSidedContent.md#title)
- [type](DMenuSidedContent.md#type)
- [unsafe](DMenuSidedContent.md#unsafe)
- [weight](DMenuSidedContent.md#weight)
- [width](DMenuSidedContent.md#width)
- [x](DMenuSidedContent.md#x)
- [y](DMenuSidedContent.md#y)

### Methods

- [\_calculateBounds](DMenuSidedContent.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DMenuSidedContent.md#_recursivepostupdatetransform)
- [\_render](DMenuSidedContent.md#_render)
- [addChild](DMenuSidedContent.md#addchild)
- [addChildAt](DMenuSidedContent.md#addchildat)
- [addListener](DMenuSidedContent.md#addlistener)
- [addSpace](DMenuSidedContent.md#addspace)
- [applyTitle](DMenuSidedContent.md#applytitle)
- [blur](DMenuSidedContent.md#blur)
- [calcSpaceLeft](DMenuSidedContent.md#calcspaceleft)
- [calculateBounds](DMenuSidedContent.md#calculatebounds)
- [containsGlobalPoint](DMenuSidedContent.md#containsglobalpoint)
- [containsLocalPoint](DMenuSidedContent.md#containslocalpoint)
- [containsPoint](DMenuSidedContent.md#containspoint)
- [countColumn](DMenuSidedContent.md#countcolumn)
- [countRow](DMenuSidedContent.md#countrow)
- [destroy](DMenuSidedContent.md#destroy)
- [displayObjectUpdateTransform](DMenuSidedContent.md#displayobjectupdatetransform)
- [emit](DMenuSidedContent.md#emit)
- [eventNames](DMenuSidedContent.md#eventnames)
- [findColumnIndexNext](DMenuSidedContent.md#findcolumnindexnext)
- [findColumnIndexPrevious](DMenuSidedContent.md#findcolumnindexprevious)
- [findRowIndexNext](DMenuSidedContent.md#findrowindexnext)
- [findRowIndexPrevious](DMenuSidedContent.md#findrowindexprevious)
- [focus](DMenuSidedContent.md#focus)
- [focusOnClosest](DMenuSidedContent.md#focusonclosest)
- [getBounds](DMenuSidedContent.md#getbounds)
- [getChildAt](DMenuSidedContent.md#getchildat)
- [getChildByName](DMenuSidedContent.md#getchildbyname)
- [getChildIndex](DMenuSidedContent.md#getchildindex)
- [getClearType](DMenuSidedContent.md#getcleartype)
- [getClippingRect](DMenuSidedContent.md#getclippingrect)
- [getGlobalPosition](DMenuSidedContent.md#getglobalposition)
- [getHeight](DMenuSidedContent.md#getheight)
- [getLocalBounds](DMenuSidedContent.md#getlocalbounds)
- [getParentOfSize](DMenuSidedContent.md#getparentofsize)
- [getSpaceLeft](DMenuSidedContent.md#getspaceleft)
- [getThemeDefault](DMenuSidedContent.md#getthemedefault)
- [getType](DMenuSidedContent.md#gettype)
- [getWeightTotal](DMenuSidedContent.md#getweighttotal)
- [getWidth](DMenuSidedContent.md#getwidth)
- [getX](DMenuSidedContent.md#getx)
- [getY](DMenuSidedContent.md#gety)
- [hasClearType](DMenuSidedContent.md#hascleartype)
- [hasClearTypeAfter](DMenuSidedContent.md#hascleartypeafter)
- [hasClearTypeBefore](DMenuSidedContent.md#hascleartypebefore)
- [hasDirty](DMenuSidedContent.md#hasdirty)
- [hasRefitableHeight](DMenuSidedContent.md#hasrefitableheight)
- [hasRefitableWidth](DMenuSidedContent.md#hasrefitablewidth)
- [hide](DMenuSidedContent.md#hide)
- [init](DMenuSidedContent.md#init)
- [initReflowable](DMenuSidedContent.md#initreflowable)
- [isDirty](DMenuSidedContent.md#isdirty)
- [isEventTarget](DMenuSidedContent.md#iseventtarget)
- [isHidden](DMenuSidedContent.md#ishidden)
- [isHierarchyDirty](DMenuSidedContent.md#ishierarchydirty)
- [isRefitable](DMenuSidedContent.md#isrefitable)
- [isShown](DMenuSidedContent.md#isshown)
- [listenerCount](DMenuSidedContent.md#listenercount)
- [listeners](DMenuSidedContent.md#listeners)
- [off](DMenuSidedContent.md#off)
- [on](DMenuSidedContent.md#on)
- [onBlur](DMenuSidedContent.md#onblur)
- [onChildBlur](DMenuSidedContent.md#onchildblur)
- [onChildFocus](DMenuSidedContent.md#onchildfocus)
- [onChildrenChange](DMenuSidedContent.md#onchildrenchange)
- [onDblClick](DMenuSidedContent.md#ondblclick)
- [onDown](DMenuSidedContent.md#ondown)
- [onDownThis](DMenuSidedContent.md#ondownthis)
- [onFocus](DMenuSidedContent.md#onfocus)
- [onHierarchyDirty](DMenuSidedContent.md#onhierarchydirty)
- [onKeyDown](DMenuSidedContent.md#onkeydown)
- [onKeyUp](DMenuSidedContent.md#onkeyup)
- [onMove](DMenuSidedContent.md#onmove)
- [onOut](DMenuSidedContent.md#onout)
- [onOver](DMenuSidedContent.md#onover)
- [onParentMove](DMenuSidedContent.md#onparentmove)
- [onParentResize](DMenuSidedContent.md#onparentresize)
- [onRefit](DMenuSidedContent.md#onrefit)
- [onReflow](DMenuSidedContent.md#onreflow)
- [onResize](DMenuSidedContent.md#onresize)
- [onScale](DMenuSidedContent.md#onscale)
- [onShortcut](DMenuSidedContent.md#onshortcut)
- [onSkew](DMenuSidedContent.md#onskew)
- [onStateChange](DMenuSidedContent.md#onstatechange)
- [onUp](DMenuSidedContent.md#onup)
- [onUpThis](DMenuSidedContent.md#onupthis)
- [onWheel](DMenuSidedContent.md#onwheel)
- [once](DMenuSidedContent.md#once)
- [reflow](DMenuSidedContent.md#reflow)
- [removeAllListeners](DMenuSidedContent.md#removealllisteners)
- [removeChild](DMenuSidedContent.md#removechild)
- [removeChildAt](DMenuSidedContent.md#removechildat)
- [removeChildren](DMenuSidedContent.md#removechildren)
- [removeListener](DMenuSidedContent.md#removelistener)
- [render](DMenuSidedContent.md#render)
- [renderAdvanced](DMenuSidedContent.md#renderadvanced)
- [resize](DMenuSidedContent.md#resize)
- [setChildIndex](DMenuSidedContent.md#setchildindex)
- [setFocused](DMenuSidedContent.md#setfocused)
- [setHeight](DMenuSidedContent.md#setheight)
- [setParent](DMenuSidedContent.md#setparent)
- [setTransform](DMenuSidedContent.md#settransform)
- [setWidth](DMenuSidedContent.md#setwidth)
- [setX](DMenuSidedContent.md#setx)
- [setY](DMenuSidedContent.md#sety)
- [show](DMenuSidedContent.md#show)
- [sortChildren](DMenuSidedContent.md#sortchildren)
- [swapChildren](DMenuSidedContent.md#swapchildren)
- [toCornerMaskColumn](DMenuSidedContent.md#tocornermaskcolumn)
- [toCornerMaskRow](DMenuSidedContent.md#tocornermaskrow)
- [toCursor](DMenuSidedContent.md#tocursor)
- [toDirty](DMenuSidedContent.md#todirty)
- [toGlobal](DMenuSidedContent.md#toglobal)
- [toHasDirty](DMenuSidedContent.md#tohasdirty)
- [toHierarchyDirty](DMenuSidedContent.md#tohierarchydirty)
- [toLocal](DMenuSidedContent.md#tolocal)
- [toParentHasDirty](DMenuSidedContent.md#toparenthasdirty)
- [toParentHierarchyDirty](DMenuSidedContent.md#toparenthierarchydirty)
- [toParentResized](DMenuSidedContent.md#toparentresized)
- [updateTransform](DMenuSidedContent.md#updatetransform)
- [mixin](DMenuSidedContent.md#mixin)

## Constructors

### constructor

• **new DMenuSidedContent**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemeMenuSidedContent`](../interfaces/DThemeMenuSidedContent.md) = [`DThemeMenuSidedContent`](../interfaces/DThemeMenuSidedContent.md) |
| `OPTIONS` | extends [`DMenuSidedContentOptions`](../interfaces/DMenuSidedContentOptions.md)<`THEME`, `OPTIONS`\> = [`DMenuSidedContentOptions`](../interfaces/DMenuSidedContentOptions.md)<`THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DMenuSidedContent`](DMenuSidedContent.md)<`THEME`, `OPTIONS`\>
...
[`DMenuSidedContent`](DMenuSidedContent.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DMenuSidedContent`](DMenuSidedContent.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DMenuSidedContent`](DMenuSidedContent.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-menu-sided-content.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-menu-sided-content.ts#L23)
...
▸ **hide**(): [`DMenuSidedContent`](DMenuSidedContent.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-menu-sided-content.ts:19](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-menu-sided-content.ts#L19)
...
▸ **off**(`event`, `fn?`, `context?`): [`DMenuSidedContent`](DMenuSidedContent.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DMenuSidedContent`](DMenuSidedContent.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DMenuSidedContent`](DMenuSidedContent.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DMenuSidedContent`](DMenuSidedContent.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DMenuSidedContent`](DMenuSidedContent.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DMenuSidedContent`](DMenuSidedContent.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DMenuSidedContent`](DMenuSidedContent.md)<`THEME`, `OPTIONS`\>
