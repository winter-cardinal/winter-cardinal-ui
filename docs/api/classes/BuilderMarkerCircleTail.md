[Winter Cardinal UI - v0.374.0](../index.md) / BuilderMarkerCircleTail
...
• **new BuilderMarkerCircleTail**(`vertexOffset`, `indexOffset`): [`BuilderMarkerCircleTail`](BuilderMarkerCircleTail.md)
...
[src/main/typescript/wcardinal/ui/shape/variant/builder-marker-circle-tail.ts:11](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/shape/variant/builder-marker-circle-tail.ts#L11)
