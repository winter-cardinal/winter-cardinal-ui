[Winter Cardinal UI - v0.200.0](../index.md) / DThemeDarkDialogDate
...
- [getContent](DThemeDarkDialogDate.md#getcontent)
...
- [getOutlineOffset](DThemeDarkDialogDate.md#getoutlineoffset)
