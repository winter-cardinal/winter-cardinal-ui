[Winter Cardinal UI - v0.457.0](../index.md) / DDialogTime
...
- [\_alwaysOnTop](DDialogTime.md#_alwaysontop)
...
- [\_boundsID](DDialogTime.md#_boundsid)
- [\_boundsRect](DDialogTime.md#_boundsrect)
...
- [\_enabledFilters](DDialogTime.md#_enabledfilters)
...
- [\_localBounds](DDialogTime.md#_localbounds)
- [\_localBoundsRect](DDialogTime.md#_localboundsrect)
- [\_mask](DDialogTime.md#_mask)
- [\_mode](DDialogTime.md#_mode)
- [\_onParentChildAddedBound](DDialogTime.md#_onparentchildaddedbound)
...
- [alwaysOnTop](DDialogTime.md#alwaysontop)
...
- [bringToFront](DDialogTime.md#bringtofront)
- [calculateBounds](DDialogTime.md#calculatebounds)
- [cancel](DDialogTime.md#cancel)
- [close](DDialogTime.md#close)
- [containerUpdateTransform](DDialogTime.md#containerupdatetransform)
...
- [disableTempParent](DDialogTime.md#disabletempparent)
...
- [enableTempParent](DDialogTime.md#enabletempparent)
...
[src/main/typescript/wcardinal/ui/d-dialog-time.ts:21](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-time.ts#L21)
...
[src/main/typescript/wcardinal/ui/d-dialog-time.ts:29](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-time.ts#L29)
...
[src/main/typescript/wcardinal/ui/d-dialog-time.ts:33](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-time.ts#L33)
...
[src/main/typescript/wcardinal/ui/d-dialog-time.ts:37](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-time.ts#L37)
...
[src/main/typescript/wcardinal/ui/d-dialog-time.ts:41](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-time.ts#L41)
...
[src/main/typescript/wcardinal/ui/d-dialog-time.ts:45](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-time.ts#L45)
...
[src/main/typescript/wcardinal/ui/d-dialog-time.ts:54](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-time.ts#L54)
...
[src/main/typescript/wcardinal/ui/d-dialog-time.ts:58](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-time.ts#L58)
...
[src/main/typescript/wcardinal/ui/d-dialog-time.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-time.ts#L23)
