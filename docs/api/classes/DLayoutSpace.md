[Winter Cardinal UI - v0.407.0](../index.md) / DLayoutSpace
...
- [\_boundsID](DLayoutSpace.md#_boundsid)
- [\_boundsRect](DLayoutSpace.md#_boundsrect)
...
- [\_enabledFilters](DLayoutSpace.md#_enabledfilters)
- [\_lastDownPoint](DLayoutSpace.md#_lastdownpoint)
- [\_lastSortedIndex](DLayoutSpace.md#_lastsortedindex)
- [\_localBounds](DLayoutSpace.md#_localbounds)
- [\_localBoundsRect](DLayoutSpace.md#_localboundsrect)
...
- [options](DLayoutSpace.md#options)
...
- [containerUpdateTransform](DLayoutSpace.md#containerupdatetransform)
...
- [disableTempParent](DLayoutSpace.md#disabletempparent)
- [displayObjectUpdateTransform](DLayoutSpace.md#displayobjectupdatetransform)
- [emit](DLayoutSpace.md#emit)
- [enableTempParent](DLayoutSpace.md#enabletempparent)
...
- [newPadding](DLayoutSpace.md#newpadding)
...
• **new DLayoutSpace**\<`THEME`, `OPTIONS`\>(`options?`): [`DLayoutSpace`](DLayoutSpace.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-layout-space.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-layout-space.ts#L22)
...
▸ **setFocused**(`isFocused`): [`DLayoutSpace`](DLayoutSpace.md)\<`THEME`, `OPTIONS`\>
