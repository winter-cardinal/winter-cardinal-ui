[Winter Cardinal UI - v0.160.0](../index.md) / DLayoutSpace

# Class: DLayoutSpace<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeLayoutSpace`](../interfaces/DThemeLayoutSpace.md) = [`DThemeLayoutSpace`](../interfaces/DThemeLayoutSpace.md) |
| `OPTIONS` | extends [`DLayoutSpaceOptions`](../interfaces/DLayoutSpaceOptions.md)<`THEME`\> = [`DLayoutSpaceOptions`](../interfaces/DLayoutSpaceOptions.md)<`THEME`\> |
...
- [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DMenuItemSpace`](DMenuItemSpace.md)

## Table of contents

### Constructors

- [constructor](DLayoutSpace.md#constructor)

### Properties

- [\_accessibleActive](DLayoutSpace.md#_accessibleactive)
- [\_accessibleDiv](DLayoutSpace.md#_accessiblediv)
- [\_auto](DLayoutSpace.md#_auto)
- [\_background](DLayoutSpace.md#_background)
- [\_border](DLayoutSpace.md#_border)
- [\_bounds](DLayoutSpace.md#_bounds)
- [\_clearType](DLayoutSpace.md#_cleartype)
- [\_corner](DLayoutSpace.md#_corner)
- [\_cursor](DLayoutSpace.md#_cursor)
- [\_destroyed](DLayoutSpace.md#_destroyed)
- [\_lastDownPoint](DLayoutSpace.md#_lastdownpoint)
- [\_lastSortedIndex](DLayoutSpace.md#_lastsortedindex)
- [\_mask](DLayoutSpace.md#_mask)
- [\_options](DLayoutSpace.md#_options)
- [\_outline](DLayoutSpace.md#_outline)
- [\_padding](DLayoutSpace.md#_padding)
- [\_reflowable](DLayoutSpace.md#_reflowable)
- [\_shortcuts](DLayoutSpace.md#_shortcuts)
- [\_snippet](DLayoutSpace.md#_snippet)
- [\_tempDisplayObjectParent](DLayoutSpace.md#_tempdisplayobjectparent)
- [\_title](DLayoutSpace.md#_title)
- [\_zIndex](DLayoutSpace.md#_zindex)
- [accessible](DLayoutSpace.md#accessible)
- [accessibleChildren](DLayoutSpace.md#accessiblechildren)
- [accessibleHint](DLayoutSpace.md#accessiblehint)
- [accessiblePointerEvents](DLayoutSpace.md#accessiblepointerevents)
- [accessibleTitle](DLayoutSpace.md#accessibletitle)
- [accessibleType](DLayoutSpace.md#accessibletype)
- [alpha](DLayoutSpace.md#alpha)
- [angle](DLayoutSpace.md#angle)
- [buttonMode](DLayoutSpace.md#buttonmode)
- [cacheAsBitmap](DLayoutSpace.md#cacheasbitmap)
- [children](DLayoutSpace.md#children)
- [cursor](DLayoutSpace.md#cursor)
- [filterArea](DLayoutSpace.md#filterarea)
- [filters](DLayoutSpace.md#filters)
- [hitArea](DLayoutSpace.md#hitarea)
- [interactive](DLayoutSpace.md#interactive)
- [interactiveChildren](DLayoutSpace.md#interactivechildren)
- [isMask](DLayoutSpace.md#ismask)
- [isSprite](DLayoutSpace.md#issprite)
- [localTransform](DLayoutSpace.md#localtransform)
- [mask](DLayoutSpace.md#mask)
- [name](DLayoutSpace.md#name)
- [parent](DLayoutSpace.md#parent)
- [pivot](DLayoutSpace.md#pivot)
- [renderable](DLayoutSpace.md#renderable)
- [rotation](DLayoutSpace.md#rotation)
- [sortDirty](DLayoutSpace.md#sortdirty)
- [sortableChildren](DLayoutSpace.md#sortablechildren)
- [transform](DLayoutSpace.md#transform)
- [visible](DLayoutSpace.md#visible)
- [worldAlpha](DLayoutSpace.md#worldalpha)
- [worldTransform](DLayoutSpace.md#worldtransform)
- [worldVisible](DLayoutSpace.md#worldvisible)
- [zIndex](DLayoutSpace.md#zindex)
- [WORK\_CONTAINS\_POINT](DLayoutSpace.md#work_contains_point)

### Accessors

- [background](DLayoutSpace.md#background)
- [border](DLayoutSpace.md#border)
- [corner](DLayoutSpace.md#corner)
- [height](DLayoutSpace.md#height)
- [outline](DLayoutSpace.md#outline)
- [padding](DLayoutSpace.md#padding)
- [position](DLayoutSpace.md#position)
- [reflowable](DLayoutSpace.md#reflowable)
- [scale](DLayoutSpace.md#scale)
- [shadow](DLayoutSpace.md#shadow)
- [skew](DLayoutSpace.md#skew)
- [snippet](DLayoutSpace.md#snippet)
- [state](DLayoutSpace.md#state)
- [theme](DLayoutSpace.md#theme)
- [title](DLayoutSpace.md#title)
- [type](DLayoutSpace.md#type)
- [unsafe](DLayoutSpace.md#unsafe)
- [weight](DLayoutSpace.md#weight)
- [width](DLayoutSpace.md#width)
- [x](DLayoutSpace.md#x)
- [y](DLayoutSpace.md#y)

### Methods

- [\_calculateBounds](DLayoutSpace.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DLayoutSpace.md#_recursivepostupdatetransform)
- [\_render](DLayoutSpace.md#_render)
- [addChild](DLayoutSpace.md#addchild)
- [addChildAt](DLayoutSpace.md#addchildat)
- [addListener](DLayoutSpace.md#addlistener)
- [applyTitle](DLayoutSpace.md#applytitle)
- [blur](DLayoutSpace.md#blur)
- [calculateBounds](DLayoutSpace.md#calculatebounds)
- [containsGlobalPoint](DLayoutSpace.md#containsglobalpoint)
- [containsLocalPoint](DLayoutSpace.md#containslocalpoint)
- [containsPoint](DLayoutSpace.md#containspoint)
- [destroy](DLayoutSpace.md#destroy)
- [displayObjectUpdateTransform](DLayoutSpace.md#displayobjectupdatetransform)
- [emit](DLayoutSpace.md#emit)
- [eventNames](DLayoutSpace.md#eventnames)
- [focus](DLayoutSpace.md#focus)
- [focusOnClosest](DLayoutSpace.md#focusonclosest)
- [getBounds](DLayoutSpace.md#getbounds)
- [getChildAt](DLayoutSpace.md#getchildat)
- [getChildByName](DLayoutSpace.md#getchildbyname)
- [getChildIndex](DLayoutSpace.md#getchildindex)
- [getClearType](DLayoutSpace.md#getcleartype)
- [getClippingRect](DLayoutSpace.md#getclippingrect)
- [getGlobalPosition](DLayoutSpace.md#getglobalposition)
- [getHeight](DLayoutSpace.md#getheight)
- [getLocalBounds](DLayoutSpace.md#getlocalbounds)
- [getParentOfSize](DLayoutSpace.md#getparentofsize)
- [getThemeDefault](DLayoutSpace.md#getthemedefault)
- [getType](DLayoutSpace.md#gettype)
- [getWidth](DLayoutSpace.md#getwidth)
- [getX](DLayoutSpace.md#getx)
- [getY](DLayoutSpace.md#gety)
- [hasDirty](DLayoutSpace.md#hasdirty)
- [hasRefitableHeight](DLayoutSpace.md#hasrefitableheight)
- [hasRefitableWidth](DLayoutSpace.md#hasrefitablewidth)
- [hide](DLayoutSpace.md#hide)
- [init](DLayoutSpace.md#init)
- [initReflowable](DLayoutSpace.md#initreflowable)
- [isDirty](DLayoutSpace.md#isdirty)
- [isEventTarget](DLayoutSpace.md#iseventtarget)
- [isHidden](DLayoutSpace.md#ishidden)
- [isHierarchyDirty](DLayoutSpace.md#ishierarchydirty)
- [isRefitable](DLayoutSpace.md#isrefitable)
- [isShown](DLayoutSpace.md#isshown)
- [listenerCount](DLayoutSpace.md#listenercount)
- [listeners](DLayoutSpace.md#listeners)
- [off](DLayoutSpace.md#off)
- [on](DLayoutSpace.md#on)
- [onBlur](DLayoutSpace.md#onblur)
- [onChildBlur](DLayoutSpace.md#onchildblur)
- [onChildFocus](DLayoutSpace.md#onchildfocus)
- [onChildrenChange](DLayoutSpace.md#onchildrenchange)
- [onDblClick](DLayoutSpace.md#ondblclick)
- [onDown](DLayoutSpace.md#ondown)
- [onDownThis](DLayoutSpace.md#ondownthis)
- [onFocus](DLayoutSpace.md#onfocus)
- [onHierarchyDirty](DLayoutSpace.md#onhierarchydirty)
- [onKeyDown](DLayoutSpace.md#onkeydown)
- [onKeyUp](DLayoutSpace.md#onkeyup)
- [onMove](DLayoutSpace.md#onmove)
- [onOut](DLayoutSpace.md#onout)
- [onOver](DLayoutSpace.md#onover)
- [onParentMove](DLayoutSpace.md#onparentmove)
- [onParentResize](DLayoutSpace.md#onparentresize)
- [onRefit](DLayoutSpace.md#onrefit)
- [onReflow](DLayoutSpace.md#onreflow)
- [onResize](DLayoutSpace.md#onresize)
- [onScale](DLayoutSpace.md#onscale)
- [onShortcut](DLayoutSpace.md#onshortcut)
- [onSkew](DLayoutSpace.md#onskew)
- [onStateChange](DLayoutSpace.md#onstatechange)
- [onUp](DLayoutSpace.md#onup)
- [onUpThis](DLayoutSpace.md#onupthis)
- [onWheel](DLayoutSpace.md#onwheel)
- [once](DLayoutSpace.md#once)
- [reflow](DLayoutSpace.md#reflow)
- [removeAllListeners](DLayoutSpace.md#removealllisteners)
- [removeChild](DLayoutSpace.md#removechild)
- [removeChildAt](DLayoutSpace.md#removechildat)
- [removeChildren](DLayoutSpace.md#removechildren)
- [removeListener](DLayoutSpace.md#removelistener)
- [render](DLayoutSpace.md#render)
- [renderAdvanced](DLayoutSpace.md#renderadvanced)
- [resize](DLayoutSpace.md#resize)
- [setChildIndex](DLayoutSpace.md#setchildindex)
- [setFocused](DLayoutSpace.md#setfocused)
- [setHeight](DLayoutSpace.md#setheight)
- [setParent](DLayoutSpace.md#setparent)
- [setTransform](DLayoutSpace.md#settransform)
- [setWidth](DLayoutSpace.md#setwidth)
- [setX](DLayoutSpace.md#setx)
- [setY](DLayoutSpace.md#sety)
- [show](DLayoutSpace.md#show)
- [sortChildren](DLayoutSpace.md#sortchildren)
- [swapChildren](DLayoutSpace.md#swapchildren)
- [toCursor](DLayoutSpace.md#tocursor)
- [toDirty](DLayoutSpace.md#todirty)
- [toGlobal](DLayoutSpace.md#toglobal)
- [toHasDirty](DLayoutSpace.md#tohasdirty)
- [toHierarchyDirty](DLayoutSpace.md#tohierarchydirty)
- [toLocal](DLayoutSpace.md#tolocal)
- [toParentHasDirty](DLayoutSpace.md#toparenthasdirty)
- [toParentHierarchyDirty](DLayoutSpace.md#toparenthierarchydirty)
- [toParentResized](DLayoutSpace.md#toparentresized)
- [updateTransform](DLayoutSpace.md#updatetransform)
- [mixin](DLayoutSpace.md#mixin)

## Constructors

### constructor

• **new DLayoutSpace**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemeLayoutSpace`](../interfaces/DThemeLayoutSpace.md) = [`DThemeLayoutSpace`](../interfaces/DThemeLayoutSpace.md) |
| `OPTIONS` | extends [`DLayoutSpaceOptions`](../interfaces/DLayoutSpaceOptions.md)<`THEME`, `OPTIONS`\> = [`DLayoutSpaceOptions`](../interfaces/DLayoutSpaceOptions.md)<`THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DLayoutSpace`](DLayoutSpace.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DLayoutSpace`](DLayoutSpace.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DLayoutSpace`](DLayoutSpace.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-layout-space.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout-space.ts#L22)
...
▸ **hide**(): [`DLayoutSpace`](DLayoutSpace.md)<`THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DLayoutSpace`](DLayoutSpace.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DLayoutSpace`](DLayoutSpace.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DLayoutSpace`](DLayoutSpace.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DLayoutSpace`](DLayoutSpace.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DLayoutSpace`](DLayoutSpace.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DLayoutSpace`](DLayoutSpace.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DLayoutSpace`](DLayoutSpace.md)<`THEME`, `OPTIONS`\>
