[Winter Cardinal UI - v0.457.0](../index.md) / EShapeActionRuntimeChangeCursor

# Class: EShapeActionRuntimeChangeCursor
...
- [`EShapeActionRuntimeConditional`](EShapeActionRuntimeConditional.md)
  ...
  ↳ **`EShapeActionRuntimeChangeCursor`**

## Table of contents

### Constructors

- [constructor](EShapeActionRuntimeChangeCursor.md#constructor)

### Properties

- [condition](EShapeActionRuntimeChangeCursor.md#condition)
- [name](EShapeActionRuntimeChangeCursor.md#name)
- [reset](EShapeActionRuntimeChangeCursor.md#reset)

### Methods

- [execute](EShapeActionRuntimeChangeCursor.md#execute)
- [initialize](EShapeActionRuntimeChangeCursor.md#initialize)
- [onBlur](EShapeActionRuntimeChangeCursor.md#onblur)
- [onClick](EShapeActionRuntimeChangeCursor.md#onclick)
- [onDblClick](EShapeActionRuntimeChangeCursor.md#ondblclick)
- [onDown](EShapeActionRuntimeChangeCursor.md#ondown)
- [onDowning](EShapeActionRuntimeChangeCursor.md#ondowning)
- [onFocus](EShapeActionRuntimeChangeCursor.md#onfocus)
- [onKeyDown](EShapeActionRuntimeChangeCursor.md#onkeydown)
- [onKeyUp](EShapeActionRuntimeChangeCursor.md#onkeyup)
- [onMove](EShapeActionRuntimeChangeCursor.md#onmove)
- [onOut](EShapeActionRuntimeChangeCursor.md#onout)
- [onOver](EShapeActionRuntimeChangeCursor.md#onover)
- [onPressed](EShapeActionRuntimeChangeCursor.md#onpressed)
- [onRender](EShapeActionRuntimeChangeCursor.md#onrender)
- [onResize](EShapeActionRuntimeChangeCursor.md#onresize)
- [onRightClick](EShapeActionRuntimeChangeCursor.md#onrightclick)
- [onRightDown](EShapeActionRuntimeChangeCursor.md#onrightdown)
- [onRightDowning](EShapeActionRuntimeChangeCursor.md#onrightdowning)
- [onRightPressed](EShapeActionRuntimeChangeCursor.md#onrightpressed)
- [onRightUnpressed](EShapeActionRuntimeChangeCursor.md#onrightunpressed)
- [onRightUp](EShapeActionRuntimeChangeCursor.md#onrightup)
- [onRightUpOutside](EShapeActionRuntimeChangeCursor.md#onrightupoutside)
- [onUnpressed](EShapeActionRuntimeChangeCursor.md#onunpressed)
- [onUp](EShapeActionRuntimeChangeCursor.md#onup)
- [onUpOutside](EShapeActionRuntimeChangeCursor.md#onupoutside)

## Constructors

### constructor

• **new EShapeActionRuntimeChangeCursor**(`value`): [`EShapeActionRuntimeChangeCursor`](EShapeActionRuntimeChangeCursor.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `value` | [`EShapeActionValueChangeCursor`](EShapeActionValueChangeCursor.md) |
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-change-cursor.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-change-cursor.ts#L18)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-change-cursor.ts:16](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-change-cursor.ts#L16)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-change-cursor.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-change-cursor.ts#L23)
