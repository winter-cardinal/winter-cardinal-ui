[Winter Cardinal UI - v0.407.0](../index.md) / DMenuItemCheck
...
[src/main/typescript/wcardinal/ui/d-menu-item-check.ts:30](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-item-check.ts#L30)
...
▸ **setFocused**(`isFocused`): [`DMenuItemCheck`](DMenuItemCheck.md)\<`VALUE`, `THEME`, `OPTIONS`\>
