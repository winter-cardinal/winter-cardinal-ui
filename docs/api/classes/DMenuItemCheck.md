[Winter Cardinal UI - v0.167.0](../index.md) / DMenuItemCheck
...
- [\_images](DMenuItemCheck.md#_images)
- [\_isOverflowMaskEnabled](DMenuItemCheck.md#_isoverflowmaskenabled)
- [\_isTextVisible](DMenuItemCheck.md#_istextvisible)
...
- [\_textAlign](DMenuItemCheck.md#_textalign)
- [\_textAlpha](DMenuItemCheck.md#_textalpha)
- [\_textColor](DMenuItemCheck.md#_textcolor)
- [\_textFormatter](DMenuItemCheck.md#_textformatter)
- [\_textStyle](DMenuItemCheck.md#_textstyle)
- [\_textValue](DMenuItemCheck.md#_textvalue)
- [\_textValueComputed](DMenuItemCheck.md#_textvaluecomputed)
...
- [computeTextValue](DMenuItemCheck.md#computetextvalue)
...
- [createOrUpdateText](DMenuItemCheck.md#createorupdatetext)
- [createText](DMenuItemCheck.md#createtext)
...
- [getTextAlpha](DMenuItemCheck.md#gettextalpha)
- [getTextColor](DMenuItemCheck.md#gettextcolor)
...
- [hideText](DMenuItemCheck.md#hidetext)
- [init](DMenuItemCheck.md#init)
- [initOnClick](DMenuItemCheck.md#initonclick)
...
- [newImages](DMenuItemCheck.md#newimages)
...
- [onTextChange](DMenuItemCheck.md#ontextchange)
...
- [showText](DMenuItemCheck.md#showtext)
...
- [toImageOptions](DMenuItemCheck.md#toimageoptions)
...
- [updateText](DMenuItemCheck.md#updatetext)
- [updateTextAndImage](DMenuItemCheck.md#updatetextandimage)
- [updateTextColor](DMenuItemCheck.md#updatetextcolor)
- [updateTextPosition](DMenuItemCheck.md#updatetextposition)
- [updateTextValue](DMenuItemCheck.md#updatetextvalue)
...
• **new DMenuItemCheck**<`VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DMenuItemCheck`](DMenuItemCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DMenuItemCheck`](DMenuItemCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DMenuItemCheck`](DMenuItemCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-menu-item-check.ts:30](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-menu-item-check.ts#L30)
...
▸ **hide**(): [`DMenuItemCheck`](DMenuItemCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DMenuItemCheck`](DMenuItemCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DMenuItemCheck`](DMenuItemCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DMenuItemCheck`](DMenuItemCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DMenuItemCheck`](DMenuItemCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DMenuItemCheck`](DMenuItemCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DMenuItemCheck`](DMenuItemCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DMenuItemCheck`](DMenuItemCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
