[Winter Cardinal UI - v0.227.0](../index.md) / FormatNodeg
...
[src/main/typescript/wcardinal/ui/util/format-node/format-node-g.ts:9](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.227.0/src/main/typescript/wcardinal/ui/util/format-node/format-node-g.ts#L9)
