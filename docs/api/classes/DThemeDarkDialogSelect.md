[Winter Cardinal UI - v0.164.0](../index.md) / DThemeDarkDialogSelect
...
- [getCancel](DThemeDarkDialogSelect.md#getcancel)
...
- [getInputMarginHorizontal](DThemeDarkDialogSelect.md#getinputmarginhorizontal)
- [getInputMarginVertical](DThemeDarkDialogSelect.md#getinputmarginvertical)
- [getInteractive](DThemeDarkDialogSelect.md#getinteractive)
- [getLayoutHeight](DThemeDarkDialogSelect.md#getlayoutheight)
- [getLayoutMargin](DThemeDarkDialogSelect.md#getlayoutmargin)
- [getLayoutWidth](DThemeDarkDialogSelect.md#getlayoutwidth)
- [getLayoutX](DThemeDarkDialogSelect.md#getlayoutx)
- [getLayoutY](DThemeDarkDialogSelect.md#getlayouty)
- [getLineHeight](DThemeDarkDialogSelect.md#getlineheight)
- [getMode](DThemeDarkDialogSelect.md#getmode)
- [getOffsetX](DThemeDarkDialogSelect.md#getoffsetx)
- [getOffsetY](DThemeDarkDialogSelect.md#getoffsety)
- [getOk](DThemeDarkDialogSelect.md#getok)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-dialog-select.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.164.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-dialog-select.ts#L22)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-dialog-select.ts:30](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.164.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-dialog-select.ts#L30)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-dialog-select.ts:26](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.164.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-dialog-select.ts#L26)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-dialog-select.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.164.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-dialog-select.ts#L18)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-dialog-select.ts:14](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.164.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-dialog-select.ts#L14)
