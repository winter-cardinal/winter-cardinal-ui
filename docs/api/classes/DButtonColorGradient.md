[Winter Cardinal UI - v0.374.0](../index.md) / DButtonColorGradient
...
- [newPadding](DButtonColorGradient.md#newpadding)
- [newText](DButtonColorGradient.md#newtext)
...
• **new DButtonColorGradient**\<`THEME`, `OPTIONS`\>(`options?`): [`DButtonColorGradient`](DButtonColorGradient.md)\<`THEME`, `OPTIONS`\>
...
| :------ | :------ |
| `THEME` | extends [`DThemeButtonColorGradient`](../interfaces/DThemeButtonColorGradient.md) = [`DThemeButtonColorGradient`](../interfaces/DThemeButtonColorGradient.md) |
| `OPTIONS` | extends [`DButtonColorGradientOptions`](../interfaces/DButtonColorGradientOptions.md)\<`THEME`, `any`\> = [`DButtonColorGradientOptions`](../interfaces/DButtonColorGradientOptions.md)\<`THEME`, `any`\> |
...
▸ **computeTextValue**(): `undefined` \| [`DColorGradientObservable`](DColorGradientObservable.md)
...
▸ **newDialog**(`options?`): [`DDialogColorGradient`](DDialogColorGradient.md)\<[`DThemeDialogColorGradient`](../interfaces/DThemeDialogColorGradient.md), [`DDialogColorGradientOptions`](../interfaces/DDialogColorGradientOptions.md)\<[`DThemeDialogColorGradient`](../interfaces/DThemeDialogColorGradient.md)\>\>
...
▸ **setFocused**(`isFocused`): [`DButtonColorGradient`](DButtonColorGradient.md)\<`THEME`, `OPTIONS`\>
...
▸ **toClone**(`value?`): [`DColorGradient`](../interfaces/DColorGradient.md)
