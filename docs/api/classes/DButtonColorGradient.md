[Winter Cardinal UI](../README.md) / DButtonColorGradient
...
• `Protected` `Optional` **\_textValue**: [`DStateAwareOrValueMightBe`](../README.md#dstateawareorvaluemightbe)<[`DColorGradientObservable`](DColorGradientObservable.md)\>
