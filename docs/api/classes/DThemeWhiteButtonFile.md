[Winter Cardinal UI - v0.407.0](../index.md) / DThemeWhiteButtonFile
...
- [getImageRotation](DThemeWhiteButtonFile.md#getimagerotation)
...
- [getSecondaryImageRotation](DThemeWhiteButtonFile.md#getsecondaryimagerotation)
...
- [getTertiaryImageRotation](DThemeWhiteButtonFile.md#gettertiaryimagerotation)
...
- [getTextStyleFitting](DThemeWhiteButtonFile.md#gettextstylefitting)
...
• **new DThemeWhiteButtonFile**\<`VALUE`\>(`backgroundColor?`, `hover?`, `pressed?`): [`DThemeWhiteButtonFile`](DThemeWhiteButtonFile.md)\<`VALUE`\>
...
[`DThemeWhiteButtonFile`](DThemeWhiteButtonFile.md)\<`VALUE`\>
