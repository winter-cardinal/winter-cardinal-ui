[Winter Cardinal UI - v0.407.0](../index.md) / EShapeActionRuntimeBlinkBrighten

# Class: EShapeActionRuntimeBlinkBrighten
...
- [`EShapeActionRuntimeBlink`](EShapeActionRuntimeBlink.md)
  ...
  ↳ **`EShapeActionRuntimeBlinkBrighten`**

## Table of contents

### Constructors

- [constructor](EShapeActionRuntimeBlinkBrighten.md#constructor)

### Properties

- [condition](EShapeActionRuntimeBlinkBrighten.md#condition)
- [interval](EShapeActionRuntimeBlinkBrighten.md#interval)
- [reset](EShapeActionRuntimeBlinkBrighten.md#reset)

### Methods

- [execute](EShapeActionRuntimeBlinkBrighten.md#execute)
- [initialize](EShapeActionRuntimeBlinkBrighten.md#initialize)
- [onBlur](EShapeActionRuntimeBlinkBrighten.md#onblur)
- [onClick](EShapeActionRuntimeBlinkBrighten.md#onclick)
- [onDblClick](EShapeActionRuntimeBlinkBrighten.md#ondblclick)
- [onDown](EShapeActionRuntimeBlinkBrighten.md#ondown)
- [onDowning](EShapeActionRuntimeBlinkBrighten.md#ondowning)
- [onFocus](EShapeActionRuntimeBlinkBrighten.md#onfocus)
- [onKeyDown](EShapeActionRuntimeBlinkBrighten.md#onkeydown)
- [onKeyUp](EShapeActionRuntimeBlinkBrighten.md#onkeyup)
- [onMove](EShapeActionRuntimeBlinkBrighten.md#onmove)
- [onOut](EShapeActionRuntimeBlinkBrighten.md#onout)
- [onOver](EShapeActionRuntimeBlinkBrighten.md#onover)
- [onPressed](EShapeActionRuntimeBlinkBrighten.md#onpressed)
- [onRender](EShapeActionRuntimeBlinkBrighten.md#onrender)
- [onResize](EShapeActionRuntimeBlinkBrighten.md#onresize)
- [onRightClick](EShapeActionRuntimeBlinkBrighten.md#onrightclick)
- [onRightDown](EShapeActionRuntimeBlinkBrighten.md#onrightdown)
- [onRightDowning](EShapeActionRuntimeBlinkBrighten.md#onrightdowning)
- [onRightPressed](EShapeActionRuntimeBlinkBrighten.md#onrightpressed)
- [onRightUnpressed](EShapeActionRuntimeBlinkBrighten.md#onrightunpressed)
- [onRightUp](EShapeActionRuntimeBlinkBrighten.md#onrightup)
- [onRightUpOutside](EShapeActionRuntimeBlinkBrighten.md#onrightupoutside)
- [onUnpressed](EShapeActionRuntimeBlinkBrighten.md#onunpressed)
- [onUp](EShapeActionRuntimeBlinkBrighten.md#onup)
- [onUpOutside](EShapeActionRuntimeBlinkBrighten.md#onupoutside)
- [toOff](EShapeActionRuntimeBlinkBrighten.md#tooff)
- [toOn](EShapeActionRuntimeBlinkBrighten.md#toon)

## Constructors

### constructor

• **new EShapeActionRuntimeBlinkBrighten**(`value`): [`EShapeActionRuntimeBlinkBrighten`](EShapeActionRuntimeBlinkBrighten.md)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-blink-brighten.ts:15](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-blink-brighten.ts#L15)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-blink.ts:14](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-blink.ts#L14)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-blink.ts:21](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-blink.ts#L21)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-blink.ts:40](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-blink.ts#L40)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-blink-brighten.ts:19](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-blink-brighten.ts#L19)
