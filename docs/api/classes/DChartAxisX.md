[Winter Cardinal UI - v0.164.0](../index.md) / DChartAxisX
...
[src/main/typescript/wcardinal/ui/d-chart-axis-x.ts:19](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.164.0/src/main/typescript/wcardinal/ui/d-chart-axis-x.ts#L19)
