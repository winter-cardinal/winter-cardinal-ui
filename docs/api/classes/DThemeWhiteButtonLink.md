[Winter Cardinal UI - v0.407.0](../index.md) / DThemeWhiteButtonLink
...
- [getImageRotation](DThemeWhiteButtonLink.md#getimagerotation)
...
- [getSecondaryImageRotation](DThemeWhiteButtonLink.md#getsecondaryimagerotation)
...
- [getTertiaryImageRotation](DThemeWhiteButtonLink.md#gettertiaryimagerotation)
...
- [getTextStyleFitting](DThemeWhiteButtonLink.md#gettextstylefitting)
...
• **new DThemeWhiteButtonLink**\<`VALUE`\>(`backgroundColor?`, `hover?`, `pressed?`): [`DThemeWhiteButtonLink`](DThemeWhiteButtonLink.md)\<`VALUE`\>
...
[`DThemeWhiteButtonLink`](DThemeWhiteButtonLink.md)\<`VALUE`\>
