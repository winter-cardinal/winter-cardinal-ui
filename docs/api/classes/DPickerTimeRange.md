[Winter Cardinal UI - v0.160.0](../index.md) / DPickerTimeRange

# Class: DPickerTimeRange<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemePickerTimeRange`](../interfaces/DThemePickerTimeRange.md) = [`DThemePickerTimeRange`](../interfaces/DThemePickerTimeRange.md) |
| `OPTIONS` | extends [`DPickerTimeRangeOptions`](../interfaces/DPickerTimeRangeOptions.md)<`THEME`\> = [`DPickerTimeRangeOptions`](../interfaces/DPickerTimeRangeOptions.md)<`THEME`\> |
...
- [constructor](DPickerTimeRange.md#constructor)

### Properties

- [\_accessibleActive](DPickerTimeRange.md#_accessibleactive)
- [\_accessibleDiv](DPickerTimeRange.md#_accessiblediv)
- [\_auto](DPickerTimeRange.md#_auto)
- [\_background](DPickerTimeRange.md#_background)
- [\_border](DPickerTimeRange.md#_border)
- [\_bounds](DPickerTimeRange.md#_bounds)
- [\_clearType](DPickerTimeRange.md#_cleartype)
- [\_corner](DPickerTimeRange.md#_corner)
- [\_cursor](DPickerTimeRange.md#_cursor)
- [\_destroyed](DPickerTimeRange.md#_destroyed)
- [\_lastDownPoint](DPickerTimeRange.md#_lastdownpoint)
- [\_lastSortedIndex](DPickerTimeRange.md#_lastsortedindex)
- [\_mask](DPickerTimeRange.md#_mask)
- [\_options](DPickerTimeRange.md#_options)
- [\_outline](DPickerTimeRange.md#_outline)
- [\_padding](DPickerTimeRange.md#_padding)
- [\_reflowable](DPickerTimeRange.md#_reflowable)
- [\_shortcuts](DPickerTimeRange.md#_shortcuts)
- [\_snippet](DPickerTimeRange.md#_snippet)
- [\_tempDisplayObjectParent](DPickerTimeRange.md#_tempdisplayobjectparent)
- [\_title](DPickerTimeRange.md#_title)
- [\_zIndex](DPickerTimeRange.md#_zindex)
- [accessible](DPickerTimeRange.md#accessible)
- [accessibleChildren](DPickerTimeRange.md#accessiblechildren)
- [accessibleHint](DPickerTimeRange.md#accessiblehint)
- [accessiblePointerEvents](DPickerTimeRange.md#accessiblepointerevents)
- [accessibleTitle](DPickerTimeRange.md#accessibletitle)
- [accessibleType](DPickerTimeRange.md#accessibletype)
- [alpha](DPickerTimeRange.md#alpha)
- [angle](DPickerTimeRange.md#angle)
- [buttonMode](DPickerTimeRange.md#buttonmode)
- [cacheAsBitmap](DPickerTimeRange.md#cacheasbitmap)
- [children](DPickerTimeRange.md#children)
- [cursor](DPickerTimeRange.md#cursor)
- [filterArea](DPickerTimeRange.md#filterarea)
- [filters](DPickerTimeRange.md#filters)
- [hitArea](DPickerTimeRange.md#hitarea)
- [interactive](DPickerTimeRange.md#interactive)
- [interactiveChildren](DPickerTimeRange.md#interactivechildren)
- [isMask](DPickerTimeRange.md#ismask)
- [isSprite](DPickerTimeRange.md#issprite)
- [localTransform](DPickerTimeRange.md#localtransform)
- [mask](DPickerTimeRange.md#mask)
- [name](DPickerTimeRange.md#name)
- [parent](DPickerTimeRange.md#parent)
- [pivot](DPickerTimeRange.md#pivot)
- [renderable](DPickerTimeRange.md#renderable)
- [rotation](DPickerTimeRange.md#rotation)
- [sortDirty](DPickerTimeRange.md#sortdirty)
- [sortableChildren](DPickerTimeRange.md#sortablechildren)
- [transform](DPickerTimeRange.md#transform)
- [visible](DPickerTimeRange.md#visible)
- [worldAlpha](DPickerTimeRange.md#worldalpha)
- [worldTransform](DPickerTimeRange.md#worldtransform)
- [worldVisible](DPickerTimeRange.md#worldvisible)
- [zIndex](DPickerTimeRange.md#zindex)
- [WORK\_CONTAINS\_POINT](DPickerTimeRange.md#work_contains_point)

### Accessors

- [background](DPickerTimeRange.md#background)
- [border](DPickerTimeRange.md#border)
- [corner](DPickerTimeRange.md#corner)
- [height](DPickerTimeRange.md#height)
- [outline](DPickerTimeRange.md#outline)
- [padding](DPickerTimeRange.md#padding)
- [position](DPickerTimeRange.md#position)
- [reflowable](DPickerTimeRange.md#reflowable)
- [scale](DPickerTimeRange.md#scale)
- [shadow](DPickerTimeRange.md#shadow)
- [skew](DPickerTimeRange.md#skew)
- [snippet](DPickerTimeRange.md#snippet)
- [state](DPickerTimeRange.md#state)
- [theme](DPickerTimeRange.md#theme)
- [title](DPickerTimeRange.md#title)
- [type](DPickerTimeRange.md#type)
- [unsafe](DPickerTimeRange.md#unsafe)
- [weight](DPickerTimeRange.md#weight)
- [width](DPickerTimeRange.md#width)
- [x](DPickerTimeRange.md#x)
- [y](DPickerTimeRange.md#y)

### Methods

- [\_calculateBounds](DPickerTimeRange.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DPickerTimeRange.md#_recursivepostupdatetransform)
- [\_render](DPickerTimeRange.md#_render)
- [addChild](DPickerTimeRange.md#addchild)
- [addChildAt](DPickerTimeRange.md#addchildat)
- [addListener](DPickerTimeRange.md#addlistener)
- [applyTitle](DPickerTimeRange.md#applytitle)
- [blur](DPickerTimeRange.md#blur)
- [calculateBounds](DPickerTimeRange.md#calculatebounds)
- [containsGlobalPoint](DPickerTimeRange.md#containsglobalpoint)
- [containsLocalPoint](DPickerTimeRange.md#containslocalpoint)
- [containsPoint](DPickerTimeRange.md#containspoint)
- [destroy](DPickerTimeRange.md#destroy)
- [displayObjectUpdateTransform](DPickerTimeRange.md#displayobjectupdatetransform)
- [emit](DPickerTimeRange.md#emit)
- [eventNames](DPickerTimeRange.md#eventnames)
- [focus](DPickerTimeRange.md#focus)
- [focusOnClosest](DPickerTimeRange.md#focusonclosest)
- [getBounds](DPickerTimeRange.md#getbounds)
- [getChildAt](DPickerTimeRange.md#getchildat)
- [getChildByName](DPickerTimeRange.md#getchildbyname)
- [getChildIndex](DPickerTimeRange.md#getchildindex)
- [getClearType](DPickerTimeRange.md#getcleartype)
- [getClippingRect](DPickerTimeRange.md#getclippingrect)
- [getGlobalPosition](DPickerTimeRange.md#getglobalposition)
- [getHeight](DPickerTimeRange.md#getheight)
- [getLocalBounds](DPickerTimeRange.md#getlocalbounds)
- [getParentOfSize](DPickerTimeRange.md#getparentofsize)
- [getThemeDefault](DPickerTimeRange.md#getthemedefault)
- [getType](DPickerTimeRange.md#gettype)
- [getWidth](DPickerTimeRange.md#getwidth)
- [getX](DPickerTimeRange.md#getx)
- [getY](DPickerTimeRange.md#gety)
- [hasDirty](DPickerTimeRange.md#hasdirty)
- [hasRefitableHeight](DPickerTimeRange.md#hasrefitableheight)
- [hasRefitableWidth](DPickerTimeRange.md#hasrefitablewidth)
- [hide](DPickerTimeRange.md#hide)
- [init](DPickerTimeRange.md#init)
- [initReflowable](DPickerTimeRange.md#initreflowable)
- [isDirty](DPickerTimeRange.md#isdirty)
- [isEventTarget](DPickerTimeRange.md#iseventtarget)
- [isHidden](DPickerTimeRange.md#ishidden)
- [isHierarchyDirty](DPickerTimeRange.md#ishierarchydirty)
- [isRefitable](DPickerTimeRange.md#isrefitable)
- [isShown](DPickerTimeRange.md#isshown)
- [listenerCount](DPickerTimeRange.md#listenercount)
- [listeners](DPickerTimeRange.md#listeners)
- [off](DPickerTimeRange.md#off)
- [on](DPickerTimeRange.md#on)
- [onBlur](DPickerTimeRange.md#onblur)
- [onChildBlur](DPickerTimeRange.md#onchildblur)
- [onChildFocus](DPickerTimeRange.md#onchildfocus)
- [onChildrenChange](DPickerTimeRange.md#onchildrenchange)
- [onDblClick](DPickerTimeRange.md#ondblclick)
- [onDown](DPickerTimeRange.md#ondown)
- [onDownThis](DPickerTimeRange.md#ondownthis)
- [onFocus](DPickerTimeRange.md#onfocus)
- [onHierarchyDirty](DPickerTimeRange.md#onhierarchydirty)
- [onKeyDown](DPickerTimeRange.md#onkeydown)
- [onKeyUp](DPickerTimeRange.md#onkeyup)
- [onMove](DPickerTimeRange.md#onmove)
- [onOut](DPickerTimeRange.md#onout)
- [onOver](DPickerTimeRange.md#onover)
- [onParentMove](DPickerTimeRange.md#onparentmove)
- [onParentResize](DPickerTimeRange.md#onparentresize)
- [onRefit](DPickerTimeRange.md#onrefit)
- [onReflow](DPickerTimeRange.md#onreflow)
- [onResize](DPickerTimeRange.md#onresize)
- [onScale](DPickerTimeRange.md#onscale)
- [onShortcut](DPickerTimeRange.md#onshortcut)
- [onSkew](DPickerTimeRange.md#onskew)
- [onStateChange](DPickerTimeRange.md#onstatechange)
- [onUp](DPickerTimeRange.md#onup)
- [onUpThis](DPickerTimeRange.md#onupthis)
- [onWheel](DPickerTimeRange.md#onwheel)
- [once](DPickerTimeRange.md#once)
- [reflow](DPickerTimeRange.md#reflow)
- [removeAllListeners](DPickerTimeRange.md#removealllisteners)
- [removeChild](DPickerTimeRange.md#removechild)
- [removeChildAt](DPickerTimeRange.md#removechildat)
- [removeChildren](DPickerTimeRange.md#removechildren)
- [removeListener](DPickerTimeRange.md#removelistener)
- [render](DPickerTimeRange.md#render)
- [renderAdvanced](DPickerTimeRange.md#renderadvanced)
- [resize](DPickerTimeRange.md#resize)
- [setChildIndex](DPickerTimeRange.md#setchildindex)
- [setFocused](DPickerTimeRange.md#setfocused)
- [setHeight](DPickerTimeRange.md#setheight)
- [setParent](DPickerTimeRange.md#setparent)
- [setTransform](DPickerTimeRange.md#settransform)
- [setWidth](DPickerTimeRange.md#setwidth)
- [setX](DPickerTimeRange.md#setx)
- [setY](DPickerTimeRange.md#sety)
- [show](DPickerTimeRange.md#show)
- [sortChildren](DPickerTimeRange.md#sortchildren)
- [swapChildren](DPickerTimeRange.md#swapchildren)
- [toCursor](DPickerTimeRange.md#tocursor)
- [toDirty](DPickerTimeRange.md#todirty)
- [toGlobal](DPickerTimeRange.md#toglobal)
- [toHasDirty](DPickerTimeRange.md#tohasdirty)
- [toHierarchyDirty](DPickerTimeRange.md#tohierarchydirty)
- [toLocal](DPickerTimeRange.md#tolocal)
- [toParentHasDirty](DPickerTimeRange.md#toparenthasdirty)
- [toParentHierarchyDirty](DPickerTimeRange.md#toparenthierarchydirty)
- [toParentResized](DPickerTimeRange.md#toparentresized)
- [updateTransform](DPickerTimeRange.md#updatetransform)
- [mixin](DPickerTimeRange.md#mixin)

## Constructors

### constructor

• **new DPickerTimeRange**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemePickerTimeRange`](../interfaces/DThemePickerTimeRange.md) = [`DThemePickerTimeRange`](../interfaces/DThemePickerTimeRange.md) |
| `OPTIONS` | extends [`DPickerTimeRangeOptions`](../interfaces/DPickerTimeRangeOptions.md)<`THEME`, `OPTIONS`\> = [`DPickerTimeRangeOptions`](../interfaces/DPickerTimeRangeOptions.md)<`THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DPickerTimeRange`](DPickerTimeRange.md)<`THEME`, `OPTIONS`\>
...
[`DPickerTimeRange`](DPickerTimeRange.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DPickerTimeRange`](DPickerTimeRange.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DPickerTimeRange`](DPickerTimeRange.md)<`THEME`, `OPTIONS`\>
...
▸ **hide**(): [`DPickerTimeRange`](DPickerTimeRange.md)<`THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DPickerTimeRange`](DPickerTimeRange.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DPickerTimeRange`](DPickerTimeRange.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DPickerTimeRange`](DPickerTimeRange.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DPickerTimeRange`](DPickerTimeRange.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DPickerTimeRange`](DPickerTimeRange.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DPickerTimeRange`](DPickerTimeRange.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DPickerTimeRange`](DPickerTimeRange.md)<`THEME`, `OPTIONS`\>
