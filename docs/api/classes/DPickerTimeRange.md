[Winter Cardinal UI - v0.407.0](../index.md) / DPickerTimeRange
...
- [\_boundsID](DPickerTimeRange.md#_boundsid)
- [\_boundsRect](DPickerTimeRange.md#_boundsrect)
...
- [\_enabledFilters](DPickerTimeRange.md#_enabledfilters)
- [\_lastDownPoint](DPickerTimeRange.md#_lastdownpoint)
- [\_lastSortedIndex](DPickerTimeRange.md#_lastsortedindex)
- [\_localBounds](DPickerTimeRange.md#_localbounds)
- [\_localBoundsRect](DPickerTimeRange.md#_localboundsrect)
...
- [options](DPickerTimeRange.md#options)
...
- [containerUpdateTransform](DPickerTimeRange.md#containerupdatetransform)
...
- [disableTempParent](DPickerTimeRange.md#disabletempparent)
- [displayObjectUpdateTransform](DPickerTimeRange.md#displayobjectupdatetransform)
- [emit](DPickerTimeRange.md#emit)
- [enableTempParent](DPickerTimeRange.md#enabletempparent)
...
- [newPadding](DPickerTimeRange.md#newpadding)
...
• **new DPickerTimeRange**\<`THEME`, `OPTIONS`\>(`options?`): [`DPickerTimeRange`](DPickerTimeRange.md)\<`THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DPickerTimeRange`](DPickerTimeRange.md)\<`THEME`, `OPTIONS`\>
