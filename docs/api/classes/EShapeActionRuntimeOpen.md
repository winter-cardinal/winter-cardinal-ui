[Winter Cardinal UI - v0.442.0](../index.md) / EShapeActionRuntimeOpen
...
- [onClick](EShapeActionRuntimeOpen.md#onclick)
...
- [onKeyDown](EShapeActionRuntimeOpen.md#onkeydown)
- [onKeyUp](EShapeActionRuntimeOpen.md#onkeyup)
- [onMove](EShapeActionRuntimeOpen.md#onmove)
- [onOut](EShapeActionRuntimeOpen.md#onout)
- [onOver](EShapeActionRuntimeOpen.md#onover)
- [onPressed](EShapeActionRuntimeOpen.md#onpressed)
- [onRender](EShapeActionRuntimeOpen.md#onrender)
- [onResize](EShapeActionRuntimeOpen.md#onresize)
- [onRightClick](EShapeActionRuntimeOpen.md#onrightclick)
- [onRightDown](EShapeActionRuntimeOpen.md#onrightdown)
- [onRightDowning](EShapeActionRuntimeOpen.md#onrightdowning)
- [onRightPressed](EShapeActionRuntimeOpen.md#onrightpressed)
- [onRightUnpressed](EShapeActionRuntimeOpen.md#onrightunpressed)
- [onRightUp](EShapeActionRuntimeOpen.md#onrightup)
- [onRightUpOutside](EShapeActionRuntimeOpen.md#onrightupoutside)
- [onUnpressed](EShapeActionRuntimeOpen.md#onunpressed)
- [onUp](EShapeActionRuntimeOpen.md#onup)
- [onUpOutside](EShapeActionRuntimeOpen.md#onupoutside)

## Constructors

### constructor

• **new EShapeActionRuntimeOpen**(`value`, `subtype`): [`EShapeActionRuntimeOpen`](EShapeActionRuntimeOpen.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `value` | [`EShapeActionValueOpenExtension`](EShapeActionValueOpenExtension.md) \| [`EShapeActionValueOpen`](EShapeActionValueOpen.md) |
| `subtype` | `number` |
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open.ts#L23)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open.ts:21](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open.ts#L21)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open.ts:19](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open.ts#L19)

___

### target

• `Protected` `Readonly` **target**: [`EShapeActionExpression`](../index.md#eshapeactionexpression)\<`unknown`\>

#### Defined in

[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open.ts#L20)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open.ts:33](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open.ts#L33)
