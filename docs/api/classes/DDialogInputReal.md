[Winter Cardinal UI - v0.457.0](../index.md) / DDialogInputReal
...
- [\_alwaysOnTop](DDialogInputReal.md#_alwaysontop)
...
- [\_boundsID](DDialogInputReal.md#_boundsid)
- [\_boundsRect](DDialogInputReal.md#_boundsrect)
...
- [\_enabledFilters](DDialogInputReal.md#_enabledfilters)
...
- [\_localBounds](DDialogInputReal.md#_localbounds)
- [\_localBoundsRect](DDialogInputReal.md#_localboundsrect)
- [\_mask](DDialogInputReal.md#_mask)
- [\_mode](DDialogInputReal.md#_mode)
- [\_onParentChildAddedBound](DDialogInputReal.md#_onparentchildaddedbound)
...
- [alwaysOnTop](DDialogInputReal.md#alwaysontop)
...
- [disableTempParent](DDialogInputReal.md#disabletempparent)
...
- [enableTempParent](DDialogInputReal.md#enabletempparent)
...
- [newPadding](DDialogInputReal.md#newpadding)
...
• **new DDialogInputReal**\<`THEME`, `OPTIONS`\>(`options?`): [`DDialogInputReal`](DDialogInputReal.md)\<`THEME`, `OPTIONS`\>
...
▸ **getResolvedValue**(): `number` \| `PromiseLike`\<`number`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-input-real.ts:44](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-input-real.ts#L44)
...
▸ **newInput**(`options?`): [`DInputReal`](DInputReal.md)\<[`DThemeInputReal`](../interfaces/DThemeInputReal.md), [`DInputRealOptions`](../interfaces/DInputRealOptions.md)\<[`DThemeInputReal`](../interfaces/DThemeInputReal.md)\>\>
...
[src/main/typescript/wcardinal/ui/d-dialog-input-real.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-input-real.ts#L22)
...
▸ **toInputOptions**(`options?`): `undefined` \| [`DDialogInputRealInputOptions`](../interfaces/DDialogInputRealInputOptions.md)
...
[src/main/typescript/wcardinal/ui/d-dialog-input-real.ts:30](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-input-real.ts#L30)
