[Winter Cardinal UI - v0.160.0](../index.md) / DLayoutVertical
...
• **new DLayoutVertical**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemeLayoutVertical`](../interfaces/DThemeLayoutVertical.md) = [`DThemeLayoutVertical`](../interfaces/DThemeLayoutVertical.md) |
| `OPTIONS` | extends [`DLayoutVerticalOptions`](../interfaces/DLayoutVerticalOptions.md)<`THEME`, `OPTIONS`\> = [`DLayoutVerticalOptions`](../interfaces/DLayoutVerticalOptions.md)<`THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DLayoutVertical`](DLayoutVertical.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DLayoutVertical`](DLayoutVertical.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DLayoutVertical`](DLayoutVertical.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-layout-vertical.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout-vertical.ts#L17)
...
▸ **hide**(): [`DLayoutVertical`](DLayoutVertical.md)<`THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DLayoutVertical`](DLayoutVertical.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DLayoutVertical`](DLayoutVertical.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DLayoutVertical`](DLayoutVertical.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DLayoutVertical`](DLayoutVertical.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DLayoutVertical`](DLayoutVertical.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DLayoutVertical`](DLayoutVertical.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DLayoutVertical`](DLayoutVertical.md)<`THEME`, `OPTIONS`\>
