[Winter Cardinal UI - v0.407.0](../index.md) / DLayoutVertical
...
[src/main/typescript/wcardinal/ui/d-layout-vertical.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-layout-vertical.ts#L17)
...
▸ **setFocused**(`isFocused`): [`DLayoutVertical`](DLayoutVertical.md)\<`THEME`, `OPTIONS`\>
