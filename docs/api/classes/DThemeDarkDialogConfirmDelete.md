[Winter Cardinal UI - v0.200.0](../index.md) / DThemeDarkDialogConfirmDelete

# Class: DThemeDarkDialogConfirmDelete

## Hierarchy

- [`DThemeDarkDialogConfirm`](DThemeDarkDialogConfirm.md)

  ↳ **`DThemeDarkDialogConfirmDelete`**

## Table of contents

### Constructors

- [constructor](DThemeDarkDialogConfirmDelete.md#constructor)

### Methods

- [closeOn](DThemeDarkDialogConfirmDelete.md#closeon)
- [getAlign](DThemeDarkDialogConfirmDelete.md#getalign)
- [getAlpha](DThemeDarkDialogConfirmDelete.md#getalpha)
- [getBackgroundAlpha](DThemeDarkDialogConfirmDelete.md#getbackgroundalpha)
- [getBackgroundColor](DThemeDarkDialogConfirmDelete.md#getbackgroundcolor)
- [getBackgroundTexture](DThemeDarkDialogConfirmDelete.md#getbackgroundtexture)
- [getBorderAlign](DThemeDarkDialogConfirmDelete.md#getborderalign)
- [getBorderAlpha](DThemeDarkDialogConfirmDelete.md#getborderalpha)
- [getBorderColor](DThemeDarkDialogConfirmDelete.md#getbordercolor)
- [getBorderMask](DThemeDarkDialogConfirmDelete.md#getbordermask)
- [getBorderTexture](DThemeDarkDialogConfirmDelete.md#getbordertexture)
- [getBorderWidth](DThemeDarkDialogConfirmDelete.md#getborderwidth)
- [getClearType](DThemeDarkDialogConfirmDelete.md#getcleartype)
- [getColor](DThemeDarkDialogConfirmDelete.md#getcolor)
- [getContent](DThemeDarkDialogConfirmDelete.md#getcontent)
- [getCornerMask](DThemeDarkDialogConfirmDelete.md#getcornermask)
- [getCornerRadius](DThemeDarkDialogConfirmDelete.md#getcornerradius)
- [getCursor](DThemeDarkDialogConfirmDelete.md#getcursor)
- [getFontFamilly](DThemeDarkDialogConfirmDelete.md#getfontfamilly)
- [getFontSize](DThemeDarkDialogConfirmDelete.md#getfontsize)
- [getFontStyle](DThemeDarkDialogConfirmDelete.md#getfontstyle)
- [getFontVariant](DThemeDarkDialogConfirmDelete.md#getfontvariant)
- [getFontWeight](DThemeDarkDialogConfirmDelete.md#getfontweight)
- [getFooter](DThemeDarkDialogConfirmDelete.md#getfooter)
- [getGestureMode](DThemeDarkDialogConfirmDelete.md#getgesturemode)
- [getHeader](DThemeDarkDialogConfirmDelete.md#getheader)
- [getHeight](DThemeDarkDialogConfirmDelete.md#getheight)
- [getInteractive](DThemeDarkDialogConfirmDelete.md#getinteractive)
- [getLayout](DThemeDarkDialogConfirmDelete.md#getlayout)
- [getLineHeight](DThemeDarkDialogConfirmDelete.md#getlineheight)
- [getMessage](DThemeDarkDialogConfirmDelete.md#getmessage)
- [getMode](DThemeDarkDialogConfirmDelete.md#getmode)
- [getOffsetX](DThemeDarkDialogConfirmDelete.md#getoffsetx)
- [getOffsetY](DThemeDarkDialogConfirmDelete.md#getoffsety)
- [getOutlineAlign](DThemeDarkDialogConfirmDelete.md#getoutlinealign)
- [getOutlineAlpha](DThemeDarkDialogConfirmDelete.md#getoutlinealpha)
- [getOutlineColor](DThemeDarkDialogConfirmDelete.md#getoutlinecolor)
- [getOutlineMask](DThemeDarkDialogConfirmDelete.md#getoutlinemask)
- [getOutlineOffset](DThemeDarkDialogConfirmDelete.md#getoutlineoffset)
- [getOutlineWidth](DThemeDarkDialogConfirmDelete.md#getoutlinewidth)
- [getPaddingBottom](DThemeDarkDialogConfirmDelete.md#getpaddingbottom)
- [getPaddingLeft](DThemeDarkDialogConfirmDelete.md#getpaddingleft)
- [getPaddingRight](DThemeDarkDialogConfirmDelete.md#getpaddingright)
- [getPaddingTop](DThemeDarkDialogConfirmDelete.md#getpaddingtop)
- [getShadow](DThemeDarkDialogConfirmDelete.md#getshadow)
- [getTitle](DThemeDarkDialogConfirmDelete.md#gettitle)
- [getWeight](DThemeDarkDialogConfirmDelete.md#getweight)
- [getWidth](DThemeDarkDialogConfirmDelete.md#getwidth)
- [getX](DThemeDarkDialogConfirmDelete.md#getx)
- [getY](DThemeDarkDialogConfirmDelete.md#gety)
- [isGestureEnabled](DThemeDarkDialogConfirmDelete.md#isgestureenabled)
- [isSticky](DThemeDarkDialogConfirmDelete.md#issticky)
- [newAnimation](DThemeDarkDialogConfirmDelete.md#newanimation)
- [newShadow](DThemeDarkDialogConfirmDelete.md#newshadow)
- [newShadowWeak](DThemeDarkDialogConfirmDelete.md#newshadowweak)
- [newState](DThemeDarkDialogConfirmDelete.md#newstate)

## Constructors

### constructor

• **new DThemeDarkDialogConfirmDelete**()
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-dialog-confirm.ts:15](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.200.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-dialog-confirm.ts#L15)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-dialog-confirm-delete.ts:10](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.200.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-dialog-confirm-delete.ts#L10)
