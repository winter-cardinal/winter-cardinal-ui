[Winter Cardinal UI - v0.374.0](../index.md) / DDialogSelectListItem
...
[src/main/typescript/wcardinal/ui/d-dialog-select-list-item.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-select-list-item.ts#L23)
