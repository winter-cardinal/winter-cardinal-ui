[Winter Cardinal UI - v0.407.0](../index.md) / DDialogSelectListItem
...
- [\_boundsID](DDialogSelectListItem.md#_boundsid)
- [\_boundsRect](DDialogSelectListItem.md#_boundsrect)
...
- [\_enabledFilters](DDialogSelectListItem.md#_enabledfilters)
- [\_image](DDialogSelectListItem.md#_image)
...
- [\_localBounds](DDialogSelectListItem.md#_localbounds)
- [\_localBoundsRect](DDialogSelectListItem.md#_localboundsrect)
...
- [link](DDialogSelectListItem.md#link)
- [options](DDialogSelectListItem.md#options)
...
- [activate](DDialogSelectListItem.md#activate)
...
- [containerUpdateTransform](DDialogSelectListItem.md#containerupdatetransform)
...
- [disableTempParent](DDialogSelectListItem.md#disabletempparent)
- [displayObjectUpdateTransform](DDialogSelectListItem.md#displayobjectupdatetransform)
- [emit](DDialogSelectListItem.md#emit)
- [enableTempParent](DDialogSelectListItem.md#enabletempparent)
...
- [getImage](DDialogSelectListItem.md#getimage)
- [getLayouter](DDialogSelectListItem.md#getlayouter)
...
- [getText](DDialogSelectListItem.md#gettext)
...
- [newLink](DDialogSelectListItem.md#newlink)
- [newOverflowMask](DDialogSelectListItem.md#newoverflowmask)
- [newPadding](DDialogSelectListItem.md#newpadding)
- [newText](DDialogSelectListItem.md#newtext)
...
- [onClick](DDialogSelectListItem.md#onclick)
...
- [onReflowTextAndImage](DDialogSelectListItem.md#onreflowtextandimage)
...
• **new DDialogSelectListItem**\<`VALUE`, `THEME`, `OPTIONS`\>(`data`, `options?`): [`DDialogSelectListItem`](DDialogSelectListItem.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-select-list-item.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-select-list-item.ts#L23)
...
▸ **setFocused**(`isFocused`): [`DDialogSelectListItem`](DDialogSelectListItem.md)\<`VALUE`, `THEME`, `OPTIONS`\>
