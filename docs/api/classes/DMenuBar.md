[Winter Cardinal UI - v0.160.0](../index.md) / DMenuBar

# Class: DMenuBar<VALUE, THEME, OPTIONS\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeMenuBar`](../interfaces/DThemeMenuBar.md) = [`DThemeMenuBar`](../interfaces/DThemeMenuBar.md) |
| `OPTIONS` | extends [`DMenuBarOptions`](../interfaces/DMenuBarOptions.md)<`VALUE`, `THEME`\> = [`DMenuBarOptions`](../interfaces/DMenuBarOptions.md)<`VALUE`, `THEME`\> |
...
- [constructor](DMenuBar.md#constructor)

### Properties

- [\_accessibleActive](DMenuBar.md#_accessibleactive)
- [\_accessibleDiv](DMenuBar.md#_accessiblediv)
- [\_auto](DMenuBar.md#_auto)
- [\_background](DMenuBar.md#_background)
- [\_border](DMenuBar.md#_border)
- [\_bounds](DMenuBar.md#_bounds)
- [\_clearType](DMenuBar.md#_cleartype)
- [\_corner](DMenuBar.md#_corner)
- [\_cornerAdjust](DMenuBar.md#_corneradjust)
- [\_cursor](DMenuBar.md#_cursor)
- [\_destroyed](DMenuBar.md#_destroyed)
- [\_direction](DMenuBar.md#_direction)
- [\_lastDownPoint](DMenuBar.md#_lastdownpoint)
- [\_lastSortedIndex](DMenuBar.md#_lastsortedindex)
- [\_margin](DMenuBar.md#_margin)
- [\_mask](DMenuBar.md#_mask)
- [\_multiplicity](DMenuBar.md#_multiplicity)
- [\_options](DMenuBar.md#_options)
- [\_outline](DMenuBar.md#_outline)
- [\_padding](DMenuBar.md#_padding)
- [\_reflowable](DMenuBar.md#_reflowable)
- [\_reverse](DMenuBar.md#_reverse)
- [\_shortcuts](DMenuBar.md#_shortcuts)
- [\_snippet](DMenuBar.md#_snippet)
- [\_tempDisplayObjectParent](DMenuBar.md#_tempdisplayobjectparent)
- [\_title](DMenuBar.md#_title)
- [\_zIndex](DMenuBar.md#_zindex)
- [accessible](DMenuBar.md#accessible)
- [accessibleChildren](DMenuBar.md#accessiblechildren)
- [accessibleHint](DMenuBar.md#accessiblehint)
- [accessiblePointerEvents](DMenuBar.md#accessiblepointerevents)
- [accessibleTitle](DMenuBar.md#accessibletitle)
- [accessibleType](DMenuBar.md#accessibletype)
- [alpha](DMenuBar.md#alpha)
- [angle](DMenuBar.md#angle)
- [buttonMode](DMenuBar.md#buttonmode)
- [cacheAsBitmap](DMenuBar.md#cacheasbitmap)
- [children](DMenuBar.md#children)
- [cursor](DMenuBar.md#cursor)
- [filterArea](DMenuBar.md#filterarea)
- [filters](DMenuBar.md#filters)
- [hitArea](DMenuBar.md#hitarea)
- [interactive](DMenuBar.md#interactive)
- [interactiveChildren](DMenuBar.md#interactivechildren)
- [isMask](DMenuBar.md#ismask)
- [isSprite](DMenuBar.md#issprite)
- [localTransform](DMenuBar.md#localtransform)
- [mask](DMenuBar.md#mask)
- [name](DMenuBar.md#name)
- [parent](DMenuBar.md#parent)
- [pivot](DMenuBar.md#pivot)
- [renderable](DMenuBar.md#renderable)
- [rotation](DMenuBar.md#rotation)
- [sortDirty](DMenuBar.md#sortdirty)
- [sortableChildren](DMenuBar.md#sortablechildren)
- [transform](DMenuBar.md#transform)
- [visible](DMenuBar.md#visible)
- [worldAlpha](DMenuBar.md#worldalpha)
- [worldTransform](DMenuBar.md#worldtransform)
- [worldVisible](DMenuBar.md#worldvisible)
- [zIndex](DMenuBar.md#zindex)
- [CORNER\_ADJUST\_WORK](DMenuBar.md#corner_adjust_work)
- [WORK\_CONTAINS\_POINT](DMenuBar.md#work_contains_point)

### Accessors

- [background](DMenuBar.md#background)
- [border](DMenuBar.md#border)
- [corner](DMenuBar.md#corner)
- [height](DMenuBar.md#height)
- [margin](DMenuBar.md#margin)
- [multiplicity](DMenuBar.md#multiplicity)
- [outline](DMenuBar.md#outline)
- [padding](DMenuBar.md#padding)
- [position](DMenuBar.md#position)
- [reflowable](DMenuBar.md#reflowable)
- [scale](DMenuBar.md#scale)
- [shadow](DMenuBar.md#shadow)
- [skew](DMenuBar.md#skew)
- [snippet](DMenuBar.md#snippet)
- [state](DMenuBar.md#state)
- [theme](DMenuBar.md#theme)
- [title](DMenuBar.md#title)
- [type](DMenuBar.md#type)
- [unsafe](DMenuBar.md#unsafe)
- [weight](DMenuBar.md#weight)
- [width](DMenuBar.md#width)
- [x](DMenuBar.md#x)
- [y](DMenuBar.md#y)

### Methods

- [\_calculateBounds](DMenuBar.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DMenuBar.md#_recursivepostupdatetransform)
- [\_render](DMenuBar.md#_render)
- [addChild](DMenuBar.md#addchild)
- [addChildAt](DMenuBar.md#addchildat)
- [addListener](DMenuBar.md#addlistener)
- [addSpace](DMenuBar.md#addspace)
- [applyTitle](DMenuBar.md#applytitle)
- [blur](DMenuBar.md#blur)
- [calcSpaceLeft](DMenuBar.md#calcspaceleft)
- [calculateBounds](DMenuBar.md#calculatebounds)
- [containsGlobalPoint](DMenuBar.md#containsglobalpoint)
- [containsLocalPoint](DMenuBar.md#containslocalpoint)
- [containsPoint](DMenuBar.md#containspoint)
- [countColumn](DMenuBar.md#countcolumn)
- [countRow](DMenuBar.md#countrow)
- [destroy](DMenuBar.md#destroy)
- [displayObjectUpdateTransform](DMenuBar.md#displayobjectupdatetransform)
- [emit](DMenuBar.md#emit)
- [eventNames](DMenuBar.md#eventnames)
- [findColumnIndexNext](DMenuBar.md#findcolumnindexnext)
- [findColumnIndexPrevious](DMenuBar.md#findcolumnindexprevious)
- [findRowIndexNext](DMenuBar.md#findrowindexnext)
- [findRowIndexPrevious](DMenuBar.md#findrowindexprevious)
- [focus](DMenuBar.md#focus)
- [focusOnClosest](DMenuBar.md#focusonclosest)
- [getBounds](DMenuBar.md#getbounds)
- [getChildAt](DMenuBar.md#getchildat)
- [getChildByName](DMenuBar.md#getchildbyname)
- [getChildIndex](DMenuBar.md#getchildindex)
- [getClearType](DMenuBar.md#getcleartype)
- [getClippingRect](DMenuBar.md#getclippingrect)
- [getGlobalPosition](DMenuBar.md#getglobalposition)
- [getHeight](DMenuBar.md#getheight)
- [getLocalBounds](DMenuBar.md#getlocalbounds)
- [getParentOfSize](DMenuBar.md#getparentofsize)
- [getSpaceLeft](DMenuBar.md#getspaceleft)
- [getThemeDefault](DMenuBar.md#getthemedefault)
- [getType](DMenuBar.md#gettype)
- [getWeightTotal](DMenuBar.md#getweighttotal)
- [getWidth](DMenuBar.md#getwidth)
- [getX](DMenuBar.md#getx)
- [getY](DMenuBar.md#gety)
- [hasClearType](DMenuBar.md#hascleartype)
- [hasClearTypeAfter](DMenuBar.md#hascleartypeafter)
- [hasClearTypeBefore](DMenuBar.md#hascleartypebefore)
- [hasDirty](DMenuBar.md#hasdirty)
- [hasRefitableHeight](DMenuBar.md#hasrefitableheight)
- [hasRefitableWidth](DMenuBar.md#hasrefitablewidth)
- [hide](DMenuBar.md#hide)
- [init](DMenuBar.md#init)
- [initReflowable](DMenuBar.md#initreflowable)
- [isDirty](DMenuBar.md#isdirty)
- [isEventTarget](DMenuBar.md#iseventtarget)
- [isHidden](DMenuBar.md#ishidden)
- [isHierarchyDirty](DMenuBar.md#ishierarchydirty)
- [isRefitable](DMenuBar.md#isrefitable)
- [isShown](DMenuBar.md#isshown)
- [listenerCount](DMenuBar.md#listenercount)
- [listeners](DMenuBar.md#listeners)
- [off](DMenuBar.md#off)
- [on](DMenuBar.md#on)
- [onBlur](DMenuBar.md#onblur)
- [onChildBlur](DMenuBar.md#onchildblur)
- [onChildFocus](DMenuBar.md#onchildfocus)
- [onChildrenChange](DMenuBar.md#onchildrenchange)
- [onDblClick](DMenuBar.md#ondblclick)
- [onDown](DMenuBar.md#ondown)
- [onDownThis](DMenuBar.md#ondownthis)
- [onFocus](DMenuBar.md#onfocus)
- [onHierarchyDirty](DMenuBar.md#onhierarchydirty)
- [onKeyDown](DMenuBar.md#onkeydown)
- [onKeyUp](DMenuBar.md#onkeyup)
- [onMove](DMenuBar.md#onmove)
- [onOut](DMenuBar.md#onout)
- [onOver](DMenuBar.md#onover)
- [onParentMove](DMenuBar.md#onparentmove)
- [onParentResize](DMenuBar.md#onparentresize)
- [onRefit](DMenuBar.md#onrefit)
- [onReflow](DMenuBar.md#onreflow)
- [onResize](DMenuBar.md#onresize)
- [onScale](DMenuBar.md#onscale)
- [onShortcut](DMenuBar.md#onshortcut)
- [onSkew](DMenuBar.md#onskew)
- [onStateChange](DMenuBar.md#onstatechange)
- [onUp](DMenuBar.md#onup)
- [onUpThis](DMenuBar.md#onupthis)
- [onWheel](DMenuBar.md#onwheel)
- [once](DMenuBar.md#once)
- [reflow](DMenuBar.md#reflow)
- [removeAllListeners](DMenuBar.md#removealllisteners)
- [removeChild](DMenuBar.md#removechild)
- [removeChildAt](DMenuBar.md#removechildat)
- [removeChildren](DMenuBar.md#removechildren)
- [removeListener](DMenuBar.md#removelistener)
- [render](DMenuBar.md#render)
- [renderAdvanced](DMenuBar.md#renderadvanced)
- [resize](DMenuBar.md#resize)
- [setChildIndex](DMenuBar.md#setchildindex)
- [setFocused](DMenuBar.md#setfocused)
- [setHeight](DMenuBar.md#setheight)
- [setParent](DMenuBar.md#setparent)
- [setTransform](DMenuBar.md#settransform)
- [setWidth](DMenuBar.md#setwidth)
- [setX](DMenuBar.md#setx)
- [setY](DMenuBar.md#sety)
- [show](DMenuBar.md#show)
- [sortChildren](DMenuBar.md#sortchildren)
- [swapChildren](DMenuBar.md#swapchildren)
- [toCornerMaskColumn](DMenuBar.md#tocornermaskcolumn)
- [toCornerMaskRow](DMenuBar.md#tocornermaskrow)
- [toCursor](DMenuBar.md#tocursor)
- [toDirty](DMenuBar.md#todirty)
- [toGlobal](DMenuBar.md#toglobal)
- [toHasDirty](DMenuBar.md#tohasdirty)
- [toHierarchyDirty](DMenuBar.md#tohierarchydirty)
- [toItem](DMenuBar.md#toitem)
- [toLocal](DMenuBar.md#tolocal)
- [toParentHasDirty](DMenuBar.md#toparenthasdirty)
- [toParentHierarchyDirty](DMenuBar.md#toparenthierarchydirty)
- [toParentResized](DMenuBar.md#toparentresized)
- [updateTransform](DMenuBar.md#updatetransform)
- [mixin](DMenuBar.md#mixin)

## Constructors

### constructor

• **new DMenuBar**<`VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeMenuBar`](../interfaces/DThemeMenuBar.md) = [`DThemeMenuBar`](../interfaces/DThemeMenuBar.md) |
| `OPTIONS` | extends [`DMenuBarOptions`](../interfaces/DMenuBarOptions.md)<`VALUE`, `THEME`, `OPTIONS`\> = [`DMenuBarOptions`](../interfaces/DMenuBarOptions.md)<`VALUE`, `THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DMenuBar`](DMenuBar.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[`DMenuBar`](DMenuBar.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DMenuBar`](DMenuBar.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DMenuBar`](DMenuBar.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-menu-bar.ts:68](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-menu-bar.ts#L68)
...
▸ **hide**(): [`DMenuBar`](DMenuBar.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-menu-bar.ts:36](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-menu-bar.ts#L36)
...
▸ **off**(`event`, `fn?`, `context?`): [`DMenuBar`](DMenuBar.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DMenuBar`](DMenuBar.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-menu-bar.ts:63](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-menu-bar.ts#L63)
...
▸ **once**(`event`, `fn`, `context?`): [`DMenuBar`](DMenuBar.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DMenuBar`](DMenuBar.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DMenuBar`](DMenuBar.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DMenuBar`](DMenuBar.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DMenuBar`](DMenuBar.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **toItem**(`item`): ``null`` \| `DisplayObject`

#### Parameters

| Name | Type |
| :------ | :------ |
| `item` | ``null`` \| `DisplayObject` \| [`DMenuBarItemSpaceOptions`](../interfaces/DMenuBarItemSpaceOptions.md)<[`DThemeMenuBarItemSpace`](../interfaces/DThemeMenuBarItemSpace.md)\> \| [`DMenuBarItemOptions`](../interfaces/DMenuBarItemOptions.md)<`VALUE`, [`DThemeMenuBarItem`](../interfaces/DThemeMenuBarItem.md)<`VALUE`\>\> |
...
[src/main/typescript/wcardinal/ui/d-menu-bar.ts:50](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-menu-bar.ts#L50)
