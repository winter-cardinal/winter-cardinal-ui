[Winter Cardinal UI - v0.407.0](../index.md) / DButtonCheckRight
...
- [\_boundsID](DButtonCheckRight.md#_boundsid)
- [\_boundsRect](DButtonCheckRight.md#_boundsrect)
...
- [\_enabledFilters](DButtonCheckRight.md#_enabledfilters)
- [\_image](DButtonCheckRight.md#_image)
...
- [\_localBounds](DButtonCheckRight.md#_localbounds)
- [\_localBoundsRect](DButtonCheckRight.md#_localboundsrect)
...
- [containerUpdateTransform](DButtonCheckRight.md#containerupdatetransform)
...
- [disableTempParent](DButtonCheckRight.md#disabletempparent)
- [displayObjectUpdateTransform](DButtonCheckRight.md#displayobjectupdatetransform)
- [emit](DButtonCheckRight.md#emit)
- [enableTempParent](DButtonCheckRight.md#enabletempparent)
...
- [getImage](DButtonCheckRight.md#getimage)
- [getLayouter](DButtonCheckRight.md#getlayouter)
...
- [getText](DButtonCheckRight.md#gettext)
...
- [newOverflowMask](DButtonCheckRight.md#newoverflowmask)
- [newPadding](DButtonCheckRight.md#newpadding)
- [newText](DButtonCheckRight.md#newtext)
...
- [onReflowTextAndImage](DButtonCheckRight.md#onreflowtextandimage)
...
• **new DButtonCheckRight**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DButtonCheckRight`](DButtonCheckRight.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-check-right.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-check-right.ts#L20)
...
[DButtonCheck](DButtonCheck.md).[newOverflowMask](DButtonCheck.md#newoverflowmask)
...
[DButtonCheck](DButtonCheck.md).[newPadding](DButtonCheck.md#newpadding)
...
[DButtonCheck](DButtonCheck.md).[newText](DButtonCheck.md#newtext)
...
[DButtonCheck](DButtonCheck.md).[onReflowTextAndImage](DButtonCheck.md#onreflowtextandimage)
...
▸ **setFocused**(`isFocused`): [`DButtonCheckRight`](DButtonCheckRight.md)\<`VALUE`, `THEME`, `OPTIONS`\>
