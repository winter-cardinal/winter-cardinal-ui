[Winter Cardinal UI - v0.154.0](../index.md) / DButtonSecondary
...
- [\_isChildrenDirty](DButtonSecondary.md#_ischildrendirty)
...
- [isChildrenDirty](DButtonSecondary.md#ischildrendirty)
...
- [onChildrenDirty](DButtonSecondary.md#onchildrendirty)
...
- [refit](DButtonSecondary.md#refit)
...
- [toChildrenDirty](DButtonSecondary.md#tochildrendirty)
...
[src/main/typescript/wcardinal/ui/d-button-secondary.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-button-secondary.ts#L20)
