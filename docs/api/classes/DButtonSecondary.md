[Winter Cardinal UI - v0.374.0](../index.md) / DButtonSecondary
...
- [newPadding](DButtonSecondary.md#newpadding)
- [newText](DButtonSecondary.md#newtext)
...
• **new DButtonSecondary**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DButtonSecondary`](DButtonSecondary.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DButtonSecondary`](DButtonSecondary.md)\<`VALUE`, `THEME`, `OPTIONS`\>
