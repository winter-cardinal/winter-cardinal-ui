[Winter Cardinal UI - v0.407.0](../index.md) / DDialogLayeredHeaderSeparator
...
- [\_boundsID](DDialogLayeredHeaderSeparator.md#_boundsid)
- [\_boundsRect](DDialogLayeredHeaderSeparator.md#_boundsrect)
...
- [\_enabledFilters](DDialogLayeredHeaderSeparator.md#_enabledfilters)
- [\_image](DDialogLayeredHeaderSeparator.md#_image)
...
- [\_localBounds](DDialogLayeredHeaderSeparator.md#_localbounds)
- [\_localBoundsRect](DDialogLayeredHeaderSeparator.md#_localboundsrect)
...
- [containerUpdateTransform](DDialogLayeredHeaderSeparator.md#containerupdatetransform)
...
- [disableTempParent](DDialogLayeredHeaderSeparator.md#disabletempparent)
...
- [enableTempParent](DDialogLayeredHeaderSeparator.md#enabletempparent)
...
- [getImage](DDialogLayeredHeaderSeparator.md#getimage)
- [getLayouter](DDialogLayeredHeaderSeparator.md#getlayouter)
...
- [getText](DDialogLayeredHeaderSeparator.md#gettext)
...
- [newOverflowMask](DDialogLayeredHeaderSeparator.md#newoverflowmask)
...
- [onReflowTextAndImage](DDialogLayeredHeaderSeparator.md#onreflowtextandimage)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header-separator.ts:19](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-layered-header-separator.ts#L19)
