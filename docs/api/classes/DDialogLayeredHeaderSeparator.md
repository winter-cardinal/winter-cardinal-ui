[Winter Cardinal UI - v0.310.1](../index.md) / DDialogLayeredHeaderSeparator

# Class: DDialogLayeredHeaderSeparator<THEME, OPTIONS\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeDialogLayeredHeaderSeparator`](../interfaces/DThemeDialogLayeredHeaderSeparator.md) = [`DThemeDialogLayeredHeaderSeparator`](../interfaces/DThemeDialogLayeredHeaderSeparator.md) |
| `OPTIONS` | extends [`DDialogLayeredHeaderSeparatorOptions`](../interfaces/DDialogLayeredHeaderSeparatorOptions.md)<`THEME`\> = [`DDialogLayeredHeaderSeparatorOptions`](../interfaces/DDialogLayeredHeaderSeparatorOptions.md)<`THEME`\> |

## Hierarchy

- [`DImageBase`](DImageBase.md)<`string`, `THEME`, `OPTIONS`\>

  ↳ **`DDialogLayeredHeaderSeparator`**

## Table of contents

### Constructors

- [constructor](DDialogLayeredHeaderSeparator.md#constructor)

### Properties

- [\_accessibleActive](DDialogLayeredHeaderSeparator.md#_accessibleactive)
- [\_accessibleDiv](DDialogLayeredHeaderSeparator.md#_accessiblediv)
- [\_auto](DDialogLayeredHeaderSeparator.md#_auto)
- [\_background](DDialogLayeredHeaderSeparator.md#_background)
- [\_border](DDialogLayeredHeaderSeparator.md#_border)
- [\_bounds](DDialogLayeredHeaderSeparator.md#_bounds)
- [\_clearType](DDialogLayeredHeaderSeparator.md#_cleartype)
- [\_corner](DDialogLayeredHeaderSeparator.md#_corner)
- [\_cursor](DDialogLayeredHeaderSeparator.md#_cursor)
- [\_destroyed](DDialogLayeredHeaderSeparator.md#_destroyed)
- [\_images](DDialogLayeredHeaderSeparator.md#_images)
- [\_isOverflowMaskEnabled](DDialogLayeredHeaderSeparator.md#_isoverflowmaskenabled)
- [\_isTextVisible](DDialogLayeredHeaderSeparator.md#_istextvisible)
- [\_lastDownPoint](DDialogLayeredHeaderSeparator.md#_lastdownpoint)
- [\_lastSortedIndex](DDialogLayeredHeaderSeparator.md#_lastsortedindex)
- [\_mask](DDialogLayeredHeaderSeparator.md#_mask)
- [\_options](DDialogLayeredHeaderSeparator.md#_options)
- [\_outline](DDialogLayeredHeaderSeparator.md#_outline)
- [\_overflowMask](DDialogLayeredHeaderSeparator.md#_overflowmask)
- [\_padding](DDialogLayeredHeaderSeparator.md#_padding)
- [\_reflowable](DDialogLayeredHeaderSeparator.md#_reflowable)
- [\_shortcuts](DDialogLayeredHeaderSeparator.md#_shortcuts)
- [\_snippet](DDialogLayeredHeaderSeparator.md#_snippet)
- [\_tempDisplayObjectParent](DDialogLayeredHeaderSeparator.md#_tempdisplayobjectparent)
- [\_text](DDialogLayeredHeaderSeparator.md#_text)
- [\_textAlign](DDialogLayeredHeaderSeparator.md#_textalign)
- [\_textAlpha](DDialogLayeredHeaderSeparator.md#_textalpha)
- [\_textColor](DDialogLayeredHeaderSeparator.md#_textcolor)
- [\_textFormatter](DDialogLayeredHeaderSeparator.md#_textformatter)
- [\_textStyle](DDialogLayeredHeaderSeparator.md#_textstyle)
- [\_textValue](DDialogLayeredHeaderSeparator.md#_textvalue)
- [\_textValueComputed](DDialogLayeredHeaderSeparator.md#_textvaluecomputed)
- [\_title](DDialogLayeredHeaderSeparator.md#_title)
- [\_zIndex](DDialogLayeredHeaderSeparator.md#_zindex)
- [accessible](DDialogLayeredHeaderSeparator.md#accessible)
- [accessibleChildren](DDialogLayeredHeaderSeparator.md#accessiblechildren)
- [accessibleHint](DDialogLayeredHeaderSeparator.md#accessiblehint)
- [accessiblePointerEvents](DDialogLayeredHeaderSeparator.md#accessiblepointerevents)
- [accessibleTitle](DDialogLayeredHeaderSeparator.md#accessibletitle)
- [accessibleType](DDialogLayeredHeaderSeparator.md#accessibletype)
- [alpha](DDialogLayeredHeaderSeparator.md#alpha)
- [angle](DDialogLayeredHeaderSeparator.md#angle)
- [buttonMode](DDialogLayeredHeaderSeparator.md#buttonmode)
- [cacheAsBitmap](DDialogLayeredHeaderSeparator.md#cacheasbitmap)
- [children](DDialogLayeredHeaderSeparator.md#children)
- [cursor](DDialogLayeredHeaderSeparator.md#cursor)
- [filterArea](DDialogLayeredHeaderSeparator.md#filterarea)
- [filters](DDialogLayeredHeaderSeparator.md#filters)
- [hitArea](DDialogLayeredHeaderSeparator.md#hitarea)
- [interactive](DDialogLayeredHeaderSeparator.md#interactive)
- [interactiveChildren](DDialogLayeredHeaderSeparator.md#interactivechildren)
- [isMask](DDialogLayeredHeaderSeparator.md#ismask)
- [isSprite](DDialogLayeredHeaderSeparator.md#issprite)
- [localTransform](DDialogLayeredHeaderSeparator.md#localtransform)
- [mask](DDialogLayeredHeaderSeparator.md#mask)
- [name](DDialogLayeredHeaderSeparator.md#name)
- [parent](DDialogLayeredHeaderSeparator.md#parent)
- [pivot](DDialogLayeredHeaderSeparator.md#pivot)
- [renderable](DDialogLayeredHeaderSeparator.md#renderable)
- [rotation](DDialogLayeredHeaderSeparator.md#rotation)
- [sortDirty](DDialogLayeredHeaderSeparator.md#sortdirty)
- [sortableChildren](DDialogLayeredHeaderSeparator.md#sortablechildren)
- [transform](DDialogLayeredHeaderSeparator.md#transform)
- [visible](DDialogLayeredHeaderSeparator.md#visible)
- [worldAlpha](DDialogLayeredHeaderSeparator.md#worldalpha)
- [worldTransform](DDialogLayeredHeaderSeparator.md#worldtransform)
- [worldVisible](DDialogLayeredHeaderSeparator.md#worldvisible)
- [zIndex](DDialogLayeredHeaderSeparator.md#zindex)
- [LAYOUTER](DDialogLayeredHeaderSeparator.md#layouter)
- [WORK\_CONTAINS\_POINT](DDialogLayeredHeaderSeparator.md#work_contains_point)

### Accessors

- [background](DDialogLayeredHeaderSeparator.md#background)
- [border](DDialogLayeredHeaderSeparator.md#border)
- [corner](DDialogLayeredHeaderSeparator.md#corner)
- [height](DDialogLayeredHeaderSeparator.md#height)
- [image](DDialogLayeredHeaderSeparator.md#image)
- [options](DDialogLayeredHeaderSeparator.md#options)
- [outline](DDialogLayeredHeaderSeparator.md#outline)
- [padding](DDialogLayeredHeaderSeparator.md#padding)
- [position](DDialogLayeredHeaderSeparator.md#position)
- [reflowable](DDialogLayeredHeaderSeparator.md#reflowable)
- [scale](DDialogLayeredHeaderSeparator.md#scale)
- [shadow](DDialogLayeredHeaderSeparator.md#shadow)
- [skew](DDialogLayeredHeaderSeparator.md#skew)
- [snippet](DDialogLayeredHeaderSeparator.md#snippet)
- [state](DDialogLayeredHeaderSeparator.md#state)
- [text](DDialogLayeredHeaderSeparator.md#text)
- [theme](DDialogLayeredHeaderSeparator.md#theme)
- [title](DDialogLayeredHeaderSeparator.md#title)
- [type](DDialogLayeredHeaderSeparator.md#type)
- [unsafe](DDialogLayeredHeaderSeparator.md#unsafe)
- [weight](DDialogLayeredHeaderSeparator.md#weight)
- [width](DDialogLayeredHeaderSeparator.md#width)
- [x](DDialogLayeredHeaderSeparator.md#x)
- [y](DDialogLayeredHeaderSeparator.md#y)

### Methods

- [\_calculateBounds](DDialogLayeredHeaderSeparator.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DDialogLayeredHeaderSeparator.md#_recursivepostupdatetransform)
- [\_render](DDialogLayeredHeaderSeparator.md#_render)
- [addChild](DDialogLayeredHeaderSeparator.md#addchild)
- [addChildAt](DDialogLayeredHeaderSeparator.md#addchildat)
- [addListener](DDialogLayeredHeaderSeparator.md#addlistener)
- [applyTitle](DDialogLayeredHeaderSeparator.md#applytitle)
- [blur](DDialogLayeredHeaderSeparator.md#blur)
- [calculateBounds](DDialogLayeredHeaderSeparator.md#calculatebounds)
- [computeTextValue](DDialogLayeredHeaderSeparator.md#computetextvalue)
- [containsGlobalPoint](DDialogLayeredHeaderSeparator.md#containsglobalpoint)
- [containsLocalPoint](DDialogLayeredHeaderSeparator.md#containslocalpoint)
- [containsPoint](DDialogLayeredHeaderSeparator.md#containspoint)
- [createOrUpdateText](DDialogLayeredHeaderSeparator.md#createorupdatetext)
- [createText](DDialogLayeredHeaderSeparator.md#createtext)
- [destroy](DDialogLayeredHeaderSeparator.md#destroy)
- [displayObjectUpdateTransform](DDialogLayeredHeaderSeparator.md#displayobjectupdatetransform)
- [emit](DDialogLayeredHeaderSeparator.md#emit)
- [eventNames](DDialogLayeredHeaderSeparator.md#eventnames)
- [focus](DDialogLayeredHeaderSeparator.md#focus)
- [focusOnClosest](DDialogLayeredHeaderSeparator.md#focusonclosest)
- [getBounds](DDialogLayeredHeaderSeparator.md#getbounds)
- [getChildAt](DDialogLayeredHeaderSeparator.md#getchildat)
- [getChildByName](DDialogLayeredHeaderSeparator.md#getchildbyname)
- [getChildIndex](DDialogLayeredHeaderSeparator.md#getchildindex)
- [getClearType](DDialogLayeredHeaderSeparator.md#getcleartype)
- [getClippingRect](DDialogLayeredHeaderSeparator.md#getclippingrect)
- [getGlobalPosition](DDialogLayeredHeaderSeparator.md#getglobalposition)
- [getHeight](DDialogLayeredHeaderSeparator.md#getheight)
- [getLocalBounds](DDialogLayeredHeaderSeparator.md#getlocalbounds)
- [getOverflowMask](DDialogLayeredHeaderSeparator.md#getoverflowmask)
- [getParentOfSize](DDialogLayeredHeaderSeparator.md#getparentofsize)
- [getTextAlpha](DDialogLayeredHeaderSeparator.md#gettextalpha)
- [getTextColor](DDialogLayeredHeaderSeparator.md#gettextcolor)
- [getThemeDefault](DDialogLayeredHeaderSeparator.md#getthemedefault)
- [getType](DDialogLayeredHeaderSeparator.md#gettype)
- [getWidth](DDialogLayeredHeaderSeparator.md#getwidth)
- [getX](DDialogLayeredHeaderSeparator.md#getx)
- [getY](DDialogLayeredHeaderSeparator.md#gety)
- [hasDirty](DDialogLayeredHeaderSeparator.md#hasdirty)
- [hasRefitableHeight](DDialogLayeredHeaderSeparator.md#hasrefitableheight)
- [hasRefitableWidth](DDialogLayeredHeaderSeparator.md#hasrefitablewidth)
- [hide](DDialogLayeredHeaderSeparator.md#hide)
- [hideText](DDialogLayeredHeaderSeparator.md#hidetext)
- [init](DDialogLayeredHeaderSeparator.md#init)
- [initReflowable](DDialogLayeredHeaderSeparator.md#initreflowable)
- [isDirty](DDialogLayeredHeaderSeparator.md#isdirty)
- [isEventTarget](DDialogLayeredHeaderSeparator.md#iseventtarget)
- [isHidden](DDialogLayeredHeaderSeparator.md#ishidden)
- [isHierarchyDirty](DDialogLayeredHeaderSeparator.md#ishierarchydirty)
- [isRefitable](DDialogLayeredHeaderSeparator.md#isrefitable)
- [isShown](DDialogLayeredHeaderSeparator.md#isshown)
- [listenerCount](DDialogLayeredHeaderSeparator.md#listenercount)
- [listeners](DDialogLayeredHeaderSeparator.md#listeners)
- [newImage](DDialogLayeredHeaderSeparator.md#newimage)
- [newImages](DDialogLayeredHeaderSeparator.md#newimages)
- [off](DDialogLayeredHeaderSeparator.md#off)
- [on](DDialogLayeredHeaderSeparator.md#on)
- [onBlur](DDialogLayeredHeaderSeparator.md#onblur)
- [onChildBlur](DDialogLayeredHeaderSeparator.md#onchildblur)
- [onChildFocus](DDialogLayeredHeaderSeparator.md#onchildfocus)
- [onChildrenChange](DDialogLayeredHeaderSeparator.md#onchildrenchange)
- [onDblClick](DDialogLayeredHeaderSeparator.md#ondblclick)
- [onDown](DDialogLayeredHeaderSeparator.md#ondown)
- [onDownThis](DDialogLayeredHeaderSeparator.md#ondownthis)
- [onFocus](DDialogLayeredHeaderSeparator.md#onfocus)
- [onHierarchyDirty](DDialogLayeredHeaderSeparator.md#onhierarchydirty)
- [onKeyDown](DDialogLayeredHeaderSeparator.md#onkeydown)
- [onKeyUp](DDialogLayeredHeaderSeparator.md#onkeyup)
- [onMove](DDialogLayeredHeaderSeparator.md#onmove)
- [onOut](DDialogLayeredHeaderSeparator.md#onout)
- [onOver](DDialogLayeredHeaderSeparator.md#onover)
- [onParentMove](DDialogLayeredHeaderSeparator.md#onparentmove)
- [onParentResize](DDialogLayeredHeaderSeparator.md#onparentresize)
- [onRefit](DDialogLayeredHeaderSeparator.md#onrefit)
- [onReflow](DDialogLayeredHeaderSeparator.md#onreflow)
- [onResize](DDialogLayeredHeaderSeparator.md#onresize)
- [onScale](DDialogLayeredHeaderSeparator.md#onscale)
- [onShortcut](DDialogLayeredHeaderSeparator.md#onshortcut)
- [onSkew](DDialogLayeredHeaderSeparator.md#onskew)
- [onStateChange](DDialogLayeredHeaderSeparator.md#onstatechange)
- [onTextChange](DDialogLayeredHeaderSeparator.md#ontextchange)
- [onUp](DDialogLayeredHeaderSeparator.md#onup)
- [onUpThis](DDialogLayeredHeaderSeparator.md#onupthis)
- [onWheel](DDialogLayeredHeaderSeparator.md#onwheel)
- [once](DDialogLayeredHeaderSeparator.md#once)
- [reflow](DDialogLayeredHeaderSeparator.md#reflow)
- [removeAllListeners](DDialogLayeredHeaderSeparator.md#removealllisteners)
- [removeChild](DDialogLayeredHeaderSeparator.md#removechild)
- [removeChildAt](DDialogLayeredHeaderSeparator.md#removechildat)
- [removeChildren](DDialogLayeredHeaderSeparator.md#removechildren)
- [removeListener](DDialogLayeredHeaderSeparator.md#removelistener)
- [render](DDialogLayeredHeaderSeparator.md#render)
- [renderAdvanced](DDialogLayeredHeaderSeparator.md#renderadvanced)
- [resize](DDialogLayeredHeaderSeparator.md#resize)
- [setChildIndex](DDialogLayeredHeaderSeparator.md#setchildindex)
- [setFocused](DDialogLayeredHeaderSeparator.md#setfocused)
- [setHeight](DDialogLayeredHeaderSeparator.md#setheight)
- [setParent](DDialogLayeredHeaderSeparator.md#setparent)
- [setTransform](DDialogLayeredHeaderSeparator.md#settransform)
- [setWidth](DDialogLayeredHeaderSeparator.md#setwidth)
- [setX](DDialogLayeredHeaderSeparator.md#setx)
- [setY](DDialogLayeredHeaderSeparator.md#sety)
- [show](DDialogLayeredHeaderSeparator.md#show)
- [showText](DDialogLayeredHeaderSeparator.md#showtext)
- [sortChildren](DDialogLayeredHeaderSeparator.md#sortchildren)
- [swapChildren](DDialogLayeredHeaderSeparator.md#swapchildren)
- [toCursor](DDialogLayeredHeaderSeparator.md#tocursor)
- [toDirty](DDialogLayeredHeaderSeparator.md#todirty)
- [toGlobal](DDialogLayeredHeaderSeparator.md#toglobal)
- [toHasDirty](DDialogLayeredHeaderSeparator.md#tohasdirty)
- [toHierarchyDirty](DDialogLayeredHeaderSeparator.md#tohierarchydirty)
- [toImageOptions](DDialogLayeredHeaderSeparator.md#toimageoptions)
- [toLocal](DDialogLayeredHeaderSeparator.md#tolocal)
- [toParentHasDirty](DDialogLayeredHeaderSeparator.md#toparenthasdirty)
- [toParentHierarchyDirty](DDialogLayeredHeaderSeparator.md#toparenthierarchydirty)
- [toParentResized](DDialogLayeredHeaderSeparator.md#toparentresized)
- [updateText](DDialogLayeredHeaderSeparator.md#updatetext)
- [updateTextAndImage](DDialogLayeredHeaderSeparator.md#updatetextandimage)
- [updateTextColor](DDialogLayeredHeaderSeparator.md#updatetextcolor)
- [updateTextPosition](DDialogLayeredHeaderSeparator.md#updatetextposition)
- [updateTextValue](DDialogLayeredHeaderSeparator.md#updatetextvalue)
- [updateTransform](DDialogLayeredHeaderSeparator.md#updatetransform)
- [mixin](DDialogLayeredHeaderSeparator.md#mixin)

## Constructors

### constructor

• **new DDialogLayeredHeaderSeparator**<`THEME`, `OPTIONS`\>(`options?`)

#### Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeDialogLayeredHeaderSeparator`](../interfaces/DThemeDialogLayeredHeaderSeparator.md)<`THEME`\> = [`DThemeDialogLayeredHeaderSeparator`](../interfaces/DThemeDialogLayeredHeaderSeparator.md) |
| `OPTIONS` | extends [`DDialogLayeredHeaderSeparatorOptions`](../interfaces/DDialogLayeredHeaderSeparatorOptions.md)<`THEME`, `OPTIONS`\> = [`DDialogLayeredHeaderSeparatorOptions`](../interfaces/DDialogLayeredHeaderSeparatorOptions.md)<`THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<`THEME`, `OPTIONS`\>
...
[`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header-separator.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-layered-header-separator.ts#L18)
...
▸ **hide**(): [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<`THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<`THEME`, `OPTIONS`\>
