[Winter Cardinal UI - v0.374.0](../index.md) / DDialogLayeredHeaderSeparator
...
- [newPadding](DDialogLayeredHeaderSeparator.md#newpadding)
- [newText](DDialogLayeredHeaderSeparator.md#newtext)
...
• **new DDialogLayeredHeaderSeparator**\<`THEME`, `OPTIONS`\>(`options?`): [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)\<`THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)\<`THEME`, `OPTIONS`\>
