[Winter Cardinal UI - v0.414.0](../index.md) / FormatNodee
...
[src/main/typescript/wcardinal/ui/util/format-node/format-node-e.ts:9](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/util/format-node/format-node-e.ts#L9)
