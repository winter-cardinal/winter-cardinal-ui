[Winter Cardinal UI - v0.155.0](../index.md) / DMenuItemExpandableBody
...
- [\_isChildrenDirty](DMenuItemExpandableBody.md#_ischildrendirty)
...
- [isChildrenDirty](DMenuItemExpandableBody.md#ischildrendirty)
...
- [onChildrenDirty](DMenuItemExpandableBody.md#onchildrendirty)
...
- [refit](DMenuItemExpandableBody.md#refit)
...
- [toChildrenDirty](DMenuItemExpandableBody.md#tochildrendirty)
...
- [toParentChildrenDirty](DMenuItemExpandableBody.md#toparentchildrendirty)
...
[src/main/typescript/wcardinal/ui/d-menu-item-expandable-body.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-menu-item-expandable-body.ts#L18)
