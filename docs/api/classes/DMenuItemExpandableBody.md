[Winter Cardinal UI - v0.407.0](../index.md) / DMenuItemExpandableBody
...
[src/main/typescript/wcardinal/ui/d-menu-item-expandable-body.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-item-expandable-body.ts#L18)
...
▸ **setFocused**(`isFocused`): [`DMenuItemExpandableBody`](DMenuItemExpandableBody.md)\<`THEME`, `OPTIONS`\>
