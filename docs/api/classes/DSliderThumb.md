[Winter Cardinal UI - v0.374.0](../index.md) / DSliderThumb
...
- [newPadding](DSliderThumb.md#newpadding)
- [newText](DSliderThumb.md#newtext)
...
• **new DSliderThumb**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DSliderThumb`](DSliderThumb.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DSliderThumb`](DSliderThumb.md)\<`VALUE`, `THEME`, `OPTIONS`\>
