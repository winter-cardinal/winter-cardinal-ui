[Winter Cardinal UI - v0.407.0](../index.md) / DSliderThumb
...
- [\_boundsID](DSliderThumb.md#_boundsid)
- [\_boundsRect](DSliderThumb.md#_boundsrect)
...
- [\_enabledFilters](DSliderThumb.md#_enabledfilters)
- [\_image](DSliderThumb.md#_image)
...
- [\_localBounds](DSliderThumb.md#_localbounds)
- [\_localBoundsRect](DSliderThumb.md#_localboundsrect)
...
- [containerUpdateTransform](DSliderThumb.md#containerupdatetransform)
...
- [disableTempParent](DSliderThumb.md#disabletempparent)
- [displayObjectUpdateTransform](DSliderThumb.md#displayobjectupdatetransform)
- [emit](DSliderThumb.md#emit)
- [enableTempParent](DSliderThumb.md#enabletempparent)
...
- [getImage](DSliderThumb.md#getimage)
- [getLayouter](DSliderThumb.md#getlayouter)
...
- [getText](DSliderThumb.md#gettext)
...
- [newOverflowMask](DSliderThumb.md#newoverflowmask)
...
- [onReflowTextAndImage](DSliderThumb.md#onreflowtextandimage)
...
[src/main/typescript/wcardinal/ui/d-slider-thumb.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-slider-thumb.ts#L20)
