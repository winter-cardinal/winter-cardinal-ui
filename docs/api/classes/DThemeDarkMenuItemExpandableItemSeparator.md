[Winter Cardinal UI - v0.167.0](../index.md) / DThemeDarkMenuItemExpandableItemSeparator
...
- [getOutlineWidth](DThemeDarkMenuItemExpandableItemSeparator.md#getoutlinewidth)
...
• **new DThemeDarkMenuItemExpandableItemSeparator**()
