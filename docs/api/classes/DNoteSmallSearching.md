[Winter Cardinal UI - v0.374.0](../index.md) / DNoteSmallSearching
...
- [newPadding](DNoteSmallSearching.md#newpadding)
- [newText](DNoteSmallSearching.md#newtext)
...
• **new DNoteSmallSearching**\<`THEME`, `OPTIONS`\>(`options?`): [`DNoteSmallSearching`](DNoteSmallSearching.md)\<`THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DNoteSmallSearching`](DNoteSmallSearching.md)\<`THEME`, `OPTIONS`\>
