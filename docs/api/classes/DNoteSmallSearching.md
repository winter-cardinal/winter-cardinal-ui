[Winter Cardinal UI - v0.167.0](../index.md) / DNoteSmallSearching

# Class: DNoteSmallSearching<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeNoteSmallSearching`](../interfaces/DThemeNoteSmallSearching.md) = [`DThemeNoteSmallSearching`](../interfaces/DThemeNoteSmallSearching.md) |
| `OPTIONS` | extends [`DNoteSmallSearchingOptions`](../interfaces/DNoteSmallSearchingOptions.md)<`THEME`\> = [`DNoteSmallSearchingOptions`](../interfaces/DNoteSmallSearchingOptions.md)<`THEME`\> |
...
- [constructor](DNoteSmallSearching.md#constructor)

### Properties

- [\_accessibleActive](DNoteSmallSearching.md#_accessibleactive)
- [\_accessibleDiv](DNoteSmallSearching.md#_accessiblediv)
- [\_auto](DNoteSmallSearching.md#_auto)
- [\_background](DNoteSmallSearching.md#_background)
- [\_border](DNoteSmallSearching.md#_border)
- [\_bounds](DNoteSmallSearching.md#_bounds)
- [\_clearType](DNoteSmallSearching.md#_cleartype)
- [\_corner](DNoteSmallSearching.md#_corner)
- [\_cursor](DNoteSmallSearching.md#_cursor)
- [\_destroyed](DNoteSmallSearching.md#_destroyed)
- [\_images](DNoteSmallSearching.md#_images)
- [\_isOverflowMaskEnabled](DNoteSmallSearching.md#_isoverflowmaskenabled)
- [\_isTextVisible](DNoteSmallSearching.md#_istextvisible)
- [\_lastDownPoint](DNoteSmallSearching.md#_lastdownpoint)
- [\_lastSortedIndex](DNoteSmallSearching.md#_lastsortedindex)
- [\_mask](DNoteSmallSearching.md#_mask)
- [\_options](DNoteSmallSearching.md#_options)
- [\_outline](DNoteSmallSearching.md#_outline)
- [\_overflowMask](DNoteSmallSearching.md#_overflowmask)
- [\_padding](DNoteSmallSearching.md#_padding)
- [\_reflowable](DNoteSmallSearching.md#_reflowable)
- [\_shortcuts](DNoteSmallSearching.md#_shortcuts)
- [\_snippet](DNoteSmallSearching.md#_snippet)
- [\_tempDisplayObjectParent](DNoteSmallSearching.md#_tempdisplayobjectparent)
- [\_text](DNoteSmallSearching.md#_text)
- [\_textAlign](DNoteSmallSearching.md#_textalign)
- [\_textAlpha](DNoteSmallSearching.md#_textalpha)
- [\_textColor](DNoteSmallSearching.md#_textcolor)
- [\_textFormatter](DNoteSmallSearching.md#_textformatter)
- [\_textStyle](DNoteSmallSearching.md#_textstyle)
- [\_textValue](DNoteSmallSearching.md#_textvalue)
- [\_textValueComputed](DNoteSmallSearching.md#_textvaluecomputed)
- [\_title](DNoteSmallSearching.md#_title)
- [\_zIndex](DNoteSmallSearching.md#_zindex)
- [accessible](DNoteSmallSearching.md#accessible)
- [accessibleChildren](DNoteSmallSearching.md#accessiblechildren)
- [accessibleHint](DNoteSmallSearching.md#accessiblehint)
- [accessiblePointerEvents](DNoteSmallSearching.md#accessiblepointerevents)
- [accessibleTitle](DNoteSmallSearching.md#accessibletitle)
- [accessibleType](DNoteSmallSearching.md#accessibletype)
- [alpha](DNoteSmallSearching.md#alpha)
- [angle](DNoteSmallSearching.md#angle)
- [buttonMode](DNoteSmallSearching.md#buttonmode)
- [cacheAsBitmap](DNoteSmallSearching.md#cacheasbitmap)
- [children](DNoteSmallSearching.md#children)
- [cursor](DNoteSmallSearching.md#cursor)
- [filterArea](DNoteSmallSearching.md#filterarea)
- [filters](DNoteSmallSearching.md#filters)
- [hitArea](DNoteSmallSearching.md#hitarea)
- [interactive](DNoteSmallSearching.md#interactive)
- [interactiveChildren](DNoteSmallSearching.md#interactivechildren)
- [isMask](DNoteSmallSearching.md#ismask)
- [isSprite](DNoteSmallSearching.md#issprite)
- [localTransform](DNoteSmallSearching.md#localtransform)
- [mask](DNoteSmallSearching.md#mask)
- [name](DNoteSmallSearching.md#name)
- [parent](DNoteSmallSearching.md#parent)
- [pivot](DNoteSmallSearching.md#pivot)
- [renderable](DNoteSmallSearching.md#renderable)
- [rotation](DNoteSmallSearching.md#rotation)
- [sortDirty](DNoteSmallSearching.md#sortdirty)
- [sortableChildren](DNoteSmallSearching.md#sortablechildren)
- [transform](DNoteSmallSearching.md#transform)
- [visible](DNoteSmallSearching.md#visible)
- [worldAlpha](DNoteSmallSearching.md#worldalpha)
- [worldTransform](DNoteSmallSearching.md#worldtransform)
- [worldVisible](DNoteSmallSearching.md#worldvisible)
- [zIndex](DNoteSmallSearching.md#zindex)
- [LAYOUTER](DNoteSmallSearching.md#layouter)
- [WORK\_CONTAINS\_POINT](DNoteSmallSearching.md#work_contains_point)

### Accessors

- [background](DNoteSmallSearching.md#background)
- [border](DNoteSmallSearching.md#border)
- [corner](DNoteSmallSearching.md#corner)
- [height](DNoteSmallSearching.md#height)
- [image](DNoteSmallSearching.md#image)
- [outline](DNoteSmallSearching.md#outline)
- [padding](DNoteSmallSearching.md#padding)
- [position](DNoteSmallSearching.md#position)
- [reflowable](DNoteSmallSearching.md#reflowable)
- [scale](DNoteSmallSearching.md#scale)
- [shadow](DNoteSmallSearching.md#shadow)
- [skew](DNoteSmallSearching.md#skew)
- [snippet](DNoteSmallSearching.md#snippet)
- [state](DNoteSmallSearching.md#state)
- [text](DNoteSmallSearching.md#text)
- [theme](DNoteSmallSearching.md#theme)
- [title](DNoteSmallSearching.md#title)
- [type](DNoteSmallSearching.md#type)
- [unsafe](DNoteSmallSearching.md#unsafe)
- [weight](DNoteSmallSearching.md#weight)
- [width](DNoteSmallSearching.md#width)
- [x](DNoteSmallSearching.md#x)
- [y](DNoteSmallSearching.md#y)

### Methods

- [\_calculateBounds](DNoteSmallSearching.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DNoteSmallSearching.md#_recursivepostupdatetransform)
- [\_render](DNoteSmallSearching.md#_render)
- [addChild](DNoteSmallSearching.md#addchild)
- [addChildAt](DNoteSmallSearching.md#addchildat)
- [addListener](DNoteSmallSearching.md#addlistener)
- [applyTitle](DNoteSmallSearching.md#applytitle)
- [blur](DNoteSmallSearching.md#blur)
- [calculateBounds](DNoteSmallSearching.md#calculatebounds)
- [computeTextValue](DNoteSmallSearching.md#computetextvalue)
- [containsGlobalPoint](DNoteSmallSearching.md#containsglobalpoint)
- [containsLocalPoint](DNoteSmallSearching.md#containslocalpoint)
- [containsPoint](DNoteSmallSearching.md#containspoint)
- [createOrUpdateText](DNoteSmallSearching.md#createorupdatetext)
- [createText](DNoteSmallSearching.md#createtext)
- [destroy](DNoteSmallSearching.md#destroy)
- [displayObjectUpdateTransform](DNoteSmallSearching.md#displayobjectupdatetransform)
- [emit](DNoteSmallSearching.md#emit)
- [eventNames](DNoteSmallSearching.md#eventnames)
- [focus](DNoteSmallSearching.md#focus)
- [focusOnClosest](DNoteSmallSearching.md#focusonclosest)
- [getBounds](DNoteSmallSearching.md#getbounds)
- [getChildAt](DNoteSmallSearching.md#getchildat)
- [getChildByName](DNoteSmallSearching.md#getchildbyname)
- [getChildIndex](DNoteSmallSearching.md#getchildindex)
- [getClearType](DNoteSmallSearching.md#getcleartype)
- [getClippingRect](DNoteSmallSearching.md#getclippingrect)
- [getGlobalPosition](DNoteSmallSearching.md#getglobalposition)
- [getHeight](DNoteSmallSearching.md#getheight)
- [getLocalBounds](DNoteSmallSearching.md#getlocalbounds)
- [getOverflowMask](DNoteSmallSearching.md#getoverflowmask)
- [getParentOfSize](DNoteSmallSearching.md#getparentofsize)
- [getTextAlpha](DNoteSmallSearching.md#gettextalpha)
- [getTextColor](DNoteSmallSearching.md#gettextcolor)
- [getThemeDefault](DNoteSmallSearching.md#getthemedefault)
- [getType](DNoteSmallSearching.md#gettype)
- [getWidth](DNoteSmallSearching.md#getwidth)
- [getX](DNoteSmallSearching.md#getx)
- [getY](DNoteSmallSearching.md#gety)
- [hasDirty](DNoteSmallSearching.md#hasdirty)
- [hasRefitableHeight](DNoteSmallSearching.md#hasrefitableheight)
- [hasRefitableWidth](DNoteSmallSearching.md#hasrefitablewidth)
- [hide](DNoteSmallSearching.md#hide)
- [hideText](DNoteSmallSearching.md#hidetext)
- [init](DNoteSmallSearching.md#init)
- [initReflowable](DNoteSmallSearching.md#initreflowable)
- [isDirty](DNoteSmallSearching.md#isdirty)
- [isEventTarget](DNoteSmallSearching.md#iseventtarget)
- [isHidden](DNoteSmallSearching.md#ishidden)
- [isHierarchyDirty](DNoteSmallSearching.md#ishierarchydirty)
- [isRefitable](DNoteSmallSearching.md#isrefitable)
- [isShown](DNoteSmallSearching.md#isshown)
- [listenerCount](DNoteSmallSearching.md#listenercount)
- [listeners](DNoteSmallSearching.md#listeners)
- [newImage](DNoteSmallSearching.md#newimage)
- [newImages](DNoteSmallSearching.md#newimages)
- [off](DNoteSmallSearching.md#off)
- [on](DNoteSmallSearching.md#on)
- [onBlur](DNoteSmallSearching.md#onblur)
- [onChildBlur](DNoteSmallSearching.md#onchildblur)
- [onChildFocus](DNoteSmallSearching.md#onchildfocus)
- [onChildrenChange](DNoteSmallSearching.md#onchildrenchange)
- [onDblClick](DNoteSmallSearching.md#ondblclick)
- [onDown](DNoteSmallSearching.md#ondown)
- [onDownThis](DNoteSmallSearching.md#ondownthis)
- [onFocus](DNoteSmallSearching.md#onfocus)
- [onHierarchyDirty](DNoteSmallSearching.md#onhierarchydirty)
- [onKeyDown](DNoteSmallSearching.md#onkeydown)
- [onKeyUp](DNoteSmallSearching.md#onkeyup)
- [onMove](DNoteSmallSearching.md#onmove)
- [onOut](DNoteSmallSearching.md#onout)
- [onOver](DNoteSmallSearching.md#onover)
- [onParentMove](DNoteSmallSearching.md#onparentmove)
- [onParentResize](DNoteSmallSearching.md#onparentresize)
- [onRefit](DNoteSmallSearching.md#onrefit)
- [onReflow](DNoteSmallSearching.md#onreflow)
- [onResize](DNoteSmallSearching.md#onresize)
- [onScale](DNoteSmallSearching.md#onscale)
- [onShortcut](DNoteSmallSearching.md#onshortcut)
- [onSkew](DNoteSmallSearching.md#onskew)
- [onStateChange](DNoteSmallSearching.md#onstatechange)
- [onTextChange](DNoteSmallSearching.md#ontextchange)
- [onUp](DNoteSmallSearching.md#onup)
- [onUpThis](DNoteSmallSearching.md#onupthis)
- [onWheel](DNoteSmallSearching.md#onwheel)
- [once](DNoteSmallSearching.md#once)
- [reflow](DNoteSmallSearching.md#reflow)
- [removeAllListeners](DNoteSmallSearching.md#removealllisteners)
- [removeChild](DNoteSmallSearching.md#removechild)
- [removeChildAt](DNoteSmallSearching.md#removechildat)
- [removeChildren](DNoteSmallSearching.md#removechildren)
- [removeListener](DNoteSmallSearching.md#removelistener)
- [render](DNoteSmallSearching.md#render)
- [renderAdvanced](DNoteSmallSearching.md#renderadvanced)
- [resize](DNoteSmallSearching.md#resize)
- [setChildIndex](DNoteSmallSearching.md#setchildindex)
- [setFocused](DNoteSmallSearching.md#setfocused)
- [setHeight](DNoteSmallSearching.md#setheight)
- [setParent](DNoteSmallSearching.md#setparent)
- [setTransform](DNoteSmallSearching.md#settransform)
- [setWidth](DNoteSmallSearching.md#setwidth)
- [setX](DNoteSmallSearching.md#setx)
- [setY](DNoteSmallSearching.md#sety)
- [show](DNoteSmallSearching.md#show)
- [showText](DNoteSmallSearching.md#showtext)
- [sortChildren](DNoteSmallSearching.md#sortchildren)
- [swapChildren](DNoteSmallSearching.md#swapchildren)
- [toCursor](DNoteSmallSearching.md#tocursor)
- [toDirty](DNoteSmallSearching.md#todirty)
- [toGlobal](DNoteSmallSearching.md#toglobal)
- [toHasDirty](DNoteSmallSearching.md#tohasdirty)
- [toHierarchyDirty](DNoteSmallSearching.md#tohierarchydirty)
- [toImageOptions](DNoteSmallSearching.md#toimageoptions)
- [toLocal](DNoteSmallSearching.md#tolocal)
- [toParentHasDirty](DNoteSmallSearching.md#toparenthasdirty)
- [toParentHierarchyDirty](DNoteSmallSearching.md#toparenthierarchydirty)
- [toParentResized](DNoteSmallSearching.md#toparentresized)
- [updateText](DNoteSmallSearching.md#updatetext)
- [updateTextAndImage](DNoteSmallSearching.md#updatetextandimage)
- [updateTextColor](DNoteSmallSearching.md#updatetextcolor)
- [updateTextPosition](DNoteSmallSearching.md#updatetextposition)
- [updateTextValue](DNoteSmallSearching.md#updatetextvalue)
- [updateTransform](DNoteSmallSearching.md#updatetransform)
- [mixin](DNoteSmallSearching.md#mixin)

## Constructors

### constructor

• **new DNoteSmallSearching**<`THEME`, `OPTIONS`\>(`options?`)

#### Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeNoteSmallSearching`](../interfaces/DThemeNoteSmallSearching.md)<`THEME`\> = [`DThemeNoteSmallSearching`](../interfaces/DThemeNoteSmallSearching.md) |
| `OPTIONS` | extends [`DNoteSmallSearchingOptions`](../interfaces/DNoteSmallSearchingOptions.md)<`THEME`, `OPTIONS`\> = [`DNoteSmallSearchingOptions`](../interfaces/DNoteSmallSearchingOptions.md)<`THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DNoteSmallSearching`](DNoteSmallSearching.md)<`THEME`, `OPTIONS`\>
...
[`DNoteSmallSearching`](DNoteSmallSearching.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DNoteSmallSearching`](DNoteSmallSearching.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DNoteSmallSearching`](DNoteSmallSearching.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-note-small-searching.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-note-small-searching.ts#L18)
...
▸ **hide**(): [`DNoteSmallSearching`](DNoteSmallSearching.md)<`THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DNoteSmallSearching`](DNoteSmallSearching.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DNoteSmallSearching`](DNoteSmallSearching.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DNoteSmallSearching`](DNoteSmallSearching.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DNoteSmallSearching`](DNoteSmallSearching.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DNoteSmallSearching`](DNoteSmallSearching.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DNoteSmallSearching`](DNoteSmallSearching.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DNoteSmallSearching`](DNoteSmallSearching.md)<`THEME`, `OPTIONS`\>
