[Winter Cardinal UI - v0.407.0](../index.md) / DNoteSmallSearching
...
- [\_boundsID](DNoteSmallSearching.md#_boundsid)
- [\_boundsRect](DNoteSmallSearching.md#_boundsrect)
...
- [\_enabledFilters](DNoteSmallSearching.md#_enabledfilters)
- [\_image](DNoteSmallSearching.md#_image)
- [\_lastDownPoint](DNoteSmallSearching.md#_lastdownpoint)
- [\_lastSortedIndex](DNoteSmallSearching.md#_lastsortedindex)
- [\_localBounds](DNoteSmallSearching.md#_localbounds)
- [\_localBoundsRect](DNoteSmallSearching.md#_localboundsrect)
...
- [containerUpdateTransform](DNoteSmallSearching.md#containerupdatetransform)
...
- [disableTempParent](DNoteSmallSearching.md#disabletempparent)
- [displayObjectUpdateTransform](DNoteSmallSearching.md#displayobjectupdatetransform)
- [emit](DNoteSmallSearching.md#emit)
- [enableTempParent](DNoteSmallSearching.md#enabletempparent)
...
- [getImage](DNoteSmallSearching.md#getimage)
- [getLayouter](DNoteSmallSearching.md#getlayouter)
...
- [getText](DNoteSmallSearching.md#gettext)
...
- [newOverflowMask](DNoteSmallSearching.md#newoverflowmask)
...
- [onReflowTextAndImage](DNoteSmallSearching.md#onreflowtextandimage)
...
[src/main/typescript/wcardinal/ui/d-note-small-searching.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-note-small-searching.ts#L18)
