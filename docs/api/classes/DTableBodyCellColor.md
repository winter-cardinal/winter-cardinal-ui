[Winter Cardinal UI - v0.414.0](../index.md) / DTableBodyCellColor
...
- [\_boundsID](DTableBodyCellColor.md#_boundsid)
- [\_boundsRect](DTableBodyCellColor.md#_boundsrect)
...
- [\_enabledFilters](DTableBodyCellColor.md#_enabledfilters)
- [\_image](DTableBodyCellColor.md#_image)
- [\_isGrouped](DTableBodyCellColor.md#_isgrouped)
...
- [\_localBounds](DTableBodyCellColor.md#_localbounds)
- [\_localBoundsRect](DTableBodyCellColor.md#_localboundsrect)
...
- [isGrouped](DTableBodyCellColor.md#isgrouped)
...
- [containerUpdateTransform](DTableBodyCellColor.md#containerupdatetransform)
...
- [disableTempParent](DTableBodyCellColor.md#disabletempparent)
- [displayObjectUpdateTransform](DTableBodyCellColor.md#displayobjectupdatetransform)
- [emit](DTableBodyCellColor.md#emit)
- [enableTempParent](DTableBodyCellColor.md#enabletempparent)
...
- [getImage](DTableBodyCellColor.md#getimage)
- [getLayouter](DTableBodyCellColor.md#getlayouter)
...
- [getText](DTableBodyCellColor.md#gettext)
...
- [newOverflowMask](DTableBodyCellColor.md#newoverflowmask)
- [newPadding](DTableBodyCellColor.md#newpadding)
- [newText](DTableBodyCellColor.md#newtext)
...
- [onPress](DTableBodyCellColor.md#onpress)
- [onRefit](DTableBodyCellColor.md#onrefit)
- [onReflow](DTableBodyCellColor.md#onreflow)
- [onReflowTextAndImage](DTableBodyCellColor.md#onreflowtextandimage)
...
- [onUnpress](DTableBodyCellColor.md#onunpress)
...
• **new DTableBodyCellColor**\<`ROW`, `THEME`, `OPTIONS`\>(`columnIndex`, `column`, `onChange`, `options?`): [`DTableBodyCellColor`](DTableBodyCellColor.md)\<`ROW`, `THEME`, `OPTIONS`\>
...
| `onChange` | [`DTableBodyCellOnChange`](../index.md#dtablebodycellonchange)\<`ROW`, [`DColorAndAlpha`](../interfaces/DColorAndAlpha.md)\> |
| `options?` | `OPTIONS` |
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts:39](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts#L39)
...
[DButtonColor](DButtonColor.md).[_boundsID](DButtonColor.md#_boundsid)
...
[DButtonColor](DButtonColor.md).[_boundsRect](DButtonColor.md#_boundsrect)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts:36](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts#L36)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts:35](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts#L35)
...
[DButtonColor](DButtonColor.md).[_enabledFilters](DButtonColor.md#_enabledfilters)
...
[DButtonColor](DButtonColor.md).[_image](DButtonColor.md#_image)
...
[DButtonColor](DButtonColor.md).[_isGrouped](DButtonColor.md#_isgrouped)
...
[DButtonColor](DButtonColor.md).[_localBounds](DButtonColor.md#_localbounds)
...
[DButtonColor](DButtonColor.md).[_localBoundsRect](DButtonColor.md#_localboundsrect)
...
• `Protected` **\_onChange**: [`DTableBodyCellOnChange`](../index.md#dtablebodycellonchange)\<`ROW`, [`DColorAndAlpha`](../interfaces/DColorAndAlpha.md)\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts:37](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts#L37)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts:33](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts#L33)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts:34](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts#L34)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts:79](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts#L79)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts:75](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts#L75)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts:67](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts#L67)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts:71](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts#L71)
...
[DButtonColor](DButtonColor.md).[containerUpdateTransform](DButtonColor.md#containerupdatetransform)
...
[DButtonColor](DButtonColor.md).[disableTempParent](DButtonColor.md#disabletempparent)
...
[DButtonColor](DButtonColor.md).[enableTempParent](DButtonColor.md#enabletempparent)
...
[DButtonColor](DButtonColor.md).[getImage](DButtonColor.md#getimage)
...
[DButtonColor](DButtonColor.md).[getLayouter](DButtonColor.md#getlayouter)
...
[DButtonColor](DButtonColor.md).[getText](DButtonColor.md#gettext)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts:119](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts#L119)
...
[DButtonColor](DButtonColor.md).[newOverflowMask](DButtonColor.md#newoverflowmask)
...
[DButtonColor](DButtonColor.md).[newPadding](DButtonColor.md#newpadding)
...
[DButtonColor](DButtonColor.md).[newText](DButtonColor.md#newtext)
...
[DButtonColor](DButtonColor.md).[onPress](DButtonColor.md#onpress)
...
[DButtonColor](DButtonColor.md).[onReflowTextAndImage](DButtonColor.md#onreflowtextandimage)
...
[DButtonColor](DButtonColor.md).[onUnpress](DButtonColor.md#onunpress)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts:53](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts#L53)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts:83](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts#L83)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts:114](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-table-body-cell-color.ts#L114)
