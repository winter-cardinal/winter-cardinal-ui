[Winter Cardinal UI](../README.md) / DTableBodyCellCheck
...
| `onChange` | [`DTableBodyCellOnChange`](../README.md#dtablebodycellonchange)<`ROW`, `boolean`, `any`\> |
| `options?` | `OPTIONS` |
...
• `Protected` **\_onChange**: [`DTableBodyCellOnChange`](../README.md#dtablebodycellonchange)<`ROW`, `boolean`, `any`\>
...
• `Protected` `Optional` **\_textValue**: [`DStateAwareOrValueMightBe`](../README.md#dstateawareorvaluemightbe)<`boolean`\>
