[Winter Cardinal UI - v0.160.0](../index.md) / DPickerTime

# Class: DPickerTime<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemePickerTime`](../interfaces/DThemePickerTime.md) = [`DThemePickerTime`](../interfaces/DThemePickerTime.md) |
| `OPTIONS` | extends [`DPickerTimeOptions`](../interfaces/DPickerTimeOptions.md)<`THEME`\> = [`DPickerTimeOptions`](../interfaces/DPickerTimeOptions.md)<`THEME`\> |
...
- [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DPickerDatetime`](DPickerDatetime.md)

## Table of contents

### Constructors

- [constructor](DPickerTime.md#constructor)

### Properties

- [\_accessibleActive](DPickerTime.md#_accessibleactive)
- [\_accessibleDiv](DPickerTime.md#_accessiblediv)
- [\_auto](DPickerTime.md#_auto)
- [\_background](DPickerTime.md#_background)
- [\_border](DPickerTime.md#_border)
- [\_bounds](DPickerTime.md#_bounds)
- [\_clearType](DPickerTime.md#_cleartype)
- [\_corner](DPickerTime.md#_corner)
- [\_cursor](DPickerTime.md#_cursor)
- [\_dateBounds](DPickerTime.md#_datebounds)
- [\_dateCurrent](DPickerTime.md#_datecurrent)
- [\_dateNew](DPickerTime.md#_datenew)
- [\_destroyed](DPickerTime.md#_destroyed)
- [\_inputHours](DPickerTime.md#_inputhours)
- [\_inputMinutes](DPickerTime.md#_inputminutes)
- [\_inputSeconds](DPickerTime.md#_inputseconds)
- [\_lastDownPoint](DPickerTime.md#_lastdownpoint)
- [\_lastSortedIndex](DPickerTime.md#_lastsortedindex)
- [\_mask](DPickerTime.md#_mask)
- [\_options](DPickerTime.md#_options)
- [\_outline](DPickerTime.md#_outline)
- [\_padding](DPickerTime.md#_padding)
- [\_reflowable](DPickerTime.md#_reflowable)
- [\_shortcuts](DPickerTime.md#_shortcuts)
- [\_snippet](DPickerTime.md#_snippet)
- [\_tempDisplayObjectParent](DPickerTime.md#_tempdisplayobjectparent)
- [\_title](DPickerTime.md#_title)
- [\_zIndex](DPickerTime.md#_zindex)
- [accessible](DPickerTime.md#accessible)
- [accessibleChildren](DPickerTime.md#accessiblechildren)
- [accessibleHint](DPickerTime.md#accessiblehint)
- [accessiblePointerEvents](DPickerTime.md#accessiblepointerevents)
- [accessibleTitle](DPickerTime.md#accessibletitle)
- [accessibleType](DPickerTime.md#accessibletype)
- [alpha](DPickerTime.md#alpha)
- [angle](DPickerTime.md#angle)
- [buttonMode](DPickerTime.md#buttonmode)
- [cacheAsBitmap](DPickerTime.md#cacheasbitmap)
- [children](DPickerTime.md#children)
- [cursor](DPickerTime.md#cursor)
- [filterArea](DPickerTime.md#filterarea)
- [filters](DPickerTime.md#filters)
- [hitArea](DPickerTime.md#hitarea)
- [interactive](DPickerTime.md#interactive)
- [interactiveChildren](DPickerTime.md#interactivechildren)
- [isMask](DPickerTime.md#ismask)
- [isSprite](DPickerTime.md#issprite)
- [localTransform](DPickerTime.md#localtransform)
- [mask](DPickerTime.md#mask)
- [name](DPickerTime.md#name)
- [parent](DPickerTime.md#parent)
- [pivot](DPickerTime.md#pivot)
- [renderable](DPickerTime.md#renderable)
- [rotation](DPickerTime.md#rotation)
- [sortDirty](DPickerTime.md#sortdirty)
- [sortableChildren](DPickerTime.md#sortablechildren)
- [transform](DPickerTime.md#transform)
- [visible](DPickerTime.md#visible)
- [worldAlpha](DPickerTime.md#worldalpha)
- [worldTransform](DPickerTime.md#worldtransform)
- [worldVisible](DPickerTime.md#worldvisible)
- [zIndex](DPickerTime.md#zindex)
- [WORK\_CONTAINS\_POINT](DPickerTime.md#work_contains_point)

### Accessors

- [background](DPickerTime.md#background)
- [border](DPickerTime.md#border)
- [bounds](DPickerTime.md#bounds)
- [corner](DPickerTime.md#corner)
- [current](DPickerTime.md#current)
- [height](DPickerTime.md#height)
- [new](DPickerTime.md#new)
- [outline](DPickerTime.md#outline)
- [padding](DPickerTime.md#padding)
- [position](DPickerTime.md#position)
- [reflowable](DPickerTime.md#reflowable)
- [scale](DPickerTime.md#scale)
- [shadow](DPickerTime.md#shadow)
- [skew](DPickerTime.md#skew)
- [snippet](DPickerTime.md#snippet)
- [state](DPickerTime.md#state)
- [theme](DPickerTime.md#theme)
- [title](DPickerTime.md#title)
- [type](DPickerTime.md#type)
- [unsafe](DPickerTime.md#unsafe)
- [weight](DPickerTime.md#weight)
- [width](DPickerTime.md#width)
- [x](DPickerTime.md#x)
- [y](DPickerTime.md#y)

### Methods

- [\_calculateBounds](DPickerTime.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DPickerTime.md#_recursivepostupdatetransform)
- [\_render](DPickerTime.md#_render)
- [addChild](DPickerTime.md#addchild)
- [addChildAt](DPickerTime.md#addchildat)
- [addListener](DPickerTime.md#addlistener)
- [adjustInputOptions](DPickerTime.md#adjustinputoptions)
- [applyTitle](DPickerTime.md#applytitle)
- [blur](DPickerTime.md#blur)
- [calculateBounds](DPickerTime.md#calculatebounds)
- [containsGlobalPoint](DPickerTime.md#containsglobalpoint)
- [containsLocalPoint](DPickerTime.md#containslocalpoint)
- [containsPoint](DPickerTime.md#containspoint)
- [destroy](DPickerTime.md#destroy)
- [displayObjectUpdateTransform](DPickerTime.md#displayobjectupdatetransform)
- [emit](DPickerTime.md#emit)
- [eventNames](DPickerTime.md#eventnames)
- [focus](DPickerTime.md#focus)
- [focusOnClosest](DPickerTime.md#focusonclosest)
- [getBounds](DPickerTime.md#getbounds)
- [getChildAt](DPickerTime.md#getchildat)
- [getChildByName](DPickerTime.md#getchildbyname)
- [getChildIndex](DPickerTime.md#getchildindex)
- [getClearType](DPickerTime.md#getcleartype)
- [getClippingRect](DPickerTime.md#getclippingrect)
- [getGlobalPosition](DPickerTime.md#getglobalposition)
- [getHeight](DPickerTime.md#getheight)
- [getLocalBounds](DPickerTime.md#getlocalbounds)
- [getMinuteSeparator](DPickerTime.md#getminuteseparator)
- [getParentOfSize](DPickerTime.md#getparentofsize)
- [getSecondSeparator](DPickerTime.md#getsecondseparator)
- [getThemeDefault](DPickerTime.md#getthemedefault)
- [getTimeLayoutHeight](DPickerTime.md#gettimelayoutheight)
- [getTimeLayoutWidth](DPickerTime.md#gettimelayoutwidth)
- [getType](DPickerTime.md#gettype)
- [getWidth](DPickerTime.md#getwidth)
- [getX](DPickerTime.md#getx)
- [getY](DPickerTime.md#gety)
- [hasDirty](DPickerTime.md#hasdirty)
- [hasHours](DPickerTime.md#hashours)
- [hasMinutes](DPickerTime.md#hasminutes)
- [hasRefitableHeight](DPickerTime.md#hasrefitableheight)
- [hasRefitableWidth](DPickerTime.md#hasrefitablewidth)
- [hasSeconds](DPickerTime.md#hasseconds)
- [hide](DPickerTime.md#hide)
- [init](DPickerTime.md#init)
- [initReflowable](DPickerTime.md#initreflowable)
- [isDirty](DPickerTime.md#isdirty)
- [isEventTarget](DPickerTime.md#iseventtarget)
- [isHidden](DPickerTime.md#ishidden)
- [isHierarchyDirty](DPickerTime.md#ishierarchydirty)
- [isRefitable](DPickerTime.md#isrefitable)
- [isShown](DPickerTime.md#isshown)
- [listenerCount](DPickerTime.md#listenercount)
- [listeners](DPickerTime.md#listeners)
- [newChildren](DPickerTime.md#newchildren)
- [newInputHours](DPickerTime.md#newinputhours)
- [newInputMinutes](DPickerTime.md#newinputminutes)
- [newInputSeconds](DPickerTime.md#newinputseconds)
- [newMinuteSeparator](DPickerTime.md#newminuteseparator)
- [newSecondSeparator](DPickerTime.md#newsecondseparator)
- [newTimeLayout](DPickerTime.md#newtimelayout)
- [newTimeLayoutChildren](DPickerTime.md#newtimelayoutchildren)
- [off](DPickerTime.md#off)
- [on](DPickerTime.md#on)
- [onBlur](DPickerTime.md#onblur)
- [onChildBlur](DPickerTime.md#onchildblur)
- [onChildFocus](DPickerTime.md#onchildfocus)
- [onChildrenChange](DPickerTime.md#onchildrenchange)
- [onDblClick](DPickerTime.md#ondblclick)
- [onDown](DPickerTime.md#ondown)
- [onDownThis](DPickerTime.md#ondownthis)
- [onFocus](DPickerTime.md#onfocus)
- [onHierarchyDirty](DPickerTime.md#onhierarchydirty)
- [onHoursChange](DPickerTime.md#onhourschange)
- [onKeyDown](DPickerTime.md#onkeydown)
- [onKeyUp](DPickerTime.md#onkeyup)
- [onMinutesChange](DPickerTime.md#onminuteschange)
- [onMove](DPickerTime.md#onmove)
- [onNewChange](DPickerTime.md#onnewchange)
- [onOut](DPickerTime.md#onout)
- [onOver](DPickerTime.md#onover)
- [onParentMove](DPickerTime.md#onparentmove)
- [onParentResize](DPickerTime.md#onparentresize)
- [onRefit](DPickerTime.md#onrefit)
- [onReflow](DPickerTime.md#onreflow)
- [onReset](DPickerTime.md#onreset)
- [onResize](DPickerTime.md#onresize)
- [onScale](DPickerTime.md#onscale)
- [onSecondsChange](DPickerTime.md#onsecondschange)
- [onShortcut](DPickerTime.md#onshortcut)
- [onSkew](DPickerTime.md#onskew)
- [onStateChange](DPickerTime.md#onstatechange)
- [onUp](DPickerTime.md#onup)
- [onUpThis](DPickerTime.md#onupthis)
- [onWheel](DPickerTime.md#onwheel)
- [once](DPickerTime.md#once)
- [reflow](DPickerTime.md#reflow)
- [removeAllListeners](DPickerTime.md#removealllisteners)
- [removeChild](DPickerTime.md#removechild)
- [removeChildAt](DPickerTime.md#removechildat)
- [removeChildren](DPickerTime.md#removechildren)
- [removeListener](DPickerTime.md#removelistener)
- [render](DPickerTime.md#render)
- [renderAdvanced](DPickerTime.md#renderadvanced)
- [reset](DPickerTime.md#reset)
- [resize](DPickerTime.md#resize)
- [setChildIndex](DPickerTime.md#setchildindex)
- [setFocused](DPickerTime.md#setfocused)
- [setHeight](DPickerTime.md#setheight)
- [setParent](DPickerTime.md#setparent)
- [setTransform](DPickerTime.md#settransform)
- [setWidth](DPickerTime.md#setwidth)
- [setX](DPickerTime.md#setx)
- [setY](DPickerTime.md#sety)
- [show](DPickerTime.md#show)
- [sortChildren](DPickerTime.md#sortchildren)
- [swapChildren](DPickerTime.md#swapchildren)
- [toCursor](DPickerTime.md#tocursor)
- [toDirty](DPickerTime.md#todirty)
- [toGlobal](DPickerTime.md#toglobal)
- [toHasDirty](DPickerTime.md#tohasdirty)
- [toHierarchyDirty](DPickerTime.md#tohierarchydirty)
- [toLocal](DPickerTime.md#tolocal)
- [toParentHasDirty](DPickerTime.md#toparenthasdirty)
- [toParentHierarchyDirty](DPickerTime.md#toparenthierarchydirty)
- [toParentResized](DPickerTime.md#toparentresized)
- [updateTransform](DPickerTime.md#updatetransform)
- [mixin](DPickerTime.md#mixin)

## Constructors

### constructor

• **new DPickerTime**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemePickerTime`](../interfaces/DThemePickerTime.md) = [`DThemePickerTime`](../interfaces/DThemePickerTime.md) |
| `OPTIONS` | extends [`DPickerTimeOptions`](../interfaces/DPickerTimeOptions.md)<`THEME`, `OPTIONS`\> = [`DPickerTimeOptions`](../interfaces/DPickerTimeOptions.md)<`THEME`\> |
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:103](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L103)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:96](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L96)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:97](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L97)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:98](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L98)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:99](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L99)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:100](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L100)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:101](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L101)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:154](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L154)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:133](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L133)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:137](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L137)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:143](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L143)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:147](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L147)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DPickerTime`](DPickerTime.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:304](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L304)
...
▸ **blur**(`recursively?`): [`DPickerTime`](DPickerTime.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DPickerTime`](DPickerTime.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:287](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L287)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:300](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L300)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:250](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L250)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:246](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L246)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:367](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L367)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:158](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L158)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:162](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L162)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:166](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L166)

___

### hide

▸ **hide**(): [`DPickerTime`](DPickerTime.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:108](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L108)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:210](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L210)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:321](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L321)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:337](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L337)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:353](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L353)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:278](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L278)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:291](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L291)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:228](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L228)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:254](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L254)

___

### off

▸ **off**(`event`, `fn?`, `context?`): [`DPickerTime`](DPickerTime.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DPickerTime`](DPickerTime.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:331](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L331)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:347](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L347)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:180](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L180)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:176](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L176)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:363](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L363)
...
▸ **once**(`event`, `fn`, `context?`): [`DPickerTime`](DPickerTime.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DPickerTime`](DPickerTime.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DPickerTime`](DPickerTime.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:170](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L170)
...
▸ `Protected` **setFocused**(`isFocused`): [`DPickerTime`](DPickerTime.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DPickerTime`](DPickerTime.md)<`THEME`, `OPTIONS`\>
