[Winter Cardinal UI - v0.167.0](../index.md) / DImageBase

# Class: DImageBase<VALUE, THEME, OPTIONS\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeImageBase`](../interfaces/DThemeImageBase.md)<`VALUE`\> = [`DThemeImageBase`](../interfaces/DThemeImageBase.md)<`VALUE`\> |
| `OPTIONS` | extends [`DImageBaseOptions`](../interfaces/DImageBaseOptions.md)<`VALUE`, `THEME`\> = [`DImageBaseOptions`](../interfaces/DImageBaseOptions.md)<`VALUE`, `THEME`\> |
...
- [`DTextBase`](DTextBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DButtonBase`](DButtonBase.md)

  ↳↳ [`DHtmlElement`](DHtmlElement.md)

  ↳↳ [`DImage`](DImage.md)

  ↳↳ [`DListItem`](DListItem.md)

  ↳↳ [`DNote`](DNote.md)

  ↳↳ [`DPaginationDots`](DPaginationDots.md)

  ↳↳ [`DPaginationPage`](DPaginationPage.md)

  ↳↳ [`DTableBodyCellIndex`](DTableBodyCellIndex.md)

  ↳↳ [`DTableBodyCellText`](DTableBodyCellText.md)

  ↳↳ [`DTreeItemText`](DTreeItemText.md)

## Table of contents

### Constructors

- [constructor](DImageBase.md#constructor)

### Properties

- [\_accessibleActive](DImageBase.md#_accessibleactive)
- [\_accessibleDiv](DImageBase.md#_accessiblediv)
- [\_auto](DImageBase.md#_auto)
- [\_background](DImageBase.md#_background)
- [\_border](DImageBase.md#_border)
- [\_bounds](DImageBase.md#_bounds)
- [\_clearType](DImageBase.md#_cleartype)
- [\_corner](DImageBase.md#_corner)
- [\_cursor](DImageBase.md#_cursor)
- [\_destroyed](DImageBase.md#_destroyed)
- [\_images](DImageBase.md#_images)
- [\_isOverflowMaskEnabled](DImageBase.md#_isoverflowmaskenabled)
- [\_isTextVisible](DImageBase.md#_istextvisible)
- [\_lastDownPoint](DImageBase.md#_lastdownpoint)
- [\_lastSortedIndex](DImageBase.md#_lastsortedindex)
- [\_mask](DImageBase.md#_mask)
- [\_options](DImageBase.md#_options)
- [\_outline](DImageBase.md#_outline)
- [\_overflowMask](DImageBase.md#_overflowmask)
- [\_padding](DImageBase.md#_padding)
- [\_reflowable](DImageBase.md#_reflowable)
- [\_shortcuts](DImageBase.md#_shortcuts)
- [\_snippet](DImageBase.md#_snippet)
- [\_tempDisplayObjectParent](DImageBase.md#_tempdisplayobjectparent)
- [\_text](DImageBase.md#_text)
- [\_textAlign](DImageBase.md#_textalign)
- [\_textAlpha](DImageBase.md#_textalpha)
- [\_textColor](DImageBase.md#_textcolor)
- [\_textFormatter](DImageBase.md#_textformatter)
- [\_textStyle](DImageBase.md#_textstyle)
- [\_textValue](DImageBase.md#_textvalue)
- [\_textValueComputed](DImageBase.md#_textvaluecomputed)
- [\_title](DImageBase.md#_title)
- [\_zIndex](DImageBase.md#_zindex)
- [accessible](DImageBase.md#accessible)
- [accessibleChildren](DImageBase.md#accessiblechildren)
- [accessibleHint](DImageBase.md#accessiblehint)
- [accessiblePointerEvents](DImageBase.md#accessiblepointerevents)
- [accessibleTitle](DImageBase.md#accessibletitle)
- [accessibleType](DImageBase.md#accessibletype)
- [alpha](DImageBase.md#alpha)
- [angle](DImageBase.md#angle)
- [buttonMode](DImageBase.md#buttonmode)
- [cacheAsBitmap](DImageBase.md#cacheasbitmap)
- [children](DImageBase.md#children)
- [cursor](DImageBase.md#cursor)
- [filterArea](DImageBase.md#filterarea)
- [filters](DImageBase.md#filters)
- [hitArea](DImageBase.md#hitarea)
- [interactive](DImageBase.md#interactive)
- [interactiveChildren](DImageBase.md#interactivechildren)
- [isMask](DImageBase.md#ismask)
- [isSprite](DImageBase.md#issprite)
- [localTransform](DImageBase.md#localtransform)
- [mask](DImageBase.md#mask)
- [name](DImageBase.md#name)
- [parent](DImageBase.md#parent)
- [pivot](DImageBase.md#pivot)
- [renderable](DImageBase.md#renderable)
- [rotation](DImageBase.md#rotation)
- [sortDirty](DImageBase.md#sortdirty)
- [sortableChildren](DImageBase.md#sortablechildren)
- [transform](DImageBase.md#transform)
- [visible](DImageBase.md#visible)
- [worldAlpha](DImageBase.md#worldalpha)
- [worldTransform](DImageBase.md#worldtransform)
- [worldVisible](DImageBase.md#worldvisible)
- [zIndex](DImageBase.md#zindex)
- [LAYOUTER](DImageBase.md#layouter)
- [WORK\_CONTAINS\_POINT](DImageBase.md#work_contains_point)

### Accessors

- [background](DImageBase.md#background)
- [border](DImageBase.md#border)
- [corner](DImageBase.md#corner)
- [height](DImageBase.md#height)
- [image](DImageBase.md#image)
- [outline](DImageBase.md#outline)
- [padding](DImageBase.md#padding)
- [position](DImageBase.md#position)
- [reflowable](DImageBase.md#reflowable)
- [scale](DImageBase.md#scale)
- [shadow](DImageBase.md#shadow)
- [skew](DImageBase.md#skew)
- [snippet](DImageBase.md#snippet)
- [state](DImageBase.md#state)
- [text](DImageBase.md#text)
- [theme](DImageBase.md#theme)
- [title](DImageBase.md#title)
- [type](DImageBase.md#type)
- [unsafe](DImageBase.md#unsafe)
- [weight](DImageBase.md#weight)
- [width](DImageBase.md#width)
- [x](DImageBase.md#x)
- [y](DImageBase.md#y)

### Methods

- [\_calculateBounds](DImageBase.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DImageBase.md#_recursivepostupdatetransform)
- [\_render](DImageBase.md#_render)
- [addChild](DImageBase.md#addchild)
- [addChildAt](DImageBase.md#addchildat)
- [addListener](DImageBase.md#addlistener)
- [applyTitle](DImageBase.md#applytitle)
- [blur](DImageBase.md#blur)
- [calculateBounds](DImageBase.md#calculatebounds)
- [computeTextValue](DImageBase.md#computetextvalue)
- [containsGlobalPoint](DImageBase.md#containsglobalpoint)
- [containsLocalPoint](DImageBase.md#containslocalpoint)
- [containsPoint](DImageBase.md#containspoint)
- [createOrUpdateText](DImageBase.md#createorupdatetext)
- [createText](DImageBase.md#createtext)
- [destroy](DImageBase.md#destroy)
- [displayObjectUpdateTransform](DImageBase.md#displayobjectupdatetransform)
- [emit](DImageBase.md#emit)
- [eventNames](DImageBase.md#eventnames)
- [focus](DImageBase.md#focus)
- [focusOnClosest](DImageBase.md#focusonclosest)
- [getBounds](DImageBase.md#getbounds)
- [getChildAt](DImageBase.md#getchildat)
- [getChildByName](DImageBase.md#getchildbyname)
- [getChildIndex](DImageBase.md#getchildindex)
- [getClearType](DImageBase.md#getcleartype)
- [getClippingRect](DImageBase.md#getclippingrect)
- [getGlobalPosition](DImageBase.md#getglobalposition)
- [getHeight](DImageBase.md#getheight)
- [getLocalBounds](DImageBase.md#getlocalbounds)
- [getOverflowMask](DImageBase.md#getoverflowmask)
- [getParentOfSize](DImageBase.md#getparentofsize)
- [getTextAlpha](DImageBase.md#gettextalpha)
- [getTextColor](DImageBase.md#gettextcolor)
- [getThemeDefault](DImageBase.md#getthemedefault)
- [getType](DImageBase.md#gettype)
- [getWidth](DImageBase.md#getwidth)
- [getX](DImageBase.md#getx)
- [getY](DImageBase.md#gety)
- [hasDirty](DImageBase.md#hasdirty)
- [hasRefitableHeight](DImageBase.md#hasrefitableheight)
- [hasRefitableWidth](DImageBase.md#hasrefitablewidth)
- [hide](DImageBase.md#hide)
- [hideText](DImageBase.md#hidetext)
- [init](DImageBase.md#init)
- [initReflowable](DImageBase.md#initreflowable)
- [isDirty](DImageBase.md#isdirty)
- [isEventTarget](DImageBase.md#iseventtarget)
- [isHidden](DImageBase.md#ishidden)
- [isHierarchyDirty](DImageBase.md#ishierarchydirty)
- [isRefitable](DImageBase.md#isrefitable)
- [isShown](DImageBase.md#isshown)
- [listenerCount](DImageBase.md#listenercount)
- [listeners](DImageBase.md#listeners)
- [newImage](DImageBase.md#newimage)
- [newImages](DImageBase.md#newimages)
- [off](DImageBase.md#off)
- [on](DImageBase.md#on)
- [onBlur](DImageBase.md#onblur)
- [onChildBlur](DImageBase.md#onchildblur)
- [onChildFocus](DImageBase.md#onchildfocus)
- [onChildrenChange](DImageBase.md#onchildrenchange)
- [onDblClick](DImageBase.md#ondblclick)
- [onDown](DImageBase.md#ondown)
- [onDownThis](DImageBase.md#ondownthis)
- [onFocus](DImageBase.md#onfocus)
- [onHierarchyDirty](DImageBase.md#onhierarchydirty)
- [onKeyDown](DImageBase.md#onkeydown)
- [onKeyUp](DImageBase.md#onkeyup)
- [onMove](DImageBase.md#onmove)
- [onOut](DImageBase.md#onout)
- [onOver](DImageBase.md#onover)
- [onParentMove](DImageBase.md#onparentmove)
- [onParentResize](DImageBase.md#onparentresize)
- [onRefit](DImageBase.md#onrefit)
- [onReflow](DImageBase.md#onreflow)
- [onResize](DImageBase.md#onresize)
- [onScale](DImageBase.md#onscale)
- [onShortcut](DImageBase.md#onshortcut)
- [onSkew](DImageBase.md#onskew)
- [onStateChange](DImageBase.md#onstatechange)
- [onTextChange](DImageBase.md#ontextchange)
- [onUp](DImageBase.md#onup)
- [onUpThis](DImageBase.md#onupthis)
- [onWheel](DImageBase.md#onwheel)
- [once](DImageBase.md#once)
- [reflow](DImageBase.md#reflow)
- [removeAllListeners](DImageBase.md#removealllisteners)
- [removeChild](DImageBase.md#removechild)
- [removeChildAt](DImageBase.md#removechildat)
- [removeChildren](DImageBase.md#removechildren)
- [removeListener](DImageBase.md#removelistener)
- [render](DImageBase.md#render)
- [renderAdvanced](DImageBase.md#renderadvanced)
- [resize](DImageBase.md#resize)
- [setChildIndex](DImageBase.md#setchildindex)
- [setFocused](DImageBase.md#setfocused)
- [setHeight](DImageBase.md#setheight)
- [setParent](DImageBase.md#setparent)
- [setTransform](DImageBase.md#settransform)
- [setWidth](DImageBase.md#setwidth)
- [setX](DImageBase.md#setx)
- [setY](DImageBase.md#sety)
- [show](DImageBase.md#show)
- [showText](DImageBase.md#showtext)
- [sortChildren](DImageBase.md#sortchildren)
- [swapChildren](DImageBase.md#swapchildren)
- [toCursor](DImageBase.md#tocursor)
- [toDirty](DImageBase.md#todirty)
- [toGlobal](DImageBase.md#toglobal)
- [toHasDirty](DImageBase.md#tohasdirty)
- [toHierarchyDirty](DImageBase.md#tohierarchydirty)
- [toImageOptions](DImageBase.md#toimageoptions)
- [toLocal](DImageBase.md#tolocal)
- [toParentHasDirty](DImageBase.md#toparenthasdirty)
- [toParentHierarchyDirty](DImageBase.md#toparenthierarchydirty)
- [toParentResized](DImageBase.md#toparentresized)
- [updateText](DImageBase.md#updatetext)
- [updateTextAndImage](DImageBase.md#updatetextandimage)
- [updateTextColor](DImageBase.md#updatetextcolor)
- [updateTextPosition](DImageBase.md#updatetextposition)
- [updateTextValue](DImageBase.md#updatetextvalue)
- [updateTransform](DImageBase.md#updatetransform)
- [mixin](DImageBase.md#mixin)

## Constructors

### constructor

• **new DImageBase**<`VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeImageBase`](../interfaces/DThemeImageBase.md)<`VALUE`, `THEME`\> = [`DThemeImageBase`](../interfaces/DThemeImageBase.md)<`VALUE`\> |
| `OPTIONS` | extends [`DImageBaseOptions`](../interfaces/DImageBaseOptions.md)<`VALUE`, `THEME`, `any`, `OPTIONS`\> = [`DImageBaseOptions`](../interfaces/DImageBaseOptions.md)<`VALUE`, `THEME`, `any`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DImageBase`](DImageBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DImageBase`](DImageBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DImageBase`](DImageBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-image-base.ts:191](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-image-base.ts#L191)
...
▸ **hide**(): [`DImageBase`](DImageBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DImageBase`](DImageBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DImageBase`](DImageBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DImageBase`](DImageBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DImageBase`](DImageBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DImageBase`](DImageBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DImageBase`](DImageBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DImageBase`](DImageBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
