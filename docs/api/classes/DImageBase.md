[Winter Cardinal UI - v0.407.0](../index.md) / DImageBase
...
- [`DTextBase`](DTextBase.md)\<`VALUE`, `THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)

  ↳↳ [`DDialogLayeredHeader`](DDialogLayeredHeader.md)
...
- [\_boundsID](DImageBase.md#_boundsid)
- [\_boundsRect](DImageBase.md#_boundsrect)
...
- [\_enabledFilters](DImageBase.md#_enabledfilters)
- [\_image](DImageBase.md#_image)
- [\_lastDownPoint](DImageBase.md#_lastdownpoint)
- [\_lastSortedIndex](DImageBase.md#_lastsortedindex)
- [\_localBounds](DImageBase.md#_localbounds)
- [\_localBoundsRect](DImageBase.md#_localboundsrect)
...
- [containerUpdateTransform](DImageBase.md#containerupdatetransform)
...
- [disableTempParent](DImageBase.md#disabletempparent)
- [displayObjectUpdateTransform](DImageBase.md#displayobjectupdatetransform)
- [emit](DImageBase.md#emit)
- [enableTempParent](DImageBase.md#enabletempparent)
...
- [getImage](DImageBase.md#getimage)
- [getLayouter](DImageBase.md#getlayouter)
...
- [newOverflowMask](DImageBase.md#newoverflowmask)
- [newPadding](DImageBase.md#newpadding)
- [newText](DImageBase.md#newtext)
...
- [onReflowTextAndImage](DImageBase.md#onreflowtextandimage)
...
• **new DImageBase**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DImageBase`](DImageBase.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeImageBase`](../interfaces/DThemeImageBase.md)\<`VALUE`\> = [`DThemeImageBase`](../interfaces/DThemeImageBase.md)\<`VALUE`\> |
| `OPTIONS` | extends [`DImageBaseOptions`](../interfaces/DImageBaseOptions.md)\<`VALUE`, `THEME`, `any`\> = [`DImageBaseOptions`](../interfaces/DImageBaseOptions.md)\<`VALUE`, `THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-image-base.ts:117](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-image-base.ts#L117)
...
▸ **setFocused**(`isFocused`): [`DImageBase`](DImageBase.md)\<`VALUE`, `THEME`, `OPTIONS`\>
