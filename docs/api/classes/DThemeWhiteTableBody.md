[Winter Cardinal UI - v0.165.0](../index.md) / DThemeWhiteTableBody
...
- [constructor](DThemeWhiteTableBody.md#constructor)

### Methods

- [getAlpha](DThemeWhiteTableBody.md#getalpha)
- [getBackgroundAlpha](DThemeWhiteTableBody.md#getbackgroundalpha)
- [getBackgroundColor](DThemeWhiteTableBody.md#getbackgroundcolor)
- [getBackgroundTexture](DThemeWhiteTableBody.md#getbackgroundtexture)
- [getBorderAlign](DThemeWhiteTableBody.md#getborderalign)
- [getBorderAlpha](DThemeWhiteTableBody.md#getborderalpha)
- [getBorderColor](DThemeWhiteTableBody.md#getbordercolor)
- [getBorderMask](DThemeWhiteTableBody.md#getbordermask)
- [getBorderTexture](DThemeWhiteTableBody.md#getbordertexture)
- [getBorderWidth](DThemeWhiteTableBody.md#getborderwidth)
- [getClearType](DThemeWhiteTableBody.md#getcleartype)
- [getColor](DThemeWhiteTableBody.md#getcolor)
- [getCornerMask](DThemeWhiteTableBody.md#getcornermask)
- [getCornerRadius](DThemeWhiteTableBody.md#getcornerradius)
- [getCursor](DThemeWhiteTableBody.md#getcursor)
- [getFontFamilly](DThemeWhiteTableBody.md#getfontfamilly)
- [getFontSize](DThemeWhiteTableBody.md#getfontsize)
- [getFontStyle](DThemeWhiteTableBody.md#getfontstyle)
- [getFontVariant](DThemeWhiteTableBody.md#getfontvariant)
- [getFontWeight](DThemeWhiteTableBody.md#getfontweight)
- [getHeight](DThemeWhiteTableBody.md#getheight)
- [getInteractive](DThemeWhiteTableBody.md#getinteractive)
- [getLineHeight](DThemeWhiteTableBody.md#getlineheight)
- [getOutlineAlign](DThemeWhiteTableBody.md#getoutlinealign)
- [getOutlineAlpha](DThemeWhiteTableBody.md#getoutlinealpha)
- [getOutlineColor](DThemeWhiteTableBody.md#getoutlinecolor)
- [getOutlineMask](DThemeWhiteTableBody.md#getoutlinemask)
- [getOutlineOffset](DThemeWhiteTableBody.md#getoutlineoffset)
- [getOutlineWidth](DThemeWhiteTableBody.md#getoutlinewidth)
- [getPaddingBottom](DThemeWhiteTableBody.md#getpaddingbottom)
- [getPaddingLeft](DThemeWhiteTableBody.md#getpaddingleft)
- [getPaddingRight](DThemeWhiteTableBody.md#getpaddingright)
- [getPaddingTop](DThemeWhiteTableBody.md#getpaddingtop)
- [getRowHeight](DThemeWhiteTableBody.md#getrowheight)
- [getShadow](DThemeWhiteTableBody.md#getshadow)
- [getTitle](DThemeWhiteTableBody.md#gettitle)
- [getWeight](DThemeWhiteTableBody.md#getweight)
- [getWidth](DThemeWhiteTableBody.md#getwidth)
- [getX](DThemeWhiteTableBody.md#getx)
- [getY](DThemeWhiteTableBody.md#gety)
- [newShadow](DThemeWhiteTableBody.md#newshadow)
- [newShadowWeak](DThemeWhiteTableBody.md#newshadowweak)
- [newState](DThemeWhiteTableBody.md#newstate)
...
[src/main/typescript/wcardinal/ui/theme/white/d-theme-white-table-body.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/theme/white/d-theme-white-table-body.ts#L22)
...
[src/main/typescript/wcardinal/ui/theme/white/d-theme-white-table-body.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/theme/white/d-theme-white-table-body.ts#L18)
...
[DThemeTableBody](../interfaces/DThemeTableBody.md).[getFontVariant](../interfaces/DThemeTableBody.md#getfontvariant)
...
[src/main/typescript/wcardinal/ui/theme/white/d-theme-white-table-body.ts:30](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/theme/white/d-theme-white-table-body.ts#L30)
...
[src/main/typescript/wcardinal/ui/theme/white/d-theme-white-table-body.ts:26](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/theme/white/d-theme-white-table-body.ts#L26)
...
[DThemeTableBody](../interfaces/DThemeTableBody.md).[getShadow](../interfaces/DThemeTableBody.md#getshadow)
...
[DThemeTableBody](../interfaces/DThemeTableBody.md).[getWeight](../interfaces/DThemeTableBody.md#getweight)
...
[src/main/typescript/wcardinal/ui/theme/white/d-theme-white-table-body.ts:14](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/theme/white/d-theme-white-table-body.ts#L14)
...
[src/main/typescript/wcardinal/ui/theme/white/d-theme-white-table-body.ts:34](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/theme/white/d-theme-white-table-body.ts#L34)
