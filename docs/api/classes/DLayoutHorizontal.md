[Winter Cardinal UI - v0.414.0](../index.md) / DLayoutHorizontal
...
- [\_boundsID](DLayoutHorizontal.md#_boundsid)
- [\_boundsRect](DLayoutHorizontal.md#_boundsrect)
...
- [\_enabledFilters](DLayoutHorizontal.md#_enabledfilters)
- [\_lastDownPoint](DLayoutHorizontal.md#_lastdownpoint)
- [\_lastSortedIndex](DLayoutHorizontal.md#_lastsortedindex)
- [\_localBounds](DLayoutHorizontal.md#_localbounds)
- [\_localBoundsRect](DLayoutHorizontal.md#_localboundsrect)
...
- [containerUpdateTransform](DLayoutHorizontal.md#containerupdatetransform)
...
- [disableTempParent](DLayoutHorizontal.md#disabletempparent)
- [displayObjectUpdateTransform](DLayoutHorizontal.md#displayobjectupdatetransform)
- [emit](DLayoutHorizontal.md#emit)
- [enableTempParent](DLayoutHorizontal.md#enabletempparent)
...
- [newPadding](DLayoutHorizontal.md#newpadding)
...
• **new DLayoutHorizontal**\<`THEME`, `OPTIONS`\>(`options?`): [`DLayoutHorizontal`](DLayoutHorizontal.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-layout-horizontal.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-layout-horizontal.ts#L18)
