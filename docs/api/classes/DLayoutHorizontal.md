[Winter Cardinal UI - v0.199.0](../index.md) / DLayoutHorizontal
...
- [`DLayout`](DLayout.md)<`THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DDialogLayeredFooter`](DDialogLayeredFooter.md)
...
- [options](DLayoutHorizontal.md#options)
...
[src/main/typescript/wcardinal/ui/d-layout-horizontal.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.199.0/src/main/typescript/wcardinal/ui/d-layout-horizontal.ts#L18)
