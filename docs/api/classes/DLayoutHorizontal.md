[Winter Cardinal UI - v0.407.0](../index.md) / DLayoutHorizontal
...
[src/main/typescript/wcardinal/ui/d-layout-horizontal.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-layout-horizontal.ts#L18)
...
▸ **setFocused**(`isFocused`): [`DLayoutHorizontal`](DLayoutHorizontal.md)\<`THEME`, `OPTIONS`\>
