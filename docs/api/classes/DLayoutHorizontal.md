[Winter Cardinal UI - v0.154.0](../index.md) / DLayoutHorizontal
...
- [`DLayout`](DLayout.md)<`THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DPaginationDynamicButtons`](DPaginationDynamicButtons.md)
...
[src/main/typescript/wcardinal/ui/d-layout-horizontal.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-layout-horizontal.ts#L18)
