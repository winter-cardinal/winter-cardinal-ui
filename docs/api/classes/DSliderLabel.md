[Winter Cardinal UI - v0.407.0](../index.md) / DSliderLabel
...
- [\_boundsID](DSliderLabel.md#_boundsid)
- [\_boundsRect](DSliderLabel.md#_boundsrect)
...
- [\_enabledFilters](DSliderLabel.md#_enabledfilters)
- [\_lastDownPoint](DSliderLabel.md#_lastdownpoint)
- [\_lastSortedIndex](DSliderLabel.md#_lastsortedindex)
- [\_localBounds](DSliderLabel.md#_localbounds)
- [\_localBoundsRect](DSliderLabel.md#_localboundsrect)
...
- [LAYOUTER](DSliderLabel.md#layouter)
...
- [containerUpdateTransform](DSliderLabel.md#containerupdatetransform)
...
- [disableTempParent](DSliderLabel.md#disabletempparent)
- [displayObjectUpdateTransform](DSliderLabel.md#displayobjectupdatetransform)
- [emit](DSliderLabel.md#emit)
- [enableTempParent](DSliderLabel.md#enabletempparent)
...
- [getLayouter](DSliderLabel.md#getlayouter)
...
- [getText](DSliderLabel.md#gettext)
...
- [newOverflowMask](DSliderLabel.md#newoverflowmask)
- [newPadding](DSliderLabel.md#newpadding)
- [newText](DSliderLabel.md#newtext)
...
- [onReflowTextAndImage](DSliderLabel.md#onreflowtextandimage)
...
• **new DSliderLabel**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DSliderLabel`](DSliderLabel.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-slider-label.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-slider-label.ts#L22)
...
[src/main/typescript/wcardinal/ui/d-slider-label.ts:33](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-slider-label.ts#L33)
...
[src/main/typescript/wcardinal/ui/d-slider-label.ts:29](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-slider-label.ts#L29)
...
[src/main/typescript/wcardinal/ui/d-slider-label.ts:37](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-slider-label.ts#L37)
...
[src/main/typescript/wcardinal/ui/d-slider-label.ts:24](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-slider-label.ts#L24)
...
▸ **setFocused**(`isFocused`): [`DSliderLabel`](DSliderLabel.md)\<`VALUE`, `THEME`, `OPTIONS`\>
