[Winter Cardinal UI - v0.167.0](../index.md) / DButtonDate

# Class: DButtonDate<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeButtonDate`](../interfaces/DThemeButtonDate.md) = [`DThemeButtonDate`](../interfaces/DThemeButtonDate.md) |
| `OPTIONS` | extends [`DButtonDateOptions`](../interfaces/DButtonDateOptions.md)<`THEME`\> = [`DButtonDateOptions`](../interfaces/DButtonDateOptions.md)<`THEME`\> |
...
- [`DButton`](DButton.md)<`Date`, `THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DTableBodyCellDate`](DTableBodyCellDate.md)

## Table of contents

### Constructors

- [constructor](DButtonDate.md#constructor)

### Properties

- [\_accessibleActive](DButtonDate.md#_accessibleactive)
- [\_accessibleDiv](DButtonDate.md#_accessiblediv)
- [\_auto](DButtonDate.md#_auto)
- [\_background](DButtonDate.md#_background)
- [\_border](DButtonDate.md#_border)
- [\_bounds](DButtonDate.md#_bounds)
- [\_clearType](DButtonDate.md#_cleartype)
- [\_corner](DButtonDate.md#_corner)
- [\_cursor](DButtonDate.md#_cursor)
- [\_destroyed](DButtonDate.md#_destroyed)
- [\_dialog](DButtonDate.md#_dialog)
- [\_images](DButtonDate.md#_images)
- [\_isOverflowMaskEnabled](DButtonDate.md#_isoverflowmaskenabled)
- [\_isTextVisible](DButtonDate.md#_istextvisible)
- [\_isToggle](DButtonDate.md#_istoggle)
- [\_lastDownPoint](DButtonDate.md#_lastdownpoint)
- [\_lastSortedIndex](DButtonDate.md#_lastsortedindex)
- [\_mask](DButtonDate.md#_mask)
- [\_options](DButtonDate.md#_options)
- [\_outline](DButtonDate.md#_outline)
- [\_overflowMask](DButtonDate.md#_overflowmask)
- [\_padding](DButtonDate.md#_padding)
- [\_reflowable](DButtonDate.md#_reflowable)
- [\_shortcuts](DButtonDate.md#_shortcuts)
- [\_snippet](DButtonDate.md#_snippet)
- [\_tempDisplayObjectParent](DButtonDate.md#_tempdisplayobjectparent)
- [\_text](DButtonDate.md#_text)
- [\_textAlign](DButtonDate.md#_textalign)
- [\_textAlpha](DButtonDate.md#_textalpha)
- [\_textColor](DButtonDate.md#_textcolor)
- [\_textFormatter](DButtonDate.md#_textformatter)
- [\_textStyle](DButtonDate.md#_textstyle)
- [\_textValue](DButtonDate.md#_textvalue)
- [\_textValueComputed](DButtonDate.md#_textvaluecomputed)
- [\_title](DButtonDate.md#_title)
- [\_when](DButtonDate.md#_when)
- [\_zIndex](DButtonDate.md#_zindex)
- [accessible](DButtonDate.md#accessible)
- [accessibleChildren](DButtonDate.md#accessiblechildren)
- [accessibleHint](DButtonDate.md#accessiblehint)
- [accessiblePointerEvents](DButtonDate.md#accessiblepointerevents)
- [accessibleTitle](DButtonDate.md#accessibletitle)
- [accessibleType](DButtonDate.md#accessibletype)
- [alpha](DButtonDate.md#alpha)
- [angle](DButtonDate.md#angle)
- [buttonMode](DButtonDate.md#buttonmode)
- [cacheAsBitmap](DButtonDate.md#cacheasbitmap)
- [children](DButtonDate.md#children)
- [cursor](DButtonDate.md#cursor)
- [filterArea](DButtonDate.md#filterarea)
- [filters](DButtonDate.md#filters)
- [hitArea](DButtonDate.md#hitarea)
- [interactive](DButtonDate.md#interactive)
- [interactiveChildren](DButtonDate.md#interactivechildren)
- [isMask](DButtonDate.md#ismask)
- [isSprite](DButtonDate.md#issprite)
- [localTransform](DButtonDate.md#localtransform)
- [mask](DButtonDate.md#mask)
- [name](DButtonDate.md#name)
- [parent](DButtonDate.md#parent)
- [pivot](DButtonDate.md#pivot)
- [renderable](DButtonDate.md#renderable)
- [rotation](DButtonDate.md#rotation)
- [sortDirty](DButtonDate.md#sortdirty)
- [sortableChildren](DButtonDate.md#sortablechildren)
- [transform](DButtonDate.md#transform)
- [visible](DButtonDate.md#visible)
- [worldAlpha](DButtonDate.md#worldalpha)
- [worldTransform](DButtonDate.md#worldtransform)
- [worldVisible](DButtonDate.md#worldvisible)
- [zIndex](DButtonDate.md#zindex)
- [DIALOG](DButtonDate.md#dialog)
- [LAYOUTER](DButtonDate.md#layouter)
- [WORK\_CONTAINS\_POINT](DButtonDate.md#work_contains_point)

### Accessors

- [background](DButtonDate.md#background)
- [border](DButtonDate.md#border)
- [corner](DButtonDate.md#corner)
- [dialog](DButtonDate.md#dialog)
- [height](DButtonDate.md#height)
- [image](DButtonDate.md#image)
- [isToggle](DButtonDate.md#istoggle)
- [outline](DButtonDate.md#outline)
- [padding](DButtonDate.md#padding)
- [position](DButtonDate.md#position)
- [reflowable](DButtonDate.md#reflowable)
- [scale](DButtonDate.md#scale)
- [shadow](DButtonDate.md#shadow)
- [skew](DButtonDate.md#skew)
- [snippet](DButtonDate.md#snippet)
- [state](DButtonDate.md#state)
- [text](DButtonDate.md#text)
- [theme](DButtonDate.md#theme)
- [title](DButtonDate.md#title)
- [type](DButtonDate.md#type)
- [unsafe](DButtonDate.md#unsafe)
- [value](DButtonDate.md#value)
- [weight](DButtonDate.md#weight)
- [width](DButtonDate.md#width)
- [x](DButtonDate.md#x)
- [y](DButtonDate.md#y)

### Methods

- [\_calculateBounds](DButtonDate.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DButtonDate.md#_recursivepostupdatetransform)
- [\_render](DButtonDate.md#_render)
- [addChild](DButtonDate.md#addchild)
- [addChildAt](DButtonDate.md#addchildat)
- [addListener](DButtonDate.md#addlistener)
- [applyTitle](DButtonDate.md#applytitle)
- [blur](DButtonDate.md#blur)
- [calculateBounds](DButtonDate.md#calculatebounds)
- [computeTextValue](DButtonDate.md#computetextvalue)
- [containsGlobalPoint](DButtonDate.md#containsglobalpoint)
- [containsLocalPoint](DButtonDate.md#containslocalpoint)
- [containsPoint](DButtonDate.md#containspoint)
- [createOrUpdateText](DButtonDate.md#createorupdatetext)
- [createText](DButtonDate.md#createtext)
- [destroy](DButtonDate.md#destroy)
- [displayObjectUpdateTransform](DButtonDate.md#displayobjectupdatetransform)
- [emit](DButtonDate.md#emit)
- [eventNames](DButtonDate.md#eventnames)
- [focus](DButtonDate.md#focus)
- [focusOnClosest](DButtonDate.md#focusonclosest)
- [getBounds](DButtonDate.md#getbounds)
- [getChildAt](DButtonDate.md#getchildat)
- [getChildByName](DButtonDate.md#getchildbyname)
- [getChildIndex](DButtonDate.md#getchildindex)
- [getClearType](DButtonDate.md#getcleartype)
- [getClippingRect](DButtonDate.md#getclippingrect)
- [getGlobalPosition](DButtonDate.md#getglobalposition)
- [getHeight](DButtonDate.md#getheight)
- [getLocalBounds](DButtonDate.md#getlocalbounds)
- [getOverflowMask](DButtonDate.md#getoverflowmask)
- [getParentOfSize](DButtonDate.md#getparentofsize)
- [getTextAlpha](DButtonDate.md#gettextalpha)
- [getTextColor](DButtonDate.md#gettextcolor)
- [getThemeDefault](DButtonDate.md#getthemedefault)
- [getType](DButtonDate.md#gettype)
- [getWidth](DButtonDate.md#getwidth)
- [getX](DButtonDate.md#getx)
- [getY](DButtonDate.md#gety)
- [hasDirty](DButtonDate.md#hasdirty)
- [hasRefitableHeight](DButtonDate.md#hasrefitableheight)
- [hasRefitableWidth](DButtonDate.md#hasrefitablewidth)
- [hide](DButtonDate.md#hide)
- [hideText](DButtonDate.md#hidetext)
- [init](DButtonDate.md#init)
- [initOnClick](DButtonDate.md#initonclick)
- [initOnPress](DButtonDate.md#initonpress)
- [initReflowable](DButtonDate.md#initreflowable)
- [isDirty](DButtonDate.md#isdirty)
- [isEventTarget](DButtonDate.md#iseventtarget)
- [isHidden](DButtonDate.md#ishidden)
- [isHierarchyDirty](DButtonDate.md#ishierarchydirty)
- [isRefitable](DButtonDate.md#isrefitable)
- [isShown](DButtonDate.md#isshown)
- [listenerCount](DButtonDate.md#listenercount)
- [listeners](DButtonDate.md#listeners)
- [newDialog](DButtonDate.md#newdialog)
- [newImage](DButtonDate.md#newimage)
- [newImages](DButtonDate.md#newimages)
- [off](DButtonDate.md#off)
- [on](DButtonDate.md#on)
- [onActivate](DButtonDate.md#onactivate)
- [onActivateKeyDown](DButtonDate.md#onactivatekeydown)
- [onActivateKeyUp](DButtonDate.md#onactivatekeyup)
- [onBlur](DButtonDate.md#onblur)
- [onChildBlur](DButtonDate.md#onchildblur)
- [onChildFocus](DButtonDate.md#onchildfocus)
- [onChildrenChange](DButtonDate.md#onchildrenchange)
- [onClick](DButtonDate.md#onclick)
- [onDblClick](DButtonDate.md#ondblclick)
- [onDown](DButtonDate.md#ondown)
- [onDownThis](DButtonDate.md#ondownthis)
- [onFocus](DButtonDate.md#onfocus)
- [onHierarchyDirty](DButtonDate.md#onhierarchydirty)
- [onInactivate](DButtonDate.md#oninactivate)
- [onKeyDown](DButtonDate.md#onkeydown)
- [onKeyUp](DButtonDate.md#onkeyup)
- [onMove](DButtonDate.md#onmove)
- [onOut](DButtonDate.md#onout)
- [onOver](DButtonDate.md#onover)
- [onParentMove](DButtonDate.md#onparentmove)
- [onParentResize](DButtonDate.md#onparentresize)
- [onRefit](DButtonDate.md#onrefit)
- [onReflow](DButtonDate.md#onreflow)
- [onResize](DButtonDate.md#onresize)
- [onScale](DButtonDate.md#onscale)
- [onShortcut](DButtonDate.md#onshortcut)
- [onSkew](DButtonDate.md#onskew)
- [onStateChange](DButtonDate.md#onstatechange)
- [onTextChange](DButtonDate.md#ontextchange)
- [onToggleEnd](DButtonDate.md#ontoggleend)
- [onToggleStart](DButtonDate.md#ontogglestart)
- [onUp](DButtonDate.md#onup)
- [onUpThis](DButtonDate.md#onupthis)
- [onValueChange](DButtonDate.md#onvaluechange)
- [onWheel](DButtonDate.md#onwheel)
- [once](DButtonDate.md#once)
- [reflow](DButtonDate.md#reflow)
- [removeAllListeners](DButtonDate.md#removealllisteners)
- [removeChild](DButtonDate.md#removechild)
- [removeChildAt](DButtonDate.md#removechildat)
- [removeChildren](DButtonDate.md#removechildren)
- [removeListener](DButtonDate.md#removelistener)
- [render](DButtonDate.md#render)
- [renderAdvanced](DButtonDate.md#renderadvanced)
- [resize](DButtonDate.md#resize)
- [setChildIndex](DButtonDate.md#setchildindex)
- [setFocused](DButtonDate.md#setfocused)
- [setHeight](DButtonDate.md#setheight)
- [setParent](DButtonDate.md#setparent)
- [setTransform](DButtonDate.md#settransform)
- [setWidth](DButtonDate.md#setwidth)
- [setX](DButtonDate.md#setx)
- [setY](DButtonDate.md#sety)
- [show](DButtonDate.md#show)
- [showText](DButtonDate.md#showtext)
- [sortChildren](DButtonDate.md#sortchildren)
- [swapChildren](DButtonDate.md#swapchildren)
- [toCursor](DButtonDate.md#tocursor)
- [toDirty](DButtonDate.md#todirty)
- [toGlobal](DButtonDate.md#toglobal)
- [toHasDirty](DButtonDate.md#tohasdirty)
- [toHierarchyDirty](DButtonDate.md#tohierarchydirty)
- [toImageOptions](DButtonDate.md#toimageoptions)
- [toLocal](DButtonDate.md#tolocal)
- [toParentHasDirty](DButtonDate.md#toparenthasdirty)
- [toParentHierarchyDirty](DButtonDate.md#toparenthierarchydirty)
- [toParentResized](DButtonDate.md#toparentresized)
- [toggle](DButtonDate.md#toggle)
- [updateText](DButtonDate.md#updatetext)
- [updateTextAndImage](DButtonDate.md#updatetextandimage)
- [updateTextColor](DButtonDate.md#updatetextcolor)
- [updateTextPosition](DButtonDate.md#updatetextposition)
- [updateTextValue](DButtonDate.md#updatetextvalue)
- [updateTransform](DButtonDate.md#updatetransform)
- [mixin](DButtonDate.md#mixin)

## Constructors

### constructor

• **new DButtonDate**<`THEME`, `OPTIONS`\>(`options?`)

#### Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeButtonDate`](../interfaces/DThemeButtonDate.md)<`THEME`\> = [`DThemeButtonDate`](../interfaces/DThemeButtonDate.md) |
| `OPTIONS` | extends [`DButtonDateOptions`](../interfaces/DButtonDateOptions.md)<`THEME`, `any`, `OPTIONS`\> = [`DButtonDateOptions`](../interfaces/DButtonDateOptions.md)<`THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:53](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-date.ts#L53)
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:52](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-date.ts#L52)
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:74](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-date.ts#L74)
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:98](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-date.ts#L98)
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:102](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-date.ts#L102)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DButtonDate`](DButtonDate.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DButtonDate`](DButtonDate.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DButtonDate`](DButtonDate.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:109](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-date.ts#L109)
...
▸ **hide**(): [`DButtonDate`](DButtonDate.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:94](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-date.ts#L94)
...
▸ **off**(`event`, `fn?`, `context?`): [`DButtonDate`](DButtonDate.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DButtonDate`](DButtonDate.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:55](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-date.ts#L55)
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:69](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-date.ts#L69)
...
▸ **once**(`event`, `fn`, `context?`): [`DButtonDate`](DButtonDate.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DButtonDate`](DButtonDate.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DButtonDate`](DButtonDate.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DButtonDate`](DButtonDate.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DButtonDate`](DButtonDate.md)<`THEME`, `OPTIONS`\>
