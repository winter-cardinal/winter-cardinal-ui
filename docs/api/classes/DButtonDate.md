[Winter Cardinal UI - v0.374.0](../index.md) / DButtonDate
...
- [newPadding](DButtonDate.md#newpadding)
- [newText](DButtonDate.md#newtext)
...
• **new DButtonDate**\<`THEME`, `OPTIONS`\>(`options?`): [`DButtonDate`](DButtonDate.md)\<`THEME`, `OPTIONS`\>
...
| :------ | :------ |
| `THEME` | extends [`DThemeButtonDate`](../interfaces/DThemeButtonDate.md) = [`DThemeButtonDate`](../interfaces/DThemeButtonDate.md) |
| `OPTIONS` | extends [`DButtonDateOptions`](../interfaces/DButtonDateOptions.md)\<`THEME`, `any`\> = [`DButtonDateOptions`](../interfaces/DButtonDateOptions.md)\<`THEME`, `any`\> |
...
▸ **setFocused**(`isFocused`): [`DButtonDate`](DButtonDate.md)\<`THEME`, `OPTIONS`\>
