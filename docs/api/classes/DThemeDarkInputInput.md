[Winter Cardinal UI - v0.414.0](../index.md) / DThemeDarkInputInput
...
- [getElementStyleClipPath](DThemeDarkInputInput.md#getelementstyleclippath)
...
- [getImageRotation](DThemeDarkInputInput.md#getimagerotation)
...
- [getSecondaryImageRotation](DThemeDarkInputInput.md#getsecondaryimagerotation)
...
- [getTertiaryImageRotation](DThemeDarkInputInput.md#gettertiaryimagerotation)
...
- [getTextStyleFitting](DThemeDarkInputInput.md#gettextstylefitting)
...
- [getY](DThemeDarkInputInput.md#gety)
...
• **new DThemeDarkInputInput**\<`VALUE`\>(): [`DThemeDarkInputInput`](DThemeDarkInputInput.md)\<`VALUE`\>
...
[`DThemeDarkInputInput`](DThemeDarkInputInput.md)\<`VALUE`\>
