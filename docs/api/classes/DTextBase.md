[Winter Cardinal UI - v0.374.0](../index.md) / DTextBase
...
- [newPadding](DTextBase.md#newpadding)
- [newText](DTextBase.md#newtext)
...
• **new DTextBase**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DTextBase`](DTextBase.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeTextBase`](../interfaces/DThemeTextBase.md)\<`VALUE`\> = [`DThemeTextBase`](../interfaces/DThemeTextBase.md)\<`VALUE`\> |
| `OPTIONS` | extends [`DTextBaseOptions`](../interfaces/DTextBaseOptions.md)\<`VALUE`, `THEME`, `any`\> = [`DTextBaseOptions`](../interfaces/DTextBaseOptions.md)\<`VALUE`, `THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-text-base.ts:400](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-text-base.ts#L400)
...
▸ **setFocused**(`isFocused`): [`DTextBase`](DTextBase.md)\<`VALUE`, `THEME`, `OPTIONS`\>
