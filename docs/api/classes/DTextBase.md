[Winter Cardinal UI - v0.167.0](../index.md) / DTextBase

# Class: DTextBase<VALUE, THEME, OPTIONS\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeTextBase`](../interfaces/DThemeTextBase.md)<`VALUE`\> = [`DThemeTextBase`](../interfaces/DThemeTextBase.md)<`VALUE`\> |
| `OPTIONS` | extends [`DTextBaseOptions`](../interfaces/DTextBaseOptions.md)<`VALUE`, `THEME`\> = [`DTextBaseOptions`](../interfaces/DTextBaseOptions.md)<`VALUE`, `THEME`\> |
...
- [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DImageBase`](DImageBase.md)

  ↳↳ [`DSliderLabel`](DSliderLabel.md)

  ↳↳ [`DSliderValue`](DSliderValue.md)
...
- [constructor](DTextBase.md#constructor)

### Properties

- [\_accessibleActive](DTextBase.md#_accessibleactive)
- [\_accessibleDiv](DTextBase.md#_accessiblediv)
- [\_auto](DTextBase.md#_auto)
- [\_background](DTextBase.md#_background)
- [\_border](DTextBase.md#_border)
- [\_bounds](DTextBase.md#_bounds)
- [\_clearType](DTextBase.md#_cleartype)
- [\_corner](DTextBase.md#_corner)
- [\_cursor](DTextBase.md#_cursor)
- [\_destroyed](DTextBase.md#_destroyed)
- [\_isOverflowMaskEnabled](DTextBase.md#_isoverflowmaskenabled)
- [\_isTextVisible](DTextBase.md#_istextvisible)
- [\_lastDownPoint](DTextBase.md#_lastdownpoint)
- [\_lastSortedIndex](DTextBase.md#_lastsortedindex)
- [\_mask](DTextBase.md#_mask)
- [\_options](DTextBase.md#_options)
- [\_outline](DTextBase.md#_outline)
- [\_overflowMask](DTextBase.md#_overflowmask)
- [\_padding](DTextBase.md#_padding)
- [\_reflowable](DTextBase.md#_reflowable)
- [\_shortcuts](DTextBase.md#_shortcuts)
- [\_snippet](DTextBase.md#_snippet)
- [\_tempDisplayObjectParent](DTextBase.md#_tempdisplayobjectparent)
- [\_text](DTextBase.md#_text)
- [\_textAlign](DTextBase.md#_textalign)
- [\_textAlpha](DTextBase.md#_textalpha)
- [\_textColor](DTextBase.md#_textcolor)
- [\_textFormatter](DTextBase.md#_textformatter)
- [\_textStyle](DTextBase.md#_textstyle)
- [\_textValue](DTextBase.md#_textvalue)
- [\_textValueComputed](DTextBase.md#_textvaluecomputed)
- [\_title](DTextBase.md#_title)
- [\_zIndex](DTextBase.md#_zindex)
- [accessible](DTextBase.md#accessible)
- [accessibleChildren](DTextBase.md#accessiblechildren)
- [accessibleHint](DTextBase.md#accessiblehint)
- [accessiblePointerEvents](DTextBase.md#accessiblepointerevents)
- [accessibleTitle](DTextBase.md#accessibletitle)
- [accessibleType](DTextBase.md#accessibletype)
- [alpha](DTextBase.md#alpha)
- [angle](DTextBase.md#angle)
- [buttonMode](DTextBase.md#buttonmode)
- [cacheAsBitmap](DTextBase.md#cacheasbitmap)
- [children](DTextBase.md#children)
- [cursor](DTextBase.md#cursor)
- [filterArea](DTextBase.md#filterarea)
- [filters](DTextBase.md#filters)
- [hitArea](DTextBase.md#hitarea)
- [interactive](DTextBase.md#interactive)
- [interactiveChildren](DTextBase.md#interactivechildren)
- [isMask](DTextBase.md#ismask)
- [isSprite](DTextBase.md#issprite)
- [localTransform](DTextBase.md#localtransform)
- [mask](DTextBase.md#mask)
- [name](DTextBase.md#name)
- [parent](DTextBase.md#parent)
- [pivot](DTextBase.md#pivot)
- [renderable](DTextBase.md#renderable)
- [rotation](DTextBase.md#rotation)
- [sortDirty](DTextBase.md#sortdirty)
- [sortableChildren](DTextBase.md#sortablechildren)
- [transform](DTextBase.md#transform)
- [visible](DTextBase.md#visible)
- [worldAlpha](DTextBase.md#worldalpha)
- [worldTransform](DTextBase.md#worldtransform)
- [worldVisible](DTextBase.md#worldvisible)
- [zIndex](DTextBase.md#zindex)
- [WORK\_CONTAINS\_POINT](DTextBase.md#work_contains_point)

### Accessors

- [background](DTextBase.md#background)
- [border](DTextBase.md#border)
- [corner](DTextBase.md#corner)
- [height](DTextBase.md#height)
- [outline](DTextBase.md#outline)
- [padding](DTextBase.md#padding)
- [position](DTextBase.md#position)
- [reflowable](DTextBase.md#reflowable)
- [scale](DTextBase.md#scale)
- [shadow](DTextBase.md#shadow)
- [skew](DTextBase.md#skew)
- [snippet](DTextBase.md#snippet)
- [state](DTextBase.md#state)
- [text](DTextBase.md#text)
- [theme](DTextBase.md#theme)
- [title](DTextBase.md#title)
- [type](DTextBase.md#type)
- [unsafe](DTextBase.md#unsafe)
- [weight](DTextBase.md#weight)
- [width](DTextBase.md#width)
- [x](DTextBase.md#x)
- [y](DTextBase.md#y)

### Methods

- [\_calculateBounds](DTextBase.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DTextBase.md#_recursivepostupdatetransform)
- [\_render](DTextBase.md#_render)
- [addChild](DTextBase.md#addchild)
- [addChildAt](DTextBase.md#addchildat)
- [addListener](DTextBase.md#addlistener)
- [applyTitle](DTextBase.md#applytitle)
- [blur](DTextBase.md#blur)
- [calculateBounds](DTextBase.md#calculatebounds)
- [computeTextValue](DTextBase.md#computetextvalue)
- [containsGlobalPoint](DTextBase.md#containsglobalpoint)
- [containsLocalPoint](DTextBase.md#containslocalpoint)
- [containsPoint](DTextBase.md#containspoint)
- [createOrUpdateText](DTextBase.md#createorupdatetext)
- [createText](DTextBase.md#createtext)
- [destroy](DTextBase.md#destroy)
- [displayObjectUpdateTransform](DTextBase.md#displayobjectupdatetransform)
- [emit](DTextBase.md#emit)
- [eventNames](DTextBase.md#eventnames)
- [focus](DTextBase.md#focus)
- [focusOnClosest](DTextBase.md#focusonclosest)
- [getBounds](DTextBase.md#getbounds)
- [getChildAt](DTextBase.md#getchildat)
- [getChildByName](DTextBase.md#getchildbyname)
- [getChildIndex](DTextBase.md#getchildindex)
- [getClearType](DTextBase.md#getcleartype)
- [getClippingRect](DTextBase.md#getclippingrect)
- [getGlobalPosition](DTextBase.md#getglobalposition)
- [getHeight](DTextBase.md#getheight)
- [getLocalBounds](DTextBase.md#getlocalbounds)
- [getOverflowMask](DTextBase.md#getoverflowmask)
- [getParentOfSize](DTextBase.md#getparentofsize)
- [getTextAlpha](DTextBase.md#gettextalpha)
- [getTextColor](DTextBase.md#gettextcolor)
- [getThemeDefault](DTextBase.md#getthemedefault)
- [getType](DTextBase.md#gettype)
- [getWidth](DTextBase.md#getwidth)
- [getX](DTextBase.md#getx)
- [getY](DTextBase.md#gety)
- [hasDirty](DTextBase.md#hasdirty)
- [hasRefitableHeight](DTextBase.md#hasrefitableheight)
- [hasRefitableWidth](DTextBase.md#hasrefitablewidth)
- [hide](DTextBase.md#hide)
- [hideText](DTextBase.md#hidetext)
- [init](DTextBase.md#init)
- [initReflowable](DTextBase.md#initreflowable)
- [isDirty](DTextBase.md#isdirty)
- [isEventTarget](DTextBase.md#iseventtarget)
- [isHidden](DTextBase.md#ishidden)
- [isHierarchyDirty](DTextBase.md#ishierarchydirty)
- [isRefitable](DTextBase.md#isrefitable)
- [isShown](DTextBase.md#isshown)
- [listenerCount](DTextBase.md#listenercount)
- [listeners](DTextBase.md#listeners)
- [off](DTextBase.md#off)
- [on](DTextBase.md#on)
- [onBlur](DTextBase.md#onblur)
- [onChildBlur](DTextBase.md#onchildblur)
- [onChildFocus](DTextBase.md#onchildfocus)
- [onChildrenChange](DTextBase.md#onchildrenchange)
- [onDblClick](DTextBase.md#ondblclick)
- [onDown](DTextBase.md#ondown)
- [onDownThis](DTextBase.md#ondownthis)
- [onFocus](DTextBase.md#onfocus)
- [onHierarchyDirty](DTextBase.md#onhierarchydirty)
- [onKeyDown](DTextBase.md#onkeydown)
- [onKeyUp](DTextBase.md#onkeyup)
- [onMove](DTextBase.md#onmove)
- [onOut](DTextBase.md#onout)
- [onOver](DTextBase.md#onover)
- [onParentMove](DTextBase.md#onparentmove)
- [onParentResize](DTextBase.md#onparentresize)
- [onRefit](DTextBase.md#onrefit)
- [onReflow](DTextBase.md#onreflow)
- [onResize](DTextBase.md#onresize)
- [onScale](DTextBase.md#onscale)
- [onShortcut](DTextBase.md#onshortcut)
- [onSkew](DTextBase.md#onskew)
- [onStateChange](DTextBase.md#onstatechange)
- [onTextChange](DTextBase.md#ontextchange)
- [onUp](DTextBase.md#onup)
- [onUpThis](DTextBase.md#onupthis)
- [onWheel](DTextBase.md#onwheel)
- [once](DTextBase.md#once)
- [reflow](DTextBase.md#reflow)
- [removeAllListeners](DTextBase.md#removealllisteners)
- [removeChild](DTextBase.md#removechild)
- [removeChildAt](DTextBase.md#removechildat)
- [removeChildren](DTextBase.md#removechildren)
- [removeListener](DTextBase.md#removelistener)
- [render](DTextBase.md#render)
- [renderAdvanced](DTextBase.md#renderadvanced)
- [resize](DTextBase.md#resize)
- [setChildIndex](DTextBase.md#setchildindex)
- [setFocused](DTextBase.md#setfocused)
- [setHeight](DTextBase.md#setheight)
- [setParent](DTextBase.md#setparent)
- [setTransform](DTextBase.md#settransform)
- [setWidth](DTextBase.md#setwidth)
- [setX](DTextBase.md#setx)
- [setY](DTextBase.md#sety)
- [show](DTextBase.md#show)
- [showText](DTextBase.md#showtext)
- [sortChildren](DTextBase.md#sortchildren)
- [swapChildren](DTextBase.md#swapchildren)
- [toCursor](DTextBase.md#tocursor)
- [toDirty](DTextBase.md#todirty)
- [toGlobal](DTextBase.md#toglobal)
- [toHasDirty](DTextBase.md#tohasdirty)
- [toHierarchyDirty](DTextBase.md#tohierarchydirty)
- [toLocal](DTextBase.md#tolocal)
- [toParentHasDirty](DTextBase.md#toparenthasdirty)
- [toParentHierarchyDirty](DTextBase.md#toparenthierarchydirty)
- [toParentResized](DTextBase.md#toparentresized)
- [updateText](DTextBase.md#updatetext)
- [updateTextColor](DTextBase.md#updatetextcolor)
- [updateTextPosition](DTextBase.md#updatetextposition)
- [updateTextValue](DTextBase.md#updatetextvalue)
- [updateTransform](DTextBase.md#updatetransform)
- [mixin](DTextBase.md#mixin)

## Constructors

### constructor

• **new DTextBase**<`VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeTextBase`](../interfaces/DThemeTextBase.md)<`VALUE`, `THEME`\> = [`DThemeTextBase`](../interfaces/DThemeTextBase.md)<`VALUE`\> |
| `OPTIONS` | extends [`DTextBaseOptions`](../interfaces/DTextBaseOptions.md)<`VALUE`, `THEME`, `any`, `OPTIONS`\> = [`DTextBaseOptions`](../interfaces/DTextBaseOptions.md)<`VALUE`, `THEME`, `any`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DTextBase`](DTextBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DTextBase`](DTextBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DTextBase`](DTextBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-text-base.ts:395](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-text-base.ts#L395)
...
▸ **hide**(): [`DTextBase`](DTextBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DTextBase`](DTextBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DTextBase`](DTextBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DTextBase`](DTextBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DTextBase`](DTextBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DTextBase`](DTextBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DTextBase`](DTextBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DTextBase`](DTextBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
