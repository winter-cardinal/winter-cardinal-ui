[Winter Cardinal UI - v0.407.0](../index.md) / DTextBase
...
- [\_boundsID](DTextBase.md#_boundsid)
- [\_boundsRect](DTextBase.md#_boundsrect)
...
- [\_enabledFilters](DTextBase.md#_enabledfilters)
- [\_lastDownPoint](DTextBase.md#_lastdownpoint)
- [\_lastSortedIndex](DTextBase.md#_lastsortedindex)
- [\_localBounds](DTextBase.md#_localbounds)
- [\_localBoundsRect](DTextBase.md#_localboundsrect)
...
- [LAYOUTER](DTextBase.md#layouter)
...
- [containerUpdateTransform](DTextBase.md#containerupdatetransform)
...
- [disableTempParent](DTextBase.md#disabletempparent)
- [displayObjectUpdateTransform](DTextBase.md#displayobjectupdatetransform)
- [emit](DTextBase.md#emit)
- [enableTempParent](DTextBase.md#enabletempparent)
...
- [getLayouter](DTextBase.md#getlayouter)
...
- [newOverflowMask](DTextBase.md#newoverflowmask)
...
- [onReflowTextAndImage](DTextBase.md#onreflowtextandimage)
...
[src/main/typescript/wcardinal/ui/d-text-base.ts:148](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-text-base.ts#L148)
