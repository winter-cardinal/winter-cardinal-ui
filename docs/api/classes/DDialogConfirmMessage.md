[Winter Cardinal UI - v0.407.0](../index.md) / DDialogConfirmMessage
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm-message.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-confirm-message.ts#L18)
...
▸ **setFocused**(`isFocused`): [`DDialogConfirmMessage`](DDialogConfirmMessage.md)\<`THEME`, `OPTIONS`\>
