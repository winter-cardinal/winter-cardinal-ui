[Winter Cardinal UI - v0.167.0](../index.md) / DDialogConfirmMessage
...
▸ **blur**(`recursively?`): [`DDialogConfirmMessage`](DDialogConfirmMessage.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm-message.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dialog-confirm-message.ts#L18)
...
▸ **once**(`event`, `fn`, `context?`): [`DDialogConfirmMessage`](DDialogConfirmMessage.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DDialogConfirmMessage`](DDialogConfirmMessage.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DDialogConfirmMessage`](DDialogConfirmMessage.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DDialogConfirmMessage`](DDialogConfirmMessage.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DDialogConfirmMessage`](DDialogConfirmMessage.md)<`THEME`, `OPTIONS`\>
