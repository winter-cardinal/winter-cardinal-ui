[Winter Cardinal UI - v0.155.0](../index.md) / DDialogConfirmMessage
...
- [\_isChildrenDirty](DDialogConfirmMessage.md#_ischildrendirty)
...
- [isChildrenDirty](DDialogConfirmMessage.md#ischildrendirty)
...
- [onChildrenDirty](DDialogConfirmMessage.md#onchildrendirty)
...
- [refit](DDialogConfirmMessage.md#refit)
...
- [toChildrenDirty](DDialogConfirmMessage.md#tochildrendirty)
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm-message.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-dialog-confirm-message.ts#L18)
