[Winter Cardinal UI - v0.407.0](../index.md) / DThemeWhiteNote
...
- [getImageRotation](DThemeWhiteNote.md#getimagerotation)
...
- [getSecondaryImageRotation](DThemeWhiteNote.md#getsecondaryimagerotation)
...
- [getTertiaryImageRotation](DThemeWhiteNote.md#gettertiaryimagerotation)
...
- [getTextStyleFitting](DThemeWhiteNote.md#gettextstylefitting)
...
• **new DThemeWhiteNote**(): [`DThemeWhiteNote`](DThemeWhiteNote.md)
