[Winter Cardinal UI - v0.407.0](../index.md) / DPickerDatetimeLabel
...
- [\_boundsID](DPickerDatetimeLabel.md#_boundsid)
- [\_boundsRect](DPickerDatetimeLabel.md#_boundsrect)
...
- [\_enabledFilters](DPickerDatetimeLabel.md#_enabledfilters)
- [\_lastDownPoint](DPickerDatetimeLabel.md#_lastdownpoint)
- [\_lastSortedIndex](DPickerDatetimeLabel.md#_lastsortedindex)
- [\_localBounds](DPickerDatetimeLabel.md#_localbounds)
- [\_localBoundsRect](DPickerDatetimeLabel.md#_localboundsrect)
...
- [LAYOUTER](DPickerDatetimeLabel.md#layouter)
...
- [options](DPickerDatetimeLabel.md#options)
...
- [containerUpdateTransform](DPickerDatetimeLabel.md#containerupdatetransform)
...
- [disableTempParent](DPickerDatetimeLabel.md#disabletempparent)
- [displayObjectUpdateTransform](DPickerDatetimeLabel.md#displayobjectupdatetransform)
- [emit](DPickerDatetimeLabel.md#emit)
- [enableTempParent](DPickerDatetimeLabel.md#enabletempparent)
...
- [getLayouter](DPickerDatetimeLabel.md#getlayouter)
...
- [getText](DPickerDatetimeLabel.md#gettext)
...
- [newOverflowMask](DPickerDatetimeLabel.md#newoverflowmask)
- [newPadding](DPickerDatetimeLabel.md#newpadding)
- [newText](DPickerDatetimeLabel.md#newtext)
...
- [onReflowTextAndImage](DPickerDatetimeLabel.md#onreflowtextandimage)
...
• **new DPickerDatetimeLabel**\<`THEME`, `OPTIONS`\>(`options?`): [`DPickerDatetimeLabel`](DPickerDatetimeLabel.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-picker-datetime-label.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-picker-datetime-label.ts#L18)
...
▸ **setFocused**(`isFocused`): [`DPickerDatetimeLabel`](DPickerDatetimeLabel.md)\<`THEME`, `OPTIONS`\>
