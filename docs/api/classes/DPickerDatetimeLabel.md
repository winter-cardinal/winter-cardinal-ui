[Winter Cardinal UI](../README.md) / DPickerDatetimeLabel
...
- [\_isChildrenDirty](DPickerDatetimeLabel.md#_ischildrendirty)
...
- [isChildrenDirty](DPickerDatetimeLabel.md#ischildrendirty)
...
- [onChildrenDirty](DPickerDatetimeLabel.md#onchildrendirty)
...
- [refit](DPickerDatetimeLabel.md#refit)
...
- [toChildrenDirty](DPickerDatetimeLabel.md#tochildrendirty)
...
• `Protected` `Optional` **\_textValue**: [`DStateAwareOrValueMightBe`](../README.md#dstateawareorvaluemightbe)<`Date`\>
...
[src/main/typescript/wcardinal/ui/d-picker-datetime-label.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-picker-datetime-label.ts#L18)
