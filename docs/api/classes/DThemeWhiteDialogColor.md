[Winter Cardinal UI - v0.414.0](../index.md) / DThemeWhiteDialogColor
...
- [getContent](DThemeWhiteDialogColor.md#getcontent)
...
• **new DThemeWhiteDialogColor**(): [`DThemeWhiteDialogColor`](DThemeWhiteDialogColor.md)
