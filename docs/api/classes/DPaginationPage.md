[Winter Cardinal UI - v0.374.0](../index.md) / DPaginationPage
...
- [newPadding](DPaginationPage.md#newpadding)
- [newText](DPaginationPage.md#newtext)
...
• **new DPaginationPage**\<`THEME`, `OPTIONS`\>(`options?`): [`DPaginationPage`](DPaginationPage.md)\<`THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DPaginationPage`](DPaginationPage.md)\<`THEME`, `OPTIONS`\>
