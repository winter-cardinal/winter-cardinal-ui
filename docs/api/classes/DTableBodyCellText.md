[Winter Cardinal UI - v0.167.0](../index.md) / DTableBodyCellText

# Class: DTableBodyCellText<ROW, VALUE, THEME, OPTIONS\>
...
| `ROW` | `ROW` |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeTableBodyCellText`](../interfaces/DThemeTableBodyCellText.md)<`VALUE`\> = [`DThemeTableBodyCellText`](../interfaces/DThemeTableBodyCellText.md)<`VALUE`\> |
| `OPTIONS` | extends [`DTableBodyCellTextOptions`](../interfaces/DTableBodyCellTextOptions.md)<`ROW`, `VALUE`, `THEME`\> = [`DTableBodyCellTextOptions`](../interfaces/DTableBodyCellTextOptions.md)<`ROW`, `VALUE`, `THEME`\> |
...
- [`DImageBase`](DImageBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DTableBodyCellButton`](DTableBodyCellButton.md)
...
- [constructor](DTableBodyCellText.md#constructor)

### Properties

- [\_accessibleActive](DTableBodyCellText.md#_accessibleactive)
- [\_accessibleDiv](DTableBodyCellText.md#_accessiblediv)
- [\_auto](DTableBodyCellText.md#_auto)
- [\_background](DTableBodyCellText.md#_background)
- [\_border](DTableBodyCellText.md#_border)
- [\_bounds](DTableBodyCellText.md#_bounds)
- [\_clearType](DTableBodyCellText.md#_cleartype)
- [\_column](DTableBodyCellText.md#_column)
- [\_columnIndex](DTableBodyCellText.md#_columnindex)
- [\_corner](DTableBodyCellText.md#_corner)
- [\_cursor](DTableBodyCellText.md#_cursor)
- [\_destroyed](DTableBodyCellText.md#_destroyed)
- [\_images](DTableBodyCellText.md#_images)
- [\_isOverflowMaskEnabled](DTableBodyCellText.md#_isoverflowmaskenabled)
- [\_isTextVisible](DTableBodyCellText.md#_istextvisible)
- [\_lastDownPoint](DTableBodyCellText.md#_lastdownpoint)
- [\_lastSortedIndex](DTableBodyCellText.md#_lastsortedindex)
- [\_mask](DTableBodyCellText.md#_mask)
- [\_onChange](DTableBodyCellText.md#_onchange)
- [\_options](DTableBodyCellText.md#_options)
- [\_outline](DTableBodyCellText.md#_outline)
- [\_overflowMask](DTableBodyCellText.md#_overflowmask)
- [\_padding](DTableBodyCellText.md#_padding)
- [\_reflowable](DTableBodyCellText.md#_reflowable)
- [\_row](DTableBodyCellText.md#_row)
- [\_rowIndex](DTableBodyCellText.md#_rowindex)
- [\_shortcuts](DTableBodyCellText.md#_shortcuts)
- [\_snippet](DTableBodyCellText.md#_snippet)
- [\_tempDisplayObjectParent](DTableBodyCellText.md#_tempdisplayobjectparent)
- [\_text](DTableBodyCellText.md#_text)
- [\_textAlign](DTableBodyCellText.md#_textalign)
- [\_textAlpha](DTableBodyCellText.md#_textalpha)
- [\_textColor](DTableBodyCellText.md#_textcolor)
- [\_textFormatter](DTableBodyCellText.md#_textformatter)
- [\_textStyle](DTableBodyCellText.md#_textstyle)
- [\_textValue](DTableBodyCellText.md#_textvalue)
- [\_textValueComputed](DTableBodyCellText.md#_textvaluecomputed)
- [\_title](DTableBodyCellText.md#_title)
- [\_zIndex](DTableBodyCellText.md#_zindex)
- [accessible](DTableBodyCellText.md#accessible)
- [accessibleChildren](DTableBodyCellText.md#accessiblechildren)
- [accessibleHint](DTableBodyCellText.md#accessiblehint)
- [accessiblePointerEvents](DTableBodyCellText.md#accessiblepointerevents)
- [accessibleTitle](DTableBodyCellText.md#accessibletitle)
- [accessibleType](DTableBodyCellText.md#accessibletype)
- [alpha](DTableBodyCellText.md#alpha)
- [angle](DTableBodyCellText.md#angle)
- [buttonMode](DTableBodyCellText.md#buttonmode)
- [cacheAsBitmap](DTableBodyCellText.md#cacheasbitmap)
- [children](DTableBodyCellText.md#children)
- [cursor](DTableBodyCellText.md#cursor)
- [filterArea](DTableBodyCellText.md#filterarea)
- [filters](DTableBodyCellText.md#filters)
- [hitArea](DTableBodyCellText.md#hitarea)
- [interactive](DTableBodyCellText.md#interactive)
- [interactiveChildren](DTableBodyCellText.md#interactivechildren)
- [isMask](DTableBodyCellText.md#ismask)
- [isSprite](DTableBodyCellText.md#issprite)
- [localTransform](DTableBodyCellText.md#localtransform)
- [mask](DTableBodyCellText.md#mask)
- [name](DTableBodyCellText.md#name)
- [parent](DTableBodyCellText.md#parent)
- [pivot](DTableBodyCellText.md#pivot)
- [renderable](DTableBodyCellText.md#renderable)
- [rotation](DTableBodyCellText.md#rotation)
- [sortDirty](DTableBodyCellText.md#sortdirty)
- [sortableChildren](DTableBodyCellText.md#sortablechildren)
- [transform](DTableBodyCellText.md#transform)
- [visible](DTableBodyCellText.md#visible)
- [worldAlpha](DTableBodyCellText.md#worldalpha)
- [worldTransform](DTableBodyCellText.md#worldtransform)
- [worldVisible](DTableBodyCellText.md#worldvisible)
- [zIndex](DTableBodyCellText.md#zindex)
- [LAYOUTER](DTableBodyCellText.md#layouter)
- [WORK\_CONTAINS\_POINT](DTableBodyCellText.md#work_contains_point)

### Accessors

- [background](DTableBodyCellText.md#background)
- [border](DTableBodyCellText.md#border)
- [column](DTableBodyCellText.md#column)
- [columnIndex](DTableBodyCellText.md#columnindex)
- [corner](DTableBodyCellText.md#corner)
- [height](DTableBodyCellText.md#height)
- [image](DTableBodyCellText.md#image)
- [outline](DTableBodyCellText.md#outline)
- [padding](DTableBodyCellText.md#padding)
- [position](DTableBodyCellText.md#position)
- [reflowable](DTableBodyCellText.md#reflowable)
- [row](DTableBodyCellText.md#row)
- [rowIndex](DTableBodyCellText.md#rowindex)
- [scale](DTableBodyCellText.md#scale)
- [shadow](DTableBodyCellText.md#shadow)
- [skew](DTableBodyCellText.md#skew)
- [snippet](DTableBodyCellText.md#snippet)
- [state](DTableBodyCellText.md#state)
- [text](DTableBodyCellText.md#text)
- [theme](DTableBodyCellText.md#theme)
- [title](DTableBodyCellText.md#title)
- [type](DTableBodyCellText.md#type)
- [unsafe](DTableBodyCellText.md#unsafe)
- [weight](DTableBodyCellText.md#weight)
- [width](DTableBodyCellText.md#width)
- [x](DTableBodyCellText.md#x)
- [y](DTableBodyCellText.md#y)

### Methods

- [\_calculateBounds](DTableBodyCellText.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DTableBodyCellText.md#_recursivepostupdatetransform)
- [\_render](DTableBodyCellText.md#_render)
- [addChild](DTableBodyCellText.md#addchild)
- [addChildAt](DTableBodyCellText.md#addchildat)
- [addListener](DTableBodyCellText.md#addlistener)
- [applyTitle](DTableBodyCellText.md#applytitle)
- [blur](DTableBodyCellText.md#blur)
- [calculateBounds](DTableBodyCellText.md#calculatebounds)
- [computeTextValue](DTableBodyCellText.md#computetextvalue)
- [containsGlobalPoint](DTableBodyCellText.md#containsglobalpoint)
- [containsLocalPoint](DTableBodyCellText.md#containslocalpoint)
- [containsPoint](DTableBodyCellText.md#containspoint)
- [createOrUpdateText](DTableBodyCellText.md#createorupdatetext)
- [createText](DTableBodyCellText.md#createtext)
- [destroy](DTableBodyCellText.md#destroy)
- [displayObjectUpdateTransform](DTableBodyCellText.md#displayobjectupdatetransform)
- [emit](DTableBodyCellText.md#emit)
- [eventNames](DTableBodyCellText.md#eventnames)
- [focus](DTableBodyCellText.md#focus)
- [focusOnClosest](DTableBodyCellText.md#focusonclosest)
- [getBounds](DTableBodyCellText.md#getbounds)
- [getChildAt](DTableBodyCellText.md#getchildat)
- [getChildByName](DTableBodyCellText.md#getchildbyname)
- [getChildIndex](DTableBodyCellText.md#getchildindex)
- [getClearType](DTableBodyCellText.md#getcleartype)
- [getClippingRect](DTableBodyCellText.md#getclippingrect)
- [getGlobalPosition](DTableBodyCellText.md#getglobalposition)
- [getHeight](DTableBodyCellText.md#getheight)
- [getLocalBounds](DTableBodyCellText.md#getlocalbounds)
- [getOverflowMask](DTableBodyCellText.md#getoverflowmask)
- [getParentOfSize](DTableBodyCellText.md#getparentofsize)
- [getTextAlpha](DTableBodyCellText.md#gettextalpha)
- [getTextColor](DTableBodyCellText.md#gettextcolor)
- [getThemeDefault](DTableBodyCellText.md#getthemedefault)
- [getType](DTableBodyCellText.md#gettype)
- [getWidth](DTableBodyCellText.md#getwidth)
- [getX](DTableBodyCellText.md#getx)
- [getY](DTableBodyCellText.md#gety)
- [hasDirty](DTableBodyCellText.md#hasdirty)
- [hasRefitableHeight](DTableBodyCellText.md#hasrefitableheight)
- [hasRefitableWidth](DTableBodyCellText.md#hasrefitablewidth)
- [hide](DTableBodyCellText.md#hide)
- [hideText](DTableBodyCellText.md#hidetext)
- [init](DTableBodyCellText.md#init)
- [initReflowable](DTableBodyCellText.md#initreflowable)
- [isDirty](DTableBodyCellText.md#isdirty)
- [isEventTarget](DTableBodyCellText.md#iseventtarget)
- [isHidden](DTableBodyCellText.md#ishidden)
- [isHierarchyDirty](DTableBodyCellText.md#ishierarchydirty)
- [isRefitable](DTableBodyCellText.md#isrefitable)
- [isShown](DTableBodyCellText.md#isshown)
- [listenerCount](DTableBodyCellText.md#listenercount)
- [listeners](DTableBodyCellText.md#listeners)
- [newImage](DTableBodyCellText.md#newimage)
- [newImages](DTableBodyCellText.md#newimages)
- [off](DTableBodyCellText.md#off)
- [on](DTableBodyCellText.md#on)
- [onBlur](DTableBodyCellText.md#onblur)
- [onChildBlur](DTableBodyCellText.md#onchildblur)
- [onChildFocus](DTableBodyCellText.md#onchildfocus)
- [onChildrenChange](DTableBodyCellText.md#onchildrenchange)
- [onDblClick](DTableBodyCellText.md#ondblclick)
- [onDown](DTableBodyCellText.md#ondown)
- [onDownThis](DTableBodyCellText.md#ondownthis)
- [onFocus](DTableBodyCellText.md#onfocus)
- [onHierarchyDirty](DTableBodyCellText.md#onhierarchydirty)
- [onKeyDown](DTableBodyCellText.md#onkeydown)
- [onKeyUp](DTableBodyCellText.md#onkeyup)
- [onMove](DTableBodyCellText.md#onmove)
- [onOut](DTableBodyCellText.md#onout)
- [onOver](DTableBodyCellText.md#onover)
- [onParentMove](DTableBodyCellText.md#onparentmove)
- [onParentResize](DTableBodyCellText.md#onparentresize)
- [onRefit](DTableBodyCellText.md#onrefit)
- [onReflow](DTableBodyCellText.md#onreflow)
- [onResize](DTableBodyCellText.md#onresize)
- [onScale](DTableBodyCellText.md#onscale)
- [onShortcut](DTableBodyCellText.md#onshortcut)
- [onSkew](DTableBodyCellText.md#onskew)
- [onStateChange](DTableBodyCellText.md#onstatechange)
- [onTextChange](DTableBodyCellText.md#ontextchange)
- [onUp](DTableBodyCellText.md#onup)
- [onUpThis](DTableBodyCellText.md#onupthis)
- [onWheel](DTableBodyCellText.md#onwheel)
- [once](DTableBodyCellText.md#once)
- [reflow](DTableBodyCellText.md#reflow)
- [removeAllListeners](DTableBodyCellText.md#removealllisteners)
- [removeChild](DTableBodyCellText.md#removechild)
- [removeChildAt](DTableBodyCellText.md#removechildat)
- [removeChildren](DTableBodyCellText.md#removechildren)
- [removeListener](DTableBodyCellText.md#removelistener)
- [render](DTableBodyCellText.md#render)
- [renderAdvanced](DTableBodyCellText.md#renderadvanced)
- [resize](DTableBodyCellText.md#resize)
- [set](DTableBodyCellText.md#set)
- [setChildIndex](DTableBodyCellText.md#setchildindex)
- [setFocused](DTableBodyCellText.md#setfocused)
- [setHeight](DTableBodyCellText.md#setheight)
- [setParent](DTableBodyCellText.md#setparent)
- [setTransform](DTableBodyCellText.md#settransform)
- [setWidth](DTableBodyCellText.md#setwidth)
- [setX](DTableBodyCellText.md#setx)
- [setY](DTableBodyCellText.md#sety)
- [show](DTableBodyCellText.md#show)
- [showText](DTableBodyCellText.md#showtext)
- [sortChildren](DTableBodyCellText.md#sortchildren)
- [swapChildren](DTableBodyCellText.md#swapchildren)
- [toCursor](DTableBodyCellText.md#tocursor)
- [toDirty](DTableBodyCellText.md#todirty)
- [toGlobal](DTableBodyCellText.md#toglobal)
- [toHasDirty](DTableBodyCellText.md#tohasdirty)
- [toHierarchyDirty](DTableBodyCellText.md#tohierarchydirty)
- [toImageOptions](DTableBodyCellText.md#toimageoptions)
- [toLocal](DTableBodyCellText.md#tolocal)
- [toParentHasDirty](DTableBodyCellText.md#toparenthasdirty)
- [toParentHierarchyDirty](DTableBodyCellText.md#toparenthierarchydirty)
- [toParentResized](DTableBodyCellText.md#toparentresized)
- [unset](DTableBodyCellText.md#unset)
- [updateText](DTableBodyCellText.md#updatetext)
- [updateTextAndImage](DTableBodyCellText.md#updatetextandimage)
- [updateTextColor](DTableBodyCellText.md#updatetextcolor)
- [updateTextPosition](DTableBodyCellText.md#updatetextposition)
- [updateTextValue](DTableBodyCellText.md#updatetextvalue)
- [updateTransform](DTableBodyCellText.md#updatetransform)
- [mixin](DTableBodyCellText.md#mixin)

## Constructors

### constructor

• **new DTableBodyCellText**<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>(`columnIndex`, `column`, `onChange`, `options?`)
...
| `ROW` | `ROW` |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeTableBodyCellText`](../interfaces/DThemeTableBodyCellText.md)<`VALUE`, `THEME`\> = [`DThemeTableBodyCellText`](../interfaces/DThemeTableBodyCellText.md)<`VALUE`\> |
| `OPTIONS` | extends [`DTableBodyCellTextOptions`](../interfaces/DTableBodyCellTextOptions.md)<`ROW`, `VALUE`, `THEME`, `OPTIONS`\> = [`DTableBodyCellTextOptions`](../interfaces/DTableBodyCellTextOptions.md)<`ROW`, `VALUE`, `THEME`\> |
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts:39](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts#L39)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts:36](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts#L36)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts:35](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts#L35)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts:37](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts#L37)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts:33](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts#L33)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts:34](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts#L34)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts:65](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts#L65)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts:61](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts#L61)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts:53](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts#L53)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts:57](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts#L57)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DTableBodyCellText`](DTableBodyCellText.md)<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DTableBodyCellText`](DTableBodyCellText.md)<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DTableBodyCellText`](DTableBodyCellText.md)<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts:91](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts#L91)
...
▸ **hide**(): [`DTableBodyCellText`](DTableBodyCellText.md)<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DTableBodyCellText`](DTableBodyCellText.md)<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DTableBodyCellText`](DTableBodyCellText.md)<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DTableBodyCellText`](DTableBodyCellText.md)<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DTableBodyCellText`](DTableBodyCellText.md)<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DTableBodyCellText`](DTableBodyCellText.md)<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts:69](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts#L69)
...
▸ `Protected` **setFocused**(`isFocused`): [`DTableBodyCellText`](DTableBodyCellText.md)<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DTableBodyCellText`](DTableBodyCellText.md)<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts:86](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts#L86)
