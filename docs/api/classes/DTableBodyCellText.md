[Winter Cardinal UI - v0.407.0](../index.md) / DTableBodyCellText
...
- [`DImageBase`](DImageBase.md)\<`VALUE`, `THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DTableBodyCellTextArea`](DTableBodyCellTextArea.md)
...
- [\_boundsID](DTableBodyCellText.md#_boundsid)
- [\_boundsRect](DTableBodyCellText.md#_boundsrect)
...
- [\_enabledFilters](DTableBodyCellText.md#_enabledfilters)
- [\_image](DTableBodyCellText.md#_image)
- [\_lastDownPoint](DTableBodyCellText.md#_lastdownpoint)
- [\_lastSortedIndex](DTableBodyCellText.md#_lastsortedindex)
- [\_localBounds](DTableBodyCellText.md#_localbounds)
- [\_localBoundsRect](DTableBodyCellText.md#_localboundsrect)
...
- [containerUpdateTransform](DTableBodyCellText.md#containerupdatetransform)
...
- [disableTempParent](DTableBodyCellText.md#disabletempparent)
- [displayObjectUpdateTransform](DTableBodyCellText.md#displayobjectupdatetransform)
- [emit](DTableBodyCellText.md#emit)
- [enableTempParent](DTableBodyCellText.md#enabletempparent)
...
- [getImage](DTableBodyCellText.md#getimage)
- [getLayouter](DTableBodyCellText.md#getlayouter)
...
- [getText](DTableBodyCellText.md#gettext)
...
- [newOverflowMask](DTableBodyCellText.md#newoverflowmask)
- [newPadding](DTableBodyCellText.md#newpadding)
- [newText](DTableBodyCellText.md#newtext)
...
- [onReflowTextAndImage](DTableBodyCellText.md#onreflowtextandimage)
...
• **new DTableBodyCellText**\<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>(`columnIndex`, `column`, `onChange`, `options?`): [`DTableBodyCellText`](DTableBodyCellText.md)\<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts:89](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-table-body-cell-text.ts#L89)
...
▸ **setFocused**(`isFocused`): [`DTableBodyCellText`](DTableBodyCellText.md)\<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>
