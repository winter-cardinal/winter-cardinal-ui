[Winter Cardinal UI - v0.407.0](../index.md) / DInputReal
...
[src/main/typescript/wcardinal/ui/d-input-real.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-input-real.ts#L17)
...
▸ **setFocused**(`isFocused`): [`DInputReal`](DInputReal.md)\<`THEME`, `OPTIONS`\>
