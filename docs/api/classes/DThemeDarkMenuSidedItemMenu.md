[Winter Cardinal UI - v0.167.0](../index.md) / DThemeDarkMenuSidedItemMenu
...
- [getPaddingRight](DThemeDarkMenuSidedItemMenu.md#getpaddingright)
...
• **new DThemeDarkMenuSidedItemMenu**()
