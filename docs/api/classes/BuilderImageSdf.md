[Winter Cardinal UI - v0.165.0](../index.md) / BuilderImageSdf
...
- [constructor](BuilderImageSdf.md#constructor)

### Properties

- [alphaFill](BuilderImageSdf.md#alphafill)
- [alphaStroke](BuilderImageSdf.md#alphastroke)
- [colorFill](BuilderImageSdf.md#colorfill)
- [colorStroke](BuilderImageSdf.md#colorstroke)
- [indexCount](BuilderImageSdf.md#indexcount)
- [indexOffset](BuilderImageSdf.md#indexoffset)
- [sizeX](BuilderImageSdf.md#sizex)
- [sizeY](BuilderImageSdf.md#sizey)
- [strokeAlign](BuilderImageSdf.md#strokealign)
- [strokeSide](BuilderImageSdf.md#strokeside)
- [strokeStyle](BuilderImageSdf.md#strokestyle)
- [strokeWidth](BuilderImageSdf.md#strokewidth)
- [texture](BuilderImageSdf.md#texture)
- [textureHeight](BuilderImageSdf.md#textureheight)
- [textureTransformId](BuilderImageSdf.md#texturetransformid)
- [textureWidth](BuilderImageSdf.md#texturewidth)
- [transformLocalId](BuilderImageSdf.md#transformlocalid)
- [vertexCount](BuilderImageSdf.md#vertexcount)
- [vertexOffset](BuilderImageSdf.md#vertexoffset)

### Methods

- [buildUnit](BuilderImageSdf.md#buildunit)
- [init](BuilderImageSdf.md#init)
- [isCompatible](BuilderImageSdf.md#iscompatible)
- [update](BuilderImageSdf.md#update)
- [updateColorFill](BuilderImageSdf.md#updatecolorfill)
- [updateColorStroke](BuilderImageSdf.md#updatecolorstroke)
- [updateUv](BuilderImageSdf.md#updateuv)
- [updateVertexAndStep](BuilderImageSdf.md#updatevertexandstep)

## Constructors

### constructor

• **new BuilderImageSdf**(`vertexOffset`, `indexOffset`)
...
[src/main/typescript/wcardinal/ui/shape/variant/builder-image-sdf.ts:25](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/shape/variant/builder-image-sdf.ts#L25)
...
[src/main/typescript/wcardinal/ui/shape/variant/builder-image-sdf.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/shape/variant/builder-image-sdf.ts#L23)
...
[src/main/typescript/wcardinal/ui/shape/variant/builder-image-sdf.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/shape/variant/builder-image-sdf.ts#L22)
...
[src/main/typescript/wcardinal/ui/shape/variant/builder-image-sdf.ts:31](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/shape/variant/builder-image-sdf.ts#L31)
...
[src/main/typescript/wcardinal/ui/shape/variant/builder-image-sdf.ts:39](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/shape/variant/builder-image-sdf.ts#L39)
...
[src/main/typescript/wcardinal/ui/shape/variant/builder-image-sdf.ts:108](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/shape/variant/builder-image-sdf.ts#L108)
...
[src/main/typescript/wcardinal/ui/shape/variant/builder-image-sdf.ts:46](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/shape/variant/builder-image-sdf.ts#L46)
