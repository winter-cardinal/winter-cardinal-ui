[Winter Cardinal UI - v0.407.0](../index.md) / DImage
...
- [\_boundsID](DImage.md#_boundsid)
- [\_boundsRect](DImage.md#_boundsrect)
- [\_clearType](DImage.md#_cleartype)
- [\_corner](DImage.md#_corner)
- [\_cursor](DImage.md#_cursor)
- [\_destroyed](DImage.md#_destroyed)
- [\_enabledFilters](DImage.md#_enabledfilters)
- [\_image](DImage.md#_image)
- [\_lastDownPoint](DImage.md#_lastdownpoint)
- [\_lastSortedIndex](DImage.md#_lastsortedindex)
- [\_localBounds](DImage.md#_localbounds)
- [\_localBoundsRect](DImage.md#_localboundsrect)
...
- [containerUpdateTransform](DImage.md#containerupdatetransform)
...
- [disableTempParent](DImage.md#disabletempparent)
- [displayObjectUpdateTransform](DImage.md#displayobjectupdatetransform)
- [emit](DImage.md#emit)
- [enableTempParent](DImage.md#enabletempparent)
...
- [getImage](DImage.md#getimage)
- [getLayouter](DImage.md#getlayouter)
...
- [newOverflowMask](DImage.md#newoverflowmask)
- [newPadding](DImage.md#newpadding)
- [newText](DImage.md#newtext)
- [off](DImage.md#off)
- [on](DImage.md#on)
...
- [onReflowTextAndImage](DImage.md#onreflowtextandimage)
...
• **new DImage**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DImage`](DImage.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-image.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-image.ts#L20)
...
▸ **setFocused**(`isFocused`): [`DImage`](DImage.md)\<`VALUE`, `THEME`, `OPTIONS`\>
