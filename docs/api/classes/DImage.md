[Winter Cardinal UI - v0.167.0](../index.md) / DImage
...
- [\_textAlign](DImage.md#_textalign)
...
- [isHierarchyDirty](DImage.md#ishierarchydirty)
...
- [onHierarchyDirty](DImage.md#onhierarchydirty)
...
[src/main/typescript/wcardinal/ui/d-image.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-image.ts#L20)
...
▸ **once**(`event`, `fn`, `context?`): [`DImage`](DImage.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DImage`](DImage.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DImage`](DImage.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DImage`](DImage.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DImage`](DImage.md)<`VALUE`, `THEME`, `OPTIONS`\>
