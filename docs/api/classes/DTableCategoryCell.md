[Winter Cardinal UI - v0.155.0](../index.md) / DTableCategoryCell
...
- [\_isChildrenDirty](DTableCategoryCell.md#_ischildrendirty)
...
- [isChildrenDirty](DTableCategoryCell.md#ischildrendirty)
...
- [onChildrenDirty](DTableCategoryCell.md#onchildrendirty)
...
- [refit](DTableCategoryCell.md#refit)
...
- [toChildrenDirty](DTableCategoryCell.md#tochildrendirty)
...
[src/main/typescript/wcardinal/ui/d-table-category-cell.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-table-category-cell.ts#L18)
