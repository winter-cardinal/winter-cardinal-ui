[Winter Cardinal UI - v0.167.0](../index.md) / DTableCategoryCell
...
- [\_images](DTableCategoryCell.md#_images)
- [\_isOverflowMaskEnabled](DTableCategoryCell.md#_isoverflowmaskenabled)
- [\_isTextVisible](DTableCategoryCell.md#_istextvisible)
...
- [\_textAlign](DTableCategoryCell.md#_textalign)
- [\_textAlpha](DTableCategoryCell.md#_textalpha)
- [\_textColor](DTableCategoryCell.md#_textcolor)
- [\_textFormatter](DTableCategoryCell.md#_textformatter)
- [\_textStyle](DTableCategoryCell.md#_textstyle)
- [\_textValue](DTableCategoryCell.md#_textvalue)
- [\_textValueComputed](DTableCategoryCell.md#_textvaluecomputed)
...
- [computeTextValue](DTableCategoryCell.md#computetextvalue)
...
- [createOrUpdateText](DTableCategoryCell.md#createorupdatetext)
- [createText](DTableCategoryCell.md#createtext)
...
- [getTextAlpha](DTableCategoryCell.md#gettextalpha)
- [getTextColor](DTableCategoryCell.md#gettextcolor)
...
- [hideText](DTableCategoryCell.md#hidetext)
...
- [newImages](DTableCategoryCell.md#newimages)
...
- [onTextChange](DTableCategoryCell.md#ontextchange)
...
- [showText](DTableCategoryCell.md#showtext)
...
- [toImageOptions](DTableCategoryCell.md#toimageoptions)
...
- [updateText](DTableCategoryCell.md#updatetext)
- [updateTextAndImage](DTableCategoryCell.md#updatetextandimage)
- [updateTextColor](DTableCategoryCell.md#updatetextcolor)
- [updateTextPosition](DTableCategoryCell.md#updatetextposition)
- [updateTextValue](DTableCategoryCell.md#updatetextvalue)
...
• **new DTableCategoryCell**<`THEME`, `OPTIONS`\>(`options?`)

#### Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeTableCategoryCell`](../interfaces/DThemeTableCategoryCell.md)<`THEME`\> = [`DThemeTableCategoryCell`](../interfaces/DThemeTableCategoryCell.md) |
| `OPTIONS` | extends [`DTableCategoryCellOptions`](../interfaces/DTableCategoryCellOptions.md)<`THEME`, `OPTIONS`\> = [`DTableCategoryCellOptions`](../interfaces/DTableCategoryCellOptions.md)<`THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DTableCategoryCell`](DTableCategoryCell.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DTableCategoryCell`](DTableCategoryCell.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DTableCategoryCell`](DTableCategoryCell.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-table-category-cell.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-category-cell.ts#L18)
...
▸ **hide**(): [`DTableCategoryCell`](DTableCategoryCell.md)<`THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DTableCategoryCell`](DTableCategoryCell.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DTableCategoryCell`](DTableCategoryCell.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DTableCategoryCell`](DTableCategoryCell.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DTableCategoryCell`](DTableCategoryCell.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DTableCategoryCell`](DTableCategoryCell.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DTableCategoryCell`](DTableCategoryCell.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DTableCategoryCell`](DTableCategoryCell.md)<`THEME`, `OPTIONS`\>
