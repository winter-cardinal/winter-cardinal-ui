[Winter Cardinal UI - v0.374.0](../index.md) / DTableCategoryCell
...
• **new DTableCategoryCell**\<`THEME`, `OPTIONS`\>(`options?`): [`DTableCategoryCell`](DTableCategoryCell.md)\<`THEME`, `OPTIONS`\>
...
▸ **computeTextValue**(): `undefined` \| ``null`` \| `string`
...
▸ **setFocused**(`isFocused`): [`DTableCategoryCell`](DTableCategoryCell.md)\<`THEME`, `OPTIONS`\>
