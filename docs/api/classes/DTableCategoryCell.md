[Winter Cardinal UI](../README.md) / DTableCategoryCell
...
• `Protected` `Optional` **\_textValue**: [`DStateAwareOrValueMightBe`](../README.md#dstateawareorvaluemightbe)<``null`` \| `string`\>
...
[src/main/typescript/wcardinal/ui/d-table-category-cell.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-table-category-cell.ts#L18)
