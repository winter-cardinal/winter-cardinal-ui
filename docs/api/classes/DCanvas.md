[Winter Cardinal UI - v0.407.0](../index.md) / DCanvas
...
- [containerUpdateTransform](DCanvas.md#containerupdatetransform)
...
- [disableTempParent](DCanvas.md#disabletempparent)
- [displayObjectUpdateTransform](DCanvas.md#displayobjectupdatetransform)
- [emit](DCanvas.md#emit)
- [enableTempParent](DCanvas.md#enabletempparent)
...
- [newPadding](DCanvas.md#newpadding)
- [off](DCanvas.md#off)
- [on](DCanvas.md#on)
...
• **new DCanvas**\<`THEME`, `OPTIONS`\>(`options?`): [`DCanvas`](DCanvas.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-canvas.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-canvas.ts#L17)
...
▸ **setFocused**(`isFocused`): [`DCanvas`](DCanvas.md)\<`THEME`, `OPTIONS`\>
