[Winter Cardinal UI - v0.160.0](../index.md) / DCanvas
...
- [\_calculateBounds](DCanvas.md#_calculatebounds)
...
- [onParentResize](DCanvas.md#onparentresize)
...
[src/main/typescript/wcardinal/ui/d-canvas.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-canvas.ts#L17)
...
▸ **off**(`event`, `fn?`, `context?`): [`DCanvas`](DCanvas.md)<`THEME`, `OPTIONS`\>
