[Winter Cardinal UI - v0.407.0](../index.md) / DInputLabel
...
- [\_boundsID](DInputLabel.md#_boundsid)
- [\_boundsRect](DInputLabel.md#_boundsrect)
...
- [\_enabledFilters](DInputLabel.md#_enabledfilters)
- [\_lastDownPoint](DInputLabel.md#_lastdownpoint)
- [\_lastSortedIndex](DInputLabel.md#_lastsortedindex)
- [\_localBounds](DInputLabel.md#_localbounds)
- [\_localBoundsRect](DInputLabel.md#_localboundsrect)
...
- [LAYOUTER](DInputLabel.md#layouter)
...
- [containerUpdateTransform](DInputLabel.md#containerupdatetransform)
...
- [disableTempParent](DInputLabel.md#disabletempparent)
- [displayObjectUpdateTransform](DInputLabel.md#displayobjectupdatetransform)
- [emit](DInputLabel.md#emit)
- [enableTempParent](DInputLabel.md#enabletempparent)
...
- [getLayouter](DInputLabel.md#getlayouter)
...
- [getText](DInputLabel.md#gettext)
...
- [newOverflowMask](DInputLabel.md#newoverflowmask)
- [newPadding](DInputLabel.md#newpadding)
- [newText](DInputLabel.md#newtext)
...
- [onReflowTextAndImage](DInputLabel.md#onreflowtextandimage)
...
• **new DInputLabel**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DInputLabel`](DInputLabel.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-input-label.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-input-label.ts#L20)
...
▸ **setFocused**(`isFocused`): [`DInputLabel`](DInputLabel.md)\<`VALUE`, `THEME`, `OPTIONS`\>
