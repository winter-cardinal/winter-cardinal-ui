[Winter Cardinal UI - v0.160.0](../index.md) / DDialogColorGradient

# Class: DDialogColorGradient<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeDialogColorGradient`](../interfaces/DThemeDialogColorGradient.md) = [`DThemeDialogColorGradient`](../interfaces/DThemeDialogColorGradient.md) |
| `OPTIONS` | extends [`DDialogColorGradientOptions`](../interfaces/DDialogColorGradientOptions.md)<`THEME`\> = [`DDialogColorGradientOptions`](../interfaces/DDialogColorGradientOptions.md)<`THEME`\> |

## Hierarchy

- [`DDialogCommand`](DDialogCommand.md)<[`DColorGradient`](../interfaces/DColorGradient.md), `THEME`, `OPTIONS`\>

  ↳ **`DDialogColorGradient`**

## Table of contents

### Constructors

- [constructor](DDialogColorGradient.md#constructor)

### Properties

- [\_accessibleActive](DDialogColorGradient.md#_accessibleactive)
- [\_accessibleDiv](DDialogColorGradient.md#_accessiblediv)
- [\_align](DDialogColorGradient.md#_align)
- [\_animation](DDialogColorGradient.md#_animation)
- [\_auto](DDialogColorGradient.md#_auto)
- [\_background](DDialogColorGradient.md#_background)
- [\_border](DDialogColorGradient.md#_border)
- [\_bounds](DDialogColorGradient.md#_bounds)
- [\_buttonCancel](DDialogColorGradient.md#_buttoncancel)
- [\_buttonLayout](DDialogColorGradient.md#_buttonlayout)
- [\_buttonOk](DDialogColorGradient.md#_buttonok)
- [\_clearType](DDialogColorGradient.md#_cleartype)
- [\_closeOn](DDialogColorGradient.md#_closeon)
- [\_corner](DDialogColorGradient.md#_corner)
- [\_cursor](DDialogColorGradient.md#_cursor)
- [\_destroyed](DDialogColorGradient.md#_destroyed)
- [\_focused](DDialogColorGradient.md#_focused)
- [\_lastDownPoint](DDialogColorGradient.md#_lastdownpoint)
- [\_lastSortedIndex](DDialogColorGradient.md#_lastsortedindex)
- [\_mask](DDialogColorGradient.md#_mask)
- [\_mode](DDialogColorGradient.md#_mode)
- [\_onPrerenderBound](DDialogColorGradient.md#_onprerenderbound)
- [\_options](DDialogColorGradient.md#_options)
- [\_outline](DDialogColorGradient.md#_outline)
- [\_overlay](DDialogColorGradient.md#_overlay)
- [\_owner](DDialogColorGradient.md#_owner)
- [\_padding](DDialogColorGradient.md#_padding)
- [\_picker](DDialogColorGradient.md#_picker)
- [\_promise](DDialogColorGradient.md#_promise)
- [\_reflowable](DDialogColorGradient.md#_reflowable)
- [\_reject](DDialogColorGradient.md#_reject)
- [\_resolve](DDialogColorGradient.md#_resolve)
- [\_shortcuts](DDialogColorGradient.md#_shortcuts)
- [\_snippet](DDialogColorGradient.md#_snippet)
- [\_sticky](DDialogColorGradient.md#_sticky)
- [\_tempDisplayObjectParent](DDialogColorGradient.md#_tempdisplayobjectparent)
- [\_title](DDialogColorGradient.md#_title)
- [\_zIndex](DDialogColorGradient.md#_zindex)
- [accessible](DDialogColorGradient.md#accessible)
- [accessibleChildren](DDialogColorGradient.md#accessiblechildren)
- [accessibleHint](DDialogColorGradient.md#accessiblehint)
- [accessiblePointerEvents](DDialogColorGradient.md#accessiblepointerevents)
- [accessibleTitle](DDialogColorGradient.md#accessibletitle)
- [accessibleType](DDialogColorGradient.md#accessibletype)
- [alpha](DDialogColorGradient.md#alpha)
- [angle](DDialogColorGradient.md#angle)
- [buttonMode](DDialogColorGradient.md#buttonmode)
- [cacheAsBitmap](DDialogColorGradient.md#cacheasbitmap)
- [children](DDialogColorGradient.md#children)
- [cursor](DDialogColorGradient.md#cursor)
- [filterArea](DDialogColorGradient.md#filterarea)
- [filters](DDialogColorGradient.md#filters)
- [hitArea](DDialogColorGradient.md#hitarea)
- [interactive](DDialogColorGradient.md#interactive)
- [interactiveChildren](DDialogColorGradient.md#interactivechildren)
- [isMask](DDialogColorGradient.md#ismask)
- [isSprite](DDialogColorGradient.md#issprite)
- [localTransform](DDialogColorGradient.md#localtransform)
- [mask](DDialogColorGradient.md#mask)
- [name](DDialogColorGradient.md#name)
- [parent](DDialogColorGradient.md#parent)
- [pivot](DDialogColorGradient.md#pivot)
- [renderable](DDialogColorGradient.md#renderable)
- [rotation](DDialogColorGradient.md#rotation)
- [sortDirty](DDialogColorGradient.md#sortdirty)
- [sortableChildren](DDialogColorGradient.md#sortablechildren)
- [transform](DDialogColorGradient.md#transform)
- [visible](DDialogColorGradient.md#visible)
- [worldAlpha](DDialogColorGradient.md#worldalpha)
- [worldTransform](DDialogColorGradient.md#worldtransform)
- [worldVisible](DDialogColorGradient.md#worldvisible)
- [zIndex](DDialogColorGradient.md#zindex)
- [WORK\_CONTAINS\_POINT](DDialogColorGradient.md#work_contains_point)

### Accessors

- [background](DDialogColorGradient.md#background)
- [border](DDialogColorGradient.md#border)
- [corner](DDialogColorGradient.md#corner)
- [height](DDialogColorGradient.md#height)
- [outline](DDialogColorGradient.md#outline)
- [padding](DDialogColorGradient.md#padding)
- [picker](DDialogColorGradient.md#picker)
- [position](DDialogColorGradient.md#position)
- [recent](DDialogColorGradient.md#recent)
- [reflowable](DDialogColorGradient.md#reflowable)
- [scale](DDialogColorGradient.md#scale)
- [shadow](DDialogColorGradient.md#shadow)
- [skew](DDialogColorGradient.md#skew)
- [snippet](DDialogColorGradient.md#snippet)
- [state](DDialogColorGradient.md#state)
- [theme](DDialogColorGradient.md#theme)
- [title](DDialogColorGradient.md#title)
- [type](DDialogColorGradient.md#type)
- [unsafe](DDialogColorGradient.md#unsafe)
- [value](DDialogColorGradient.md#value)
- [weight](DDialogColorGradient.md#weight)
- [width](DDialogColorGradient.md#width)
- [x](DDialogColorGradient.md#x)
- [y](DDialogColorGradient.md#y)

### Methods

- [\_calculateBounds](DDialogColorGradient.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DDialogColorGradient.md#_recursivepostupdatetransform)
- [\_render](DDialogColorGradient.md#_render)
- [addChild](DDialogColorGradient.md#addchild)
- [addChildAt](DDialogColorGradient.md#addchildat)
- [addListener](DDialogColorGradient.md#addlistener)
- [applyTitle](DDialogColorGradient.md#applytitle)
- [blur](DDialogColorGradient.md#blur)
- [calculateBounds](DDialogColorGradient.md#calculatebounds)
- [cancel](DDialogColorGradient.md#cancel)
- [close](DDialogColorGradient.md#close)
- [containsGlobalPoint](DDialogColorGradient.md#containsglobalpoint)
- [containsLocalPoint](DDialogColorGradient.md#containslocalpoint)
- [containsPoint](DDialogColorGradient.md#containspoint)
- [destroy](DDialogColorGradient.md#destroy)
- [displayObjectUpdateTransform](DDialogColorGradient.md#displayobjectupdatetransform)
- [doReject](DDialogColorGradient.md#doreject)
- [doResolve](DDialogColorGradient.md#doresolve)
- [emit](DDialogColorGradient.md#emit)
- [eventNames](DDialogColorGradient.md#eventnames)
- [focus](DDialogColorGradient.md#focus)
- [focusOnClosest](DDialogColorGradient.md#focusonclosest)
- [getAnimation](DDialogColorGradient.md#getanimation)
- [getBounds](DDialogColorGradient.md#getbounds)
- [getChildAt](DDialogColorGradient.md#getchildat)
- [getChildByName](DDialogColorGradient.md#getchildbyname)
- [getChildIndex](DDialogColorGradient.md#getchildindex)
- [getClearType](DDialogColorGradient.md#getcleartype)
- [getClippingRect](DDialogColorGradient.md#getclippingrect)
- [getGlobalPosition](DDialogColorGradient.md#getglobalposition)
- [getHeight](DDialogColorGradient.md#getheight)
- [getLocalBounds](DDialogColorGradient.md#getlocalbounds)
- [getParentOfSize](DDialogColorGradient.md#getparentofsize)
- [getRejectReason](DDialogColorGradient.md#getrejectreason)
- [getResolvedValue](DDialogColorGradient.md#getresolvedvalue)
- [getThemeDefault](DDialogColorGradient.md#getthemedefault)
- [getType](DDialogColorGradient.md#gettype)
- [getWidth](DDialogColorGradient.md#getwidth)
- [getX](DDialogColorGradient.md#getx)
- [getY](DDialogColorGradient.md#gety)
- [hasDirty](DDialogColorGradient.md#hasdirty)
- [hasRefitableHeight](DDialogColorGradient.md#hasrefitableheight)
- [hasRefitableWidth](DDialogColorGradient.md#hasrefitablewidth)
- [hide](DDialogColorGradient.md#hide)
- [init](DDialogColorGradient.md#init)
- [initReflowable](DDialogColorGradient.md#initreflowable)
- [isDirty](DDialogColorGradient.md#isdirty)
- [isEventTarget](DDialogColorGradient.md#iseventtarget)
- [isHidden](DDialogColorGradient.md#ishidden)
- [isHierarchyDirty](DDialogColorGradient.md#ishierarchydirty)
- [isOpened](DDialogColorGradient.md#isopened)
- [isRefitable](DDialogColorGradient.md#isrefitable)
- [isShown](DDialogColorGradient.md#isshown)
- [listenerCount](DDialogColorGradient.md#listenercount)
- [listeners](DDialogColorGradient.md#listeners)
- [newLayout](DDialogColorGradient.md#newlayout)
- [off](DDialogColorGradient.md#off)
- [ok](DDialogColorGradient.md#ok)
- [on](DDialogColorGradient.md#on)
- [onAnimationEnd](DDialogColorGradient.md#onanimationend)
- [onBlur](DDialogColorGradient.md#onblur)
- [onCancel](DDialogColorGradient.md#oncancel)
- [onChildBlur](DDialogColorGradient.md#onchildblur)
- [onChildFocus](DDialogColorGradient.md#onchildfocus)
- [onChildrenChange](DDialogColorGradient.md#onchildrenchange)
- [onClose](DDialogColorGradient.md#onclose)
- [onCloseOn](DDialogColorGradient.md#oncloseon)
- [onDblClick](DDialogColorGradient.md#ondblclick)
- [onDown](DDialogColorGradient.md#ondown)
- [onDownThis](DDialogColorGradient.md#ondownthis)
- [onFocus](DDialogColorGradient.md#onfocus)
- [onHierarchyDirty](DDialogColorGradient.md#onhierarchydirty)
- [onInit](DDialogColorGradient.md#oninit)
- [onKeyDown](DDialogColorGradient.md#onkeydown)
- [onKeyUp](DDialogColorGradient.md#onkeyup)
- [onMove](DDialogColorGradient.md#onmove)
- [onOk](DDialogColorGradient.md#onok)
- [onOpen](DDialogColorGradient.md#onopen)
- [onOut](DDialogColorGradient.md#onout)
- [onOver](DDialogColorGradient.md#onover)
- [onParentMove](DDialogColorGradient.md#onparentmove)
- [onParentResize](DDialogColorGradient.md#onparentresize)
- [onPrerender](DDialogColorGradient.md#onprerender)
- [onRefit](DDialogColorGradient.md#onrefit)
- [onReflow](DDialogColorGradient.md#onreflow)
- [onResize](DDialogColorGradient.md#onresize)
- [onScale](DDialogColorGradient.md#onscale)
- [onShortcut](DDialogColorGradient.md#onshortcut)
- [onSkew](DDialogColorGradient.md#onskew)
- [onStateChange](DDialogColorGradient.md#onstatechange)
- [onUp](DDialogColorGradient.md#onup)
- [onUpThis](DDialogColorGradient.md#onupthis)
- [onWheel](DDialogColorGradient.md#onwheel)
- [once](DDialogColorGradient.md#once)
- [open](DDialogColorGradient.md#open)
- [reflow](DDialogColorGradient.md#reflow)
- [removeAllListeners](DDialogColorGradient.md#removealllisteners)
- [removeChild](DDialogColorGradient.md#removechild)
- [removeChildAt](DDialogColorGradient.md#removechildat)
- [removeChildren](DDialogColorGradient.md#removechildren)
- [removeListener](DDialogColorGradient.md#removelistener)
- [render](DDialogColorGradient.md#render)
- [renderAdvanced](DDialogColorGradient.md#renderadvanced)
- [resize](DDialogColorGradient.md#resize)
- [setChildIndex](DDialogColorGradient.md#setchildindex)
- [setFocused](DDialogColorGradient.md#setfocused)
- [setHeight](DDialogColorGradient.md#setheight)
- [setParent](DDialogColorGradient.md#setparent)
- [setTransform](DDialogColorGradient.md#settransform)
- [setWidth](DDialogColorGradient.md#setwidth)
- [setX](DDialogColorGradient.md#setx)
- [setY](DDialogColorGradient.md#sety)
- [show](DDialogColorGradient.md#show)
- [sortChildren](DDialogColorGradient.md#sortchildren)
- [swapChildren](DDialogColorGradient.md#swapchildren)
- [toCursor](DDialogColorGradient.md#tocursor)
- [toDirty](DDialogColorGradient.md#todirty)
- [toGlobal](DDialogColorGradient.md#toglobal)
- [toHasDirty](DDialogColorGradient.md#tohasdirty)
- [toHierarchyDirty](DDialogColorGradient.md#tohierarchydirty)
- [toLayoutOptions](DDialogColorGradient.md#tolayoutoptions)
- [toLocal](DDialogColorGradient.md#tolocal)
- [toParentHasDirty](DDialogColorGradient.md#toparenthasdirty)
- [toParentHierarchyDirty](DDialogColorGradient.md#toparenthierarchydirty)
- [toParentResized](DDialogColorGradient.md#toparentresized)
- [updateTransform](DDialogColorGradient.md#updatetransform)
- [mixin](DDialogColorGradient.md#mixin)

## Constructors

### constructor

• **new DDialogColorGradient**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemeDialogColorGradient`](../interfaces/DThemeDialogColorGradient.md) = [`DThemeDialogColorGradient`](../interfaces/DThemeDialogColorGradient.md) |
| `OPTIONS` | extends [`DDialogColorGradientOptions`](../interfaces/DDialogColorGradientOptions.md)<`THEME`, `OPTIONS`\> = [`DDialogColorGradientOptions`](../interfaces/DDialogColorGradientOptions.md)<`THEME`\> |
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:105](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L105)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:98](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L98)
...
[src/main/typescript/wcardinal/ui/d-dialog-command.ts:96](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-command.ts#L96)
...
[src/main/typescript/wcardinal/ui/d-dialog-command.ts:94](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-command.ts#L94)
...
[src/main/typescript/wcardinal/ui/d-dialog-command.ts:95](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-command.ts#L95)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:99](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L99)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:100](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L100)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:102](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L102)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:104](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L104)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:101](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L101)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:106](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L106)
...
• `Protected` `Optional` **\_picker**: [`DPickerColorGradient`](DPickerColorGradient.md)<[`DThemePickerColorGradient`](../interfaces/DThemePickerColorGradient.md), [`DPickerColorGradientOptions`](../interfaces/DPickerColorGradientOptions.md)<[`DThemePickerColorGradient`](../interfaces/DThemePickerColorGradient.md)\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts:25](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts#L25)

___

### \_promise

• `Protected` `Optional` **\_promise**: `Promise`<[`DColorGradient`](../interfaces/DColorGradient.md)\>
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:94](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L94)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:96](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L96)

___

### \_resolve

• `Protected` `Optional` **\_resolve**: (`value`: [`DColorGradient`](../interfaces/DColorGradient.md) \| `PromiseLike`<[`DColorGradient`](../interfaces/DColorGradient.md)\>) => `void`
...
| Name | Type |
| :------ | :------ |
| `value` | [`DColorGradient`](../interfaces/DColorGradient.md) \| `PromiseLike`<[`DColorGradient`](../interfaces/DColorGradient.md)\> |
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:95](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L95)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:103](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L103)
...
• `get` **picker**(): [`DPickerColorGradient`](DPickerColorGradient.md)<[`DThemePickerColorGradient`](../interfaces/DThemePickerColorGradient.md), [`DPickerColorGradientOptions`](../interfaces/DPickerColorGradientOptions.md)<[`DThemePickerColorGradient`](../interfaces/DThemePickerColorGradient.md)\>\>

#### Returns

[`DPickerColorGradient`](DPickerColorGradient.md)<[`DThemePickerColorGradient`](../interfaces/DThemePickerColorGradient.md), [`DPickerColorGradientOptions`](../interfaces/DPickerColorGradientOptions.md)<[`DThemePickerColorGradient`](../interfaces/DThemePickerColorGradient.md)\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts:51](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts#L51)
...
[src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts:47](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts#L47)
...
[src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts:43](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts#L43)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DDialogColorGradient`](DDialogColorGradient.md)<`THEME`, `OPTIONS`\>
...
[`DDialogColorGradient`](DDialogColorGradient.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DDialogColorGradient`](DDialogColorGradient.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-command.ts:210](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-command.ts#L210)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:277](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L277)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:374](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L374)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:294](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L294)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:281](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L281)
...
▸ **focus**(): [`DDialogColorGradient`](DDialogColorGradient.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:155](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L155)
...
[src/main/typescript/wcardinal/ui/d-dialog-command.ts:223](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-command.ts#L223)

___

### getResolvedValue

▸ `Protected` **getResolvedValue**(): [`DColorGradient`](../interfaces/DColorGradient.md) \| `PromiseLike`<[`DColorGradient`](../interfaces/DColorGradient.md)\>

#### Returns

[`DColorGradient`](../interfaces/DColorGradient.md) \| `PromiseLike`<[`DColorGradient`](../interfaces/DColorGradient.md)\>
...
[src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts:60](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts#L60)
...
[src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts:69](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts#L69)
...
▸ **hide**(): [`DDialogColorGradient`](DDialogColorGradient.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-command.ts:98](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-command.ts#L98)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:273](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L273)
...
[src/main/typescript/wcardinal/ui/d-dialog-command.ts:177](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-command.ts#L177)

___

### off

▸ **off**(`event`, `fn?`, `context?`): [`DDialogColorGradient`](DDialogColorGradient.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-command.ts:199](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-command.ts#L199)

___

### on

▸ **on**(`event`, `fn`, `context?`): [`DDialogColorGradient`](DDialogColorGradient.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:180](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L180)
...
[src/main/typescript/wcardinal/ui/d-dialog-command.ts:214](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-command.ts#L214)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:307](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L307)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:370](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L370)
...
[src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts:27](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts#L27)
...
[src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts:64](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts#L64)
...
[src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts:32](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts#L32)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:260](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L260)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:238](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L238)
...
▸ **once**(`event`, `fn`, `context?`): [`DDialogColorGradient`](DDialogColorGradient.md)<`THEME`, `OPTIONS`\>
...
▸ **open**(`owner?`): `Promise`<[`DColorGradient`](../interfaces/DColorGradient.md)\>
...
`Promise`<[`DColorGradient`](../interfaces/DColorGradient.md)\>
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:197](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L197)
...
▸ **removeAllListeners**(`event?`): [`DDialogColorGradient`](DDialogColorGradient.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DDialogColorGradient`](DDialogColorGradient.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DDialogColorGradient`](DDialogColorGradient.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DDialogColorGradient`](DDialogColorGradient.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-command.ts:181](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-command.ts#L181)
