[Winter Cardinal UI - v0.167.0](../index.md) / DButtonDatetime

# Class: DButtonDatetime<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeButtonDatetime`](../interfaces/DThemeButtonDatetime.md) = [`DThemeButtonDatetime`](../interfaces/DThemeButtonDatetime.md) |
| `OPTIONS` | extends [`DButtonDatetimeOptions`](../interfaces/DButtonDatetimeOptions.md)<`THEME`\> = [`DButtonDatetimeOptions`](../interfaces/DButtonDatetimeOptions.md)<`THEME`\> |
...
- [`DButton`](DButton.md)<`Date`, `THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DTableBodyCellDatetime`](DTableBodyCellDatetime.md)

## Table of contents

### Constructors

- [constructor](DButtonDatetime.md#constructor)

### Properties

- [\_accessibleActive](DButtonDatetime.md#_accessibleactive)
- [\_accessibleDiv](DButtonDatetime.md#_accessiblediv)
- [\_auto](DButtonDatetime.md#_auto)
- [\_background](DButtonDatetime.md#_background)
- [\_border](DButtonDatetime.md#_border)
- [\_bounds](DButtonDatetime.md#_bounds)
- [\_clearType](DButtonDatetime.md#_cleartype)
- [\_corner](DButtonDatetime.md#_corner)
- [\_cursor](DButtonDatetime.md#_cursor)
- [\_datetimeMask](DButtonDatetime.md#_datetimemask)
- [\_destroyed](DButtonDatetime.md#_destroyed)
- [\_dialog](DButtonDatetime.md#_dialog)
- [\_images](DButtonDatetime.md#_images)
- [\_isOverflowMaskEnabled](DButtonDatetime.md#_isoverflowmaskenabled)
- [\_isTextVisible](DButtonDatetime.md#_istextvisible)
- [\_isToggle](DButtonDatetime.md#_istoggle)
- [\_lastDownPoint](DButtonDatetime.md#_lastdownpoint)
- [\_lastSortedIndex](DButtonDatetime.md#_lastsortedindex)
- [\_mask](DButtonDatetime.md#_mask)
- [\_options](DButtonDatetime.md#_options)
- [\_outline](DButtonDatetime.md#_outline)
- [\_overflowMask](DButtonDatetime.md#_overflowmask)
- [\_padding](DButtonDatetime.md#_padding)
- [\_reflowable](DButtonDatetime.md#_reflowable)
- [\_shortcuts](DButtonDatetime.md#_shortcuts)
- [\_snippet](DButtonDatetime.md#_snippet)
- [\_tempDisplayObjectParent](DButtonDatetime.md#_tempdisplayobjectparent)
- [\_text](DButtonDatetime.md#_text)
- [\_textAlign](DButtonDatetime.md#_textalign)
- [\_textAlpha](DButtonDatetime.md#_textalpha)
- [\_textColor](DButtonDatetime.md#_textcolor)
- [\_textFormatter](DButtonDatetime.md#_textformatter)
- [\_textStyle](DButtonDatetime.md#_textstyle)
- [\_textValue](DButtonDatetime.md#_textvalue)
- [\_textValueComputed](DButtonDatetime.md#_textvaluecomputed)
- [\_title](DButtonDatetime.md#_title)
- [\_when](DButtonDatetime.md#_when)
- [\_zIndex](DButtonDatetime.md#_zindex)
- [accessible](DButtonDatetime.md#accessible)
- [accessibleChildren](DButtonDatetime.md#accessiblechildren)
- [accessibleHint](DButtonDatetime.md#accessiblehint)
- [accessiblePointerEvents](DButtonDatetime.md#accessiblepointerevents)
- [accessibleTitle](DButtonDatetime.md#accessibletitle)
- [accessibleType](DButtonDatetime.md#accessibletype)
- [alpha](DButtonDatetime.md#alpha)
- [angle](DButtonDatetime.md#angle)
- [buttonMode](DButtonDatetime.md#buttonmode)
- [cacheAsBitmap](DButtonDatetime.md#cacheasbitmap)
- [children](DButtonDatetime.md#children)
- [cursor](DButtonDatetime.md#cursor)
- [filterArea](DButtonDatetime.md#filterarea)
- [filters](DButtonDatetime.md#filters)
- [hitArea](DButtonDatetime.md#hitarea)
- [interactive](DButtonDatetime.md#interactive)
- [interactiveChildren](DButtonDatetime.md#interactivechildren)
- [isMask](DButtonDatetime.md#ismask)
- [isSprite](DButtonDatetime.md#issprite)
- [localTransform](DButtonDatetime.md#localtransform)
- [mask](DButtonDatetime.md#mask)
- [name](DButtonDatetime.md#name)
- [parent](DButtonDatetime.md#parent)
- [pivot](DButtonDatetime.md#pivot)
- [renderable](DButtonDatetime.md#renderable)
- [rotation](DButtonDatetime.md#rotation)
- [sortDirty](DButtonDatetime.md#sortdirty)
- [sortableChildren](DButtonDatetime.md#sortablechildren)
- [transform](DButtonDatetime.md#transform)
- [visible](DButtonDatetime.md#visible)
- [worldAlpha](DButtonDatetime.md#worldalpha)
- [worldTransform](DButtonDatetime.md#worldtransform)
- [worldVisible](DButtonDatetime.md#worldvisible)
- [zIndex](DButtonDatetime.md#zindex)
- [DIALOG](DButtonDatetime.md#dialog)
- [LAYOUTER](DButtonDatetime.md#layouter)
- [WORK\_CONTAINS\_POINT](DButtonDatetime.md#work_contains_point)

### Accessors

- [background](DButtonDatetime.md#background)
- [border](DButtonDatetime.md#border)
- [corner](DButtonDatetime.md#corner)
- [dialog](DButtonDatetime.md#dialog)
- [height](DButtonDatetime.md#height)
- [image](DButtonDatetime.md#image)
- [isToggle](DButtonDatetime.md#istoggle)
- [outline](DButtonDatetime.md#outline)
- [padding](DButtonDatetime.md#padding)
- [position](DButtonDatetime.md#position)
- [reflowable](DButtonDatetime.md#reflowable)
- [scale](DButtonDatetime.md#scale)
- [shadow](DButtonDatetime.md#shadow)
- [skew](DButtonDatetime.md#skew)
- [snippet](DButtonDatetime.md#snippet)
- [state](DButtonDatetime.md#state)
- [text](DButtonDatetime.md#text)
- [theme](DButtonDatetime.md#theme)
- [title](DButtonDatetime.md#title)
- [type](DButtonDatetime.md#type)
- [unsafe](DButtonDatetime.md#unsafe)
- [value](DButtonDatetime.md#value)
- [weight](DButtonDatetime.md#weight)
- [width](DButtonDatetime.md#width)
- [x](DButtonDatetime.md#x)
- [y](DButtonDatetime.md#y)

### Methods

- [\_calculateBounds](DButtonDatetime.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DButtonDatetime.md#_recursivepostupdatetransform)
- [\_render](DButtonDatetime.md#_render)
- [addChild](DButtonDatetime.md#addchild)
- [addChildAt](DButtonDatetime.md#addchildat)
- [addListener](DButtonDatetime.md#addlistener)
- [applyTitle](DButtonDatetime.md#applytitle)
- [blur](DButtonDatetime.md#blur)
- [calculateBounds](DButtonDatetime.md#calculatebounds)
- [computeTextValue](DButtonDatetime.md#computetextvalue)
- [containsGlobalPoint](DButtonDatetime.md#containsglobalpoint)
- [containsLocalPoint](DButtonDatetime.md#containslocalpoint)
- [containsPoint](DButtonDatetime.md#containspoint)
- [createOrUpdateText](DButtonDatetime.md#createorupdatetext)
- [createText](DButtonDatetime.md#createtext)
- [destroy](DButtonDatetime.md#destroy)
- [displayObjectUpdateTransform](DButtonDatetime.md#displayobjectupdatetransform)
- [emit](DButtonDatetime.md#emit)
- [eventNames](DButtonDatetime.md#eventnames)
- [focus](DButtonDatetime.md#focus)
- [focusOnClosest](DButtonDatetime.md#focusonclosest)
- [getBounds](DButtonDatetime.md#getbounds)
- [getChildAt](DButtonDatetime.md#getchildat)
- [getChildByName](DButtonDatetime.md#getchildbyname)
- [getChildIndex](DButtonDatetime.md#getchildindex)
- [getClearType](DButtonDatetime.md#getcleartype)
- [getClippingRect](DButtonDatetime.md#getclippingrect)
- [getDatetimeMask](DButtonDatetime.md#getdatetimemask)
- [getGlobalPosition](DButtonDatetime.md#getglobalposition)
- [getHeight](DButtonDatetime.md#getheight)
- [getLocalBounds](DButtonDatetime.md#getlocalbounds)
- [getOverflowMask](DButtonDatetime.md#getoverflowmask)
- [getParentOfSize](DButtonDatetime.md#getparentofsize)
- [getTextAlpha](DButtonDatetime.md#gettextalpha)
- [getTextColor](DButtonDatetime.md#gettextcolor)
- [getThemeDefault](DButtonDatetime.md#getthemedefault)
- [getType](DButtonDatetime.md#gettype)
- [getWidth](DButtonDatetime.md#getwidth)
- [getX](DButtonDatetime.md#getx)
- [getY](DButtonDatetime.md#gety)
- [hasDirty](DButtonDatetime.md#hasdirty)
- [hasRefitableHeight](DButtonDatetime.md#hasrefitableheight)
- [hasRefitableWidth](DButtonDatetime.md#hasrefitablewidth)
- [hide](DButtonDatetime.md#hide)
- [hideText](DButtonDatetime.md#hidetext)
- [init](DButtonDatetime.md#init)
- [initOnClick](DButtonDatetime.md#initonclick)
- [initOnPress](DButtonDatetime.md#initonpress)
- [initReflowable](DButtonDatetime.md#initreflowable)
- [isDirty](DButtonDatetime.md#isdirty)
- [isEventTarget](DButtonDatetime.md#iseventtarget)
- [isHidden](DButtonDatetime.md#ishidden)
- [isHierarchyDirty](DButtonDatetime.md#ishierarchydirty)
- [isRefitable](DButtonDatetime.md#isrefitable)
- [isShown](DButtonDatetime.md#isshown)
- [listenerCount](DButtonDatetime.md#listenercount)
- [listeners](DButtonDatetime.md#listeners)
- [newDialog](DButtonDatetime.md#newdialog)
- [newImage](DButtonDatetime.md#newimage)
- [newImages](DButtonDatetime.md#newimages)
- [off](DButtonDatetime.md#off)
- [on](DButtonDatetime.md#on)
- [onActivate](DButtonDatetime.md#onactivate)
- [onActivateKeyDown](DButtonDatetime.md#onactivatekeydown)
- [onActivateKeyUp](DButtonDatetime.md#onactivatekeyup)
- [onBlur](DButtonDatetime.md#onblur)
- [onChildBlur](DButtonDatetime.md#onchildblur)
- [onChildFocus](DButtonDatetime.md#onchildfocus)
- [onChildrenChange](DButtonDatetime.md#onchildrenchange)
- [onClick](DButtonDatetime.md#onclick)
- [onDblClick](DButtonDatetime.md#ondblclick)
- [onDown](DButtonDatetime.md#ondown)
- [onDownThis](DButtonDatetime.md#ondownthis)
- [onFocus](DButtonDatetime.md#onfocus)
- [onHierarchyDirty](DButtonDatetime.md#onhierarchydirty)
- [onInactivate](DButtonDatetime.md#oninactivate)
- [onKeyDown](DButtonDatetime.md#onkeydown)
- [onKeyUp](DButtonDatetime.md#onkeyup)
- [onMove](DButtonDatetime.md#onmove)
- [onOut](DButtonDatetime.md#onout)
- [onOver](DButtonDatetime.md#onover)
- [onParentMove](DButtonDatetime.md#onparentmove)
- [onParentResize](DButtonDatetime.md#onparentresize)
- [onRefit](DButtonDatetime.md#onrefit)
- [onReflow](DButtonDatetime.md#onreflow)
- [onResize](DButtonDatetime.md#onresize)
- [onScale](DButtonDatetime.md#onscale)
- [onShortcut](DButtonDatetime.md#onshortcut)
- [onSkew](DButtonDatetime.md#onskew)
- [onStateChange](DButtonDatetime.md#onstatechange)
- [onTextChange](DButtonDatetime.md#ontextchange)
- [onToggleEnd](DButtonDatetime.md#ontoggleend)
- [onToggleStart](DButtonDatetime.md#ontogglestart)
- [onUp](DButtonDatetime.md#onup)
- [onUpThis](DButtonDatetime.md#onupthis)
- [onValueChange](DButtonDatetime.md#onvaluechange)
- [onWheel](DButtonDatetime.md#onwheel)
- [once](DButtonDatetime.md#once)
- [reflow](DButtonDatetime.md#reflow)
- [removeAllListeners](DButtonDatetime.md#removealllisteners)
- [removeChild](DButtonDatetime.md#removechild)
- [removeChildAt](DButtonDatetime.md#removechildat)
- [removeChildren](DButtonDatetime.md#removechildren)
- [removeListener](DButtonDatetime.md#removelistener)
- [render](DButtonDatetime.md#render)
- [renderAdvanced](DButtonDatetime.md#renderadvanced)
- [resize](DButtonDatetime.md#resize)
- [setChildIndex](DButtonDatetime.md#setchildindex)
- [setFocused](DButtonDatetime.md#setfocused)
- [setHeight](DButtonDatetime.md#setheight)
- [setParent](DButtonDatetime.md#setparent)
- [setTransform](DButtonDatetime.md#settransform)
- [setWidth](DButtonDatetime.md#setwidth)
- [setX](DButtonDatetime.md#setx)
- [setY](DButtonDatetime.md#sety)
- [show](DButtonDatetime.md#show)
- [showText](DButtonDatetime.md#showtext)
- [sortChildren](DButtonDatetime.md#sortchildren)
- [swapChildren](DButtonDatetime.md#swapchildren)
- [toCursor](DButtonDatetime.md#tocursor)
- [toDirty](DButtonDatetime.md#todirty)
- [toGlobal](DButtonDatetime.md#toglobal)
- [toHasDirty](DButtonDatetime.md#tohasdirty)
- [toHierarchyDirty](DButtonDatetime.md#tohierarchydirty)
- [toImageOptions](DButtonDatetime.md#toimageoptions)
- [toLocal](DButtonDatetime.md#tolocal)
- [toParentHasDirty](DButtonDatetime.md#toparenthasdirty)
- [toParentHierarchyDirty](DButtonDatetime.md#toparenthierarchydirty)
- [toParentResized](DButtonDatetime.md#toparentresized)
- [toggle](DButtonDatetime.md#toggle)
- [updateText](DButtonDatetime.md#updatetext)
- [updateTextAndImage](DButtonDatetime.md#updatetextandimage)
- [updateTextColor](DButtonDatetime.md#updatetextcolor)
- [updateTextPosition](DButtonDatetime.md#updatetextposition)
- [updateTextValue](DButtonDatetime.md#updatetextvalue)
- [updateTransform](DButtonDatetime.md#updatetransform)
- [mixin](DButtonDatetime.md#mixin)

## Constructors

### constructor

• **new DButtonDatetime**<`THEME`, `OPTIONS`\>(`options?`)

#### Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeButtonDatetime`](../interfaces/DThemeButtonDatetime.md)<`THEME`\> = [`DThemeButtonDatetime`](../interfaces/DThemeButtonDatetime.md) |
| `OPTIONS` | extends [`DButtonDatetimeOptions`](../interfaces/DButtonDatetimeOptions.md)<`THEME`, `any`, `OPTIONS`\> = [`DButtonDatetimeOptions`](../interfaces/DButtonDatetimeOptions.md)<`THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-button-datetime.ts:54](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-datetime.ts#L54)
...
[src/main/typescript/wcardinal/ui/d-button-datetime.ts:53](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-datetime.ts#L53)
...
[src/main/typescript/wcardinal/ui/d-button-datetime.ts:52](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-datetime.ts#L52)
...
[src/main/typescript/wcardinal/ui/d-button-datetime.ts:84](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-datetime.ts#L84)
...
[src/main/typescript/wcardinal/ui/d-button-datetime.ts:108](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-datetime.ts#L108)
...
[src/main/typescript/wcardinal/ui/d-button-datetime.ts:112](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-datetime.ts#L112)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DButtonDatetime`](DButtonDatetime.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DButtonDatetime`](DButtonDatetime.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DButtonDatetime`](DButtonDatetime.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-datetime.ts:75](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-datetime.ts#L75)
...
[src/main/typescript/wcardinal/ui/d-button-datetime.ts:119](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-datetime.ts#L119)
...
▸ **hide**(): [`DButtonDatetime`](DButtonDatetime.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-datetime.ts:104](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-datetime.ts#L104)
...
▸ **off**(`event`, `fn?`, `context?`): [`DButtonDatetime`](DButtonDatetime.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DButtonDatetime`](DButtonDatetime.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-datetime.ts:56](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-datetime.ts#L56)
...
[src/main/typescript/wcardinal/ui/d-button-datetime.ts:70](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-datetime.ts#L70)
...
▸ **once**(`event`, `fn`, `context?`): [`DButtonDatetime`](DButtonDatetime.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DButtonDatetime`](DButtonDatetime.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DButtonDatetime`](DButtonDatetime.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DButtonDatetime`](DButtonDatetime.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DButtonDatetime`](DButtonDatetime.md)<`THEME`, `OPTIONS`\>
