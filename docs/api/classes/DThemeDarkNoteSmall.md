[Winter Cardinal UI - v0.407.0](../index.md) / DThemeDarkNoteSmall
...
- [getImageRotation](DThemeDarkNoteSmall.md#getimagerotation)
...
- [getPaddingTop](DThemeDarkNoteSmall.md#getpaddingtop)
...
- [getSecondaryImageRotation](DThemeDarkNoteSmall.md#getsecondaryimagerotation)
...
- [getTertiaryImageRotation](DThemeDarkNoteSmall.md#gettertiaryimagerotation)
...
- [getTextStyleFitting](DThemeDarkNoteSmall.md#gettextstylefitting)
...
• **new DThemeDarkNoteSmall**(): [`DThemeDarkNoteSmall`](DThemeDarkNoteSmall.md)
