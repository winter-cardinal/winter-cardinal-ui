[Winter Cardinal UI - v0.457.0](../index.md) / EShapeActionRuntimeMiscWriteLocal
...
• **new EShapeActionRuntimeMiscWriteLocal**(`value`): [`EShapeActionRuntimeMiscWriteLocal`](EShapeActionRuntimeMiscWriteLocal.md)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-misc-write-local.ts:11](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-misc-write-local.ts#L11)
