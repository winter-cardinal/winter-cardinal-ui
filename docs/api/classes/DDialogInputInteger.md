[Winter Cardinal UI - v0.160.0](../index.md) / DDialogInputInteger
...
- [`DDialogInput`](DDialogInput.md)<`number`, [`DInputInteger`](DInputInteger.md), [`DInputIntegerOptions`](../interfaces/DInputIntegerOptions.md), `THEME`, `OPTIONS`\>
...
- [\_buttonCancel](DDialogInputInteger.md#_buttoncancel)
- [\_buttonLayout](DDialogInputInteger.md#_buttonlayout)
- [\_buttonOk](DDialogInputInteger.md#_buttonok)
...
- [\_label](DDialogInputInteger.md#_label)
...
- [\_owner](DDialogInputInteger.md#_owner)
...
- [label](DDialogInputInteger.md#label)
...
- [onInit](DDialogInputInteger.md#oninit)
...
- [toLabelOptions](DDialogInputInteger.md#tolabeloptions)
- [toLayoutOptions](DDialogInputInteger.md#tolayoutoptions)
- [toLocal](DDialogInputInteger.md#tolocal)
- [toMargin](DDialogInputInteger.md#tomargin)
...
[src/main/typescript/wcardinal/ui/d-dialog-input-integer.ts:38](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-input-integer.ts#L38)
...
[src/main/typescript/wcardinal/ui/d-dialog-input-integer.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-input-integer.ts#L18)
...
▸ `Protected` **toInputOptions**(`options?`): [`DInputIntegerOptions`](../interfaces/DInputIntegerOptions.md)<[`DThemeInputInteger`](../interfaces/DThemeInputInteger.md)\>
...
[src/main/typescript/wcardinal/ui/d-dialog-input-integer.ts:26](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-input-integer.ts#L26)
