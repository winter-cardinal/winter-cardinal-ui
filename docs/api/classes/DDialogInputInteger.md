[Winter Cardinal UI - v0.457.0](../index.md) / DDialogInputInteger
...
- [\_alwaysOnTop](DDialogInputInteger.md#_alwaysontop)
...
- [\_boundsID](DDialogInputInteger.md#_boundsid)
- [\_boundsRect](DDialogInputInteger.md#_boundsrect)
...
- [\_enabledFilters](DDialogInputInteger.md#_enabledfilters)
...
- [\_localBounds](DDialogInputInteger.md#_localbounds)
- [\_localBoundsRect](DDialogInputInteger.md#_localboundsrect)
- [\_mask](DDialogInputInteger.md#_mask)
- [\_mode](DDialogInputInteger.md#_mode)
- [\_onParentChildAddedBound](DDialogInputInteger.md#_onparentchildaddedbound)
...
- [alwaysOnTop](DDialogInputInteger.md#alwaysontop)
...
- [bringToFront](DDialogInputInteger.md#bringtofront)
...
- [containerUpdateTransform](DDialogInputInteger.md#containerupdatetransform)
...
- [disableTempParent](DDialogInputInteger.md#disabletempparent)
...
- [enableTempParent](DDialogInputInteger.md#enabletempparent)
...
- [newPadding](DDialogInputInteger.md#newpadding)
...
• **new DDialogInputInteger**\<`THEME`, `OPTIONS`\>(`options?`): [`DDialogInputInteger`](DDialogInputInteger.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-input-integer.ts:44](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-input-integer.ts#L44)
...
▸ **newInput**(`options?`): [`DInputInteger`](DInputInteger.md)\<[`DThemeInputInteger`](../interfaces/DThemeInputInteger.md), [`DInputIntegerOptions`](../interfaces/DInputIntegerOptions.md)\<[`DThemeInputInteger`](../interfaces/DThemeInputInteger.md)\>\>
...
[src/main/typescript/wcardinal/ui/d-dialog-input-integer.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-input-integer.ts#L22)
...
▸ **toInputOptions**(`options?`): [`DDialogInputIntegerInputOptions`](../interfaces/DDialogInputIntegerInputOptions.md)
...
[src/main/typescript/wcardinal/ui/d-dialog-input-integer.ts:30](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-input-integer.ts#L30)
