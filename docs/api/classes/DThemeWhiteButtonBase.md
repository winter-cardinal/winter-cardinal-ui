[Winter Cardinal UI - v0.457.0](../index.md) / DThemeWhiteButtonBase
...
- [`DThemeWhiteImageBase`](DThemeWhiteImageBase.md)\<`VALUE`\>
  ...
  ↳↳ [`DThemeWhiteDropdownBase`](DThemeWhiteDropdownBase.md)

  ↳↳ [`DThemeWhiteTableBodyCellInputTreeMarker`](DThemeWhiteTableBodyCellInputTreeMarker.md)
...
- [getImageRotation](DThemeWhiteButtonBase.md#getimagerotation)
...
- [getSecondaryImageRotation](DThemeWhiteButtonBase.md#getsecondaryimagerotation)
...
- [getTertiaryImageRotation](DThemeWhiteButtonBase.md#gettertiaryimagerotation)
...
- [getTextStyleFitting](DThemeWhiteButtonBase.md#gettextstylefitting)
