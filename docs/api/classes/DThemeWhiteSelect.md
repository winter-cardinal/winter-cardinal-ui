[Winter Cardinal UI - v0.414.0](../index.md) / DThemeWhiteSelect
...
- [getTextStyleFitting](DThemeWhiteSelect.md#gettextstylefitting)
...
• **new DThemeWhiteSelect**\<`VALUE`\>(): [`DThemeWhiteSelect`](DThemeWhiteSelect.md)\<`VALUE`\>
