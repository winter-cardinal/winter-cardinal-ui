[Winter Cardinal UI - v0.155.0](../index.md) / DPaginationButtonTop
...
- [\_isChildrenDirty](DPaginationButtonTop.md#_ischildrendirty)
...
- [isChildrenDirty](DPaginationButtonTop.md#ischildrendirty)
...
- [onChildrenDirty](DPaginationButtonTop.md#onchildrendirty)
...
- [refit](DPaginationButtonTop.md#refit)
...
- [toChildrenDirty](DPaginationButtonTop.md#tochildrendirty)
...
[src/main/typescript/wcardinal/ui/d-pagination-button-top.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-pagination-button-top.ts#L18)
