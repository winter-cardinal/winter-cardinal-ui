[Winter Cardinal UI - v0.374.0](../index.md) / DPaginationButtonTop
...
- [newPadding](DPaginationButtonTop.md#newpadding)
- [newText](DPaginationButtonTop.md#newtext)
...
• **new DPaginationButtonTop**\<`THEME`, `OPTIONS`\>(`options?`): [`DPaginationButtonTop`](DPaginationButtonTop.md)\<`THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DPaginationButtonTop`](DPaginationButtonTop.md)\<`THEME`, `OPTIONS`\>
