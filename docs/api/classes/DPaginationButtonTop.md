[Winter Cardinal UI - v0.310.1](../index.md) / DPaginationButtonTop
...
- [\_isGrouped](DPaginationButtonTop.md#_isgrouped)
...
- [isGrouped](DPaginationButtonTop.md#isgrouped)
...
- [activate](DPaginationButtonTop.md#activate)
...
- [onPress](DPaginationButtonTop.md#onpress)
...
- [onUnpress](DPaginationButtonTop.md#onunpress)
...
[src/main/typescript/wcardinal/ui/d-pagination-button-top.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-pagination-button-top.ts#L18)
