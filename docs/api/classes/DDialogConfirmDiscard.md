[Winter Cardinal UI - v0.205.1](../index.md) / DDialogConfirmDiscard
...
- [\_content](DDialogConfirmDiscard.md#_content)
...
- [\_footer](DDialogConfirmDiscard.md#_footer)
- [\_gesture](DDialogConfirmDiscard.md#_gesture)
- [\_header](DDialogConfirmDiscard.md#_header)
- [\_lastDownPoint](DDialogConfirmDiscard.md#_lastdownpoint)
- [\_lastSortedIndex](DDialogConfirmDiscard.md#_lastsortedindex)
- [\_layer](DDialogConfirmDiscard.md#_layer)
- [\_layout](DDialogConfirmDiscard.md#_layout)
...
- [\_opener](DDialogConfirmDiscard.md#_opener)
...
- [WORK\_BOUNDS](DDialogConfirmDiscard.md#work_bounds)
- [WORK\_CONTAINS\_POINT](DDialogConfirmDiscard.md#work_contains_point)

### Accessors

- [algin](DDialogConfirmDiscard.md#algin)
- [align](DDialogConfirmDiscard.md#align)
- [background](DDialogConfirmDiscard.md#background)
- [border](DDialogConfirmDiscard.md#border)
- [content](DDialogConfirmDiscard.md#content)
- [corner](DDialogConfirmDiscard.md#corner)
- [footer](DDialogConfirmDiscard.md#footer)
- [gesture](DDialogConfirmDiscard.md#gesture)
- [header](DDialogConfirmDiscard.md#header)
- [height](DDialogConfirmDiscard.md#height)
- [layer](DDialogConfirmDiscard.md#layer)
- [layout](DDialogConfirmDiscard.md#layout)
- [message](DDialogConfirmDiscard.md#message)
- [mode](DDialogConfirmDiscard.md#mode)
- [options](DDialogConfirmDiscard.md#options)
...
- [findFirstFocusable](DDialogConfirmDiscard.md#findfirstfocusable)
...
- [newContent](DDialogConfirmDiscard.md#newcontent)
- [newContentChildren](DDialogConfirmDiscard.md#newcontentchildren)
- [newFooter](DDialogConfirmDiscard.md#newfooter)
- [newHeader](DDialogConfirmDiscard.md#newheader)
- [newLayout](DDialogConfirmDiscard.md#newlayout)
- [newLayoutChildren](DDialogConfirmDiscard.md#newlayoutchildren)
- [newLayoutOptions](DDialogConfirmDiscard.md#newlayoutoptions)
...
- [toAlign](DDialogConfirmDiscard.md#toalign)
- [toCloseOn](DDialogConfirmDiscard.md#tocloseon)
- [toContentOptions](DDialogConfirmDiscard.md#tocontentoptions)
- [toCursor](DDialogConfirmDiscard.md#tocursor)
- [toDirty](DDialogConfirmDiscard.md#todirty)
- [toFooterOptions](DDialogConfirmDiscard.md#tofooteroptions)
- [toGestureOptions](DDialogConfirmDiscard.md#togestureoptions)
- [toGlobal](DDialogConfirmDiscard.md#toglobal)
- [toHasDirty](DDialogConfirmDiscard.md#tohasdirty)
- [toHeaderOptions](DDialogConfirmDiscard.md#toheaderoptions)
...
• `Protected` **\_gesture**: [`DDialogGesture`](../interfaces/DDialogGesture.md)<[`DDialogConfirmDiscard`](DDialogConfirmDiscard.md)<`THEME`, `OPTIONS`\>\>
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm-discard.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-confirm-discard.ts#L17)
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm.ts:72](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-confirm.ts#L72)
