[Winter Cardinal UI - v0.160.0](../index.md) / DDialogConfirmDiscard
...
- [\_tempDisplayObjectParent](DDialogConfirmDiscard.md#_tempdisplayobjectparent)
...
- [isHierarchyDirty](DDialogConfirmDiscard.md#ishierarchydirty)
...
- [onBlur](DDialogConfirmDiscard.md#onblur)
...
- [onHierarchyDirty](DDialogConfirmDiscard.md#onhierarchydirty)
...
- [toHierarchyDirty](DDialogConfirmDiscard.md#tohierarchydirty)
...
- [toMessageOptions](DDialogConfirmDiscard.md#tomessageoptions)
...
- [toParentHierarchyDirty](DDialogConfirmDiscard.md#toparenthierarchydirty)
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm-discard.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-confirm-discard.ts#L17)
...
▸ **once**(`event`, `fn`, `context?`): [`DDialogConfirmDiscard`](DDialogConfirmDiscard.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DDialogConfirmDiscard`](DDialogConfirmDiscard.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DDialogConfirmDiscard`](DDialogConfirmDiscard.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DDialogConfirmDiscard`](DDialogConfirmDiscard.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DDialogConfirmDiscard`](DDialogConfirmDiscard.md)<`THEME`, `OPTIONS`\>
