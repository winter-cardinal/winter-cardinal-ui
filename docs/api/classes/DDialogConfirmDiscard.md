[Winter Cardinal UI - v0.414.0](../index.md) / DDialogConfirmDiscard
...
- [\_boundsID](DDialogConfirmDiscard.md#_boundsid)
- [\_boundsRect](DDialogConfirmDiscard.md#_boundsrect)
...
- [\_enabledFilters](DDialogConfirmDiscard.md#_enabledfilters)
...
- [\_localBounds](DDialogConfirmDiscard.md#_localbounds)
- [\_localBoundsRect](DDialogConfirmDiscard.md#_localboundsrect)
...
- [containerUpdateTransform](DDialogConfirmDiscard.md#containerupdatetransform)
...
- [disableTempParent](DDialogConfirmDiscard.md#disabletempparent)
...
- [enableTempParent](DDialogConfirmDiscard.md#enabletempparent)
...
- [newPadding](DDialogConfirmDiscard.md#newpadding)
...
• **new DDialogConfirmDiscard**\<`THEME`, `OPTIONS`\>(`options?`): [`DDialogConfirmDiscard`](DDialogConfirmDiscard.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm-discard.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-dialog-confirm-discard.ts#L17)
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm.ts:72](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-dialog-confirm.ts#L72)
