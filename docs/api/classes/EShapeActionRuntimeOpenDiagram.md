[Winter Cardinal UI - v0.165.0](../index.md) / EShapeActionRuntimeOpenDiagram

# Class: EShapeActionRuntimeOpenDiagram

## Hierarchy

- [`EShapeActionRuntimeOpen`](EShapeActionRuntimeOpen.md)

  ↳ **`EShapeActionRuntimeOpenDiagram`**

## Table of contents

### Constructors

- [constructor](EShapeActionRuntimeOpenDiagram.md#constructor)

### Properties

- [condition](EShapeActionRuntimeOpenDiagram.md#condition)
- [reset](EShapeActionRuntimeOpenDiagram.md#reset)
- [target](EShapeActionRuntimeOpenDiagram.md#target)

### Methods

- [execute](EShapeActionRuntimeOpenDiagram.md#execute)
- [initialize](EShapeActionRuntimeOpenDiagram.md#initialize)
- [onBlur](EShapeActionRuntimeOpenDiagram.md#onblur)
- [onDblClick](EShapeActionRuntimeOpenDiagram.md#ondblclick)
- [onDown](EShapeActionRuntimeOpenDiagram.md#ondown)
- [onDowning](EShapeActionRuntimeOpenDiagram.md#ondowning)
- [onFocus](EShapeActionRuntimeOpenDiagram.md#onfocus)
- [onMove](EShapeActionRuntimeOpenDiagram.md#onmove)
- [onRender](EShapeActionRuntimeOpenDiagram.md#onrender)

## Constructors

### constructor

• **new EShapeActionRuntimeOpenDiagram**(`value`)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open-diagram.ts:13](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open-diagram.ts#L13)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open-diagram.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-open-diagram.ts#L17)
