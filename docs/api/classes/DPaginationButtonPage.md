[Winter Cardinal UI - v0.310.1](../index.md) / DPaginationButtonPage
...
- [\_isGrouped](DPaginationButtonPage.md#_isgrouped)
...
- [isGrouped](DPaginationButtonPage.md#isgrouped)
...
- [activate](DPaginationButtonPage.md#activate)
...
- [onPress](DPaginationButtonPage.md#onpress)
...
- [onUnpress](DPaginationButtonPage.md#onunpress)
...
[src/main/typescript/wcardinal/ui/d-pagination-button-page.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-pagination-button-page.ts#L18)
