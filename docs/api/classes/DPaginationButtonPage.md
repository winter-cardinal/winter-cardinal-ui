[Winter Cardinal UI - v0.374.0](../index.md) / DPaginationButtonPage
...
- [newPadding](DPaginationButtonPage.md#newpadding)
- [newText](DPaginationButtonPage.md#newtext)
...
• **new DPaginationButtonPage**\<`THEME`, `OPTIONS`\>(`options?`): [`DPaginationButtonPage`](DPaginationButtonPage.md)\<`THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DPaginationButtonPage`](DPaginationButtonPage.md)\<`THEME`, `OPTIONS`\>
