[Winter Cardinal UI - v0.374.0](../index.md) / DButtonUndo
...
- [newPadding](DButtonUndo.md#newpadding)
- [newText](DButtonUndo.md#newtext)
...
• **new DButtonUndo**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DButtonUndo`](DButtonUndo.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeButton`](../interfaces/DThemeButton.md)\<`VALUE`\> = [`DThemeButton`](../interfaces/DThemeButton.md)\<`VALUE`\> |
| `OPTIONS` | extends [`DButtonOptions`](../interfaces/DButtonOptions.md)\<`VALUE`, `THEME`, `any`\> = [`DButtonOptions`](../interfaces/DButtonOptions.md)\<`VALUE`, `THEME`, `any`\> |
...
▸ **setFocused**(`isFocused`): [`DButtonUndo`](DButtonUndo.md)\<`VALUE`, `THEME`, `OPTIONS`\>
