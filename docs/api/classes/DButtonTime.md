[Winter Cardinal UI - v0.374.0](../index.md) / DButtonTime
...
- [\_isGrouped](DButtonTime.md#_isgrouped)
...
- [dialog](DButtonTime.md#dialog-1)
- [height](DButtonTime.md#height)
- [image](DButtonTime.md#image)
- [isGrouped](DButtonTime.md#isgrouped)
...
- [activate](DButtonTime.md#activate)
...
- [newPadding](DButtonTime.md#newpadding)
- [newText](DButtonTime.md#newtext)
...
- [onPress](DButtonTime.md#onpress)
...
- [onUnpress](DButtonTime.md#onunpress)
...
• **new DButtonTime**\<`THEME`, `OPTIONS`\>(`options?`): [`DButtonTime`](DButtonTime.md)\<`THEME`, `OPTIONS`\>
...
| :------ | :------ |
| `THEME` | extends [`DThemeButtonTime`](../interfaces/DThemeButtonTime.md) = [`DThemeButtonTime`](../interfaces/DThemeButtonTime.md) |
| `OPTIONS` | extends [`DButtonTimeOptions`](../interfaces/DButtonTimeOptions.md)\<`THEME`, `any`\> = [`DButtonTimeOptions`](../interfaces/DButtonTimeOptions.md)\<`THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:54](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-time.ts#L54)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:53](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-time.ts#L53)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:52](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-time.ts#L52)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:83](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-time.ts#L83)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:107](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-time.ts#L107)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:111](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-time.ts#L111)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:74](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-time.ts#L74)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:118](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-time.ts#L118)
...
▸ **newDialog**(`options?`): [`DDialogTime`](DDialogTime.md)\<[`DThemeDialogTime`](../interfaces/DThemeDialogTime.md), [`DDialogTimeOptions`](../interfaces/DDialogTimeOptions.md)\<[`DThemeDialogTime`](../interfaces/DThemeDialogTime.md)\>\>
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:103](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-time.ts#L103)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:56](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-time.ts#L56)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:69](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-time.ts#L69)
...
▸ **setFocused**(`isFocused`): [`DButtonTime`](DButtonTime.md)\<`THEME`, `OPTIONS`\>
