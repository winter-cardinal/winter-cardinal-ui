[Winter Cardinal UI - v0.167.0](../index.md) / DButtonTime

# Class: DButtonTime<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeButtonTime`](../interfaces/DThemeButtonTime.md) = [`DThemeButtonTime`](../interfaces/DThemeButtonTime.md) |
| `OPTIONS` | extends [`DButtonTimeOptions`](../interfaces/DButtonTimeOptions.md)<`THEME`\> = [`DButtonTimeOptions`](../interfaces/DButtonTimeOptions.md)<`THEME`\> |
...
- [`DButton`](DButton.md)<`Date`, `THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DTableBodyCellTime`](DTableBodyCellTime.md)

## Table of contents

### Constructors

- [constructor](DButtonTime.md#constructor)

### Properties

- [\_accessibleActive](DButtonTime.md#_accessibleactive)
- [\_accessibleDiv](DButtonTime.md#_accessiblediv)
- [\_auto](DButtonTime.md#_auto)
- [\_background](DButtonTime.md#_background)
- [\_border](DButtonTime.md#_border)
- [\_bounds](DButtonTime.md#_bounds)
- [\_clearType](DButtonTime.md#_cleartype)
- [\_corner](DButtonTime.md#_corner)
- [\_cursor](DButtonTime.md#_cursor)
- [\_datetimeMask](DButtonTime.md#_datetimemask)
- [\_destroyed](DButtonTime.md#_destroyed)
- [\_dialog](DButtonTime.md#_dialog)
- [\_images](DButtonTime.md#_images)
- [\_isOverflowMaskEnabled](DButtonTime.md#_isoverflowmaskenabled)
- [\_isTextVisible](DButtonTime.md#_istextvisible)
- [\_isToggle](DButtonTime.md#_istoggle)
- [\_lastDownPoint](DButtonTime.md#_lastdownpoint)
- [\_lastSortedIndex](DButtonTime.md#_lastsortedindex)
- [\_mask](DButtonTime.md#_mask)
- [\_options](DButtonTime.md#_options)
- [\_outline](DButtonTime.md#_outline)
- [\_overflowMask](DButtonTime.md#_overflowmask)
- [\_padding](DButtonTime.md#_padding)
- [\_reflowable](DButtonTime.md#_reflowable)
- [\_shortcuts](DButtonTime.md#_shortcuts)
- [\_snippet](DButtonTime.md#_snippet)
- [\_tempDisplayObjectParent](DButtonTime.md#_tempdisplayobjectparent)
- [\_text](DButtonTime.md#_text)
- [\_textAlign](DButtonTime.md#_textalign)
- [\_textAlpha](DButtonTime.md#_textalpha)
- [\_textColor](DButtonTime.md#_textcolor)
- [\_textFormatter](DButtonTime.md#_textformatter)
- [\_textStyle](DButtonTime.md#_textstyle)
- [\_textValue](DButtonTime.md#_textvalue)
- [\_textValueComputed](DButtonTime.md#_textvaluecomputed)
- [\_title](DButtonTime.md#_title)
- [\_when](DButtonTime.md#_when)
- [\_zIndex](DButtonTime.md#_zindex)
- [accessible](DButtonTime.md#accessible)
- [accessibleChildren](DButtonTime.md#accessiblechildren)
- [accessibleHint](DButtonTime.md#accessiblehint)
- [accessiblePointerEvents](DButtonTime.md#accessiblepointerevents)
- [accessibleTitle](DButtonTime.md#accessibletitle)
- [accessibleType](DButtonTime.md#accessibletype)
- [alpha](DButtonTime.md#alpha)
- [angle](DButtonTime.md#angle)
- [buttonMode](DButtonTime.md#buttonmode)
- [cacheAsBitmap](DButtonTime.md#cacheasbitmap)
- [children](DButtonTime.md#children)
- [cursor](DButtonTime.md#cursor)
- [filterArea](DButtonTime.md#filterarea)
- [filters](DButtonTime.md#filters)
- [hitArea](DButtonTime.md#hitarea)
- [interactive](DButtonTime.md#interactive)
- [interactiveChildren](DButtonTime.md#interactivechildren)
- [isMask](DButtonTime.md#ismask)
- [isSprite](DButtonTime.md#issprite)
- [localTransform](DButtonTime.md#localtransform)
- [mask](DButtonTime.md#mask)
- [name](DButtonTime.md#name)
- [parent](DButtonTime.md#parent)
- [pivot](DButtonTime.md#pivot)
- [renderable](DButtonTime.md#renderable)
- [rotation](DButtonTime.md#rotation)
- [sortDirty](DButtonTime.md#sortdirty)
- [sortableChildren](DButtonTime.md#sortablechildren)
- [transform](DButtonTime.md#transform)
- [visible](DButtonTime.md#visible)
- [worldAlpha](DButtonTime.md#worldalpha)
- [worldTransform](DButtonTime.md#worldtransform)
- [worldVisible](DButtonTime.md#worldvisible)
- [zIndex](DButtonTime.md#zindex)
- [DIALOG](DButtonTime.md#dialog)
- [LAYOUTER](DButtonTime.md#layouter)
- [WORK\_CONTAINS\_POINT](DButtonTime.md#work_contains_point)

### Accessors

- [background](DButtonTime.md#background)
- [border](DButtonTime.md#border)
- [corner](DButtonTime.md#corner)
- [dialog](DButtonTime.md#dialog)
- [height](DButtonTime.md#height)
- [image](DButtonTime.md#image)
- [isToggle](DButtonTime.md#istoggle)
- [outline](DButtonTime.md#outline)
- [padding](DButtonTime.md#padding)
- [position](DButtonTime.md#position)
- [reflowable](DButtonTime.md#reflowable)
- [scale](DButtonTime.md#scale)
- [shadow](DButtonTime.md#shadow)
- [skew](DButtonTime.md#skew)
- [snippet](DButtonTime.md#snippet)
- [state](DButtonTime.md#state)
- [text](DButtonTime.md#text)
- [theme](DButtonTime.md#theme)
- [title](DButtonTime.md#title)
- [type](DButtonTime.md#type)
- [unsafe](DButtonTime.md#unsafe)
- [value](DButtonTime.md#value)
- [weight](DButtonTime.md#weight)
- [width](DButtonTime.md#width)
- [x](DButtonTime.md#x)
- [y](DButtonTime.md#y)

### Methods

- [\_calculateBounds](DButtonTime.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DButtonTime.md#_recursivepostupdatetransform)
- [\_render](DButtonTime.md#_render)
- [addChild](DButtonTime.md#addchild)
- [addChildAt](DButtonTime.md#addchildat)
- [addListener](DButtonTime.md#addlistener)
- [applyTitle](DButtonTime.md#applytitle)
- [blur](DButtonTime.md#blur)
- [calculateBounds](DButtonTime.md#calculatebounds)
- [computeTextValue](DButtonTime.md#computetextvalue)
- [containsGlobalPoint](DButtonTime.md#containsglobalpoint)
- [containsLocalPoint](DButtonTime.md#containslocalpoint)
- [containsPoint](DButtonTime.md#containspoint)
- [createOrUpdateText](DButtonTime.md#createorupdatetext)
- [createText](DButtonTime.md#createtext)
- [destroy](DButtonTime.md#destroy)
- [displayObjectUpdateTransform](DButtonTime.md#displayobjectupdatetransform)
- [emit](DButtonTime.md#emit)
- [eventNames](DButtonTime.md#eventnames)
- [focus](DButtonTime.md#focus)
- [focusOnClosest](DButtonTime.md#focusonclosest)
- [getBounds](DButtonTime.md#getbounds)
- [getChildAt](DButtonTime.md#getchildat)
- [getChildByName](DButtonTime.md#getchildbyname)
- [getChildIndex](DButtonTime.md#getchildindex)
- [getClearType](DButtonTime.md#getcleartype)
- [getClippingRect](DButtonTime.md#getclippingrect)
- [getDatetimeMask](DButtonTime.md#getdatetimemask)
- [getGlobalPosition](DButtonTime.md#getglobalposition)
- [getHeight](DButtonTime.md#getheight)
- [getLocalBounds](DButtonTime.md#getlocalbounds)
- [getOverflowMask](DButtonTime.md#getoverflowmask)
- [getParentOfSize](DButtonTime.md#getparentofsize)
- [getTextAlpha](DButtonTime.md#gettextalpha)
- [getTextColor](DButtonTime.md#gettextcolor)
- [getThemeDefault](DButtonTime.md#getthemedefault)
- [getType](DButtonTime.md#gettype)
- [getWidth](DButtonTime.md#getwidth)
- [getX](DButtonTime.md#getx)
- [getY](DButtonTime.md#gety)
- [hasDirty](DButtonTime.md#hasdirty)
- [hasRefitableHeight](DButtonTime.md#hasrefitableheight)
- [hasRefitableWidth](DButtonTime.md#hasrefitablewidth)
- [hide](DButtonTime.md#hide)
- [hideText](DButtonTime.md#hidetext)
- [init](DButtonTime.md#init)
- [initOnClick](DButtonTime.md#initonclick)
- [initOnPress](DButtonTime.md#initonpress)
- [initReflowable](DButtonTime.md#initreflowable)
- [isDirty](DButtonTime.md#isdirty)
- [isEventTarget](DButtonTime.md#iseventtarget)
- [isHidden](DButtonTime.md#ishidden)
- [isHierarchyDirty](DButtonTime.md#ishierarchydirty)
- [isRefitable](DButtonTime.md#isrefitable)
- [isShown](DButtonTime.md#isshown)
- [listenerCount](DButtonTime.md#listenercount)
- [listeners](DButtonTime.md#listeners)
- [newDialog](DButtonTime.md#newdialog)
- [newImage](DButtonTime.md#newimage)
- [newImages](DButtonTime.md#newimages)
- [off](DButtonTime.md#off)
- [on](DButtonTime.md#on)
- [onActivate](DButtonTime.md#onactivate)
- [onActivateKeyDown](DButtonTime.md#onactivatekeydown)
- [onActivateKeyUp](DButtonTime.md#onactivatekeyup)
- [onBlur](DButtonTime.md#onblur)
- [onChildBlur](DButtonTime.md#onchildblur)
- [onChildFocus](DButtonTime.md#onchildfocus)
- [onChildrenChange](DButtonTime.md#onchildrenchange)
- [onClick](DButtonTime.md#onclick)
- [onDblClick](DButtonTime.md#ondblclick)
- [onDown](DButtonTime.md#ondown)
- [onDownThis](DButtonTime.md#ondownthis)
- [onFocus](DButtonTime.md#onfocus)
- [onHierarchyDirty](DButtonTime.md#onhierarchydirty)
- [onInactivate](DButtonTime.md#oninactivate)
- [onKeyDown](DButtonTime.md#onkeydown)
- [onKeyUp](DButtonTime.md#onkeyup)
- [onMove](DButtonTime.md#onmove)
- [onOut](DButtonTime.md#onout)
- [onOver](DButtonTime.md#onover)
- [onParentMove](DButtonTime.md#onparentmove)
- [onParentResize](DButtonTime.md#onparentresize)
- [onRefit](DButtonTime.md#onrefit)
- [onReflow](DButtonTime.md#onreflow)
- [onResize](DButtonTime.md#onresize)
- [onScale](DButtonTime.md#onscale)
- [onShortcut](DButtonTime.md#onshortcut)
- [onSkew](DButtonTime.md#onskew)
- [onStateChange](DButtonTime.md#onstatechange)
- [onTextChange](DButtonTime.md#ontextchange)
- [onToggleEnd](DButtonTime.md#ontoggleend)
- [onToggleStart](DButtonTime.md#ontogglestart)
- [onUp](DButtonTime.md#onup)
- [onUpThis](DButtonTime.md#onupthis)
- [onValueChange](DButtonTime.md#onvaluechange)
- [onWheel](DButtonTime.md#onwheel)
- [once](DButtonTime.md#once)
- [reflow](DButtonTime.md#reflow)
- [removeAllListeners](DButtonTime.md#removealllisteners)
- [removeChild](DButtonTime.md#removechild)
- [removeChildAt](DButtonTime.md#removechildat)
- [removeChildren](DButtonTime.md#removechildren)
- [removeListener](DButtonTime.md#removelistener)
- [render](DButtonTime.md#render)
- [renderAdvanced](DButtonTime.md#renderadvanced)
- [resize](DButtonTime.md#resize)
- [setChildIndex](DButtonTime.md#setchildindex)
- [setFocused](DButtonTime.md#setfocused)
- [setHeight](DButtonTime.md#setheight)
- [setParent](DButtonTime.md#setparent)
- [setTransform](DButtonTime.md#settransform)
- [setWidth](DButtonTime.md#setwidth)
- [setX](DButtonTime.md#setx)
- [setY](DButtonTime.md#sety)
- [show](DButtonTime.md#show)
- [showText](DButtonTime.md#showtext)
- [sortChildren](DButtonTime.md#sortchildren)
- [swapChildren](DButtonTime.md#swapchildren)
- [toCursor](DButtonTime.md#tocursor)
- [toDirty](DButtonTime.md#todirty)
- [toGlobal](DButtonTime.md#toglobal)
- [toHasDirty](DButtonTime.md#tohasdirty)
- [toHierarchyDirty](DButtonTime.md#tohierarchydirty)
- [toImageOptions](DButtonTime.md#toimageoptions)
- [toLocal](DButtonTime.md#tolocal)
- [toParentHasDirty](DButtonTime.md#toparenthasdirty)
- [toParentHierarchyDirty](DButtonTime.md#toparenthierarchydirty)
- [toParentResized](DButtonTime.md#toparentresized)
- [toggle](DButtonTime.md#toggle)
- [updateText](DButtonTime.md#updatetext)
- [updateTextAndImage](DButtonTime.md#updatetextandimage)
- [updateTextColor](DButtonTime.md#updatetextcolor)
- [updateTextPosition](DButtonTime.md#updatetextposition)
- [updateTextValue](DButtonTime.md#updatetextvalue)
- [updateTransform](DButtonTime.md#updatetransform)
- [mixin](DButtonTime.md#mixin)

## Constructors

### constructor

• **new DButtonTime**<`THEME`, `OPTIONS`\>(`options?`)

#### Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeButtonTime`](../interfaces/DThemeButtonTime.md)<`THEME`\> = [`DThemeButtonTime`](../interfaces/DThemeButtonTime.md) |
| `OPTIONS` | extends [`DButtonTimeOptions`](../interfaces/DButtonTimeOptions.md)<`THEME`, `any`, `OPTIONS`\> = [`DButtonTimeOptions`](../interfaces/DButtonTimeOptions.md)<`THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:54](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-time.ts#L54)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:53](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-time.ts#L53)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:52](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-time.ts#L52)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:83](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-time.ts#L83)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:107](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-time.ts#L107)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:111](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-time.ts#L111)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DButtonTime`](DButtonTime.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DButtonTime`](DButtonTime.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DButtonTime`](DButtonTime.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:74](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-time.ts#L74)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:118](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-time.ts#L118)
...
▸ **hide**(): [`DButtonTime`](DButtonTime.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:103](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-time.ts#L103)
...
▸ **off**(`event`, `fn?`, `context?`): [`DButtonTime`](DButtonTime.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DButtonTime`](DButtonTime.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:56](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-time.ts#L56)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:69](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-time.ts#L69)
...
▸ **once**(`event`, `fn`, `context?`): [`DButtonTime`](DButtonTime.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DButtonTime`](DButtonTime.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DButtonTime`](DButtonTime.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DButtonTime`](DButtonTime.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DButtonTime`](DButtonTime.md)<`THEME`, `OPTIONS`\>
