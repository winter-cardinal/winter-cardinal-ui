[Winter Cardinal UI - v0.457.0](../index.md) / DThemeWhiteInputInput
...
- [getImageRotation](DThemeWhiteInputInput.md#getimagerotation)
...
- [getSecondaryImageRotation](DThemeWhiteInputInput.md#getsecondaryimagerotation)
...
- [getTertiaryImageRotation](DThemeWhiteInputInput.md#gettertiaryimagerotation)
...
- [getTextStyleFitting](DThemeWhiteInputInput.md#gettextstylefitting)
...
• **new DThemeWhiteInputInput**\<`VALUE`\>(): [`DThemeWhiteInputInput`](DThemeWhiteInputInput.md)\<`VALUE`\>
...
[`DThemeWhiteInputInput`](DThemeWhiteInputInput.md)\<`VALUE`\>
