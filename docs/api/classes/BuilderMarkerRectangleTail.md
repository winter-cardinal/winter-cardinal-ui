[Winter Cardinal UI - v0.374.0](../index.md) / BuilderMarkerRectangleTail
...
• **new BuilderMarkerRectangleTail**(`vertexOffset`, `indexOffset`): [`BuilderMarkerRectangleTail`](BuilderMarkerRectangleTail.md)
