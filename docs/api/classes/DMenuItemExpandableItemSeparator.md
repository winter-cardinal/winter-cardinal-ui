[Winter Cardinal UI - v0.374.0](../index.md) / DMenuItemExpandableItemSeparator
...
▸ **setFocused**(`isFocused`): [`DMenuItemExpandableItemSeparator`](DMenuItemExpandableItemSeparator.md)\<`VALUE`, `THEME`, `OPTIONS`\>
