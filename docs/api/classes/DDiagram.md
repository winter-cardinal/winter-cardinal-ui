[Winter Cardinal UI - v0.310.1](../index.md) / DDiagram
...
▸ `Protected` **onShapeRightCancel**(`e`): `void`
...
▸ `Protected` **onShapeRightClick**(`e`): `void`
...
▸ `Protected` **onShapeRightDown**(`e`): `void`
...
▸ `Protected` **onShapeRightUp**(`e`): `void`
