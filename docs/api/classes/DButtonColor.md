[Winter Cardinal UI - v0.407.0](../index.md) / DButtonColor
...
- [\_boundsID](DButtonColor.md#_boundsid)
- [\_boundsRect](DButtonColor.md#_boundsrect)
...
- [\_enabledFilters](DButtonColor.md#_enabledfilters)
- [\_image](DButtonColor.md#_image)
...
- [\_localBounds](DButtonColor.md#_localbounds)
- [\_localBoundsRect](DButtonColor.md#_localboundsrect)
...
- [containerUpdateTransform](DButtonColor.md#containerupdatetransform)
...
- [disableTempParent](DButtonColor.md#disabletempparent)
- [displayObjectUpdateTransform](DButtonColor.md#displayobjectupdatetransform)
- [emit](DButtonColor.md#emit)
- [enableTempParent](DButtonColor.md#enabletempparent)
...
- [getImage](DButtonColor.md#getimage)
- [getLayouter](DButtonColor.md#getlayouter)
...
- [getText](DButtonColor.md#gettext)
...
- [newOverflowMask](DButtonColor.md#newoverflowmask)
...
- [onReflowTextAndImage](DButtonColor.md#onreflowtextandimage)
...
[src/main/typescript/wcardinal/ui/d-button-color.ts:59](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-color.ts#L59)
...
• `Protected` `Optional` **\_text**: [`DTextPieceImpl`](DTextPieceImpl.md)\<[`DColorAndAlpha`](../interfaces/DColorAndAlpha.md)\>
...
[src/main/typescript/wcardinal/ui/d-button-color.ts:60](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-color.ts#L60)
...
[src/main/typescript/wcardinal/ui/d-button-color.ts:58](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-color.ts#L58)
...
[src/main/typescript/wcardinal/ui/d-button-color.ts:107](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-color.ts#L107)
...
[src/main/typescript/wcardinal/ui/d-button-color.ts:131](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-color.ts#L131)
...
▸ **getText**(): [`DTextPieceImpl`](DTextPieceImpl.md)\<[`DColorAndAlpha`](../interfaces/DColorAndAlpha.md)\>

#### Returns

[`DTextPieceImpl`](DTextPieceImpl.md)\<[`DColorAndAlpha`](../interfaces/DColorAndAlpha.md)\>
...
[src/main/typescript/wcardinal/ui/d-button-color.ts:156](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-color.ts#L156)
...
[src/main/typescript/wcardinal/ui/d-button-color.ts:127](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-color.ts#L127)
...
▸ **newText**(): [`DTextPieceImpl`](DTextPieceImpl.md)\<[`DColorAndAlpha`](../interfaces/DColorAndAlpha.md)\>
...
[src/main/typescript/wcardinal/ui/d-button-color.ts:140](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-color.ts#L140)
...
[src/main/typescript/wcardinal/ui/d-button-color.ts:62](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-color.ts#L62)
...
[src/main/typescript/wcardinal/ui/d-button-color.ts:96](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-color.ts#L96)
...
[src/main/typescript/wcardinal/ui/d-button-color.ts:86](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-color.ts#L86)
...
[src/main/typescript/wcardinal/ui/d-button-color.ts:79](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-color.ts#L79)
