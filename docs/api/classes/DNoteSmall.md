[Winter Cardinal UI - v0.407.0](../index.md) / DNoteSmall
...
- [\_boundsID](DNoteSmall.md#_boundsid)
- [\_boundsRect](DNoteSmall.md#_boundsrect)
...
- [\_enabledFilters](DNoteSmall.md#_enabledfilters)
- [\_image](DNoteSmall.md#_image)
- [\_lastDownPoint](DNoteSmall.md#_lastdownpoint)
- [\_lastSortedIndex](DNoteSmall.md#_lastsortedindex)
- [\_localBounds](DNoteSmall.md#_localbounds)
- [\_localBoundsRect](DNoteSmall.md#_localboundsrect)
...
- [containerUpdateTransform](DNoteSmall.md#containerupdatetransform)
...
- [disableTempParent](DNoteSmall.md#disabletempparent)
- [displayObjectUpdateTransform](DNoteSmall.md#displayobjectupdatetransform)
- [emit](DNoteSmall.md#emit)
- [enableTempParent](DNoteSmall.md#enabletempparent)
...
- [getImage](DNoteSmall.md#getimage)
- [getLayouter](DNoteSmall.md#getlayouter)
...
- [newOverflowMask](DNoteSmall.md#newoverflowmask)
...
- [onReflowTextAndImage](DNoteSmall.md#onreflowtextandimage)
...
[src/main/typescript/wcardinal/ui/d-note-small.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-note-small.ts#L17)
