[Winter Cardinal UI - v0.374.0](../index.md) / DNoteSmall
...
- [newPadding](DNoteSmall.md#newpadding)
- [newText](DNoteSmall.md#newtext)
...
• **new DNoteSmall**\<`THEME`, `OPTIONS`\>(`options?`): [`DNoteSmall`](DNoteSmall.md)\<`THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DNoteSmall`](DNoteSmall.md)\<`THEME`, `OPTIONS`\>
