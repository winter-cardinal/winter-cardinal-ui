[Winter Cardinal UI - v0.407.0](../index.md) / DBoard
...
- [containerUpdateTransform](DBoard.md#containerupdatetransform)
...
- [disableTempParent](DBoard.md#disabletempparent)
- [displayObjectUpdateTransform](DBoard.md#displayobjectupdatetransform)
- [emit](DBoard.md#emit)
- [enableTempParent](DBoard.md#enabletempparent)
...
- [newPadding](DBoard.md#newpadding)
- [off](DBoard.md#off)
- [on](DBoard.md#on)
...
• **new DBoard**\<`THEME`, `OPTIONS`\>(`options?`): [`DBoard`](DBoard.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-board.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-board.ts#L17)
...
▸ **setFocused**(`isFocused`): [`DBoard`](DBoard.md)\<`THEME`, `OPTIONS`\>
