[Winter Cardinal UI - v0.160.0](../index.md) / DBoard

# Class: DBoard<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeBoard`](../interfaces/DThemeBoard.md) = [`DThemeBoard`](../interfaces/DThemeBoard.md) |
| `OPTIONS` | extends [`DBoardOptions`](../interfaces/DBoardOptions.md)<`THEME`\> = [`DBoardOptions`](../interfaces/DBoardOptions.md)<`THEME`\> |
...
- [constructor](DBoard.md#constructor)

### Properties

- [\_accessibleActive](DBoard.md#_accessibleactive)
- [\_accessibleDiv](DBoard.md#_accessiblediv)
- [\_auto](DBoard.md#_auto)
- [\_background](DBoard.md#_background)
- [\_border](DBoard.md#_border)
- [\_bounds](DBoard.md#_bounds)
- [\_clearType](DBoard.md#_cleartype)
- [\_corner](DBoard.md#_corner)
- [\_cursor](DBoard.md#_cursor)
- [\_destroyed](DBoard.md#_destroyed)
- [\_lastDownPoint](DBoard.md#_lastdownpoint)
- [\_lastSortedIndex](DBoard.md#_lastsortedindex)
- [\_mask](DBoard.md#_mask)
- [\_options](DBoard.md#_options)
- [\_outline](DBoard.md#_outline)
- [\_padding](DBoard.md#_padding)
- [\_reflowable](DBoard.md#_reflowable)
- [\_shortcuts](DBoard.md#_shortcuts)
- [\_snippet](DBoard.md#_snippet)
- [\_tempDisplayObjectParent](DBoard.md#_tempdisplayobjectparent)
- [\_title](DBoard.md#_title)
- [\_zIndex](DBoard.md#_zindex)
- [accessible](DBoard.md#accessible)
- [accessibleChildren](DBoard.md#accessiblechildren)
- [accessibleHint](DBoard.md#accessiblehint)
- [accessiblePointerEvents](DBoard.md#accessiblepointerevents)
- [accessibleTitle](DBoard.md#accessibletitle)
- [accessibleType](DBoard.md#accessibletype)
- [alpha](DBoard.md#alpha)
- [angle](DBoard.md#angle)
- [buttonMode](DBoard.md#buttonmode)
- [cacheAsBitmap](DBoard.md#cacheasbitmap)
- [children](DBoard.md#children)
- [cursor](DBoard.md#cursor)
- [filterArea](DBoard.md#filterarea)
- [filters](DBoard.md#filters)
- [hitArea](DBoard.md#hitarea)
- [interactive](DBoard.md#interactive)
- [interactiveChildren](DBoard.md#interactivechildren)
- [isMask](DBoard.md#ismask)
- [isSprite](DBoard.md#issprite)
- [localTransform](DBoard.md#localtransform)
- [mask](DBoard.md#mask)
- [name](DBoard.md#name)
- [parent](DBoard.md#parent)
- [pivot](DBoard.md#pivot)
- [renderable](DBoard.md#renderable)
- [rotation](DBoard.md#rotation)
- [sortDirty](DBoard.md#sortdirty)
- [sortableChildren](DBoard.md#sortablechildren)
- [transform](DBoard.md#transform)
- [visible](DBoard.md#visible)
- [worldAlpha](DBoard.md#worldalpha)
- [worldTransform](DBoard.md#worldtransform)
- [worldVisible](DBoard.md#worldvisible)
- [zIndex](DBoard.md#zindex)
- [WORK\_CONTAINS\_POINT](DBoard.md#work_contains_point)

### Accessors

- [background](DBoard.md#background)
- [border](DBoard.md#border)
- [corner](DBoard.md#corner)
- [height](DBoard.md#height)
- [outline](DBoard.md#outline)
- [padding](DBoard.md#padding)
- [position](DBoard.md#position)
- [reflowable](DBoard.md#reflowable)
- [scale](DBoard.md#scale)
- [shadow](DBoard.md#shadow)
- [skew](DBoard.md#skew)
- [snippet](DBoard.md#snippet)
- [state](DBoard.md#state)
- [theme](DBoard.md#theme)
- [title](DBoard.md#title)
- [type](DBoard.md#type)
- [unsafe](DBoard.md#unsafe)
- [weight](DBoard.md#weight)
- [width](DBoard.md#width)
- [x](DBoard.md#x)
- [y](DBoard.md#y)

### Methods

- [\_calculateBounds](DBoard.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DBoard.md#_recursivepostupdatetransform)
- [\_render](DBoard.md#_render)
- [addChild](DBoard.md#addchild)
- [addChildAt](DBoard.md#addchildat)
- [addListener](DBoard.md#addlistener)
- [applyTitle](DBoard.md#applytitle)
- [blur](DBoard.md#blur)
- [calculateBounds](DBoard.md#calculatebounds)
- [containsGlobalPoint](DBoard.md#containsglobalpoint)
- [containsLocalPoint](DBoard.md#containslocalpoint)
- [containsPoint](DBoard.md#containspoint)
- [destroy](DBoard.md#destroy)
- [displayObjectUpdateTransform](DBoard.md#displayobjectupdatetransform)
- [emit](DBoard.md#emit)
- [eventNames](DBoard.md#eventnames)
- [focus](DBoard.md#focus)
- [focusOnClosest](DBoard.md#focusonclosest)
- [getBounds](DBoard.md#getbounds)
- [getChildAt](DBoard.md#getchildat)
- [getChildByName](DBoard.md#getchildbyname)
- [getChildIndex](DBoard.md#getchildindex)
- [getClearType](DBoard.md#getcleartype)
- [getClippingRect](DBoard.md#getclippingrect)
- [getGlobalPosition](DBoard.md#getglobalposition)
- [getHeight](DBoard.md#getheight)
- [getLocalBounds](DBoard.md#getlocalbounds)
- [getParentOfSize](DBoard.md#getparentofsize)
- [getThemeDefault](DBoard.md#getthemedefault)
- [getType](DBoard.md#gettype)
- [getWidth](DBoard.md#getwidth)
- [getX](DBoard.md#getx)
- [getY](DBoard.md#gety)
- [hasDirty](DBoard.md#hasdirty)
- [hasRefitableHeight](DBoard.md#hasrefitableheight)
- [hasRefitableWidth](DBoard.md#hasrefitablewidth)
- [hide](DBoard.md#hide)
- [init](DBoard.md#init)
- [initReflowable](DBoard.md#initreflowable)
- [isDirty](DBoard.md#isdirty)
- [isEventTarget](DBoard.md#iseventtarget)
- [isHidden](DBoard.md#ishidden)
- [isHierarchyDirty](DBoard.md#ishierarchydirty)
- [isRefitable](DBoard.md#isrefitable)
- [isShown](DBoard.md#isshown)
- [listenerCount](DBoard.md#listenercount)
- [listeners](DBoard.md#listeners)
- [off](DBoard.md#off)
- [on](DBoard.md#on)
- [onBlur](DBoard.md#onblur)
- [onChildBlur](DBoard.md#onchildblur)
- [onChildFocus](DBoard.md#onchildfocus)
- [onChildrenChange](DBoard.md#onchildrenchange)
- [onDblClick](DBoard.md#ondblclick)
- [onDown](DBoard.md#ondown)
- [onDownThis](DBoard.md#ondownthis)
- [onFocus](DBoard.md#onfocus)
- [onHierarchyDirty](DBoard.md#onhierarchydirty)
- [onKeyDown](DBoard.md#onkeydown)
- [onKeyUp](DBoard.md#onkeyup)
- [onMove](DBoard.md#onmove)
- [onOut](DBoard.md#onout)
- [onOver](DBoard.md#onover)
- [onParentMove](DBoard.md#onparentmove)
- [onParentResize](DBoard.md#onparentresize)
- [onRefit](DBoard.md#onrefit)
- [onReflow](DBoard.md#onreflow)
- [onResize](DBoard.md#onresize)
- [onScale](DBoard.md#onscale)
- [onShortcut](DBoard.md#onshortcut)
- [onSkew](DBoard.md#onskew)
- [onStateChange](DBoard.md#onstatechange)
- [onUp](DBoard.md#onup)
- [onUpThis](DBoard.md#onupthis)
- [onWheel](DBoard.md#onwheel)
- [once](DBoard.md#once)
- [reflow](DBoard.md#reflow)
- [removeAllListeners](DBoard.md#removealllisteners)
- [removeChild](DBoard.md#removechild)
- [removeChildAt](DBoard.md#removechildat)
- [removeChildren](DBoard.md#removechildren)
- [removeListener](DBoard.md#removelistener)
- [render](DBoard.md#render)
- [renderAdvanced](DBoard.md#renderadvanced)
- [resize](DBoard.md#resize)
- [setChildIndex](DBoard.md#setchildindex)
- [setFocused](DBoard.md#setfocused)
- [setHeight](DBoard.md#setheight)
- [setParent](DBoard.md#setparent)
- [setTransform](DBoard.md#settransform)
- [setWidth](DBoard.md#setwidth)
- [setX](DBoard.md#setx)
- [setY](DBoard.md#sety)
- [show](DBoard.md#show)
- [sortChildren](DBoard.md#sortchildren)
- [swapChildren](DBoard.md#swapchildren)
- [toCursor](DBoard.md#tocursor)
- [toDirty](DBoard.md#todirty)
- [toGlobal](DBoard.md#toglobal)
- [toHasDirty](DBoard.md#tohasdirty)
- [toHierarchyDirty](DBoard.md#tohierarchydirty)
- [toLocal](DBoard.md#tolocal)
- [toParentHasDirty](DBoard.md#toparenthasdirty)
- [toParentHierarchyDirty](DBoard.md#toparenthierarchydirty)
- [toParentResized](DBoard.md#toparentresized)
- [updateTransform](DBoard.md#updatetransform)
- [mixin](DBoard.md#mixin)

## Constructors

### constructor

• **new DBoard**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemeBoard`](../interfaces/DThemeBoard.md) = [`DThemeBoard`](../interfaces/DThemeBoard.md) |
| `OPTIONS` | extends [`DBoardOptions`](../interfaces/DBoardOptions.md)<`THEME`, `OPTIONS`\> = [`DBoardOptions`](../interfaces/DBoardOptions.md)<`THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DBoard`](DBoard.md)<`THEME`, `OPTIONS`\>
...
[`DBoard`](DBoard.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DBoard`](DBoard.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DBoard`](DBoard.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-board.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-board.ts#L17)
...
▸ **hide**(): [`DBoard`](DBoard.md)<`THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DBoard`](DBoard.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DBoard`](DBoard.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DBoard`](DBoard.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DBoard`](DBoard.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DBoard`](DBoard.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DBoard`](DBoard.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DBoard`](DBoard.md)<`THEME`, `OPTIONS`\>
