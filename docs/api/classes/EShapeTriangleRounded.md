[Winter Cardinal UI - v0.407.0](../index.md) / EShapeTriangleRounded
...
[src/main/typescript/wcardinal/ui/shape/variant/e-shape-triangle-rounded.ts:11](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/shape/variant/e-shape-triangle-rounded.ts#L11)
...
[src/main/typescript/wcardinal/ui/shape/variant/e-shape-triangle-rounded.ts:15](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/shape/variant/e-shape-triangle-rounded.ts#L15)
...
[src/main/typescript/wcardinal/ui/shape/variant/e-shape-triangle-rounded.ts:19](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/shape/variant/e-shape-triangle-rounded.ts#L19)
...
▸ **detach**(`exceptions?`): [`EShapeTriangleRounded`](EShapeTriangleRounded.md)
...
▸ **lock**(`part`): [`EShapeTriangleRounded`](EShapeTriangleRounded.md)
...
▸ **unlock**(`part`, `invoke`): [`EShapeTriangleRounded`](EShapeTriangleRounded.md)
