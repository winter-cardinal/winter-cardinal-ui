[Winter Cardinal UI - v0.154.0](../index.md) / DPaginationDynamicButtons

# Class: DPaginationDynamicButtons<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemePaginationDynamicButtons`](../interfaces/DThemePaginationDynamicButtons.md) = [`DThemePaginationDynamicButtons`](../interfaces/DThemePaginationDynamicButtons.md) |
| `OPTIONS` | extends [`DPaginationDynamicButtonsOptions`](../interfaces/DPaginationDynamicButtonsOptions.md)<`THEME`\> = [`DPaginationDynamicButtonsOptions`](../interfaces/DPaginationDynamicButtonsOptions.md)<`THEME`\> |

## Hierarchy

- [`DLayoutHorizontal`](DLayoutHorizontal.md)<`THEME`, `OPTIONS`\>

  ↳ **`DPaginationDynamicButtons`**

## Table of contents

### Constructors

- [constructor](DPaginationDynamicButtons.md#constructor)

### Properties

- [\_accessibleActive](DPaginationDynamicButtons.md#_accessibleactive)
- [\_accessibleDiv](DPaginationDynamicButtons.md#_accessiblediv)
- [\_auto](DPaginationDynamicButtons.md#_auto)
- [\_background](DPaginationDynamicButtons.md#_background)
- [\_border](DPaginationDynamicButtons.md#_border)
- [\_bounds](DPaginationDynamicButtons.md#_bounds)
- [\_clearType](DPaginationDynamicButtons.md#_cleartype)
- [\_corner](DPaginationDynamicButtons.md#_corner)
- [\_cornerAdjust](DPaginationDynamicButtons.md#_corneradjust)
- [\_cursor](DPaginationDynamicButtons.md#_cursor)
- [\_destroyed](DPaginationDynamicButtons.md#_destroyed)
- [\_direction](DPaginationDynamicButtons.md#_direction)
- [\_dotsBtnLeft](DPaginationDynamicButtons.md#_dotsbtnleft)
- [\_dotsBtnRight](DPaginationDynamicButtons.md#_dotsbtnright)
- [\_isChildrenDirty](DPaginationDynamicButtons.md#_ischildrendirty)
- [\_lastDownPoint](DPaginationDynamicButtons.md#_lastdownpoint)
- [\_lastSortedIndex](DPaginationDynamicButtons.md#_lastsortedindex)
- [\_margin](DPaginationDynamicButtons.md#_margin)
- [\_mask](DPaginationDynamicButtons.md#_mask)
- [\_multiplicity](DPaginationDynamicButtons.md#_multiplicity)
- [\_options](DPaginationDynamicButtons.md#_options)
- [\_outline](DPaginationDynamicButtons.md#_outline)
- [\_padding](DPaginationDynamicButtons.md#_padding)
- [\_reflowable](DPaginationDynamicButtons.md#_reflowable)
- [\_reverse](DPaginationDynamicButtons.md#_reverse)
- [\_shortcuts](DPaginationDynamicButtons.md#_shortcuts)
- [\_snippet](DPaginationDynamicButtons.md#_snippet)
- [\_tempDisplayObjectParent](DPaginationDynamicButtons.md#_tempdisplayobjectparent)
- [\_title](DPaginationDynamicButtons.md#_title)
- [\_zIndex](DPaginationDynamicButtons.md#_zindex)
- [accessible](DPaginationDynamicButtons.md#accessible)
- [accessibleChildren](DPaginationDynamicButtons.md#accessiblechildren)
- [accessibleHint](DPaginationDynamicButtons.md#accessiblehint)
- [accessiblePointerEvents](DPaginationDynamicButtons.md#accessiblepointerevents)
- [accessibleTitle](DPaginationDynamicButtons.md#accessibletitle)
- [accessibleType](DPaginationDynamicButtons.md#accessibletype)
- [alpha](DPaginationDynamicButtons.md#alpha)
- [angle](DPaginationDynamicButtons.md#angle)
- [buttonMode](DPaginationDynamicButtons.md#buttonmode)
- [cacheAsBitmap](DPaginationDynamicButtons.md#cacheasbitmap)
- [children](DPaginationDynamicButtons.md#children)
- [cursor](DPaginationDynamicButtons.md#cursor)
- [filterArea](DPaginationDynamicButtons.md#filterarea)
- [filters](DPaginationDynamicButtons.md#filters)
- [hitArea](DPaginationDynamicButtons.md#hitarea)
- [interactive](DPaginationDynamicButtons.md#interactive)
- [interactiveChildren](DPaginationDynamicButtons.md#interactivechildren)
- [isMask](DPaginationDynamicButtons.md#ismask)
- [isSprite](DPaginationDynamicButtons.md#issprite)
- [localTransform](DPaginationDynamicButtons.md#localtransform)
- [mask](DPaginationDynamicButtons.md#mask)
- [name](DPaginationDynamicButtons.md#name)
- [parent](DPaginationDynamicButtons.md#parent)
- [pivot](DPaginationDynamicButtons.md#pivot)
- [renderable](DPaginationDynamicButtons.md#renderable)
- [rotation](DPaginationDynamicButtons.md#rotation)
- [sortDirty](DPaginationDynamicButtons.md#sortdirty)
- [sortableChildren](DPaginationDynamicButtons.md#sortablechildren)
- [transform](DPaginationDynamicButtons.md#transform)
- [visible](DPaginationDynamicButtons.md#visible)
- [worldAlpha](DPaginationDynamicButtons.md#worldalpha)
- [worldTransform](DPaginationDynamicButtons.md#worldtransform)
- [worldVisible](DPaginationDynamicButtons.md#worldvisible)
- [zIndex](DPaginationDynamicButtons.md#zindex)
- [CORNER\_ADJUST\_WORK](DPaginationDynamicButtons.md#corner_adjust_work)
- [WORK\_CONTAINS\_POINT](DPaginationDynamicButtons.md#work_contains_point)

### Accessors

- [background](DPaginationDynamicButtons.md#background)
- [border](DPaginationDynamicButtons.md#border)
- [corner](DPaginationDynamicButtons.md#corner)
- [height](DPaginationDynamicButtons.md#height)
- [margin](DPaginationDynamicButtons.md#margin)
- [multiplicity](DPaginationDynamicButtons.md#multiplicity)
- [outline](DPaginationDynamicButtons.md#outline)
- [padding](DPaginationDynamicButtons.md#padding)
- [position](DPaginationDynamicButtons.md#position)
- [reflowable](DPaginationDynamicButtons.md#reflowable)
- [scale](DPaginationDynamicButtons.md#scale)
- [shadow](DPaginationDynamicButtons.md#shadow)
- [skew](DPaginationDynamicButtons.md#skew)
- [snippet](DPaginationDynamicButtons.md#snippet)
- [state](DPaginationDynamicButtons.md#state)
- [theme](DPaginationDynamicButtons.md#theme)
- [title](DPaginationDynamicButtons.md#title)
- [type](DPaginationDynamicButtons.md#type)
- [unsafe](DPaginationDynamicButtons.md#unsafe)
- [weight](DPaginationDynamicButtons.md#weight)
- [width](DPaginationDynamicButtons.md#width)
- [x](DPaginationDynamicButtons.md#x)
- [y](DPaginationDynamicButtons.md#y)

### Methods

- [\_calculateBounds](DPaginationDynamicButtons.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DPaginationDynamicButtons.md#_recursivepostupdatetransform)
- [\_render](DPaginationDynamicButtons.md#_render)
- [addChild](DPaginationDynamicButtons.md#addchild)
- [addChildAt](DPaginationDynamicButtons.md#addchildat)
- [addListener](DPaginationDynamicButtons.md#addlistener)
- [addSpace](DPaginationDynamicButtons.md#addspace)
- [applyTitle](DPaginationDynamicButtons.md#applytitle)
- [blur](DPaginationDynamicButtons.md#blur)
- [calcSpaceLeft](DPaginationDynamicButtons.md#calcspaceleft)
- [calculateBounds](DPaginationDynamicButtons.md#calculatebounds)
- [containsGlobalPoint](DPaginationDynamicButtons.md#containsglobalpoint)
- [containsLocalPoint](DPaginationDynamicButtons.md#containslocalpoint)
- [containsPoint](DPaginationDynamicButtons.md#containspoint)
- [countColumn](DPaginationDynamicButtons.md#countcolumn)
- [countRow](DPaginationDynamicButtons.md#countrow)
- [destroy](DPaginationDynamicButtons.md#destroy)
- [displayObjectUpdateTransform](DPaginationDynamicButtons.md#displayobjectupdatetransform)
- [emit](DPaginationDynamicButtons.md#emit)
- [eventNames](DPaginationDynamicButtons.md#eventnames)
- [findColumnIndexNext](DPaginationDynamicButtons.md#findcolumnindexnext)
- [findColumnIndexPrevious](DPaginationDynamicButtons.md#findcolumnindexprevious)
- [findRowIndexNext](DPaginationDynamicButtons.md#findrowindexnext)
- [findRowIndexPrevious](DPaginationDynamicButtons.md#findrowindexprevious)
- [focus](DPaginationDynamicButtons.md#focus)
- [focusOnClosest](DPaginationDynamicButtons.md#focusonclosest)
- [getBounds](DPaginationDynamicButtons.md#getbounds)
- [getChildAt](DPaginationDynamicButtons.md#getchildat)
- [getChildByName](DPaginationDynamicButtons.md#getchildbyname)
- [getChildIndex](DPaginationDynamicButtons.md#getchildindex)
- [getClearType](DPaginationDynamicButtons.md#getcleartype)
- [getClippingRect](DPaginationDynamicButtons.md#getclippingrect)
- [getGlobalPosition](DPaginationDynamicButtons.md#getglobalposition)
- [getHeight](DPaginationDynamicButtons.md#getheight)
- [getLocalBounds](DPaginationDynamicButtons.md#getlocalbounds)
- [getParentOfSize](DPaginationDynamicButtons.md#getparentofsize)
- [getSpaceLeft](DPaginationDynamicButtons.md#getspaceleft)
- [getThemeDefault](DPaginationDynamicButtons.md#getthemedefault)
- [getType](DPaginationDynamicButtons.md#gettype)
- [getWeightTotal](DPaginationDynamicButtons.md#getweighttotal)
- [getWidth](DPaginationDynamicButtons.md#getwidth)
- [getX](DPaginationDynamicButtons.md#getx)
- [getY](DPaginationDynamicButtons.md#gety)
- [hasClearType](DPaginationDynamicButtons.md#hascleartype)
- [hasClearTypeAfter](DPaginationDynamicButtons.md#hascleartypeafter)
- [hasClearTypeBefore](DPaginationDynamicButtons.md#hascleartypebefore)
- [hasDirty](DPaginationDynamicButtons.md#hasdirty)
- [hasRefitableHeight](DPaginationDynamicButtons.md#hasrefitableheight)
- [hasRefitableWidth](DPaginationDynamicButtons.md#hasrefitablewidth)
- [hide](DPaginationDynamicButtons.md#hide)
- [init](DPaginationDynamicButtons.md#init)
- [initReflowable](DPaginationDynamicButtons.md#initreflowable)
- [isChildrenDirty](DPaginationDynamicButtons.md#ischildrendirty)
- [isDirty](DPaginationDynamicButtons.md#isdirty)
- [isEventTarget](DPaginationDynamicButtons.md#iseventtarget)
- [isHidden](DPaginationDynamicButtons.md#ishidden)
- [isRefitable](DPaginationDynamicButtons.md#isrefitable)
- [isShown](DPaginationDynamicButtons.md#isshown)
- [listenerCount](DPaginationDynamicButtons.md#listenercount)
- [listeners](DPaginationDynamicButtons.md#listeners)
- [off](DPaginationDynamicButtons.md#off)
- [on](DPaginationDynamicButtons.md#on)
- [onBlur](DPaginationDynamicButtons.md#onblur)
- [onChildBlur](DPaginationDynamicButtons.md#onchildblur)
- [onChildFocus](DPaginationDynamicButtons.md#onchildfocus)
- [onChildrenChange](DPaginationDynamicButtons.md#onchildrenchange)
- [onChildrenDirty](DPaginationDynamicButtons.md#onchildrendirty)
- [onDblClick](DPaginationDynamicButtons.md#ondblclick)
- [onDown](DPaginationDynamicButtons.md#ondown)
- [onDownThis](DPaginationDynamicButtons.md#ondownthis)
- [onFocus](DPaginationDynamicButtons.md#onfocus)
- [onKeyDown](DPaginationDynamicButtons.md#onkeydown)
- [onKeyUp](DPaginationDynamicButtons.md#onkeyup)
- [onMove](DPaginationDynamicButtons.md#onmove)
- [onOut](DPaginationDynamicButtons.md#onout)
- [onOver](DPaginationDynamicButtons.md#onover)
- [onParentMove](DPaginationDynamicButtons.md#onparentmove)
- [onParentResize](DPaginationDynamicButtons.md#onparentresize)
- [onRefit](DPaginationDynamicButtons.md#onrefit)
- [onReflow](DPaginationDynamicButtons.md#onreflow)
- [onResize](DPaginationDynamicButtons.md#onresize)
- [onScale](DPaginationDynamicButtons.md#onscale)
- [onShortcut](DPaginationDynamicButtons.md#onshortcut)
- [onSkew](DPaginationDynamicButtons.md#onskew)
- [onStateChange](DPaginationDynamicButtons.md#onstatechange)
- [onUp](DPaginationDynamicButtons.md#onup)
- [onUpThis](DPaginationDynamicButtons.md#onupthis)
- [onWheel](DPaginationDynamicButtons.md#onwheel)
- [once](DPaginationDynamicButtons.md#once)
- [refit](DPaginationDynamicButtons.md#refit)
- [reflow](DPaginationDynamicButtons.md#reflow)
- [removeAllListeners](DPaginationDynamicButtons.md#removealllisteners)
- [removeChild](DPaginationDynamicButtons.md#removechild)
- [removeChildAt](DPaginationDynamicButtons.md#removechildat)
- [removeChildren](DPaginationDynamicButtons.md#removechildren)
- [removeListener](DPaginationDynamicButtons.md#removelistener)
- [render](DPaginationDynamicButtons.md#render)
- [renderAdvanced](DPaginationDynamicButtons.md#renderadvanced)
- [resize](DPaginationDynamicButtons.md#resize)
- [setChildIndex](DPaginationDynamicButtons.md#setchildindex)
- [setFocused](DPaginationDynamicButtons.md#setfocused)
- [setHeight](DPaginationDynamicButtons.md#setheight)
- [setParent](DPaginationDynamicButtons.md#setparent)
- [setTransform](DPaginationDynamicButtons.md#settransform)
- [setWidth](DPaginationDynamicButtons.md#setwidth)
- [setX](DPaginationDynamicButtons.md#setx)
- [setY](DPaginationDynamicButtons.md#sety)
- [show](DPaginationDynamicButtons.md#show)
- [sortChildren](DPaginationDynamicButtons.md#sortchildren)
- [swapChildren](DPaginationDynamicButtons.md#swapchildren)
- [toChildrenDirty](DPaginationDynamicButtons.md#tochildrendirty)
- [toCornerMaskColumn](DPaginationDynamicButtons.md#tocornermaskcolumn)
- [toCornerMaskRow](DPaginationDynamicButtons.md#tocornermaskrow)
- [toCursor](DPaginationDynamicButtons.md#tocursor)
- [toDirty](DPaginationDynamicButtons.md#todirty)
- [toGlobal](DPaginationDynamicButtons.md#toglobal)
- [toHasDirty](DPaginationDynamicButtons.md#tohasdirty)
- [toLocal](DPaginationDynamicButtons.md#tolocal)
- [toParentChildrenDirty](DPaginationDynamicButtons.md#toparentchildrendirty)
- [toParentHasDirty](DPaginationDynamicButtons.md#toparenthasdirty)
- [toParentResized](DPaginationDynamicButtons.md#toparentresized)
- [update](DPaginationDynamicButtons.md#update)
- [updateTransform](DPaginationDynamicButtons.md#updatetransform)
- [mixin](DPaginationDynamicButtons.md#mixin)

## Constructors

### constructor

• **new DPaginationDynamicButtons**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemePaginationDynamicButtons`](../interfaces/DThemePaginationDynamicButtons.md) = [`DThemePaginationDynamicButtons`](../interfaces/DThemePaginationDynamicButtons.md) |
| `OPTIONS` | extends [`DPaginationDynamicButtonsOptions`](../interfaces/DPaginationDynamicButtonsOptions.md)<`THEME`, `OPTIONS`\> = [`DPaginationDynamicButtonsOptions`](../interfaces/DPaginationDynamicButtonsOptions.md)<`THEME`\> |
...
• `Protected` **\_dotsBtnLeft**: [`DPaginationDotsButton`](DPaginationDotsButton.md)<[`DThemePaginationDotsButton`](../interfaces/DThemePaginationDotsButton.md), [`DPaginationDotsButtonOptions`](../interfaces/DPaginationDotsButtonOptions.md)<[`DThemePaginationDotsButton`](../interfaces/DThemePaginationDotsButton.md)\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts:32](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts#L32)

___

### \_dotsBtnRight

• `Protected` **\_dotsBtnRight**: [`DPaginationDotsButton`](DPaginationDotsButton.md)<[`DThemePaginationDotsButton`](../interfaces/DThemePaginationDotsButton.md), [`DPaginationDotsButtonOptions`](../interfaces/DPaginationDotsButtonOptions.md)<[`DThemePaginationDotsButton`](../interfaces/DThemePaginationDotsButton.md)\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts:33](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts#L33)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DPaginationDynamicButtons`](DPaginationDynamicButtons.md)<`THEME`, `OPTIONS`\>
...
[`DPaginationDynamicButtons`](DPaginationDynamicButtons.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DPaginationDynamicButtons`](DPaginationDynamicButtons.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DPaginationDynamicButtons`](DPaginationDynamicButtons.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts:94](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts#L94)
...
▸ **hide**(): [`DPaginationDynamicButtons`](DPaginationDynamicButtons.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts:35](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts#L35)
...
▸ **off**(`event`, `fn?`, `context?`): [`DPaginationDynamicButtons`](DPaginationDynamicButtons.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DPaginationDynamicButtons`](DPaginationDynamicButtons.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DPaginationDynamicButtons`](DPaginationDynamicButtons.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DPaginationDynamicButtons`](DPaginationDynamicButtons.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DPaginationDynamicButtons`](DPaginationDynamicButtons.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DPaginationDynamicButtons`](DPaginationDynamicButtons.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DPaginationDynamicButtons`](DPaginationDynamicButtons.md)<`THEME`, `OPTIONS`\>
...
| Name | Type |
| :------ | :------ |
| `options` | [`DPaginationDynamicButtonsOptions`](../interfaces/DPaginationDynamicButtonsOptions.md)<`THEME`\> |
...
[src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts:49](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts#L49)
