[Winter Cardinal UI - v0.374.0](../index.md) / DTableBodyCellActionDialog
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-action-dialog.ts:31](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-table-body-cell-action-dialog.ts#L31)
...
▸ **setFocused**(`isFocused`): [`DTableBodyCellActionDialog`](DTableBodyCellActionDialog.md)\<`ROW`, `VALUE`, `THEME`, `OPTIONS`\>
