[Winter Cardinal UI - v0.155.0](../index.md) / DDiagramCanvasBase
...
- [\_isChildrenDirty](DDiagramCanvasBase.md#_ischildrendirty)
...
- [isChildrenDirty](DDiagramCanvasBase.md#ischildrendirty)
...
- [onChildrenDirty](DDiagramCanvasBase.md#onchildrendirty)
...
- [refit](DDiagramCanvasBase.md#refit)
...
- [toChildrenDirty](DDiagramCanvasBase.md#tochildrendirty)
...
- [toParentChildrenDirty](DDiagramCanvasBase.md#toparentchildrendirty)
...
[src/main/typescript/wcardinal/ui/d-diagram-canvas-base.ts:38](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-diagram-canvas-base.ts#L38)
...
[DCanvas](DCanvas.md).[_isChildrenDirty](DCanvas.md#_ischildrendirty)
...
[src/main/typescript/wcardinal/ui/d-diagram-canvas-base.ts:103](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-diagram-canvas-base.ts#L103)
...
[src/main/typescript/wcardinal/ui/d-diagram-canvas-base.ts:77](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-diagram-canvas-base.ts#L77)
...
[DCanvas](DCanvas.md).[isChildrenDirty](DCanvas.md#ischildrendirty)
...
[DCanvas](DCanvas.md).[onChildrenDirty](DCanvas.md#onchildrendirty)
...
[DCanvas](DCanvas.md).[refit](DCanvas.md#refit)
...
[DCanvas](DCanvas.md).[toChildrenDirty](DCanvas.md#tochildrendirty)
...
[DCanvas](DCanvas.md).[toParentChildrenDirty](DCanvas.md#toparentchildrendirty)
