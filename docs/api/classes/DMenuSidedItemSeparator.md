[Winter Cardinal UI - v0.374.0](../index.md) / DMenuSidedItemSeparator
...
▸ **setFocused**(`isFocused`): [`DMenuSidedItemSeparator`](DMenuSidedItemSeparator.md)\<`VALUE`, `THEME`, `OPTIONS`\>
