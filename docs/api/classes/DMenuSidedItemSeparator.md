[Winter Cardinal UI - v0.155.0](../index.md) / DMenuSidedItemSeparator
...
- [\_isChildrenDirty](DMenuSidedItemSeparator.md#_ischildrendirty)
...
- [isChildrenDirty](DMenuSidedItemSeparator.md#ischildrendirty)
...
- [onChildrenDirty](DMenuSidedItemSeparator.md#onchildrendirty)
...
- [refit](DMenuSidedItemSeparator.md#refit)
...
- [toChildrenDirty](DMenuSidedItemSeparator.md#tochildrendirty)
...
[src/main/typescript/wcardinal/ui/d-menu-sided-item-separator.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-menu-sided-item-separator.ts#L20)
