[Winter Cardinal UI - v0.407.0](../index.md) / DMenuSidedItemExpandableItemCheck
...
[src/main/typescript/wcardinal/ui/d-menu-sided-item-expandable-item-check.ts:14](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-sided-item-expandable-item-check.ts#L14)
...
▸ **setFocused**(`isFocused`): [`DMenuSidedItemExpandableItemCheck`](DMenuSidedItemExpandableItemCheck.md)\<`VALUE`, `THEME`, `OPTIONS`\>
