[Winter Cardinal UI - v0.407.0](../index.md) / DExpandableHeader
...
- [\_boundsID](DExpandableHeader.md#_boundsid)
- [\_boundsRect](DExpandableHeader.md#_boundsrect)
...
- [\_enabledFilters](DExpandableHeader.md#_enabledfilters)
- [\_image](DExpandableHeader.md#_image)
- [\_lastDownPoint](DExpandableHeader.md#_lastdownpoint)
- [\_lastSortedIndex](DExpandableHeader.md#_lastsortedindex)
- [\_localBounds](DExpandableHeader.md#_localbounds)
- [\_localBoundsRect](DExpandableHeader.md#_localboundsrect)
...
- [options](DExpandableHeader.md#options)
...
- [containerUpdateTransform](DExpandableHeader.md#containerupdatetransform)
...
- [disableTempParent](DExpandableHeader.md#disabletempparent)
- [displayObjectUpdateTransform](DExpandableHeader.md#displayobjectupdatetransform)
- [emit](DExpandableHeader.md#emit)
- [enableTempParent](DExpandableHeader.md#enabletempparent)
...
- [getImage](DExpandableHeader.md#getimage)
- [getLayouter](DExpandableHeader.md#getlayouter)
...
- [getText](DExpandableHeader.md#gettext)
...
- [newOverflowMask](DExpandableHeader.md#newoverflowmask)
- [newPadding](DExpandableHeader.md#newpadding)
- [newText](DExpandableHeader.md#newtext)
...
- [onReflowTextAndImage](DExpandableHeader.md#onreflowtextandimage)
...
• **new DExpandableHeader**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DExpandableHeader`](DExpandableHeader.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-expandable-header.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-expandable-header.ts#L23)
...
[src/main/typescript/wcardinal/ui/d-expandable-header.ts:52](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-expandable-header.ts#L52)
...
[src/main/typescript/wcardinal/ui/d-expandable-header.ts:37](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-expandable-header.ts#L37)
...
[src/main/typescript/wcardinal/ui/d-expandable-header.ts:44](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-expandable-header.ts#L44)
...
[src/main/typescript/wcardinal/ui/d-expandable-header.ts:33](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-expandable-header.ts#L33)
...
▸ **setFocused**(`isFocused`): [`DExpandableHeader`](DExpandableHeader.md)\<`VALUE`, `THEME`, `OPTIONS`\>
