[Winter Cardinal UI - v0.407.0](../index.md) / DThemeDarkEnUsNoteError

# Class: DThemeDarkEnUsNoteError
...
- [`DThemeDarkNoteError`](DThemeDarkNoteError.md)
  ...
  ↳ **`DThemeDarkEnUsNoteError`**

## Table of contents

### Constructors

- [constructor](DThemeDarkEnUsNoteError.md#constructor)

### Methods

- [getAlpha](DThemeDarkEnUsNoteError.md#getalpha)
- [getBackgroundAlpha](DThemeDarkEnUsNoteError.md#getbackgroundalpha)
- [getBackgroundColor](DThemeDarkEnUsNoteError.md#getbackgroundcolor)
- [getBackgroundTexture](DThemeDarkEnUsNoteError.md#getbackgroundtexture)
- [getBorderAlign](DThemeDarkEnUsNoteError.md#getborderalign)
- [getBorderAlpha](DThemeDarkEnUsNoteError.md#getborderalpha)
- [getBorderColor](DThemeDarkEnUsNoteError.md#getbordercolor)
- [getBorderMask](DThemeDarkEnUsNoteError.md#getbordermask)
- [getBorderTexture](DThemeDarkEnUsNoteError.md#getbordertexture)
- [getBorderWidth](DThemeDarkEnUsNoteError.md#getborderwidth)
- [getClearType](DThemeDarkEnUsNoteError.md#getcleartype)
- [getColor](DThemeDarkEnUsNoteError.md#getcolor)
- [getCornerMask](DThemeDarkEnUsNoteError.md#getcornermask)
- [getCornerRadius](DThemeDarkEnUsNoteError.md#getcornerradius)
- [getCursor](DThemeDarkEnUsNoteError.md#getcursor)
- [getFontFamilly](DThemeDarkEnUsNoteError.md#getfontfamilly)
- [getFontSize](DThemeDarkEnUsNoteError.md#getfontsize)
- [getFontStyle](DThemeDarkEnUsNoteError.md#getfontstyle)
- [getFontVariant](DThemeDarkEnUsNoteError.md#getfontvariant)
- [getFontWeight](DThemeDarkEnUsNoteError.md#getfontweight)
- [getHeight](DThemeDarkEnUsNoteError.md#getheight)
- [getImageAlignHorizontal](DThemeDarkEnUsNoteError.md#getimagealignhorizontal)
- [getImageAlignVertical](DThemeDarkEnUsNoteError.md#getimagealignvertical)
- [getImageAlignWith](DThemeDarkEnUsNoteError.md#getimagealignwith)
- [getImageMarginHorizontal](DThemeDarkEnUsNoteError.md#getimagemarginhorizontal)
- [getImageMarginVertial](DThemeDarkEnUsNoteError.md#getimagemarginvertial)
- [getImageRotation](DThemeDarkEnUsNoteError.md#getimagerotation)
- [getImageSource](DThemeDarkEnUsNoteError.md#getimagesource)
- [getImageTintAlpha](DThemeDarkEnUsNoteError.md#getimagetintalpha)
- [getImageTintColor](DThemeDarkEnUsNoteError.md#getimagetintcolor)
- [getInteractive](DThemeDarkEnUsNoteError.md#getinteractive)
- [getLineHeight](DThemeDarkEnUsNoteError.md#getlineheight)
- [getOutlineAlign](DThemeDarkEnUsNoteError.md#getoutlinealign)
- [getOutlineAlpha](DThemeDarkEnUsNoteError.md#getoutlinealpha)
- [getOutlineColor](DThemeDarkEnUsNoteError.md#getoutlinecolor)
- [getOutlineMask](DThemeDarkEnUsNoteError.md#getoutlinemask)
- [getOutlineOffset](DThemeDarkEnUsNoteError.md#getoutlineoffset)
- [getOutlineWidth](DThemeDarkEnUsNoteError.md#getoutlinewidth)
- [getPaddingBottom](DThemeDarkEnUsNoteError.md#getpaddingbottom)
- [getPaddingLeft](DThemeDarkEnUsNoteError.md#getpaddingleft)
- [getPaddingRight](DThemeDarkEnUsNoteError.md#getpaddingright)
- [getPaddingTop](DThemeDarkEnUsNoteError.md#getpaddingtop)
- [getSecondaryImageAlignHorizontal](DThemeDarkEnUsNoteError.md#getsecondaryimagealignhorizontal)
- [getSecondaryImageAlignVertical](DThemeDarkEnUsNoteError.md#getsecondaryimagealignvertical)
- [getSecondaryImageAlignWith](DThemeDarkEnUsNoteError.md#getsecondaryimagealignwith)
- [getSecondaryImageMarginHorizontal](DThemeDarkEnUsNoteError.md#getsecondaryimagemarginhorizontal)
- [getSecondaryImageMarginVertial](DThemeDarkEnUsNoteError.md#getsecondaryimagemarginvertial)
- [getSecondaryImageRotation](DThemeDarkEnUsNoteError.md#getsecondaryimagerotation)
- [getSecondaryImageTintAlpha](DThemeDarkEnUsNoteError.md#getsecondaryimagetintalpha)
- [getSecondaryImageTintColor](DThemeDarkEnUsNoteError.md#getsecondaryimagetintcolor)
- [getShadow](DThemeDarkEnUsNoteError.md#getshadow)
- [getTertiaryImageAlignHorizontal](DThemeDarkEnUsNoteError.md#gettertiaryimagealignhorizontal)
- [getTertiaryImageAlignVertical](DThemeDarkEnUsNoteError.md#gettertiaryimagealignvertical)
- [getTertiaryImageAlignWith](DThemeDarkEnUsNoteError.md#gettertiaryimagealignwith)
- [getTertiaryImageMarginHorizontal](DThemeDarkEnUsNoteError.md#gettertiaryimagemarginhorizontal)
- [getTertiaryImageMarginVertial](DThemeDarkEnUsNoteError.md#gettertiaryimagemarginvertial)
- [getTertiaryImageRotation](DThemeDarkEnUsNoteError.md#gettertiaryimagerotation)
- [getTertiaryImageTintAlpha](DThemeDarkEnUsNoteError.md#gettertiaryimagetintalpha)
- [getTertiaryImageTintColor](DThemeDarkEnUsNoteError.md#gettertiaryimagetintcolor)
- [getTextAlignHorizontal](DThemeDarkEnUsNoteError.md#gettextalignhorizontal)
- [getTextAlignVertical](DThemeDarkEnUsNoteError.md#gettextalignvertical)
- [getTextFormatter](DThemeDarkEnUsNoteError.md#gettextformatter)
- [getTextStyleClipping](DThemeDarkEnUsNoteError.md#gettextstyleclipping)
- [getTextStyleFitting](DThemeDarkEnUsNoteError.md#gettextstylefitting)
- [getTextStyleWordWrap](DThemeDarkEnUsNoteError.md#gettextstylewordwrap)
- [getTextValue](DThemeDarkEnUsNoteError.md#gettextvalue)
- [getTitle](DThemeDarkEnUsNoteError.md#gettitle)
- [getWeight](DThemeDarkEnUsNoteError.md#getweight)
- [getWidth](DThemeDarkEnUsNoteError.md#getwidth)
- [getX](DThemeDarkEnUsNoteError.md#getx)
- [getY](DThemeDarkEnUsNoteError.md#gety)
- [isOverflowMaskEnabled](DThemeDarkEnUsNoteError.md#isoverflowmaskenabled)
- [newShadow](DThemeDarkEnUsNoteError.md#newshadow)
- [newShadowWeak](DThemeDarkEnUsNoteError.md#newshadowweak)
- [newState](DThemeDarkEnUsNoteError.md#newstate)
- [newTextValue](DThemeDarkEnUsNoteError.md#newtextvalue)

## Constructors

### constructor

• **new DThemeDarkEnUsNoteError**(): [`DThemeDarkEnUsNoteError`](DThemeDarkEnUsNoteError.md)
...
[DThemeDarkNoteError](DThemeDarkNoteError.md).[getBorderTexture](DThemeDarkNoteError.md#getbordertexture)
...
[DThemeDarkNoteError](DThemeDarkNoteError.md).[getInteractive](DThemeDarkNoteError.md#getinteractive)
...
[DThemeDarkNoteError](DThemeDarkNoteError.md).[getTertiaryImageTintColor](DThemeDarkNoteError.md#gettertiaryimagetintcolor)
...
[DThemeDarkNoteError](DThemeDarkNoteError.md).[getTextValue](DThemeDarkNoteError.md#gettextvalue)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-en-us-note-error.ts:10](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-en-us-note-error.ts#L10)
