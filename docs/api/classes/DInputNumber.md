[Winter Cardinal UI - v0.414.0](../index.md) / DInputNumber
...
- [\_boundsID](DInputNumber.md#_boundsid)
- [\_boundsRect](DInputNumber.md#_boundsrect)
...
- [\_enabledFilters](DInputNumber.md#_enabledfilters)
- [\_image](DInputNumber.md#_image)
- [\_lastDownPoint](DInputNumber.md#_lastdownpoint)
- [\_lastSortedIndex](DInputNumber.md#_lastsortedindex)
- [\_localBounds](DInputNumber.md#_localbounds)
- [\_localBoundsRect](DInputNumber.md#_localboundsrect)
...
- [containerUpdateTransform](DInputNumber.md#containerupdatetransform)
...
- [disableTempParent](DInputNumber.md#disabletempparent)
- [displayObjectUpdateTransform](DInputNumber.md#displayobjectupdatetransform)
- [emit](DInputNumber.md#emit)
- [enableTempParent](DInputNumber.md#enabletempparent)
...
- [getImage](DInputNumber.md#getimage)
- [getLayouter](DInputNumber.md#getlayouter)
...
- [getText](DInputNumber.md#gettext)
...
- [newOverflowMask](DInputNumber.md#newoverflowmask)
- [newPadding](DInputNumber.md#newpadding)
- [newText](DInputNumber.md#newtext)
...
- [onReflowTextAndImage](DInputNumber.md#onreflowtextandimage)
...
• **new DInputNumber**\<`THEME`, `OPTIONS`\>(`options?`): [`DInputNumber`](DInputNumber.md)\<`THEME`, `OPTIONS`\>
...
[DInputInput](DInputInput.md).[newOverflowMask](DInputInput.md#newoverflowmask)
...
[DInputInput](DInputInput.md).[onReflowTextAndImage](DInputInput.md#onreflowtextandimage)
