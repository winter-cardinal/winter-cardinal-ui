[Winter Cardinal UI - v0.457.0](../index.md) / DDialogInputBoolean
...
- [\_alwaysOnTop](DDialogInputBoolean.md#_alwaysontop)
...
- [\_boundsID](DDialogInputBoolean.md#_boundsid)
- [\_boundsRect](DDialogInputBoolean.md#_boundsrect)
...
- [\_enabledFilters](DDialogInputBoolean.md#_enabledfilters)
...
- [\_localBounds](DDialogInputBoolean.md#_localbounds)
- [\_localBoundsRect](DDialogInputBoolean.md#_localboundsrect)
- [\_mask](DDialogInputBoolean.md#_mask)
- [\_mode](DDialogInputBoolean.md#_mode)
- [\_onParentChildAddedBound](DDialogInputBoolean.md#_onparentchildaddedbound)
...
- [alwaysOnTop](DDialogInputBoolean.md#alwaysontop)
...
- [bringToFront](DDialogInputBoolean.md#bringtofront)
...
- [containerUpdateTransform](DDialogInputBoolean.md#containerupdatetransform)
...
- [disableTempParent](DDialogInputBoolean.md#disabletempparent)
...
- [enableTempParent](DDialogInputBoolean.md#enabletempparent)
...
- [newPadding](DDialogInputBoolean.md#newpadding)
...
• **new DDialogInputBoolean**\<`THEME`, `OPTIONS`\>(`options?`): [`DDialogInputBoolean`](DDialogInputBoolean.md)\<`THEME`, `OPTIONS`\>
...
▸ **getResolvedValue**(): `boolean` \| `PromiseLike`\<`boolean`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-input-boolean.ts:40](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-input-boolean.ts#L40)
...
[src/main/typescript/wcardinal/ui/d-dialog-input.ts:42](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-input.ts#L42)
...
▸ **newInput**(`options?`): [`DInputBoolean`](DInputBoolean.md)\<[`DThemeInputBoolean`](../interfaces/DThemeInputBoolean.md), [`DInputBooleanOptions`](../interfaces/DInputBooleanOptions.md)\<[`DThemeInputBoolean`](../interfaces/DThemeInputBoolean.md)\>\>
...
[src/main/typescript/wcardinal/ui/d-dialog-input-boolean.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-input-boolean.ts#L22)
...
[src/main/typescript/wcardinal/ui/d-dialog-input.ts:61](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-input.ts#L61)
...
[src/main/typescript/wcardinal/ui/d-dialog-input.ts:48](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-input.ts#L48)

___

### toInputOptions

▸ **toInputOptions**(`options?`): [`DDialogInputBooleanInputOptions`](../interfaces/DDialogInputBooleanInputOptions.md)
...
[src/main/typescript/wcardinal/ui/d-dialog-input-boolean.ts:26](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-input-boolean.ts#L26)
