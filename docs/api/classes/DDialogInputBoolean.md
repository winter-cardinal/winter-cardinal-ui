[Winter Cardinal UI - v0.205.1](../index.md) / DDialogInputBoolean
...
- [`DDialogInput`](DDialogInput.md)<`boolean`, [`DInputBoolean`](DInputBoolean.md), [`DDialogInputBooleanInputOptions`](../interfaces/DDialogInputBooleanInputOptions.md), `THEME`, `OPTIONS`\>
...
- [\_content](DDialogInputBoolean.md#_content)
...
- [\_footer](DDialogInputBoolean.md#_footer)
- [\_gesture](DDialogInputBoolean.md#_gesture)
- [\_header](DDialogInputBoolean.md#_header)
- [\_input](DDialogInputBoolean.md#_input)
- [\_inputLayout](DDialogInputBoolean.md#_inputlayout)
...
- [\_layout](DDialogInputBoolean.md#_layout)
...
- [content](DDialogInputBoolean.md#content)
- [corner](DDialogInputBoolean.md#corner)
- [footer](DDialogInputBoolean.md#footer)
- [gesture](DDialogInputBoolean.md#gesture)
- [header](DDialogInputBoolean.md#header)
- [height](DDialogInputBoolean.md#height)
- [input](DDialogInputBoolean.md#input)
- [inputLayout](DDialogInputBoolean.md#inputlayout)
- [layer](DDialogInputBoolean.md#layer)
- [layout](DDialogInputBoolean.md#layout)
- [mode](DDialogInputBoolean.md#mode)
- [options](DDialogInputBoolean.md#options)
...
- [findFirstFocusable](DDialogInputBoolean.md#findfirstfocusable)
...
- [newContent](DDialogInputBoolean.md#newcontent)
- [newContentChildren](DDialogInputBoolean.md#newcontentchildren)
- [newFooter](DDialogInputBoolean.md#newfooter)
- [newHeader](DDialogInputBoolean.md#newheader)
- [newInput](DDialogInputBoolean.md#newinput)
- [newInputLayout](DDialogInputBoolean.md#newinputlayout)
- [newLayout](DDialogInputBoolean.md#newlayout)
- [newLayoutChildren](DDialogInputBoolean.md#newlayoutchildren)
- [newLayoutOptions](DDialogInputBoolean.md#newlayoutoptions)
...
- [toContentOptions](DDialogInputBoolean.md#tocontentoptions)
- [toCursor](DDialogInputBoolean.md#tocursor)
- [toDirty](DDialogInputBoolean.md#todirty)
- [toFooterOptions](DDialogInputBoolean.md#tofooteroptions)
...
- [toHeaderOptions](DDialogInputBoolean.md#toheaderoptions)
- [toHierarchyDirty](DDialogInputBoolean.md#tohierarchydirty)
- [toInputMargin](DDialogInputBoolean.md#toinputmargin)
...
[src/main/typescript/wcardinal/ui/d-dialog-input.ts:39](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input.ts#L39)
...
[src/main/typescript/wcardinal/ui/d-dialog-input.ts:40](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input.ts#L40)
...
[src/main/typescript/wcardinal/ui/d-dialog-input.ts:75](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input.ts#L75)
...
[src/main/typescript/wcardinal/ui/d-dialog-input.ts:52](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input.ts#L52)
...
[src/main/typescript/wcardinal/ui/d-dialog-input.ts:87](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input.ts#L87)
...
[src/main/typescript/wcardinal/ui/d-dialog-input.ts:91](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input.ts#L91)
...
[src/main/typescript/wcardinal/ui/d-dialog-input.ts:95](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input.ts#L95)
...
[src/main/typescript/wcardinal/ui/d-dialog-input-boolean.ts:40](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input-boolean.ts#L40)
...
[src/main/typescript/wcardinal/ui/d-dialog-input.ts:42](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input.ts#L42)
...
| Name | Type |
| :------ | :------ |
| `options?` | [`DDialogInputBooleanInputOptions`](../interfaces/DDialogInputBooleanInputOptions.md) |
...
[src/main/typescript/wcardinal/ui/d-dialog-input-boolean.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input-boolean.ts#L22)
...
[src/main/typescript/wcardinal/ui/d-dialog-input.ts:61](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input.ts#L61)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered.ts:233](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-layered.ts#L233)
...
[src/main/typescript/wcardinal/ui/d-dialog-input.ts:48](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input.ts#L48)

___

### toInputOptions

▸ `Protected` **toInputOptions**(`options?`): [`DDialogInputBooleanInputOptions`](../interfaces/DDialogInputBooleanInputOptions.md)
...
[src/main/typescript/wcardinal/ui/d-dialog-input-boolean.ts:26](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input-boolean.ts#L26)
