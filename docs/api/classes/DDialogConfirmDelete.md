[Winter Cardinal UI - v0.155.0](../index.md) / DDialogConfirmDelete
...
- [\_isChildrenDirty](DDialogConfirmDelete.md#_ischildrendirty)
...
- [isChildrenDirty](DDialogConfirmDelete.md#ischildrendirty)
...
- [onChildrenDirty](DDialogConfirmDelete.md#onchildrendirty)
...
- [refit](DDialogConfirmDelete.md#refit)
...
- [toChildrenDirty](DDialogConfirmDelete.md#tochildrendirty)
...
- [toParentChildrenDirty](DDialogConfirmDelete.md#toparentchildrendirty)
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm-delete.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-dialog-confirm-delete.ts#L17)
