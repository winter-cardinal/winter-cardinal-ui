[Winter Cardinal UI - v0.160.0](../index.md) / DDialogConfirmDelete
...
- [\_buttonCancel](DDialogConfirmDelete.md#_buttoncancel)
- [\_buttonLayout](DDialogConfirmDelete.md#_buttonlayout)
- [\_buttonOk](DDialogConfirmDelete.md#_buttonok)
...
- [\_overlay](DDialogConfirmDelete.md#_overlay)
- [\_owner](DDialogConfirmDelete.md#_owner)
...
- [getChildByName](DDialogConfirmDelete.md#getchildbyname)
...
- [onInit](DDialogConfirmDelete.md#oninit)
...
- [onPrerender](DDialogConfirmDelete.md#onprerender)
...
• **new DDialogConfirmDelete**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemeDialogConfirm`](../interfaces/DThemeDialogConfirm.md) = [`DThemeDialogConfirm`](../interfaces/DThemeDialogConfirm.md) |
| `OPTIONS` | extends [`DDialogConfirmDeleteOptions`](../interfaces/DDialogConfirmDeleteOptions.md)<`THEME`, `OPTIONS`\> = [`DDialogConfirmDeleteOptions`](../interfaces/DDialogConfirmDeleteOptions.md)<`THEME`\> |
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm-delete.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-confirm-delete.ts#L17)
...
▸ **hide**(): [`DDialogConfirmDelete`](DDialogConfirmDelete.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm.ts:71](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-confirm.ts#L71)

___

### off

▸ **off**(`event`, `fn?`, `context?`): [`DDialogConfirmDelete`](DDialogConfirmDelete.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DDialogConfirmDelete`](DDialogConfirmDelete.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DDialogConfirmDelete`](DDialogConfirmDelete.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DDialogConfirmDelete`](DDialogConfirmDelete.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DDialogConfirmDelete`](DDialogConfirmDelete.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DDialogConfirmDelete`](DDialogConfirmDelete.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DDialogConfirmDelete`](DDialogConfirmDelete.md)<`THEME`, `OPTIONS`\>
