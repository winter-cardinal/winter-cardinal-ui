[Winter Cardinal UI - v0.457.0](../index.md) / DDialogConfirmDelete
...
- [\_alwaysOnTop](DDialogConfirmDelete.md#_alwaysontop)
...
- [\_onParentChildAddedBound](DDialogConfirmDelete.md#_onparentchildaddedbound)
...
- [alwaysOnTop](DDialogConfirmDelete.md#alwaysontop)
...
- [bringToFront](DDialogConfirmDelete.md#bringtofront)
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm-delete.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-confirm-delete.ts#L17)
