[Winter Cardinal UI - v0.167.0](../index.md) / DButtonBase
...
- [createText](DButtonBase.md#createtext)
...
- [initOnClick](DButtonBase.md#initonclick)
...
• **new DButtonBase**<`VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeButtonBase`](../interfaces/DThemeButtonBase.md)<`VALUE`, `THEME`\> = [`DThemeButtonBase`](../interfaces/DThemeButtonBase.md)<`VALUE`\> |
| `OPTIONS` | extends [`DButtonBaseOptions`](../interfaces/DButtonBaseOptions.md)<`VALUE`, `THEME`, `any`, `OPTIONS`\> = [`DButtonBaseOptions`](../interfaces/DButtonBaseOptions.md)<`VALUE`, `THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-button-base.ts:159](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-base.ts#L159)
...
▸ `Protected` **setFocused**(`isFocused`): [`DButtonBase`](DButtonBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
