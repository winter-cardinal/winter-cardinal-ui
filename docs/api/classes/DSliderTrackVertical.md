[Winter Cardinal UI - v0.167.0](../index.md) / DSliderTrackVertical
...
- [\_textValueComputed](DSliderTrackVertical.md#_textvaluecomputed)
...
- [unsafe](DSliderTrackVertical.md#unsafe)
...
- [initOnClick](DSliderTrackVertical.md#initonclick)
...
- [newImage](DSliderTrackVertical.md#newimage)
...
- [toGlobal](DSliderTrackVertical.md#toglobal)
...
[src/main/typescript/wcardinal/ui/d-slider-track-vertical.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-slider-track-vertical.ts#L23)
...
▸ **once**(`event`, `fn`, `context?`): [`DSliderTrackVertical`](DSliderTrackVertical.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DSliderTrackVertical`](DSliderTrackVertical.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DSliderTrackVertical`](DSliderTrackVertical.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DSliderTrackVertical`](DSliderTrackVertical.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DSliderTrackVertical`](DSliderTrackVertical.md)<`VALUE`, `THEME`, `OPTIONS`\>
