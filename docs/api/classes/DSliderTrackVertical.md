[Winter Cardinal UI - v0.407.0](../index.md) / DSliderTrackVertical
...
- [\_boundsID](DSliderTrackVertical.md#_boundsid)
- [\_boundsRect](DSliderTrackVertical.md#_boundsrect)
...
- [\_enabledFilters](DSliderTrackVertical.md#_enabledfilters)
- [\_image](DSliderTrackVertical.md#_image)
...
- [\_localBounds](DSliderTrackVertical.md#_localbounds)
- [\_localBoundsRect](DSliderTrackVertical.md#_localboundsrect)
...
- [containerUpdateTransform](DSliderTrackVertical.md#containerupdatetransform)
...
- [disableTempParent](DSliderTrackVertical.md#disabletempparent)
- [displayObjectUpdateTransform](DSliderTrackVertical.md#displayobjectupdatetransform)
- [emit](DSliderTrackVertical.md#emit)
- [enableTempParent](DSliderTrackVertical.md#enabletempparent)
...
- [getImage](DSliderTrackVertical.md#getimage)
- [getLayouter](DSliderTrackVertical.md#getlayouter)
...
- [getText](DSliderTrackVertical.md#gettext)
...
- [newOverflowMask](DSliderTrackVertical.md#newoverflowmask)
- [newPadding](DSliderTrackVertical.md#newpadding)
- [newText](DSliderTrackVertical.md#newtext)
...
- [onReflowTextAndImage](DSliderTrackVertical.md#onreflowtextandimage)
...
• **new DSliderTrackVertical**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DSliderTrackVertical`](DSliderTrackVertical.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-slider-track-vertical.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-slider-track-vertical.ts#L23)
...
▸ **setFocused**(`isFocused`): [`DSliderTrackVertical`](DSliderTrackVertical.md)\<`VALUE`, `THEME`, `OPTIONS`\>
