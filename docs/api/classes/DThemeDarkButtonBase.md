[Winter Cardinal UI - v0.457.0](../index.md) / DThemeDarkButtonBase
...
- [`DThemeDarkImageBase`](DThemeDarkImageBase.md)\<`VALUE`\>
  ...
  ↳↳ [`DThemeDarkDropdownBase`](DThemeDarkDropdownBase.md)

  ↳↳ [`DThemeDarkTableBodyCellInputTreeMarker`](DThemeDarkTableBodyCellInputTreeMarker.md)
...
- [getImageRotation](DThemeDarkButtonBase.md#getimagerotation)
...
- [getSecondaryImageRotation](DThemeDarkButtonBase.md#getsecondaryimagerotation)
...
- [getTertiaryImageRotation](DThemeDarkButtonBase.md#gettertiaryimagerotation)
...
- [getTextStyleFitting](DThemeDarkButtonBase.md#gettextstylefitting)
...
• **new DThemeDarkButtonBase**\<`VALUE`\>(`backgroundColor?`, `hover?`, `pressed?`): [`DThemeDarkButtonBase`](DThemeDarkButtonBase.md)\<`VALUE`\>
...
[DThemeButtonBase](../interfaces/DThemeButtonBase.md).[getImageRotation](../interfaces/DThemeButtonBase.md#getimagerotation)
...
[DThemeButtonBase](../interfaces/DThemeButtonBase.md).[getSecondaryImageRotation](../interfaces/DThemeButtonBase.md#getsecondaryimagerotation)
...
[DThemeButtonBase](../interfaces/DThemeButtonBase.md).[getTertiaryImageRotation](../interfaces/DThemeButtonBase.md#gettertiaryimagerotation)
...
[DThemeButtonBase](../interfaces/DThemeButtonBase.md).[getTextStyleFitting](../interfaces/DThemeButtonBase.md#gettextstylefitting)
