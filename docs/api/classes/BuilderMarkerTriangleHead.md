[Winter Cardinal UI - v0.374.0](../index.md) / BuilderMarkerTriangleHead
...
• **new BuilderMarkerTriangleHead**(`vertexOffset`, `indexOffset`): [`BuilderMarkerTriangleHead`](BuilderMarkerTriangleHead.md)
