[Winter Cardinal UI - v0.374.0](../index.md) / DDialogLayeredHeader
...
- [newPadding](DDialogLayeredHeader.md#newpadding)
- [newSeparator](DDialogLayeredHeader.md#newseparator)
- [newText](DDialogLayeredHeader.md#newtext)
...
• **new DDialogLayeredHeader**\<`THEME`, `OPTIONS`\>(`parent`, `options?`): [`DDialogLayeredHeader`](DDialogLayeredHeader.md)\<`THEME`, `OPTIONS`\>
...
▸ **newButtonClose**(): ``null`` \| [`DDialogLayeredHeaderButtonClose`](DDialogLayeredHeaderButtonClose.md)\<[`DThemeDialogLayeredHeaderButtonClose`](../interfaces/DThemeDialogLayeredHeaderButtonClose.md), [`DDialogLayeredHeaderButtonCloseOptions`](../interfaces/DDialogLayeredHeaderButtonCloseOptions.md)\<[`DThemeDialogLayeredHeaderButtonClose`](../interfaces/DThemeDialogLayeredHeaderButtonClose.md)\>\>
...
▸ **setFocused**(`isFocused`): [`DDialogLayeredHeader`](DDialogLayeredHeader.md)\<`THEME`, `OPTIONS`\>
