[Winter Cardinal UI - v0.310.1](../index.md) / DDialogLayeredHeader

# Class: DDialogLayeredHeader<THEME, OPTIONS\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeDialogLayeredHeader`](../interfaces/DThemeDialogLayeredHeader.md) = [`DThemeDialogLayeredHeader`](../interfaces/DThemeDialogLayeredHeader.md) |
| `OPTIONS` | extends [`DDialogLayeredHeaderOptions`](../interfaces/DDialogLayeredHeaderOptions.md)<`THEME`\> = [`DDialogLayeredHeaderOptions`](../interfaces/DDialogLayeredHeaderOptions.md)<`THEME`\> |

## Hierarchy

- [`DImageBase`](DImageBase.md)<`string`, `THEME`, `OPTIONS`\>

  ↳ **`DDialogLayeredHeader`**

## Table of contents

### Constructors

- [constructor](DDialogLayeredHeader.md#constructor)

### Properties

- [\_accessibleActive](DDialogLayeredHeader.md#_accessibleactive)
- [\_accessibleDiv](DDialogLayeredHeader.md#_accessiblediv)
- [\_auto](DDialogLayeredHeader.md#_auto)
- [\_background](DDialogLayeredHeader.md#_background)
- [\_border](DDialogLayeredHeader.md#_border)
- [\_bounds](DDialogLayeredHeader.md#_bounds)
- [\_buttonClose](DDialogLayeredHeader.md#_buttonclose)
- [\_clearType](DDialogLayeredHeader.md#_cleartype)
- [\_corner](DDialogLayeredHeader.md#_corner)
- [\_cursor](DDialogLayeredHeader.md#_cursor)
- [\_destroyed](DDialogLayeredHeader.md#_destroyed)
- [\_images](DDialogLayeredHeader.md#_images)
- [\_isOverflowMaskEnabled](DDialogLayeredHeader.md#_isoverflowmaskenabled)
- [\_isTextVisible](DDialogLayeredHeader.md#_istextvisible)
- [\_lastDownPoint](DDialogLayeredHeader.md#_lastdownpoint)
- [\_lastSortedIndex](DDialogLayeredHeader.md#_lastsortedindex)
- [\_mask](DDialogLayeredHeader.md#_mask)
- [\_options](DDialogLayeredHeader.md#_options)
- [\_outline](DDialogLayeredHeader.md#_outline)
- [\_overflowMask](DDialogLayeredHeader.md#_overflowmask)
- [\_padding](DDialogLayeredHeader.md#_padding)
- [\_parent](DDialogLayeredHeader.md#_parent)
- [\_reflowable](DDialogLayeredHeader.md#_reflowable)
- [\_separator](DDialogLayeredHeader.md#_separator)
- [\_shortcuts](DDialogLayeredHeader.md#_shortcuts)
- [\_snippet](DDialogLayeredHeader.md#_snippet)
- [\_tempDisplayObjectParent](DDialogLayeredHeader.md#_tempdisplayobjectparent)
- [\_text](DDialogLayeredHeader.md#_text)
- [\_textAlign](DDialogLayeredHeader.md#_textalign)
- [\_textAlpha](DDialogLayeredHeader.md#_textalpha)
- [\_textColor](DDialogLayeredHeader.md#_textcolor)
- [\_textFormatter](DDialogLayeredHeader.md#_textformatter)
- [\_textStyle](DDialogLayeredHeader.md#_textstyle)
- [\_textValue](DDialogLayeredHeader.md#_textvalue)
- [\_textValueComputed](DDialogLayeredHeader.md#_textvaluecomputed)
- [\_title](DDialogLayeredHeader.md#_title)
- [\_zIndex](DDialogLayeredHeader.md#_zindex)
- [accessible](DDialogLayeredHeader.md#accessible)
- [accessibleChildren](DDialogLayeredHeader.md#accessiblechildren)
- [accessibleHint](DDialogLayeredHeader.md#accessiblehint)
- [accessiblePointerEvents](DDialogLayeredHeader.md#accessiblepointerevents)
- [accessibleTitle](DDialogLayeredHeader.md#accessibletitle)
- [accessibleType](DDialogLayeredHeader.md#accessibletype)
- [alpha](DDialogLayeredHeader.md#alpha)
- [angle](DDialogLayeredHeader.md#angle)
- [buttonMode](DDialogLayeredHeader.md#buttonmode)
- [cacheAsBitmap](DDialogLayeredHeader.md#cacheasbitmap)
- [children](DDialogLayeredHeader.md#children)
- [cursor](DDialogLayeredHeader.md#cursor)
- [filterArea](DDialogLayeredHeader.md#filterarea)
- [filters](DDialogLayeredHeader.md#filters)
- [hitArea](DDialogLayeredHeader.md#hitarea)
- [interactive](DDialogLayeredHeader.md#interactive)
- [interactiveChildren](DDialogLayeredHeader.md#interactivechildren)
- [isMask](DDialogLayeredHeader.md#ismask)
- [isSprite](DDialogLayeredHeader.md#issprite)
- [localTransform](DDialogLayeredHeader.md#localtransform)
- [mask](DDialogLayeredHeader.md#mask)
- [name](DDialogLayeredHeader.md#name)
- [parent](DDialogLayeredHeader.md#parent)
- [pivot](DDialogLayeredHeader.md#pivot)
- [renderable](DDialogLayeredHeader.md#renderable)
- [rotation](DDialogLayeredHeader.md#rotation)
- [sortDirty](DDialogLayeredHeader.md#sortdirty)
- [sortableChildren](DDialogLayeredHeader.md#sortablechildren)
- [transform](DDialogLayeredHeader.md#transform)
- [visible](DDialogLayeredHeader.md#visible)
- [worldAlpha](DDialogLayeredHeader.md#worldalpha)
- [worldTransform](DDialogLayeredHeader.md#worldtransform)
- [worldVisible](DDialogLayeredHeader.md#worldvisible)
- [zIndex](DDialogLayeredHeader.md#zindex)
- [LAYOUTER](DDialogLayeredHeader.md#layouter)
- [WORK\_CONTAINS\_POINT](DDialogLayeredHeader.md#work_contains_point)

### Accessors

- [background](DDialogLayeredHeader.md#background)
- [border](DDialogLayeredHeader.md#border)
- [buttonClose](DDialogLayeredHeader.md#buttonclose)
- [corner](DDialogLayeredHeader.md#corner)
- [height](DDialogLayeredHeader.md#height)
- [image](DDialogLayeredHeader.md#image)
- [options](DDialogLayeredHeader.md#options)
- [outline](DDialogLayeredHeader.md#outline)
- [padding](DDialogLayeredHeader.md#padding)
- [position](DDialogLayeredHeader.md#position)
- [reflowable](DDialogLayeredHeader.md#reflowable)
- [scale](DDialogLayeredHeader.md#scale)
- [separator](DDialogLayeredHeader.md#separator)
- [shadow](DDialogLayeredHeader.md#shadow)
- [skew](DDialogLayeredHeader.md#skew)
- [snippet](DDialogLayeredHeader.md#snippet)
- [state](DDialogLayeredHeader.md#state)
- [text](DDialogLayeredHeader.md#text)
- [theme](DDialogLayeredHeader.md#theme)
- [title](DDialogLayeredHeader.md#title)
- [type](DDialogLayeredHeader.md#type)
- [unsafe](DDialogLayeredHeader.md#unsafe)
- [weight](DDialogLayeredHeader.md#weight)
- [width](DDialogLayeredHeader.md#width)
- [x](DDialogLayeredHeader.md#x)
- [y](DDialogLayeredHeader.md#y)

### Methods

- [\_calculateBounds](DDialogLayeredHeader.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DDialogLayeredHeader.md#_recursivepostupdatetransform)
- [\_render](DDialogLayeredHeader.md#_render)
- [addChild](DDialogLayeredHeader.md#addchild)
- [addChildAt](DDialogLayeredHeader.md#addchildat)
- [addListener](DDialogLayeredHeader.md#addlistener)
- [applyTitle](DDialogLayeredHeader.md#applytitle)
- [blur](DDialogLayeredHeader.md#blur)
- [calculateBounds](DDialogLayeredHeader.md#calculatebounds)
- [computeTextValue](DDialogLayeredHeader.md#computetextvalue)
- [containsGlobalPoint](DDialogLayeredHeader.md#containsglobalpoint)
- [containsLocalPoint](DDialogLayeredHeader.md#containslocalpoint)
- [containsPoint](DDialogLayeredHeader.md#containspoint)
- [createOrUpdateText](DDialogLayeredHeader.md#createorupdatetext)
- [createText](DDialogLayeredHeader.md#createtext)
- [destroy](DDialogLayeredHeader.md#destroy)
- [displayObjectUpdateTransform](DDialogLayeredHeader.md#displayobjectupdatetransform)
- [emit](DDialogLayeredHeader.md#emit)
- [eventNames](DDialogLayeredHeader.md#eventnames)
- [focus](DDialogLayeredHeader.md#focus)
- [focusOnClosest](DDialogLayeredHeader.md#focusonclosest)
- [getBounds](DDialogLayeredHeader.md#getbounds)
- [getChildAt](DDialogLayeredHeader.md#getchildat)
- [getChildByName](DDialogLayeredHeader.md#getchildbyname)
- [getChildIndex](DDialogLayeredHeader.md#getchildindex)
- [getClearType](DDialogLayeredHeader.md#getcleartype)
- [getClippingRect](DDialogLayeredHeader.md#getclippingrect)
- [getGlobalPosition](DDialogLayeredHeader.md#getglobalposition)
- [getHeight](DDialogLayeredHeader.md#getheight)
- [getLocalBounds](DDialogLayeredHeader.md#getlocalbounds)
- [getOverflowMask](DDialogLayeredHeader.md#getoverflowmask)
- [getParentOfSize](DDialogLayeredHeader.md#getparentofsize)
- [getTextAlpha](DDialogLayeredHeader.md#gettextalpha)
- [getTextColor](DDialogLayeredHeader.md#gettextcolor)
- [getThemeDefault](DDialogLayeredHeader.md#getthemedefault)
- [getType](DDialogLayeredHeader.md#gettype)
- [getWidth](DDialogLayeredHeader.md#getwidth)
- [getX](DDialogLayeredHeader.md#getx)
- [getY](DDialogLayeredHeader.md#gety)
- [hasDirty](DDialogLayeredHeader.md#hasdirty)
- [hasRefitableHeight](DDialogLayeredHeader.md#hasrefitableheight)
- [hasRefitableWidth](DDialogLayeredHeader.md#hasrefitablewidth)
- [hide](DDialogLayeredHeader.md#hide)
- [hideText](DDialogLayeredHeader.md#hidetext)
- [init](DDialogLayeredHeader.md#init)
- [initReflowable](DDialogLayeredHeader.md#initreflowable)
- [isDirty](DDialogLayeredHeader.md#isdirty)
- [isEventTarget](DDialogLayeredHeader.md#iseventtarget)
- [isHidden](DDialogLayeredHeader.md#ishidden)
- [isHierarchyDirty](DDialogLayeredHeader.md#ishierarchydirty)
- [isRefitable](DDialogLayeredHeader.md#isrefitable)
- [isShown](DDialogLayeredHeader.md#isshown)
- [listenerCount](DDialogLayeredHeader.md#listenercount)
- [listeners](DDialogLayeredHeader.md#listeners)
- [newButtonClose](DDialogLayeredHeader.md#newbuttonclose)
- [newImage](DDialogLayeredHeader.md#newimage)
- [newImages](DDialogLayeredHeader.md#newimages)
- [newSeparator](DDialogLayeredHeader.md#newseparator)
- [off](DDialogLayeredHeader.md#off)
- [on](DDialogLayeredHeader.md#on)
- [onBlur](DDialogLayeredHeader.md#onblur)
- [onChildBlur](DDialogLayeredHeader.md#onchildblur)
- [onChildFocus](DDialogLayeredHeader.md#onchildfocus)
- [onChildrenChange](DDialogLayeredHeader.md#onchildrenchange)
- [onDblClick](DDialogLayeredHeader.md#ondblclick)
- [onDown](DDialogLayeredHeader.md#ondown)
- [onDownThis](DDialogLayeredHeader.md#ondownthis)
- [onFocus](DDialogLayeredHeader.md#onfocus)
- [onHierarchyDirty](DDialogLayeredHeader.md#onhierarchydirty)
- [onKeyDown](DDialogLayeredHeader.md#onkeydown)
- [onKeyUp](DDialogLayeredHeader.md#onkeyup)
- [onMove](DDialogLayeredHeader.md#onmove)
- [onOut](DDialogLayeredHeader.md#onout)
- [onOver](DDialogLayeredHeader.md#onover)
- [onParentMove](DDialogLayeredHeader.md#onparentmove)
- [onParentResize](DDialogLayeredHeader.md#onparentresize)
- [onRefit](DDialogLayeredHeader.md#onrefit)
- [onReflow](DDialogLayeredHeader.md#onreflow)
- [onResize](DDialogLayeredHeader.md#onresize)
- [onScale](DDialogLayeredHeader.md#onscale)
- [onShortcut](DDialogLayeredHeader.md#onshortcut)
- [onSkew](DDialogLayeredHeader.md#onskew)
- [onStateChange](DDialogLayeredHeader.md#onstatechange)
- [onTextChange](DDialogLayeredHeader.md#ontextchange)
- [onUp](DDialogLayeredHeader.md#onup)
- [onUpThis](DDialogLayeredHeader.md#onupthis)
- [onWheel](DDialogLayeredHeader.md#onwheel)
- [once](DDialogLayeredHeader.md#once)
- [reflow](DDialogLayeredHeader.md#reflow)
- [removeAllListeners](DDialogLayeredHeader.md#removealllisteners)
- [removeChild](DDialogLayeredHeader.md#removechild)
- [removeChildAt](DDialogLayeredHeader.md#removechildat)
- [removeChildren](DDialogLayeredHeader.md#removechildren)
- [removeListener](DDialogLayeredHeader.md#removelistener)
- [render](DDialogLayeredHeader.md#render)
- [renderAdvanced](DDialogLayeredHeader.md#renderadvanced)
- [resize](DDialogLayeredHeader.md#resize)
- [setChildIndex](DDialogLayeredHeader.md#setchildindex)
- [setFocused](DDialogLayeredHeader.md#setfocused)
- [setHeight](DDialogLayeredHeader.md#setheight)
- [setParent](DDialogLayeredHeader.md#setparent)
- [setTransform](DDialogLayeredHeader.md#settransform)
- [setWidth](DDialogLayeredHeader.md#setwidth)
- [setX](DDialogLayeredHeader.md#setx)
- [setY](DDialogLayeredHeader.md#sety)
- [show](DDialogLayeredHeader.md#show)
- [showText](DDialogLayeredHeader.md#showtext)
- [sortChildren](DDialogLayeredHeader.md#sortchildren)
- [swapChildren](DDialogLayeredHeader.md#swapchildren)
- [toCursor](DDialogLayeredHeader.md#tocursor)
- [toDirty](DDialogLayeredHeader.md#todirty)
- [toGlobal](DDialogLayeredHeader.md#toglobal)
- [toHasDirty](DDialogLayeredHeader.md#tohasdirty)
- [toHierarchyDirty](DDialogLayeredHeader.md#tohierarchydirty)
- [toImageOptions](DDialogLayeredHeader.md#toimageoptions)
- [toLocal](DDialogLayeredHeader.md#tolocal)
- [toParentHasDirty](DDialogLayeredHeader.md#toparenthasdirty)
- [toParentHierarchyDirty](DDialogLayeredHeader.md#toparenthierarchydirty)
- [toParentResized](DDialogLayeredHeader.md#toparentresized)
- [updateText](DDialogLayeredHeader.md#updatetext)
- [updateTextAndImage](DDialogLayeredHeader.md#updatetextandimage)
- [updateTextColor](DDialogLayeredHeader.md#updatetextcolor)
- [updateTextPosition](DDialogLayeredHeader.md#updatetextposition)
- [updateTextValue](DDialogLayeredHeader.md#updatetextvalue)
- [updateTransform](DDialogLayeredHeader.md#updatetransform)
- [mixin](DDialogLayeredHeader.md#mixin)

## Constructors

### constructor

• **new DDialogLayeredHeader**<`THEME`, `OPTIONS`\>(`parent`, `options?`)

#### Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeDialogLayeredHeader`](../interfaces/DThemeDialogLayeredHeader.md)<`THEME`\> = [`DThemeDialogLayeredHeader`](../interfaces/DThemeDialogLayeredHeader.md) |
| `OPTIONS` | extends [`DDialogLayeredHeaderOptions`](../interfaces/DDialogLayeredHeaderOptions.md)<`THEME`, `OPTIONS`\> = [`DDialogLayeredHeaderOptions`](../interfaces/DDialogLayeredHeaderOptions.md)<`THEME`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `parent` | [`DDialogLayeredHeaderParent`](../interfaces/DDialogLayeredHeaderParent.md) |
| `options?` | `OPTIONS` |
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:35](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L35)
...
• `Protected` `Optional` **\_buttonClose**: ``null`` \| [`DDialogLayeredHeaderButtonClose`](DDialogLayeredHeaderButtonClose.md)<[`DThemeDialogLayeredHeaderButtonClose`](../interfaces/DThemeDialogLayeredHeaderButtonClose.md), [`DDialogLayeredHeaderButtonCloseOptions`](../interfaces/DDialogLayeredHeaderButtonCloseOptions.md)<[`DThemeDialogLayeredHeaderButtonClose`](../interfaces/DThemeDialogLayeredHeaderButtonClose.md)\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:32](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L32)
...
• `Protected` **\_parent**: [`DDialogLayeredHeaderParent`](../interfaces/DDialogLayeredHeaderParent.md)

#### Defined in

[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:31](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L31)
...
• `Protected` `Optional` **\_separator**: ``null`` \| [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<[`DThemeDialogLayeredHeaderSeparator`](../interfaces/DThemeDialogLayeredHeaderSeparator.md), [`DDialogLayeredHeaderSeparatorOptions`](../interfaces/DDialogLayeredHeaderSeparatorOptions.md)<[`DThemeDialogLayeredHeaderSeparator`](../interfaces/DThemeDialogLayeredHeaderSeparator.md)\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:33](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L33)
...
• `get` **buttonClose**(): ``null`` \| [`DDialogLayeredHeaderButtonClose`](DDialogLayeredHeaderButtonClose.md)<[`DThemeDialogLayeredHeaderButtonClose`](../interfaces/DThemeDialogLayeredHeaderButtonClose.md), [`DDialogLayeredHeaderButtonCloseOptions`](../interfaces/DDialogLayeredHeaderButtonCloseOptions.md)<[`DThemeDialogLayeredHeaderButtonClose`](../interfaces/DThemeDialogLayeredHeaderButtonClose.md)\>\>

#### Returns

``null`` \| [`DDialogLayeredHeaderButtonClose`](DDialogLayeredHeaderButtonClose.md)<[`DThemeDialogLayeredHeaderButtonClose`](../interfaces/DThemeDialogLayeredHeaderButtonClose.md), [`DDialogLayeredHeaderButtonCloseOptions`](../interfaces/DDialogLayeredHeaderButtonCloseOptions.md)<[`DThemeDialogLayeredHeaderButtonClose`](../interfaces/DThemeDialogLayeredHeaderButtonClose.md)\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:53](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L53)
...
• `get` **separator**(): ``null`` \| [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<[`DThemeDialogLayeredHeaderSeparator`](../interfaces/DThemeDialogLayeredHeaderSeparator.md), [`DDialogLayeredHeaderSeparatorOptions`](../interfaces/DDialogLayeredHeaderSeparatorOptions.md)<[`DThemeDialogLayeredHeaderSeparator`](../interfaces/DThemeDialogLayeredHeaderSeparator.md)\>\>

#### Returns

``null`` \| [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<[`DThemeDialogLayeredHeaderSeparator`](../interfaces/DThemeDialogLayeredHeaderSeparator.md), [`DDialogLayeredHeaderSeparatorOptions`](../interfaces/DDialogLayeredHeaderSeparatorOptions.md)<[`DThemeDialogLayeredHeaderSeparator`](../interfaces/DThemeDialogLayeredHeaderSeparator.md)\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:69](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L69)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DDialogLayeredHeader`](DDialogLayeredHeader.md)<`THEME`, `OPTIONS`\>
...
[`DDialogLayeredHeader`](DDialogLayeredHeader.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DDialogLayeredHeader`](DDialogLayeredHeader.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DDialogLayeredHeader`](DDialogLayeredHeader.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:85](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L85)
...
▸ **hide**(): [`DDialogLayeredHeader`](DDialogLayeredHeader.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **newButtonClose**(): ``null`` \| [`DDialogLayeredHeaderButtonClose`](DDialogLayeredHeaderButtonClose.md)<[`DThemeDialogLayeredHeaderButtonClose`](../interfaces/DThemeDialogLayeredHeaderButtonClose.md), [`DDialogLayeredHeaderButtonCloseOptions`](../interfaces/DDialogLayeredHeaderButtonCloseOptions.md)<[`DThemeDialogLayeredHeaderButtonClose`](../interfaces/DThemeDialogLayeredHeaderButtonClose.md)\>\>
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:62](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L62)
...
▸ `Protected` **newSeparator**(): ``null`` \| [`DDialogLayeredHeaderSeparator`](DDialogLayeredHeaderSeparator.md)<[`DThemeDialogLayeredHeaderSeparator`](../interfaces/DThemeDialogLayeredHeaderSeparator.md), [`DDialogLayeredHeaderSeparatorOptions`](../interfaces/DDialogLayeredHeaderSeparatorOptions.md)<[`DThemeDialogLayeredHeaderSeparator`](../interfaces/DThemeDialogLayeredHeaderSeparator.md)\>\>
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:78](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L78)

___

### off

▸ **off**(`event`, `fn?`, `context?`): [`DDialogLayeredHeader`](DDialogLayeredHeader.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DDialogLayeredHeader`](DDialogLayeredHeader.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DDialogLayeredHeader`](DDialogLayeredHeader.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DDialogLayeredHeader`](DDialogLayeredHeader.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DDialogLayeredHeader`](DDialogLayeredHeader.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DDialogLayeredHeader`](DDialogLayeredHeader.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DDialogLayeredHeader`](DDialogLayeredHeader.md)<`THEME`, `OPTIONS`\>
