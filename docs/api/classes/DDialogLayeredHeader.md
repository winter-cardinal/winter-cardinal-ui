[Winter Cardinal UI - v0.407.0](../index.md) / DDialogLayeredHeader
...
- [\_boundsID](DDialogLayeredHeader.md#_boundsid)
- [\_boundsRect](DDialogLayeredHeader.md#_boundsrect)
...
- [\_enabledFilters](DDialogLayeredHeader.md#_enabledfilters)
- [\_image](DDialogLayeredHeader.md#_image)
- [\_lastDownPoint](DDialogLayeredHeader.md#_lastdownpoint)
- [\_lastSortedIndex](DDialogLayeredHeader.md#_lastsortedindex)
- [\_localBounds](DDialogLayeredHeader.md#_localbounds)
- [\_localBoundsRect](DDialogLayeredHeader.md#_localboundsrect)
...
- [containerUpdateTransform](DDialogLayeredHeader.md#containerupdatetransform)
...
- [disableTempParent](DDialogLayeredHeader.md#disabletempparent)
- [displayObjectUpdateTransform](DDialogLayeredHeader.md#displayobjectupdatetransform)
- [emit](DDialogLayeredHeader.md#emit)
- [enableTempParent](DDialogLayeredHeader.md#enabletempparent)
...
- [getImage](DDialogLayeredHeader.md#getimage)
- [getLayouter](DDialogLayeredHeader.md#getlayouter)
...
- [getText](DDialogLayeredHeader.md#gettext)
...
- [newOverflowMask](DDialogLayeredHeader.md#newoverflowmask)
...
- [onReflowTextAndImage](DDialogLayeredHeader.md#onreflowtextandimage)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:35](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L35)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:32](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L32)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:31](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L31)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:33](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L33)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:53](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L53)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:69](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L69)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:85](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L85)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:62](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L62)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts:78](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-layered-header.ts#L78)
