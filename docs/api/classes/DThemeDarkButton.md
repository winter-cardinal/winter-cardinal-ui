[Winter Cardinal UI - v0.457.0](../index.md) / DThemeDarkButton
...
- [`DThemeDarkButtonBase`](DThemeDarkButtonBase.md)\<`VALUE`\>
  ...
  ↳↳ [`DThemeDarkButtonSelect`](DThemeDarkButtonSelect.md)
...
- [getImageRotation](DThemeDarkButton.md#getimagerotation)
...
- [getSecondaryImageRotation](DThemeDarkButton.md#getsecondaryimagerotation)
...
- [getTertiaryImageRotation](DThemeDarkButton.md#gettertiaryimagerotation)
...
- [getTextStyleFitting](DThemeDarkButton.md#gettextstylefitting)
...
• **new DThemeDarkButton**\<`VALUE`\>(`backgroundColor?`, `hover?`, `pressed?`): [`DThemeDarkButton`](DThemeDarkButton.md)\<`VALUE`\>
