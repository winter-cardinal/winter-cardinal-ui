[Winter Cardinal UI - v0.407.0](../index.md) / DMenuBarItem
...
- [\_boundsID](DMenuBarItem.md#_boundsid)
- [\_boundsRect](DMenuBarItem.md#_boundsrect)
...
- [\_enabledFilters](DMenuBarItem.md#_enabledfilters)
- [\_image](DMenuBarItem.md#_image)
- [\_isGrouped](DMenuBarItem.md#_isgrouped)
...
- [\_localBounds](DMenuBarItem.md#_localbounds)
- [\_localBoundsRect](DMenuBarItem.md#_localboundsrect)
...
- [isGrouped](DMenuBarItem.md#isgrouped)
...
- [containerUpdateTransform](DMenuBarItem.md#containerupdatetransform)
...
- [disableTempParent](DMenuBarItem.md#disabletempparent)
- [displayObjectUpdateTransform](DMenuBarItem.md#displayobjectupdatetransform)
- [emit](DMenuBarItem.md#emit)
- [enableTempParent](DMenuBarItem.md#enabletempparent)
...
- [getImage](DMenuBarItem.md#getimage)
- [getLayouter](DMenuBarItem.md#getlayouter)
...
- [getText](DMenuBarItem.md#gettext)
...
- [newOverflowMask](DMenuBarItem.md#newoverflowmask)
- [newPadding](DMenuBarItem.md#newpadding)
- [newText](DMenuBarItem.md#newtext)
...
- [onPress](DMenuBarItem.md#onpress)
- [onRefit](DMenuBarItem.md#onrefit)
- [onReflow](DMenuBarItem.md#onreflow)
- [onReflowTextAndImage](DMenuBarItem.md#onreflowtextandimage)
...
- [onUnpress](DMenuBarItem.md#onunpress)
...
• **new DMenuBarItem**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DMenuBarItem`](DMenuBarItem.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-menu-bar-item.ts:26](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-bar-item.ts#L26)
...
[src/main/typescript/wcardinal/ui/d-menu-bar-item.ts:69](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-bar-item.ts#L69)
...
[src/main/typescript/wcardinal/ui/d-menu-bar-item.ts:65](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-bar-item.ts#L65)
...
[src/main/typescript/wcardinal/ui/d-menu-bar-item.ts:107](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-bar-item.ts#L107)
...
▸ **newMenu**(`theme`, `options?`): [`DMenu`](DMenu.md)\<`VALUE`, [`DThemeMenu`](../interfaces/DThemeMenu.md), [`DMenuOptions`](../interfaces/DMenuOptions.md)\<`VALUE`, [`DThemeMenu`](../interfaces/DThemeMenu.md)\>\>
...
[src/main/typescript/wcardinal/ui/d-menu-bar-item.ts:37](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-bar-item.ts#L37)
...
[src/main/typescript/wcardinal/ui/d-menu-bar-item.ts:56](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-bar-item.ts#L56)
...
[src/main/typescript/wcardinal/ui/d-menu-bar-item.ts:92](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-bar-item.ts#L92)
...
[src/main/typescript/wcardinal/ui/d-menu-bar-item.ts:99](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-bar-item.ts#L99)
...
[src/main/typescript/wcardinal/ui/d-menu-bar-item.ts:84](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-bar-item.ts#L84)
...
[src/main/typescript/wcardinal/ui/d-menu-bar-item.ts:61](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-bar-item.ts#L61)
...
▸ **setFocused**(`isFocused`): [`DMenuBarItem`](DMenuBarItem.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-menu-bar-item.ts:28](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-bar-item.ts#L28)

___

### toMenuOptions

▸ **toMenuOptions**(`theme`, `options?`): `undefined` \| [`DMenuOptions`](../interfaces/DMenuOptions.md)\<`VALUE`, [`DThemeMenu`](../interfaces/DThemeMenu.md)\>
...
[src/main/typescript/wcardinal/ui/d-menu-bar-item.ts:41](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-bar-item.ts#L41)
