[Winter Cardinal UI - v0.407.0](../index.md) / DInputTextArea
...
[src/main/typescript/wcardinal/ui/d-input-text-area.ts:29](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-input-text-area.ts#L29)
...
▸ **setFocused**(`isFocused`): [`DInputTextArea`](DInputTextArea.md)\<`THEME`, `OPTIONS`\>
