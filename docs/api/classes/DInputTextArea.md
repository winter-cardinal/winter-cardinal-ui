[Winter Cardinal UI - v0.414.0](../index.md) / DInputTextArea
...
- [`DInput`](DInput.md)\<`string`, `HTMLTextAreaElement`, `THEME`, `OPTIONS`, [`UtilInputTextArea`](UtilInputTextArea.md)\>
  ...
  ↳↳ [`DTableBodyCellInputTextArea`](DTableBodyCellInputTextArea.md)
...
- [\_boundsID](DInputTextArea.md#_boundsid)
- [\_boundsRect](DInputTextArea.md#_boundsrect)
...
- [\_enabledFilters](DInputTextArea.md#_enabledfilters)
- [\_image](DInputTextArea.md#_image)
- [\_lastDownPoint](DInputTextArea.md#_lastdownpoint)
- [\_lastSortedIndex](DInputTextArea.md#_lastsortedindex)
- [\_localBounds](DInputTextArea.md#_localbounds)
- [\_localBoundsRect](DInputTextArea.md#_localboundsrect)
...
- [containerUpdateTransform](DInputTextArea.md#containerupdatetransform)
...
- [disableTempParent](DInputTextArea.md#disabletempparent)
- [displayObjectUpdateTransform](DInputTextArea.md#displayobjectupdatetransform)
- [emit](DInputTextArea.md#emit)
- [enableTempParent](DInputTextArea.md#enabletempparent)
...
- [getImage](DInputTextArea.md#getimage)
- [getLayouter](DInputTextArea.md#getlayouter)
...
- [getText](DInputTextArea.md#gettext)
...
- [newOverflowMask](DInputTextArea.md#newoverflowmask)
- [newPadding](DInputTextArea.md#newpadding)
- [newText](DInputTextArea.md#newtext)
...
- [onReflowTextAndImage](DInputTextArea.md#onreflowtextandimage)
...
• **new DInputTextArea**\<`THEME`, `OPTIONS`\>(`options?`): [`DInputTextArea`](DInputTextArea.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-input-text-area.ts:29](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-input-text-area.ts#L29)
