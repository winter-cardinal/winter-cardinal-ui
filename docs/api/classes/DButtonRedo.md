[Winter Cardinal UI - v0.167.0](../index.md) / DButtonRedo

# Class: DButtonRedo<VALUE, THEME, OPTIONS\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeButton`](../interfaces/DThemeButton.md)<`VALUE`\> = [`DThemeButton`](../interfaces/DThemeButton.md)<`VALUE`\> |
| `OPTIONS` | extends [`DButtonOptions`](../interfaces/DButtonOptions.md)<`VALUE`, `THEME`\> = [`DButtonOptions`](../interfaces/DButtonOptions.md)<`VALUE`, `THEME`\> |
...
- [constructor](DButtonRedo.md#constructor)

### Properties

- [\_accessibleActive](DButtonRedo.md#_accessibleactive)
- [\_accessibleDiv](DButtonRedo.md#_accessiblediv)
- [\_auto](DButtonRedo.md#_auto)
- [\_background](DButtonRedo.md#_background)
- [\_border](DButtonRedo.md#_border)
- [\_bounds](DButtonRedo.md#_bounds)
- [\_clearType](DButtonRedo.md#_cleartype)
- [\_corner](DButtonRedo.md#_corner)
- [\_cursor](DButtonRedo.md#_cursor)
- [\_destroyed](DButtonRedo.md#_destroyed)
- [\_images](DButtonRedo.md#_images)
- [\_isOverflowMaskEnabled](DButtonRedo.md#_isoverflowmaskenabled)
- [\_isTextVisible](DButtonRedo.md#_istextvisible)
- [\_isToggle](DButtonRedo.md#_istoggle)
- [\_lastDownPoint](DButtonRedo.md#_lastdownpoint)
- [\_lastSortedIndex](DButtonRedo.md#_lastsortedindex)
- [\_mask](DButtonRedo.md#_mask)
- [\_options](DButtonRedo.md#_options)
- [\_outline](DButtonRedo.md#_outline)
- [\_overflowMask](DButtonRedo.md#_overflowmask)
- [\_padding](DButtonRedo.md#_padding)
- [\_reflowable](DButtonRedo.md#_reflowable)
- [\_shortcuts](DButtonRedo.md#_shortcuts)
- [\_snippet](DButtonRedo.md#_snippet)
- [\_tempDisplayObjectParent](DButtonRedo.md#_tempdisplayobjectparent)
- [\_text](DButtonRedo.md#_text)
- [\_textAlign](DButtonRedo.md#_textalign)
- [\_textAlpha](DButtonRedo.md#_textalpha)
- [\_textColor](DButtonRedo.md#_textcolor)
- [\_textFormatter](DButtonRedo.md#_textformatter)
- [\_textStyle](DButtonRedo.md#_textstyle)
- [\_textValue](DButtonRedo.md#_textvalue)
- [\_textValueComputed](DButtonRedo.md#_textvaluecomputed)
- [\_title](DButtonRedo.md#_title)
- [\_when](DButtonRedo.md#_when)
- [\_zIndex](DButtonRedo.md#_zindex)
- [accessible](DButtonRedo.md#accessible)
- [accessibleChildren](DButtonRedo.md#accessiblechildren)
- [accessibleHint](DButtonRedo.md#accessiblehint)
- [accessiblePointerEvents](DButtonRedo.md#accessiblepointerevents)
- [accessibleTitle](DButtonRedo.md#accessibletitle)
- [accessibleType](DButtonRedo.md#accessibletype)
- [alpha](DButtonRedo.md#alpha)
- [angle](DButtonRedo.md#angle)
- [buttonMode](DButtonRedo.md#buttonmode)
- [cacheAsBitmap](DButtonRedo.md#cacheasbitmap)
- [children](DButtonRedo.md#children)
- [cursor](DButtonRedo.md#cursor)
- [filterArea](DButtonRedo.md#filterarea)
- [filters](DButtonRedo.md#filters)
- [hitArea](DButtonRedo.md#hitarea)
- [interactive](DButtonRedo.md#interactive)
- [interactiveChildren](DButtonRedo.md#interactivechildren)
- [isMask](DButtonRedo.md#ismask)
- [isSprite](DButtonRedo.md#issprite)
- [localTransform](DButtonRedo.md#localtransform)
- [mask](DButtonRedo.md#mask)
- [name](DButtonRedo.md#name)
- [parent](DButtonRedo.md#parent)
- [pivot](DButtonRedo.md#pivot)
- [renderable](DButtonRedo.md#renderable)
- [rotation](DButtonRedo.md#rotation)
- [sortDirty](DButtonRedo.md#sortdirty)
- [sortableChildren](DButtonRedo.md#sortablechildren)
- [transform](DButtonRedo.md#transform)
- [visible](DButtonRedo.md#visible)
- [worldAlpha](DButtonRedo.md#worldalpha)
- [worldTransform](DButtonRedo.md#worldtransform)
- [worldVisible](DButtonRedo.md#worldvisible)
- [zIndex](DButtonRedo.md#zindex)
- [LAYOUTER](DButtonRedo.md#layouter)
- [WORK\_CONTAINS\_POINT](DButtonRedo.md#work_contains_point)

### Accessors

- [background](DButtonRedo.md#background)
- [border](DButtonRedo.md#border)
- [corner](DButtonRedo.md#corner)
- [height](DButtonRedo.md#height)
- [image](DButtonRedo.md#image)
- [isToggle](DButtonRedo.md#istoggle)
- [outline](DButtonRedo.md#outline)
- [padding](DButtonRedo.md#padding)
- [position](DButtonRedo.md#position)
- [reflowable](DButtonRedo.md#reflowable)
- [scale](DButtonRedo.md#scale)
- [shadow](DButtonRedo.md#shadow)
- [skew](DButtonRedo.md#skew)
- [snippet](DButtonRedo.md#snippet)
- [state](DButtonRedo.md#state)
- [text](DButtonRedo.md#text)
- [theme](DButtonRedo.md#theme)
- [title](DButtonRedo.md#title)
- [type](DButtonRedo.md#type)
- [unsafe](DButtonRedo.md#unsafe)
- [weight](DButtonRedo.md#weight)
- [width](DButtonRedo.md#width)
- [x](DButtonRedo.md#x)
- [y](DButtonRedo.md#y)

### Methods

- [\_calculateBounds](DButtonRedo.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DButtonRedo.md#_recursivepostupdatetransform)
- [\_render](DButtonRedo.md#_render)
- [addChild](DButtonRedo.md#addchild)
- [addChildAt](DButtonRedo.md#addchildat)
- [addListener](DButtonRedo.md#addlistener)
- [applyTitle](DButtonRedo.md#applytitle)
- [blur](DButtonRedo.md#blur)
- [calculateBounds](DButtonRedo.md#calculatebounds)
- [computeTextValue](DButtonRedo.md#computetextvalue)
- [containsGlobalPoint](DButtonRedo.md#containsglobalpoint)
- [containsLocalPoint](DButtonRedo.md#containslocalpoint)
- [containsPoint](DButtonRedo.md#containspoint)
- [createOrUpdateText](DButtonRedo.md#createorupdatetext)
- [createText](DButtonRedo.md#createtext)
- [destroy](DButtonRedo.md#destroy)
- [displayObjectUpdateTransform](DButtonRedo.md#displayobjectupdatetransform)
- [emit](DButtonRedo.md#emit)
- [eventNames](DButtonRedo.md#eventnames)
- [focus](DButtonRedo.md#focus)
- [focusOnClosest](DButtonRedo.md#focusonclosest)
- [getBounds](DButtonRedo.md#getbounds)
- [getChildAt](DButtonRedo.md#getchildat)
- [getChildByName](DButtonRedo.md#getchildbyname)
- [getChildIndex](DButtonRedo.md#getchildindex)
- [getClearType](DButtonRedo.md#getcleartype)
- [getClippingRect](DButtonRedo.md#getclippingrect)
- [getGlobalPosition](DButtonRedo.md#getglobalposition)
- [getHeight](DButtonRedo.md#getheight)
- [getLocalBounds](DButtonRedo.md#getlocalbounds)
- [getOverflowMask](DButtonRedo.md#getoverflowmask)
- [getParentOfSize](DButtonRedo.md#getparentofsize)
- [getTextAlpha](DButtonRedo.md#gettextalpha)
- [getTextColor](DButtonRedo.md#gettextcolor)
- [getThemeDefault](DButtonRedo.md#getthemedefault)
- [getType](DButtonRedo.md#gettype)
- [getWidth](DButtonRedo.md#getwidth)
- [getX](DButtonRedo.md#getx)
- [getY](DButtonRedo.md#gety)
- [hasDirty](DButtonRedo.md#hasdirty)
- [hasRefitableHeight](DButtonRedo.md#hasrefitableheight)
- [hasRefitableWidth](DButtonRedo.md#hasrefitablewidth)
- [hide](DButtonRedo.md#hide)
- [hideText](DButtonRedo.md#hidetext)
- [init](DButtonRedo.md#init)
- [initOnClick](DButtonRedo.md#initonclick)
- [initOnPress](DButtonRedo.md#initonpress)
- [initReflowable](DButtonRedo.md#initreflowable)
- [isDirty](DButtonRedo.md#isdirty)
- [isEventTarget](DButtonRedo.md#iseventtarget)
- [isHidden](DButtonRedo.md#ishidden)
- [isHierarchyDirty](DButtonRedo.md#ishierarchydirty)
- [isRefitable](DButtonRedo.md#isrefitable)
- [isShown](DButtonRedo.md#isshown)
- [listenerCount](DButtonRedo.md#listenercount)
- [listeners](DButtonRedo.md#listeners)
- [newImage](DButtonRedo.md#newimage)
- [newImages](DButtonRedo.md#newimages)
- [off](DButtonRedo.md#off)
- [on](DButtonRedo.md#on)
- [onActivate](DButtonRedo.md#onactivate)
- [onActivateKeyDown](DButtonRedo.md#onactivatekeydown)
- [onActivateKeyUp](DButtonRedo.md#onactivatekeyup)
- [onBlur](DButtonRedo.md#onblur)
- [onChildBlur](DButtonRedo.md#onchildblur)
- [onChildFocus](DButtonRedo.md#onchildfocus)
- [onChildrenChange](DButtonRedo.md#onchildrenchange)
- [onClick](DButtonRedo.md#onclick)
- [onDblClick](DButtonRedo.md#ondblclick)
- [onDown](DButtonRedo.md#ondown)
- [onDownThis](DButtonRedo.md#ondownthis)
- [onFocus](DButtonRedo.md#onfocus)
- [onHierarchyDirty](DButtonRedo.md#onhierarchydirty)
- [onInactivate](DButtonRedo.md#oninactivate)
- [onKeyDown](DButtonRedo.md#onkeydown)
- [onKeyUp](DButtonRedo.md#onkeyup)
- [onMove](DButtonRedo.md#onmove)
- [onOut](DButtonRedo.md#onout)
- [onOver](DButtonRedo.md#onover)
- [onParentMove](DButtonRedo.md#onparentmove)
- [onParentResize](DButtonRedo.md#onparentresize)
- [onRefit](DButtonRedo.md#onrefit)
- [onReflow](DButtonRedo.md#onreflow)
- [onResize](DButtonRedo.md#onresize)
- [onScale](DButtonRedo.md#onscale)
- [onShortcut](DButtonRedo.md#onshortcut)
- [onSkew](DButtonRedo.md#onskew)
- [onStateChange](DButtonRedo.md#onstatechange)
- [onTextChange](DButtonRedo.md#ontextchange)
- [onToggleEnd](DButtonRedo.md#ontoggleend)
- [onToggleStart](DButtonRedo.md#ontogglestart)
- [onUp](DButtonRedo.md#onup)
- [onUpThis](DButtonRedo.md#onupthis)
- [onWheel](DButtonRedo.md#onwheel)
- [once](DButtonRedo.md#once)
- [reflow](DButtonRedo.md#reflow)
- [removeAllListeners](DButtonRedo.md#removealllisteners)
- [removeChild](DButtonRedo.md#removechild)
- [removeChildAt](DButtonRedo.md#removechildat)
- [removeChildren](DButtonRedo.md#removechildren)
- [removeListener](DButtonRedo.md#removelistener)
- [render](DButtonRedo.md#render)
- [renderAdvanced](DButtonRedo.md#renderadvanced)
- [resize](DButtonRedo.md#resize)
- [setChildIndex](DButtonRedo.md#setchildindex)
- [setFocused](DButtonRedo.md#setfocused)
- [setHeight](DButtonRedo.md#setheight)
- [setParent](DButtonRedo.md#setparent)
- [setTransform](DButtonRedo.md#settransform)
- [setWidth](DButtonRedo.md#setwidth)
- [setX](DButtonRedo.md#setx)
- [setY](DButtonRedo.md#sety)
- [show](DButtonRedo.md#show)
- [showText](DButtonRedo.md#showtext)
- [sortChildren](DButtonRedo.md#sortchildren)
- [swapChildren](DButtonRedo.md#swapchildren)
- [toCursor](DButtonRedo.md#tocursor)
- [toDirty](DButtonRedo.md#todirty)
- [toGlobal](DButtonRedo.md#toglobal)
- [toHasDirty](DButtonRedo.md#tohasdirty)
- [toHierarchyDirty](DButtonRedo.md#tohierarchydirty)
- [toImageOptions](DButtonRedo.md#toimageoptions)
- [toLocal](DButtonRedo.md#tolocal)
- [toParentHasDirty](DButtonRedo.md#toparenthasdirty)
- [toParentHierarchyDirty](DButtonRedo.md#toparenthierarchydirty)
- [toParentResized](DButtonRedo.md#toparentresized)
- [toggle](DButtonRedo.md#toggle)
- [updateText](DButtonRedo.md#updatetext)
- [updateTextAndImage](DButtonRedo.md#updatetextandimage)
- [updateTextColor](DButtonRedo.md#updatetextcolor)
- [updateTextPosition](DButtonRedo.md#updatetextposition)
- [updateTextValue](DButtonRedo.md#updatetextvalue)
- [updateTransform](DButtonRedo.md#updatetransform)
- [mixin](DButtonRedo.md#mixin)

## Constructors

### constructor

• **new DButtonRedo**<`VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeButton`](../interfaces/DThemeButton.md)<`VALUE`, `THEME`\> = [`DThemeButton`](../interfaces/DThemeButton.md)<`VALUE`\> |
| `OPTIONS` | extends [`DButtonOptions`](../interfaces/DButtonOptions.md)<`VALUE`, `THEME`, `any`, `OPTIONS`\> = [`DButtonOptions`](../interfaces/DButtonOptions.md)<`VALUE`, `THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-button-redo.ts:15](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-redo.ts#L15)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DButtonRedo`](DButtonRedo.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[`DButtonRedo`](DButtonRedo.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DButtonRedo`](DButtonRedo.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DButtonRedo`](DButtonRedo.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button.ts:50](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button.ts#L50)
...
▸ **hide**(): [`DButtonRedo`](DButtonRedo.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DButtonRedo`](DButtonRedo.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DButtonRedo`](DButtonRedo.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-redo.ts:26](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-redo.ts#L26)
...
▸ **once**(`event`, `fn`, `context?`): [`DButtonRedo`](DButtonRedo.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DButtonRedo`](DButtonRedo.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DButtonRedo`](DButtonRedo.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DButtonRedo`](DButtonRedo.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DButtonRedo`](DButtonRedo.md)<`VALUE`, `THEME`, `OPTIONS`\>
