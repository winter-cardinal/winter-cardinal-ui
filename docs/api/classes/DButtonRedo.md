[Winter Cardinal UI - v0.374.0](../index.md) / DButtonRedo
...
- [newPadding](DButtonRedo.md#newpadding)
- [newText](DButtonRedo.md#newtext)
...
• **new DButtonRedo**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DButtonRedo`](DButtonRedo.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DButtonRedo`](DButtonRedo.md)\<`VALUE`, `THEME`, `OPTIONS`\>
