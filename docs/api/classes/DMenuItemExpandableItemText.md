[Winter Cardinal UI - v0.407.0](../index.md) / DMenuItemExpandableItemText
...
[src/main/typescript/wcardinal/ui/d-menu-item-expandable-item-text.ts:13](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-item-expandable-item-text.ts#L13)
...
▸ **setFocused**(`isFocused`): [`DMenuItemExpandableItemText`](DMenuItemExpandableItemText.md)\<`VALUE`, `THEME`, `OPTIONS`\>
