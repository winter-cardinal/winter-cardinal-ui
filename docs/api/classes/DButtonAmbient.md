[Winter Cardinal UI - v0.194.0](../index.md) / DButtonAmbient
...
- [`DButton`](DButton.md)<`VALUE`, `THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DDialogLayeredHeaderButtonClose`](DDialogLayeredHeaderButtonClose.md)
...
- [options](DButtonAmbient.md#options)
...
[src/main/typescript/wcardinal/ui/d-button-ambient.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.194.0/src/main/typescript/wcardinal/ui/d-button-ambient.ts#L20)
