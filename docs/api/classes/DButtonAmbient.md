[Winter Cardinal UI - v0.407.0](../index.md) / DButtonAmbient
...
[src/main/typescript/wcardinal/ui/d-button-ambient.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-ambient.ts#L20)
...
▸ **setFocused**(`isFocused`): [`DButtonAmbient`](DButtonAmbient.md)\<`VALUE`, `THEME`, `OPTIONS`\>
