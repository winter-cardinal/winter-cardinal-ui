[Winter Cardinal UI - v0.414.0](../index.md) / DButtonAmbient
...
- [\_boundsID](DButtonAmbient.md#_boundsid)
- [\_boundsRect](DButtonAmbient.md#_boundsrect)
...
- [\_enabledFilters](DButtonAmbient.md#_enabledfilters)
- [\_image](DButtonAmbient.md#_image)
- [\_isGrouped](DButtonAmbient.md#_isgrouped)
...
- [\_localBounds](DButtonAmbient.md#_localbounds)
- [\_localBoundsRect](DButtonAmbient.md#_localboundsrect)
...
- [isGrouped](DButtonAmbient.md#isgrouped)
...
- [activate](DButtonAmbient.md#activate)
...
- [containerUpdateTransform](DButtonAmbient.md#containerupdatetransform)
...
- [disableTempParent](DButtonAmbient.md#disabletempparent)
- [displayObjectUpdateTransform](DButtonAmbient.md#displayobjectupdatetransform)
- [emit](DButtonAmbient.md#emit)
- [enableTempParent](DButtonAmbient.md#enabletempparent)
...
- [getImage](DButtonAmbient.md#getimage)
- [getLayouter](DButtonAmbient.md#getlayouter)
...
- [getText](DButtonAmbient.md#gettext)
...
- [newOverflowMask](DButtonAmbient.md#newoverflowmask)
- [newPadding](DButtonAmbient.md#newpadding)
- [newText](DButtonAmbient.md#newtext)
...
- [onPress](DButtonAmbient.md#onpress)
- [onRefit](DButtonAmbient.md#onrefit)
- [onReflow](DButtonAmbient.md#onreflow)
- [onReflowTextAndImage](DButtonAmbient.md#onreflowtextandimage)
...
- [onUnpress](DButtonAmbient.md#onunpress)
...
• **new DButtonAmbient**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DButtonAmbient`](DButtonAmbient.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-ambient.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-button-ambient.ts#L20)
