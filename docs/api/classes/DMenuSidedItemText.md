[Winter Cardinal UI - v0.155.0](../index.md) / DMenuSidedItemText
...
- [\_isChildrenDirty](DMenuSidedItemText.md#_ischildrendirty)
...
- [isChildrenDirty](DMenuSidedItemText.md#ischildrendirty)
...
- [onChildrenDirty](DMenuSidedItemText.md#onchildrendirty)
...
- [refit](DMenuSidedItemText.md#refit)
...
- [toChildrenDirty](DMenuSidedItemText.md#tochildrendirty)
...
[src/main/typescript/wcardinal/ui/d-menu-sided-item-text.ts:13](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-menu-sided-item-text.ts#L13)
