[Winter Cardinal UI - v0.407.0](../index.md) / DThemeDarkImage
...
- [getImageRotation](DThemeDarkImage.md#getimagerotation)
...
- [getSecondaryImageRotation](DThemeDarkImage.md#getsecondaryimagerotation)
...
- [getTertiaryImageRotation](DThemeDarkImage.md#gettertiaryimagerotation)
...
- [getTextStyleFitting](DThemeDarkImage.md#gettextstylefitting)
...
• **new DThemeDarkImage**\<`VALUE`\>(): [`DThemeDarkImage`](DThemeDarkImage.md)\<`VALUE`\>
