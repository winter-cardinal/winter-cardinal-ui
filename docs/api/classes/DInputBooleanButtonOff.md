[Winter Cardinal UI - v0.407.0](../index.md) / DInputBooleanButtonOff
...
- [\_boundsID](DInputBooleanButtonOff.md#_boundsid)
- [\_boundsRect](DInputBooleanButtonOff.md#_boundsrect)
...
- [\_enabledFilters](DInputBooleanButtonOff.md#_enabledfilters)
- [\_image](DInputBooleanButtonOff.md#_image)
...
- [\_localBounds](DInputBooleanButtonOff.md#_localbounds)
- [\_localBoundsRect](DInputBooleanButtonOff.md#_localboundsrect)
...
- [containerUpdateTransform](DInputBooleanButtonOff.md#containerupdatetransform)
...
- [disableTempParent](DInputBooleanButtonOff.md#disabletempparent)
- [displayObjectUpdateTransform](DInputBooleanButtonOff.md#displayobjectupdatetransform)
- [emit](DInputBooleanButtonOff.md#emit)
- [enableTempParent](DInputBooleanButtonOff.md#enabletempparent)
...
- [getImage](DInputBooleanButtonOff.md#getimage)
- [getLayouter](DInputBooleanButtonOff.md#getlayouter)
...
- [getText](DInputBooleanButtonOff.md#gettext)
...
- [newOverflowMask](DInputBooleanButtonOff.md#newoverflowmask)
...
- [onReflowTextAndImage](DInputBooleanButtonOff.md#onreflowtextandimage)
...
[src/main/typescript/wcardinal/ui/d-input-boolean-button-off.ts:19](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-input-boolean-button-off.ts#L19)
