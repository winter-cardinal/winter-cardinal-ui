[Winter Cardinal UI - v0.374.0](../index.md) / DInputBooleanButtonOff
...
- [newPadding](DInputBooleanButtonOff.md#newpadding)
- [newText](DInputBooleanButtonOff.md#newtext)
...
• **new DInputBooleanButtonOff**\<`THEME`, `OPTIONS`\>(`options?`): [`DInputBooleanButtonOff`](DInputBooleanButtonOff.md)\<`THEME`, `OPTIONS`\>
...
| :------ | :------ |
| `THEME` | extends [`DThemeInputBooleanButtonOff`](../interfaces/DThemeInputBooleanButtonOff.md) = [`DThemeInputBooleanButtonOff`](../interfaces/DThemeInputBooleanButtonOff.md) |
| `OPTIONS` | extends [`DInputBooleanButtonOffOptions`](../interfaces/DInputBooleanButtonOffOptions.md)\<`THEME`, `any`\> = [`DInputBooleanButtonOffOptions`](../interfaces/DInputBooleanButtonOffOptions.md)\<`THEME`, `any`\> |
...
▸ **setFocused**(`isFocused`): [`DInputBooleanButtonOff`](DInputBooleanButtonOff.md)\<`THEME`, `OPTIONS`\>
