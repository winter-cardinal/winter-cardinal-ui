[Winter Cardinal UI - v0.154.0](../index.md) / DInputBooleanButtonOff
...
- [\_isChildrenDirty](DInputBooleanButtonOff.md#_ischildrendirty)
...
- [isChildrenDirty](DInputBooleanButtonOff.md#ischildrendirty)
...
- [onChildrenDirty](DInputBooleanButtonOff.md#onchildrendirty)
...
- [refit](DInputBooleanButtonOff.md#refit)
...
- [toChildrenDirty](DInputBooleanButtonOff.md#tochildrendirty)
...
[src/main/typescript/wcardinal/ui/d-input-boolean-button-off.ts:19](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-input-boolean-button-off.ts#L19)
