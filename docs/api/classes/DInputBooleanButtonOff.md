[Winter Cardinal UI - v0.310.1](../index.md) / DInputBooleanButtonOff
...
- [\_isGrouped](DInputBooleanButtonOff.md#_isgrouped)
...
- [isGrouped](DInputBooleanButtonOff.md#isgrouped)
...
- [activate](DInputBooleanButtonOff.md#activate)
...
- [onPress](DInputBooleanButtonOff.md#onpress)
...
- [onUnpress](DInputBooleanButtonOff.md#onunpress)
...
[src/main/typescript/wcardinal/ui/d-input-boolean-button-off.ts:19](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-input-boolean-button-off.ts#L19)
