[Winter Cardinal UI - v0.407.0](../index.md) / DListItemAmbient
...
- [\_boundsID](DListItemAmbient.md#_boundsid)
- [\_boundsRect](DListItemAmbient.md#_boundsrect)
...
- [\_enabledFilters](DListItemAmbient.md#_enabledfilters)
- [\_image](DListItemAmbient.md#_image)
...
- [\_localBounds](DListItemAmbient.md#_localbounds)
- [\_localBoundsRect](DListItemAmbient.md#_localboundsrect)
...
- [link](DListItemAmbient.md#link)
- [options](DListItemAmbient.md#options)
...
- [activate](DListItemAmbient.md#activate)
...
- [containerUpdateTransform](DListItemAmbient.md#containerupdatetransform)
...
- [disableTempParent](DListItemAmbient.md#disabletempparent)
- [displayObjectUpdateTransform](DListItemAmbient.md#displayobjectupdatetransform)
- [emit](DListItemAmbient.md#emit)
- [enableTempParent](DListItemAmbient.md#enabletempparent)
...
- [getImage](DListItemAmbient.md#getimage)
- [getLayouter](DListItemAmbient.md#getlayouter)
...
- [getText](DListItemAmbient.md#gettext)
...
- [newLink](DListItemAmbient.md#newlink)
- [newOverflowMask](DListItemAmbient.md#newoverflowmask)
- [newPadding](DListItemAmbient.md#newpadding)
- [newText](DListItemAmbient.md#newtext)
...
- [onClick](DListItemAmbient.md#onclick)
...
- [onReflowTextAndImage](DListItemAmbient.md#onreflowtextandimage)
...
• **new DListItemAmbient**\<`VALUE`, `THEME`, `OPTIONS`\>(`data`, `options?`): [`DListItemAmbient`](DListItemAmbient.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:81](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L81)
...
[DListItem](DListItem.md).[_boundsID](DListItem.md#_boundsid)
...
[DListItem](DListItem.md).[_boundsRect](DListItem.md#_boundsrect)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:76](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L76)
...
[DListItem](DListItem.md).[_enabledFilters](DListItem.md#_enabledfilters)
...
[DListItem](DListItem.md).[_image](DListItem.md#_image)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:78](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L78)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:79](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L79)
...
[DListItem](DListItem.md).[_localBounds](DListItem.md#_localbounds)
...
[DListItem](DListItem.md).[_localBoundsRect](DListItem.md#_localboundsrect)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:77](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L77)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:155](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L155)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:89](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L89)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:151](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L151)
...
[DListItem](DListItem.md).[activate](DListItem.md#activate)

#### Defined in

[src/main/typescript/wcardinal/ui/d-list-item.ts:114](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L114)
...
[DListItem](DListItem.md).[containerUpdateTransform](DListItem.md#containerupdatetransform)
...
[DListItem](DListItem.md).[disableTempParent](DListItem.md#disabletempparent)
...
[DListItem](DListItem.md).[enableTempParent](DListItem.md#enabletempparent)
...
[DListItem](DListItem.md).[getImage](DListItem.md#getimage)
...
[DListItem](DListItem.md).[getLayouter](DListItem.md#getlayouter)
...
[DListItem](DListItem.md).[getText](DListItem.md#gettext)
...
[src/main/typescript/wcardinal/ui/d-list-item-ambient.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item-ambient.ts#L20)
...
[DListItem](DListItem.md).[newLink](DListItem.md#newlink)

#### Defined in

[src/main/typescript/wcardinal/ui/d-list-item.ts:98](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L98)
...
[DListItem](DListItem.md).[newOverflowMask](DListItem.md#newoverflowmask)
...
[DListItem](DListItem.md).[newPadding](DListItem.md#newpadding)
...
[DListItem](DListItem.md).[newText](DListItem.md#newtext)
...
[DListItem](DListItem.md).[onClick](DListItem.md#onclick)

#### Defined in

[src/main/typescript/wcardinal/ui/d-list-item.ts:106](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L106)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:259](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L259)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:266](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L266)
...
[DListItem](DListItem.md).[onReflowTextAndImage](DListItem.md#onreflowtextandimage)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:159](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L159)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:216](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L216)
...
▸ **setFocused**(`isFocused`): [`DListItemAmbient`](DListItemAmbient.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **toLinkChecker**(`checker?`): `undefined` \| [`DLinkChecker`](../index.md#dlinkchecker)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:138](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L138)

___

### toLinkOptions

▸ **toLinkOptions**(`accessor`): [`DLinkOptions`](../interfaces/DLinkOptions.md)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:121](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L121)

___

### toLinkUrl

▸ **toLinkUrl**(`toUrl`): [`DLinkUrlMaker`](../index.md#dlinkurlmaker)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:129](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L129)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:240](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L240)
