[Winter Cardinal UI - v0.457.0](../index.md) / DDialogFitted
...
- [\_alwaysOnTop](DDialogFitted.md#_alwaysontop)
...
- [\_boundsID](DDialogFitted.md#_boundsid)
- [\_boundsRect](DDialogFitted.md#_boundsrect)
...
- [\_enabledFilters](DDialogFitted.md#_enabledfilters)
...
- [\_localBounds](DDialogFitted.md#_localbounds)
- [\_localBoundsRect](DDialogFitted.md#_localboundsrect)
- [\_mask](DDialogFitted.md#_mask)
- [\_mode](DDialogFitted.md#_mode)
- [\_onParentChildAddedBound](DDialogFitted.md#_onparentchildaddedbound)
...
- [alwaysOnTop](DDialogFitted.md#alwaysontop)
...
- [bringToFront](DDialogFitted.md#bringtofront)
- [calculateBounds](DDialogFitted.md#calculatebounds)
- [cancel](DDialogFitted.md#cancel)
- [close](DDialogFitted.md#close)
- [containerUpdateTransform](DDialogFitted.md#containerupdatetransform)
...
- [disableTempParent](DDialogFitted.md#disabletempparent)
...
- [enableTempParent](DDialogFitted.md#enabletempparent)
...
- [newPadding](DDialogFitted.md#newpadding)
...
• **new DDialogFitted**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DDialogFitted`](DDialogFitted.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
| `VALUE` | `void` |
| `THEME` | extends [`DThemeDialogFitted`](../interfaces/DThemeDialogFitted.md) = [`DThemeDialogFitted`](../interfaces/DThemeDialogFitted.md) |
| `OPTIONS` | extends [`DDialogFittedOptions`](../interfaces/DDialogFittedOptions.md)\<`VALUE`, `THEME`, `any`\> = [`DDialogFittedOptions`](../interfaces/DDialogFittedOptions.md)\<`VALUE`, `THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-dialog-layered.ts:247](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-layered.ts#L247)
...
[src/main/typescript/wcardinal/ui/d-dialog-fitted.ts:45](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-fitted.ts#L45)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered.ts:191](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-layered.ts#L191)
