[Winter Cardinal UI - v0.160.0](../index.md) / DBase
...
- `Container`
  ...
  ↳↳ [`DChartPlotAreaImpl`](DChartPlotAreaImpl.md)
...
• **new DBase**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemeBase`](../interfaces/DThemeBase.md) = [`DThemeBase`](../interfaces/DThemeBase.md) |
| `OPTIONS` | extends [`DBaseOptions`](../interfaces/DBaseOptions.md)<`THEME`, `any`, `OPTIONS`\> = [`DBaseOptions`](../interfaces/DBaseOptions.md)<`THEME`, `any`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
...
▸ **hide**(): [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
