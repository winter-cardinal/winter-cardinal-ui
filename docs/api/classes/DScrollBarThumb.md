[Winter Cardinal UI - v0.407.0](../index.md) / DScrollBarThumb
...
- [\_boundsID](DScrollBarThumb.md#_boundsid)
- [\_boundsRect](DScrollBarThumb.md#_boundsrect)
...
- [\_enabledFilters](DScrollBarThumb.md#_enabledfilters)
...
- [\_localBounds](DScrollBarThumb.md#_localbounds)
- [\_localBoundsRect](DScrollBarThumb.md#_localboundsrect)
...
- [options](DScrollBarThumb.md#options)
...
- [containerUpdateTransform](DScrollBarThumb.md#containerupdatetransform)
...
- [disableTempParent](DScrollBarThumb.md#disabletempparent)
- [displayObjectUpdateTransform](DScrollBarThumb.md#displayobjectupdatetransform)
- [emit](DScrollBarThumb.md#emit)
- [enableTempParent](DScrollBarThumb.md#enabletempparent)
...
- [newPadding](DScrollBarThumb.md#newpadding)
...
• **new DScrollBarThumb**(`options?`): [`DScrollBarThumb`](DScrollBarThumb.md)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar-thumb.ts:45](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-scroll-bar-thumb.ts#L45)
...
▸ **setFocused**(`isFocused`): [`DScrollBarThumb`](DScrollBarThumb.md)
