[Winter Cardinal UI - v0.457.0](../index.md) / DThemeDarkPickerDatetimeButtonDate
...
- [getImageRotation](DThemeDarkPickerDatetimeButtonDate.md#getimagerotation)
...
- [getSecondaryImageRotation](DThemeDarkPickerDatetimeButtonDate.md#getsecondaryimagerotation)
...
- [getTertiaryImageRotation](DThemeDarkPickerDatetimeButtonDate.md#gettertiaryimagerotation)
...
- [getTextStyleFitting](DThemeDarkPickerDatetimeButtonDate.md#gettextstylefitting)
...
• **new DThemeDarkPickerDatetimeButtonDate**\<`VALUE`\>(`backgroundColor?`, `hover?`, `pressed?`): [`DThemeDarkPickerDatetimeButtonDate`](DThemeDarkPickerDatetimeButtonDate.md)\<`VALUE`\>
...
[`DThemeDarkPickerDatetimeButtonDate`](DThemeDarkPickerDatetimeButtonDate.md)\<`VALUE`\>
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-picker-datetime-button-date.ts:27](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-picker-datetime-button-date.ts#L27)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-picker-datetime-button-date.ts:15](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-picker-datetime-button-date.ts#L15)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-picker-datetime-button-date.ts:19](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-picker-datetime-button-date.ts#L19)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-picker-datetime-button-date.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-picker-datetime-button-date.ts#L23)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-picker-datetime-button-date.ts:31](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-picker-datetime-button-date.ts#L31)
