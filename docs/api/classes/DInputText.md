[Winter Cardinal UI - v0.167.0](../index.md) / DInputText
...
- [\_images](DInputText.md#_images)
- [\_isOverflowMaskEnabled](DInputText.md#_isoverflowmaskenabled)
- [\_isTextVisible](DInputText.md#_istextvisible)
...
- [\_textAlign](DInputText.md#_textalign)
- [\_textAlpha](DInputText.md#_textalpha)
- [\_textColor](DInputText.md#_textcolor)
- [\_textFormatter](DInputText.md#_textformatter)
- [\_textStyle](DInputText.md#_textstyle)
- [\_textValue](DInputText.md#_textvalue)
- [\_textValueComputed](DInputText.md#_textvaluecomputed)
- [\_title](DInputText.md#_title)
...
- [computeTextValue](DInputText.md#computetextvalue)
...
- [createOrUpdateText](DInputText.md#createorupdatetext)
- [createText](DInputText.md#createtext)
...
- [getTextAlpha](DInputText.md#gettextalpha)
- [getTextColor](DInputText.md#gettextcolor)
...
- [hideText](DInputText.md#hidetext)
...
- [listenerCount](DInputText.md#listenercount)
- [listeners](DInputText.md#listeners)
- [newImage](DInputText.md#newimage)
- [newImages](DInputText.md#newimages)
...
- [onTextChange](DInputText.md#ontextchange)
...
- [showText](DInputText.md#showtext)
- [sortChildren](DInputText.md#sortchildren)
- [start](DInputText.md#start)
- [swapChildren](DInputText.md#swapchildren)
...
- [toImageOptions](DInputText.md#toimageoptions)
...
- [updateText](DInputText.md#updatetext)
- [updateTextAndImage](DInputText.md#updatetextandimage)
- [updateTextColor](DInputText.md#updatetextcolor)
- [updateTextPosition](DInputText.md#updatetextposition)
- [updateTextValue](DInputText.md#updatetextvalue)
...
• **new DInputText**<`THEME`, `OPTIONS`\>(`options?`)

#### Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeInputText`](../interfaces/DThemeInputText.md)<`THEME`\> = [`DThemeInputText`](../interfaces/DThemeInputText.md) |
| `OPTIONS` | extends [`DInputTextOptions`](../interfaces/DInputTextOptions.md)<`THEME`, `OPTIONS`\> = [`DInputTextOptions`](../interfaces/DInputTextOptions.md)<`THEME`\> |
...
[src/main/typescript/wcardinal/ui/d-input-text.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-input-text.ts#L23)
...
▸ **once**(`event`, `fn`, `context?`): [`DInputText`](DInputText.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DInputText`](DInputText.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DInputText`](DInputText.md)<`THEME`, `OPTIONS`\>
...
▸ **select**(): [`DInputText`](DInputText.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DInputText`](DInputText.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DInputText`](DInputText.md)<`THEME`, `OPTIONS`\>
