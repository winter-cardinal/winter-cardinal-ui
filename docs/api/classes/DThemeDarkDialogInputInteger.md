[Winter Cardinal UI - v0.200.0](../index.md) / DThemeDarkDialogInputInteger
...
- [getContent](DThemeDarkDialogInputInteger.md#getcontent)
...
- [getOutlineAlpha](DThemeDarkDialogInputInteger.md#getoutlinealpha)
