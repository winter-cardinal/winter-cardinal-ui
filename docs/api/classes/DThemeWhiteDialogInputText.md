[Winter Cardinal UI - v0.414.0](../index.md) / DThemeWhiteDialogInputText
...
- [getContent](DThemeWhiteDialogInputText.md#getcontent)
...
- [getOutlineAlign](DThemeWhiteDialogInputText.md#getoutlinealign)
...
• **new DThemeWhiteDialogInputText**(): [`DThemeWhiteDialogInputText`](DThemeWhiteDialogInputText.md)
