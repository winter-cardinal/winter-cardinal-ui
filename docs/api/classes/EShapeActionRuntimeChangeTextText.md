[Winter Cardinal UI](../README.md) / EShapeActionRuntimeChangeTextText
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-change-text-text.ts:16](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-change-text-text.ts#L16)
...
• `Protected` **text**: [`EShapeActionExpression`](../README.md#eshapeactionexpression)<`string`\>

#### Defined in

[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-change-text-text.ts:14](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-change-text-text.ts#L14)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-change-text-text.ts:21](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-change-text-text.ts#L21)
