[Winter Cardinal UI - v0.374.0](../index.md) / DDropdown
...
[src/main/typescript/wcardinal/ui/d-dropdown.ts:24](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dropdown.ts#L24)
...
▸ **setFocused**(`isFocused`): [`DDropdown`](DDropdown.md)\<`VALUE`, `THEME`, `OPTIONS`\>
