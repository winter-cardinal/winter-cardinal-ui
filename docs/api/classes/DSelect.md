[Winter Cardinal UI - v0.407.0](../index.md) / DSelect
...
- [\_boundsID](DSelect.md#_boundsid)
- [\_boundsRect](DSelect.md#_boundsrect)
- [\_clearType](DSelect.md#_cleartype)
- [\_corner](DSelect.md#_corner)
- [\_cursor](DSelect.md#_cursor)
- [\_destroyed](DSelect.md#_destroyed)
- [\_enabledFilters](DSelect.md#_enabledfilters)
- [\_image](DSelect.md#_image)
- [\_isGrouped](DSelect.md#_isgrouped)
- [\_isToggle](DSelect.md#_istoggle)
- [\_lastDownPoint](DSelect.md#_lastdownpoint)
- [\_lastSortedIndex](DSelect.md#_lastsortedindex)
- [\_localBounds](DSelect.md#_localbounds)
- [\_localBoundsRect](DSelect.md#_localboundsrect)
...
- [isGrouped](DSelect.md#isgrouped)
...
- [containerUpdateTransform](DSelect.md#containerupdatetransform)
...
- [disableTempParent](DSelect.md#disabletempparent)
- [displayObjectUpdateTransform](DSelect.md#displayobjectupdatetransform)
- [emit](DSelect.md#emit)
- [enableTempParent](DSelect.md#enabletempparent)
...
- [getImage](DSelect.md#getimage)
- [getLayouter](DSelect.md#getlayouter)
...
- [newOverflowMask](DSelect.md#newoverflowmask)
- [newPadding](DSelect.md#newpadding)
- [newText](DSelect.md#newtext)
- [off](DSelect.md#off)
- [on](DSelect.md#on)
...
- [onPress](DSelect.md#onpress)
- [onRefit](DSelect.md#onrefit)
- [onReflow](DSelect.md#onreflow)
- [onReflowTextAndImage](DSelect.md#onreflowtextandimage)
...
- [onUnpress](DSelect.md#onunpress)
...
• **new DSelect**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DSelect`](DSelect.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeSelect`](../interfaces/DThemeSelect.md)\<`VALUE`\> = [`DThemeSelect`](../interfaces/DThemeSelect.md)\<`VALUE`\> |
| `OPTIONS` | extends [`DSelectOptions`](../interfaces/DSelectOptions.md)\<`VALUE`, `THEME`, `any`\> = [`DSelectOptions`](../interfaces/DSelectOptions.md)\<`VALUE`, `THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-select.ts:77](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-select.ts#L77)
...
[DDropdownBase](DDropdownBase.md).[_boundsID](DDropdownBase.md#_boundsid)
...
[DDropdownBase](DDropdownBase.md).[_boundsRect](DDropdownBase.md#_boundsrect)
...
[DDropdownBase](DDropdownBase.md).[_enabledFilters](DDropdownBase.md#_enabledfilters)
...
[DDropdownBase](DDropdownBase.md).[_image](DDropdownBase.md#_image)
...
[DDropdownBase](DDropdownBase.md).[_localBounds](DDropdownBase.md#_localbounds)
...
[DDropdownBase](DDropdownBase.md).[_localBoundsRect](DDropdownBase.md#_localboundsrect)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:80](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L80)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:86](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L86)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:81](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L81)
...
[src/main/typescript/wcardinal/ui/d-select.ts:75](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-select.ts#L75)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:128](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L128)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:137](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L137)
...
[src/main/typescript/wcardinal/ui/d-select.ts:142](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-select.ts#L142)
...
[src/main/typescript/wcardinal/ui/d-select.ts:149](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-select.ts#L149)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:209](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L209)
...
[DDropdownBase](DDropdownBase.md).[containerUpdateTransform](DDropdownBase.md#containerupdatetransform)
...
[DDropdownBase](DDropdownBase.md).[disableTempParent](DDropdownBase.md#disabletempparent)
...
[DDropdownBase](DDropdownBase.md).[enableTempParent](DDropdownBase.md#enabletempparent)
...
[src/main/typescript/wcardinal/ui/d-select.ts:121](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-select.ts#L121)
...
[DDropdownBase](DDropdownBase.md).[getImage](DDropdownBase.md#getimage)
...
[DDropdownBase](DDropdownBase.md).[getLayouter](DDropdownBase.md#getlayouter)
...
[DDropdownBase](DDropdownBase.md).[getText](DDropdownBase.md#gettext)
...
[src/main/typescript/wcardinal/ui/d-select.ts:162](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-select.ts#L162)
...
[DDropdownBase](DDropdownBase.md).[newOverflowMask](DDropdownBase.md#newoverflowmask)
...
[DDropdownBase](DDropdownBase.md).[newPadding](DDropdownBase.md#newpadding)
...
[DDropdownBase](DDropdownBase.md).[newText](DDropdownBase.md#newtext)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:170](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L170)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:155](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L155)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:162](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L162)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:92](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L92)
...
[src/main/typescript/wcardinal/ui/d-select.ts:98](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-select.ts#L98)
...
[src/main/typescript/wcardinal/ui/d-select.ts:88](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-select.ts#L88)
...
[DDropdownBase](DDropdownBase.md).[onReflowTextAndImage](DDropdownBase.md#onreflowtextandimage)
...
[src/main/typescript/wcardinal/ui/d-select.ts:113](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-select.ts#L113)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:175](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L175)
...
▸ **setFocused**(`isFocused`): [`DSelect`](DSelect.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:105](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L105)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:113](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L113)
