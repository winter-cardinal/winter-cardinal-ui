[Winter Cardinal UI - v0.167.0](../index.md) / DSelect

# Class: DSelect<VALUE, THEME, OPTIONS\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeSelect`](../interfaces/DThemeSelect.md)<`VALUE`\> = [`DThemeSelect`](../interfaces/DThemeSelect.md)<`VALUE`\> |
| `OPTIONS` | extends [`DSelectOptions`](../interfaces/DSelectOptions.md)<`VALUE`, `THEME`\> = [`DSelectOptions`](../interfaces/DSelectOptions.md)<`VALUE`, `THEME`\> |

## Hierarchy

- [`DDropdownBase`](DDropdownBase.md)<`VALUE`, [`DMenuItem`](DMenuItem.md)<`VALUE`\> \| ``null``, `THEME`, `OPTIONS`\>

  ↳ **`DSelect`**

  ↳↳ [`DTableBodyCellSelectMenu`](DTableBodyCellSelectMenu.md)

## Table of contents

### Constructors

- [constructor](DSelect.md#constructor)

### Properties

- [\_accessibleActive](DSelect.md#_accessibleactive)
- [\_accessibleDiv](DSelect.md#_accessiblediv)
- [\_auto](DSelect.md#_auto)
- [\_background](DSelect.md#_background)
- [\_border](DSelect.md#_border)
- [\_bounds](DSelect.md#_bounds)
- [\_clearType](DSelect.md#_cleartype)
- [\_corner](DSelect.md#_corner)
- [\_cursor](DSelect.md#_cursor)
- [\_destroyed](DSelect.md#_destroyed)
- [\_images](DSelect.md#_images)
- [\_isOverflowMaskEnabled](DSelect.md#_isoverflowmaskenabled)
- [\_isTextVisible](DSelect.md#_istextvisible)
- [\_isToggle](DSelect.md#_istoggle)
- [\_lastDownPoint](DSelect.md#_lastdownpoint)
- [\_lastSortedIndex](DSelect.md#_lastsortedindex)
- [\_mask](DSelect.md#_mask)
- [\_menu](DSelect.md#_menu)
- [\_onMenuCloseBound](DSelect.md#_onmenuclosebound)
- [\_onMenuSelectBound](DSelect.md#_onmenuselectbound)
- [\_options](DSelect.md#_options)
- [\_outline](DSelect.md#_outline)
- [\_overflowMask](DSelect.md#_overflowmask)
- [\_padding](DSelect.md#_padding)
- [\_reflowable](DSelect.md#_reflowable)
- [\_shortcuts](DSelect.md#_shortcuts)
- [\_snippet](DSelect.md#_snippet)
- [\_tempDisplayObjectParent](DSelect.md#_tempdisplayobjectparent)
- [\_text](DSelect.md#_text)
- [\_textAlign](DSelect.md#_textalign)
- [\_textAlpha](DSelect.md#_textalpha)
- [\_textColor](DSelect.md#_textcolor)
- [\_textFormatter](DSelect.md#_textformatter)
- [\_textStyle](DSelect.md#_textstyle)
- [\_textValue](DSelect.md#_textvalue)
- [\_textValueComputed](DSelect.md#_textvaluecomputed)
- [\_title](DSelect.md#_title)
- [\_value](DSelect.md#_value)
- [\_when](DSelect.md#_when)
- [\_zIndex](DSelect.md#_zindex)
- [accessible](DSelect.md#accessible)
- [accessibleChildren](DSelect.md#accessiblechildren)
- [accessibleHint](DSelect.md#accessiblehint)
- [accessiblePointerEvents](DSelect.md#accessiblepointerevents)
- [accessibleTitle](DSelect.md#accessibletitle)
- [accessibleType](DSelect.md#accessibletype)
- [alpha](DSelect.md#alpha)
- [angle](DSelect.md#angle)
- [buttonMode](DSelect.md#buttonmode)
- [cacheAsBitmap](DSelect.md#cacheasbitmap)
- [children](DSelect.md#children)
- [cursor](DSelect.md#cursor)
- [filterArea](DSelect.md#filterarea)
- [filters](DSelect.md#filters)
- [hitArea](DSelect.md#hitarea)
- [interactive](DSelect.md#interactive)
- [interactiveChildren](DSelect.md#interactivechildren)
- [isMask](DSelect.md#ismask)
- [isSprite](DSelect.md#issprite)
- [localTransform](DSelect.md#localtransform)
- [mask](DSelect.md#mask)
- [name](DSelect.md#name)
- [parent](DSelect.md#parent)
- [pivot](DSelect.md#pivot)
- [renderable](DSelect.md#renderable)
- [rotation](DSelect.md#rotation)
- [sortDirty](DSelect.md#sortdirty)
- [sortableChildren](DSelect.md#sortablechildren)
- [transform](DSelect.md#transform)
- [visible](DSelect.md#visible)
- [worldAlpha](DSelect.md#worldalpha)
- [worldTransform](DSelect.md#worldtransform)
- [worldVisible](DSelect.md#worldvisible)
- [zIndex](DSelect.md#zindex)
- [LAYOUTER](DSelect.md#layouter)
- [WORK\_CONTAINS\_POINT](DSelect.md#work_contains_point)

### Accessors

- [background](DSelect.md#background)
- [border](DSelect.md#border)
- [corner](DSelect.md#corner)
- [height](DSelect.md#height)
- [image](DSelect.md#image)
- [isToggle](DSelect.md#istoggle)
- [menu](DSelect.md#menu)
- [outline](DSelect.md#outline)
- [padding](DSelect.md#padding)
- [position](DSelect.md#position)
- [reflowable](DSelect.md#reflowable)
- [scale](DSelect.md#scale)
- [shadow](DSelect.md#shadow)
- [skew](DSelect.md#skew)
- [snippet](DSelect.md#snippet)
- [state](DSelect.md#state)
- [text](DSelect.md#text)
- [theme](DSelect.md#theme)
- [title](DSelect.md#title)
- [type](DSelect.md#type)
- [unsafe](DSelect.md#unsafe)
- [value](DSelect.md#value)
- [weight](DSelect.md#weight)
- [width](DSelect.md#width)
- [x](DSelect.md#x)
- [y](DSelect.md#y)

### Methods

- [\_calculateBounds](DSelect.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DSelect.md#_recursivepostupdatetransform)
- [\_render](DSelect.md#_render)
- [addChild](DSelect.md#addchild)
- [addChildAt](DSelect.md#addchildat)
- [addListener](DSelect.md#addlistener)
- [applyTitle](DSelect.md#applytitle)
- [blur](DSelect.md#blur)
- [calculateBounds](DSelect.md#calculatebounds)
- [close](DSelect.md#close)
- [computeTextValue](DSelect.md#computetextvalue)
- [containsGlobalPoint](DSelect.md#containsglobalpoint)
- [containsLocalPoint](DSelect.md#containslocalpoint)
- [containsPoint](DSelect.md#containspoint)
- [createOrUpdateText](DSelect.md#createorupdatetext)
- [createText](DSelect.md#createtext)
- [destroy](DSelect.md#destroy)
- [displayObjectUpdateTransform](DSelect.md#displayobjectupdatetransform)
- [emit](DSelect.md#emit)
- [eventNames](DSelect.md#eventnames)
- [findMenuItem](DSelect.md#findmenuitem)
- [focus](DSelect.md#focus)
- [focusOnClosest](DSelect.md#focusonclosest)
- [getBounds](DSelect.md#getbounds)
- [getChildAt](DSelect.md#getchildat)
- [getChildByName](DSelect.md#getchildbyname)
- [getChildIndex](DSelect.md#getchildindex)
- [getClearType](DSelect.md#getcleartype)
- [getClippingRect](DSelect.md#getclippingrect)
- [getGlobalPosition](DSelect.md#getglobalposition)
- [getHeight](DSelect.md#getheight)
- [getLocalBounds](DSelect.md#getlocalbounds)
- [getOverflowMask](DSelect.md#getoverflowmask)
- [getParentOfSize](DSelect.md#getparentofsize)
- [getTextAlpha](DSelect.md#gettextalpha)
- [getTextColor](DSelect.md#gettextcolor)
- [getThemeDefault](DSelect.md#getthemedefault)
- [getType](DSelect.md#gettype)
- [getWidth](DSelect.md#getwidth)
- [getX](DSelect.md#getx)
- [getY](DSelect.md#gety)
- [hasDirty](DSelect.md#hasdirty)
- [hasRefitableHeight](DSelect.md#hasrefitableheight)
- [hasRefitableWidth](DSelect.md#hasrefitablewidth)
- [hide](DSelect.md#hide)
- [hideText](DSelect.md#hidetext)
- [init](DSelect.md#init)
- [initOnClick](DSelect.md#initonclick)
- [initOnPress](DSelect.md#initonpress)
- [initReflowable](DSelect.md#initreflowable)
- [isDirty](DSelect.md#isdirty)
- [isEventTarget](DSelect.md#iseventtarget)
- [isHidden](DSelect.md#ishidden)
- [isHierarchyDirty](DSelect.md#ishierarchydirty)
- [isRefitable](DSelect.md#isrefitable)
- [isShown](DSelect.md#isshown)
- [listenerCount](DSelect.md#listenercount)
- [listeners](DSelect.md#listeners)
- [newImage](DSelect.md#newimage)
- [newImages](DSelect.md#newimages)
- [off](DSelect.md#off)
- [on](DSelect.md#on)
- [onActivate](DSelect.md#onactivate)
- [onActivateKeyDown](DSelect.md#onactivatekeydown)
- [onActivateKeyUp](DSelect.md#onactivatekeyup)
- [onBlur](DSelect.md#onblur)
- [onChildBlur](DSelect.md#onchildblur)
- [onChildFocus](DSelect.md#onchildfocus)
- [onChildrenChange](DSelect.md#onchildrenchange)
- [onClick](DSelect.md#onclick)
- [onDblClick](DSelect.md#ondblclick)
- [onDown](DSelect.md#ondown)
- [onDownThis](DSelect.md#ondownthis)
- [onFocus](DSelect.md#onfocus)
- [onHierarchyDirty](DSelect.md#onhierarchydirty)
- [onInactivate](DSelect.md#oninactivate)
- [onKeyDown](DSelect.md#onkeydown)
- [onKeyDownArrowDown](DSelect.md#onkeydownarrowdown)
- [onKeyUp](DSelect.md#onkeyup)
- [onMenuClose](DSelect.md#onmenuclose)
- [onMenuReplaced](DSelect.md#onmenureplaced)
- [onMenuSelect](DSelect.md#onmenuselect)
- [onMove](DSelect.md#onmove)
- [onOut](DSelect.md#onout)
- [onOver](DSelect.md#onover)
- [onParentMove](DSelect.md#onparentmove)
- [onParentResize](DSelect.md#onparentresize)
- [onRefit](DSelect.md#onrefit)
- [onReflow](DSelect.md#onreflow)
- [onResize](DSelect.md#onresize)
- [onScale](DSelect.md#onscale)
- [onShortcut](DSelect.md#onshortcut)
- [onSkew](DSelect.md#onskew)
- [onStateChange](DSelect.md#onstatechange)
- [onTextChange](DSelect.md#ontextchange)
- [onToggleEnd](DSelect.md#ontoggleend)
- [onToggleStart](DSelect.md#ontogglestart)
- [onUp](DSelect.md#onup)
- [onUpThis](DSelect.md#onupthis)
- [onValueChange](DSelect.md#onvaluechange)
- [onWheel](DSelect.md#onwheel)
- [once](DSelect.md#once)
- [reflow](DSelect.md#reflow)
- [removeAllListeners](DSelect.md#removealllisteners)
- [removeChild](DSelect.md#removechild)
- [removeChildAt](DSelect.md#removechildat)
- [removeChildren](DSelect.md#removechildren)
- [removeListener](DSelect.md#removelistener)
- [render](DSelect.md#render)
- [renderAdvanced](DSelect.md#renderadvanced)
- [resize](DSelect.md#resize)
- [setChildIndex](DSelect.md#setchildindex)
- [setFocused](DSelect.md#setfocused)
- [setHeight](DSelect.md#setheight)
- [setParent](DSelect.md#setparent)
- [setTransform](DSelect.md#settransform)
- [setWidth](DSelect.md#setwidth)
- [setX](DSelect.md#setx)
- [setY](DSelect.md#sety)
- [show](DSelect.md#show)
- [showText](DSelect.md#showtext)
- [sortChildren](DSelect.md#sortchildren)
- [start](DSelect.md#start)
- [swapChildren](DSelect.md#swapchildren)
- [toCursor](DSelect.md#tocursor)
- [toDirty](DSelect.md#todirty)
- [toGlobal](DSelect.md#toglobal)
- [toHasDirty](DSelect.md#tohasdirty)
- [toHierarchyDirty](DSelect.md#tohierarchydirty)
- [toImageOptions](DSelect.md#toimageoptions)
- [toLocal](DSelect.md#tolocal)
- [toMenu](DSelect.md#tomenu)
- [toMenuOptions](DSelect.md#tomenuoptions)
- [toParentHasDirty](DSelect.md#toparenthasdirty)
- [toParentHierarchyDirty](DSelect.md#toparenthierarchydirty)
- [toParentResized](DSelect.md#toparentresized)
- [toggle](DSelect.md#toggle)
- [updateText](DSelect.md#updatetext)
- [updateTextAndImage](DSelect.md#updatetextandimage)
- [updateTextColor](DSelect.md#updatetextcolor)
- [updateTextPosition](DSelect.md#updatetextposition)
- [updateTextValue](DSelect.md#updatetextvalue)
- [updateTransform](DSelect.md#updatetransform)
- [mixin](DSelect.md#mixin)

## Constructors

### constructor

• **new DSelect**<`VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeSelect`](../interfaces/DThemeSelect.md)<`VALUE`, `THEME`\> = [`DThemeSelect`](../interfaces/DThemeSelect.md)<`VALUE`\> |
| `OPTIONS` | extends [`DSelectOptions`](../interfaces/DSelectOptions.md)<`VALUE`, `THEME`, `any`, `OPTIONS`\> = [`DSelectOptions`](../interfaces/DSelectOptions.md)<`VALUE`, `THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-select.ts:77](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-select.ts#L77)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:75](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L75)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:81](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L81)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:76](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L76)
...
• `Protected` **\_textFormatter**: (`value`: ``null`` \| [`DMenuItem`](DMenuItem.md)<`VALUE`, [`DThemeMenuItem`](../interfaces/DThemeMenuItem.md), [`DMenuItemOptions`](../interfaces/DMenuItemOptions.md)<`VALUE`, [`DThemeMenuItem`](../interfaces/DThemeMenuItem.md)\>\>, `caller`: `any`) => `string`
...
• `Protected` `Optional` **\_textValue**: [`DStateAwareOrValueMightBe`](../index.md#dstateawareorvaluemightbe)<``null`` \| [`DMenuItem`](DMenuItem.md)<`VALUE`, [`DThemeMenuItem`](../interfaces/DThemeMenuItem.md), [`DMenuItemOptions`](../interfaces/DMenuItemOptions.md)<`VALUE`, [`DThemeMenuItem`](../interfaces/DThemeMenuItem.md)\>\>\>
...
• `Protected` `Optional` **\_textValueComputed**: ``null`` \| [`DMenuItem`](DMenuItem.md)<`VALUE`, [`DThemeMenuItem`](../interfaces/DThemeMenuItem.md), [`DMenuItemOptions`](../interfaces/DMenuItemOptions.md)<`VALUE`, [`DThemeMenuItem`](../interfaces/DThemeMenuItem.md)\>\>
...
[src/main/typescript/wcardinal/ui/d-select.ts:75](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-select.ts#L75)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:127](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L127)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:136](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L136)
...
[src/main/typescript/wcardinal/ui/d-select.ts:147](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-select.ts#L147)
...
[src/main/typescript/wcardinal/ui/d-select.ts:154](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-select.ts#L154)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DSelect`](DSelect.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DSelect`](DSelect.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:209](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L209)

___

### computeTextValue

▸ `Protected` **computeTextValue**(): `undefined` \| ``null`` \| [`DMenuItem`](DMenuItem.md)<`VALUE`, [`DThemeMenuItem`](../interfaces/DThemeMenuItem.md), [`DMenuItemOptions`](../interfaces/DMenuItemOptions.md)<`VALUE`, [`DThemeMenuItem`](../interfaces/DThemeMenuItem.md)\>\>
...
▸ `Protected` **findMenuItem**(`menu`, `value`): ``null`` \| [`DMenuItem`](DMenuItem.md)<`VALUE`, [`DThemeMenuItem`](../interfaces/DThemeMenuItem.md), [`DMenuItemOptions`](../interfaces/DMenuItemOptions.md)<`VALUE`, [`DThemeMenuItem`](../interfaces/DThemeMenuItem.md)\>\>
...
[src/main/typescript/wcardinal/ui/d-select.ts:126](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-select.ts#L126)

___

### focus

▸ **focus**(): [`DSelect`](DSelect.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-select.ts:167](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-select.ts#L167)
...
▸ **hide**(): [`DSelect`](DSelect.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DSelect`](DSelect.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DSelect`](DSelect.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:169](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L169)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:154](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L154)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:161](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L161)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:91](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L91)
...
[src/main/typescript/wcardinal/ui/d-select.ts:98](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-select.ts#L98)

___

### onMenuSelect

▸ `Protected` **onMenuSelect**(`newValue`, `item`, `menu`): `void`
...
[src/main/typescript/wcardinal/ui/d-select.ts:88](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-select.ts#L88)
...
▸ `Protected` **onValueChange**(`newValue`, `oldValue`, `item`): `void`
...
[src/main/typescript/wcardinal/ui/d-select.ts:118](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-select.ts#L118)
...
▸ **once**(`event`, `fn`, `context?`): [`DSelect`](DSelect.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DSelect`](DSelect.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DSelect`](DSelect.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DSelect`](DSelect.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DSelect`](DSelect.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:176](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L176)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:104](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L104)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:112](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L112)
