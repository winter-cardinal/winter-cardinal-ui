[Winter Cardinal UI - v0.374.0](../index.md) / DButton
...
- [newPadding](DButton.md#newpadding)
- [newText](DButton.md#newtext)
- [off](DButton.md#off)
- [on](DButton.md#on)
...
• **new DButton**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DButton`](DButton.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DButton`](DButton.md)\<`VALUE`, `THEME`, `OPTIONS`\>
