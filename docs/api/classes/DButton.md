[Winter Cardinal UI - v0.155.0](../index.md) / DButton
...
- [\_isChildrenDirty](DButton.md#_ischildrendirty)
...
- [isChildrenDirty](DButton.md#ischildrendirty)
...
- [onChildrenDirty](DButton.md#onchildrendirty)
...
- [toChildrenDirty](DButton.md#tochildrendirty)
