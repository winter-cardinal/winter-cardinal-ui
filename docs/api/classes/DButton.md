[Winter Cardinal UI - v0.167.0](../index.md) / DButton

# Class: DButton<VALUE, THEME, OPTIONS\>
...
- [`DButtonBase`](DButtonBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DButtonAmbient`](DButtonAmbient.md)

  ↳↳ [`DButtonColorGradient`](DButtonColorGradient.md)

  ↳↳ [`DButtonColor`](DButtonColor.md)

  ↳↳ [`DButtonDanger`](DButtonDanger.md)

  ↳↳ [`DButtonDate`](DButtonDate.md)

  ↳↳ [`DButtonDatetime`](DButtonDatetime.md)

  ↳↳ [`DButtonFile`](DButtonFile.md)

  ↳↳ [`DButtonPrimary`](DButtonPrimary.md)

  ↳↳ [`DButtonRedo`](DButtonRedo.md)

  ↳↳ [`DButtonSecondary`](DButtonSecondary.md)

  ↳↳ [`DButtonSelect`](DButtonSelect.md)

  ↳↳ [`DButtonTime`](DButtonTime.md)

  ↳↳ [`DButtonUndo`](DButtonUndo.md)

  ↳↳ [`DInputBooleanButtonOff`](DInputBooleanButtonOff.md)

  ↳↳ [`DInputBooleanButtonOn`](DInputBooleanButtonOn.md)

  ↳↳ [`DMenuBarItem`](DMenuBarItem.md)

  ↳↳ [`DSliderThumb`](DSliderThumb.md)

  ↳↳ [`DSliderTrack`](DSliderTrack.md)

  ↳↳ [`DTableBodyCellSelectDialog`](DTableBodyCellSelectDialog.md)

  ↳↳ [`DTableBodyCellSelectPromise`](DTableBodyCellSelectPromise.md)

## Table of contents

### Constructors

- [constructor](DButton.md#constructor)

### Properties

- [\_accessibleActive](DButton.md#_accessibleactive)
- [\_accessibleDiv](DButton.md#_accessiblediv)
- [\_auto](DButton.md#_auto)
- [\_background](DButton.md#_background)
- [\_border](DButton.md#_border)
- [\_bounds](DButton.md#_bounds)
- [\_clearType](DButton.md#_cleartype)
- [\_corner](DButton.md#_corner)
- [\_cursor](DButton.md#_cursor)
- [\_destroyed](DButton.md#_destroyed)
- [\_images](DButton.md#_images)
- [\_isOverflowMaskEnabled](DButton.md#_isoverflowmaskenabled)
- [\_isTextVisible](DButton.md#_istextvisible)
- [\_isToggle](DButton.md#_istoggle)
- [\_lastDownPoint](DButton.md#_lastdownpoint)
- [\_lastSortedIndex](DButton.md#_lastsortedindex)
- [\_mask](DButton.md#_mask)
- [\_options](DButton.md#_options)
- [\_outline](DButton.md#_outline)
- [\_overflowMask](DButton.md#_overflowmask)
- [\_padding](DButton.md#_padding)
- [\_reflowable](DButton.md#_reflowable)
- [\_shortcuts](DButton.md#_shortcuts)
- [\_snippet](DButton.md#_snippet)
- [\_tempDisplayObjectParent](DButton.md#_tempdisplayobjectparent)
- [\_text](DButton.md#_text)
- [\_textAlign](DButton.md#_textalign)
- [\_textAlpha](DButton.md#_textalpha)
- [\_textColor](DButton.md#_textcolor)
- [\_textFormatter](DButton.md#_textformatter)
- [\_textStyle](DButton.md#_textstyle)
- [\_textValue](DButton.md#_textvalue)
- [\_textValueComputed](DButton.md#_textvaluecomputed)
- [\_title](DButton.md#_title)
- [\_when](DButton.md#_when)
- [\_zIndex](DButton.md#_zindex)
- [accessible](DButton.md#accessible)
- [accessibleChildren](DButton.md#accessiblechildren)
- [accessibleHint](DButton.md#accessiblehint)
- [accessiblePointerEvents](DButton.md#accessiblepointerevents)
- [accessibleTitle](DButton.md#accessibletitle)
- [accessibleType](DButton.md#accessibletype)
- [alpha](DButton.md#alpha)
- [angle](DButton.md#angle)
- [buttonMode](DButton.md#buttonmode)
- [cacheAsBitmap](DButton.md#cacheasbitmap)
- [children](DButton.md#children)
- [cursor](DButton.md#cursor)
- [filterArea](DButton.md#filterarea)
- [filters](DButton.md#filters)
- [hitArea](DButton.md#hitarea)
- [interactive](DButton.md#interactive)
- [interactiveChildren](DButton.md#interactivechildren)
- [isMask](DButton.md#ismask)
- [isSprite](DButton.md#issprite)
- [localTransform](DButton.md#localtransform)
- [mask](DButton.md#mask)
- [name](DButton.md#name)
- [parent](DButton.md#parent)
- [pivot](DButton.md#pivot)
- [renderable](DButton.md#renderable)
- [rotation](DButton.md#rotation)
- [sortDirty](DButton.md#sortdirty)
- [sortableChildren](DButton.md#sortablechildren)
- [transform](DButton.md#transform)
- [visible](DButton.md#visible)
- [worldAlpha](DButton.md#worldalpha)
- [worldTransform](DButton.md#worldtransform)
- [worldVisible](DButton.md#worldvisible)
- [zIndex](DButton.md#zindex)
- [LAYOUTER](DButton.md#layouter)
- [WORK\_CONTAINS\_POINT](DButton.md#work_contains_point)

### Accessors

- [background](DButton.md#background)
- [border](DButton.md#border)
- [corner](DButton.md#corner)
- [height](DButton.md#height)
- [image](DButton.md#image)
- [isToggle](DButton.md#istoggle)
- [outline](DButton.md#outline)
- [padding](DButton.md#padding)
- [position](DButton.md#position)
- [reflowable](DButton.md#reflowable)
- [scale](DButton.md#scale)
- [shadow](DButton.md#shadow)
- [skew](DButton.md#skew)
- [snippet](DButton.md#snippet)
- [state](DButton.md#state)
- [text](DButton.md#text)
- [theme](DButton.md#theme)
- [title](DButton.md#title)
- [type](DButton.md#type)
- [unsafe](DButton.md#unsafe)
- [weight](DButton.md#weight)
- [width](DButton.md#width)
- [x](DButton.md#x)
- [y](DButton.md#y)

### Methods

- [\_calculateBounds](DButton.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DButton.md#_recursivepostupdatetransform)
- [\_render](DButton.md#_render)
- [addChild](DButton.md#addchild)
- [addChildAt](DButton.md#addchildat)
- [addListener](DButton.md#addlistener)
- [applyTitle](DButton.md#applytitle)
- [blur](DButton.md#blur)
- [calculateBounds](DButton.md#calculatebounds)
- [computeTextValue](DButton.md#computetextvalue)
- [containsGlobalPoint](DButton.md#containsglobalpoint)
- [containsLocalPoint](DButton.md#containslocalpoint)
- [containsPoint](DButton.md#containspoint)
- [createOrUpdateText](DButton.md#createorupdatetext)
- [createText](DButton.md#createtext)
- [destroy](DButton.md#destroy)
- [displayObjectUpdateTransform](DButton.md#displayobjectupdatetransform)
- [emit](DButton.md#emit)
- [eventNames](DButton.md#eventnames)
- [focus](DButton.md#focus)
- [focusOnClosest](DButton.md#focusonclosest)
- [getBounds](DButton.md#getbounds)
- [getChildAt](DButton.md#getchildat)
- [getChildByName](DButton.md#getchildbyname)
- [getChildIndex](DButton.md#getchildindex)
- [getClearType](DButton.md#getcleartype)
- [getClippingRect](DButton.md#getclippingrect)
- [getGlobalPosition](DButton.md#getglobalposition)
- [getHeight](DButton.md#getheight)
- [getLocalBounds](DButton.md#getlocalbounds)
- [getOverflowMask](DButton.md#getoverflowmask)
- [getParentOfSize](DButton.md#getparentofsize)
- [getTextAlpha](DButton.md#gettextalpha)
- [getTextColor](DButton.md#gettextcolor)
- [getThemeDefault](DButton.md#getthemedefault)
- [getType](DButton.md#gettype)
- [getWidth](DButton.md#getwidth)
- [getX](DButton.md#getx)
- [getY](DButton.md#gety)
- [hasDirty](DButton.md#hasdirty)
- [hasRefitableHeight](DButton.md#hasrefitableheight)
- [hasRefitableWidth](DButton.md#hasrefitablewidth)
- [hide](DButton.md#hide)
- [hideText](DButton.md#hidetext)
- [init](DButton.md#init)
- [initOnClick](DButton.md#initonclick)
- [initOnPress](DButton.md#initonpress)
- [initReflowable](DButton.md#initreflowable)
- [isDirty](DButton.md#isdirty)
- [isEventTarget](DButton.md#iseventtarget)
- [isHidden](DButton.md#ishidden)
- [isHierarchyDirty](DButton.md#ishierarchydirty)
- [isRefitable](DButton.md#isrefitable)
- [isShown](DButton.md#isshown)
- [listenerCount](DButton.md#listenercount)
- [listeners](DButton.md#listeners)
- [newImage](DButton.md#newimage)
- [newImages](DButton.md#newimages)
- [off](DButton.md#off)
- [on](DButton.md#on)
- [onActivate](DButton.md#onactivate)
- [onActivateKeyDown](DButton.md#onactivatekeydown)
- [onActivateKeyUp](DButton.md#onactivatekeyup)
- [onBlur](DButton.md#onblur)
- [onChildBlur](DButton.md#onchildblur)
- [onChildFocus](DButton.md#onchildfocus)
- [onChildrenChange](DButton.md#onchildrenchange)
- [onClick](DButton.md#onclick)
- [onDblClick](DButton.md#ondblclick)
- [onDown](DButton.md#ondown)
- [onDownThis](DButton.md#ondownthis)
- [onFocus](DButton.md#onfocus)
- [onHierarchyDirty](DButton.md#onhierarchydirty)
- [onInactivate](DButton.md#oninactivate)
- [onKeyDown](DButton.md#onkeydown)
- [onKeyUp](DButton.md#onkeyup)
- [onMove](DButton.md#onmove)
- [onOut](DButton.md#onout)
- [onOver](DButton.md#onover)
- [onParentMove](DButton.md#onparentmove)
- [onParentResize](DButton.md#onparentresize)
- [onRefit](DButton.md#onrefit)
- [onReflow](DButton.md#onreflow)
- [onResize](DButton.md#onresize)
- [onScale](DButton.md#onscale)
- [onShortcut](DButton.md#onshortcut)
- [onSkew](DButton.md#onskew)
- [onStateChange](DButton.md#onstatechange)
- [onTextChange](DButton.md#ontextchange)
- [onToggleEnd](DButton.md#ontoggleend)
- [onToggleStart](DButton.md#ontogglestart)
- [onUp](DButton.md#onup)
- [onUpThis](DButton.md#onupthis)
- [onWheel](DButton.md#onwheel)
- [once](DButton.md#once)
- [reflow](DButton.md#reflow)
- [removeAllListeners](DButton.md#removealllisteners)
- [removeChild](DButton.md#removechild)
- [removeChildAt](DButton.md#removechildat)
- [removeChildren](DButton.md#removechildren)
- [removeListener](DButton.md#removelistener)
- [render](DButton.md#render)
- [renderAdvanced](DButton.md#renderadvanced)
- [resize](DButton.md#resize)
- [setChildIndex](DButton.md#setchildindex)
- [setFocused](DButton.md#setfocused)
- [setHeight](DButton.md#setheight)
- [setParent](DButton.md#setparent)
- [setTransform](DButton.md#settransform)
- [setWidth](DButton.md#setwidth)
- [setX](DButton.md#setx)
- [setY](DButton.md#sety)
- [show](DButton.md#show)
- [showText](DButton.md#showtext)
- [sortChildren](DButton.md#sortchildren)
- [swapChildren](DButton.md#swapchildren)
- [toCursor](DButton.md#tocursor)
- [toDirty](DButton.md#todirty)
- [toGlobal](DButton.md#toglobal)
- [toHasDirty](DButton.md#tohasdirty)
- [toHierarchyDirty](DButton.md#tohierarchydirty)
- [toImageOptions](DButton.md#toimageoptions)
- [toLocal](DButton.md#tolocal)
- [toParentHasDirty](DButton.md#toparenthasdirty)
- [toParentHierarchyDirty](DButton.md#toparenthierarchydirty)
- [toParentResized](DButton.md#toparentresized)
- [toggle](DButton.md#toggle)
- [updateText](DButton.md#updatetext)
- [updateTextAndImage](DButton.md#updatetextandimage)
- [updateTextColor](DButton.md#updatetextcolor)
- [updateTextPosition](DButton.md#updatetextposition)
- [updateTextValue](DButton.md#updatetextvalue)
- [updateTransform](DButton.md#updatetransform)
- [mixin](DButton.md#mixin)

## Constructors

### constructor

• **new DButton**<`VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DButton`](DButton.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DButton`](DButton.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DButton`](DButton.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **hide**(): [`DButton`](DButton.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DButton`](DButton.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DButton`](DButton.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DButton`](DButton.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DButton`](DButton.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DButton`](DButton.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DButton`](DButton.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DButton`](DButton.md)<`VALUE`, `THEME`, `OPTIONS`\>
