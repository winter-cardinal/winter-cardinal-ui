[Winter Cardinal UI - v0.414.0](../index.md) / EShapeActionRuntimeMiscExecute

# Class: EShapeActionRuntimeMiscExecute
...
- [`EShapeActionRuntimeConditional`](EShapeActionRuntimeConditional.md)
  ...
  ↳ **`EShapeActionRuntimeMiscExecute`**

## Table of contents

### Constructors

- [constructor](EShapeActionRuntimeMiscExecute.md#constructor)

### Properties

- [condition](EShapeActionRuntimeMiscExecute.md#condition)
- [reset](EShapeActionRuntimeMiscExecute.md#reset)
- [target](EShapeActionRuntimeMiscExecute.md#target)

### Methods

- [execute](EShapeActionRuntimeMiscExecute.md#execute)
- [initialize](EShapeActionRuntimeMiscExecute.md#initialize)
- [onBlur](EShapeActionRuntimeMiscExecute.md#onblur)
- [onClick](EShapeActionRuntimeMiscExecute.md#onclick)
- [onDblClick](EShapeActionRuntimeMiscExecute.md#ondblclick)
- [onDown](EShapeActionRuntimeMiscExecute.md#ondown)
- [onDowning](EShapeActionRuntimeMiscExecute.md#ondowning)
- [onFocus](EShapeActionRuntimeMiscExecute.md#onfocus)
- [onKeyDown](EShapeActionRuntimeMiscExecute.md#onkeydown)
- [onKeyUp](EShapeActionRuntimeMiscExecute.md#onkeyup)
- [onMove](EShapeActionRuntimeMiscExecute.md#onmove)
- [onOut](EShapeActionRuntimeMiscExecute.md#onout)
- [onOver](EShapeActionRuntimeMiscExecute.md#onover)
- [onPressed](EShapeActionRuntimeMiscExecute.md#onpressed)
- [onRender](EShapeActionRuntimeMiscExecute.md#onrender)
- [onResize](EShapeActionRuntimeMiscExecute.md#onresize)
- [onRightClick](EShapeActionRuntimeMiscExecute.md#onrightclick)
- [onRightDown](EShapeActionRuntimeMiscExecute.md#onrightdown)
- [onRightDowning](EShapeActionRuntimeMiscExecute.md#onrightdowning)
- [onRightPressed](EShapeActionRuntimeMiscExecute.md#onrightpressed)
- [onRightUnpressed](EShapeActionRuntimeMiscExecute.md#onrightunpressed)
- [onRightUp](EShapeActionRuntimeMiscExecute.md#onrightup)
- [onRightUpOutside](EShapeActionRuntimeMiscExecute.md#onrightupoutside)
- [onUnpressed](EShapeActionRuntimeMiscExecute.md#onunpressed)
- [onUp](EShapeActionRuntimeMiscExecute.md#onup)
- [onUpOutside](EShapeActionRuntimeMiscExecute.md#onupoutside)

## Constructors

### constructor

• **new EShapeActionRuntimeMiscExecute**(`value`): [`EShapeActionRuntimeMiscExecute`](EShapeActionRuntimeMiscExecute.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `value` | [`EShapeActionValueMiscExecute`](EShapeActionValueMiscExecute.md) |
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-misc-execute.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-misc-execute.ts#L18)
...
• `Protected` **target**: [`EShapeActionExpression`](../index.md#eshapeactionexpression)\<`unknown`\>

#### Defined in

[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-misc-execute.ts:16](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-misc-execute.ts#L16)
...
[src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-misc-execute.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/shape/action/e-shape-action-runtime-misc-execute.ts#L23)
