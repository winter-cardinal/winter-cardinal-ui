[Winter Cardinal UI - v0.155.0](../index.md) / DDialogConfirm
...
- [\_isChildrenDirty](DDialogConfirm.md#_ischildrendirty)
...
- [isChildrenDirty](DDialogConfirm.md#ischildrendirty)
...
- [onChildrenDirty](DDialogConfirm.md#onchildrendirty)
...
- [toChildrenDirty](DDialogConfirm.md#tochildrendirty)
...
- [toParentChildrenDirty](DDialogConfirm.md#toparentchildrendirty)
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm.ts:88](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-dialog-confirm.ts#L88)
