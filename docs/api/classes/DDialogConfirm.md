[Winter Cardinal UI - v0.407.0](../index.md) / DDialogConfirm
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm.ts:89](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-confirm.ts#L89)
...
▸ **setFocused**(`isFocused`): [`DDialogConfirm`](DDialogConfirm.md)\<`THEME`, `OPTIONS`\>
