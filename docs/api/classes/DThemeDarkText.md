[Winter Cardinal UI - v0.407.0](../index.md) / DThemeDarkText
...
- [getTextStyleFitting](DThemeDarkText.md#gettextstylefitting)
...
• **new DThemeDarkText**\<`VALUE`\>(): [`DThemeDarkText`](DThemeDarkText.md)\<`VALUE`\>
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-text.ts:15](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-text.ts#L15)
