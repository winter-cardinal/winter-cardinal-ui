[Winter Cardinal UI - v0.154.0](../index.md) / DThemeWhiteButtonAmbient
...
- [`DThemeWhiteButtonBase`](DThemeWhiteButtonBase.md)<`VALUE`\>
  ...
  ↳↳ [`DThemeWhitePaginationNavigationButton`](DThemeWhitePaginationNavigationButton.md)

  ↳↳ [`DThemeWhitePaginationDotsButton`](DThemeWhitePaginationDotsButton.md)
