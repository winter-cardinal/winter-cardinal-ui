[Winter Cardinal UI - v0.414.0](../index.md) / DMenuSidedItemCheck
...
- [\_boundsID](DMenuSidedItemCheck.md#_boundsid)
- [\_boundsRect](DMenuSidedItemCheck.md#_boundsrect)
...
- [\_enabledFilters](DMenuSidedItemCheck.md#_enabledfilters)
- [\_image](DMenuSidedItemCheck.md#_image)
- [\_lastDownPoint](DMenuSidedItemCheck.md#_lastdownpoint)
- [\_lastSortedIndex](DMenuSidedItemCheck.md#_lastsortedindex)
- [\_localBounds](DMenuSidedItemCheck.md#_localbounds)
- [\_localBoundsRect](DMenuSidedItemCheck.md#_localboundsrect)
...
- [containerUpdateTransform](DMenuSidedItemCheck.md#containerupdatetransform)
...
- [disableTempParent](DMenuSidedItemCheck.md#disabletempparent)
- [displayObjectUpdateTransform](DMenuSidedItemCheck.md#displayobjectupdatetransform)
- [emit](DMenuSidedItemCheck.md#emit)
- [enableTempParent](DMenuSidedItemCheck.md#enabletempparent)
...
- [getImage](DMenuSidedItemCheck.md#getimage)
- [getLayouter](DMenuSidedItemCheck.md#getlayouter)
...
- [getText](DMenuSidedItemCheck.md#gettext)
...
- [newOverflowMask](DMenuSidedItemCheck.md#newoverflowmask)
- [newPadding](DMenuSidedItemCheck.md#newpadding)
- [newShortcutText](DMenuSidedItemCheck.md#newshortcuttext)
- [newText](DMenuSidedItemCheck.md#newtext)
...
- [onReflowTextAndImage](DMenuSidedItemCheck.md#onreflowtextandimage)
...
- [updateShortcutColor](DMenuSidedItemCheck.md#updateshortcutcolor)
...
• **new DMenuSidedItemCheck**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DMenuSidedItemCheck`](DMenuSidedItemCheck.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-menu-sided-item-check.ts:13](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-menu-sided-item-check.ts#L13)
