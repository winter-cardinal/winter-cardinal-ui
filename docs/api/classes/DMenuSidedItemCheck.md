[Winter Cardinal UI - v0.407.0](../index.md) / DMenuSidedItemCheck
...
[src/main/typescript/wcardinal/ui/d-menu-sided-item-check.ts:13](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-sided-item-check.ts#L13)
...
▸ **setFocused**(`isFocused`): [`DMenuSidedItemCheck`](DMenuSidedItemCheck.md)\<`VALUE`, `THEME`, `OPTIONS`\>
