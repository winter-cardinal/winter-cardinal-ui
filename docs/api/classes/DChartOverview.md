[Winter Cardinal UI - v0.160.0](../index.md) / DChartOverview

# Class: DChartOverview<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeChartOverview`](../interfaces/DThemeChartOverview.md) = [`DThemeChartOverview`](../interfaces/DThemeChartOverview.md) |
| `OPTIONS` | extends [`DChartOverviewOptions`](../interfaces/DChartOverviewOptions.md)<`THEME`\> = [`DChartOverviewOptions`](../interfaces/DChartOverviewOptions.md)<`THEME`\> |
...
- [constructor](DChartOverview.md#constructor)

### Properties

- [\_accessibleActive](DChartOverview.md#_accessibleactive)
- [\_accessibleDiv](DChartOverview.md#_accessiblediv)
- [\_auto](DChartOverview.md#_auto)
- [\_background](DChartOverview.md#_background)
- [\_border](DChartOverview.md#_border)
- [\_bounds](DChartOverview.md#_bounds)
- [\_clearType](DChartOverview.md#_cleartype)
- [\_corner](DChartOverview.md#_corner)
- [\_cursor](DChartOverview.md#_cursor)
- [\_destroyed](DChartOverview.md#_destroyed)
- [\_lastDownPoint](DChartOverview.md#_lastdownpoint)
- [\_lastSortedIndex](DChartOverview.md#_lastsortedindex)
- [\_mask](DChartOverview.md#_mask)
- [\_options](DChartOverview.md#_options)
- [\_outline](DChartOverview.md#_outline)
- [\_padding](DChartOverview.md#_padding)
- [\_reflowable](DChartOverview.md#_reflowable)
- [\_shortcuts](DChartOverview.md#_shortcuts)
- [\_snippet](DChartOverview.md#_snippet)
- [\_tempDisplayObjectParent](DChartOverview.md#_tempdisplayobjectparent)
- [\_title](DChartOverview.md#_title)
- [\_zIndex](DChartOverview.md#_zindex)
- [accessible](DChartOverview.md#accessible)
- [accessibleChildren](DChartOverview.md#accessiblechildren)
- [accessibleHint](DChartOverview.md#accessiblehint)
- [accessiblePointerEvents](DChartOverview.md#accessiblepointerevents)
- [accessibleTitle](DChartOverview.md#accessibletitle)
- [accessibleType](DChartOverview.md#accessibletype)
- [alpha](DChartOverview.md#alpha)
- [angle](DChartOverview.md#angle)
- [buttonMode](DChartOverview.md#buttonmode)
- [cacheAsBitmap](DChartOverview.md#cacheasbitmap)
- [children](DChartOverview.md#children)
- [cursor](DChartOverview.md#cursor)
- [filterArea](DChartOverview.md#filterarea)
- [filters](DChartOverview.md#filters)
- [hitArea](DChartOverview.md#hitarea)
- [interactive](DChartOverview.md#interactive)
- [interactiveChildren](DChartOverview.md#interactivechildren)
- [isMask](DChartOverview.md#ismask)
- [isSprite](DChartOverview.md#issprite)
- [localTransform](DChartOverview.md#localtransform)
- [mask](DChartOverview.md#mask)
- [name](DChartOverview.md#name)
- [parent](DChartOverview.md#parent)
- [pivot](DChartOverview.md#pivot)
- [renderable](DChartOverview.md#renderable)
- [rotation](DChartOverview.md#rotation)
- [sortDirty](DChartOverview.md#sortdirty)
- [sortableChildren](DChartOverview.md#sortablechildren)
- [transform](DChartOverview.md#transform)
- [visible](DChartOverview.md#visible)
- [worldAlpha](DChartOverview.md#worldalpha)
- [worldTransform](DChartOverview.md#worldtransform)
- [worldVisible](DChartOverview.md#worldvisible)
- [zIndex](DChartOverview.md#zindex)
- [WORK\_CONTAINS\_POINT](DChartOverview.md#work_contains_point)

### Accessors

- [background](DChartOverview.md#background)
- [border](DChartOverview.md#border)
- [corner](DChartOverview.md#corner)
- [height](DChartOverview.md#height)
- [outline](DChartOverview.md#outline)
- [padding](DChartOverview.md#padding)
- [position](DChartOverview.md#position)
- [reflowable](DChartOverview.md#reflowable)
- [scale](DChartOverview.md#scale)
- [shadow](DChartOverview.md#shadow)
- [skew](DChartOverview.md#skew)
- [snippet](DChartOverview.md#snippet)
- [state](DChartOverview.md#state)
- [theme](DChartOverview.md#theme)
- [title](DChartOverview.md#title)
- [type](DChartOverview.md#type)
- [unsafe](DChartOverview.md#unsafe)
- [weight](DChartOverview.md#weight)
- [width](DChartOverview.md#width)
- [x](DChartOverview.md#x)
- [y](DChartOverview.md#y)

### Methods

- [\_calculateBounds](DChartOverview.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DChartOverview.md#_recursivepostupdatetransform)
- [\_render](DChartOverview.md#_render)
- [addChild](DChartOverview.md#addchild)
- [addChildAt](DChartOverview.md#addchildat)
- [addListener](DChartOverview.md#addlistener)
- [applyTitle](DChartOverview.md#applytitle)
- [blur](DChartOverview.md#blur)
- [calculateBounds](DChartOverview.md#calculatebounds)
- [containsGlobalPoint](DChartOverview.md#containsglobalpoint)
- [containsLocalPoint](DChartOverview.md#containslocalpoint)
- [containsPoint](DChartOverview.md#containspoint)
- [destroy](DChartOverview.md#destroy)
- [displayObjectUpdateTransform](DChartOverview.md#displayobjectupdatetransform)
- [emit](DChartOverview.md#emit)
- [eventNames](DChartOverview.md#eventnames)
- [focus](DChartOverview.md#focus)
- [focusOnClosest](DChartOverview.md#focusonclosest)
- [getBounds](DChartOverview.md#getbounds)
- [getChildAt](DChartOverview.md#getchildat)
- [getChildByName](DChartOverview.md#getchildbyname)
- [getChildIndex](DChartOverview.md#getchildindex)
- [getClearType](DChartOverview.md#getcleartype)
- [getClippingRect](DChartOverview.md#getclippingrect)
- [getGlobalPosition](DChartOverview.md#getglobalposition)
- [getHeight](DChartOverview.md#getheight)
- [getLocalBounds](DChartOverview.md#getlocalbounds)
- [getParentOfSize](DChartOverview.md#getparentofsize)
- [getThemeDefault](DChartOverview.md#getthemedefault)
- [getType](DChartOverview.md#gettype)
- [getWidth](DChartOverview.md#getwidth)
- [getX](DChartOverview.md#getx)
- [getY](DChartOverview.md#gety)
- [hasDirty](DChartOverview.md#hasdirty)
- [hasRefitableHeight](DChartOverview.md#hasrefitableheight)
- [hasRefitableWidth](DChartOverview.md#hasrefitablewidth)
- [hide](DChartOverview.md#hide)
- [init](DChartOverview.md#init)
- [initReflowable](DChartOverview.md#initreflowable)
- [isDirty](DChartOverview.md#isdirty)
- [isEventTarget](DChartOverview.md#iseventtarget)
- [isHidden](DChartOverview.md#ishidden)
- [isHierarchyDirty](DChartOverview.md#ishierarchydirty)
- [isRefitable](DChartOverview.md#isrefitable)
- [isShown](DChartOverview.md#isshown)
- [listenerCount](DChartOverview.md#listenercount)
- [listeners](DChartOverview.md#listeners)
- [off](DChartOverview.md#off)
- [on](DChartOverview.md#on)
- [onBlur](DChartOverview.md#onblur)
- [onChildBlur](DChartOverview.md#onchildblur)
- [onChildFocus](DChartOverview.md#onchildfocus)
- [onChildrenChange](DChartOverview.md#onchildrenchange)
- [onDblClick](DChartOverview.md#ondblclick)
- [onDown](DChartOverview.md#ondown)
- [onDownThis](DChartOverview.md#ondownthis)
- [onFocus](DChartOverview.md#onfocus)
- [onHierarchyDirty](DChartOverview.md#onhierarchydirty)
- [onKeyDown](DChartOverview.md#onkeydown)
- [onKeyUp](DChartOverview.md#onkeyup)
- [onMove](DChartOverview.md#onmove)
- [onOut](DChartOverview.md#onout)
- [onOver](DChartOverview.md#onover)
- [onParentMove](DChartOverview.md#onparentmove)
- [onParentResize](DChartOverview.md#onparentresize)
- [onRefit](DChartOverview.md#onrefit)
- [onReflow](DChartOverview.md#onreflow)
- [onResize](DChartOverview.md#onresize)
- [onScale](DChartOverview.md#onscale)
- [onShortcut](DChartOverview.md#onshortcut)
- [onSkew](DChartOverview.md#onskew)
- [onStateChange](DChartOverview.md#onstatechange)
- [onUp](DChartOverview.md#onup)
- [onUpThis](DChartOverview.md#onupthis)
- [onWheel](DChartOverview.md#onwheel)
- [once](DChartOverview.md#once)
- [reflow](DChartOverview.md#reflow)
- [removeAllListeners](DChartOverview.md#removealllisteners)
- [removeChild](DChartOverview.md#removechild)
- [removeChildAt](DChartOverview.md#removechildat)
- [removeChildren](DChartOverview.md#removechildren)
- [removeListener](DChartOverview.md#removelistener)
- [render](DChartOverview.md#render)
- [renderAdvanced](DChartOverview.md#renderadvanced)
- [resize](DChartOverview.md#resize)
- [setChildIndex](DChartOverview.md#setchildindex)
- [setFocused](DChartOverview.md#setfocused)
- [setHeight](DChartOverview.md#setheight)
- [setParent](DChartOverview.md#setparent)
- [setTransform](DChartOverview.md#settransform)
- [setWidth](DChartOverview.md#setwidth)
- [setX](DChartOverview.md#setx)
- [setY](DChartOverview.md#sety)
- [show](DChartOverview.md#show)
- [sortChildren](DChartOverview.md#sortchildren)
- [swapChildren](DChartOverview.md#swapchildren)
- [toCursor](DChartOverview.md#tocursor)
- [toDirty](DChartOverview.md#todirty)
- [toGlobal](DChartOverview.md#toglobal)
- [toHasDirty](DChartOverview.md#tohasdirty)
- [toHierarchyDirty](DChartOverview.md#tohierarchydirty)
- [toLocal](DChartOverview.md#tolocal)
- [toParentHasDirty](DChartOverview.md#toparenthasdirty)
- [toParentHierarchyDirty](DChartOverview.md#toparenthierarchydirty)
- [toParentResized](DChartOverview.md#toparentresized)
- [updateTransform](DChartOverview.md#updatetransform)
- [mixin](DChartOverview.md#mixin)

## Constructors

### constructor

• **new DChartOverview**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemeChartOverview`](../interfaces/DThemeChartOverview.md) = [`DThemeChartOverview`](../interfaces/DThemeChartOverview.md) |
| `OPTIONS` | extends [`DChartOverviewOptions`](../interfaces/DChartOverviewOptions.md)<`THEME`, `OPTIONS`\> = [`DChartOverviewOptions`](../interfaces/DChartOverviewOptions.md)<`THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DChartOverview`](DChartOverview.md)<`THEME`, `OPTIONS`\>
...
[`DChartOverview`](DChartOverview.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DChartOverview`](DChartOverview.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DChartOverview`](DChartOverview.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-chart-overview.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-chart-overview.ts#L17)
...
▸ **hide**(): [`DChartOverview`](DChartOverview.md)<`THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DChartOverview`](DChartOverview.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DChartOverview`](DChartOverview.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DChartOverview`](DChartOverview.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DChartOverview`](DChartOverview.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DChartOverview`](DChartOverview.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DChartOverview`](DChartOverview.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DChartOverview`](DChartOverview.md)<`THEME`, `OPTIONS`\>
