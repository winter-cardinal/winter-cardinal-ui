[Winter Cardinal UI - v0.407.0](../index.md) / DChartOverview
...
- [\_boundsID](DChartOverview.md#_boundsid)
- [\_boundsRect](DChartOverview.md#_boundsrect)
...
- [\_enabledFilters](DChartOverview.md#_enabledfilters)
- [\_lastDownPoint](DChartOverview.md#_lastdownpoint)
- [\_lastSortedIndex](DChartOverview.md#_lastsortedindex)
- [\_localBounds](DChartOverview.md#_localbounds)
- [\_localBoundsRect](DChartOverview.md#_localboundsrect)
...
- [options](DChartOverview.md#options)
...
- [containerUpdateTransform](DChartOverview.md#containerupdatetransform)
...
- [disableTempParent](DChartOverview.md#disabletempparent)
- [displayObjectUpdateTransform](DChartOverview.md#displayobjectupdatetransform)
- [emit](DChartOverview.md#emit)
- [enableTempParent](DChartOverview.md#enabletempparent)
...
- [newPadding](DChartOverview.md#newpadding)
...
• **new DChartOverview**\<`THEME`, `OPTIONS`\>(`options?`): [`DChartOverview`](DChartOverview.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-chart-overview.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-chart-overview.ts#L17)
...
▸ **setFocused**(`isFocused`): [`DChartOverview`](DChartOverview.md)\<`THEME`, `OPTIONS`\>
