[Winter Cardinal UI - v0.160.0](../index.md) / DScrollBar

# Class: DScrollBar<THEME, OPTIONS\>
...
- [`DBase`](DBase.md)<`THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DScrollBarHorizontal`](DScrollBarHorizontal.md)

  ↳↳ [`DScrollBarVertical`](DScrollBarVertical.md)

## Table of contents

### Constructors

- [constructor](DScrollBar.md#constructor)

### Properties

- [\_accessibleActive](DScrollBar.md#_accessibleactive)
- [\_accessibleDiv](DScrollBar.md#_accessiblediv)
- [\_auto](DScrollBar.md#_auto)
- [\_background](DScrollBar.md#_background)
- [\_border](DScrollBar.md#_border)
- [\_bounds](DScrollBar.md#_bounds)
- [\_clearType](DScrollBar.md#_cleartype)
- [\_corner](DScrollBar.md#_corner)
- [\_cursor](DScrollBar.md#_cursor)
- [\_destroyed](DScrollBar.md#_destroyed)
- [\_end](DScrollBar.md#_end)
- [\_fadeOutDelay](DScrollBar.md#_fadeoutdelay)
- [\_fadeOutTimeoutId](DScrollBar.md#_fadeouttimeoutid)
- [\_isSilent](DScrollBar.md#_issilent)
- [\_isTouched](DScrollBar.md#_istouched)
- [\_lastDownPoint](DScrollBar.md#_lastdownpoint)
- [\_lastSortedIndex](DScrollBar.md#_lastsortedindex)
- [\_mask](DScrollBar.md#_mask)
- [\_onFadeOutTimeoutBound](DScrollBar.md#_onfadeouttimeoutbound)
- [\_options](DScrollBar.md#_options)
- [\_outline](DScrollBar.md#_outline)
- [\_padding](DScrollBar.md#_padding)
- [\_reflowable](DScrollBar.md#_reflowable)
- [\_shortcuts](DScrollBar.md#_shortcuts)
- [\_snippet](DScrollBar.md#_snippet)
- [\_start](DScrollBar.md#_start)
- [\_tempDisplayObjectParent](DScrollBar.md#_tempdisplayobjectparent)
- [\_thumb](DScrollBar.md#_thumb)
- [\_title](DScrollBar.md#_title)
- [\_touchedAt](DScrollBar.md#_touchedat)
- [\_zIndex](DScrollBar.md#_zindex)
- [accessible](DScrollBar.md#accessible)
- [accessibleChildren](DScrollBar.md#accessiblechildren)
- [accessibleHint](DScrollBar.md#accessiblehint)
- [accessiblePointerEvents](DScrollBar.md#accessiblepointerevents)
- [accessibleTitle](DScrollBar.md#accessibletitle)
- [accessibleType](DScrollBar.md#accessibletype)
- [alpha](DScrollBar.md#alpha)
- [angle](DScrollBar.md#angle)
- [buttonMode](DScrollBar.md#buttonmode)
- [cacheAsBitmap](DScrollBar.md#cacheasbitmap)
- [children](DScrollBar.md#children)
- [cursor](DScrollBar.md#cursor)
- [filterArea](DScrollBar.md#filterarea)
- [filters](DScrollBar.md#filters)
- [hitArea](DScrollBar.md#hitarea)
- [interactive](DScrollBar.md#interactive)
- [interactiveChildren](DScrollBar.md#interactivechildren)
- [isMask](DScrollBar.md#ismask)
- [isSprite](DScrollBar.md#issprite)
- [localTransform](DScrollBar.md#localtransform)
- [mask](DScrollBar.md#mask)
- [name](DScrollBar.md#name)
- [parent](DScrollBar.md#parent)
- [pivot](DScrollBar.md#pivot)
- [renderable](DScrollBar.md#renderable)
- [rotation](DScrollBar.md#rotation)
- [sortDirty](DScrollBar.md#sortdirty)
- [sortableChildren](DScrollBar.md#sortablechildren)
- [transform](DScrollBar.md#transform)
- [visible](DScrollBar.md#visible)
- [worldAlpha](DScrollBar.md#worldalpha)
- [worldTransform](DScrollBar.md#worldtransform)
- [worldVisible](DScrollBar.md#worldvisible)
- [zIndex](DScrollBar.md#zindex)
- [WORK\_CONTAINS\_POINT](DScrollBar.md#work_contains_point)

### Accessors

- [background](DScrollBar.md#background)
- [border](DScrollBar.md#border)
- [corner](DScrollBar.md#corner)
- [end](DScrollBar.md#end)
- [height](DScrollBar.md#height)
- [outline](DScrollBar.md#outline)
- [padding](DScrollBar.md#padding)
- [position](DScrollBar.md#position)
- [reflowable](DScrollBar.md#reflowable)
- [scale](DScrollBar.md#scale)
- [shadow](DScrollBar.md#shadow)
- [skew](DScrollBar.md#skew)
- [snippet](DScrollBar.md#snippet)
- [start](DScrollBar.md#start)
- [state](DScrollBar.md#state)
- [theme](DScrollBar.md#theme)
- [thumb](DScrollBar.md#thumb)
- [title](DScrollBar.md#title)
- [type](DScrollBar.md#type)
- [unsafe](DScrollBar.md#unsafe)
- [weight](DScrollBar.md#weight)
- [width](DScrollBar.md#width)
- [x](DScrollBar.md#x)
- [y](DScrollBar.md#y)

### Methods

- [\_calculateBounds](DScrollBar.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DScrollBar.md#_recursivepostupdatetransform)
- [\_render](DScrollBar.md#_render)
- [addChild](DScrollBar.md#addchild)
- [addChildAt](DScrollBar.md#addchildat)
- [addListener](DScrollBar.md#addlistener)
- [applyTitle](DScrollBar.md#applytitle)
- [blur](DScrollBar.md#blur)
- [calculateBounds](DScrollBar.md#calculatebounds)
- [containsGlobalPoint](DScrollBar.md#containsglobalpoint)
- [containsLocalPoint](DScrollBar.md#containslocalpoint)
- [containsPoint](DScrollBar.md#containspoint)
- [destroy](DScrollBar.md#destroy)
- [displayObjectUpdateTransform](DScrollBar.md#displayobjectupdatetransform)
- [emit](DScrollBar.md#emit)
- [eventNames](DScrollBar.md#eventnames)
- [focus](DScrollBar.md#focus)
- [focusOnClosest](DScrollBar.md#focusonclosest)
- [getBounds](DScrollBar.md#getbounds)
- [getChildAt](DScrollBar.md#getchildat)
- [getChildByName](DScrollBar.md#getchildbyname)
- [getChildIndex](DScrollBar.md#getchildindex)
- [getClearType](DScrollBar.md#getcleartype)
- [getClippingRect](DScrollBar.md#getclippingrect)
- [getGlobalPosition](DScrollBar.md#getglobalposition)
- [getHeight](DScrollBar.md#getheight)
- [getLocalBounds](DScrollBar.md#getlocalbounds)
- [getParentOfSize](DScrollBar.md#getparentofsize)
- [getThemeDefault](DScrollBar.md#getthemedefault)
- [getType](DScrollBar.md#gettype)
- [getWidth](DScrollBar.md#getwidth)
- [getX](DScrollBar.md#getx)
- [getY](DScrollBar.md#gety)
- [hasDirty](DScrollBar.md#hasdirty)
- [hasRefitableHeight](DScrollBar.md#hasrefitableheight)
- [hasRefitableWidth](DScrollBar.md#hasrefitablewidth)
- [hide](DScrollBar.md#hide)
- [init](DScrollBar.md#init)
- [initReflowable](DScrollBar.md#initreflowable)
- [isDirty](DScrollBar.md#isdirty)
- [isEventTarget](DScrollBar.md#iseventtarget)
- [isHidden](DScrollBar.md#ishidden)
- [isHierarchyDirty](DScrollBar.md#ishierarchydirty)
- [isRefitable](DScrollBar.md#isrefitable)
- [isRegionVisible](DScrollBar.md#isregionvisible)
- [isShown](DScrollBar.md#isshown)
- [listenerCount](DScrollBar.md#listenercount)
- [listeners](DScrollBar.md#listeners)
- [newThumb](DScrollBar.md#newthumb)
- [off](DScrollBar.md#off)
- [on](DScrollBar.md#on)
- [onBlur](DScrollBar.md#onblur)
- [onChange](DScrollBar.md#onchange)
- [onChildBlur](DScrollBar.md#onchildblur)
- [onChildFocus](DScrollBar.md#onchildfocus)
- [onChildrenChange](DScrollBar.md#onchildrenchange)
- [onDblClick](DScrollBar.md#ondblclick)
- [onDown](DScrollBar.md#ondown)
- [onDownThis](DScrollBar.md#ondownthis)
- [onFadeOutTimeout](DScrollBar.md#onfadeouttimeout)
- [onFocus](DScrollBar.md#onfocus)
- [onHierarchyDirty](DScrollBar.md#onhierarchydirty)
- [onKeyDown](DScrollBar.md#onkeydown)
- [onKeyUp](DScrollBar.md#onkeyup)
- [onMove](DScrollBar.md#onmove)
- [onOut](DScrollBar.md#onout)
- [onOver](DScrollBar.md#onover)
- [onParentMove](DScrollBar.md#onparentmove)
- [onParentResize](DScrollBar.md#onparentresize)
- [onRefit](DScrollBar.md#onrefit)
- [onReflow](DScrollBar.md#onreflow)
- [onResize](DScrollBar.md#onresize)
- [onScale](DScrollBar.md#onscale)
- [onShortcut](DScrollBar.md#onshortcut)
- [onSkew](DScrollBar.md#onskew)
- [onStateChange](DScrollBar.md#onstatechange)
- [onThumbStateChange](DScrollBar.md#onthumbstatechange)
- [onUp](DScrollBar.md#onup)
- [onUpThis](DScrollBar.md#onupthis)
- [onWheel](DScrollBar.md#onwheel)
- [once](DScrollBar.md#once)
- [reflow](DScrollBar.md#reflow)
- [removeAllListeners](DScrollBar.md#removealllisteners)
- [removeChild](DScrollBar.md#removechild)
- [removeChildAt](DScrollBar.md#removechildat)
- [removeChildren](DScrollBar.md#removechildren)
- [removeListener](DScrollBar.md#removelistener)
- [render](DScrollBar.md#render)
- [renderAdvanced](DScrollBar.md#renderadvanced)
- [resize](DScrollBar.md#resize)
- [set](DScrollBar.md#set)
- [setChildIndex](DScrollBar.md#setchildindex)
- [setFocused](DScrollBar.md#setfocused)
- [setHeight](DScrollBar.md#setheight)
- [setParent](DScrollBar.md#setparent)
- [setTransform](DScrollBar.md#settransform)
- [setWidth](DScrollBar.md#setwidth)
- [setX](DScrollBar.md#setx)
- [setY](DScrollBar.md#sety)
- [show](DScrollBar.md#show)
- [sortChildren](DScrollBar.md#sortchildren)
- [swapChildren](DScrollBar.md#swapchildren)
- [toCursor](DScrollBar.md#tocursor)
- [toDirty](DScrollBar.md#todirty)
- [toGlobal](DScrollBar.md#toglobal)
- [toHasDirty](DScrollBar.md#tohasdirty)
- [toHierarchyDirty](DScrollBar.md#tohierarchydirty)
- [toLocal](DScrollBar.md#tolocal)
- [toParentHasDirty](DScrollBar.md#toparenthasdirty)
- [toParentHierarchyDirty](DScrollBar.md#toparenthierarchydirty)
- [toParentResized](DScrollBar.md#toparentresized)
- [updateThumb](DScrollBar.md#updatethumb)
- [updateTransform](DScrollBar.md#updatetransform)
- [mixin](DScrollBar.md#mixin)

## Constructors

### constructor

• **new DScrollBar**<`THEME`, `OPTIONS`\>(`options?`)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:39](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L39)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:30](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L30)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:35](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L35)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:34](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L34)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:37](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L37)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:33](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L33)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:36](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L36)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:29](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L29)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:31](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L31)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:32](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L32)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:69](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L69)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:65](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L65)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:61](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L61)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DScrollBar`](DScrollBar.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DScrollBar`](DScrollBar.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DScrollBar`](DScrollBar.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:191](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L191)
...
▸ **hide**(): [`DScrollBar`](DScrollBar.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:100](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L100)
...
▸ `Protected` `Abstract` **newThumb**(`options?`): [`DScrollBarThumb`](DScrollBarThumb.md)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:189](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L189)

___

### off

▸ **off**(`event`, `fn?`, `context?`): [`DScrollBar`](DScrollBar.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DScrollBar`](DScrollBar.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:88](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L88)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:140](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L140)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:133](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L133)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:179](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L179)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:171](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L171)
...
▸ **once**(`event`, `fn`, `context?`): [`DScrollBar`](DScrollBar.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DScrollBar`](DScrollBar.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DScrollBar`](DScrollBar.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:104](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L104)
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:73](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L73)
...
▸ `Protected` **setFocused**(`isFocused`): [`DScrollBar`](DScrollBar.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DScrollBar`](DScrollBar.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` `Abstract` **updateThumb**(`width`, `height`): `void`
...
[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:138](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L138)
