[Winter Cardinal UI - v0.374.0](../index.md) / DSliderTrack
...
- [newPadding](DSliderTrack.md#newpadding)
- [newText](DSliderTrack.md#newtext)
...
• **new DSliderTrack**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DSliderTrack`](DSliderTrack.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DSliderTrack`](DSliderTrack.md)\<`VALUE`, `THEME`, `OPTIONS`\>
