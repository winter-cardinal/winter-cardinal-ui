[Winter Cardinal UI - v0.167.0](../index.md) / DSliderTrack

# Class: DSliderTrack<VALUE, THEME, OPTIONS\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeSliderTrack`](../interfaces/DThemeSliderTrack.md)<`VALUE`\> = [`DThemeSliderTrack`](../interfaces/DThemeSliderTrack.md)<`VALUE`\> |
| `OPTIONS` | extends [`DSliderTrackOptions`](../interfaces/DSliderTrackOptions.md)<`VALUE`, `THEME`\> = [`DSliderTrackOptions`](../interfaces/DSliderTrackOptions.md)<`VALUE`, `THEME`\> |
...
- [`DButton`](DButton.md)<`VALUE`, `THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DSliderTrackHorizontal`](DSliderTrackHorizontal.md)

  ↳↳ [`DSliderTrackVertical`](DSliderTrackVertical.md)

## Table of contents

### Constructors

- [constructor](DSliderTrack.md#constructor)

### Properties

- [\_accessibleActive](DSliderTrack.md#_accessibleactive)
- [\_accessibleDiv](DSliderTrack.md#_accessiblediv)
- [\_auto](DSliderTrack.md#_auto)
- [\_background](DSliderTrack.md#_background)
- [\_border](DSliderTrack.md#_border)
- [\_bounds](DSliderTrack.md#_bounds)
- [\_clearType](DSliderTrack.md#_cleartype)
- [\_corner](DSliderTrack.md#_corner)
- [\_cursor](DSliderTrack.md#_cursor)
- [\_destroyed](DSliderTrack.md#_destroyed)
- [\_images](DSliderTrack.md#_images)
- [\_isOverflowMaskEnabled](DSliderTrack.md#_isoverflowmaskenabled)
- [\_isTextVisible](DSliderTrack.md#_istextvisible)
- [\_isToggle](DSliderTrack.md#_istoggle)
- [\_lastDownPoint](DSliderTrack.md#_lastdownpoint)
- [\_lastSortedIndex](DSliderTrack.md#_lastsortedindex)
- [\_mask](DSliderTrack.md#_mask)
- [\_options](DSliderTrack.md#_options)
- [\_outline](DSliderTrack.md#_outline)
- [\_overflowMask](DSliderTrack.md#_overflowmask)
- [\_padding](DSliderTrack.md#_padding)
- [\_reflowable](DSliderTrack.md#_reflowable)
- [\_shortcuts](DSliderTrack.md#_shortcuts)
- [\_snippet](DSliderTrack.md#_snippet)
- [\_tempDisplayObjectParent](DSliderTrack.md#_tempdisplayobjectparent)
- [\_text](DSliderTrack.md#_text)
- [\_textAlign](DSliderTrack.md#_textalign)
- [\_textAlpha](DSliderTrack.md#_textalpha)
- [\_textColor](DSliderTrack.md#_textcolor)
- [\_textFormatter](DSliderTrack.md#_textformatter)
- [\_textStyle](DSliderTrack.md#_textstyle)
- [\_textValue](DSliderTrack.md#_textvalue)
- [\_textValueComputed](DSliderTrack.md#_textvaluecomputed)
- [\_title](DSliderTrack.md#_title)
- [\_when](DSliderTrack.md#_when)
- [\_zIndex](DSliderTrack.md#_zindex)
- [accessible](DSliderTrack.md#accessible)
- [accessibleChildren](DSliderTrack.md#accessiblechildren)
- [accessibleHint](DSliderTrack.md#accessiblehint)
- [accessiblePointerEvents](DSliderTrack.md#accessiblepointerevents)
- [accessibleTitle](DSliderTrack.md#accessibletitle)
- [accessibleType](DSliderTrack.md#accessibletype)
- [alpha](DSliderTrack.md#alpha)
- [angle](DSliderTrack.md#angle)
- [buttonMode](DSliderTrack.md#buttonmode)
- [cacheAsBitmap](DSliderTrack.md#cacheasbitmap)
- [children](DSliderTrack.md#children)
- [cursor](DSliderTrack.md#cursor)
- [filterArea](DSliderTrack.md#filterarea)
- [filters](DSliderTrack.md#filters)
- [hitArea](DSliderTrack.md#hitarea)
- [interactive](DSliderTrack.md#interactive)
- [interactiveChildren](DSliderTrack.md#interactivechildren)
- [isMask](DSliderTrack.md#ismask)
- [isSprite](DSliderTrack.md#issprite)
- [localTransform](DSliderTrack.md#localtransform)
- [mask](DSliderTrack.md#mask)
- [name](DSliderTrack.md#name)
- [parent](DSliderTrack.md#parent)
- [pivot](DSliderTrack.md#pivot)
- [renderable](DSliderTrack.md#renderable)
- [rotation](DSliderTrack.md#rotation)
- [sortDirty](DSliderTrack.md#sortdirty)
- [sortableChildren](DSliderTrack.md#sortablechildren)
- [transform](DSliderTrack.md#transform)
- [visible](DSliderTrack.md#visible)
- [worldAlpha](DSliderTrack.md#worldalpha)
- [worldTransform](DSliderTrack.md#worldtransform)
- [worldVisible](DSliderTrack.md#worldvisible)
- [zIndex](DSliderTrack.md#zindex)
- [LAYOUTER](DSliderTrack.md#layouter)
- [WORK\_CONTAINS\_POINT](DSliderTrack.md#work_contains_point)

### Accessors

- [background](DSliderTrack.md#background)
- [border](DSliderTrack.md#border)
- [corner](DSliderTrack.md#corner)
- [height](DSliderTrack.md#height)
- [image](DSliderTrack.md#image)
- [isToggle](DSliderTrack.md#istoggle)
- [outline](DSliderTrack.md#outline)
- [padding](DSliderTrack.md#padding)
- [position](DSliderTrack.md#position)
- [reflowable](DSliderTrack.md#reflowable)
- [scale](DSliderTrack.md#scale)
- [shadow](DSliderTrack.md#shadow)
- [skew](DSliderTrack.md#skew)
- [snippet](DSliderTrack.md#snippet)
- [state](DSliderTrack.md#state)
- [text](DSliderTrack.md#text)
- [theme](DSliderTrack.md#theme)
- [title](DSliderTrack.md#title)
- [type](DSliderTrack.md#type)
- [unsafe](DSliderTrack.md#unsafe)
- [weight](DSliderTrack.md#weight)
- [width](DSliderTrack.md#width)
- [x](DSliderTrack.md#x)
- [y](DSliderTrack.md#y)

### Methods

- [\_calculateBounds](DSliderTrack.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DSliderTrack.md#_recursivepostupdatetransform)
- [\_render](DSliderTrack.md#_render)
- [addChild](DSliderTrack.md#addchild)
- [addChildAt](DSliderTrack.md#addchildat)
- [addListener](DSliderTrack.md#addlistener)
- [applyTitle](DSliderTrack.md#applytitle)
- [blur](DSliderTrack.md#blur)
- [calculateBounds](DSliderTrack.md#calculatebounds)
- [computeTextValue](DSliderTrack.md#computetextvalue)
- [containsGlobalPoint](DSliderTrack.md#containsglobalpoint)
- [containsLocalPoint](DSliderTrack.md#containslocalpoint)
- [containsPoint](DSliderTrack.md#containspoint)
- [createOrUpdateText](DSliderTrack.md#createorupdatetext)
- [createText](DSliderTrack.md#createtext)
- [destroy](DSliderTrack.md#destroy)
- [displayObjectUpdateTransform](DSliderTrack.md#displayobjectupdatetransform)
- [emit](DSliderTrack.md#emit)
- [eventNames](DSliderTrack.md#eventnames)
- [focus](DSliderTrack.md#focus)
- [focusOnClosest](DSliderTrack.md#focusonclosest)
- [getBounds](DSliderTrack.md#getbounds)
- [getChildAt](DSliderTrack.md#getchildat)
- [getChildByName](DSliderTrack.md#getchildbyname)
- [getChildIndex](DSliderTrack.md#getchildindex)
- [getClearType](DSliderTrack.md#getcleartype)
- [getClippingRect](DSliderTrack.md#getclippingrect)
- [getGlobalPosition](DSliderTrack.md#getglobalposition)
- [getHeight](DSliderTrack.md#getheight)
- [getLocalBounds](DSliderTrack.md#getlocalbounds)
- [getOverflowMask](DSliderTrack.md#getoverflowmask)
- [getParentOfSize](DSliderTrack.md#getparentofsize)
- [getTextAlpha](DSliderTrack.md#gettextalpha)
- [getTextColor](DSliderTrack.md#gettextcolor)
- [getThemeDefault](DSliderTrack.md#getthemedefault)
- [getType](DSliderTrack.md#gettype)
- [getWidth](DSliderTrack.md#getwidth)
- [getX](DSliderTrack.md#getx)
- [getY](DSliderTrack.md#gety)
- [hasDirty](DSliderTrack.md#hasdirty)
- [hasRefitableHeight](DSliderTrack.md#hasrefitableheight)
- [hasRefitableWidth](DSliderTrack.md#hasrefitablewidth)
- [hide](DSliderTrack.md#hide)
- [hideText](DSliderTrack.md#hidetext)
- [init](DSliderTrack.md#init)
- [initOnClick](DSliderTrack.md#initonclick)
- [initOnPress](DSliderTrack.md#initonpress)
- [initReflowable](DSliderTrack.md#initreflowable)
- [isDirty](DSliderTrack.md#isdirty)
- [isEventTarget](DSliderTrack.md#iseventtarget)
- [isHidden](DSliderTrack.md#ishidden)
- [isHierarchyDirty](DSliderTrack.md#ishierarchydirty)
- [isRefitable](DSliderTrack.md#isrefitable)
- [isShown](DSliderTrack.md#isshown)
- [listenerCount](DSliderTrack.md#listenercount)
- [listeners](DSliderTrack.md#listeners)
- [newImage](DSliderTrack.md#newimage)
- [newImages](DSliderTrack.md#newimages)
- [off](DSliderTrack.md#off)
- [on](DSliderTrack.md#on)
- [onActivate](DSliderTrack.md#onactivate)
- [onActivateKeyDown](DSliderTrack.md#onactivatekeydown)
- [onActivateKeyUp](DSliderTrack.md#onactivatekeyup)
- [onBlur](DSliderTrack.md#onblur)
- [onChildBlur](DSliderTrack.md#onchildblur)
- [onChildFocus](DSliderTrack.md#onchildfocus)
- [onChildrenChange](DSliderTrack.md#onchildrenchange)
- [onClick](DSliderTrack.md#onclick)
- [onDblClick](DSliderTrack.md#ondblclick)
- [onDown](DSliderTrack.md#ondown)
- [onDownThis](DSliderTrack.md#ondownthis)
- [onFocus](DSliderTrack.md#onfocus)
- [onHierarchyDirty](DSliderTrack.md#onhierarchydirty)
- [onInactivate](DSliderTrack.md#oninactivate)
- [onKeyDown](DSliderTrack.md#onkeydown)
- [onKeyUp](DSliderTrack.md#onkeyup)
- [onMove](DSliderTrack.md#onmove)
- [onOut](DSliderTrack.md#onout)
- [onOver](DSliderTrack.md#onover)
- [onParentMove](DSliderTrack.md#onparentmove)
- [onParentResize](DSliderTrack.md#onparentresize)
- [onRefit](DSliderTrack.md#onrefit)
- [onReflow](DSliderTrack.md#onreflow)
- [onResize](DSliderTrack.md#onresize)
- [onScale](DSliderTrack.md#onscale)
- [onShortcut](DSliderTrack.md#onshortcut)
- [onSkew](DSliderTrack.md#onskew)
- [onStateChange](DSliderTrack.md#onstatechange)
- [onTextChange](DSliderTrack.md#ontextchange)
- [onToggleEnd](DSliderTrack.md#ontoggleend)
- [onToggleStart](DSliderTrack.md#ontogglestart)
- [onUp](DSliderTrack.md#onup)
- [onUpThis](DSliderTrack.md#onupthis)
- [onWheel](DSliderTrack.md#onwheel)
- [once](DSliderTrack.md#once)
- [reflow](DSliderTrack.md#reflow)
- [removeAllListeners](DSliderTrack.md#removealllisteners)
- [removeChild](DSliderTrack.md#removechild)
- [removeChildAt](DSliderTrack.md#removechildat)
- [removeChildren](DSliderTrack.md#removechildren)
- [removeListener](DSliderTrack.md#removelistener)
- [render](DSliderTrack.md#render)
- [renderAdvanced](DSliderTrack.md#renderadvanced)
- [resize](DSliderTrack.md#resize)
- [setChildIndex](DSliderTrack.md#setchildindex)
- [setFocused](DSliderTrack.md#setfocused)
- [setHeight](DSliderTrack.md#setheight)
- [setParent](DSliderTrack.md#setparent)
- [setTransform](DSliderTrack.md#settransform)
- [setWidth](DSliderTrack.md#setwidth)
- [setX](DSliderTrack.md#setx)
- [setY](DSliderTrack.md#sety)
- [show](DSliderTrack.md#show)
- [showText](DSliderTrack.md#showtext)
- [sortChildren](DSliderTrack.md#sortchildren)
- [swapChildren](DSliderTrack.md#swapchildren)
- [toCursor](DSliderTrack.md#tocursor)
- [toDirty](DSliderTrack.md#todirty)
- [toGlobal](DSliderTrack.md#toglobal)
- [toHasDirty](DSliderTrack.md#tohasdirty)
- [toHierarchyDirty](DSliderTrack.md#tohierarchydirty)
- [toImageOptions](DSliderTrack.md#toimageoptions)
- [toLocal](DSliderTrack.md#tolocal)
- [toParentHasDirty](DSliderTrack.md#toparenthasdirty)
- [toParentHierarchyDirty](DSliderTrack.md#toparenthierarchydirty)
- [toParentResized](DSliderTrack.md#toparentresized)
- [toggle](DSliderTrack.md#toggle)
- [updateText](DSliderTrack.md#updatetext)
- [updateTextAndImage](DSliderTrack.md#updatetextandimage)
- [updateTextColor](DSliderTrack.md#updatetextcolor)
- [updateTextPosition](DSliderTrack.md#updatetextposition)
- [updateTextValue](DSliderTrack.md#updatetextvalue)
- [updateTransform](DSliderTrack.md#updatetransform)
- [mixin](DSliderTrack.md#mixin)

## Constructors

### constructor

• **new DSliderTrack**<`VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeSliderTrack`](../interfaces/DThemeSliderTrack.md)<`VALUE`, `THEME`\> = [`DThemeSliderTrack`](../interfaces/DThemeSliderTrack.md)<`VALUE`\> |
| `OPTIONS` | extends [`DSliderTrackOptions`](../interfaces/DSliderTrackOptions.md)<`VALUE`, `THEME`, `OPTIONS`\> = [`DSliderTrackOptions`](../interfaces/DSliderTrackOptions.md)<`VALUE`, `THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DSliderTrack`](DSliderTrack.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DSliderTrack`](DSliderTrack.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DSliderTrack`](DSliderTrack.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-slider-track.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-slider-track.ts#L20)
...
▸ **hide**(): [`DSliderTrack`](DSliderTrack.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DSliderTrack`](DSliderTrack.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DSliderTrack`](DSliderTrack.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DSliderTrack`](DSliderTrack.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DSliderTrack`](DSliderTrack.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DSliderTrack`](DSliderTrack.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DSliderTrack`](DSliderTrack.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DSliderTrack`](DSliderTrack.md)<`VALUE`, `THEME`, `OPTIONS`\>
