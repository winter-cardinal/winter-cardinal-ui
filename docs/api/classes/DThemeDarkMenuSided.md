[Winter Cardinal UI - v0.200.0](../index.md) / DThemeDarkMenuSided

# Class: DThemeDarkMenuSided
...
- [constructor](DThemeDarkMenuSided.md#constructor)

### Methods

- [getAlpha](DThemeDarkMenuSided.md#getalpha)
- [getBackgroundAlpha](DThemeDarkMenuSided.md#getbackgroundalpha)
- [getBackgroundColor](DThemeDarkMenuSided.md#getbackgroundcolor)
- [getBackgroundTexture](DThemeDarkMenuSided.md#getbackgroundtexture)
- [getBorderAlign](DThemeDarkMenuSided.md#getborderalign)
- [getBorderAlpha](DThemeDarkMenuSided.md#getborderalpha)
- [getBorderColor](DThemeDarkMenuSided.md#getbordercolor)
- [getBorderMask](DThemeDarkMenuSided.md#getbordermask)
- [getBorderTexture](DThemeDarkMenuSided.md#getbordertexture)
- [getBorderWidth](DThemeDarkMenuSided.md#getborderwidth)
- [getClearType](DThemeDarkMenuSided.md#getcleartype)
- [getColor](DThemeDarkMenuSided.md#getcolor)
- [getCornerMask](DThemeDarkMenuSided.md#getcornermask)
- [getCornerRadius](DThemeDarkMenuSided.md#getcornerradius)
- [getCursor](DThemeDarkMenuSided.md#getcursor)
- [getFontFamilly](DThemeDarkMenuSided.md#getfontfamilly)
- [getFontSize](DThemeDarkMenuSided.md#getfontsize)
- [getFontStyle](DThemeDarkMenuSided.md#getfontstyle)
- [getFontVariant](DThemeDarkMenuSided.md#getfontvariant)
- [getFontWeight](DThemeDarkMenuSided.md#getfontweight)
- [getGestureMode](DThemeDarkMenuSided.md#getgesturemode)
- [getHeight](DThemeDarkMenuSided.md#getheight)
- [getInteractive](DThemeDarkMenuSided.md#getinteractive)
- [getLineHeight](DThemeDarkMenuSided.md#getlineheight)
- [getOutlineAlign](DThemeDarkMenuSided.md#getoutlinealign)
- [getOutlineAlpha](DThemeDarkMenuSided.md#getoutlinealpha)
- [getOutlineColor](DThemeDarkMenuSided.md#getoutlinecolor)
- [getOutlineMask](DThemeDarkMenuSided.md#getoutlinemask)
- [getOutlineOffset](DThemeDarkMenuSided.md#getoutlineoffset)
- [getOutlineWidth](DThemeDarkMenuSided.md#getoutlinewidth)
- [getPaddingBottom](DThemeDarkMenuSided.md#getpaddingbottom)
- [getPaddingLeft](DThemeDarkMenuSided.md#getpaddingleft)
- [getPaddingRight](DThemeDarkMenuSided.md#getpaddingright)
- [getPaddingTop](DThemeDarkMenuSided.md#getpaddingtop)
- [getShadow](DThemeDarkMenuSided.md#getshadow)
- [getTitle](DThemeDarkMenuSided.md#gettitle)
- [getWeight](DThemeDarkMenuSided.md#getweight)
- [getWheelSpeed](DThemeDarkMenuSided.md#getwheelspeed)
- [getWidth](DThemeDarkMenuSided.md#getwidth)
- [getX](DThemeDarkMenuSided.md#getx)
- [getY](DThemeDarkMenuSided.md#gety)
- [isOverflowMaskEnabled](DThemeDarkMenuSided.md#isoverflowmaskenabled)
- [newShadow](DThemeDarkMenuSided.md#newshadow)
- [newShadowWeak](DThemeDarkMenuSided.md#newshadowweak)
- [newState](DThemeDarkMenuSided.md#newstate)

## Constructors

### constructor

• **new DThemeDarkMenuSided**()
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-menu-sided.ts:13](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.200.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-menu-sided.ts#L13)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-menu-sided.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.200.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-menu-sided.ts#L17)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-menu-sided.ts:21](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.200.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-menu-sided.ts#L21)
