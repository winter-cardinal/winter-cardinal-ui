[Winter Cardinal UI - v0.310.1](../index.md) / DInputBooleanButtonOn
...
- [\_isGrouped](DInputBooleanButtonOn.md#_isgrouped)
...
- [isGrouped](DInputBooleanButtonOn.md#isgrouped)
...
- [activate](DInputBooleanButtonOn.md#activate)
...
- [onPress](DInputBooleanButtonOn.md#onpress)
...
- [onUnpress](DInputBooleanButtonOn.md#onunpress)
...
[src/main/typescript/wcardinal/ui/d-input-boolean-button-on.ts:19](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-input-boolean-button-on.ts#L19)
