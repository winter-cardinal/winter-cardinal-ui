[Winter Cardinal UI - v0.374.0](../index.md) / DInputBooleanButtonOn
...
- [newPadding](DInputBooleanButtonOn.md#newpadding)
- [newText](DInputBooleanButtonOn.md#newtext)
...
• **new DInputBooleanButtonOn**\<`THEME`, `OPTIONS`\>(`options?`): [`DInputBooleanButtonOn`](DInputBooleanButtonOn.md)\<`THEME`, `OPTIONS`\>
...
| :------ | :------ |
| `THEME` | extends [`DThemeInputBooleanButtonOn`](../interfaces/DThemeInputBooleanButtonOn.md) = [`DThemeInputBooleanButtonOn`](../interfaces/DThemeInputBooleanButtonOn.md) |
| `OPTIONS` | extends [`DInputBooleanButtonOnOptions`](../interfaces/DInputBooleanButtonOnOptions.md)\<`THEME`, `any`\> = [`DInputBooleanButtonOnOptions`](../interfaces/DInputBooleanButtonOnOptions.md)\<`THEME`, `any`\> |
...
▸ **setFocused**(`isFocused`): [`DInputBooleanButtonOn`](DInputBooleanButtonOn.md)\<`THEME`, `OPTIONS`\>
