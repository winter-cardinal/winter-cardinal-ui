[Winter Cardinal UI - v0.154.0](../index.md) / DPaginationDotsButton

# Class: DPaginationDotsButton<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemePaginationDotsButton`](../interfaces/DThemePaginationDotsButton.md) = [`DThemePaginationDotsButton`](../interfaces/DThemePaginationDotsButton.md) |
| `OPTIONS` | extends [`DPaginationDotsButtonOptions`](../interfaces/DPaginationDotsButtonOptions.md)<`THEME`\> = [`DPaginationDotsButtonOptions`](../interfaces/DPaginationDotsButtonOptions.md)<`THEME`\> |

## Hierarchy

- [`DButtonAmbient`](DButtonAmbient.md)<`string`, `THEME`, `OPTIONS`\>

  ↳ **`DPaginationDotsButton`**

## Table of contents

### Constructors

- [constructor](DPaginationDotsButton.md#constructor)

### Properties

- [\_accessibleActive](DPaginationDotsButton.md#_accessibleactive)
- [\_accessibleDiv](DPaginationDotsButton.md#_accessiblediv)
- [\_auto](DPaginationDotsButton.md#_auto)
- [\_background](DPaginationDotsButton.md#_background)
- [\_border](DPaginationDotsButton.md#_border)
- [\_bounds](DPaginationDotsButton.md#_bounds)
- [\_clearType](DPaginationDotsButton.md#_cleartype)
- [\_corner](DPaginationDotsButton.md#_corner)
- [\_cursor](DPaginationDotsButton.md#_cursor)
- [\_destroyed](DPaginationDotsButton.md#_destroyed)
- [\_images](DPaginationDotsButton.md#_images)
- [\_isChildrenDirty](DPaginationDotsButton.md#_ischildrendirty)
- [\_isOverflowMaskEnabled](DPaginationDotsButton.md#_isoverflowmaskenabled)
- [\_isTextVisible](DPaginationDotsButton.md#_istextvisible)
- [\_isToggle](DPaginationDotsButton.md#_istoggle)
- [\_lastDownPoint](DPaginationDotsButton.md#_lastdownpoint)
- [\_lastSortedIndex](DPaginationDotsButton.md#_lastsortedindex)
- [\_mask](DPaginationDotsButton.md#_mask)
- [\_options](DPaginationDotsButton.md#_options)
- [\_outline](DPaginationDotsButton.md#_outline)
- [\_overflowMask](DPaginationDotsButton.md#_overflowmask)
- [\_padding](DPaginationDotsButton.md#_padding)
- [\_reflowable](DPaginationDotsButton.md#_reflowable)
- [\_shortcuts](DPaginationDotsButton.md#_shortcuts)
- [\_snippet](DPaginationDotsButton.md#_snippet)
- [\_tempDisplayObjectParent](DPaginationDotsButton.md#_tempdisplayobjectparent)
- [\_text](DPaginationDotsButton.md#_text)
- [\_textAlign](DPaginationDotsButton.md#_textalign)
- [\_textAlpha](DPaginationDotsButton.md#_textalpha)
- [\_textColor](DPaginationDotsButton.md#_textcolor)
- [\_textFormatter](DPaginationDotsButton.md#_textformatter)
- [\_textStyle](DPaginationDotsButton.md#_textstyle)
- [\_textValue](DPaginationDotsButton.md#_textvalue)
- [\_textValueComputed](DPaginationDotsButton.md#_textvaluecomputed)
- [\_title](DPaginationDotsButton.md#_title)
- [\_when](DPaginationDotsButton.md#_when)
- [\_zIndex](DPaginationDotsButton.md#_zindex)
- [accessible](DPaginationDotsButton.md#accessible)
- [accessibleChildren](DPaginationDotsButton.md#accessiblechildren)
- [accessibleHint](DPaginationDotsButton.md#accessiblehint)
- [accessiblePointerEvents](DPaginationDotsButton.md#accessiblepointerevents)
- [accessibleTitle](DPaginationDotsButton.md#accessibletitle)
- [accessibleType](DPaginationDotsButton.md#accessibletype)
- [alpha](DPaginationDotsButton.md#alpha)
- [angle](DPaginationDotsButton.md#angle)
- [buttonMode](DPaginationDotsButton.md#buttonmode)
- [cacheAsBitmap](DPaginationDotsButton.md#cacheasbitmap)
- [children](DPaginationDotsButton.md#children)
- [cursor](DPaginationDotsButton.md#cursor)
- [filterArea](DPaginationDotsButton.md#filterarea)
- [filters](DPaginationDotsButton.md#filters)
- [hitArea](DPaginationDotsButton.md#hitarea)
- [interactive](DPaginationDotsButton.md#interactive)
- [interactiveChildren](DPaginationDotsButton.md#interactivechildren)
- [isMask](DPaginationDotsButton.md#ismask)
- [isSprite](DPaginationDotsButton.md#issprite)
- [localTransform](DPaginationDotsButton.md#localtransform)
- [mask](DPaginationDotsButton.md#mask)
- [name](DPaginationDotsButton.md#name)
- [parent](DPaginationDotsButton.md#parent)
- [pivot](DPaginationDotsButton.md#pivot)
- [renderable](DPaginationDotsButton.md#renderable)
- [rotation](DPaginationDotsButton.md#rotation)
- [sortDirty](DPaginationDotsButton.md#sortdirty)
- [sortableChildren](DPaginationDotsButton.md#sortablechildren)
- [transform](DPaginationDotsButton.md#transform)
- [visible](DPaginationDotsButton.md#visible)
- [worldAlpha](DPaginationDotsButton.md#worldalpha)
- [worldTransform](DPaginationDotsButton.md#worldtransform)
- [worldVisible](DPaginationDotsButton.md#worldvisible)
- [zIndex](DPaginationDotsButton.md#zindex)
- [WORK\_CONTAINS\_POINT](DPaginationDotsButton.md#work_contains_point)

### Accessors

- [background](DPaginationDotsButton.md#background)
- [border](DPaginationDotsButton.md#border)
- [corner](DPaginationDotsButton.md#corner)
- [height](DPaginationDotsButton.md#height)
- [image](DPaginationDotsButton.md#image)
- [isToggle](DPaginationDotsButton.md#istoggle)
- [outline](DPaginationDotsButton.md#outline)
- [padding](DPaginationDotsButton.md#padding)
- [position](DPaginationDotsButton.md#position)
- [reflowable](DPaginationDotsButton.md#reflowable)
- [scale](DPaginationDotsButton.md#scale)
- [shadow](DPaginationDotsButton.md#shadow)
- [skew](DPaginationDotsButton.md#skew)
- [snippet](DPaginationDotsButton.md#snippet)
- [state](DPaginationDotsButton.md#state)
- [text](DPaginationDotsButton.md#text)
- [theme](DPaginationDotsButton.md#theme)
- [title](DPaginationDotsButton.md#title)
- [type](DPaginationDotsButton.md#type)
- [unsafe](DPaginationDotsButton.md#unsafe)
- [weight](DPaginationDotsButton.md#weight)
- [width](DPaginationDotsButton.md#width)
- [x](DPaginationDotsButton.md#x)
- [y](DPaginationDotsButton.md#y)

### Methods

- [\_calculateBounds](DPaginationDotsButton.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DPaginationDotsButton.md#_recursivepostupdatetransform)
- [\_render](DPaginationDotsButton.md#_render)
- [addChild](DPaginationDotsButton.md#addchild)
- [addChildAt](DPaginationDotsButton.md#addchildat)
- [addListener](DPaginationDotsButton.md#addlistener)
- [applyTitle](DPaginationDotsButton.md#applytitle)
- [blur](DPaginationDotsButton.md#blur)
- [calculateBounds](DPaginationDotsButton.md#calculatebounds)
- [computeTextValue](DPaginationDotsButton.md#computetextvalue)
- [containsGlobalPoint](DPaginationDotsButton.md#containsglobalpoint)
- [containsLocalPoint](DPaginationDotsButton.md#containslocalpoint)
- [containsPoint](DPaginationDotsButton.md#containspoint)
- [createOrUpdateText](DPaginationDotsButton.md#createorupdatetext)
- [createText](DPaginationDotsButton.md#createtext)
- [destroy](DPaginationDotsButton.md#destroy)
- [displayObjectUpdateTransform](DPaginationDotsButton.md#displayobjectupdatetransform)
- [emit](DPaginationDotsButton.md#emit)
- [eventNames](DPaginationDotsButton.md#eventnames)
- [focus](DPaginationDotsButton.md#focus)
- [focusOnClosest](DPaginationDotsButton.md#focusonclosest)
- [getBounds](DPaginationDotsButton.md#getbounds)
- [getChildAt](DPaginationDotsButton.md#getchildat)
- [getChildByName](DPaginationDotsButton.md#getchildbyname)
- [getChildIndex](DPaginationDotsButton.md#getchildindex)
- [getClearType](DPaginationDotsButton.md#getcleartype)
- [getClippingRect](DPaginationDotsButton.md#getclippingrect)
- [getGlobalPosition](DPaginationDotsButton.md#getglobalposition)
- [getHeight](DPaginationDotsButton.md#getheight)
- [getLocalBounds](DPaginationDotsButton.md#getlocalbounds)
- [getOverflowMask](DPaginationDotsButton.md#getoverflowmask)
- [getParentOfSize](DPaginationDotsButton.md#getparentofsize)
- [getTextAlpha](DPaginationDotsButton.md#gettextalpha)
- [getTextColor](DPaginationDotsButton.md#gettextcolor)
- [getThemeDefault](DPaginationDotsButton.md#getthemedefault)
- [getType](DPaginationDotsButton.md#gettype)
- [getWidth](DPaginationDotsButton.md#getwidth)
- [getX](DPaginationDotsButton.md#getx)
- [getY](DPaginationDotsButton.md#gety)
- [hasDirty](DPaginationDotsButton.md#hasdirty)
- [hasRefitableHeight](DPaginationDotsButton.md#hasrefitableheight)
- [hasRefitableWidth](DPaginationDotsButton.md#hasrefitablewidth)
- [hide](DPaginationDotsButton.md#hide)
- [hideText](DPaginationDotsButton.md#hidetext)
- [init](DPaginationDotsButton.md#init)
- [initOnClick](DPaginationDotsButton.md#initonclick)
- [initOnPress](DPaginationDotsButton.md#initonpress)
- [initReflowable](DPaginationDotsButton.md#initreflowable)
- [isChildrenDirty](DPaginationDotsButton.md#ischildrendirty)
- [isDirty](DPaginationDotsButton.md#isdirty)
- [isEventTarget](DPaginationDotsButton.md#iseventtarget)
- [isHidden](DPaginationDotsButton.md#ishidden)
- [isRefitable](DPaginationDotsButton.md#isrefitable)
- [isShown](DPaginationDotsButton.md#isshown)
- [listenerCount](DPaginationDotsButton.md#listenercount)
- [listeners](DPaginationDotsButton.md#listeners)
- [newImage](DPaginationDotsButton.md#newimage)
- [newImages](DPaginationDotsButton.md#newimages)
- [off](DPaginationDotsButton.md#off)
- [on](DPaginationDotsButton.md#on)
- [onActivate](DPaginationDotsButton.md#onactivate)
- [onActivateKeyDown](DPaginationDotsButton.md#onactivatekeydown)
- [onActivateKeyUp](DPaginationDotsButton.md#onactivatekeyup)
- [onBlur](DPaginationDotsButton.md#onblur)
- [onChildBlur](DPaginationDotsButton.md#onchildblur)
- [onChildFocus](DPaginationDotsButton.md#onchildfocus)
- [onChildrenChange](DPaginationDotsButton.md#onchildrenchange)
- [onChildrenDirty](DPaginationDotsButton.md#onchildrendirty)
- [onClick](DPaginationDotsButton.md#onclick)
- [onDblClick](DPaginationDotsButton.md#ondblclick)
- [onDown](DPaginationDotsButton.md#ondown)
- [onDownThis](DPaginationDotsButton.md#ondownthis)
- [onFocus](DPaginationDotsButton.md#onfocus)
- [onInactivate](DPaginationDotsButton.md#oninactivate)
- [onKeyDown](DPaginationDotsButton.md#onkeydown)
- [onKeyUp](DPaginationDotsButton.md#onkeyup)
- [onMove](DPaginationDotsButton.md#onmove)
- [onOut](DPaginationDotsButton.md#onout)
- [onOver](DPaginationDotsButton.md#onover)
- [onParentMove](DPaginationDotsButton.md#onparentmove)
- [onParentResize](DPaginationDotsButton.md#onparentresize)
- [onRefit](DPaginationDotsButton.md#onrefit)
- [onReflow](DPaginationDotsButton.md#onreflow)
- [onResize](DPaginationDotsButton.md#onresize)
- [onScale](DPaginationDotsButton.md#onscale)
- [onShortcut](DPaginationDotsButton.md#onshortcut)
- [onSkew](DPaginationDotsButton.md#onskew)
- [onStateChange](DPaginationDotsButton.md#onstatechange)
- [onTextChange](DPaginationDotsButton.md#ontextchange)
- [onToggleEnd](DPaginationDotsButton.md#ontoggleend)
- [onToggleStart](DPaginationDotsButton.md#ontogglestart)
- [onUp](DPaginationDotsButton.md#onup)
- [onUpThis](DPaginationDotsButton.md#onupthis)
- [onWheel](DPaginationDotsButton.md#onwheel)
- [once](DPaginationDotsButton.md#once)
- [refit](DPaginationDotsButton.md#refit)
- [reflow](DPaginationDotsButton.md#reflow)
- [removeAllListeners](DPaginationDotsButton.md#removealllisteners)
- [removeChild](DPaginationDotsButton.md#removechild)
- [removeChildAt](DPaginationDotsButton.md#removechildat)
- [removeChildren](DPaginationDotsButton.md#removechildren)
- [removeListener](DPaginationDotsButton.md#removelistener)
- [render](DPaginationDotsButton.md#render)
- [renderAdvanced](DPaginationDotsButton.md#renderadvanced)
- [resize](DPaginationDotsButton.md#resize)
- [setChildIndex](DPaginationDotsButton.md#setchildindex)
- [setFocused](DPaginationDotsButton.md#setfocused)
- [setHeight](DPaginationDotsButton.md#setheight)
- [setParent](DPaginationDotsButton.md#setparent)
- [setTransform](DPaginationDotsButton.md#settransform)
- [setWidth](DPaginationDotsButton.md#setwidth)
- [setX](DPaginationDotsButton.md#setx)
- [setY](DPaginationDotsButton.md#sety)
- [show](DPaginationDotsButton.md#show)
- [showText](DPaginationDotsButton.md#showtext)
- [sortChildren](DPaginationDotsButton.md#sortchildren)
- [swapChildren](DPaginationDotsButton.md#swapchildren)
- [toChildrenDirty](DPaginationDotsButton.md#tochildrendirty)
- [toCursor](DPaginationDotsButton.md#tocursor)
- [toDirty](DPaginationDotsButton.md#todirty)
- [toGlobal](DPaginationDotsButton.md#toglobal)
- [toHasDirty](DPaginationDotsButton.md#tohasdirty)
- [toImageOptions](DPaginationDotsButton.md#toimageoptions)
- [toLocal](DPaginationDotsButton.md#tolocal)
- [toParentChildrenDirty](DPaginationDotsButton.md#toparentchildrendirty)
- [toParentHasDirty](DPaginationDotsButton.md#toparenthasdirty)
- [toParentResized](DPaginationDotsButton.md#toparentresized)
- [toRounded](DPaginationDotsButton.md#torounded)
- [toggle](DPaginationDotsButton.md#toggle)
- [updateText](DPaginationDotsButton.md#updatetext)
- [updateTextAndImage](DPaginationDotsButton.md#updatetextandimage)
- [updateTextColor](DPaginationDotsButton.md#updatetextcolor)
- [updateTextPosition](DPaginationDotsButton.md#updatetextposition)
- [updateTextValue](DPaginationDotsButton.md#updatetextvalue)
- [updateTransform](DPaginationDotsButton.md#updatetransform)
- [mixin](DPaginationDotsButton.md#mixin)

## Constructors

### constructor

• **new DPaginationDotsButton**<`THEME`, `OPTIONS`\>(`options?`)

#### Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemePaginationDotsButton`](../interfaces/DThemePaginationDotsButton.md)<`THEME`\> = [`DThemePaginationDotsButton`](../interfaces/DThemePaginationDotsButton.md) |
| `OPTIONS` | extends [`DPaginationDotsButtonOptions`](../interfaces/DPaginationDotsButtonOptions.md)<`THEME`, `OPTIONS`\> = [`DPaginationDotsButtonOptions`](../interfaces/DPaginationDotsButtonOptions.md)<`THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DPaginationDotsButton`](DPaginationDotsButton.md)<`THEME`, `OPTIONS`\>
...
[`DPaginationDotsButton`](DPaginationDotsButton.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DPaginationDotsButton`](DPaginationDotsButton.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DPaginationDotsButton`](DPaginationDotsButton.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-pagination-dots-button.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-pagination-dots-button.ts#L18)
...
▸ **hide**(): [`DPaginationDotsButton`](DPaginationDotsButton.md)<`THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DPaginationDotsButton`](DPaginationDotsButton.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DPaginationDotsButton`](DPaginationDotsButton.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DPaginationDotsButton`](DPaginationDotsButton.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DPaginationDotsButton`](DPaginationDotsButton.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DPaginationDotsButton`](DPaginationDotsButton.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DPaginationDotsButton`](DPaginationDotsButton.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DPaginationDotsButton`](DPaginationDotsButton.md)<`THEME`, `OPTIONS`\>
