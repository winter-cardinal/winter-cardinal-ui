[Winter Cardinal UI - v0.457.0](../index.md) / DDialog
...
- [\_alwaysOnTop](DDialog.md#_alwaysontop)
...
- [\_boundsID](DDialog.md#_boundsid)
- [\_boundsRect](DDialog.md#_boundsrect)
...
- [\_enabledFilters](DDialog.md#_enabledfilters)
...
- [\_localBounds](DDialog.md#_localbounds)
- [\_localBoundsRect](DDialog.md#_localboundsrect)
- [\_mask](DDialog.md#_mask)
- [\_mode](DDialog.md#_mode)
- [\_onParentChildAddedBound](DDialog.md#_onparentchildaddedbound)
...
- [alwaysOnTop](DDialog.md#alwaysontop)
...
- [bringToFront](DDialog.md#bringtofront)
- [calculateBounds](DDialog.md#calculatebounds)
- [close](DDialog.md#close)
- [containerUpdateTransform](DDialog.md#containerupdatetransform)
...
- [disableTempParent](DDialog.md#disabletempparent)
...
- [enableTempParent](DDialog.md#enabletempparent)
...
- [newPadding](DDialog.md#newpadding)
- [off](DDialog.md#off)
- [on](DDialog.md#on)
...
• **new DDialog**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DDialog`](DDialog.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
| `VALUE` | `void` |
| `THEME` | extends [`DThemeDialog`](../interfaces/DThemeDialog.md) = [`DThemeDialog`](../interfaces/DThemeDialog.md) |
| `OPTIONS` | extends [`DDialogOptions`](../interfaces/DDialogOptions.md)\<`THEME`, `any`\> = [`DDialogOptions`](../interfaces/DDialogOptions.md)\<`THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:331](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L331)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:583](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L583)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:140](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L140)
