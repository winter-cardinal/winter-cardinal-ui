[Winter Cardinal UI - v0.167.0](../index.md) / DNoteSmallError
...
- [accessibleHint](DNoteSmallError.md#accessiblehint)
...
- [onChildrenChange](DNoteSmallError.md#onchildrenchange)
...
[src/main/typescript/wcardinal/ui/d-note-small-error.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-note-small-error.ts#L17)
...
▸ **once**(`event`, `fn`, `context?`): [`DNoteSmallError`](DNoteSmallError.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DNoteSmallError`](DNoteSmallError.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DNoteSmallError`](DNoteSmallError.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DNoteSmallError`](DNoteSmallError.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DNoteSmallError`](DNoteSmallError.md)<`THEME`, `OPTIONS`\>
