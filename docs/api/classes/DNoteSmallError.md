[Winter Cardinal UI - v0.155.0](../index.md) / DNoteSmallError
...
- [\_isChildrenDirty](DNoteSmallError.md#_ischildrendirty)
...
- [isChildrenDirty](DNoteSmallError.md#ischildrendirty)
...
- [onChildrenDirty](DNoteSmallError.md#onchildrendirty)
...
- [refit](DNoteSmallError.md#refit)
...
- [toChildrenDirty](DNoteSmallError.md#tochildrendirty)
...
[src/main/typescript/wcardinal/ui/d-note-small-error.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-note-small-error.ts#L17)
