[Winter Cardinal UI - v0.407.0](../index.md) / DNoteSmallError
...
- [\_boundsID](DNoteSmallError.md#_boundsid)
- [\_boundsRect](DNoteSmallError.md#_boundsrect)
...
- [\_enabledFilters](DNoteSmallError.md#_enabledfilters)
- [\_image](DNoteSmallError.md#_image)
- [\_lastDownPoint](DNoteSmallError.md#_lastdownpoint)
- [\_lastSortedIndex](DNoteSmallError.md#_lastsortedindex)
- [\_localBounds](DNoteSmallError.md#_localbounds)
- [\_localBoundsRect](DNoteSmallError.md#_localboundsrect)
...
- [containerUpdateTransform](DNoteSmallError.md#containerupdatetransform)
...
- [disableTempParent](DNoteSmallError.md#disabletempparent)
- [displayObjectUpdateTransform](DNoteSmallError.md#displayobjectupdatetransform)
- [emit](DNoteSmallError.md#emit)
- [enableTempParent](DNoteSmallError.md#enabletempparent)
...
- [getImage](DNoteSmallError.md#getimage)
- [getLayouter](DNoteSmallError.md#getlayouter)
...
- [getText](DNoteSmallError.md#gettext)
...
- [newOverflowMask](DNoteSmallError.md#newoverflowmask)
- [newPadding](DNoteSmallError.md#newpadding)
- [newText](DNoteSmallError.md#newtext)
...
- [onReflowTextAndImage](DNoteSmallError.md#onreflowtextandimage)
...
• **new DNoteSmallError**\<`THEME`, `OPTIONS`\>(`options?`): [`DNoteSmallError`](DNoteSmallError.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-note-small-error.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-note-small-error.ts#L17)
...
▸ **setFocused**(`isFocused`): [`DNoteSmallError`](DNoteSmallError.md)\<`THEME`, `OPTIONS`\>
