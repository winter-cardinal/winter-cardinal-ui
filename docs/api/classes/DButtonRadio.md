[Winter Cardinal UI - v0.407.0](../index.md) / DButtonRadio
...
[src/main/typescript/wcardinal/ui/d-button-radio.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-radio.ts#L20)
...
▸ **setFocused**(`isFocused`): [`DButtonRadio`](DButtonRadio.md)\<`VALUE`, `THEME`, `OPTIONS`\>
