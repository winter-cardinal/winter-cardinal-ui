[Winter Cardinal UI - v0.200.0](../index.md) / DThemeWhiteTableHeaderCell
...
- [getLineHeight](DThemeWhiteTableHeaderCell.md#getlineheight)
...
• **new DThemeWhiteTableHeaderCell**()
