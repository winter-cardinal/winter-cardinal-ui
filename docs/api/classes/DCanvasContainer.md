[Winter Cardinal UI - v0.160.0](../index.md) / DCanvasContainer
...
- [accessibleHint](DCanvasContainer.md#accessiblehint)
...
- [onMove](DCanvasContainer.md#onmove)
...
▸ **show**(): [`DCanvasContainer`](DCanvasContainer.md)<`CANVAS`, `CANVAS_OPTIONS`, `THEME`, `OPTIONS`\>
