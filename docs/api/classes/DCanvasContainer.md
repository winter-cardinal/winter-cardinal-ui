[Winter Cardinal UI - v0.407.0](../index.md) / DCanvasContainer
...
[src/main/typescript/wcardinal/ui/d-canvas-container.ts:103](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-canvas-container.ts#L103)
...
▸ **setFocused**(`isFocused`): [`DCanvasContainer`](DCanvasContainer.md)\<`CANVAS`, `CANVAS_OPTIONS`, `THEME`, `OPTIONS`\>
