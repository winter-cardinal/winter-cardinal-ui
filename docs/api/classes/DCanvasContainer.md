[Winter Cardinal UI - v0.442.0](../index.md) / DCanvasContainer
...
- [\_boundsID](DCanvasContainer.md#_boundsid)
- [\_boundsRect](DCanvasContainer.md#_boundsrect)
...
- [\_enabledFilters](DCanvasContainer.md#_enabledfilters)
- [\_lastDownPoint](DCanvasContainer.md#_lastdownpoint)
- [\_lastSortedIndex](DCanvasContainer.md#_lastsortedindex)
- [\_localBounds](DCanvasContainer.md#_localbounds)
- [\_localBoundsRect](DCanvasContainer.md#_localboundsrect)
...
- [containerUpdateTransform](DCanvasContainer.md#containerupdatetransform)
...
- [disableTempParent](DCanvasContainer.md#disabletempparent)
- [displayObjectUpdateTransform](DCanvasContainer.md#displayobjectupdatetransform)
- [emit](DCanvasContainer.md#emit)
- [enableTempParent](DCanvasContainer.md#enabletempparent)
...
- [newPadding](DCanvasContainer.md#newpadding)
...
• **new DCanvasContainer**\<`CANVAS`, `CANVAS_OPTIONS`, `THEME`, `OPTIONS`\>(`options?`): [`DCanvasContainer`](DCanvasContainer.md)\<`CANVAS`, `CANVAS_OPTIONS`, `THEME`, `OPTIONS`\>

#### Type parameters

| Name | Type |
| :------ | :------ |
| `CANVAS` | extends [`DBase`](DBase.md)\<[`DThemeBase`](../interfaces/DThemeBase.md), [`DBaseOptions`](../interfaces/DBaseOptions.md)\<[`DThemeBase`](../interfaces/DThemeBase.md), `any`\>\> = [`DCanvas`](DCanvas.md)\<[`DThemeCanvas`](../interfaces/DThemeCanvas.md), [`DCanvasOptions`](../interfaces/DCanvasOptions.md)\<[`DThemeCanvas`](../interfaces/DThemeCanvas.md)\>\> |
| `CANVAS_OPTIONS` | extends [`DBaseOptions`](../interfaces/DBaseOptions.md)\<[`DThemeBase`](../interfaces/DThemeBase.md), `any`\> = [`DBaseOptions`](../interfaces/DBaseOptions.md)\<[`DThemeBase`](../interfaces/DThemeBase.md), `any`\> |
| `THEME` | extends [`DThemeCanvasContainer`](../interfaces/DThemeCanvasContainer.md) = [`DThemeCanvasContainer`](../interfaces/DThemeCanvasContainer.md) |
| `OPTIONS` | extends [`DCanvasContainerOptions`](../interfaces/DCanvasContainerOptions.md)\<`CANVAS`, `CANVAS_OPTIONS`, `THEME`, `any`\> = [`DCanvasContainerOptions`](../interfaces/DCanvasContainerOptions.md)\<`CANVAS`, `CANVAS_OPTIONS`, `THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-canvas-container.ts:103](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/d-canvas-container.ts#L103)
