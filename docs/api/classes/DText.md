[Winter Cardinal UI - v0.407.0](../index.md) / DText
...
- [containerUpdateTransform](DText.md#containerupdatetransform)
...
- [disableTempParent](DText.md#disabletempparent)
- [displayObjectUpdateTransform](DText.md#displayobjectupdatetransform)
- [emit](DText.md#emit)
- [enableTempParent](DText.md#enabletempparent)
...
- [newOverflowMask](DText.md#newoverflowmask)
- [newPadding](DText.md#newpadding)
- [newText](DText.md#newtext)
- [off](DText.md#off)
- [on](DText.md#on)
...
- [onReflowTextAndImage](DText.md#onreflowtextandimage)
...
• **new DText**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DText`](DText.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-text.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-text.ts#L18)
...
▸ **setFocused**(`isFocused`): [`DText`](DText.md)\<`VALUE`, `THEME`, `OPTIONS`\>
