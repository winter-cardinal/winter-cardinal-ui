[Winter Cardinal UI - v0.167.0](../index.md) / DText

# Class: DText<VALUE, THEME, OPTIONS\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeText`](../interfaces/DThemeText.md)<`VALUE`\> = [`DThemeText`](../interfaces/DThemeText.md)<`VALUE`\> |
| `OPTIONS` | extends [`DTextOptions`](../interfaces/DTextOptions.md)<`VALUE`, `THEME`\> = [`DTextOptions`](../interfaces/DTextOptions.md)<`VALUE`, `THEME`\> |
...
- [`DTextBase`](DTextBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DInputLabel`](DInputLabel.md)

  ↳↳ [`DPickerDatetimeLabelDate`](DPickerDatetimeLabelDate.md)

  ↳↳ [`DPickerDatetimeLabel`](DPickerDatetimeLabel.md)

## Table of contents

### Constructors

- [constructor](DText.md#constructor)

### Properties

- [\_accessibleActive](DText.md#_accessibleactive)
- [\_accessibleDiv](DText.md#_accessiblediv)
- [\_auto](DText.md#_auto)
- [\_background](DText.md#_background)
- [\_border](DText.md#_border)
- [\_bounds](DText.md#_bounds)
- [\_clearType](DText.md#_cleartype)
- [\_corner](DText.md#_corner)
- [\_cursor](DText.md#_cursor)
- [\_destroyed](DText.md#_destroyed)
- [\_isOverflowMaskEnabled](DText.md#_isoverflowmaskenabled)
- [\_isTextVisible](DText.md#_istextvisible)
- [\_lastDownPoint](DText.md#_lastdownpoint)
- [\_lastSortedIndex](DText.md#_lastsortedindex)
- [\_mask](DText.md#_mask)
- [\_options](DText.md#_options)
- [\_outline](DText.md#_outline)
- [\_overflowMask](DText.md#_overflowmask)
- [\_padding](DText.md#_padding)
- [\_reflowable](DText.md#_reflowable)
- [\_shortcuts](DText.md#_shortcuts)
- [\_snippet](DText.md#_snippet)
- [\_tempDisplayObjectParent](DText.md#_tempdisplayobjectparent)
- [\_text](DText.md#_text)
- [\_textAlign](DText.md#_textalign)
- [\_textAlpha](DText.md#_textalpha)
- [\_textColor](DText.md#_textcolor)
- [\_textFormatter](DText.md#_textformatter)
- [\_textStyle](DText.md#_textstyle)
- [\_textValue](DText.md#_textvalue)
- [\_textValueComputed](DText.md#_textvaluecomputed)
- [\_title](DText.md#_title)
- [\_zIndex](DText.md#_zindex)
- [accessible](DText.md#accessible)
- [accessibleChildren](DText.md#accessiblechildren)
- [accessibleHint](DText.md#accessiblehint)
- [accessiblePointerEvents](DText.md#accessiblepointerevents)
- [accessibleTitle](DText.md#accessibletitle)
- [accessibleType](DText.md#accessibletype)
- [alpha](DText.md#alpha)
- [angle](DText.md#angle)
- [buttonMode](DText.md#buttonmode)
- [cacheAsBitmap](DText.md#cacheasbitmap)
- [children](DText.md#children)
- [cursor](DText.md#cursor)
- [filterArea](DText.md#filterarea)
- [filters](DText.md#filters)
- [hitArea](DText.md#hitarea)
- [interactive](DText.md#interactive)
- [interactiveChildren](DText.md#interactivechildren)
- [isMask](DText.md#ismask)
- [isSprite](DText.md#issprite)
- [localTransform](DText.md#localtransform)
- [mask](DText.md#mask)
- [name](DText.md#name)
- [parent](DText.md#parent)
- [pivot](DText.md#pivot)
- [renderable](DText.md#renderable)
- [rotation](DText.md#rotation)
- [sortDirty](DText.md#sortdirty)
- [sortableChildren](DText.md#sortablechildren)
- [transform](DText.md#transform)
- [visible](DText.md#visible)
- [worldAlpha](DText.md#worldalpha)
- [worldTransform](DText.md#worldtransform)
- [worldVisible](DText.md#worldvisible)
- [zIndex](DText.md#zindex)
- [WORK\_CONTAINS\_POINT](DText.md#work_contains_point)

### Accessors

- [background](DText.md#background)
- [border](DText.md#border)
- [corner](DText.md#corner)
- [height](DText.md#height)
- [outline](DText.md#outline)
- [padding](DText.md#padding)
- [position](DText.md#position)
- [reflowable](DText.md#reflowable)
- [scale](DText.md#scale)
- [shadow](DText.md#shadow)
- [skew](DText.md#skew)
- [snippet](DText.md#snippet)
- [state](DText.md#state)
- [text](DText.md#text)
- [theme](DText.md#theme)
- [title](DText.md#title)
- [type](DText.md#type)
- [unsafe](DText.md#unsafe)
- [weight](DText.md#weight)
- [width](DText.md#width)
- [x](DText.md#x)
- [y](DText.md#y)

### Methods

- [\_calculateBounds](DText.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DText.md#_recursivepostupdatetransform)
- [\_render](DText.md#_render)
- [addChild](DText.md#addchild)
- [addChildAt](DText.md#addchildat)
- [addListener](DText.md#addlistener)
- [applyTitle](DText.md#applytitle)
- [blur](DText.md#blur)
- [calculateBounds](DText.md#calculatebounds)
- [computeTextValue](DText.md#computetextvalue)
- [containsGlobalPoint](DText.md#containsglobalpoint)
- [containsLocalPoint](DText.md#containslocalpoint)
- [containsPoint](DText.md#containspoint)
- [createOrUpdateText](DText.md#createorupdatetext)
- [createText](DText.md#createtext)
- [destroy](DText.md#destroy)
- [displayObjectUpdateTransform](DText.md#displayobjectupdatetransform)
- [emit](DText.md#emit)
- [eventNames](DText.md#eventnames)
- [focus](DText.md#focus)
- [focusOnClosest](DText.md#focusonclosest)
- [getBounds](DText.md#getbounds)
- [getChildAt](DText.md#getchildat)
- [getChildByName](DText.md#getchildbyname)
- [getChildIndex](DText.md#getchildindex)
- [getClearType](DText.md#getcleartype)
- [getClippingRect](DText.md#getclippingrect)
- [getGlobalPosition](DText.md#getglobalposition)
- [getHeight](DText.md#getheight)
- [getLocalBounds](DText.md#getlocalbounds)
- [getOverflowMask](DText.md#getoverflowmask)
- [getParentOfSize](DText.md#getparentofsize)
- [getTextAlpha](DText.md#gettextalpha)
- [getTextColor](DText.md#gettextcolor)
- [getThemeDefault](DText.md#getthemedefault)
- [getType](DText.md#gettype)
- [getWidth](DText.md#getwidth)
- [getX](DText.md#getx)
- [getY](DText.md#gety)
- [hasDirty](DText.md#hasdirty)
- [hasRefitableHeight](DText.md#hasrefitableheight)
- [hasRefitableWidth](DText.md#hasrefitablewidth)
- [hide](DText.md#hide)
- [hideText](DText.md#hidetext)
- [init](DText.md#init)
- [initReflowable](DText.md#initreflowable)
- [isDirty](DText.md#isdirty)
- [isEventTarget](DText.md#iseventtarget)
- [isHidden](DText.md#ishidden)
- [isHierarchyDirty](DText.md#ishierarchydirty)
- [isRefitable](DText.md#isrefitable)
- [isShown](DText.md#isshown)
- [listenerCount](DText.md#listenercount)
- [listeners](DText.md#listeners)
- [off](DText.md#off)
- [on](DText.md#on)
- [onBlur](DText.md#onblur)
- [onChildBlur](DText.md#onchildblur)
- [onChildFocus](DText.md#onchildfocus)
- [onChildrenChange](DText.md#onchildrenchange)
- [onDblClick](DText.md#ondblclick)
- [onDown](DText.md#ondown)
- [onDownThis](DText.md#ondownthis)
- [onFocus](DText.md#onfocus)
- [onHierarchyDirty](DText.md#onhierarchydirty)
- [onKeyDown](DText.md#onkeydown)
- [onKeyUp](DText.md#onkeyup)
- [onMove](DText.md#onmove)
- [onOut](DText.md#onout)
- [onOver](DText.md#onover)
- [onParentMove](DText.md#onparentmove)
- [onParentResize](DText.md#onparentresize)
- [onRefit](DText.md#onrefit)
- [onReflow](DText.md#onreflow)
- [onResize](DText.md#onresize)
- [onScale](DText.md#onscale)
- [onShortcut](DText.md#onshortcut)
- [onSkew](DText.md#onskew)
- [onStateChange](DText.md#onstatechange)
- [onTextChange](DText.md#ontextchange)
- [onUp](DText.md#onup)
- [onUpThis](DText.md#onupthis)
- [onWheel](DText.md#onwheel)
- [once](DText.md#once)
- [reflow](DText.md#reflow)
- [removeAllListeners](DText.md#removealllisteners)
- [removeChild](DText.md#removechild)
- [removeChildAt](DText.md#removechildat)
- [removeChildren](DText.md#removechildren)
- [removeListener](DText.md#removelistener)
- [render](DText.md#render)
- [renderAdvanced](DText.md#renderadvanced)
- [resize](DText.md#resize)
- [setChildIndex](DText.md#setchildindex)
- [setFocused](DText.md#setfocused)
- [setHeight](DText.md#setheight)
- [setParent](DText.md#setparent)
- [setTransform](DText.md#settransform)
- [setWidth](DText.md#setwidth)
- [setX](DText.md#setx)
- [setY](DText.md#sety)
- [show](DText.md#show)
- [showText](DText.md#showtext)
- [sortChildren](DText.md#sortchildren)
- [swapChildren](DText.md#swapchildren)
- [toCursor](DText.md#tocursor)
- [toDirty](DText.md#todirty)
- [toGlobal](DText.md#toglobal)
- [toHasDirty](DText.md#tohasdirty)
- [toHierarchyDirty](DText.md#tohierarchydirty)
- [toLocal](DText.md#tolocal)
- [toParentHasDirty](DText.md#toparenthasdirty)
- [toParentHierarchyDirty](DText.md#toparenthierarchydirty)
- [toParentResized](DText.md#toparentresized)
- [updateText](DText.md#updatetext)
- [updateTextColor](DText.md#updatetextcolor)
- [updateTextPosition](DText.md#updatetextposition)
- [updateTextValue](DText.md#updatetextvalue)
- [updateTransform](DText.md#updatetransform)
- [mixin](DText.md#mixin)

## Constructors

### constructor

• **new DText**<`VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeText`](../interfaces/DThemeText.md)<`VALUE`, `THEME`\> = [`DThemeText`](../interfaces/DThemeText.md)<`VALUE`\> |
| `OPTIONS` | extends [`DTextOptions`](../interfaces/DTextOptions.md)<`VALUE`, `THEME`, `OPTIONS`\> = [`DTextOptions`](../interfaces/DTextOptions.md)<`VALUE`, `THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DText`](DText.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DText`](DText.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DText`](DText.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-text.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-text.ts#L18)
...
▸ **hide**(): [`DText`](DText.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DText`](DText.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DText`](DText.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DText`](DText.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DText`](DText.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DText`](DText.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DText`](DText.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DText`](DText.md)<`VALUE`, `THEME`, `OPTIONS`\>
