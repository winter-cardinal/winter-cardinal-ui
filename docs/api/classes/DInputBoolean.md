[Winter Cardinal UI - v0.160.0](../index.md) / DInputBoolean

# Class: DInputBoolean<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeInputBoolean`](../interfaces/DThemeInputBoolean.md) = [`DThemeInputBoolean`](../interfaces/DThemeInputBoolean.md) |
| `OPTIONS` | extends [`DInputBooleanOptions`](../interfaces/DInputBooleanOptions.md)<`THEME`\> = [`DInputBooleanOptions`](../interfaces/DInputBooleanOptions.md)<`THEME`\> |
...
- [constructor](DInputBoolean.md#constructor)

### Properties

- [\_accessibleActive](DInputBoolean.md#_accessibleactive)
- [\_accessibleDiv](DInputBoolean.md#_accessiblediv)
- [\_auto](DInputBoolean.md#_auto)
- [\_background](DInputBoolean.md#_background)
- [\_border](DInputBoolean.md#_border)
- [\_bounds](DInputBoolean.md#_bounds)
- [\_buttonGroup](DInputBoolean.md#_buttongroup)
- [\_buttonOff](DInputBoolean.md#_buttonoff)
- [\_buttonOn](DInputBoolean.md#_buttonon)
- [\_clearType](DInputBoolean.md#_cleartype)
- [\_corner](DInputBoolean.md#_corner)
- [\_cornerAdjust](DInputBoolean.md#_corneradjust)
- [\_cursor](DInputBoolean.md#_cursor)
- [\_destroyed](DInputBoolean.md#_destroyed)
- [\_direction](DInputBoolean.md#_direction)
- [\_lastDownPoint](DInputBoolean.md#_lastdownpoint)
- [\_lastSortedIndex](DInputBoolean.md#_lastsortedindex)
- [\_margin](DInputBoolean.md#_margin)
- [\_mask](DInputBoolean.md#_mask)
- [\_multiplicity](DInputBoolean.md#_multiplicity)
- [\_options](DInputBoolean.md#_options)
- [\_outline](DInputBoolean.md#_outline)
- [\_padding](DInputBoolean.md#_padding)
- [\_reflowable](DInputBoolean.md#_reflowable)
- [\_reverse](DInputBoolean.md#_reverse)
- [\_shortcuts](DInputBoolean.md#_shortcuts)
- [\_snippet](DInputBoolean.md#_snippet)
- [\_tempDisplayObjectParent](DInputBoolean.md#_tempdisplayobjectparent)
- [\_title](DInputBoolean.md#_title)
- [\_zIndex](DInputBoolean.md#_zindex)
- [accessible](DInputBoolean.md#accessible)
- [accessibleChildren](DInputBoolean.md#accessiblechildren)
- [accessibleHint](DInputBoolean.md#accessiblehint)
- [accessiblePointerEvents](DInputBoolean.md#accessiblepointerevents)
- [accessibleTitle](DInputBoolean.md#accessibletitle)
- [accessibleType](DInputBoolean.md#accessibletype)
- [alpha](DInputBoolean.md#alpha)
- [angle](DInputBoolean.md#angle)
- [buttonMode](DInputBoolean.md#buttonmode)
- [cacheAsBitmap](DInputBoolean.md#cacheasbitmap)
- [children](DInputBoolean.md#children)
- [cursor](DInputBoolean.md#cursor)
- [filterArea](DInputBoolean.md#filterarea)
- [filters](DInputBoolean.md#filters)
- [hitArea](DInputBoolean.md#hitarea)
- [interactive](DInputBoolean.md#interactive)
- [interactiveChildren](DInputBoolean.md#interactivechildren)
- [isMask](DInputBoolean.md#ismask)
- [isSprite](DInputBoolean.md#issprite)
- [localTransform](DInputBoolean.md#localtransform)
- [mask](DInputBoolean.md#mask)
- [name](DInputBoolean.md#name)
- [parent](DInputBoolean.md#parent)
- [pivot](DInputBoolean.md#pivot)
- [renderable](DInputBoolean.md#renderable)
- [rotation](DInputBoolean.md#rotation)
- [sortDirty](DInputBoolean.md#sortdirty)
- [sortableChildren](DInputBoolean.md#sortablechildren)
- [transform](DInputBoolean.md#transform)
- [visible](DInputBoolean.md#visible)
- [worldAlpha](DInputBoolean.md#worldalpha)
- [worldTransform](DInputBoolean.md#worldtransform)
- [worldVisible](DInputBoolean.md#worldvisible)
- [zIndex](DInputBoolean.md#zindex)
- [CORNER\_ADJUST\_WORK](DInputBoolean.md#corner_adjust_work)
- [WORK\_CONTAINS\_POINT](DInputBoolean.md#work_contains_point)

### Accessors

- [background](DInputBoolean.md#background)
- [border](DInputBoolean.md#border)
- [corner](DInputBoolean.md#corner)
- [height](DInputBoolean.md#height)
- [margin](DInputBoolean.md#margin)
- [multiplicity](DInputBoolean.md#multiplicity)
- [outline](DInputBoolean.md#outline)
- [padding](DInputBoolean.md#padding)
- [position](DInputBoolean.md#position)
- [reflowable](DInputBoolean.md#reflowable)
- [scale](DInputBoolean.md#scale)
- [shadow](DInputBoolean.md#shadow)
- [skew](DInputBoolean.md#skew)
- [snippet](DInputBoolean.md#snippet)
- [state](DInputBoolean.md#state)
- [theme](DInputBoolean.md#theme)
- [title](DInputBoolean.md#title)
- [type](DInputBoolean.md#type)
- [unsafe](DInputBoolean.md#unsafe)
- [value](DInputBoolean.md#value)
- [weight](DInputBoolean.md#weight)
- [width](DInputBoolean.md#width)
- [x](DInputBoolean.md#x)
- [y](DInputBoolean.md#y)

### Methods

- [\_calculateBounds](DInputBoolean.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DInputBoolean.md#_recursivepostupdatetransform)
- [\_render](DInputBoolean.md#_render)
- [addChild](DInputBoolean.md#addchild)
- [addChildAt](DInputBoolean.md#addchildat)
- [addListener](DInputBoolean.md#addlistener)
- [addSpace](DInputBoolean.md#addspace)
- [applyTitle](DInputBoolean.md#applytitle)
- [blur](DInputBoolean.md#blur)
- [calcSpaceLeft](DInputBoolean.md#calcspaceleft)
- [calculateBounds](DInputBoolean.md#calculatebounds)
- [containsGlobalPoint](DInputBoolean.md#containsglobalpoint)
- [containsLocalPoint](DInputBoolean.md#containslocalpoint)
- [containsPoint](DInputBoolean.md#containspoint)
- [countColumn](DInputBoolean.md#countcolumn)
- [countRow](DInputBoolean.md#countrow)
- [destroy](DInputBoolean.md#destroy)
- [displayObjectUpdateTransform](DInputBoolean.md#displayobjectupdatetransform)
- [emit](DInputBoolean.md#emit)
- [eventNames](DInputBoolean.md#eventnames)
- [findColumnIndexNext](DInputBoolean.md#findcolumnindexnext)
- [findColumnIndexPrevious](DInputBoolean.md#findcolumnindexprevious)
- [findRowIndexNext](DInputBoolean.md#findrowindexnext)
- [findRowIndexPrevious](DInputBoolean.md#findrowindexprevious)
- [focus](DInputBoolean.md#focus)
- [focusOnClosest](DInputBoolean.md#focusonclosest)
- [getBounds](DInputBoolean.md#getbounds)
- [getButtonGroup](DInputBoolean.md#getbuttongroup)
- [getButtonOff](DInputBoolean.md#getbuttonoff)
- [getButtonOn](DInputBoolean.md#getbuttonon)
- [getChildAt](DInputBoolean.md#getchildat)
- [getChildByName](DInputBoolean.md#getchildbyname)
- [getChildIndex](DInputBoolean.md#getchildindex)
- [getClearType](DInputBoolean.md#getcleartype)
- [getClippingRect](DInputBoolean.md#getclippingrect)
- [getGlobalPosition](DInputBoolean.md#getglobalposition)
- [getHeight](DInputBoolean.md#getheight)
- [getLocalBounds](DInputBoolean.md#getlocalbounds)
- [getParentOfSize](DInputBoolean.md#getparentofsize)
- [getSpaceLeft](DInputBoolean.md#getspaceleft)
- [getThemeDefault](DInputBoolean.md#getthemedefault)
- [getType](DInputBoolean.md#gettype)
- [getWeightTotal](DInputBoolean.md#getweighttotal)
- [getWidth](DInputBoolean.md#getwidth)
- [getX](DInputBoolean.md#getx)
- [getY](DInputBoolean.md#gety)
- [hasClearType](DInputBoolean.md#hascleartype)
- [hasClearTypeAfter](DInputBoolean.md#hascleartypeafter)
- [hasClearTypeBefore](DInputBoolean.md#hascleartypebefore)
- [hasDirty](DInputBoolean.md#hasdirty)
- [hasRefitableHeight](DInputBoolean.md#hasrefitableheight)
- [hasRefitableWidth](DInputBoolean.md#hasrefitablewidth)
- [hide](DInputBoolean.md#hide)
- [init](DInputBoolean.md#init)
- [initReflowable](DInputBoolean.md#initreflowable)
- [isDirty](DInputBoolean.md#isdirty)
- [isEventTarget](DInputBoolean.md#iseventtarget)
- [isHidden](DInputBoolean.md#ishidden)
- [isHierarchyDirty](DInputBoolean.md#ishierarchydirty)
- [isRefitable](DInputBoolean.md#isrefitable)
- [isShown](DInputBoolean.md#isshown)
- [listenerCount](DInputBoolean.md#listenercount)
- [listeners](DInputBoolean.md#listeners)
- [newButtonGroup](DInputBoolean.md#newbuttongroup)
- [newButtonOff](DInputBoolean.md#newbuttonoff)
- [newButtonOn](DInputBoolean.md#newbuttonon)
- [off](DInputBoolean.md#off)
- [on](DInputBoolean.md#on)
- [onBlur](DInputBoolean.md#onblur)
- [onChildBlur](DInputBoolean.md#onchildblur)
- [onChildFocus](DInputBoolean.md#onchildfocus)
- [onChildrenChange](DInputBoolean.md#onchildrenchange)
- [onDblClick](DInputBoolean.md#ondblclick)
- [onDown](DInputBoolean.md#ondown)
- [onDownThis](DInputBoolean.md#ondownthis)
- [onFocus](DInputBoolean.md#onfocus)
- [onHierarchyDirty](DInputBoolean.md#onhierarchydirty)
- [onKeyDown](DInputBoolean.md#onkeydown)
- [onKeyUp](DInputBoolean.md#onkeyup)
- [onMove](DInputBoolean.md#onmove)
- [onOut](DInputBoolean.md#onout)
- [onOver](DInputBoolean.md#onover)
- [onParentMove](DInputBoolean.md#onparentmove)
- [onParentResize](DInputBoolean.md#onparentresize)
- [onRefit](DInputBoolean.md#onrefit)
- [onReflow](DInputBoolean.md#onreflow)
- [onResize](DInputBoolean.md#onresize)
- [onScale](DInputBoolean.md#onscale)
- [onShortcut](DInputBoolean.md#onshortcut)
- [onSkew](DInputBoolean.md#onskew)
- [onStateChange](DInputBoolean.md#onstatechange)
- [onUp](DInputBoolean.md#onup)
- [onUpThis](DInputBoolean.md#onupthis)
- [onWheel](DInputBoolean.md#onwheel)
- [once](DInputBoolean.md#once)
- [reflow](DInputBoolean.md#reflow)
- [removeAllListeners](DInputBoolean.md#removealllisteners)
- [removeChild](DInputBoolean.md#removechild)
- [removeChildAt](DInputBoolean.md#removechildat)
- [removeChildren](DInputBoolean.md#removechildren)
- [removeListener](DInputBoolean.md#removelistener)
- [render](DInputBoolean.md#render)
- [renderAdvanced](DInputBoolean.md#renderadvanced)
- [resize](DInputBoolean.md#resize)
- [setChildIndex](DInputBoolean.md#setchildindex)
- [setFocused](DInputBoolean.md#setfocused)
- [setHeight](DInputBoolean.md#setheight)
- [setParent](DInputBoolean.md#setparent)
- [setTransform](DInputBoolean.md#settransform)
- [setWidth](DInputBoolean.md#setwidth)
- [setX](DInputBoolean.md#setx)
- [setY](DInputBoolean.md#sety)
- [show](DInputBoolean.md#show)
- [sortChildren](DInputBoolean.md#sortchildren)
- [swapChildren](DInputBoolean.md#swapchildren)
- [toCornerMaskColumn](DInputBoolean.md#tocornermaskcolumn)
- [toCornerMaskRow](DInputBoolean.md#tocornermaskrow)
- [toCursor](DInputBoolean.md#tocursor)
- [toDirty](DInputBoolean.md#todirty)
- [toGlobal](DInputBoolean.md#toglobal)
- [toHasDirty](DInputBoolean.md#tohasdirty)
- [toHierarchyDirty](DInputBoolean.md#tohierarchydirty)
- [toLocal](DInputBoolean.md#tolocal)
- [toParentHasDirty](DInputBoolean.md#toparenthasdirty)
- [toParentHierarchyDirty](DInputBoolean.md#toparenthierarchydirty)
- [toParentResized](DInputBoolean.md#toparentresized)
- [updateTransform](DInputBoolean.md#updatetransform)
- [mixin](DInputBoolean.md#mixin)

## Constructors

### constructor

• **new DInputBoolean**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemeInputBoolean`](../interfaces/DThemeInputBoolean.md) = [`DThemeInputBoolean`](../interfaces/DThemeInputBoolean.md) |
| `OPTIONS` | extends [`DInputBooleanOptions`](../interfaces/DInputBooleanOptions.md)<`THEME`, `OPTIONS`\> = [`DInputBooleanOptions`](../interfaces/DInputBooleanOptions.md)<`THEME`\> |
...
[src/main/typescript/wcardinal/ui/d-input-boolean.ts:28](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-input-boolean.ts#L28)
...
• `Protected` `Optional` **\_buttonGroup**: [`DButtonGroup`](DButtonGroup.md)<[`DButtonBase`](DButtonBase.md)<`any`, `any`, `any`\>, [`DButtonGroupOptions`](../interfaces/DButtonGroupOptions.md)<[`DButtonBase`](DButtonBase.md)<`any`, `any`, `any`\>, `any`\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-input-boolean.ts:24](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-input-boolean.ts#L24)

___

### \_buttonOff

• `Protected` `Optional` **\_buttonOff**: [`DInputBooleanButtonOff`](DInputBooleanButtonOff.md)<[`DThemeInputBooleanButtonOff`](../interfaces/DThemeInputBooleanButtonOff.md), [`DInputBooleanButtonOffOptions`](../interfaces/DInputBooleanButtonOffOptions.md)<[`DThemeInputBooleanButtonOff`](../interfaces/DThemeInputBooleanButtonOff.md), `any`\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-input-boolean.ts:26](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-input-boolean.ts#L26)

___

### \_buttonOn

• `Protected` `Optional` **\_buttonOn**: [`DInputBooleanButtonOn`](DInputBooleanButtonOn.md)<[`DThemeInputBooleanButtonOn`](../interfaces/DThemeInputBooleanButtonOn.md), [`DInputBooleanButtonOnOptions`](../interfaces/DInputBooleanButtonOnOptions.md)<[`DThemeInputBooleanButtonOn`](../interfaces/DThemeInputBooleanButtonOn.md), `any`\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-input-boolean.ts:25](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-input-boolean.ts#L25)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:126](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L126)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:128](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L128)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:125](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L125)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:127](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L127)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:129](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L129)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:123](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L123)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:142](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L142)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:146](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L146)
...
[src/main/typescript/wcardinal/ui/d-input-boolean.ts:90](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-input-boolean.ts#L90)
...
[src/main/typescript/wcardinal/ui/d-input-boolean.ts:94](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-input-boolean.ts#L94)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DInputBoolean`](DInputBoolean.md)<`THEME`, `OPTIONS`\>
...
[`DInputBoolean`](DInputBoolean.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-layout.ts:804](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L804)
...
▸ **blur**(`recursively?`): [`DInputBoolean`](DInputBoolean.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-layout.ts:261](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L261)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:760](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L760)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:718](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L718)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:699](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L699)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:686](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L686)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:741](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L741)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:728](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L728)

___

### focus

▸ **focus**(): [`DInputBoolean`](DInputBoolean.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **getButtonGroup**(): [`DButtonGroup`](DButtonGroup.md)<[`DButtonBase`](DButtonBase.md)<`any`, `any`, `any`\>, [`DButtonGroupOptions`](../interfaces/DButtonGroupOptions.md)<[`DButtonBase`](DButtonBase.md)<`any`, `any`, `any`\>, `any`\>\>

#### Returns

[`DButtonGroup`](DButtonGroup.md)<[`DButtonBase`](DButtonBase.md)<`any`, `any`, `any`\>, [`DButtonGroupOptions`](../interfaces/DButtonGroupOptions.md)<[`DButtonBase`](DButtonBase.md)<`any`, `any`, `any`\>, `any`\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-input-boolean.ts:44](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-input-boolean.ts#L44)

___

### getButtonOff

▸ `Protected` **getButtonOff**(): [`DInputBooleanButtonOff`](DInputBooleanButtonOff.md)<[`DThemeInputBooleanButtonOff`](../interfaces/DThemeInputBooleanButtonOff.md), [`DInputBooleanButtonOffOptions`](../interfaces/DInputBooleanButtonOffOptions.md)<[`DThemeInputBooleanButtonOff`](../interfaces/DThemeInputBooleanButtonOff.md), `any`\>\>

#### Returns

[`DInputBooleanButtonOff`](DInputBooleanButtonOff.md)<[`DThemeInputBooleanButtonOff`](../interfaces/DThemeInputBooleanButtonOff.md), [`DInputBooleanButtonOffOptions`](../interfaces/DInputBooleanButtonOffOptions.md)<[`DThemeInputBooleanButtonOff`](../interfaces/DThemeInputBooleanButtonOff.md), `any`\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-input-boolean.ts:73](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-input-boolean.ts#L73)

___

### getButtonOn

▸ `Protected` **getButtonOn**(): [`DInputBooleanButtonOn`](DInputBooleanButtonOn.md)<[`DThemeInputBooleanButtonOn`](../interfaces/DThemeInputBooleanButtonOn.md), [`DInputBooleanButtonOnOptions`](../interfaces/DInputBooleanButtonOnOptions.md)<[`DThemeInputBooleanButtonOn`](../interfaces/DThemeInputBooleanButtonOn.md), `any`\>\>

#### Returns

[`DInputBooleanButtonOn`](DInputBooleanButtonOn.md)<[`DThemeInputBooleanButtonOn`](../interfaces/DThemeInputBooleanButtonOn.md), [`DInputBooleanButtonOnOptions`](../interfaces/DInputBooleanButtonOnOptions.md)<[`DThemeInputBooleanButtonOn`](../interfaces/DThemeInputBooleanButtonOn.md), `any`\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-input-boolean.ts:57](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-input-boolean.ts#L57)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:184](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L184)
...
[src/main/typescript/wcardinal/ui/d-input-boolean.ts:104](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-input-boolean.ts#L104)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:150](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L150)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:669](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L669)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:665](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L665)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:661](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L661)
...
▸ **hide**(): [`DInputBoolean`](DInputBoolean.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-layout.ts:131](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L131)
...
▸ `Protected` **newButtonGroup**(): [`DButtonGroup`](DButtonGroup.md)<[`DButtonBase`](DButtonBase.md)<`any`, `any`, `any`\>, [`DButtonGroupOptions`](../interfaces/DButtonGroupOptions.md)<[`DButtonBase`](DButtonBase.md)<`any`, `any`, `any`\>, `any`\>\>
...
[src/main/typescript/wcardinal/ui/d-input-boolean.ts:53](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-input-boolean.ts#L53)

___

### newButtonOff

▸ `Protected` **newButtonOff**(): [`DInputBooleanButtonOff`](DInputBooleanButtonOff.md)<[`DThemeInputBooleanButtonOff`](../interfaces/DThemeInputBooleanButtonOff.md), [`DInputBooleanButtonOffOptions`](../interfaces/DInputBooleanButtonOffOptions.md)<[`DThemeInputBooleanButtonOff`](../interfaces/DThemeInputBooleanButtonOff.md), `any`\>\>
...
[src/main/typescript/wcardinal/ui/d-input-boolean.ts:82](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-input-boolean.ts#L82)

___

### newButtonOn

▸ `Protected` **newButtonOn**(): [`DInputBooleanButtonOn`](DInputBooleanButtonOn.md)<[`DThemeInputBooleanButtonOn`](../interfaces/DThemeInputBooleanButtonOn.md), [`DInputBooleanButtonOnOptions`](../interfaces/DInputBooleanButtonOnOptions.md)<[`DThemeInputBooleanButtonOn`](../interfaces/DThemeInputBooleanButtonOn.md), `any`\>\>
...
[src/main/typescript/wcardinal/ui/d-input-boolean.ts:66](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-input-boolean.ts#L66)

___

### off

▸ **off**(`event`, `fn?`, `context?`): [`DInputBoolean`](DInputBoolean.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DInputBoolean`](DInputBoolean.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-layout.ts:265](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L265)
...
▸ **once**(`event`, `fn`, `context?`): [`DInputBoolean`](DInputBoolean.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DInputBoolean`](DInputBoolean.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DInputBoolean`](DInputBoolean.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DInputBoolean`](DInputBoolean.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DInputBoolean`](DInputBoolean.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-layout.ts:770](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L770)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:787](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-layout.ts#L787)
