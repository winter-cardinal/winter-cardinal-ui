[Winter Cardinal UI - v0.407.0](../index.md) / DPickerDatetimeSpace
...
- [\_boundsID](DPickerDatetimeSpace.md#_boundsid)
- [\_boundsRect](DPickerDatetimeSpace.md#_boundsrect)
...
- [\_enabledFilters](DPickerDatetimeSpace.md#_enabledfilters)
- [\_lastDownPoint](DPickerDatetimeSpace.md#_lastdownpoint)
- [\_lastSortedIndex](DPickerDatetimeSpace.md#_lastsortedindex)
- [\_localBounds](DPickerDatetimeSpace.md#_localbounds)
- [\_localBoundsRect](DPickerDatetimeSpace.md#_localboundsrect)
...
- [options](DPickerDatetimeSpace.md#options)
...
- [containerUpdateTransform](DPickerDatetimeSpace.md#containerupdatetransform)
...
- [disableTempParent](DPickerDatetimeSpace.md#disabletempparent)
- [displayObjectUpdateTransform](DPickerDatetimeSpace.md#displayobjectupdatetransform)
- [emit](DPickerDatetimeSpace.md#emit)
- [enableTempParent](DPickerDatetimeSpace.md#enabletempparent)
...
- [newPadding](DPickerDatetimeSpace.md#newpadding)
...
• **new DPickerDatetimeSpace**\<`THEME`, `OPTIONS`\>(`options?`): [`DPickerDatetimeSpace`](DPickerDatetimeSpace.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-picker-datetime-space.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-picker-datetime-space.ts#L18)
...
[src/main/typescript/wcardinal/ui/d-picker-datetime-space.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-picker-datetime-space.ts#L23)
...
▸ **setFocused**(`isFocused`): [`DPickerDatetimeSpace`](DPickerDatetimeSpace.md)\<`THEME`, `OPTIONS`\>
