[Winter Cardinal UI - v0.407.0](../index.md) / DButtonCheck
...
- [\_boundsID](DButtonCheck.md#_boundsid)
- [\_boundsRect](DButtonCheck.md#_boundsrect)
...
- [\_enabledFilters](DButtonCheck.md#_enabledfilters)
- [\_image](DButtonCheck.md#_image)
...
- [\_localBounds](DButtonCheck.md#_localbounds)
- [\_localBoundsRect](DButtonCheck.md#_localboundsrect)
...
- [containerUpdateTransform](DButtonCheck.md#containerupdatetransform)
...
- [disableTempParent](DButtonCheck.md#disabletempparent)
- [displayObjectUpdateTransform](DButtonCheck.md#displayobjectupdatetransform)
- [emit](DButtonCheck.md#emit)
- [enableTempParent](DButtonCheck.md#enabletempparent)
...
- [getImage](DButtonCheck.md#getimage)
- [getLayouter](DButtonCheck.md#getlayouter)
...
- [getText](DButtonCheck.md#gettext)
...
- [newOverflowMask](DButtonCheck.md#newoverflowmask)
- [newPadding](DButtonCheck.md#newpadding)
- [newText](DButtonCheck.md#newtext)
...
- [onReflowTextAndImage](DButtonCheck.md#onreflowtextandimage)
...
• **new DButtonCheck**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DButtonCheck`](DButtonCheck.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-check.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-check.ts#L20)
...
▸ **setFocused**(`isFocused`): [`DButtonCheck`](DButtonCheck.md)\<`VALUE`, `THEME`, `OPTIONS`\>
