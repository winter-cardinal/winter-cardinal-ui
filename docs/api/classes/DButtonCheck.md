[Winter Cardinal UI - v0.310.1](../index.md) / DButtonCheck
...
- [\_isGrouped](DButtonCheck.md#_isgrouped)
...
- [isGrouped](DButtonCheck.md#isgrouped)
...
- [activate](DButtonCheck.md#activate)
...
- [onPress](DButtonCheck.md#onpress)
...
- [onUnpress](DButtonCheck.md#onunpress)
...
[src/main/typescript/wcardinal/ui/d-button-check.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-check.ts#L20)
