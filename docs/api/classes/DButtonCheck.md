[Winter Cardinal UI - v0.167.0](../index.md) / DButtonCheck

# Class: DButtonCheck<VALUE, THEME, OPTIONS\>
...
- [`DButtonBase`](DButtonBase.md)<`VALUE`, `THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DButtonCheckRight`](DButtonCheckRight.md)

  ↳↳ [`DTableBodyCellCheck`](DTableBodyCellCheck.md)

## Table of contents

### Constructors

- [constructor](DButtonCheck.md#constructor)

### Properties

- [\_accessibleActive](DButtonCheck.md#_accessibleactive)
- [\_accessibleDiv](DButtonCheck.md#_accessiblediv)
- [\_auto](DButtonCheck.md#_auto)
- [\_background](DButtonCheck.md#_background)
- [\_border](DButtonCheck.md#_border)
- [\_bounds](DButtonCheck.md#_bounds)
- [\_clearType](DButtonCheck.md#_cleartype)
- [\_corner](DButtonCheck.md#_corner)
- [\_cursor](DButtonCheck.md#_cursor)
- [\_destroyed](DButtonCheck.md#_destroyed)
- [\_images](DButtonCheck.md#_images)
- [\_isOverflowMaskEnabled](DButtonCheck.md#_isoverflowmaskenabled)
- [\_isTextVisible](DButtonCheck.md#_istextvisible)
- [\_isToggle](DButtonCheck.md#_istoggle)
- [\_lastDownPoint](DButtonCheck.md#_lastdownpoint)
- [\_lastSortedIndex](DButtonCheck.md#_lastsortedindex)
- [\_mask](DButtonCheck.md#_mask)
- [\_options](DButtonCheck.md#_options)
- [\_outline](DButtonCheck.md#_outline)
- [\_overflowMask](DButtonCheck.md#_overflowmask)
- [\_padding](DButtonCheck.md#_padding)
- [\_reflowable](DButtonCheck.md#_reflowable)
- [\_shortcuts](DButtonCheck.md#_shortcuts)
- [\_snippet](DButtonCheck.md#_snippet)
- [\_tempDisplayObjectParent](DButtonCheck.md#_tempdisplayobjectparent)
- [\_text](DButtonCheck.md#_text)
- [\_textAlign](DButtonCheck.md#_textalign)
- [\_textAlpha](DButtonCheck.md#_textalpha)
- [\_textColor](DButtonCheck.md#_textcolor)
- [\_textFormatter](DButtonCheck.md#_textformatter)
- [\_textStyle](DButtonCheck.md#_textstyle)
- [\_textValue](DButtonCheck.md#_textvalue)
- [\_textValueComputed](DButtonCheck.md#_textvaluecomputed)
- [\_title](DButtonCheck.md#_title)
- [\_when](DButtonCheck.md#_when)
- [\_zIndex](DButtonCheck.md#_zindex)
- [accessible](DButtonCheck.md#accessible)
- [accessibleChildren](DButtonCheck.md#accessiblechildren)
- [accessibleHint](DButtonCheck.md#accessiblehint)
- [accessiblePointerEvents](DButtonCheck.md#accessiblepointerevents)
- [accessibleTitle](DButtonCheck.md#accessibletitle)
- [accessibleType](DButtonCheck.md#accessibletype)
- [alpha](DButtonCheck.md#alpha)
- [angle](DButtonCheck.md#angle)
- [buttonMode](DButtonCheck.md#buttonmode)
- [cacheAsBitmap](DButtonCheck.md#cacheasbitmap)
- [children](DButtonCheck.md#children)
- [cursor](DButtonCheck.md#cursor)
- [filterArea](DButtonCheck.md#filterarea)
- [filters](DButtonCheck.md#filters)
- [hitArea](DButtonCheck.md#hitarea)
- [interactive](DButtonCheck.md#interactive)
- [interactiveChildren](DButtonCheck.md#interactivechildren)
- [isMask](DButtonCheck.md#ismask)
- [isSprite](DButtonCheck.md#issprite)
- [localTransform](DButtonCheck.md#localtransform)
- [mask](DButtonCheck.md#mask)
- [name](DButtonCheck.md#name)
- [parent](DButtonCheck.md#parent)
- [pivot](DButtonCheck.md#pivot)
- [renderable](DButtonCheck.md#renderable)
- [rotation](DButtonCheck.md#rotation)
- [sortDirty](DButtonCheck.md#sortdirty)
- [sortableChildren](DButtonCheck.md#sortablechildren)
- [transform](DButtonCheck.md#transform)
- [visible](DButtonCheck.md#visible)
- [worldAlpha](DButtonCheck.md#worldalpha)
- [worldTransform](DButtonCheck.md#worldtransform)
- [worldVisible](DButtonCheck.md#worldvisible)
- [zIndex](DButtonCheck.md#zindex)
- [LAYOUTER](DButtonCheck.md#layouter)
- [WORK\_CONTAINS\_POINT](DButtonCheck.md#work_contains_point)

### Accessors

- [background](DButtonCheck.md#background)
- [border](DButtonCheck.md#border)
- [corner](DButtonCheck.md#corner)
- [height](DButtonCheck.md#height)
- [image](DButtonCheck.md#image)
- [isToggle](DButtonCheck.md#istoggle)
- [outline](DButtonCheck.md#outline)
- [padding](DButtonCheck.md#padding)
- [position](DButtonCheck.md#position)
- [reflowable](DButtonCheck.md#reflowable)
- [scale](DButtonCheck.md#scale)
- [shadow](DButtonCheck.md#shadow)
- [skew](DButtonCheck.md#skew)
- [snippet](DButtonCheck.md#snippet)
- [state](DButtonCheck.md#state)
- [text](DButtonCheck.md#text)
- [theme](DButtonCheck.md#theme)
- [title](DButtonCheck.md#title)
- [type](DButtonCheck.md#type)
- [unsafe](DButtonCheck.md#unsafe)
- [weight](DButtonCheck.md#weight)
- [width](DButtonCheck.md#width)
- [x](DButtonCheck.md#x)
- [y](DButtonCheck.md#y)

### Methods

- [\_calculateBounds](DButtonCheck.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DButtonCheck.md#_recursivepostupdatetransform)
- [\_render](DButtonCheck.md#_render)
- [addChild](DButtonCheck.md#addchild)
- [addChildAt](DButtonCheck.md#addchildat)
- [addListener](DButtonCheck.md#addlistener)
- [applyTitle](DButtonCheck.md#applytitle)
- [blur](DButtonCheck.md#blur)
- [calculateBounds](DButtonCheck.md#calculatebounds)
- [computeTextValue](DButtonCheck.md#computetextvalue)
- [containsGlobalPoint](DButtonCheck.md#containsglobalpoint)
- [containsLocalPoint](DButtonCheck.md#containslocalpoint)
- [containsPoint](DButtonCheck.md#containspoint)
- [createOrUpdateText](DButtonCheck.md#createorupdatetext)
- [createText](DButtonCheck.md#createtext)
- [destroy](DButtonCheck.md#destroy)
- [displayObjectUpdateTransform](DButtonCheck.md#displayobjectupdatetransform)
- [emit](DButtonCheck.md#emit)
- [eventNames](DButtonCheck.md#eventnames)
- [focus](DButtonCheck.md#focus)
- [focusOnClosest](DButtonCheck.md#focusonclosest)
- [getBounds](DButtonCheck.md#getbounds)
- [getChildAt](DButtonCheck.md#getchildat)
- [getChildByName](DButtonCheck.md#getchildbyname)
- [getChildIndex](DButtonCheck.md#getchildindex)
- [getClearType](DButtonCheck.md#getcleartype)
- [getClippingRect](DButtonCheck.md#getclippingrect)
- [getGlobalPosition](DButtonCheck.md#getglobalposition)
- [getHeight](DButtonCheck.md#getheight)
- [getLocalBounds](DButtonCheck.md#getlocalbounds)
- [getOverflowMask](DButtonCheck.md#getoverflowmask)
- [getParentOfSize](DButtonCheck.md#getparentofsize)
- [getTextAlpha](DButtonCheck.md#gettextalpha)
- [getTextColor](DButtonCheck.md#gettextcolor)
- [getThemeDefault](DButtonCheck.md#getthemedefault)
- [getType](DButtonCheck.md#gettype)
- [getWidth](DButtonCheck.md#getwidth)
- [getX](DButtonCheck.md#getx)
- [getY](DButtonCheck.md#gety)
- [hasDirty](DButtonCheck.md#hasdirty)
- [hasRefitableHeight](DButtonCheck.md#hasrefitableheight)
- [hasRefitableWidth](DButtonCheck.md#hasrefitablewidth)
- [hide](DButtonCheck.md#hide)
- [hideText](DButtonCheck.md#hidetext)
- [init](DButtonCheck.md#init)
- [initOnClick](DButtonCheck.md#initonclick)
- [initOnPress](DButtonCheck.md#initonpress)
- [initReflowable](DButtonCheck.md#initreflowable)
- [isDirty](DButtonCheck.md#isdirty)
- [isEventTarget](DButtonCheck.md#iseventtarget)
- [isHidden](DButtonCheck.md#ishidden)
- [isHierarchyDirty](DButtonCheck.md#ishierarchydirty)
- [isRefitable](DButtonCheck.md#isrefitable)
- [isShown](DButtonCheck.md#isshown)
- [listenerCount](DButtonCheck.md#listenercount)
- [listeners](DButtonCheck.md#listeners)
- [newImage](DButtonCheck.md#newimage)
- [newImages](DButtonCheck.md#newimages)
- [off](DButtonCheck.md#off)
- [on](DButtonCheck.md#on)
- [onActivate](DButtonCheck.md#onactivate)
- [onActivateKeyDown](DButtonCheck.md#onactivatekeydown)
- [onActivateKeyUp](DButtonCheck.md#onactivatekeyup)
- [onBlur](DButtonCheck.md#onblur)
- [onChildBlur](DButtonCheck.md#onchildblur)
- [onChildFocus](DButtonCheck.md#onchildfocus)
- [onChildrenChange](DButtonCheck.md#onchildrenchange)
- [onClick](DButtonCheck.md#onclick)
- [onDblClick](DButtonCheck.md#ondblclick)
- [onDown](DButtonCheck.md#ondown)
- [onDownThis](DButtonCheck.md#ondownthis)
- [onFocus](DButtonCheck.md#onfocus)
- [onHierarchyDirty](DButtonCheck.md#onhierarchydirty)
- [onInactivate](DButtonCheck.md#oninactivate)
- [onKeyDown](DButtonCheck.md#onkeydown)
- [onKeyUp](DButtonCheck.md#onkeyup)
- [onMove](DButtonCheck.md#onmove)
- [onOut](DButtonCheck.md#onout)
- [onOver](DButtonCheck.md#onover)
- [onParentMove](DButtonCheck.md#onparentmove)
- [onParentResize](DButtonCheck.md#onparentresize)
- [onRefit](DButtonCheck.md#onrefit)
- [onReflow](DButtonCheck.md#onreflow)
- [onResize](DButtonCheck.md#onresize)
- [onScale](DButtonCheck.md#onscale)
- [onShortcut](DButtonCheck.md#onshortcut)
- [onSkew](DButtonCheck.md#onskew)
- [onStateChange](DButtonCheck.md#onstatechange)
- [onTextChange](DButtonCheck.md#ontextchange)
- [onToggleEnd](DButtonCheck.md#ontoggleend)
- [onToggleStart](DButtonCheck.md#ontogglestart)
- [onUp](DButtonCheck.md#onup)
- [onUpThis](DButtonCheck.md#onupthis)
- [onWheel](DButtonCheck.md#onwheel)
- [once](DButtonCheck.md#once)
- [reflow](DButtonCheck.md#reflow)
- [removeAllListeners](DButtonCheck.md#removealllisteners)
- [removeChild](DButtonCheck.md#removechild)
- [removeChildAt](DButtonCheck.md#removechildat)
- [removeChildren](DButtonCheck.md#removechildren)
- [removeListener](DButtonCheck.md#removelistener)
- [render](DButtonCheck.md#render)
- [renderAdvanced](DButtonCheck.md#renderadvanced)
- [resize](DButtonCheck.md#resize)
- [setChildIndex](DButtonCheck.md#setchildindex)
- [setFocused](DButtonCheck.md#setfocused)
- [setHeight](DButtonCheck.md#setheight)
- [setParent](DButtonCheck.md#setparent)
- [setTransform](DButtonCheck.md#settransform)
- [setWidth](DButtonCheck.md#setwidth)
- [setX](DButtonCheck.md#setx)
- [setY](DButtonCheck.md#sety)
- [show](DButtonCheck.md#show)
- [showText](DButtonCheck.md#showtext)
- [sortChildren](DButtonCheck.md#sortchildren)
- [swapChildren](DButtonCheck.md#swapchildren)
- [toCursor](DButtonCheck.md#tocursor)
- [toDirty](DButtonCheck.md#todirty)
- [toGlobal](DButtonCheck.md#toglobal)
- [toHasDirty](DButtonCheck.md#tohasdirty)
- [toHierarchyDirty](DButtonCheck.md#tohierarchydirty)
- [toImageOptions](DButtonCheck.md#toimageoptions)
- [toLocal](DButtonCheck.md#tolocal)
- [toParentHasDirty](DButtonCheck.md#toparenthasdirty)
- [toParentHierarchyDirty](DButtonCheck.md#toparenthierarchydirty)
- [toParentResized](DButtonCheck.md#toparentresized)
- [toggle](DButtonCheck.md#toggle)
- [updateText](DButtonCheck.md#updatetext)
- [updateTextAndImage](DButtonCheck.md#updatetextandimage)
- [updateTextColor](DButtonCheck.md#updatetextcolor)
- [updateTextPosition](DButtonCheck.md#updatetextposition)
- [updateTextValue](DButtonCheck.md#updatetextvalue)
- [updateTransform](DButtonCheck.md#updatetransform)
- [mixin](DButtonCheck.md#mixin)

## Constructors

### constructor

• **new DButtonCheck**<`VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DButtonCheck`](DButtonCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DButtonCheck`](DButtonCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DButtonCheck`](DButtonCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-check.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-check.ts#L20)
...
▸ **hide**(): [`DButtonCheck`](DButtonCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DButtonCheck`](DButtonCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DButtonCheck`](DButtonCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DButtonCheck`](DButtonCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DButtonCheck`](DButtonCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DButtonCheck`](DButtonCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DButtonCheck`](DButtonCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DButtonCheck`](DButtonCheck.md)<`VALUE`, `THEME`, `OPTIONS`\>
