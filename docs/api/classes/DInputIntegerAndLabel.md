[Winter Cardinal UI - v0.407.0](../index.md) / DInputIntegerAndLabel
...
[src/main/typescript/wcardinal/ui/d-input-integer-and-label.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-input-integer-and-label.ts#L17)
...
▸ **setFocused**(`isFocused`): [`DInputIntegerAndLabel`](DInputIntegerAndLabel.md)\<`THEME`, `OPTIONS`\>
