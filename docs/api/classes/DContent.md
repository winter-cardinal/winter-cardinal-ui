[Winter Cardinal UI - v0.160.0](../index.md) / DContent

# Class: DContent

## Hierarchy

- [`DBase`](DBase.md)<[`DThemeContent`](../interfaces/DThemeContent.md), [`DContentOptions`](../interfaces/DContentOptions.md)\>
...
- [constructor](DContent.md#constructor)

### Properties

- [\_accessibleActive](DContent.md#_accessibleactive)
- [\_accessibleDiv](DContent.md#_accessiblediv)
- [\_auto](DContent.md#_auto)
- [\_background](DContent.md#_background)
- [\_border](DContent.md#_border)
- [\_bounds](DContent.md#_bounds)
- [\_clearType](DContent.md#_cleartype)
- [\_corner](DContent.md#_corner)
- [\_cursor](DContent.md#_cursor)
- [\_destroyed](DContent.md#_destroyed)
- [\_lastDownPoint](DContent.md#_lastdownpoint)
- [\_lastSortedIndex](DContent.md#_lastsortedindex)
- [\_mask](DContent.md#_mask)
- [\_options](DContent.md#_options)
- [\_outline](DContent.md#_outline)
- [\_padding](DContent.md#_padding)
- [\_reflowable](DContent.md#_reflowable)
- [\_shortcuts](DContent.md#_shortcuts)
- [\_snippet](DContent.md#_snippet)
- [\_tempDisplayObjectParent](DContent.md#_tempdisplayobjectparent)
- [\_title](DContent.md#_title)
- [\_zIndex](DContent.md#_zindex)
- [accessible](DContent.md#accessible)
- [accessibleChildren](DContent.md#accessiblechildren)
- [accessibleHint](DContent.md#accessiblehint)
- [accessiblePointerEvents](DContent.md#accessiblepointerevents)
- [accessibleTitle](DContent.md#accessibletitle)
- [accessibleType](DContent.md#accessibletype)
- [alpha](DContent.md#alpha)
- [angle](DContent.md#angle)
- [buttonMode](DContent.md#buttonmode)
- [cacheAsBitmap](DContent.md#cacheasbitmap)
- [children](DContent.md#children)
- [cursor](DContent.md#cursor)
- [filterArea](DContent.md#filterarea)
- [filters](DContent.md#filters)
- [hitArea](DContent.md#hitarea)
- [interactive](DContent.md#interactive)
- [interactiveChildren](DContent.md#interactivechildren)
- [isMask](DContent.md#ismask)
- [isSprite](DContent.md#issprite)
- [localTransform](DContent.md#localtransform)
- [mask](DContent.md#mask)
- [name](DContent.md#name)
- [parent](DContent.md#parent)
- [pivot](DContent.md#pivot)
- [renderable](DContent.md#renderable)
- [rotation](DContent.md#rotation)
- [sortDirty](DContent.md#sortdirty)
- [sortableChildren](DContent.md#sortablechildren)
- [transform](DContent.md#transform)
- [visible](DContent.md#visible)
- [worldAlpha](DContent.md#worldalpha)
- [worldTransform](DContent.md#worldtransform)
- [worldVisible](DContent.md#worldvisible)
- [zIndex](DContent.md#zindex)
- [WORK\_CONTAINS\_POINT](DContent.md#work_contains_point)

### Accessors

- [background](DContent.md#background)
- [border](DContent.md#border)
- [corner](DContent.md#corner)
- [height](DContent.md#height)
- [outline](DContent.md#outline)
- [padding](DContent.md#padding)
- [position](DContent.md#position)
- [reflowable](DContent.md#reflowable)
- [scale](DContent.md#scale)
- [shadow](DContent.md#shadow)
- [skew](DContent.md#skew)
- [snippet](DContent.md#snippet)
- [state](DContent.md#state)
- [theme](DContent.md#theme)
- [title](DContent.md#title)
- [type](DContent.md#type)
- [unsafe](DContent.md#unsafe)
- [weight](DContent.md#weight)
- [width](DContent.md#width)
- [x](DContent.md#x)
- [y](DContent.md#y)

### Methods

- [\_calculateBounds](DContent.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DContent.md#_recursivepostupdatetransform)
- [\_render](DContent.md#_render)
- [addChild](DContent.md#addchild)
- [addChildAt](DContent.md#addchildat)
- [addListener](DContent.md#addlistener)
- [applyTitle](DContent.md#applytitle)
- [blur](DContent.md#blur)
- [calculateBounds](DContent.md#calculatebounds)
- [containsGlobalPoint](DContent.md#containsglobalpoint)
- [containsLocalPoint](DContent.md#containslocalpoint)
- [containsPoint](DContent.md#containspoint)
- [destroy](DContent.md#destroy)
- [displayObjectUpdateTransform](DContent.md#displayobjectupdatetransform)
- [emit](DContent.md#emit)
- [eventNames](DContent.md#eventnames)
- [focus](DContent.md#focus)
- [focusOnClosest](DContent.md#focusonclosest)
- [getBounds](DContent.md#getbounds)
- [getChildAt](DContent.md#getchildat)
- [getChildByName](DContent.md#getchildbyname)
- [getChildIndex](DContent.md#getchildindex)
- [getClearType](DContent.md#getcleartype)
- [getClippingRect](DContent.md#getclippingrect)
- [getGlobalPosition](DContent.md#getglobalposition)
- [getHeight](DContent.md#getheight)
- [getLocalBounds](DContent.md#getlocalbounds)
- [getParentOfSize](DContent.md#getparentofsize)
- [getThemeDefault](DContent.md#getthemedefault)
- [getType](DContent.md#gettype)
- [getWidth](DContent.md#getwidth)
- [getX](DContent.md#getx)
- [getY](DContent.md#gety)
- [hasDirty](DContent.md#hasdirty)
- [hasRefitableHeight](DContent.md#hasrefitableheight)
- [hasRefitableWidth](DContent.md#hasrefitablewidth)
- [hide](DContent.md#hide)
- [init](DContent.md#init)
- [initReflowable](DContent.md#initreflowable)
- [isDirty](DContent.md#isdirty)
- [isEventTarget](DContent.md#iseventtarget)
- [isHidden](DContent.md#ishidden)
- [isHierarchyDirty](DContent.md#ishierarchydirty)
- [isRefitable](DContent.md#isrefitable)
- [isShown](DContent.md#isshown)
- [listenerCount](DContent.md#listenercount)
- [listeners](DContent.md#listeners)
- [off](DContent.md#off)
- [on](DContent.md#on)
- [onBlur](DContent.md#onblur)
- [onChildBlur](DContent.md#onchildblur)
- [onChildFocus](DContent.md#onchildfocus)
- [onChildrenChange](DContent.md#onchildrenchange)
- [onDblClick](DContent.md#ondblclick)
- [onDown](DContent.md#ondown)
- [onDownThis](DContent.md#ondownthis)
- [onFocus](DContent.md#onfocus)
- [onHierarchyDirty](DContent.md#onhierarchydirty)
- [onKeyDown](DContent.md#onkeydown)
- [onKeyUp](DContent.md#onkeyup)
- [onMove](DContent.md#onmove)
- [onOut](DContent.md#onout)
- [onOver](DContent.md#onover)
- [onParentMove](DContent.md#onparentmove)
- [onParentResize](DContent.md#onparentresize)
- [onRefit](DContent.md#onrefit)
- [onReflow](DContent.md#onreflow)
- [onResize](DContent.md#onresize)
- [onScale](DContent.md#onscale)
- [onShortcut](DContent.md#onshortcut)
- [onSkew](DContent.md#onskew)
- [onStateChange](DContent.md#onstatechange)
- [onUp](DContent.md#onup)
- [onUpThis](DContent.md#onupthis)
- [onWheel](DContent.md#onwheel)
- [once](DContent.md#once)
- [reflow](DContent.md#reflow)
- [removeAllListeners](DContent.md#removealllisteners)
- [removeChild](DContent.md#removechild)
- [removeChildAt](DContent.md#removechildat)
- [removeChildren](DContent.md#removechildren)
- [removeListener](DContent.md#removelistener)
- [render](DContent.md#render)
- [renderAdvanced](DContent.md#renderadvanced)
- [resize](DContent.md#resize)
- [setChildIndex](DContent.md#setchildindex)
- [setFocused](DContent.md#setfocused)
- [setHeight](DContent.md#setheight)
- [setParent](DContent.md#setparent)
- [setTransform](DContent.md#settransform)
- [setWidth](DContent.md#setwidth)
- [setX](DContent.md#setx)
- [setY](DContent.md#sety)
- [show](DContent.md#show)
- [sortChildren](DContent.md#sortchildren)
- [swapChildren](DContent.md#swapchildren)
- [toCursor](DContent.md#tocursor)
- [toDirty](DContent.md#todirty)
- [toGlobal](DContent.md#toglobal)
- [toHasDirty](DContent.md#tohasdirty)
- [toHierarchyDirty](DContent.md#tohierarchydirty)
- [toLocal](DContent.md#tolocal)
- [toParentHasDirty](DContent.md#toparenthasdirty)
- [toParentHierarchyDirty](DContent.md#toparenthierarchydirty)
- [toParentResized](DContent.md#toparentresized)
- [updateTransform](DContent.md#updatetransform)
- [mixin](DContent.md#mixin)

## Constructors

### constructor

• **new DContent**(`options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `options?` | [`DContentOptions`](../interfaces/DContentOptions.md) |
...
• `Protected` **\_options**: `undefined` \| [`DContentOptions`](../interfaces/DContentOptions.md)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DContent`](DContent.md)
...
▸ **blur**(`recursively?`): [`DContent`](DContent.md)
...
▸ `Protected` **getThemeDefault**(): [`DThemeContent`](../interfaces/DThemeContent.md)
...
[src/main/typescript/wcardinal/ui/d-content.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-content.ts#L17)
...
[src/main/typescript/wcardinal/ui/d-content.ts:13](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-content.ts#L13)
...
▸ **off**(`event`, `fn?`, `context?`): [`DContent`](DContent.md)
...
▸ **on**(`event`, `fn`, `context?`): [`DContent`](DContent.md)
...
▸ **once**(`event`, `fn`, `context?`): [`DContent`](DContent.md)
...
▸ **removeAllListeners**(`event?`): [`DContent`](DContent.md)
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DContent`](DContent.md)
...
▸ `Protected` **setFocused**(`isFocused`): [`DContent`](DContent.md)
