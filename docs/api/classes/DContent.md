[Winter Cardinal UI - v0.407.0](../index.md) / DContent
...
- [containerUpdateTransform](DContent.md#containerupdatetransform)
...
- [disableTempParent](DContent.md#disabletempparent)
- [displayObjectUpdateTransform](DContent.md#displayobjectupdatetransform)
- [emit](DContent.md#emit)
- [enableTempParent](DContent.md#enabletempparent)
...
- [newPadding](DContent.md#newpadding)
- [off](DContent.md#off)
- [on](DContent.md#on)
...
• **new DContent**(`options?`): [`DContent`](DContent.md)
...
▸ **getThemeDefault**(): [`DThemeContent`](../interfaces/DThemeContent.md)
...
[src/main/typescript/wcardinal/ui/d-content.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-content.ts#L17)
...
[src/main/typescript/wcardinal/ui/d-content.ts:13](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-content.ts#L13)
...
| Name | Type |
| :------ | :------ |
| `theme` | [`DThemeContent`](../interfaces/DThemeContent.md) |
| `options?` | [`DContentOptions`](../interfaces/DContentOptions.md) |
| `callback?` | () => `void` |
...
▸ **setFocused**(`isFocused`): [`DContent`](DContent.md)
