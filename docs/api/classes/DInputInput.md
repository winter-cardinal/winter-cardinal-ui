[Winter Cardinal UI - v0.414.0](../index.md) / DInputInput
...
- [\_boundsID](DInputInput.md#_boundsid)
- [\_boundsRect](DInputInput.md#_boundsrect)
...
- [\_enabledFilters](DInputInput.md#_enabledfilters)
- [\_image](DInputInput.md#_image)
- [\_lastDownPoint](DInputInput.md#_lastdownpoint)
- [\_lastSortedIndex](DInputInput.md#_lastsortedindex)
- [\_localBounds](DInputInput.md#_localbounds)
- [\_localBoundsRect](DInputInput.md#_localboundsrect)
...
- [containerUpdateTransform](DInputInput.md#containerupdatetransform)
...
- [disableTempParent](DInputInput.md#disabletempparent)
- [displayObjectUpdateTransform](DInputInput.md#displayobjectupdatetransform)
- [emit](DInputInput.md#emit)
- [enableTempParent](DInputInput.md#enabletempparent)
...
- [getImage](DInputInput.md#getimage)
- [getLayouter](DInputInput.md#getlayouter)
...
- [getText](DInputInput.md#gettext)
...
- [newOverflowMask](DInputInput.md#newoverflowmask)
- [newPadding](DInputInput.md#newpadding)
- [newText](DInputInput.md#newtext)
...
- [onReflowTextAndImage](DInputInput.md#onreflowtextandimage)
...
• **new DInputInput**\<`VALUE`, `THEME`, `OPTIONS`, `UTIL`\>(`options?`): [`DInputInput`](DInputInput.md)\<`VALUE`, `THEME`, `OPTIONS`, `UTIL`\>
...
[DInput](DInput.md).[_boundsID](DInput.md#_boundsid)
...
[DInput](DInput.md).[_boundsRect](DInput.md#_boundsrect)
...
[DInput](DInput.md).[_enabledFilters](DInput.md#_enabledfilters)
...
[DInput](DInput.md).[_image](DInput.md#_image)
...
[DInput](DInput.md).[_localBounds](DInput.md#_localbounds)
...
[DInput](DInput.md).[_localBoundsRect](DInput.md#_localboundsrect)
...
[DInput](DInput.md).[containerUpdateTransform](DInput.md#containerupdatetransform)
...
[DInput](DInput.md).[disableTempParent](DInput.md#disabletempparent)
...
[DInput](DInput.md).[enableTempParent](DInput.md#enabletempparent)
...
[DInput](DInput.md).[getImage](DInput.md#getimage)
...
[DInput](DInput.md).[getLayouter](DInput.md#getlayouter)
...
[DInput](DInput.md).[getText](DInput.md#gettext)
...
[src/main/typescript/wcardinal/ui/d-input-input.ts:29](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-input-input.ts#L29)
...
▸ **newOperation**(): [`UtilInputOperation`](../interfaces/UtilInputOperation.md)\<`VALUE`, `HTMLInputElement`\>
...
[DInput](DInput.md).[newOverflowMask](DInput.md#newoverflowmask)
...
[DInput](DInput.md).[newPadding](DInput.md#newpadding)
...
[DInput](DInput.md).[newText](DInput.md#newtext)
...
[src/main/typescript/wcardinal/ui/d-html-element.ts:50](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-html-element.ts#L50)
...
[DInput](DInput.md).[onReflowTextAndImage](DInput.md#onreflowtextandimage)
