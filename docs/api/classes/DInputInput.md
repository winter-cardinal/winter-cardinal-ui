[Winter Cardinal UI - v0.407.0](../index.md) / DInputInput
...
[src/main/typescript/wcardinal/ui/d-input-input.ts:29](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-input-input.ts#L29)
...
▸ **setFocused**(`isFocused`): [`DInputInput`](DInputInput.md)\<`VALUE`, `THEME`, `OPTIONS`, `UTIL`\>
