[Winter Cardinal UI - v0.407.0](../index.md) / DButtonPrimary
...
- [\_boundsID](DButtonPrimary.md#_boundsid)
- [\_boundsRect](DButtonPrimary.md#_boundsrect)
...
- [\_enabledFilters](DButtonPrimary.md#_enabledfilters)
- [\_image](DButtonPrimary.md#_image)
...
- [\_localBounds](DButtonPrimary.md#_localbounds)
- [\_localBoundsRect](DButtonPrimary.md#_localboundsrect)
...
- [containerUpdateTransform](DButtonPrimary.md#containerupdatetransform)
...
- [disableTempParent](DButtonPrimary.md#disabletempparent)
- [displayObjectUpdateTransform](DButtonPrimary.md#displayobjectupdatetransform)
- [emit](DButtonPrimary.md#emit)
- [enableTempParent](DButtonPrimary.md#enabletempparent)
...
- [getImage](DButtonPrimary.md#getimage)
- [getLayouter](DButtonPrimary.md#getlayouter)
...
- [getText](DButtonPrimary.md#gettext)
...
- [newOverflowMask](DButtonPrimary.md#newoverflowmask)
...
- [onReflowTextAndImage](DButtonPrimary.md#onreflowtextandimage)
...
[src/main/typescript/wcardinal/ui/d-button-primary.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-primary.ts#L20)
