[Winter Cardinal UI - v0.167.0](../index.md) / DButtonPrimary

# Class: DButtonPrimary<VALUE, THEME, OPTIONS\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeButtonPrimary`](../interfaces/DThemeButtonPrimary.md)<`VALUE`\> = [`DThemeButtonPrimary`](../interfaces/DThemeButtonPrimary.md)<`VALUE`\> |
| `OPTIONS` | extends [`DButtonPrimaryOptions`](../interfaces/DButtonPrimaryOptions.md)<`VALUE`, `THEME`\> = [`DButtonPrimaryOptions`](../interfaces/DButtonPrimaryOptions.md)<`VALUE`, `THEME`\> |
...
- [constructor](DButtonPrimary.md#constructor)

### Properties

- [\_accessibleActive](DButtonPrimary.md#_accessibleactive)
- [\_accessibleDiv](DButtonPrimary.md#_accessiblediv)
- [\_auto](DButtonPrimary.md#_auto)
- [\_background](DButtonPrimary.md#_background)
- [\_border](DButtonPrimary.md#_border)
- [\_bounds](DButtonPrimary.md#_bounds)
- [\_clearType](DButtonPrimary.md#_cleartype)
- [\_corner](DButtonPrimary.md#_corner)
- [\_cursor](DButtonPrimary.md#_cursor)
- [\_destroyed](DButtonPrimary.md#_destroyed)
- [\_images](DButtonPrimary.md#_images)
- [\_isOverflowMaskEnabled](DButtonPrimary.md#_isoverflowmaskenabled)
- [\_isTextVisible](DButtonPrimary.md#_istextvisible)
- [\_isToggle](DButtonPrimary.md#_istoggle)
- [\_lastDownPoint](DButtonPrimary.md#_lastdownpoint)
- [\_lastSortedIndex](DButtonPrimary.md#_lastsortedindex)
- [\_mask](DButtonPrimary.md#_mask)
- [\_options](DButtonPrimary.md#_options)
- [\_outline](DButtonPrimary.md#_outline)
- [\_overflowMask](DButtonPrimary.md#_overflowmask)
- [\_padding](DButtonPrimary.md#_padding)
- [\_reflowable](DButtonPrimary.md#_reflowable)
- [\_shortcuts](DButtonPrimary.md#_shortcuts)
- [\_snippet](DButtonPrimary.md#_snippet)
- [\_tempDisplayObjectParent](DButtonPrimary.md#_tempdisplayobjectparent)
- [\_text](DButtonPrimary.md#_text)
- [\_textAlign](DButtonPrimary.md#_textalign)
- [\_textAlpha](DButtonPrimary.md#_textalpha)
- [\_textColor](DButtonPrimary.md#_textcolor)
- [\_textFormatter](DButtonPrimary.md#_textformatter)
- [\_textStyle](DButtonPrimary.md#_textstyle)
- [\_textValue](DButtonPrimary.md#_textvalue)
- [\_textValueComputed](DButtonPrimary.md#_textvaluecomputed)
- [\_title](DButtonPrimary.md#_title)
- [\_when](DButtonPrimary.md#_when)
- [\_zIndex](DButtonPrimary.md#_zindex)
- [accessible](DButtonPrimary.md#accessible)
- [accessibleChildren](DButtonPrimary.md#accessiblechildren)
- [accessibleHint](DButtonPrimary.md#accessiblehint)
- [accessiblePointerEvents](DButtonPrimary.md#accessiblepointerevents)
- [accessibleTitle](DButtonPrimary.md#accessibletitle)
- [accessibleType](DButtonPrimary.md#accessibletype)
- [alpha](DButtonPrimary.md#alpha)
- [angle](DButtonPrimary.md#angle)
- [buttonMode](DButtonPrimary.md#buttonmode)
- [cacheAsBitmap](DButtonPrimary.md#cacheasbitmap)
- [children](DButtonPrimary.md#children)
- [cursor](DButtonPrimary.md#cursor)
- [filterArea](DButtonPrimary.md#filterarea)
- [filters](DButtonPrimary.md#filters)
- [hitArea](DButtonPrimary.md#hitarea)
- [interactive](DButtonPrimary.md#interactive)
- [interactiveChildren](DButtonPrimary.md#interactivechildren)
- [isMask](DButtonPrimary.md#ismask)
- [isSprite](DButtonPrimary.md#issprite)
- [localTransform](DButtonPrimary.md#localtransform)
- [mask](DButtonPrimary.md#mask)
- [name](DButtonPrimary.md#name)
- [parent](DButtonPrimary.md#parent)
- [pivot](DButtonPrimary.md#pivot)
- [renderable](DButtonPrimary.md#renderable)
- [rotation](DButtonPrimary.md#rotation)
- [sortDirty](DButtonPrimary.md#sortdirty)
- [sortableChildren](DButtonPrimary.md#sortablechildren)
- [transform](DButtonPrimary.md#transform)
- [visible](DButtonPrimary.md#visible)
- [worldAlpha](DButtonPrimary.md#worldalpha)
- [worldTransform](DButtonPrimary.md#worldtransform)
- [worldVisible](DButtonPrimary.md#worldvisible)
- [zIndex](DButtonPrimary.md#zindex)
- [LAYOUTER](DButtonPrimary.md#layouter)
- [WORK\_CONTAINS\_POINT](DButtonPrimary.md#work_contains_point)

### Accessors

- [background](DButtonPrimary.md#background)
- [border](DButtonPrimary.md#border)
- [corner](DButtonPrimary.md#corner)
- [height](DButtonPrimary.md#height)
- [image](DButtonPrimary.md#image)
- [isToggle](DButtonPrimary.md#istoggle)
- [outline](DButtonPrimary.md#outline)
- [padding](DButtonPrimary.md#padding)
- [position](DButtonPrimary.md#position)
- [reflowable](DButtonPrimary.md#reflowable)
- [scale](DButtonPrimary.md#scale)
- [shadow](DButtonPrimary.md#shadow)
- [skew](DButtonPrimary.md#skew)
- [snippet](DButtonPrimary.md#snippet)
- [state](DButtonPrimary.md#state)
- [text](DButtonPrimary.md#text)
- [theme](DButtonPrimary.md#theme)
- [title](DButtonPrimary.md#title)
- [type](DButtonPrimary.md#type)
- [unsafe](DButtonPrimary.md#unsafe)
- [weight](DButtonPrimary.md#weight)
- [width](DButtonPrimary.md#width)
- [x](DButtonPrimary.md#x)
- [y](DButtonPrimary.md#y)

### Methods

- [\_calculateBounds](DButtonPrimary.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DButtonPrimary.md#_recursivepostupdatetransform)
- [\_render](DButtonPrimary.md#_render)
- [addChild](DButtonPrimary.md#addchild)
- [addChildAt](DButtonPrimary.md#addchildat)
- [addListener](DButtonPrimary.md#addlistener)
- [applyTitle](DButtonPrimary.md#applytitle)
- [blur](DButtonPrimary.md#blur)
- [calculateBounds](DButtonPrimary.md#calculatebounds)
- [computeTextValue](DButtonPrimary.md#computetextvalue)
- [containsGlobalPoint](DButtonPrimary.md#containsglobalpoint)
- [containsLocalPoint](DButtonPrimary.md#containslocalpoint)
- [containsPoint](DButtonPrimary.md#containspoint)
- [createOrUpdateText](DButtonPrimary.md#createorupdatetext)
- [createText](DButtonPrimary.md#createtext)
- [destroy](DButtonPrimary.md#destroy)
- [displayObjectUpdateTransform](DButtonPrimary.md#displayobjectupdatetransform)
- [emit](DButtonPrimary.md#emit)
- [eventNames](DButtonPrimary.md#eventnames)
- [focus](DButtonPrimary.md#focus)
- [focusOnClosest](DButtonPrimary.md#focusonclosest)
- [getBounds](DButtonPrimary.md#getbounds)
- [getChildAt](DButtonPrimary.md#getchildat)
- [getChildByName](DButtonPrimary.md#getchildbyname)
- [getChildIndex](DButtonPrimary.md#getchildindex)
- [getClearType](DButtonPrimary.md#getcleartype)
- [getClippingRect](DButtonPrimary.md#getclippingrect)
- [getGlobalPosition](DButtonPrimary.md#getglobalposition)
- [getHeight](DButtonPrimary.md#getheight)
- [getLocalBounds](DButtonPrimary.md#getlocalbounds)
- [getOverflowMask](DButtonPrimary.md#getoverflowmask)
- [getParentOfSize](DButtonPrimary.md#getparentofsize)
- [getTextAlpha](DButtonPrimary.md#gettextalpha)
- [getTextColor](DButtonPrimary.md#gettextcolor)
- [getThemeDefault](DButtonPrimary.md#getthemedefault)
- [getType](DButtonPrimary.md#gettype)
- [getWidth](DButtonPrimary.md#getwidth)
- [getX](DButtonPrimary.md#getx)
- [getY](DButtonPrimary.md#gety)
- [hasDirty](DButtonPrimary.md#hasdirty)
- [hasRefitableHeight](DButtonPrimary.md#hasrefitableheight)
- [hasRefitableWidth](DButtonPrimary.md#hasrefitablewidth)
- [hide](DButtonPrimary.md#hide)
- [hideText](DButtonPrimary.md#hidetext)
- [init](DButtonPrimary.md#init)
- [initOnClick](DButtonPrimary.md#initonclick)
- [initOnPress](DButtonPrimary.md#initonpress)
- [initReflowable](DButtonPrimary.md#initreflowable)
- [isDirty](DButtonPrimary.md#isdirty)
- [isEventTarget](DButtonPrimary.md#iseventtarget)
- [isHidden](DButtonPrimary.md#ishidden)
- [isHierarchyDirty](DButtonPrimary.md#ishierarchydirty)
- [isRefitable](DButtonPrimary.md#isrefitable)
- [isShown](DButtonPrimary.md#isshown)
- [listenerCount](DButtonPrimary.md#listenercount)
- [listeners](DButtonPrimary.md#listeners)
- [newImage](DButtonPrimary.md#newimage)
- [newImages](DButtonPrimary.md#newimages)
- [off](DButtonPrimary.md#off)
- [on](DButtonPrimary.md#on)
- [onActivate](DButtonPrimary.md#onactivate)
- [onActivateKeyDown](DButtonPrimary.md#onactivatekeydown)
- [onActivateKeyUp](DButtonPrimary.md#onactivatekeyup)
- [onBlur](DButtonPrimary.md#onblur)
- [onChildBlur](DButtonPrimary.md#onchildblur)
- [onChildFocus](DButtonPrimary.md#onchildfocus)
- [onChildrenChange](DButtonPrimary.md#onchildrenchange)
- [onClick](DButtonPrimary.md#onclick)
- [onDblClick](DButtonPrimary.md#ondblclick)
- [onDown](DButtonPrimary.md#ondown)
- [onDownThis](DButtonPrimary.md#ondownthis)
- [onFocus](DButtonPrimary.md#onfocus)
- [onHierarchyDirty](DButtonPrimary.md#onhierarchydirty)
- [onInactivate](DButtonPrimary.md#oninactivate)
- [onKeyDown](DButtonPrimary.md#onkeydown)
- [onKeyUp](DButtonPrimary.md#onkeyup)
- [onMove](DButtonPrimary.md#onmove)
- [onOut](DButtonPrimary.md#onout)
- [onOver](DButtonPrimary.md#onover)
- [onParentMove](DButtonPrimary.md#onparentmove)
- [onParentResize](DButtonPrimary.md#onparentresize)
- [onRefit](DButtonPrimary.md#onrefit)
- [onReflow](DButtonPrimary.md#onreflow)
- [onResize](DButtonPrimary.md#onresize)
- [onScale](DButtonPrimary.md#onscale)
- [onShortcut](DButtonPrimary.md#onshortcut)
- [onSkew](DButtonPrimary.md#onskew)
- [onStateChange](DButtonPrimary.md#onstatechange)
- [onTextChange](DButtonPrimary.md#ontextchange)
- [onToggleEnd](DButtonPrimary.md#ontoggleend)
- [onToggleStart](DButtonPrimary.md#ontogglestart)
- [onUp](DButtonPrimary.md#onup)
- [onUpThis](DButtonPrimary.md#onupthis)
- [onWheel](DButtonPrimary.md#onwheel)
- [once](DButtonPrimary.md#once)
- [reflow](DButtonPrimary.md#reflow)
- [removeAllListeners](DButtonPrimary.md#removealllisteners)
- [removeChild](DButtonPrimary.md#removechild)
- [removeChildAt](DButtonPrimary.md#removechildat)
- [removeChildren](DButtonPrimary.md#removechildren)
- [removeListener](DButtonPrimary.md#removelistener)
- [render](DButtonPrimary.md#render)
- [renderAdvanced](DButtonPrimary.md#renderadvanced)
- [resize](DButtonPrimary.md#resize)
- [setChildIndex](DButtonPrimary.md#setchildindex)
- [setFocused](DButtonPrimary.md#setfocused)
- [setHeight](DButtonPrimary.md#setheight)
- [setParent](DButtonPrimary.md#setparent)
- [setTransform](DButtonPrimary.md#settransform)
- [setWidth](DButtonPrimary.md#setwidth)
- [setX](DButtonPrimary.md#setx)
- [setY](DButtonPrimary.md#sety)
- [show](DButtonPrimary.md#show)
- [showText](DButtonPrimary.md#showtext)
- [sortChildren](DButtonPrimary.md#sortchildren)
- [swapChildren](DButtonPrimary.md#swapchildren)
- [toCursor](DButtonPrimary.md#tocursor)
- [toDirty](DButtonPrimary.md#todirty)
- [toGlobal](DButtonPrimary.md#toglobal)
- [toHasDirty](DButtonPrimary.md#tohasdirty)
- [toHierarchyDirty](DButtonPrimary.md#tohierarchydirty)
- [toImageOptions](DButtonPrimary.md#toimageoptions)
- [toLocal](DButtonPrimary.md#tolocal)
- [toParentHasDirty](DButtonPrimary.md#toparenthasdirty)
- [toParentHierarchyDirty](DButtonPrimary.md#toparenthierarchydirty)
- [toParentResized](DButtonPrimary.md#toparentresized)
- [toggle](DButtonPrimary.md#toggle)
- [updateText](DButtonPrimary.md#updatetext)
- [updateTextAndImage](DButtonPrimary.md#updatetextandimage)
- [updateTextColor](DButtonPrimary.md#updatetextcolor)
- [updateTextPosition](DButtonPrimary.md#updatetextposition)
- [updateTextValue](DButtonPrimary.md#updatetextvalue)
- [updateTransform](DButtonPrimary.md#updatetransform)
- [mixin](DButtonPrimary.md#mixin)

## Constructors

### constructor

• **new DButtonPrimary**<`VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeButtonPrimary`](../interfaces/DThemeButtonPrimary.md)<`VALUE`, `THEME`\> = [`DThemeButtonPrimary`](../interfaces/DThemeButtonPrimary.md)<`VALUE`\> |
| `OPTIONS` | extends [`DButtonPrimaryOptions`](../interfaces/DButtonPrimaryOptions.md)<`VALUE`, `THEME`, `OPTIONS`\> = [`DButtonPrimaryOptions`](../interfaces/DButtonPrimaryOptions.md)<`VALUE`, `THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DButtonPrimary`](DButtonPrimary.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[`DButtonPrimary`](DButtonPrimary.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DButtonPrimary`](DButtonPrimary.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DButtonPrimary`](DButtonPrimary.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-primary.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-primary.ts#L20)
...
▸ **hide**(): [`DButtonPrimary`](DButtonPrimary.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DButtonPrimary`](DButtonPrimary.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DButtonPrimary`](DButtonPrimary.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DButtonPrimary`](DButtonPrimary.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DButtonPrimary`](DButtonPrimary.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DButtonPrimary`](DButtonPrimary.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DButtonPrimary`](DButtonPrimary.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DButtonPrimary`](DButtonPrimary.md)<`VALUE`, `THEME`, `OPTIONS`\>
