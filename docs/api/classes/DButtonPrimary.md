[Winter Cardinal UI - v0.310.1](../index.md) / DButtonPrimary
...
- [\_isGrouped](DButtonPrimary.md#_isgrouped)
...
- [isGrouped](DButtonPrimary.md#isgrouped)
...
- [activate](DButtonPrimary.md#activate)
...
- [onPress](DButtonPrimary.md#onpress)
...
- [onUnpress](DButtonPrimary.md#onunpress)
...
[src/main/typescript/wcardinal/ui/d-button-primary.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-primary.ts#L20)
