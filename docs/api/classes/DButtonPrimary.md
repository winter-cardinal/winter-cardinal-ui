[Winter Cardinal UI - v0.374.0](../index.md) / DButtonPrimary
...
- [newPadding](DButtonPrimary.md#newpadding)
- [newText](DButtonPrimary.md#newtext)
...
• **new DButtonPrimary**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DButtonPrimary`](DButtonPrimary.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DButtonPrimary`](DButtonPrimary.md)\<`VALUE`, `THEME`, `OPTIONS`\>
