[Winter Cardinal UI - v0.160.0](../index.md) / DChartLegend

# Class: DChartLegend<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeChartLegend`](../interfaces/DThemeChartLegend.md) = [`DThemeChartLegend`](../interfaces/DThemeChartLegend.md) |
| `OPTIONS` | extends [`DChartLegendOptions`](../interfaces/DChartLegendOptions.md)<`THEME`\> = [`DChartLegendOptions`](../interfaces/DChartLegendOptions.md)<`THEME`\> |
...
- [constructor](DChartLegend.md#constructor)

### Properties

- [\_accessibleActive](DChartLegend.md#_accessibleactive)
- [\_accessibleDiv](DChartLegend.md#_accessiblediv)
- [\_auto](DChartLegend.md#_auto)
- [\_background](DChartLegend.md#_background)
- [\_border](DChartLegend.md#_border)
- [\_bounds](DChartLegend.md#_bounds)
- [\_clearType](DChartLegend.md#_cleartype)
- [\_corner](DChartLegend.md#_corner)
- [\_cursor](DChartLegend.md#_cursor)
- [\_destroyed](DChartLegend.md#_destroyed)
- [\_lastDownPoint](DChartLegend.md#_lastdownpoint)
- [\_lastSortedIndex](DChartLegend.md#_lastsortedindex)
- [\_mask](DChartLegend.md#_mask)
- [\_options](DChartLegend.md#_options)
- [\_outline](DChartLegend.md#_outline)
- [\_padding](DChartLegend.md#_padding)
- [\_reflowable](DChartLegend.md#_reflowable)
- [\_shortcuts](DChartLegend.md#_shortcuts)
- [\_snippet](DChartLegend.md#_snippet)
- [\_tempDisplayObjectParent](DChartLegend.md#_tempdisplayobjectparent)
- [\_title](DChartLegend.md#_title)
- [\_zIndex](DChartLegend.md#_zindex)
- [accessible](DChartLegend.md#accessible)
- [accessibleChildren](DChartLegend.md#accessiblechildren)
- [accessibleHint](DChartLegend.md#accessiblehint)
- [accessiblePointerEvents](DChartLegend.md#accessiblepointerevents)
- [accessibleTitle](DChartLegend.md#accessibletitle)
- [accessibleType](DChartLegend.md#accessibletype)
- [alpha](DChartLegend.md#alpha)
- [angle](DChartLegend.md#angle)
- [buttonMode](DChartLegend.md#buttonmode)
- [cacheAsBitmap](DChartLegend.md#cacheasbitmap)
- [children](DChartLegend.md#children)
- [cursor](DChartLegend.md#cursor)
- [filterArea](DChartLegend.md#filterarea)
- [filters](DChartLegend.md#filters)
- [hitArea](DChartLegend.md#hitarea)
- [interactive](DChartLegend.md#interactive)
- [interactiveChildren](DChartLegend.md#interactivechildren)
- [isMask](DChartLegend.md#ismask)
- [isSprite](DChartLegend.md#issprite)
- [localTransform](DChartLegend.md#localtransform)
- [mask](DChartLegend.md#mask)
- [name](DChartLegend.md#name)
- [parent](DChartLegend.md#parent)
- [pivot](DChartLegend.md#pivot)
- [renderable](DChartLegend.md#renderable)
- [rotation](DChartLegend.md#rotation)
- [sortDirty](DChartLegend.md#sortdirty)
- [sortableChildren](DChartLegend.md#sortablechildren)
- [transform](DChartLegend.md#transform)
- [visible](DChartLegend.md#visible)
- [worldAlpha](DChartLegend.md#worldalpha)
- [worldTransform](DChartLegend.md#worldtransform)
- [worldVisible](DChartLegend.md#worldvisible)
- [zIndex](DChartLegend.md#zindex)
- [WORK\_CONTAINS\_POINT](DChartLegend.md#work_contains_point)

### Accessors

- [background](DChartLegend.md#background)
- [border](DChartLegend.md#border)
- [corner](DChartLegend.md#corner)
- [height](DChartLegend.md#height)
- [outline](DChartLegend.md#outline)
- [padding](DChartLegend.md#padding)
- [position](DChartLegend.md#position)
- [reflowable](DChartLegend.md#reflowable)
- [scale](DChartLegend.md#scale)
- [shadow](DChartLegend.md#shadow)
- [skew](DChartLegend.md#skew)
- [snippet](DChartLegend.md#snippet)
- [state](DChartLegend.md#state)
- [theme](DChartLegend.md#theme)
- [title](DChartLegend.md#title)
- [type](DChartLegend.md#type)
- [unsafe](DChartLegend.md#unsafe)
- [weight](DChartLegend.md#weight)
- [width](DChartLegend.md#width)
- [x](DChartLegend.md#x)
- [y](DChartLegend.md#y)

### Methods

- [\_calculateBounds](DChartLegend.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DChartLegend.md#_recursivepostupdatetransform)
- [\_render](DChartLegend.md#_render)
- [addChild](DChartLegend.md#addchild)
- [addChildAt](DChartLegend.md#addchildat)
- [addListener](DChartLegend.md#addlistener)
- [applyTitle](DChartLegend.md#applytitle)
- [blur](DChartLegend.md#blur)
- [calculateBounds](DChartLegend.md#calculatebounds)
- [containsGlobalPoint](DChartLegend.md#containsglobalpoint)
- [containsLocalPoint](DChartLegend.md#containslocalpoint)
- [containsPoint](DChartLegend.md#containspoint)
- [destroy](DChartLegend.md#destroy)
- [displayObjectUpdateTransform](DChartLegend.md#displayobjectupdatetransform)
- [emit](DChartLegend.md#emit)
- [eventNames](DChartLegend.md#eventnames)
- [focus](DChartLegend.md#focus)
- [focusOnClosest](DChartLegend.md#focusonclosest)
- [getBounds](DChartLegend.md#getbounds)
- [getChildAt](DChartLegend.md#getchildat)
- [getChildByName](DChartLegend.md#getchildbyname)
- [getChildIndex](DChartLegend.md#getchildindex)
- [getClearType](DChartLegend.md#getcleartype)
- [getClippingRect](DChartLegend.md#getclippingrect)
- [getGlobalPosition](DChartLegend.md#getglobalposition)
- [getHeight](DChartLegend.md#getheight)
- [getLocalBounds](DChartLegend.md#getlocalbounds)
- [getParentOfSize](DChartLegend.md#getparentofsize)
- [getThemeDefault](DChartLegend.md#getthemedefault)
- [getType](DChartLegend.md#gettype)
- [getWidth](DChartLegend.md#getwidth)
- [getX](DChartLegend.md#getx)
- [getY](DChartLegend.md#gety)
- [hasDirty](DChartLegend.md#hasdirty)
- [hasRefitableHeight](DChartLegend.md#hasrefitableheight)
- [hasRefitableWidth](DChartLegend.md#hasrefitablewidth)
- [hide](DChartLegend.md#hide)
- [init](DChartLegend.md#init)
- [initReflowable](DChartLegend.md#initreflowable)
- [isDirty](DChartLegend.md#isdirty)
- [isEventTarget](DChartLegend.md#iseventtarget)
- [isHidden](DChartLegend.md#ishidden)
- [isHierarchyDirty](DChartLegend.md#ishierarchydirty)
- [isRefitable](DChartLegend.md#isrefitable)
- [isShown](DChartLegend.md#isshown)
- [listenerCount](DChartLegend.md#listenercount)
- [listeners](DChartLegend.md#listeners)
- [off](DChartLegend.md#off)
- [on](DChartLegend.md#on)
- [onBlur](DChartLegend.md#onblur)
- [onChildBlur](DChartLegend.md#onchildblur)
- [onChildFocus](DChartLegend.md#onchildfocus)
- [onChildrenChange](DChartLegend.md#onchildrenchange)
- [onDblClick](DChartLegend.md#ondblclick)
- [onDown](DChartLegend.md#ondown)
- [onDownThis](DChartLegend.md#ondownthis)
- [onFocus](DChartLegend.md#onfocus)
- [onHierarchyDirty](DChartLegend.md#onhierarchydirty)
- [onKeyDown](DChartLegend.md#onkeydown)
- [onKeyUp](DChartLegend.md#onkeyup)
- [onMove](DChartLegend.md#onmove)
- [onOut](DChartLegend.md#onout)
- [onOver](DChartLegend.md#onover)
- [onParentMove](DChartLegend.md#onparentmove)
- [onParentResize](DChartLegend.md#onparentresize)
- [onRefit](DChartLegend.md#onrefit)
- [onReflow](DChartLegend.md#onreflow)
- [onResize](DChartLegend.md#onresize)
- [onScale](DChartLegend.md#onscale)
- [onShortcut](DChartLegend.md#onshortcut)
- [onSkew](DChartLegend.md#onskew)
- [onStateChange](DChartLegend.md#onstatechange)
- [onUp](DChartLegend.md#onup)
- [onUpThis](DChartLegend.md#onupthis)
- [onWheel](DChartLegend.md#onwheel)
- [once](DChartLegend.md#once)
- [reflow](DChartLegend.md#reflow)
- [removeAllListeners](DChartLegend.md#removealllisteners)
- [removeChild](DChartLegend.md#removechild)
- [removeChildAt](DChartLegend.md#removechildat)
- [removeChildren](DChartLegend.md#removechildren)
- [removeListener](DChartLegend.md#removelistener)
- [render](DChartLegend.md#render)
- [renderAdvanced](DChartLegend.md#renderadvanced)
- [resize](DChartLegend.md#resize)
- [setChildIndex](DChartLegend.md#setchildindex)
- [setFocused](DChartLegend.md#setfocused)
- [setHeight](DChartLegend.md#setheight)
- [setParent](DChartLegend.md#setparent)
- [setTransform](DChartLegend.md#settransform)
- [setWidth](DChartLegend.md#setwidth)
- [setX](DChartLegend.md#setx)
- [setY](DChartLegend.md#sety)
- [show](DChartLegend.md#show)
- [sortChildren](DChartLegend.md#sortchildren)
- [swapChildren](DChartLegend.md#swapchildren)
- [toCursor](DChartLegend.md#tocursor)
- [toDirty](DChartLegend.md#todirty)
- [toGlobal](DChartLegend.md#toglobal)
- [toHasDirty](DChartLegend.md#tohasdirty)
- [toHierarchyDirty](DChartLegend.md#tohierarchydirty)
- [toLocal](DChartLegend.md#tolocal)
- [toParentHasDirty](DChartLegend.md#toparenthasdirty)
- [toParentHierarchyDirty](DChartLegend.md#toparenthierarchydirty)
- [toParentResized](DChartLegend.md#toparentresized)
- [updateTransform](DChartLegend.md#updatetransform)
- [mixin](DChartLegend.md#mixin)

## Constructors

### constructor

• **new DChartLegend**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemeChartLegend`](../interfaces/DThemeChartLegend.md) = [`DThemeChartLegend`](../interfaces/DThemeChartLegend.md) |
| `OPTIONS` | extends [`DChartLegendOptions`](../interfaces/DChartLegendOptions.md)<`THEME`, `OPTIONS`\> = [`DChartLegendOptions`](../interfaces/DChartLegendOptions.md)<`THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DChartLegend`](DChartLegend.md)<`THEME`, `OPTIONS`\>
...
[`DChartLegend`](DChartLegend.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DChartLegend`](DChartLegend.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DChartLegend`](DChartLegend.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-chart-legend.ts:16](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-chart-legend.ts#L16)
...
▸ **hide**(): [`DChartLegend`](DChartLegend.md)<`THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DChartLegend`](DChartLegend.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DChartLegend`](DChartLegend.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DChartLegend`](DChartLegend.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DChartLegend`](DChartLegend.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DChartLegend`](DChartLegend.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DChartLegend`](DChartLegend.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DChartLegend`](DChartLegend.md)<`THEME`, `OPTIONS`\>
