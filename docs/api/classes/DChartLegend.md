[Winter Cardinal UI - v0.407.0](../index.md) / DChartLegend
...
- [\_boundsID](DChartLegend.md#_boundsid)
- [\_boundsRect](DChartLegend.md#_boundsrect)
...
- [\_enabledFilters](DChartLegend.md#_enabledfilters)
- [\_lastDownPoint](DChartLegend.md#_lastdownpoint)
- [\_lastSortedIndex](DChartLegend.md#_lastsortedindex)
- [\_localBounds](DChartLegend.md#_localbounds)
- [\_localBoundsRect](DChartLegend.md#_localboundsrect)
...
- [options](DChartLegend.md#options)
...
- [containerUpdateTransform](DChartLegend.md#containerupdatetransform)
...
- [disableTempParent](DChartLegend.md#disabletempparent)
- [displayObjectUpdateTransform](DChartLegend.md#displayobjectupdatetransform)
- [emit](DChartLegend.md#emit)
- [enableTempParent](DChartLegend.md#enabletempparent)
...
- [newPadding](DChartLegend.md#newpadding)
...
• **new DChartLegend**\<`THEME`, `OPTIONS`\>(`options?`): [`DChartLegend`](DChartLegend.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-chart-legend.ts:16](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-chart-legend.ts#L16)
...
▸ **setFocused**(`isFocused`): [`DChartLegend`](DChartLegend.md)\<`THEME`, `OPTIONS`\>
