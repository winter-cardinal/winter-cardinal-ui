[Winter Cardinal UI - v0.457.0](../index.md) / DDialogSaveAs
...
- [\_alwaysOnTop](DDialogSaveAs.md#_alwaysontop)
...
- [\_boundsID](DDialogSaveAs.md#_boundsid)
- [\_boundsRect](DDialogSaveAs.md#_boundsrect)
...
- [\_enabledFilters](DDialogSaveAs.md#_enabledfilters)
...
- [\_localBounds](DDialogSaveAs.md#_localbounds)
- [\_localBoundsRect](DDialogSaveAs.md#_localboundsrect)
- [\_mask](DDialogSaveAs.md#_mask)
- [\_mode](DDialogSaveAs.md#_mode)
- [\_onParentChildAddedBound](DDialogSaveAs.md#_onparentchildaddedbound)
...
- [alwaysOnTop](DDialogSaveAs.md#alwaysontop)
...
- [bringToFront](DDialogSaveAs.md#bringtofront)
- [calculateBounds](DDialogSaveAs.md#calculatebounds)
- [cancel](DDialogSaveAs.md#cancel)
- [close](DDialogSaveAs.md#close)
- [containerUpdateTransform](DDialogSaveAs.md#containerupdatetransform)
...
- [disableTempParent](DDialogSaveAs.md#disabletempparent)
...
- [enableTempParent](DDialogSaveAs.md#enabletempparent)
...
- [newPadding](DDialogSaveAs.md#newpadding)
...
• **new DDialogSaveAs**\<`THEME`, `OPTIONS`\>(`options?`): [`DDialogSaveAs`](DDialogSaveAs.md)\<`THEME`, `OPTIONS`\>
...
[DDialogInputText](DDialogInputText.md).[_alwaysOnTop](DDialogInputText.md#_alwaysontop)
...
[DDialogInputText](DDialogInputText.md).[_boundsID](DDialogInputText.md#_boundsid)
...
[DDialogInputText](DDialogInputText.md).[_boundsRect](DDialogInputText.md#_boundsrect)
...
[DDialogInputText](DDialogInputText.md).[_enabledFilters](DDialogInputText.md#_enabledfilters)
...
[DDialogInputText](DDialogInputText.md).[_localBounds](DDialogInputText.md#_localbounds)
...
[DDialogInputText](DDialogInputText.md).[_localBoundsRect](DDialogInputText.md#_localboundsrect)
...
[DDialogInputText](DDialogInputText.md).[_onParentChildAddedBound](DDialogInputText.md#_onparentchildaddedbound)
...
[DDialogInputText](DDialogInputText.md).[bringToFront](DDialogInputText.md#bringtofront)
...
[DDialogInputText](DDialogInputText.md).[containerUpdateTransform](DDialogInputText.md#containerupdatetransform)
...
[DDialogInputText](DDialogInputText.md).[disableTempParent](DDialogInputText.md#disabletempparent)
...
[DDialogInputText](DDialogInputText.md).[enableTempParent](DDialogInputText.md#enabletempparent)
...
[src/main/typescript/wcardinal/ui/d-dialog-save-as.ts:44](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-save-as.ts#L44)
...
[src/main/typescript/wcardinal/ui/d-dialog-input-text.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-input-text.ts#L22)
...
[DDialogInputText](DDialogInputText.md).[newPadding](DDialogInputText.md#newpadding)
...
[src/main/typescript/wcardinal/ui/d-dialog-save-as.ts:32](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-save-as.ts#L32)
...
[src/main/typescript/wcardinal/ui/d-dialog-save-as.ts:24](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-save-as.ts#L24)
...
[src/main/typescript/wcardinal/ui/d-dialog-input-text.ts:30](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-input-text.ts#L30)
