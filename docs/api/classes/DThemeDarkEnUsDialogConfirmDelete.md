[Winter Cardinal UI - v0.442.0](../index.md) / DThemeDarkEnUsDialogConfirmDelete

# Class: DThemeDarkEnUsDialogConfirmDelete
...
- [`DThemeDarkEnUsDialogConfirm`](DThemeDarkEnUsDialogConfirm.md)
  ...
  ↳ **`DThemeDarkEnUsDialogConfirmDelete`**

## Table of contents

### Constructors

- [constructor](DThemeDarkEnUsDialogConfirmDelete.md#constructor)

### Methods

- [closeOn](DThemeDarkEnUsDialogConfirmDelete.md#closeon)
- [getAlign](DThemeDarkEnUsDialogConfirmDelete.md#getalign)
- [getAlpha](DThemeDarkEnUsDialogConfirmDelete.md#getalpha)
- [getBackgroundAlpha](DThemeDarkEnUsDialogConfirmDelete.md#getbackgroundalpha)
- [getBackgroundColor](DThemeDarkEnUsDialogConfirmDelete.md#getbackgroundcolor)
- [getBackgroundTexture](DThemeDarkEnUsDialogConfirmDelete.md#getbackgroundtexture)
- [getBorderAlign](DThemeDarkEnUsDialogConfirmDelete.md#getborderalign)
- [getBorderAlpha](DThemeDarkEnUsDialogConfirmDelete.md#getborderalpha)
- [getBorderColor](DThemeDarkEnUsDialogConfirmDelete.md#getbordercolor)
- [getBorderMask](DThemeDarkEnUsDialogConfirmDelete.md#getbordermask)
- [getBorderTexture](DThemeDarkEnUsDialogConfirmDelete.md#getbordertexture)
- [getBorderWidth](DThemeDarkEnUsDialogConfirmDelete.md#getborderwidth)
- [getClearType](DThemeDarkEnUsDialogConfirmDelete.md#getcleartype)
- [getColor](DThemeDarkEnUsDialogConfirmDelete.md#getcolor)
- [getContent](DThemeDarkEnUsDialogConfirmDelete.md#getcontent)
- [getCornerMask](DThemeDarkEnUsDialogConfirmDelete.md#getcornermask)
- [getCornerRadius](DThemeDarkEnUsDialogConfirmDelete.md#getcornerradius)
- [getCursor](DThemeDarkEnUsDialogConfirmDelete.md#getcursor)
- [getFontFamilly](DThemeDarkEnUsDialogConfirmDelete.md#getfontfamilly)
- [getFontSize](DThemeDarkEnUsDialogConfirmDelete.md#getfontsize)
- [getFontStyle](DThemeDarkEnUsDialogConfirmDelete.md#getfontstyle)
- [getFontVariant](DThemeDarkEnUsDialogConfirmDelete.md#getfontvariant)
- [getFontWeight](DThemeDarkEnUsDialogConfirmDelete.md#getfontweight)
- [getFooter](DThemeDarkEnUsDialogConfirmDelete.md#getfooter)
- [getGestureMode](DThemeDarkEnUsDialogConfirmDelete.md#getgesturemode)
- [getHeader](DThemeDarkEnUsDialogConfirmDelete.md#getheader)
- [getHeight](DThemeDarkEnUsDialogConfirmDelete.md#getheight)
- [getInteractive](DThemeDarkEnUsDialogConfirmDelete.md#getinteractive)
- [getLayout](DThemeDarkEnUsDialogConfirmDelete.md#getlayout)
- [getLineHeight](DThemeDarkEnUsDialogConfirmDelete.md#getlineheight)
- [getMessage](DThemeDarkEnUsDialogConfirmDelete.md#getmessage)
- [getMode](DThemeDarkEnUsDialogConfirmDelete.md#getmode)
- [getOffsetX](DThemeDarkEnUsDialogConfirmDelete.md#getoffsetx)
- [getOffsetY](DThemeDarkEnUsDialogConfirmDelete.md#getoffsety)
- [getOutlineAlign](DThemeDarkEnUsDialogConfirmDelete.md#getoutlinealign)
- [getOutlineAlpha](DThemeDarkEnUsDialogConfirmDelete.md#getoutlinealpha)
- [getOutlineColor](DThemeDarkEnUsDialogConfirmDelete.md#getoutlinecolor)
- [getOutlineMask](DThemeDarkEnUsDialogConfirmDelete.md#getoutlinemask)
- [getOutlineOffset](DThemeDarkEnUsDialogConfirmDelete.md#getoutlineoffset)
- [getOutlineWidth](DThemeDarkEnUsDialogConfirmDelete.md#getoutlinewidth)
- [getPaddingBottom](DThemeDarkEnUsDialogConfirmDelete.md#getpaddingbottom)
- [getPaddingLeft](DThemeDarkEnUsDialogConfirmDelete.md#getpaddingleft)
- [getPaddingRight](DThemeDarkEnUsDialogConfirmDelete.md#getpaddingright)
- [getPaddingTop](DThemeDarkEnUsDialogConfirmDelete.md#getpaddingtop)
- [getShadow](DThemeDarkEnUsDialogConfirmDelete.md#getshadow)
- [getTitle](DThemeDarkEnUsDialogConfirmDelete.md#gettitle)
- [getWeight](DThemeDarkEnUsDialogConfirmDelete.md#getweight)
- [getWidth](DThemeDarkEnUsDialogConfirmDelete.md#getwidth)
- [getX](DThemeDarkEnUsDialogConfirmDelete.md#getx)
- [getY](DThemeDarkEnUsDialogConfirmDelete.md#gety)
- [isGestureEnabled](DThemeDarkEnUsDialogConfirmDelete.md#isgestureenabled)
- [isSticky](DThemeDarkEnUsDialogConfirmDelete.md#issticky)
- [newAnimation](DThemeDarkEnUsDialogConfirmDelete.md#newanimation)
- [newShadow](DThemeDarkEnUsDialogConfirmDelete.md#newshadow)
- [newShadowWeak](DThemeDarkEnUsDialogConfirmDelete.md#newshadowweak)
- [newState](DThemeDarkEnUsDialogConfirmDelete.md#newstate)

## Constructors

### constructor

• **new DThemeDarkEnUsDialogConfirmDelete**(): [`DThemeDarkEnUsDialogConfirmDelete`](DThemeDarkEnUsDialogConfirmDelete.md)

#### Returns

[`DThemeDarkEnUsDialogConfirmDelete`](DThemeDarkEnUsDialogConfirmDelete.md)
...
[DThemeDarkEnUsDialogConfirm](DThemeDarkEnUsDialogConfirm.md).[getCursor](DThemeDarkEnUsDialogConfirm.md#getcursor)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-en-us-dialog-confirm.ts:10](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-en-us-dialog-confirm.ts#L10)
...
[DThemeDarkEnUsDialogConfirm](DThemeDarkEnUsDialogConfirm.md).[getInteractive](DThemeDarkEnUsDialogConfirm.md#getinteractive)
...
[src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-en-us-dialog-confirm-delete.ts:10](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/theme/dark/d-theme-dark-en-us-dialog-confirm-delete.ts#L10)
...
[DThemeDarkEnUsDialogConfirm](DThemeDarkEnUsDialogConfirm.md).[getOffsetX](DThemeDarkEnUsDialogConfirm.md#getoffsetx)
...
[DThemeDarkEnUsDialogConfirm](DThemeDarkEnUsDialogConfirm.md).[getOutlineAlign](DThemeDarkEnUsDialogConfirm.md#getoutlinealign)
