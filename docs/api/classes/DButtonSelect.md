[Winter Cardinal UI](../README.md) / DButtonSelect
...
• `Protected` **\_dialogGetter**: [`DButtonSelectGetter`](../README.md#dbuttonselectgetter)<`VALUE`, `DIALOG`\>
...
• `Protected` **\_dialogSetter**: [`DButtonSelectSetter`](../README.md#dbuttonselectsetter)<`VALUE`, `DIALOG`\>
