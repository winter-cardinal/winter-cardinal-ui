[Winter Cardinal UI - v0.167.0](../index.md) / DButtonSelect

# Class: DButtonSelect<VALUE, DIALOG_VALUE, DIALOG, THEME, OPTIONS\>
...
| `DIALOG` | extends [`DButtonSelectDialog`](../interfaces/DButtonSelectDialog.md)<`DIALOG_VALUE`\> = [`DButtonSelectDialog`](../interfaces/DButtonSelectDialog.md)<`DIALOG_VALUE`\> |
| `THEME` | extends [`DThemeButtonSelect`](../interfaces/DThemeButtonSelect.md)<`VALUE`\> = [`DThemeButtonSelect`](../interfaces/DThemeButtonSelect.md)<`VALUE`\> |
| `OPTIONS` | extends [`DButtonSelectOptions`](../interfaces/DButtonSelectOptions.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`\> = [`DButtonSelectOptions`](../interfaces/DButtonSelectOptions.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`\> |
...
- [constructor](DButtonSelect.md#constructor)

### Properties

- [\_accessibleActive](DButtonSelect.md#_accessibleactive)
- [\_accessibleDiv](DButtonSelect.md#_accessiblediv)
- [\_auto](DButtonSelect.md#_auto)
- [\_background](DButtonSelect.md#_background)
- [\_border](DButtonSelect.md#_border)
- [\_bounds](DButtonSelect.md#_bounds)
- [\_clearType](DButtonSelect.md#_cleartype)
- [\_corner](DButtonSelect.md#_corner)
- [\_cursor](DButtonSelect.md#_cursor)
- [\_destroyed](DButtonSelect.md#_destroyed)
- [\_dialog](DButtonSelect.md#_dialog)
- [\_dialogGetter](DButtonSelect.md#_dialoggetter)
- [\_dialogSetter](DButtonSelect.md#_dialogsetter)
- [\_images](DButtonSelect.md#_images)
- [\_isOverflowMaskEnabled](DButtonSelect.md#_isoverflowmaskenabled)
- [\_isTextVisible](DButtonSelect.md#_istextvisible)
- [\_isToggle](DButtonSelect.md#_istoggle)
- [\_lastDownPoint](DButtonSelect.md#_lastdownpoint)
- [\_lastSortedIndex](DButtonSelect.md#_lastsortedindex)
- [\_mask](DButtonSelect.md#_mask)
- [\_options](DButtonSelect.md#_options)
- [\_outline](DButtonSelect.md#_outline)
- [\_overflowMask](DButtonSelect.md#_overflowmask)
- [\_padding](DButtonSelect.md#_padding)
- [\_reflowable](DButtonSelect.md#_reflowable)
- [\_shortcuts](DButtonSelect.md#_shortcuts)
- [\_snippet](DButtonSelect.md#_snippet)
- [\_tempDisplayObjectParent](DButtonSelect.md#_tempdisplayobjectparent)
- [\_text](DButtonSelect.md#_text)
- [\_textAlign](DButtonSelect.md#_textalign)
- [\_textAlpha](DButtonSelect.md#_textalpha)
- [\_textColor](DButtonSelect.md#_textcolor)
- [\_textFormatter](DButtonSelect.md#_textformatter)
- [\_textStyle](DButtonSelect.md#_textstyle)
- [\_textValue](DButtonSelect.md#_textvalue)
- [\_textValueComputed](DButtonSelect.md#_textvaluecomputed)
- [\_title](DButtonSelect.md#_title)
- [\_when](DButtonSelect.md#_when)
- [\_zIndex](DButtonSelect.md#_zindex)
- [accessible](DButtonSelect.md#accessible)
- [accessibleChildren](DButtonSelect.md#accessiblechildren)
- [accessibleHint](DButtonSelect.md#accessiblehint)
- [accessiblePointerEvents](DButtonSelect.md#accessiblepointerevents)
- [accessibleTitle](DButtonSelect.md#accessibletitle)
- [accessibleType](DButtonSelect.md#accessibletype)
- [alpha](DButtonSelect.md#alpha)
- [angle](DButtonSelect.md#angle)
- [buttonMode](DButtonSelect.md#buttonmode)
- [cacheAsBitmap](DButtonSelect.md#cacheasbitmap)
- [children](DButtonSelect.md#children)
- [cursor](DButtonSelect.md#cursor)
- [filterArea](DButtonSelect.md#filterarea)
- [filters](DButtonSelect.md#filters)
- [hitArea](DButtonSelect.md#hitarea)
- [interactive](DButtonSelect.md#interactive)
- [interactiveChildren](DButtonSelect.md#interactivechildren)
- [isMask](DButtonSelect.md#ismask)
- [isSprite](DButtonSelect.md#issprite)
- [localTransform](DButtonSelect.md#localtransform)
- [mask](DButtonSelect.md#mask)
- [name](DButtonSelect.md#name)
- [parent](DButtonSelect.md#parent)
- [pivot](DButtonSelect.md#pivot)
- [renderable](DButtonSelect.md#renderable)
- [rotation](DButtonSelect.md#rotation)
- [sortDirty](DButtonSelect.md#sortdirty)
- [sortableChildren](DButtonSelect.md#sortablechildren)
- [transform](DButtonSelect.md#transform)
- [visible](DButtonSelect.md#visible)
- [worldAlpha](DButtonSelect.md#worldalpha)
- [worldTransform](DButtonSelect.md#worldtransform)
- [worldVisible](DButtonSelect.md#worldvisible)
- [zIndex](DButtonSelect.md#zindex)
- [LAYOUTER](DButtonSelect.md#layouter)
- [WORK\_CONTAINS\_POINT](DButtonSelect.md#work_contains_point)

### Accessors

- [background](DButtonSelect.md#background)
- [border](DButtonSelect.md#border)
- [corner](DButtonSelect.md#corner)
- [dialog](DButtonSelect.md#dialog)
- [height](DButtonSelect.md#height)
- [image](DButtonSelect.md#image)
- [isToggle](DButtonSelect.md#istoggle)
- [outline](DButtonSelect.md#outline)
- [padding](DButtonSelect.md#padding)
- [position](DButtonSelect.md#position)
- [reflowable](DButtonSelect.md#reflowable)
- [scale](DButtonSelect.md#scale)
- [shadow](DButtonSelect.md#shadow)
- [skew](DButtonSelect.md#skew)
- [snippet](DButtonSelect.md#snippet)
- [state](DButtonSelect.md#state)
- [text](DButtonSelect.md#text)
- [theme](DButtonSelect.md#theme)
- [title](DButtonSelect.md#title)
- [type](DButtonSelect.md#type)
- [unsafe](DButtonSelect.md#unsafe)
- [value](DButtonSelect.md#value)
- [weight](DButtonSelect.md#weight)
- [width](DButtonSelect.md#width)
- [x](DButtonSelect.md#x)
- [y](DButtonSelect.md#y)

### Methods

- [\_calculateBounds](DButtonSelect.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DButtonSelect.md#_recursivepostupdatetransform)
- [\_render](DButtonSelect.md#_render)
- [addChild](DButtonSelect.md#addchild)
- [addChildAt](DButtonSelect.md#addchildat)
- [addListener](DButtonSelect.md#addlistener)
- [applyTitle](DButtonSelect.md#applytitle)
- [blur](DButtonSelect.md#blur)
- [calculateBounds](DButtonSelect.md#calculatebounds)
- [computeTextValue](DButtonSelect.md#computetextvalue)
- [containsGlobalPoint](DButtonSelect.md#containsglobalpoint)
- [containsLocalPoint](DButtonSelect.md#containslocalpoint)
- [containsPoint](DButtonSelect.md#containspoint)
- [createOrUpdateText](DButtonSelect.md#createorupdatetext)
- [createText](DButtonSelect.md#createtext)
- [destroy](DButtonSelect.md#destroy)
- [displayObjectUpdateTransform](DButtonSelect.md#displayobjectupdatetransform)
- [emit](DButtonSelect.md#emit)
- [eventNames](DButtonSelect.md#eventnames)
- [focus](DButtonSelect.md#focus)
- [focusOnClosest](DButtonSelect.md#focusonclosest)
- [getBounds](DButtonSelect.md#getbounds)
- [getChildAt](DButtonSelect.md#getchildat)
- [getChildByName](DButtonSelect.md#getchildbyname)
- [getChildIndex](DButtonSelect.md#getchildindex)
- [getClearType](DButtonSelect.md#getcleartype)
- [getClippingRect](DButtonSelect.md#getclippingrect)
- [getGlobalPosition](DButtonSelect.md#getglobalposition)
- [getHeight](DButtonSelect.md#getheight)
- [getLocalBounds](DButtonSelect.md#getlocalbounds)
- [getOverflowMask](DButtonSelect.md#getoverflowmask)
- [getParentOfSize](DButtonSelect.md#getparentofsize)
- [getTextAlpha](DButtonSelect.md#gettextalpha)
- [getTextColor](DButtonSelect.md#gettextcolor)
- [getThemeDefault](DButtonSelect.md#getthemedefault)
- [getType](DButtonSelect.md#gettype)
- [getWidth](DButtonSelect.md#getwidth)
- [getX](DButtonSelect.md#getx)
- [getY](DButtonSelect.md#gety)
- [hasDirty](DButtonSelect.md#hasdirty)
- [hasRefitableHeight](DButtonSelect.md#hasrefitableheight)
- [hasRefitableWidth](DButtonSelect.md#hasrefitablewidth)
- [hide](DButtonSelect.md#hide)
- [hideText](DButtonSelect.md#hidetext)
- [init](DButtonSelect.md#init)
- [initOnClick](DButtonSelect.md#initonclick)
- [initOnPress](DButtonSelect.md#initonpress)
- [initReflowable](DButtonSelect.md#initreflowable)
- [isDirty](DButtonSelect.md#isdirty)
- [isEventTarget](DButtonSelect.md#iseventtarget)
- [isHidden](DButtonSelect.md#ishidden)
- [isHierarchyDirty](DButtonSelect.md#ishierarchydirty)
- [isRefitable](DButtonSelect.md#isrefitable)
- [isShown](DButtonSelect.md#isshown)
- [listenerCount](DButtonSelect.md#listenercount)
- [listeners](DButtonSelect.md#listeners)
- [newImage](DButtonSelect.md#newimage)
- [newImages](DButtonSelect.md#newimages)
- [off](DButtonSelect.md#off)
- [on](DButtonSelect.md#on)
- [onActivate](DButtonSelect.md#onactivate)
- [onActivateKeyDown](DButtonSelect.md#onactivatekeydown)
- [onActivateKeyUp](DButtonSelect.md#onactivatekeyup)
- [onBlur](DButtonSelect.md#onblur)
- [onChildBlur](DButtonSelect.md#onchildblur)
- [onChildFocus](DButtonSelect.md#onchildfocus)
- [onChildrenChange](DButtonSelect.md#onchildrenchange)
- [onClick](DButtonSelect.md#onclick)
- [onDblClick](DButtonSelect.md#ondblclick)
- [onDown](DButtonSelect.md#ondown)
- [onDownThis](DButtonSelect.md#ondownthis)
- [onFocus](DButtonSelect.md#onfocus)
- [onHierarchyDirty](DButtonSelect.md#onhierarchydirty)
- [onInactivate](DButtonSelect.md#oninactivate)
- [onKeyDown](DButtonSelect.md#onkeydown)
- [onKeyUp](DButtonSelect.md#onkeyup)
- [onMove](DButtonSelect.md#onmove)
- [onOut](DButtonSelect.md#onout)
- [onOver](DButtonSelect.md#onover)
- [onParentMove](DButtonSelect.md#onparentmove)
- [onParentResize](DButtonSelect.md#onparentresize)
- [onRefit](DButtonSelect.md#onrefit)
- [onReflow](DButtonSelect.md#onreflow)
- [onResize](DButtonSelect.md#onresize)
- [onScale](DButtonSelect.md#onscale)
- [onShortcut](DButtonSelect.md#onshortcut)
- [onSkew](DButtonSelect.md#onskew)
- [onStateChange](DButtonSelect.md#onstatechange)
- [onTextChange](DButtonSelect.md#ontextchange)
- [onToggleEnd](DButtonSelect.md#ontoggleend)
- [onToggleStart](DButtonSelect.md#ontogglestart)
- [onUp](DButtonSelect.md#onup)
- [onUpThis](DButtonSelect.md#onupthis)
- [onWheel](DButtonSelect.md#onwheel)
- [once](DButtonSelect.md#once)
- [reflow](DButtonSelect.md#reflow)
- [removeAllListeners](DButtonSelect.md#removealllisteners)
- [removeChild](DButtonSelect.md#removechild)
- [removeChildAt](DButtonSelect.md#removechildat)
- [removeChildren](DButtonSelect.md#removechildren)
- [removeListener](DButtonSelect.md#removelistener)
- [render](DButtonSelect.md#render)
- [renderAdvanced](DButtonSelect.md#renderadvanced)
- [resize](DButtonSelect.md#resize)
- [setChildIndex](DButtonSelect.md#setchildindex)
- [setFocused](DButtonSelect.md#setfocused)
- [setHeight](DButtonSelect.md#setheight)
- [setParent](DButtonSelect.md#setparent)
- [setTransform](DButtonSelect.md#settransform)
- [setWidth](DButtonSelect.md#setwidth)
- [setX](DButtonSelect.md#setx)
- [setY](DButtonSelect.md#sety)
- [show](DButtonSelect.md#show)
- [showText](DButtonSelect.md#showtext)
- [sortChildren](DButtonSelect.md#sortchildren)
- [swapChildren](DButtonSelect.md#swapchildren)
- [toCursor](DButtonSelect.md#tocursor)
- [toDirty](DButtonSelect.md#todirty)
- [toGlobal](DButtonSelect.md#toglobal)
- [toHasDirty](DButtonSelect.md#tohasdirty)
- [toHierarchyDirty](DButtonSelect.md#tohierarchydirty)
- [toImageOptions](DButtonSelect.md#toimageoptions)
- [toLocal](DButtonSelect.md#tolocal)
- [toParentHasDirty](DButtonSelect.md#toparenthasdirty)
- [toParentHierarchyDirty](DButtonSelect.md#toparenthierarchydirty)
- [toParentResized](DButtonSelect.md#toparentresized)
- [toggle](DButtonSelect.md#toggle)
- [updateText](DButtonSelect.md#updatetext)
- [updateTextAndImage](DButtonSelect.md#updatetextandimage)
- [updateTextColor](DButtonSelect.md#updatetextcolor)
- [updateTextPosition](DButtonSelect.md#updatetextposition)
- [updateTextValue](DButtonSelect.md#updatetextvalue)
- [updateTransform](DButtonSelect.md#updatetransform)
- [mixin](DButtonSelect.md#mixin)

## Constructors

### constructor

• **new DButtonSelect**<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `OPTIONS`\>(`options?`)
...
| `VALUE` | extends `unknown` = `unknown` |
| `DIALOG_VALUE` | extends `unknown` = `unknown` |
| `DIALOG` | extends [`DButtonSelectDialog`](../interfaces/DButtonSelectDialog.md)<`DIALOG_VALUE`, `DIALOG`\> = [`DButtonSelectDialog`](../interfaces/DButtonSelectDialog.md)<`DIALOG_VALUE`\> |
| `THEME` | extends [`DThemeButtonSelect`](../interfaces/DThemeButtonSelect.md)<`VALUE`, `THEME`\> = [`DThemeButtonSelect`](../interfaces/DThemeButtonSelect.md)<`VALUE`\> |
| `OPTIONS` | extends [`DButtonSelectOptions`](../interfaces/DButtonSelectOptions.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `any`, `OPTIONS`\> = [`DButtonSelectOptions`](../interfaces/DButtonSelectOptions.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-button-select.ts:146](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-select.ts#L146)
...
• `Protected` `Optional` **\_dialog**: `DIALOG`

#### Defined in

[src/main/typescript/wcardinal/ui/d-button-select.ts:142](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-select.ts#L142)

___

### \_dialogGetter

• `Protected` **\_dialogGetter**: [`DButtonSelectGetter`](../index.md#dbuttonselectgetter)<`VALUE`, `DIALOG`\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-button-select.ts:143](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-select.ts#L143)

___

### \_dialogSetter

• `Protected` **\_dialogSetter**: [`DButtonSelectSetter`](../index.md#dbuttonselectsetter)<`VALUE`, `DIALOG`\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-button-select.ts:144](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-select.ts#L144)
...
[src/main/typescript/wcardinal/ui/d-button-select.ts:168](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-select.ts#L168)
...
[src/main/typescript/wcardinal/ui/d-button-select.ts:183](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-select.ts#L183)
...
[src/main/typescript/wcardinal/ui/d-button-select.ts:187](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-select.ts#L187)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DButtonSelect`](DButtonSelect.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `OPTIONS`\>
...
[`DButtonSelect`](DButtonSelect.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DButtonSelect`](DButtonSelect.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DButtonSelect`](DButtonSelect.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-select.ts:191](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-select.ts#L191)
...
▸ **hide**(): [`DButtonSelect`](DButtonSelect.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DButtonSelect`](DButtonSelect.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DButtonSelect`](DButtonSelect.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-select.ts:152](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-button-select.ts#L152)
...
▸ **once**(`event`, `fn`, `context?`): [`DButtonSelect`](DButtonSelect.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DButtonSelect`](DButtonSelect.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DButtonSelect`](DButtonSelect.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DButtonSelect`](DButtonSelect.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DButtonSelect`](DButtonSelect.md)<`VALUE`, `DIALOG_VALUE`, `DIALOG`, `THEME`, `OPTIONS`\>
