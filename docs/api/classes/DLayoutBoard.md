[Winter Cardinal UI - v0.457.0](../index.md) / DLayoutBoard

# Class: DLayoutBoard\<THEME, OPTIONS\>

A board for layouting elements.
Unlike [DLayoutVertical](DLayoutVertical.md) and [DLayoutHorizontal](DLayoutHorizontal.md),
this class doesn't change the position and the size of children.
Unlike [DBase](DBase.md) and [DBoard](DBoard.md), this class doesn't have
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeLayoutBoard`](../interfaces/DThemeLayoutBoard.md) |
| `OPTIONS` | extends [`DLayoutBoardOptions`](../interfaces/DLayoutBoardOptions.md)\<`THEME`\> |
...
- [constructor](DLayoutBoard.md#constructor)

### Properties

- [\_accessibleActive](DLayoutBoard.md#_accessibleactive)
- [\_accessibleDiv](DLayoutBoard.md#_accessiblediv)
- [\_auto](DLayoutBoard.md#_auto)
- [\_background](DLayoutBoard.md#_background)
- [\_border](DLayoutBoard.md#_border)
- [\_bounds](DLayoutBoard.md#_bounds)
- [\_boundsID](DLayoutBoard.md#_boundsid)
- [\_boundsRect](DLayoutBoard.md#_boundsrect)
- [\_clearType](DLayoutBoard.md#_cleartype)
- [\_corner](DLayoutBoard.md#_corner)
- [\_cursor](DLayoutBoard.md#_cursor)
- [\_destroyed](DLayoutBoard.md#_destroyed)
- [\_enabledFilters](DLayoutBoard.md#_enabledfilters)
- [\_lastDownPoint](DLayoutBoard.md#_lastdownpoint)
- [\_lastSortedIndex](DLayoutBoard.md#_lastsortedindex)
- [\_localBounds](DLayoutBoard.md#_localbounds)
- [\_localBoundsRect](DLayoutBoard.md#_localboundsrect)
- [\_mask](DLayoutBoard.md#_mask)
- [\_options](DLayoutBoard.md#_options)
- [\_outline](DLayoutBoard.md#_outline)
- [\_padding](DLayoutBoard.md#_padding)
- [\_reflowable](DLayoutBoard.md#_reflowable)
- [\_shortcuts](DLayoutBoard.md#_shortcuts)
- [\_snippet](DLayoutBoard.md#_snippet)
- [\_tempDisplayObjectParent](DLayoutBoard.md#_tempdisplayobjectparent)
- [\_title](DLayoutBoard.md#_title)
- [\_zIndex](DLayoutBoard.md#_zindex)
- [accessible](DLayoutBoard.md#accessible)
- [accessibleChildren](DLayoutBoard.md#accessiblechildren)
- [accessibleHint](DLayoutBoard.md#accessiblehint)
- [accessiblePointerEvents](DLayoutBoard.md#accessiblepointerevents)
- [accessibleTitle](DLayoutBoard.md#accessibletitle)
- [accessibleType](DLayoutBoard.md#accessibletype)
- [alpha](DLayoutBoard.md#alpha)
- [angle](DLayoutBoard.md#angle)
- [buttonMode](DLayoutBoard.md#buttonmode)
- [cacheAsBitmap](DLayoutBoard.md#cacheasbitmap)
- [children](DLayoutBoard.md#children)
- [cursor](DLayoutBoard.md#cursor)
- [filterArea](DLayoutBoard.md#filterarea)
- [filters](DLayoutBoard.md#filters)
- [hitArea](DLayoutBoard.md#hitarea)
- [interactive](DLayoutBoard.md#interactive)
- [interactiveChildren](DLayoutBoard.md#interactivechildren)
- [isMask](DLayoutBoard.md#ismask)
- [isSprite](DLayoutBoard.md#issprite)
- [localTransform](DLayoutBoard.md#localtransform)
- [mask](DLayoutBoard.md#mask)
- [name](DLayoutBoard.md#name)
- [parent](DLayoutBoard.md#parent)
- [pivot](DLayoutBoard.md#pivot)
- [renderable](DLayoutBoard.md#renderable)
- [rotation](DLayoutBoard.md#rotation)
- [sortDirty](DLayoutBoard.md#sortdirty)
- [sortableChildren](DLayoutBoard.md#sortablechildren)
- [transform](DLayoutBoard.md#transform)
- [visible](DLayoutBoard.md#visible)
- [worldAlpha](DLayoutBoard.md#worldalpha)
- [worldTransform](DLayoutBoard.md#worldtransform)
- [worldVisible](DLayoutBoard.md#worldvisible)
- [zIndex](DLayoutBoard.md#zindex)
- [WORK\_CONTAINS\_POINT](DLayoutBoard.md#work_contains_point)

### Accessors

- [background](DLayoutBoard.md#background)
- [border](DLayoutBoard.md#border)
- [corner](DLayoutBoard.md#corner)
- [height](DLayoutBoard.md#height)
- [options](DLayoutBoard.md#options)
- [outline](DLayoutBoard.md#outline)
- [padding](DLayoutBoard.md#padding)
- [position](DLayoutBoard.md#position)
- [reflowable](DLayoutBoard.md#reflowable)
- [scale](DLayoutBoard.md#scale)
- [shadow](DLayoutBoard.md#shadow)
- [skew](DLayoutBoard.md#skew)
- [snippet](DLayoutBoard.md#snippet)
- [state](DLayoutBoard.md#state)
- [theme](DLayoutBoard.md#theme)
- [title](DLayoutBoard.md#title)
- [type](DLayoutBoard.md#type)
- [unsafe](DLayoutBoard.md#unsafe)
- [weight](DLayoutBoard.md#weight)
- [width](DLayoutBoard.md#width)
- [x](DLayoutBoard.md#x)
- [y](DLayoutBoard.md#y)

### Methods

- [\_calculateBounds](DLayoutBoard.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DLayoutBoard.md#_recursivepostupdatetransform)
- [\_render](DLayoutBoard.md#_render)
- [addChild](DLayoutBoard.md#addchild)
- [addChildAt](DLayoutBoard.md#addchildat)
- [addListener](DLayoutBoard.md#addlistener)
- [applyTitle](DLayoutBoard.md#applytitle)
- [blur](DLayoutBoard.md#blur)
- [calculateBounds](DLayoutBoard.md#calculatebounds)
- [containerUpdateTransform](DLayoutBoard.md#containerupdatetransform)
- [containsGlobalPoint](DLayoutBoard.md#containsglobalpoint)
- [containsLocalPoint](DLayoutBoard.md#containslocalpoint)
- [containsPoint](DLayoutBoard.md#containspoint)
- [destroy](DLayoutBoard.md#destroy)
- [disableTempParent](DLayoutBoard.md#disabletempparent)
- [displayObjectUpdateTransform](DLayoutBoard.md#displayobjectupdatetransform)
- [emit](DLayoutBoard.md#emit)
- [enableTempParent](DLayoutBoard.md#enabletempparent)
- [eventNames](DLayoutBoard.md#eventnames)
- [focus](DLayoutBoard.md#focus)
- [focusOnClosest](DLayoutBoard.md#focusonclosest)
- [getBounds](DLayoutBoard.md#getbounds)
- [getChildAt](DLayoutBoard.md#getchildat)
- [getChildByName](DLayoutBoard.md#getchildbyname)
- [getChildIndex](DLayoutBoard.md#getchildindex)
- [getClearType](DLayoutBoard.md#getcleartype)
- [getClippingRect](DLayoutBoard.md#getclippingrect)
- [getGlobalPosition](DLayoutBoard.md#getglobalposition)
- [getHeight](DLayoutBoard.md#getheight)
- [getLocalBounds](DLayoutBoard.md#getlocalbounds)
- [getParentOfSize](DLayoutBoard.md#getparentofsize)
- [getThemeDefault](DLayoutBoard.md#getthemedefault)
- [getType](DLayoutBoard.md#gettype)
- [getWidth](DLayoutBoard.md#getwidth)
- [getX](DLayoutBoard.md#getx)
- [getY](DLayoutBoard.md#gety)
- [hasDirty](DLayoutBoard.md#hasdirty)
- [hasRefitableHeight](DLayoutBoard.md#hasrefitableheight)
- [hasRefitableWidth](DLayoutBoard.md#hasrefitablewidth)
- [hide](DLayoutBoard.md#hide)
- [init](DLayoutBoard.md#init)
- [initReflowable](DLayoutBoard.md#initreflowable)
- [isDirty](DLayoutBoard.md#isdirty)
- [isEventTarget](DLayoutBoard.md#iseventtarget)
- [isHidden](DLayoutBoard.md#ishidden)
- [isHierarchyDirty](DLayoutBoard.md#ishierarchydirty)
- [isRefitable](DLayoutBoard.md#isrefitable)
- [isShown](DLayoutBoard.md#isshown)
- [listenerCount](DLayoutBoard.md#listenercount)
- [listeners](DLayoutBoard.md#listeners)
- [newPadding](DLayoutBoard.md#newpadding)
- [off](DLayoutBoard.md#off)
- [on](DLayoutBoard.md#on)
- [onBlur](DLayoutBoard.md#onblur)
- [onChildBlur](DLayoutBoard.md#onchildblur)
- [onChildFocus](DLayoutBoard.md#onchildfocus)
- [onChildrenChange](DLayoutBoard.md#onchildrenchange)
- [onDblClick](DLayoutBoard.md#ondblclick)
- [onDown](DLayoutBoard.md#ondown)
- [onDownThis](DLayoutBoard.md#ondownthis)
- [onFocus](DLayoutBoard.md#onfocus)
- [onHierarchyDirty](DLayoutBoard.md#onhierarchydirty)
- [onKeyDown](DLayoutBoard.md#onkeydown)
- [onKeyUp](DLayoutBoard.md#onkeyup)
- [onMove](DLayoutBoard.md#onmove)
- [onOut](DLayoutBoard.md#onout)
- [onOver](DLayoutBoard.md#onover)
- [onParentMove](DLayoutBoard.md#onparentmove)
- [onParentResize](DLayoutBoard.md#onparentresize)
- [onRefit](DLayoutBoard.md#onrefit)
- [onReflow](DLayoutBoard.md#onreflow)
- [onResize](DLayoutBoard.md#onresize)
- [onScale](DLayoutBoard.md#onscale)
- [onShortcut](DLayoutBoard.md#onshortcut)
- [onSkew](DLayoutBoard.md#onskew)
- [onStateChange](DLayoutBoard.md#onstatechange)
- [onUp](DLayoutBoard.md#onup)
- [onUpThis](DLayoutBoard.md#onupthis)
- [onWheel](DLayoutBoard.md#onwheel)
- [once](DLayoutBoard.md#once)
- [reflow](DLayoutBoard.md#reflow)
- [removeAllListeners](DLayoutBoard.md#removealllisteners)
- [removeChild](DLayoutBoard.md#removechild)
- [removeChildAt](DLayoutBoard.md#removechildat)
- [removeChildren](DLayoutBoard.md#removechildren)
- [removeListener](DLayoutBoard.md#removelistener)
- [render](DLayoutBoard.md#render)
- [renderAdvanced](DLayoutBoard.md#renderadvanced)
- [resize](DLayoutBoard.md#resize)
- [setChildIndex](DLayoutBoard.md#setchildindex)
- [setFocused](DLayoutBoard.md#setfocused)
- [setHeight](DLayoutBoard.md#setheight)
- [setParent](DLayoutBoard.md#setparent)
- [setTransform](DLayoutBoard.md#settransform)
- [setWidth](DLayoutBoard.md#setwidth)
- [setX](DLayoutBoard.md#setx)
- [setY](DLayoutBoard.md#sety)
- [show](DLayoutBoard.md#show)
- [sortChildren](DLayoutBoard.md#sortchildren)
- [swapChildren](DLayoutBoard.md#swapchildren)
- [toCursor](DLayoutBoard.md#tocursor)
- [toDirty](DLayoutBoard.md#todirty)
- [toGlobal](DLayoutBoard.md#toglobal)
- [toHasDirty](DLayoutBoard.md#tohasdirty)
- [toHierarchyDirty](DLayoutBoard.md#tohierarchydirty)
- [toLocal](DLayoutBoard.md#tolocal)
- [toParentHasDirty](DLayoutBoard.md#toparenthasdirty)
- [toParentHierarchyDirty](DLayoutBoard.md#toparenthierarchydirty)
- [toParentResized](DLayoutBoard.md#toparentresized)
- [updateTransform](DLayoutBoard.md#updatetransform)
- [mixin](DLayoutBoard.md#mixin)

## Constructors

### constructor

• **new DLayoutBoard**\<`THEME`, `OPTIONS`\>(`options?`): [`DLayoutBoard`](DLayoutBoard.md)\<`THEME`, `OPTIONS`\>
...
[`DLayoutBoard`](DLayoutBoard.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-layout-board.ts:25](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-layout-board.ts#L25)
