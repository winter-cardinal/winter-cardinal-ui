[Winter Cardinal UI - v0.374.0](../index.md) / DInputSearch
...
[src/main/typescript/wcardinal/ui/d-input-search.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-input-search.ts#L17)
...
▸ **setFocused**(`isFocused`): [`DInputSearch`](DInputSearch.md)\<`THEME`, `OPTIONS`\>
