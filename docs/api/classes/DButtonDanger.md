[Winter Cardinal UI - v0.407.0](../index.md) / DButtonDanger
...
- [\_boundsID](DButtonDanger.md#_boundsid)
- [\_boundsRect](DButtonDanger.md#_boundsrect)
...
- [\_enabledFilters](DButtonDanger.md#_enabledfilters)
- [\_image](DButtonDanger.md#_image)
...
- [\_localBounds](DButtonDanger.md#_localbounds)
- [\_localBoundsRect](DButtonDanger.md#_localboundsrect)
...
- [containerUpdateTransform](DButtonDanger.md#containerupdatetransform)
...
- [disableTempParent](DButtonDanger.md#disabletempparent)
- [displayObjectUpdateTransform](DButtonDanger.md#displayobjectupdatetransform)
- [emit](DButtonDanger.md#emit)
- [enableTempParent](DButtonDanger.md#enabletempparent)
...
- [getImage](DButtonDanger.md#getimage)
- [getLayouter](DButtonDanger.md#getlayouter)
...
- [getText](DButtonDanger.md#gettext)
...
- [newOverflowMask](DButtonDanger.md#newoverflowmask)
- [newPadding](DButtonDanger.md#newpadding)
- [newText](DButtonDanger.md#newtext)
...
- [onReflowTextAndImage](DButtonDanger.md#onreflowtextandimage)
...
• **new DButtonDanger**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DButtonDanger`](DButtonDanger.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-button-danger.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-danger.ts#L20)
...
▸ **setFocused**(`isFocused`): [`DButtonDanger`](DButtonDanger.md)\<`VALUE`, `THEME`, `OPTIONS`\>
