[Winter Cardinal UI - v0.407.0](../index.md) / DThemeWhiteText
...
- [getTextStyleFitting](DThemeWhiteText.md#gettextstylefitting)
...
• **new DThemeWhiteText**\<`VALUE`\>(): [`DThemeWhiteText`](DThemeWhiteText.md)\<`VALUE`\>
...
[src/main/typescript/wcardinal/ui/theme/white/d-theme-white-text.ts:15](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/theme/white/d-theme-white-text.ts#L15)
...
[DThemeText](../interfaces/DThemeText.md).[getTextStyleFitting](../interfaces/DThemeText.md#gettextstylefitting)
