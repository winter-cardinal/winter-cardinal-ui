[Winter Cardinal UI - v0.167.0](../index.md) / DNote

# Class: DNote<THEME, OPTIONS\>
...
- [`DImageBase`](DImageBase.md)<`string`, `THEME`, `OPTIONS`\>
  ...
  ↳↳ [`DNoteError`](DNoteError.md)

  ↳↳ [`DNoteNoItemsFound`](DNoteNoItemsFound.md)

  ↳↳ [`DNoteSearching`](DNoteSearching.md)

  ↳↳ [`DNoteSmall`](DNoteSmall.md)

## Table of contents

### Constructors

- [constructor](DNote.md#constructor)

### Properties

- [\_accessibleActive](DNote.md#_accessibleactive)
- [\_accessibleDiv](DNote.md#_accessiblediv)
- [\_auto](DNote.md#_auto)
- [\_background](DNote.md#_background)
- [\_border](DNote.md#_border)
- [\_bounds](DNote.md#_bounds)
- [\_clearType](DNote.md#_cleartype)
- [\_corner](DNote.md#_corner)
- [\_cursor](DNote.md#_cursor)
- [\_destroyed](DNote.md#_destroyed)
- [\_images](DNote.md#_images)
- [\_isOverflowMaskEnabled](DNote.md#_isoverflowmaskenabled)
- [\_isTextVisible](DNote.md#_istextvisible)
- [\_lastDownPoint](DNote.md#_lastdownpoint)
- [\_lastSortedIndex](DNote.md#_lastsortedindex)
- [\_mask](DNote.md#_mask)
- [\_options](DNote.md#_options)
- [\_outline](DNote.md#_outline)
- [\_overflowMask](DNote.md#_overflowmask)
- [\_padding](DNote.md#_padding)
- [\_reflowable](DNote.md#_reflowable)
- [\_shortcuts](DNote.md#_shortcuts)
- [\_snippet](DNote.md#_snippet)
- [\_tempDisplayObjectParent](DNote.md#_tempdisplayobjectparent)
- [\_text](DNote.md#_text)
- [\_textAlign](DNote.md#_textalign)
- [\_textAlpha](DNote.md#_textalpha)
- [\_textColor](DNote.md#_textcolor)
- [\_textFormatter](DNote.md#_textformatter)
- [\_textStyle](DNote.md#_textstyle)
- [\_textValue](DNote.md#_textvalue)
- [\_textValueComputed](DNote.md#_textvaluecomputed)
- [\_title](DNote.md#_title)
- [\_zIndex](DNote.md#_zindex)
- [accessible](DNote.md#accessible)
- [accessibleChildren](DNote.md#accessiblechildren)
- [accessibleHint](DNote.md#accessiblehint)
- [accessiblePointerEvents](DNote.md#accessiblepointerevents)
- [accessibleTitle](DNote.md#accessibletitle)
- [accessibleType](DNote.md#accessibletype)
- [alpha](DNote.md#alpha)
- [angle](DNote.md#angle)
- [buttonMode](DNote.md#buttonmode)
- [cacheAsBitmap](DNote.md#cacheasbitmap)
- [children](DNote.md#children)
- [cursor](DNote.md#cursor)
- [filterArea](DNote.md#filterarea)
- [filters](DNote.md#filters)
- [hitArea](DNote.md#hitarea)
- [interactive](DNote.md#interactive)
- [interactiveChildren](DNote.md#interactivechildren)
- [isMask](DNote.md#ismask)
- [isSprite](DNote.md#issprite)
- [localTransform](DNote.md#localtransform)
- [mask](DNote.md#mask)
- [name](DNote.md#name)
- [parent](DNote.md#parent)
- [pivot](DNote.md#pivot)
- [renderable](DNote.md#renderable)
- [rotation](DNote.md#rotation)
- [sortDirty](DNote.md#sortdirty)
- [sortableChildren](DNote.md#sortablechildren)
- [transform](DNote.md#transform)
- [visible](DNote.md#visible)
- [worldAlpha](DNote.md#worldalpha)
- [worldTransform](DNote.md#worldtransform)
- [worldVisible](DNote.md#worldvisible)
- [zIndex](DNote.md#zindex)
- [LAYOUTER](DNote.md#layouter)
- [WORK\_CONTAINS\_POINT](DNote.md#work_contains_point)

### Accessors

- [background](DNote.md#background)
- [border](DNote.md#border)
- [corner](DNote.md#corner)
- [height](DNote.md#height)
- [image](DNote.md#image)
- [outline](DNote.md#outline)
- [padding](DNote.md#padding)
- [position](DNote.md#position)
- [reflowable](DNote.md#reflowable)
- [scale](DNote.md#scale)
- [shadow](DNote.md#shadow)
- [skew](DNote.md#skew)
- [snippet](DNote.md#snippet)
- [state](DNote.md#state)
- [text](DNote.md#text)
- [theme](DNote.md#theme)
- [title](DNote.md#title)
- [type](DNote.md#type)
- [unsafe](DNote.md#unsafe)
- [weight](DNote.md#weight)
- [width](DNote.md#width)
- [x](DNote.md#x)
- [y](DNote.md#y)

### Methods

- [\_calculateBounds](DNote.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DNote.md#_recursivepostupdatetransform)
- [\_render](DNote.md#_render)
- [addChild](DNote.md#addchild)
- [addChildAt](DNote.md#addchildat)
- [addListener](DNote.md#addlistener)
- [applyTitle](DNote.md#applytitle)
- [blur](DNote.md#blur)
- [calculateBounds](DNote.md#calculatebounds)
- [computeTextValue](DNote.md#computetextvalue)
- [containsGlobalPoint](DNote.md#containsglobalpoint)
- [containsLocalPoint](DNote.md#containslocalpoint)
- [containsPoint](DNote.md#containspoint)
- [createOrUpdateText](DNote.md#createorupdatetext)
- [createText](DNote.md#createtext)
- [destroy](DNote.md#destroy)
- [displayObjectUpdateTransform](DNote.md#displayobjectupdatetransform)
- [emit](DNote.md#emit)
- [eventNames](DNote.md#eventnames)
- [focus](DNote.md#focus)
- [focusOnClosest](DNote.md#focusonclosest)
- [getBounds](DNote.md#getbounds)
- [getChildAt](DNote.md#getchildat)
- [getChildByName](DNote.md#getchildbyname)
- [getChildIndex](DNote.md#getchildindex)
- [getClearType](DNote.md#getcleartype)
- [getClippingRect](DNote.md#getclippingrect)
- [getGlobalPosition](DNote.md#getglobalposition)
- [getHeight](DNote.md#getheight)
- [getLocalBounds](DNote.md#getlocalbounds)
- [getOverflowMask](DNote.md#getoverflowmask)
- [getParentOfSize](DNote.md#getparentofsize)
- [getTextAlpha](DNote.md#gettextalpha)
- [getTextColor](DNote.md#gettextcolor)
- [getThemeDefault](DNote.md#getthemedefault)
- [getType](DNote.md#gettype)
- [getWidth](DNote.md#getwidth)
- [getX](DNote.md#getx)
- [getY](DNote.md#gety)
- [hasDirty](DNote.md#hasdirty)
- [hasRefitableHeight](DNote.md#hasrefitableheight)
- [hasRefitableWidth](DNote.md#hasrefitablewidth)
- [hide](DNote.md#hide)
- [hideText](DNote.md#hidetext)
- [init](DNote.md#init)
- [initReflowable](DNote.md#initreflowable)
- [isDirty](DNote.md#isdirty)
- [isEventTarget](DNote.md#iseventtarget)
- [isHidden](DNote.md#ishidden)
- [isHierarchyDirty](DNote.md#ishierarchydirty)
- [isRefitable](DNote.md#isrefitable)
- [isShown](DNote.md#isshown)
- [listenerCount](DNote.md#listenercount)
- [listeners](DNote.md#listeners)
- [newImage](DNote.md#newimage)
- [newImages](DNote.md#newimages)
- [off](DNote.md#off)
- [on](DNote.md#on)
- [onBlur](DNote.md#onblur)
- [onChildBlur](DNote.md#onchildblur)
- [onChildFocus](DNote.md#onchildfocus)
- [onChildrenChange](DNote.md#onchildrenchange)
- [onDblClick](DNote.md#ondblclick)
- [onDown](DNote.md#ondown)
- [onDownThis](DNote.md#ondownthis)
- [onFocus](DNote.md#onfocus)
- [onHierarchyDirty](DNote.md#onhierarchydirty)
- [onKeyDown](DNote.md#onkeydown)
- [onKeyUp](DNote.md#onkeyup)
- [onMove](DNote.md#onmove)
- [onOut](DNote.md#onout)
- [onOver](DNote.md#onover)
- [onParentMove](DNote.md#onparentmove)
- [onParentResize](DNote.md#onparentresize)
- [onRefit](DNote.md#onrefit)
- [onReflow](DNote.md#onreflow)
- [onResize](DNote.md#onresize)
- [onScale](DNote.md#onscale)
- [onShortcut](DNote.md#onshortcut)
- [onSkew](DNote.md#onskew)
- [onStateChange](DNote.md#onstatechange)
- [onTextChange](DNote.md#ontextchange)
- [onUp](DNote.md#onup)
- [onUpThis](DNote.md#onupthis)
- [onWheel](DNote.md#onwheel)
- [once](DNote.md#once)
- [reflow](DNote.md#reflow)
- [removeAllListeners](DNote.md#removealllisteners)
- [removeChild](DNote.md#removechild)
- [removeChildAt](DNote.md#removechildat)
- [removeChildren](DNote.md#removechildren)
- [removeListener](DNote.md#removelistener)
- [render](DNote.md#render)
- [renderAdvanced](DNote.md#renderadvanced)
- [resize](DNote.md#resize)
- [setChildIndex](DNote.md#setchildindex)
- [setFocused](DNote.md#setfocused)
- [setHeight](DNote.md#setheight)
- [setParent](DNote.md#setparent)
- [setTransform](DNote.md#settransform)
- [setWidth](DNote.md#setwidth)
- [setX](DNote.md#setx)
- [setY](DNote.md#sety)
- [show](DNote.md#show)
- [showText](DNote.md#showtext)
- [sortChildren](DNote.md#sortchildren)
- [swapChildren](DNote.md#swapchildren)
- [toCursor](DNote.md#tocursor)
- [toDirty](DNote.md#todirty)
- [toGlobal](DNote.md#toglobal)
- [toHasDirty](DNote.md#tohasdirty)
- [toHierarchyDirty](DNote.md#tohierarchydirty)
- [toImageOptions](DNote.md#toimageoptions)
- [toLocal](DNote.md#tolocal)
- [toParentHasDirty](DNote.md#toparenthasdirty)
- [toParentHierarchyDirty](DNote.md#toparenthierarchydirty)
- [toParentResized](DNote.md#toparentresized)
- [updateText](DNote.md#updatetext)
- [updateTextAndImage](DNote.md#updatetextandimage)
- [updateTextColor](DNote.md#updatetextcolor)
- [updateTextPosition](DNote.md#updatetextposition)
- [updateTextValue](DNote.md#updatetextvalue)
- [updateTransform](DNote.md#updatetransform)
- [mixin](DNote.md#mixin)

## Constructors

### constructor

• **new DNote**<`THEME`, `OPTIONS`\>(`options?`)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DNote`](DNote.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DNote`](DNote.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DNote`](DNote.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-note.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-note.ts#L17)
...
▸ **hide**(): [`DNote`](DNote.md)<`THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DNote`](DNote.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DNote`](DNote.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DNote`](DNote.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DNote`](DNote.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DNote`](DNote.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DNote`](DNote.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DNote`](DNote.md)<`THEME`, `OPTIONS`\>
