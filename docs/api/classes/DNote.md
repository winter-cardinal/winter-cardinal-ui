[Winter Cardinal UI - v0.374.0](../index.md) / DNote
...
- [newPadding](DNote.md#newpadding)
- [newText](DNote.md#newtext)
- [off](DNote.md#off)
- [on](DNote.md#on)
...
• **new DNote**\<`THEME`, `OPTIONS`\>(`options?`): [`DNote`](DNote.md)\<`THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DNote`](DNote.md)\<`THEME`, `OPTIONS`\>
