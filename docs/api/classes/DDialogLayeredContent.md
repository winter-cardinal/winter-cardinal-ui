[Winter Cardinal UI - v0.199.0](../index.md) / DDialogLayeredContent
...
- [accessible](DDialogLayeredContent.md#accessible)
...
- [listenerCount](DDialogLayeredContent.md#listenercount)
...
- [mixin](DDialogLayeredContent.md#mixin)

## Constructors

### constructor

• **new DDialogLayeredContent**<`THEME`, `OPTIONS`\>(`options?`)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DDialogLayeredContent`](DDialogLayeredContent.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DDialogLayeredContent`](DDialogLayeredContent.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DDialogLayeredContent`](DDialogLayeredContent.md)<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-layered-content.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.199.0/src/main/typescript/wcardinal/ui/d-dialog-layered-content.ts#L18)
...
▸ **hide**(): [`DDialogLayeredContent`](DDialogLayeredContent.md)<`THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DDialogLayeredContent`](DDialogLayeredContent.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DDialogLayeredContent`](DDialogLayeredContent.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DDialogLayeredContent`](DDialogLayeredContent.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DDialogLayeredContent`](DDialogLayeredContent.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DDialogLayeredContent`](DDialogLayeredContent.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DDialogLayeredContent`](DDialogLayeredContent.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DDialogLayeredContent`](DDialogLayeredContent.md)<`THEME`, `OPTIONS`\>
