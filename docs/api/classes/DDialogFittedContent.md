[Winter Cardinal UI - v0.407.0](../index.md) / DDialogFittedContent
...
[src/main/typescript/wcardinal/ui/d-dialog-fitted-content.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-fitted-content.ts#L22)
...
▸ **setFocused**(`isFocused`): [`DDialogFittedContent`](DDialogFittedContent.md)\<`THEME`, `OPTIONS`\>
