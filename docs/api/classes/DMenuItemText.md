[Winter Cardinal UI - v0.407.0](../index.md) / DMenuItemText
...
[src/main/typescript/wcardinal/ui/d-menu-item-text.ts:115](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-item-text.ts#L115)
...
▸ **setFocused**(`isFocused`): [`DMenuItemText`](DMenuItemText.md)\<`VALUE`, `THEME`, `OPTIONS`\>
