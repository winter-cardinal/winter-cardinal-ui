[Winter Cardinal UI - v0.414.0](../index.md) / DMenuItemText
...
- [\_boundsID](DMenuItemText.md#_boundsid)
- [\_boundsRect](DMenuItemText.md#_boundsrect)
...
- [\_enabledFilters](DMenuItemText.md#_enabledfilters)
- [\_image](DMenuItemText.md#_image)
- [\_lastDownPoint](DMenuItemText.md#_lastdownpoint)
- [\_lastSortedIndex](DMenuItemText.md#_lastsortedindex)
- [\_localBounds](DMenuItemText.md#_localbounds)
- [\_localBoundsRect](DMenuItemText.md#_localboundsrect)
...
- [containerUpdateTransform](DMenuItemText.md#containerupdatetransform)
...
- [disableTempParent](DMenuItemText.md#disabletempparent)
- [displayObjectUpdateTransform](DMenuItemText.md#displayobjectupdatetransform)
- [emit](DMenuItemText.md#emit)
- [enableTempParent](DMenuItemText.md#enabletempparent)
...
- [getImage](DMenuItemText.md#getimage)
- [getLayouter](DMenuItemText.md#getlayouter)
...
- [getText](DMenuItemText.md#gettext)
...
- [newOverflowMask](DMenuItemText.md#newoverflowmask)
- [newPadding](DMenuItemText.md#newpadding)
- [newShortcutText](DMenuItemText.md#newshortcuttext)
- [newText](DMenuItemText.md#newtext)
...
- [onReflowTextAndImage](DMenuItemText.md#onreflowtextandimage)
...
- [updateShortcutColor](DMenuItemText.md#updateshortcutcolor)
...
• **new DMenuItemText**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DMenuItemText`](DMenuItemText.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-menu-item-text.ts:115](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-menu-item-text.ts#L115)
