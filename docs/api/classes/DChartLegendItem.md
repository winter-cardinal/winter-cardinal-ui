[Winter Cardinal UI - v0.407.0](../index.md) / DChartLegendItem
...
- [\_boundsID](DChartLegendItem.md#_boundsid)
- [\_boundsRect](DChartLegendItem.md#_boundsrect)
...
- [\_enabledFilters](DChartLegendItem.md#_enabledfilters)
- [\_lastDownPoint](DChartLegendItem.md#_lastdownpoint)
- [\_lastSortedIndex](DChartLegendItem.md#_lastsortedindex)
- [\_localBounds](DChartLegendItem.md#_localbounds)
- [\_localBoundsRect](DChartLegendItem.md#_localboundsrect)
...
- [options](DChartLegendItem.md#options)
...
- [containerUpdateTransform](DChartLegendItem.md#containerupdatetransform)
...
- [disableTempParent](DChartLegendItem.md#disabletempparent)
- [displayObjectUpdateTransform](DChartLegendItem.md#displayobjectupdatetransform)
- [emit](DChartLegendItem.md#emit)
- [enableTempParent](DChartLegendItem.md#enabletempparent)
...
- [newPadding](DChartLegendItem.md#newpadding)
...
• **new DChartLegendItem**\<`THEME`, `OPTIONS`\>(`options?`): [`DChartLegendItem`](DChartLegendItem.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-chart-legend-item.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-chart-legend-item.ts#L17)
...
▸ **setFocused**(`isFocused`): [`DChartLegendItem`](DChartLegendItem.md)\<`THEME`, `OPTIONS`\>
