[Winter Cardinal UI - v0.154.0](../index.md) / DChartLegendItem
...
- [\_isChildrenDirty](DChartLegendItem.md#_ischildrendirty)
...
- [isChildrenDirty](DChartLegendItem.md#ischildrendirty)
...
- [onChildrenDirty](DChartLegendItem.md#onchildrendirty)
...
- [refit](DChartLegendItem.md#refit)
...
- [toChildrenDirty](DChartLegendItem.md#tochildrendirty)
...
- [toParentChildrenDirty](DChartLegendItem.md#toparentchildrendirty)
...
[src/main/typescript/wcardinal/ui/d-chart-legend-item.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-chart-legend-item.ts#L17)
