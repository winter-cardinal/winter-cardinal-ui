[Winter Cardinal UI - v0.160.0](../index.md) / DNotification

# Class: DNotification<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeNotification`](../interfaces/DThemeNotification.md) = [`DThemeNotification`](../interfaces/DThemeNotification.md) |
| `OPTIONS` | extends [`DNotificationOptions`](../interfaces/DNotificationOptions.md)<`THEME`\> = [`DNotificationOptions`](../interfaces/DNotificationOptions.md)<`THEME`\> |
...
- [constructor](DNotification.md#constructor)

### Properties

- [\_accessibleActive](DNotification.md#_accessibleactive)
- [\_accessibleDiv](DNotification.md#_accessiblediv)
- [\_auto](DNotification.md#_auto)
- [\_background](DNotification.md#_background)
- [\_border](DNotification.md#_border)
- [\_bounds](DNotification.md#_bounds)
- [\_clearType](DNotification.md#_cleartype)
- [\_corner](DNotification.md#_corner)
- [\_cursor](DNotification.md#_cursor)
- [\_destroyed](DNotification.md#_destroyed)
- [\_lastDownPoint](DNotification.md#_lastdownpoint)
- [\_lastSortedIndex](DNotification.md#_lastsortedindex)
- [\_mask](DNotification.md#_mask)
- [\_options](DNotification.md#_options)
- [\_outline](DNotification.md#_outline)
- [\_padding](DNotification.md#_padding)
- [\_reflowable](DNotification.md#_reflowable)
- [\_shortcuts](DNotification.md#_shortcuts)
- [\_snippet](DNotification.md#_snippet)
- [\_tempDisplayObjectParent](DNotification.md#_tempdisplayobjectparent)
- [\_title](DNotification.md#_title)
- [\_zIndex](DNotification.md#_zindex)
- [accessible](DNotification.md#accessible)
- [accessibleChildren](DNotification.md#accessiblechildren)
- [accessibleHint](DNotification.md#accessiblehint)
- [accessiblePointerEvents](DNotification.md#accessiblepointerevents)
- [accessibleTitle](DNotification.md#accessibletitle)
- [accessibleType](DNotification.md#accessibletype)
- [alpha](DNotification.md#alpha)
- [angle](DNotification.md#angle)
- [buttonMode](DNotification.md#buttonmode)
- [cacheAsBitmap](DNotification.md#cacheasbitmap)
- [children](DNotification.md#children)
- [cursor](DNotification.md#cursor)
- [filterArea](DNotification.md#filterarea)
- [filters](DNotification.md#filters)
- [hitArea](DNotification.md#hitarea)
- [interactive](DNotification.md#interactive)
- [interactiveChildren](DNotification.md#interactivechildren)
- [isMask](DNotification.md#ismask)
- [isSprite](DNotification.md#issprite)
- [localTransform](DNotification.md#localtransform)
- [mask](DNotification.md#mask)
- [name](DNotification.md#name)
- [parent](DNotification.md#parent)
- [pivot](DNotification.md#pivot)
- [renderable](DNotification.md#renderable)
- [rotation](DNotification.md#rotation)
- [sortDirty](DNotification.md#sortdirty)
- [sortableChildren](DNotification.md#sortablechildren)
- [transform](DNotification.md#transform)
- [visible](DNotification.md#visible)
- [worldAlpha](DNotification.md#worldalpha)
- [worldTransform](DNotification.md#worldtransform)
- [worldVisible](DNotification.md#worldvisible)
- [zIndex](DNotification.md#zindex)
- [WORK\_CONTAINS\_POINT](DNotification.md#work_contains_point)

### Accessors

- [background](DNotification.md#background)
- [border](DNotification.md#border)
- [corner](DNotification.md#corner)
- [height](DNotification.md#height)
- [outline](DNotification.md#outline)
- [padding](DNotification.md#padding)
- [position](DNotification.md#position)
- [reflowable](DNotification.md#reflowable)
- [scale](DNotification.md#scale)
- [shadow](DNotification.md#shadow)
- [skew](DNotification.md#skew)
- [snippet](DNotification.md#snippet)
- [state](DNotification.md#state)
- [theme](DNotification.md#theme)
- [title](DNotification.md#title)
- [type](DNotification.md#type)
- [unsafe](DNotification.md#unsafe)
- [weight](DNotification.md#weight)
- [width](DNotification.md#width)
- [x](DNotification.md#x)
- [y](DNotification.md#y)

### Methods

- [\_calculateBounds](DNotification.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DNotification.md#_recursivepostupdatetransform)
- [\_render](DNotification.md#_render)
- [addChild](DNotification.md#addchild)
- [addChildAt](DNotification.md#addchildat)
- [addListener](DNotification.md#addlistener)
- [applyTitle](DNotification.md#applytitle)
- [blur](DNotification.md#blur)
- [calculateBounds](DNotification.md#calculatebounds)
- [containsGlobalPoint](DNotification.md#containsglobalpoint)
- [containsLocalPoint](DNotification.md#containslocalpoint)
- [containsPoint](DNotification.md#containspoint)
- [destroy](DNotification.md#destroy)
- [displayObjectUpdateTransform](DNotification.md#displayobjectupdatetransform)
- [emit](DNotification.md#emit)
- [eventNames](DNotification.md#eventnames)
- [focus](DNotification.md#focus)
- [focusOnClosest](DNotification.md#focusonclosest)
- [getBounds](DNotification.md#getbounds)
- [getChildAt](DNotification.md#getchildat)
- [getChildByName](DNotification.md#getchildbyname)
- [getChildIndex](DNotification.md#getchildindex)
- [getClearType](DNotification.md#getcleartype)
- [getClippingRect](DNotification.md#getclippingrect)
- [getGlobalPosition](DNotification.md#getglobalposition)
- [getHeight](DNotification.md#getheight)
- [getLocalBounds](DNotification.md#getlocalbounds)
- [getParentOfSize](DNotification.md#getparentofsize)
- [getThemeDefault](DNotification.md#getthemedefault)
- [getType](DNotification.md#gettype)
- [getWidth](DNotification.md#getwidth)
- [getX](DNotification.md#getx)
- [getY](DNotification.md#gety)
- [hasDirty](DNotification.md#hasdirty)
- [hasRefitableHeight](DNotification.md#hasrefitableheight)
- [hasRefitableWidth](DNotification.md#hasrefitablewidth)
- [hide](DNotification.md#hide)
- [init](DNotification.md#init)
- [initReflowable](DNotification.md#initreflowable)
- [isDirty](DNotification.md#isdirty)
- [isEventTarget](DNotification.md#iseventtarget)
- [isHidden](DNotification.md#ishidden)
- [isHierarchyDirty](DNotification.md#ishierarchydirty)
- [isRefitable](DNotification.md#isrefitable)
- [isShown](DNotification.md#isshown)
- [listenerCount](DNotification.md#listenercount)
- [listeners](DNotification.md#listeners)
- [off](DNotification.md#off)
- [on](DNotification.md#on)
- [onBlur](DNotification.md#onblur)
- [onChildBlur](DNotification.md#onchildblur)
- [onChildFocus](DNotification.md#onchildfocus)
- [onChildrenChange](DNotification.md#onchildrenchange)
- [onDblClick](DNotification.md#ondblclick)
- [onDown](DNotification.md#ondown)
- [onDownThis](DNotification.md#ondownthis)
- [onFocus](DNotification.md#onfocus)
- [onHierarchyDirty](DNotification.md#onhierarchydirty)
- [onKeyDown](DNotification.md#onkeydown)
- [onKeyUp](DNotification.md#onkeyup)
- [onMove](DNotification.md#onmove)
- [onOut](DNotification.md#onout)
- [onOver](DNotification.md#onover)
- [onParentMove](DNotification.md#onparentmove)
- [onParentResize](DNotification.md#onparentresize)
- [onRefit](DNotification.md#onrefit)
- [onReflow](DNotification.md#onreflow)
- [onResize](DNotification.md#onresize)
- [onScale](DNotification.md#onscale)
- [onShortcut](DNotification.md#onshortcut)
- [onSkew](DNotification.md#onskew)
- [onStateChange](DNotification.md#onstatechange)
- [onUp](DNotification.md#onup)
- [onUpThis](DNotification.md#onupthis)
- [onWheel](DNotification.md#onwheel)
- [once](DNotification.md#once)
- [reflow](DNotification.md#reflow)
- [removeAllListeners](DNotification.md#removealllisteners)
- [removeChild](DNotification.md#removechild)
- [removeChildAt](DNotification.md#removechildat)
- [removeChildren](DNotification.md#removechildren)
- [removeListener](DNotification.md#removelistener)
- [render](DNotification.md#render)
- [renderAdvanced](DNotification.md#renderadvanced)
- [resize](DNotification.md#resize)
- [setChildIndex](DNotification.md#setchildindex)
- [setFocused](DNotification.md#setfocused)
- [setHeight](DNotification.md#setheight)
- [setParent](DNotification.md#setparent)
- [setTransform](DNotification.md#settransform)
- [setWidth](DNotification.md#setwidth)
- [setX](DNotification.md#setx)
- [setY](DNotification.md#sety)
- [show](DNotification.md#show)
- [sortChildren](DNotification.md#sortchildren)
- [swapChildren](DNotification.md#swapchildren)
- [toCursor](DNotification.md#tocursor)
- [toDirty](DNotification.md#todirty)
- [toGlobal](DNotification.md#toglobal)
- [toHasDirty](DNotification.md#tohasdirty)
- [toHierarchyDirty](DNotification.md#tohierarchydirty)
- [toLocal](DNotification.md#tolocal)
- [toParentHasDirty](DNotification.md#toparenthasdirty)
- [toParentHierarchyDirty](DNotification.md#toparenthierarchydirty)
- [toParentResized](DNotification.md#toparentresized)
- [updateTransform](DNotification.md#updatetransform)
- [mixin](DNotification.md#mixin)

## Constructors

### constructor

• **new DNotification**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemeNotification`](../interfaces/DThemeNotification.md) = [`DThemeNotification`](../interfaces/DThemeNotification.md) |
| `OPTIONS` | extends [`DNotificationOptions`](../interfaces/DNotificationOptions.md)<`THEME`, `OPTIONS`\> = [`DNotificationOptions`](../interfaces/DNotificationOptions.md)<`THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DNotification`](DNotification.md)<`THEME`, `OPTIONS`\>
...
[`DNotification`](DNotification.md)<`THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DNotification`](DNotification.md)<`THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DNotification`](DNotification.md)<`THEME`, `OPTIONS`\>
...
▸ **hide**(): [`DNotification`](DNotification.md)<`THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DNotification`](DNotification.md)<`THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DNotification`](DNotification.md)<`THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DNotification`](DNotification.md)<`THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DNotification`](DNotification.md)<`THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DNotification`](DNotification.md)<`THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DNotification`](DNotification.md)<`THEME`, `OPTIONS`\>
...
▸ **show**(): [`DNotification`](DNotification.md)<`THEME`, `OPTIONS`\>
