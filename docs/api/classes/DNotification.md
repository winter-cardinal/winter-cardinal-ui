[Winter Cardinal UI - v0.407.0](../index.md) / DNotification
...
- [\_boundsID](DNotification.md#_boundsid)
- [\_boundsRect](DNotification.md#_boundsrect)
...
- [\_enabledFilters](DNotification.md#_enabledfilters)
- [\_lastDownPoint](DNotification.md#_lastdownpoint)
- [\_lastSortedIndex](DNotification.md#_lastsortedindex)
- [\_localBounds](DNotification.md#_localbounds)
- [\_localBoundsRect](DNotification.md#_localboundsrect)
...
- [options](DNotification.md#options)
...
- [containerUpdateTransform](DNotification.md#containerupdatetransform)
...
- [disableTempParent](DNotification.md#disabletempparent)
- [displayObjectUpdateTransform](DNotification.md#displayobjectupdatetransform)
- [emit](DNotification.md#emit)
- [enableTempParent](DNotification.md#enabletempparent)
...
- [newPadding](DNotification.md#newpadding)
...
• **new DNotification**\<`THEME`, `OPTIONS`\>(`options?`): [`DNotification`](DNotification.md)\<`THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DNotification`](DNotification.md)\<`THEME`, `OPTIONS`\>
