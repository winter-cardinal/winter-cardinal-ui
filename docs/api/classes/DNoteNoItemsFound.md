[Winter Cardinal UI - v0.310.1](../index.md) / DNoteNoItemsFound
...
- [options](DNoteNoItemsFound.md#options)
...
[src/main/typescript/wcardinal/ui/d-note-no-items-found.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-note-no-items-found.ts#L18)
