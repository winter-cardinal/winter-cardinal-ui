[Winter Cardinal UI - v0.374.0](../index.md) / DNoteNoItemsFound
...
- [newPadding](DNoteNoItemsFound.md#newpadding)
- [newText](DNoteNoItemsFound.md#newtext)
...
• **new DNoteNoItemsFound**\<`THEME`, `OPTIONS`\>(`options?`): [`DNoteNoItemsFound`](DNoteNoItemsFound.md)\<`THEME`, `OPTIONS`\>
...
[DNote](DNote.md).[newPadding](DNote.md#newpadding)
...
[DNote](DNote.md).[newText](DNote.md#newtext)
...
▸ **setFocused**(`isFocused`): [`DNoteNoItemsFound`](DNoteNoItemsFound.md)\<`THEME`, `OPTIONS`\>
