[Winter Cardinal UI - v0.167.0](../index.md) / DNoteNoItemsFound

# Class: DNoteNoItemsFound<THEME, OPTIONS\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeNote`](../interfaces/DThemeNote.md) = [`DThemeNote`](../interfaces/DThemeNote.md) |
| `OPTIONS` | extends [`DNoteOptions`](../interfaces/DNoteOptions.md)<`THEME`\> = [`DNoteOptions`](../interfaces/DNoteOptions.md)<`THEME`\> |

## Hierarchy

- [`DNote`](DNote.md)<`THEME`, `OPTIONS`\>
...
- [constructor](DNoteNoItemsFound.md#constructor)

### Properties

- [\_accessibleActive](DNoteNoItemsFound.md#_accessibleactive)
- [\_accessibleDiv](DNoteNoItemsFound.md#_accessiblediv)
- [\_auto](DNoteNoItemsFound.md#_auto)
- [\_background](DNoteNoItemsFound.md#_background)
- [\_border](DNoteNoItemsFound.md#_border)
- [\_bounds](DNoteNoItemsFound.md#_bounds)
- [\_clearType](DNoteNoItemsFound.md#_cleartype)
- [\_corner](DNoteNoItemsFound.md#_corner)
- [\_cursor](DNoteNoItemsFound.md#_cursor)
- [\_destroyed](DNoteNoItemsFound.md#_destroyed)
- [\_images](DNoteNoItemsFound.md#_images)
- [\_isOverflowMaskEnabled](DNoteNoItemsFound.md#_isoverflowmaskenabled)
- [\_isTextVisible](DNoteNoItemsFound.md#_istextvisible)
- [\_lastDownPoint](DNoteNoItemsFound.md#_lastdownpoint)
- [\_lastSortedIndex](DNoteNoItemsFound.md#_lastsortedindex)
- [\_mask](DNoteNoItemsFound.md#_mask)
- [\_options](DNoteNoItemsFound.md#_options)
- [\_outline](DNoteNoItemsFound.md#_outline)
- [\_overflowMask](DNoteNoItemsFound.md#_overflowmask)
- [\_padding](DNoteNoItemsFound.md#_padding)
- [\_reflowable](DNoteNoItemsFound.md#_reflowable)
- [\_shortcuts](DNoteNoItemsFound.md#_shortcuts)
- [\_snippet](DNoteNoItemsFound.md#_snippet)
- [\_tempDisplayObjectParent](DNoteNoItemsFound.md#_tempdisplayobjectparent)
- [\_text](DNoteNoItemsFound.md#_text)
- [\_textAlign](DNoteNoItemsFound.md#_textalign)
- [\_textAlpha](DNoteNoItemsFound.md#_textalpha)
- [\_textColor](DNoteNoItemsFound.md#_textcolor)
- [\_textFormatter](DNoteNoItemsFound.md#_textformatter)
- [\_textStyle](DNoteNoItemsFound.md#_textstyle)
- [\_textValue](DNoteNoItemsFound.md#_textvalue)
- [\_textValueComputed](DNoteNoItemsFound.md#_textvaluecomputed)
- [\_title](DNoteNoItemsFound.md#_title)
- [\_zIndex](DNoteNoItemsFound.md#_zindex)
- [accessible](DNoteNoItemsFound.md#accessible)
- [accessibleChildren](DNoteNoItemsFound.md#accessiblechildren)
- [accessibleHint](DNoteNoItemsFound.md#accessiblehint)
- [accessiblePointerEvents](DNoteNoItemsFound.md#accessiblepointerevents)
- [accessibleTitle](DNoteNoItemsFound.md#accessibletitle)
- [accessibleType](DNoteNoItemsFound.md#accessibletype)
- [alpha](DNoteNoItemsFound.md#alpha)
- [angle](DNoteNoItemsFound.md#angle)
- [buttonMode](DNoteNoItemsFound.md#buttonmode)
- [cacheAsBitmap](DNoteNoItemsFound.md#cacheasbitmap)
- [children](DNoteNoItemsFound.md#children)
- [cursor](DNoteNoItemsFound.md#cursor)
- [filterArea](DNoteNoItemsFound.md#filterarea)
- [filters](DNoteNoItemsFound.md#filters)
- [hitArea](DNoteNoItemsFound.md#hitarea)
- [interactive](DNoteNoItemsFound.md#interactive)
- [interactiveChildren](DNoteNoItemsFound.md#interactivechildren)
- [isMask](DNoteNoItemsFound.md#ismask)
- [isSprite](DNoteNoItemsFound.md#issprite)
- [localTransform](DNoteNoItemsFound.md#localtransform)
- [mask](DNoteNoItemsFound.md#mask)
- [name](DNoteNoItemsFound.md#name)
- [parent](DNoteNoItemsFound.md#parent)
- [pivot](DNoteNoItemsFound.md#pivot)
- [renderable](DNoteNoItemsFound.md#renderable)
- [rotation](DNoteNoItemsFound.md#rotation)
- [sortDirty](DNoteNoItemsFound.md#sortdirty)
- [sortableChildren](DNoteNoItemsFound.md#sortablechildren)
- [transform](DNoteNoItemsFound.md#transform)
- [visible](DNoteNoItemsFound.md#visible)
- [worldAlpha](DNoteNoItemsFound.md#worldalpha)
- [worldTransform](DNoteNoItemsFound.md#worldtransform)
- [worldVisible](DNoteNoItemsFound.md#worldvisible)
- [zIndex](DNoteNoItemsFound.md#zindex)
- [LAYOUTER](DNoteNoItemsFound.md#layouter)
- [WORK\_CONTAINS\_POINT](DNoteNoItemsFound.md#work_contains_point)

### Accessors

- [background](DNoteNoItemsFound.md#background)
- [border](DNoteNoItemsFound.md#border)
- [corner](DNoteNoItemsFound.md#corner)
- [height](DNoteNoItemsFound.md#height)
- [image](DNoteNoItemsFound.md#image)
- [outline](DNoteNoItemsFound.md#outline)
- [padding](DNoteNoItemsFound.md#padding)
- [position](DNoteNoItemsFound.md#position)
- [reflowable](DNoteNoItemsFound.md#reflowable)
- [scale](DNoteNoItemsFound.md#scale)
- [shadow](DNoteNoItemsFound.md#shadow)
- [skew](DNoteNoItemsFound.md#skew)
- [snippet](DNoteNoItemsFound.md#snippet)
- [state](DNoteNoItemsFound.md#state)
- [text](DNoteNoItemsFound.md#text)
- [theme](DNoteNoItemsFound.md#theme)
- [title](DNoteNoItemsFound.md#title)
- [type](DNoteNoItemsFound.md#type)
- [unsafe](DNoteNoItemsFound.md#unsafe)
- [weight](DNoteNoItemsFound.md#weight)
- [width](DNoteNoItemsFound.md#width)
- [x](DNoteNoItemsFound.md#x)
- [y](DNoteNoItemsFound.md#y)

### Methods

- [\_calculateBounds](DNoteNoItemsFound.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DNoteNoItemsFound.md#_recursivepostupdatetransform)
- [\_render](DNoteNoItemsFound.md#_render)
- [addChild](DNoteNoItemsFound.md#addchild)
- [addChildAt](DNoteNoItemsFound.md#addchildat)
- [addListener](DNoteNoItemsFound.md#addlistener)
- [applyTitle](DNoteNoItemsFound.md#applytitle)
- [blur](DNoteNoItemsFound.md#blur)
- [calculateBounds](DNoteNoItemsFound.md#calculatebounds)
- [computeTextValue](DNoteNoItemsFound.md#computetextvalue)
- [containsGlobalPoint](DNoteNoItemsFound.md#containsglobalpoint)
- [containsLocalPoint](DNoteNoItemsFound.md#containslocalpoint)
- [containsPoint](DNoteNoItemsFound.md#containspoint)
- [createOrUpdateText](DNoteNoItemsFound.md#createorupdatetext)
- [createText](DNoteNoItemsFound.md#createtext)
- [destroy](DNoteNoItemsFound.md#destroy)
- [displayObjectUpdateTransform](DNoteNoItemsFound.md#displayobjectupdatetransform)
- [emit](DNoteNoItemsFound.md#emit)
- [eventNames](DNoteNoItemsFound.md#eventnames)
- [focus](DNoteNoItemsFound.md#focus)
- [focusOnClosest](DNoteNoItemsFound.md#focusonclosest)
- [getBounds](DNoteNoItemsFound.md#getbounds)
- [getChildAt](DNoteNoItemsFound.md#getchildat)
- [getChildByName](DNoteNoItemsFound.md#getchildbyname)
- [getChildIndex](DNoteNoItemsFound.md#getchildindex)
- [getClearType](DNoteNoItemsFound.md#getcleartype)
- [getClippingRect](DNoteNoItemsFound.md#getclippingrect)
- [getGlobalPosition](DNoteNoItemsFound.md#getglobalposition)
- [getHeight](DNoteNoItemsFound.md#getheight)
- [getLocalBounds](DNoteNoItemsFound.md#getlocalbounds)
- [getOverflowMask](DNoteNoItemsFound.md#getoverflowmask)
- [getParentOfSize](DNoteNoItemsFound.md#getparentofsize)
- [getTextAlpha](DNoteNoItemsFound.md#gettextalpha)
- [getTextColor](DNoteNoItemsFound.md#gettextcolor)
- [getThemeDefault](DNoteNoItemsFound.md#getthemedefault)
- [getType](DNoteNoItemsFound.md#gettype)
- [getWidth](DNoteNoItemsFound.md#getwidth)
- [getX](DNoteNoItemsFound.md#getx)
- [getY](DNoteNoItemsFound.md#gety)
- [hasDirty](DNoteNoItemsFound.md#hasdirty)
- [hasRefitableHeight](DNoteNoItemsFound.md#hasrefitableheight)
- [hasRefitableWidth](DNoteNoItemsFound.md#hasrefitablewidth)
- [hide](DNoteNoItemsFound.md#hide)
- [hideText](DNoteNoItemsFound.md#hidetext)
- [init](DNoteNoItemsFound.md#init)
- [initReflowable](DNoteNoItemsFound.md#initreflowable)
- [isDirty](DNoteNoItemsFound.md#isdirty)
- [isEventTarget](DNoteNoItemsFound.md#iseventtarget)
- [isHidden](DNoteNoItemsFound.md#ishidden)
- [isHierarchyDirty](DNoteNoItemsFound.md#ishierarchydirty)
- [isRefitable](DNoteNoItemsFound.md#isrefitable)
- [isShown](DNoteNoItemsFound.md#isshown)
- [listenerCount](DNoteNoItemsFound.md#listenercount)
- [listeners](DNoteNoItemsFound.md#listeners)
- [newImage](DNoteNoItemsFound.md#newimage)
- [newImages](DNoteNoItemsFound.md#newimages)
- [off](DNoteNoItemsFound.md#off)
- [on](DNoteNoItemsFound.md#on)
- [onBlur](DNoteNoItemsFound.md#onblur)
- [onChildBlur](DNoteNoItemsFound.md#onchildblur)
- [onChildFocus](DNoteNoItemsFound.md#onchildfocus)
- [onChildrenChange](DNoteNoItemsFound.md#onchildrenchange)
- [onDblClick](DNoteNoItemsFound.md#ondblclick)
- [onDown](DNoteNoItemsFound.md#ondown)
- [onDownThis](DNoteNoItemsFound.md#ondownthis)
- [onFocus](DNoteNoItemsFound.md#onfocus)
- [onHierarchyDirty](DNoteNoItemsFound.md#onhierarchydirty)
- [onKeyDown](DNoteNoItemsFound.md#onkeydown)
- [onKeyUp](DNoteNoItemsFound.md#onkeyup)
- [onMove](DNoteNoItemsFound.md#onmove)
- [onOut](DNoteNoItemsFound.md#onout)
- [onOver](DNoteNoItemsFound.md#onover)
- [onParentMove](DNoteNoItemsFound.md#onparentmove)
- [onParentResize](DNoteNoItemsFound.md#onparentresize)
- [onRefit](DNoteNoItemsFound.md#onrefit)
- [onReflow](DNoteNoItemsFound.md#onreflow)
- [onResize](DNoteNoItemsFound.md#onresize)
- [onScale](DNoteNoItemsFound.md#onscale)
- [onShortcut](DNoteNoItemsFound.md#onshortcut)
- [onSkew](DNoteNoItemsFound.md#onskew)
- [onStateChange](DNoteNoItemsFound.md#onstatechange)
- [onTextChange](DNoteNoItemsFound.md#ontextchange)
- [onUp](DNoteNoItemsFound.md#onup)
- [onUpThis](DNoteNoItemsFound.md#onupthis)
- [onWheel](DNoteNoItemsFound.md#onwheel)
- [once](DNoteNoItemsFound.md#once)
- [reflow](DNoteNoItemsFound.md#reflow)
- [removeAllListeners](DNoteNoItemsFound.md#removealllisteners)
- [removeChild](DNoteNoItemsFound.md#removechild)
- [removeChildAt](DNoteNoItemsFound.md#removechildat)
- [removeChildren](DNoteNoItemsFound.md#removechildren)
- [removeListener](DNoteNoItemsFound.md#removelistener)
- [render](DNoteNoItemsFound.md#render)
- [renderAdvanced](DNoteNoItemsFound.md#renderadvanced)
- [resize](DNoteNoItemsFound.md#resize)
- [setChildIndex](DNoteNoItemsFound.md#setchildindex)
- [setFocused](DNoteNoItemsFound.md#setfocused)
- [setHeight](DNoteNoItemsFound.md#setheight)
- [setParent](DNoteNoItemsFound.md#setparent)
- [setTransform](DNoteNoItemsFound.md#settransform)
- [setWidth](DNoteNoItemsFound.md#setwidth)
- [setX](DNoteNoItemsFound.md#setx)
- [setY](DNoteNoItemsFound.md#sety)
- [show](DNoteNoItemsFound.md#show)
- [showText](DNoteNoItemsFound.md#showtext)
- [sortChildren](DNoteNoItemsFound.md#sortchildren)
- [swapChildren](DNoteNoItemsFound.md#swapchildren)
- [toCursor](DNoteNoItemsFound.md#tocursor)
- [toDirty](DNoteNoItemsFound.md#todirty)
- [toGlobal](DNoteNoItemsFound.md#toglobal)
- [toHasDirty](DNoteNoItemsFound.md#tohasdirty)
- [toHierarchyDirty](DNoteNoItemsFound.md#tohierarchydirty)
- [toImageOptions](DNoteNoItemsFound.md#toimageoptions)
- [toLocal](DNoteNoItemsFound.md#tolocal)
- [toParentHasDirty](DNoteNoItemsFound.md#toparenthasdirty)
- [toParentHierarchyDirty](DNoteNoItemsFound.md#toparenthierarchydirty)
- [toParentResized](DNoteNoItemsFound.md#toparentresized)
- [updateText](DNoteNoItemsFound.md#updatetext)
- [updateTextAndImage](DNoteNoItemsFound.md#updatetextandimage)
- [updateTextColor](DNoteNoItemsFound.md#updatetextcolor)
- [updateTextPosition](DNoteNoItemsFound.md#updatetextposition)
- [updateTextValue](DNoteNoItemsFound.md#updatetextvalue)
- [updateTransform](DNoteNoItemsFound.md#updatetransform)
- [mixin](DNoteNoItemsFound.md#mixin)

## Constructors

### constructor

• **new DNoteNoItemsFound**<`THEME`, `OPTIONS`\>(`options?`)

#### Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeNote`](../interfaces/DThemeNote.md)<`THEME`\> = [`DThemeNote`](../interfaces/DThemeNote.md) |
| `OPTIONS` | extends [`DNoteOptions`](../interfaces/DNoteOptions.md)<`THEME`, `OPTIONS`\> = [`DNoteOptions`](../interfaces/DNoteOptions.md)<`THEME`\> |
...
[DNote](DNote.md).[constructor](DNote.md#constructor)
...
[DNote](DNote.md).[_accessibleActive](DNote.md#_accessibleactive)
...
[DNote](DNote.md).[_accessibleDiv](DNote.md#_accessiblediv)
...
[DNote](DNote.md).[_auto](DNote.md#_auto)
...
[DNote](DNote.md).[_background](DNote.md#_background)
...
[DNote](DNote.md).[_border](DNote.md#_border)
...
[DNote](DNote.md).[_bounds](DNote.md#_bounds)
...
[DNote](DNote.md).[_clearType](DNote.md#_cleartype)
...
[DNote](DNote.md).[_corner](DNote.md#_corner)
...
[DNote](DNote.md).[_cursor](DNote.md#_cursor)
...
[DNote](DNote.md).[_destroyed](DNote.md#_destroyed)
...
[DNote](DNote.md).[_images](DNote.md#_images)
...
[DNote](DNote.md).[_isOverflowMaskEnabled](DNote.md#_isoverflowmaskenabled)
...
[DNote](DNote.md).[_isTextVisible](DNote.md#_istextvisible)
...
[DNote](DNote.md).[_lastDownPoint](DNote.md#_lastdownpoint)
...
[DNote](DNote.md).[_lastSortedIndex](DNote.md#_lastsortedindex)
...
[DNote](DNote.md).[_mask](DNote.md#_mask)
...
[DNote](DNote.md).[_options](DNote.md#_options)
...
[DNote](DNote.md).[_outline](DNote.md#_outline)
...
[DNote](DNote.md).[_overflowMask](DNote.md#_overflowmask)
...
[DNote](DNote.md).[_padding](DNote.md#_padding)
...
[DNote](DNote.md).[_reflowable](DNote.md#_reflowable)
...
[DNote](DNote.md).[_shortcuts](DNote.md#_shortcuts)
...
[DNote](DNote.md).[_snippet](DNote.md#_snippet)
...
[DNote](DNote.md).[_tempDisplayObjectParent](DNote.md#_tempdisplayobjectparent)
...
[DNote](DNote.md).[_text](DNote.md#_text)
...
[DNote](DNote.md).[_textAlign](DNote.md#_textalign)
...
[DNote](DNote.md).[_textAlpha](DNote.md#_textalpha)
...
[DNote](DNote.md).[_textColor](DNote.md#_textcolor)
...
[DNote](DNote.md).[_textFormatter](DNote.md#_textformatter)
...
[DNote](DNote.md).[_textStyle](DNote.md#_textstyle)
...
[DNote](DNote.md).[_textValue](DNote.md#_textvalue)
...
[DNote](DNote.md).[_textValueComputed](DNote.md#_textvaluecomputed)
...
[DNote](DNote.md).[_title](DNote.md#_title)
...
[DNote](DNote.md).[_zIndex](DNote.md#_zindex)
...
[DNote](DNote.md).[accessible](DNote.md#accessible)
...
[DNote](DNote.md).[accessibleChildren](DNote.md#accessiblechildren)
...
[DNote](DNote.md).[accessibleHint](DNote.md#accessiblehint)
...
[DNote](DNote.md).[accessiblePointerEvents](DNote.md#accessiblepointerevents)
...
[DNote](DNote.md).[accessibleTitle](DNote.md#accessibletitle)
...
[DNote](DNote.md).[accessibleType](DNote.md#accessibletype)
...
[DNote](DNote.md).[alpha](DNote.md#alpha)
...
[DNote](DNote.md).[angle](DNote.md#angle)
...
[DNote](DNote.md).[buttonMode](DNote.md#buttonmode)
...
[DNote](DNote.md).[cacheAsBitmap](DNote.md#cacheasbitmap)
...
[DNote](DNote.md).[children](DNote.md#children)
...
[DNote](DNote.md).[cursor](DNote.md#cursor)
...
[DNote](DNote.md).[filterArea](DNote.md#filterarea)
...
[DNote](DNote.md).[filters](DNote.md#filters)
...
[DNote](DNote.md).[hitArea](DNote.md#hitarea)
...
[DNote](DNote.md).[interactive](DNote.md#interactive)
...
[DNote](DNote.md).[interactiveChildren](DNote.md#interactivechildren)
...
[DNote](DNote.md).[isMask](DNote.md#ismask)
...
[DNote](DNote.md).[isSprite](DNote.md#issprite)
...
[DNote](DNote.md).[localTransform](DNote.md#localtransform)
...
[DNote](DNote.md).[mask](DNote.md#mask)
...
[DNote](DNote.md).[name](DNote.md#name)
...
[DNote](DNote.md).[parent](DNote.md#parent)
...
[DNote](DNote.md).[pivot](DNote.md#pivot)
...
[DNote](DNote.md).[renderable](DNote.md#renderable)
...
[DNote](DNote.md).[rotation](DNote.md#rotation)
...
[DNote](DNote.md).[sortDirty](DNote.md#sortdirty)
...
[DNote](DNote.md).[sortableChildren](DNote.md#sortablechildren)
...
[DNote](DNote.md).[transform](DNote.md#transform)
...
[DNote](DNote.md).[visible](DNote.md#visible)
...
[DNote](DNote.md).[worldAlpha](DNote.md#worldalpha)
...
[DNote](DNote.md).[worldTransform](DNote.md#worldtransform)
...
[DNote](DNote.md).[worldVisible](DNote.md#worldvisible)
...
[DNote](DNote.md).[zIndex](DNote.md#zindex)
...
[DNote](DNote.md).[LAYOUTER](DNote.md#layouter)
...
[DNote](DNote.md).[WORK_CONTAINS_POINT](DNote.md#work_contains_point)
...
[DNote](DNote.md).[_calculateBounds](DNote.md#_calculatebounds)
...
[DNote](DNote.md).[_recursivePostUpdateTransform](DNote.md#_recursivepostupdatetransform)
...
[DNote](DNote.md).[_render](DNote.md#_render)
...
[DNote](DNote.md).[addChild](DNote.md#addchild)
...
[DNote](DNote.md).[addChildAt](DNote.md#addchildat)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DNoteNoItemsFound`](DNoteNoItemsFound.md)<`THEME`, `OPTIONS`\>
...
[`DNoteNoItemsFound`](DNoteNoItemsFound.md)<`THEME`, `OPTIONS`\>

#### Inherited from

[DNote](DNote.md).[addListener](DNote.md#addlistener)
...
[DNote](DNote.md).[applyTitle](DNote.md#applytitle)
...
▸ **blur**(`recursively?`): [`DNoteNoItemsFound`](DNoteNoItemsFound.md)<`THEME`, `OPTIONS`\>
...
[DNote](DNote.md).[blur](DNote.md#blur)
...
[DNote](DNote.md).[calculateBounds](DNote.md#calculatebounds)
...
[DNote](DNote.md).[computeTextValue](DNote.md#computetextvalue)
...
[DNote](DNote.md).[containsGlobalPoint](DNote.md#containsglobalpoint)
...
[DNote](DNote.md).[containsLocalPoint](DNote.md#containslocalpoint)
...
[DNote](DNote.md).[containsPoint](DNote.md#containspoint)
...
[DNote](DNote.md).[createOrUpdateText](DNote.md#createorupdatetext)
...
[DNote](DNote.md).[createText](DNote.md#createtext)
...
[DNote](DNote.md).[destroy](DNote.md#destroy)
...
[DNote](DNote.md).[displayObjectUpdateTransform](DNote.md#displayobjectupdatetransform)
...
[DNote](DNote.md).[emit](DNote.md#emit)
...
[DNote](DNote.md).[eventNames](DNote.md#eventnames)
...
▸ **focus**(): [`DNoteNoItemsFound`](DNoteNoItemsFound.md)<`THEME`, `OPTIONS`\>
...
[DNote](DNote.md).[focus](DNote.md#focus)
...
[DNote](DNote.md).[focusOnClosest](DNote.md#focusonclosest)
...
[DNote](DNote.md).[getBounds](DNote.md#getbounds)
...
[DNote](DNote.md).[getChildAt](DNote.md#getchildat)
...
[DNote](DNote.md).[getChildByName](DNote.md#getchildbyname)
...
[DNote](DNote.md).[getChildIndex](DNote.md#getchildindex)
...
[DNote](DNote.md).[getClearType](DNote.md#getcleartype)
...
[DNote](DNote.md).[getClippingRect](DNote.md#getclippingrect)
...
[DNote](DNote.md).[getGlobalPosition](DNote.md#getglobalposition)
...
[DNote](DNote.md).[getHeight](DNote.md#getheight)
...
[DNote](DNote.md).[getLocalBounds](DNote.md#getlocalbounds)
...
[DNote](DNote.md).[getOverflowMask](DNote.md#getoverflowmask)
...
[DNote](DNote.md).[getParentOfSize](DNote.md#getparentofsize)
...
[DNote](DNote.md).[getTextAlpha](DNote.md#gettextalpha)
...
[DNote](DNote.md).[getTextColor](DNote.md#gettextcolor)
...
[DNote](DNote.md).[getThemeDefault](DNote.md#getthemedefault)
...
[DNote](DNote.md).[getType](DNote.md#gettype)

#### Defined in

[src/main/typescript/wcardinal/ui/d-note-no-items-found.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-note-no-items-found.ts#L18)
...
[DNote](DNote.md).[getWidth](DNote.md#getwidth)
...
[DNote](DNote.md).[getX](DNote.md#getx)
...
[DNote](DNote.md).[getY](DNote.md#gety)
...
[DNote](DNote.md).[hasDirty](DNote.md#hasdirty)
...
[DNote](DNote.md).[hasRefitableHeight](DNote.md#hasrefitableheight)
...
[DNote](DNote.md).[hasRefitableWidth](DNote.md#hasrefitablewidth)
...
▸ **hide**(): [`DNoteNoItemsFound`](DNoteNoItemsFound.md)<`THEME`, `OPTIONS`\>
...
[DNote](DNote.md).[hide](DNote.md#hide)
...
[DNote](DNote.md).[hideText](DNote.md#hidetext)
...
[DNote](DNote.md).[init](DNote.md#init)
...
[DNote](DNote.md).[initReflowable](DNote.md#initreflowable)
...
[DNote](DNote.md).[isDirty](DNote.md#isdirty)
...
[DNote](DNote.md).[isEventTarget](DNote.md#iseventtarget)
...
[DNote](DNote.md).[isHidden](DNote.md#ishidden)
...
[DNote](DNote.md).[isHierarchyDirty](DNote.md#ishierarchydirty)
...
[DNote](DNote.md).[isRefitable](DNote.md#isrefitable)
...
[DNote](DNote.md).[isShown](DNote.md#isshown)
...
[DNote](DNote.md).[listenerCount](DNote.md#listenercount)
...
[DNote](DNote.md).[listeners](DNote.md#listeners)
...
[DNote](DNote.md).[newImage](DNote.md#newimage)
...
[DNote](DNote.md).[newImages](DNote.md#newimages)
...
▸ **off**(`event`, `fn?`, `context?`): [`DNoteNoItemsFound`](DNoteNoItemsFound.md)<`THEME`, `OPTIONS`\>
...
[DNote](DNote.md).[off](DNote.md#off)
...
▸ **on**(`event`, `fn`, `context?`): [`DNoteNoItemsFound`](DNoteNoItemsFound.md)<`THEME`, `OPTIONS`\>
...
[DNote](DNote.md).[onBlur](DNote.md#onblur)
...
[DNote](DNote.md).[onChildBlur](DNote.md#onchildblur)
...
[DNote](DNote.md).[onChildFocus](DNote.md#onchildfocus)
...
[DNote](DNote.md).[onChildrenChange](DNote.md#onchildrenchange)
...
[DNote](DNote.md).[onDblClick](DNote.md#ondblclick)
...
[DNote](DNote.md).[onDown](DNote.md#ondown)
...
[DNote](DNote.md).[onDownThis](DNote.md#ondownthis)
...
[DNote](DNote.md).[onFocus](DNote.md#onfocus)
...
[DNote](DNote.md).[onHierarchyDirty](DNote.md#onhierarchydirty)
...
[DNote](DNote.md).[onKeyDown](DNote.md#onkeydown)
...
[DNote](DNote.md).[onKeyUp](DNote.md#onkeyup)
...
[DNote](DNote.md).[onMove](DNote.md#onmove)
...
[DNote](DNote.md).[onOut](DNote.md#onout)
...
[DNote](DNote.md).[onOver](DNote.md#onover)
...
[DNote](DNote.md).[onParentMove](DNote.md#onparentmove)
...
[DNote](DNote.md).[onParentResize](DNote.md#onparentresize)
...
[DNote](DNote.md).[onRefit](DNote.md#onrefit)
...
[DNote](DNote.md).[onReflow](DNote.md#onreflow)
...
[DNote](DNote.md).[onResize](DNote.md#onresize)
...
[DNote](DNote.md).[onScale](DNote.md#onscale)
...
[DNote](DNote.md).[onShortcut](DNote.md#onshortcut)
...
[DNote](DNote.md).[onSkew](DNote.md#onskew)
...
[DNote](DNote.md).[onStateChange](DNote.md#onstatechange)
...
[DNote](DNote.md).[onTextChange](DNote.md#ontextchange)
...
[DNote](DNote.md).[onUp](DNote.md#onup)
...
[DNote](DNote.md).[onUpThis](DNote.md#onupthis)
...
[DNote](DNote.md).[onWheel](DNote.md#onwheel)
...
▸ **once**(`event`, `fn`, `context?`): [`DNoteNoItemsFound`](DNoteNoItemsFound.md)<`THEME`, `OPTIONS`\>
...
[DNote](DNote.md).[once](DNote.md#once)
...
[DNote](DNote.md).[reflow](DNote.md#reflow)
...
▸ **removeAllListeners**(`event?`): [`DNoteNoItemsFound`](DNoteNoItemsFound.md)<`THEME`, `OPTIONS`\>
...
[DNote](DNote.md).[removeAllListeners](DNote.md#removealllisteners)
...
[DNote](DNote.md).[removeChild](DNote.md#removechild)
...
[DNote](DNote.md).[removeChildAt](DNote.md#removechildat)
...
[DNote](DNote.md).[removeChildren](DNote.md#removechildren)
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DNoteNoItemsFound`](DNoteNoItemsFound.md)<`THEME`, `OPTIONS`\>
...
[DNote](DNote.md).[removeListener](DNote.md#removelistener)
...
[DNote](DNote.md).[render](DNote.md#render)
...
[DNote](DNote.md).[renderAdvanced](DNote.md#renderadvanced)
...
[DNote](DNote.md).[resize](DNote.md#resize)
...
[DNote](DNote.md).[setChildIndex](DNote.md#setchildindex)
...
▸ `Protected` **setFocused**(`isFocused`): [`DNoteNoItemsFound`](DNoteNoItemsFound.md)<`THEME`, `OPTIONS`\>
...
[DNote](DNote.md).[setFocused](DNote.md#setfocused)
...
[DNote](DNote.md).[setHeight](DNote.md#setheight)
...
[DNote](DNote.md).[setParent](DNote.md#setparent)
...
[DNote](DNote.md).[setTransform](DNote.md#settransform)
...
[DNote](DNote.md).[setWidth](DNote.md#setwidth)
...
[DNote](DNote.md).[setX](DNote.md#setx)
...
[DNote](DNote.md).[setY](DNote.md#sety)
...
▸ **show**(): [`DNoteNoItemsFound`](DNoteNoItemsFound.md)<`THEME`, `OPTIONS`\>
...
[DNote](DNote.md).[show](DNote.md#show)
...
[DNote](DNote.md).[showText](DNote.md#showtext)
...
[DNote](DNote.md).[sortChildren](DNote.md#sortchildren)
...
[DNote](DNote.md).[swapChildren](DNote.md#swapchildren)
...
[DNote](DNote.md).[toCursor](DNote.md#tocursor)
...
[DNote](DNote.md).[toDirty](DNote.md#todirty)
...
[DNote](DNote.md).[toGlobal](DNote.md#toglobal)
...
[DNote](DNote.md).[toHasDirty](DNote.md#tohasdirty)
...
[DNote](DNote.md).[toHierarchyDirty](DNote.md#tohierarchydirty)
...
[DNote](DNote.md).[toImageOptions](DNote.md#toimageoptions)
...
[DNote](DNote.md).[toLocal](DNote.md#tolocal)
...
[DNote](DNote.md).[toParentHasDirty](DNote.md#toparenthasdirty)
...
[DNote](DNote.md).[toParentHierarchyDirty](DNote.md#toparenthierarchydirty)
...
[DNote](DNote.md).[toParentResized](DNote.md#toparentresized)
...
[DNote](DNote.md).[updateText](DNote.md#updatetext)
...
[DNote](DNote.md).[updateTextAndImage](DNote.md#updatetextandimage)
...
[DNote](DNote.md).[updateTextColor](DNote.md#updatetextcolor)
...
[DNote](DNote.md).[updateTextPosition](DNote.md#updatetextposition)
...
[DNote](DNote.md).[updateTextValue](DNote.md#updatetextvalue)
...
[DNote](DNote.md).[updateTransform](DNote.md#updatetransform)
...
[DNote](DNote.md).[mixin](DNote.md#mixin)
