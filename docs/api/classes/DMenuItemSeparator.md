[Winter Cardinal UI - v0.167.0](../index.md) / DMenuItemSeparator
...
- [createText](DMenuItemSeparator.md#createtext)
...
- [initOnClick](DMenuItemSeparator.md#initonclick)
...
• **new DMenuItemSeparator**<`VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
[src/main/typescript/wcardinal/ui/d-menu-item-separator.ts:37](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-menu-item-separator.ts#L37)
...
▸ `Protected` **setFocused**(`isFocused`): [`DMenuItemSeparator`](DMenuItemSeparator.md)<`VALUE`, `THEME`, `OPTIONS`\>
