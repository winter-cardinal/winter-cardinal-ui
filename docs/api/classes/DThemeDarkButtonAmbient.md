[Winter Cardinal UI - v0.154.0](../index.md) / DThemeDarkButtonAmbient
...
- [`DThemeDarkButtonBase`](DThemeDarkButtonBase.md)<`VALUE`\>
  ...
  ↳↳ [`DThemeDarkPaginationNavigationButton`](DThemeDarkPaginationNavigationButton.md)

  ↳↳ [`DThemeDarkPaginationDotsButton`](DThemeDarkPaginationDotsButton.md)
