[Winter Cardinal UI - v0.414.0](../index.md) / DThemeWhiteButtonSecondary
...
- [getImageRotation](DThemeWhiteButtonSecondary.md#getimagerotation)
...
- [getSecondaryImageRotation](DThemeWhiteButtonSecondary.md#getsecondaryimagerotation)
...
- [getTertiaryImageRotation](DThemeWhiteButtonSecondary.md#gettertiaryimagerotation)
...
- [getTextStyleFitting](DThemeWhiteButtonSecondary.md#gettextstylefitting)
...
• **new DThemeWhiteButtonSecondary**\<`VALUE`\>(`backgroundColor?`, `hover?`, `pressed?`): [`DThemeWhiteButtonSecondary`](DThemeWhiteButtonSecondary.md)\<`VALUE`\>
...
[`DThemeWhiteButtonSecondary`](DThemeWhiteButtonSecondary.md)\<`VALUE`\>
