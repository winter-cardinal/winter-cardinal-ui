[Winter Cardinal UI - v0.310.1](../index.md) / DTableBodyCellInputTreeMarker
...
- [\_isGrouped](DTableBodyCellInputTreeMarker.md#_isgrouped)
...
- [isGrouped](DTableBodyCellInputTreeMarker.md#isgrouped)
...
- [activate](DTableBodyCellInputTreeMarker.md#activate)
...
- [onPress](DTableBodyCellInputTreeMarker.md#onpress)
...
- [onUnpress](DTableBodyCellInputTreeMarker.md#onunpress)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-input-tree-marker.ts:24](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-table-body-cell-input-tree-marker.ts#L24)
