[Winter Cardinal UI - v0.374.0](../index.md) / DTableBodyCellInputTreeMarker
...
- [newPadding](DTableBodyCellInputTreeMarker.md#newpadding)
- [newText](DTableBodyCellInputTreeMarker.md#newtext)
...
• **new DTableBodyCellInputTreeMarker**\<`VALUE`, `THEME`, `OPTIONS`\>(`options?`): [`DTableBodyCellInputTreeMarker`](DTableBodyCellInputTreeMarker.md)\<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DTableBodyCellInputTreeMarker`](DTableBodyCellInputTreeMarker.md)\<`VALUE`, `THEME`, `OPTIONS`\>
