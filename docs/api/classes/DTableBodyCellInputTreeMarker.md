[Winter Cardinal UI - v0.167.0](../index.md) / DTableBodyCellInputTreeMarker

# Class: DTableBodyCellInputTreeMarker<VALUE, THEME, OPTIONS\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeTableBodyCellInputTreeMarker`](../interfaces/DThemeTableBodyCellInputTreeMarker.md)<`VALUE`\> = [`DThemeTableBodyCellInputTreeMarker`](../interfaces/DThemeTableBodyCellInputTreeMarker.md)<`VALUE`\> |
| `OPTIONS` | extends [`DTableBodyCellInputTreeMarkerOptions`](../interfaces/DTableBodyCellInputTreeMarkerOptions.md)<`VALUE`, `THEME`\> = [`DTableBodyCellInputTreeMarkerOptions`](../interfaces/DTableBodyCellInputTreeMarkerOptions.md)<`VALUE`, `THEME`\> |

## Hierarchy

- [`DButtonBase`](DButtonBase.md)<`VALUE`, `THEME`, `OPTIONS`\>

  ↳ **`DTableBodyCellInputTreeMarker`**

## Table of contents

### Constructors

- [constructor](DTableBodyCellInputTreeMarker.md#constructor)

### Properties

- [\_accessibleActive](DTableBodyCellInputTreeMarker.md#_accessibleactive)
- [\_accessibleDiv](DTableBodyCellInputTreeMarker.md#_accessiblediv)
- [\_auto](DTableBodyCellInputTreeMarker.md#_auto)
- [\_background](DTableBodyCellInputTreeMarker.md#_background)
- [\_border](DTableBodyCellInputTreeMarker.md#_border)
- [\_bounds](DTableBodyCellInputTreeMarker.md#_bounds)
- [\_clearType](DTableBodyCellInputTreeMarker.md#_cleartype)
- [\_corner](DTableBodyCellInputTreeMarker.md#_corner)
- [\_cursor](DTableBodyCellInputTreeMarker.md#_cursor)
- [\_destroyed](DTableBodyCellInputTreeMarker.md#_destroyed)
- [\_images](DTableBodyCellInputTreeMarker.md#_images)
- [\_isOverflowMaskEnabled](DTableBodyCellInputTreeMarker.md#_isoverflowmaskenabled)
- [\_isTextVisible](DTableBodyCellInputTreeMarker.md#_istextvisible)
- [\_isToggle](DTableBodyCellInputTreeMarker.md#_istoggle)
- [\_lastDownPoint](DTableBodyCellInputTreeMarker.md#_lastdownpoint)
- [\_lastSortedIndex](DTableBodyCellInputTreeMarker.md#_lastsortedindex)
- [\_mask](DTableBodyCellInputTreeMarker.md#_mask)
- [\_options](DTableBodyCellInputTreeMarker.md#_options)
- [\_outline](DTableBodyCellInputTreeMarker.md#_outline)
- [\_overflowMask](DTableBodyCellInputTreeMarker.md#_overflowmask)
- [\_padding](DTableBodyCellInputTreeMarker.md#_padding)
- [\_reflowable](DTableBodyCellInputTreeMarker.md#_reflowable)
- [\_shortcuts](DTableBodyCellInputTreeMarker.md#_shortcuts)
- [\_snippet](DTableBodyCellInputTreeMarker.md#_snippet)
- [\_tempDisplayObjectParent](DTableBodyCellInputTreeMarker.md#_tempdisplayobjectparent)
- [\_text](DTableBodyCellInputTreeMarker.md#_text)
- [\_textAlign](DTableBodyCellInputTreeMarker.md#_textalign)
- [\_textAlpha](DTableBodyCellInputTreeMarker.md#_textalpha)
- [\_textColor](DTableBodyCellInputTreeMarker.md#_textcolor)
- [\_textFormatter](DTableBodyCellInputTreeMarker.md#_textformatter)
- [\_textStyle](DTableBodyCellInputTreeMarker.md#_textstyle)
- [\_textValue](DTableBodyCellInputTreeMarker.md#_textvalue)
- [\_textValueComputed](DTableBodyCellInputTreeMarker.md#_textvaluecomputed)
- [\_title](DTableBodyCellInputTreeMarker.md#_title)
- [\_when](DTableBodyCellInputTreeMarker.md#_when)
- [\_zIndex](DTableBodyCellInputTreeMarker.md#_zindex)
- [accessible](DTableBodyCellInputTreeMarker.md#accessible)
- [accessibleChildren](DTableBodyCellInputTreeMarker.md#accessiblechildren)
- [accessibleHint](DTableBodyCellInputTreeMarker.md#accessiblehint)
- [accessiblePointerEvents](DTableBodyCellInputTreeMarker.md#accessiblepointerevents)
- [accessibleTitle](DTableBodyCellInputTreeMarker.md#accessibletitle)
- [accessibleType](DTableBodyCellInputTreeMarker.md#accessibletype)
- [alpha](DTableBodyCellInputTreeMarker.md#alpha)
- [angle](DTableBodyCellInputTreeMarker.md#angle)
- [buttonMode](DTableBodyCellInputTreeMarker.md#buttonmode)
- [cacheAsBitmap](DTableBodyCellInputTreeMarker.md#cacheasbitmap)
- [children](DTableBodyCellInputTreeMarker.md#children)
- [cursor](DTableBodyCellInputTreeMarker.md#cursor)
- [filterArea](DTableBodyCellInputTreeMarker.md#filterarea)
- [filters](DTableBodyCellInputTreeMarker.md#filters)
- [hitArea](DTableBodyCellInputTreeMarker.md#hitarea)
- [interactive](DTableBodyCellInputTreeMarker.md#interactive)
- [interactiveChildren](DTableBodyCellInputTreeMarker.md#interactivechildren)
- [isMask](DTableBodyCellInputTreeMarker.md#ismask)
- [isSprite](DTableBodyCellInputTreeMarker.md#issprite)
- [localTransform](DTableBodyCellInputTreeMarker.md#localtransform)
- [mask](DTableBodyCellInputTreeMarker.md#mask)
- [name](DTableBodyCellInputTreeMarker.md#name)
- [parent](DTableBodyCellInputTreeMarker.md#parent)
- [pivot](DTableBodyCellInputTreeMarker.md#pivot)
- [renderable](DTableBodyCellInputTreeMarker.md#renderable)
- [rotation](DTableBodyCellInputTreeMarker.md#rotation)
- [sortDirty](DTableBodyCellInputTreeMarker.md#sortdirty)
- [sortableChildren](DTableBodyCellInputTreeMarker.md#sortablechildren)
- [transform](DTableBodyCellInputTreeMarker.md#transform)
- [visible](DTableBodyCellInputTreeMarker.md#visible)
- [worldAlpha](DTableBodyCellInputTreeMarker.md#worldalpha)
- [worldTransform](DTableBodyCellInputTreeMarker.md#worldtransform)
- [worldVisible](DTableBodyCellInputTreeMarker.md#worldvisible)
- [zIndex](DTableBodyCellInputTreeMarker.md#zindex)
- [LAYOUTER](DTableBodyCellInputTreeMarker.md#layouter)
- [WORK\_CONTAINS\_POINT](DTableBodyCellInputTreeMarker.md#work_contains_point)

### Accessors

- [background](DTableBodyCellInputTreeMarker.md#background)
- [border](DTableBodyCellInputTreeMarker.md#border)
- [corner](DTableBodyCellInputTreeMarker.md#corner)
- [height](DTableBodyCellInputTreeMarker.md#height)
- [image](DTableBodyCellInputTreeMarker.md#image)
- [isToggle](DTableBodyCellInputTreeMarker.md#istoggle)
- [outline](DTableBodyCellInputTreeMarker.md#outline)
- [padding](DTableBodyCellInputTreeMarker.md#padding)
- [position](DTableBodyCellInputTreeMarker.md#position)
- [reflowable](DTableBodyCellInputTreeMarker.md#reflowable)
- [scale](DTableBodyCellInputTreeMarker.md#scale)
- [shadow](DTableBodyCellInputTreeMarker.md#shadow)
- [skew](DTableBodyCellInputTreeMarker.md#skew)
- [snippet](DTableBodyCellInputTreeMarker.md#snippet)
- [state](DTableBodyCellInputTreeMarker.md#state)
- [text](DTableBodyCellInputTreeMarker.md#text)
- [theme](DTableBodyCellInputTreeMarker.md#theme)
- [title](DTableBodyCellInputTreeMarker.md#title)
- [type](DTableBodyCellInputTreeMarker.md#type)
- [unsafe](DTableBodyCellInputTreeMarker.md#unsafe)
- [weight](DTableBodyCellInputTreeMarker.md#weight)
- [width](DTableBodyCellInputTreeMarker.md#width)
- [x](DTableBodyCellInputTreeMarker.md#x)
- [y](DTableBodyCellInputTreeMarker.md#y)

### Methods

- [\_calculateBounds](DTableBodyCellInputTreeMarker.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DTableBodyCellInputTreeMarker.md#_recursivepostupdatetransform)
- [\_render](DTableBodyCellInputTreeMarker.md#_render)
- [addChild](DTableBodyCellInputTreeMarker.md#addchild)
- [addChildAt](DTableBodyCellInputTreeMarker.md#addchildat)
- [addListener](DTableBodyCellInputTreeMarker.md#addlistener)
- [applyTitle](DTableBodyCellInputTreeMarker.md#applytitle)
- [blur](DTableBodyCellInputTreeMarker.md#blur)
- [calculateBounds](DTableBodyCellInputTreeMarker.md#calculatebounds)
- [computeTextValue](DTableBodyCellInputTreeMarker.md#computetextvalue)
- [containsGlobalPoint](DTableBodyCellInputTreeMarker.md#containsglobalpoint)
- [containsLocalPoint](DTableBodyCellInputTreeMarker.md#containslocalpoint)
- [containsPoint](DTableBodyCellInputTreeMarker.md#containspoint)
- [createOrUpdateText](DTableBodyCellInputTreeMarker.md#createorupdatetext)
- [createText](DTableBodyCellInputTreeMarker.md#createtext)
- [destroy](DTableBodyCellInputTreeMarker.md#destroy)
- [displayObjectUpdateTransform](DTableBodyCellInputTreeMarker.md#displayobjectupdatetransform)
- [emit](DTableBodyCellInputTreeMarker.md#emit)
- [eventNames](DTableBodyCellInputTreeMarker.md#eventnames)
- [focus](DTableBodyCellInputTreeMarker.md#focus)
- [focusOnClosest](DTableBodyCellInputTreeMarker.md#focusonclosest)
- [getBounds](DTableBodyCellInputTreeMarker.md#getbounds)
- [getChildAt](DTableBodyCellInputTreeMarker.md#getchildat)
- [getChildByName](DTableBodyCellInputTreeMarker.md#getchildbyname)
- [getChildIndex](DTableBodyCellInputTreeMarker.md#getchildindex)
- [getClearType](DTableBodyCellInputTreeMarker.md#getcleartype)
- [getClippingRect](DTableBodyCellInputTreeMarker.md#getclippingrect)
- [getGlobalPosition](DTableBodyCellInputTreeMarker.md#getglobalposition)
- [getHeight](DTableBodyCellInputTreeMarker.md#getheight)
- [getLocalBounds](DTableBodyCellInputTreeMarker.md#getlocalbounds)
- [getOverflowMask](DTableBodyCellInputTreeMarker.md#getoverflowmask)
- [getParentOfSize](DTableBodyCellInputTreeMarker.md#getparentofsize)
- [getTextAlpha](DTableBodyCellInputTreeMarker.md#gettextalpha)
- [getTextColor](DTableBodyCellInputTreeMarker.md#gettextcolor)
- [getThemeDefault](DTableBodyCellInputTreeMarker.md#getthemedefault)
- [getType](DTableBodyCellInputTreeMarker.md#gettype)
- [getWidth](DTableBodyCellInputTreeMarker.md#getwidth)
- [getX](DTableBodyCellInputTreeMarker.md#getx)
- [getY](DTableBodyCellInputTreeMarker.md#gety)
- [hasDirty](DTableBodyCellInputTreeMarker.md#hasdirty)
- [hasRefitableHeight](DTableBodyCellInputTreeMarker.md#hasrefitableheight)
- [hasRefitableWidth](DTableBodyCellInputTreeMarker.md#hasrefitablewidth)
- [hide](DTableBodyCellInputTreeMarker.md#hide)
- [hideText](DTableBodyCellInputTreeMarker.md#hidetext)
- [init](DTableBodyCellInputTreeMarker.md#init)
- [initOnClick](DTableBodyCellInputTreeMarker.md#initonclick)
- [initOnPress](DTableBodyCellInputTreeMarker.md#initonpress)
- [initReflowable](DTableBodyCellInputTreeMarker.md#initreflowable)
- [isDirty](DTableBodyCellInputTreeMarker.md#isdirty)
- [isEventTarget](DTableBodyCellInputTreeMarker.md#iseventtarget)
- [isHidden](DTableBodyCellInputTreeMarker.md#ishidden)
- [isHierarchyDirty](DTableBodyCellInputTreeMarker.md#ishierarchydirty)
- [isRefitable](DTableBodyCellInputTreeMarker.md#isrefitable)
- [isShown](DTableBodyCellInputTreeMarker.md#isshown)
- [listenerCount](DTableBodyCellInputTreeMarker.md#listenercount)
- [listeners](DTableBodyCellInputTreeMarker.md#listeners)
- [newImage](DTableBodyCellInputTreeMarker.md#newimage)
- [newImages](DTableBodyCellInputTreeMarker.md#newimages)
- [off](DTableBodyCellInputTreeMarker.md#off)
- [on](DTableBodyCellInputTreeMarker.md#on)
- [onActivate](DTableBodyCellInputTreeMarker.md#onactivate)
- [onActivateKeyDown](DTableBodyCellInputTreeMarker.md#onactivatekeydown)
- [onActivateKeyUp](DTableBodyCellInputTreeMarker.md#onactivatekeyup)
- [onBlur](DTableBodyCellInputTreeMarker.md#onblur)
- [onChildBlur](DTableBodyCellInputTreeMarker.md#onchildblur)
- [onChildFocus](DTableBodyCellInputTreeMarker.md#onchildfocus)
- [onChildrenChange](DTableBodyCellInputTreeMarker.md#onchildrenchange)
- [onClick](DTableBodyCellInputTreeMarker.md#onclick)
- [onDblClick](DTableBodyCellInputTreeMarker.md#ondblclick)
- [onDown](DTableBodyCellInputTreeMarker.md#ondown)
- [onDownThis](DTableBodyCellInputTreeMarker.md#ondownthis)
- [onFocus](DTableBodyCellInputTreeMarker.md#onfocus)
- [onHierarchyDirty](DTableBodyCellInputTreeMarker.md#onhierarchydirty)
- [onInactivate](DTableBodyCellInputTreeMarker.md#oninactivate)
- [onKeyDown](DTableBodyCellInputTreeMarker.md#onkeydown)
- [onKeyUp](DTableBodyCellInputTreeMarker.md#onkeyup)
- [onMove](DTableBodyCellInputTreeMarker.md#onmove)
- [onOut](DTableBodyCellInputTreeMarker.md#onout)
- [onOver](DTableBodyCellInputTreeMarker.md#onover)
- [onParentMove](DTableBodyCellInputTreeMarker.md#onparentmove)
- [onParentResize](DTableBodyCellInputTreeMarker.md#onparentresize)
- [onRefit](DTableBodyCellInputTreeMarker.md#onrefit)
- [onReflow](DTableBodyCellInputTreeMarker.md#onreflow)
- [onResize](DTableBodyCellInputTreeMarker.md#onresize)
- [onScale](DTableBodyCellInputTreeMarker.md#onscale)
- [onShortcut](DTableBodyCellInputTreeMarker.md#onshortcut)
- [onSkew](DTableBodyCellInputTreeMarker.md#onskew)
- [onStateChange](DTableBodyCellInputTreeMarker.md#onstatechange)
- [onTextChange](DTableBodyCellInputTreeMarker.md#ontextchange)
- [onToggleEnd](DTableBodyCellInputTreeMarker.md#ontoggleend)
- [onToggleStart](DTableBodyCellInputTreeMarker.md#ontogglestart)
- [onUp](DTableBodyCellInputTreeMarker.md#onup)
- [onUpThis](DTableBodyCellInputTreeMarker.md#onupthis)
- [onWheel](DTableBodyCellInputTreeMarker.md#onwheel)
- [once](DTableBodyCellInputTreeMarker.md#once)
- [reflow](DTableBodyCellInputTreeMarker.md#reflow)
- [removeAllListeners](DTableBodyCellInputTreeMarker.md#removealllisteners)
- [removeChild](DTableBodyCellInputTreeMarker.md#removechild)
- [removeChildAt](DTableBodyCellInputTreeMarker.md#removechildat)
- [removeChildren](DTableBodyCellInputTreeMarker.md#removechildren)
- [removeListener](DTableBodyCellInputTreeMarker.md#removelistener)
- [render](DTableBodyCellInputTreeMarker.md#render)
- [renderAdvanced](DTableBodyCellInputTreeMarker.md#renderadvanced)
- [resize](DTableBodyCellInputTreeMarker.md#resize)
- [setChildIndex](DTableBodyCellInputTreeMarker.md#setchildindex)
- [setFocused](DTableBodyCellInputTreeMarker.md#setfocused)
- [setHeight](DTableBodyCellInputTreeMarker.md#setheight)
- [setParent](DTableBodyCellInputTreeMarker.md#setparent)
- [setTransform](DTableBodyCellInputTreeMarker.md#settransform)
- [setWidth](DTableBodyCellInputTreeMarker.md#setwidth)
- [setX](DTableBodyCellInputTreeMarker.md#setx)
- [setY](DTableBodyCellInputTreeMarker.md#sety)
- [show](DTableBodyCellInputTreeMarker.md#show)
- [showText](DTableBodyCellInputTreeMarker.md#showtext)
- [sortChildren](DTableBodyCellInputTreeMarker.md#sortchildren)
- [swapChildren](DTableBodyCellInputTreeMarker.md#swapchildren)
- [toCursor](DTableBodyCellInputTreeMarker.md#tocursor)
- [toDirty](DTableBodyCellInputTreeMarker.md#todirty)
- [toGlobal](DTableBodyCellInputTreeMarker.md#toglobal)
- [toHasDirty](DTableBodyCellInputTreeMarker.md#tohasdirty)
- [toHierarchyDirty](DTableBodyCellInputTreeMarker.md#tohierarchydirty)
- [toImageOptions](DTableBodyCellInputTreeMarker.md#toimageoptions)
- [toLocal](DTableBodyCellInputTreeMarker.md#tolocal)
- [toParentHasDirty](DTableBodyCellInputTreeMarker.md#toparenthasdirty)
- [toParentHierarchyDirty](DTableBodyCellInputTreeMarker.md#toparenthierarchydirty)
- [toParentResized](DTableBodyCellInputTreeMarker.md#toparentresized)
- [toggle](DTableBodyCellInputTreeMarker.md#toggle)
- [updateText](DTableBodyCellInputTreeMarker.md#updatetext)
- [updateTextAndImage](DTableBodyCellInputTreeMarker.md#updatetextandimage)
- [updateTextColor](DTableBodyCellInputTreeMarker.md#updatetextcolor)
- [updateTextPosition](DTableBodyCellInputTreeMarker.md#updatetextposition)
- [updateTextValue](DTableBodyCellInputTreeMarker.md#updatetextvalue)
- [updateTransform](DTableBodyCellInputTreeMarker.md#updatetransform)
- [mixin](DTableBodyCellInputTreeMarker.md#mixin)

## Constructors

### constructor

• **new DTableBodyCellInputTreeMarker**<`VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeTableBodyCellInputTreeMarker`](../interfaces/DThemeTableBodyCellInputTreeMarker.md)<`VALUE`, `THEME`\> = [`DThemeTableBodyCellInputTreeMarker`](../interfaces/DThemeTableBodyCellInputTreeMarker.md)<`VALUE`\> |
| `OPTIONS` | extends [`DTableBodyCellInputTreeMarkerOptions`](../interfaces/DTableBodyCellInputTreeMarkerOptions.md)<`VALUE`, `THEME`, `OPTIONS`\> = [`DTableBodyCellInputTreeMarkerOptions`](../interfaces/DTableBodyCellInputTreeMarkerOptions.md)<`VALUE`, `THEME`\> |
...
▸ **addListener**(`event`, `fn`, `context?`): [`DTableBodyCellInputTreeMarker`](DTableBodyCellInputTreeMarker.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[`DTableBodyCellInputTreeMarker`](DTableBodyCellInputTreeMarker.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DTableBodyCellInputTreeMarker`](DTableBodyCellInputTreeMarker.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **focus**(): [`DTableBodyCellInputTreeMarker`](DTableBodyCellInputTreeMarker.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-input-tree-marker.ts:24](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-table-body-cell-input-tree-marker.ts#L24)
...
▸ **hide**(): [`DTableBodyCellInputTreeMarker`](DTableBodyCellInputTreeMarker.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
[DButtonBase](DButtonBase.md).[initOnClick](DButtonBase.md#initonclick)
...
▸ **off**(`event`, `fn?`, `context?`): [`DTableBodyCellInputTreeMarker`](DTableBodyCellInputTreeMarker.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DTableBodyCellInputTreeMarker`](DTableBodyCellInputTreeMarker.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DTableBodyCellInputTreeMarker`](DTableBodyCellInputTreeMarker.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DTableBodyCellInputTreeMarker`](DTableBodyCellInputTreeMarker.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DTableBodyCellInputTreeMarker`](DTableBodyCellInputTreeMarker.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DTableBodyCellInputTreeMarker`](DTableBodyCellInputTreeMarker.md)<`VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DTableBodyCellInputTreeMarker`](DTableBodyCellInputTreeMarker.md)<`VALUE`, `THEME`, `OPTIONS`\>
