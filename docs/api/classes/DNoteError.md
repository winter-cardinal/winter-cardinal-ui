[Winter Cardinal UI - v0.374.0](../index.md) / DNoteError
...
- [newPadding](DNoteError.md#newpadding)
- [newText](DNoteError.md#newtext)
...
• **new DNoteError**\<`THEME`, `OPTIONS`\>(`options?`): [`DNoteError`](DNoteError.md)\<`THEME`, `OPTIONS`\>
...
▸ **setFocused**(`isFocused`): [`DNoteError`](DNoteError.md)\<`THEME`, `OPTIONS`\>
