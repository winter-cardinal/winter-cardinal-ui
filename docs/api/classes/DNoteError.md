[Winter Cardinal UI - v0.155.0](../index.md) / DNoteError
...
- [\_isChildrenDirty](DNoteError.md#_ischildrendirty)
...
- [isChildrenDirty](DNoteError.md#ischildrendirty)
...
- [onChildrenDirty](DNoteError.md#onchildrendirty)
...
- [toChildrenDirty](DNoteError.md#tochildrendirty)
...
[src/main/typescript/wcardinal/ui/d-note-error.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-note-error.ts#L17)
