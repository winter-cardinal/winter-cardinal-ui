[Winter Cardinal UI - v0.407.0](../index.md) / DNoteError
...
- [\_boundsID](DNoteError.md#_boundsid)
- [\_boundsRect](DNoteError.md#_boundsrect)
...
- [\_enabledFilters](DNoteError.md#_enabledfilters)
- [\_image](DNoteError.md#_image)
- [\_lastDownPoint](DNoteError.md#_lastdownpoint)
- [\_lastSortedIndex](DNoteError.md#_lastsortedindex)
- [\_localBounds](DNoteError.md#_localbounds)
- [\_localBoundsRect](DNoteError.md#_localboundsrect)
...
- [containerUpdateTransform](DNoteError.md#containerupdatetransform)
...
- [disableTempParent](DNoteError.md#disabletempparent)
- [displayObjectUpdateTransform](DNoteError.md#displayobjectupdatetransform)
- [emit](DNoteError.md#emit)
- [enableTempParent](DNoteError.md#enabletempparent)
...
- [getImage](DNoteError.md#getimage)
- [getLayouter](DNoteError.md#getlayouter)
...
- [newOverflowMask](DNoteError.md#newoverflowmask)
...
- [onReflowTextAndImage](DNoteError.md#onreflowtextandimage)
...
[src/main/typescript/wcardinal/ui/d-note-error.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-note-error.ts#L17)
