[Winter Cardinal UI - v0.155.0](../index.md) / DPaginationDots
...
- [\_isChildrenDirty](DPaginationDots.md#_ischildrendirty)
...
- [isChildrenDirty](DPaginationDots.md#ischildrendirty)
...
- [onChildrenDirty](DPaginationDots.md#onchildrendirty)
...
- [refit](DPaginationDots.md#refit)
...
- [toChildrenDirty](DPaginationDots.md#tochildrendirty)
...
[src/main/typescript/wcardinal/ui/d-pagination-dots.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-pagination-dots.ts#L17)
