[Winter Cardinal UI - v0.407.0](../index.md) / DPaginationDots
...
- [\_boundsID](DPaginationDots.md#_boundsid)
- [\_boundsRect](DPaginationDots.md#_boundsrect)
...
- [\_enabledFilters](DPaginationDots.md#_enabledfilters)
- [\_image](DPaginationDots.md#_image)
- [\_lastDownPoint](DPaginationDots.md#_lastdownpoint)
- [\_lastSortedIndex](DPaginationDots.md#_lastsortedindex)
- [\_localBounds](DPaginationDots.md#_localbounds)
- [\_localBoundsRect](DPaginationDots.md#_localboundsrect)
...
- [containerUpdateTransform](DPaginationDots.md#containerupdatetransform)
...
- [disableTempParent](DPaginationDots.md#disabletempparent)
- [displayObjectUpdateTransform](DPaginationDots.md#displayobjectupdatetransform)
- [emit](DPaginationDots.md#emit)
- [enableTempParent](DPaginationDots.md#enabletempparent)
...
- [getImage](DPaginationDots.md#getimage)
- [getLayouter](DPaginationDots.md#getlayouter)
...
- [getText](DPaginationDots.md#gettext)
...
- [newOverflowMask](DPaginationDots.md#newoverflowmask)
- [newPadding](DPaginationDots.md#newpadding)
- [newText](DPaginationDots.md#newtext)
...
- [onReflowTextAndImage](DPaginationDots.md#onreflowtextandimage)
...
• **new DPaginationDots**\<`THEME`, `OPTIONS`\>(`options?`): [`DPaginationDots`](DPaginationDots.md)\<`THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-pagination-dots.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-pagination-dots.ts#L17)
...
▸ **setFocused**(`isFocused`): [`DPaginationDots`](DPaginationDots.md)\<`THEME`, `OPTIONS`\>
