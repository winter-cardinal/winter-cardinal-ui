[Winter Cardinal UI - v0.167.0](../index.md) / DDropdownBase
...
- [\_images](DDropdownBase.md#_images)
- [\_isOverflowMaskEnabled](DDropdownBase.md#_isoverflowmaskenabled)
- [\_isTextVisible](DDropdownBase.md#_istextvisible)
...
- [\_textAlign](DDropdownBase.md#_textalign)
- [\_textAlpha](DDropdownBase.md#_textalpha)
- [\_textColor](DDropdownBase.md#_textcolor)
- [\_textFormatter](DDropdownBase.md#_textformatter)
- [\_textStyle](DDropdownBase.md#_textstyle)
- [\_textValue](DDropdownBase.md#_textvalue)
- [\_textValueComputed](DDropdownBase.md#_textvaluecomputed)
...
- [computeTextValue](DDropdownBase.md#computetextvalue)
...
- [createOrUpdateText](DDropdownBase.md#createorupdatetext)
- [createText](DDropdownBase.md#createtext)
...
- [getTextAlpha](DDropdownBase.md#gettextalpha)
- [getTextColor](DDropdownBase.md#gettextcolor)
...
- [hideText](DDropdownBase.md#hidetext)
- [init](DDropdownBase.md#init)
- [initOnClick](DDropdownBase.md#initonclick)
...
- [newImages](DDropdownBase.md#newimages)
...
- [onTextChange](DDropdownBase.md#ontextchange)
...
- [showText](DDropdownBase.md#showtext)
- [sortChildren](DDropdownBase.md#sortchildren)
- [start](DDropdownBase.md#start)
...
- [toImageOptions](DDropdownBase.md#toimageoptions)
...
- [updateText](DDropdownBase.md#updatetext)
- [updateTextAndImage](DDropdownBase.md#updatetextandimage)
- [updateTextColor](DDropdownBase.md#updatetextcolor)
- [updateTextPosition](DDropdownBase.md#updatetextposition)
- [updateTextValue](DDropdownBase.md#updatetextvalue)
...
• **new DDropdownBase**<`VALUE`, `TEXT_VALUE`, `THEME`, `OPTIONS`\>(`options?`)
...
| `VALUE` | `unknown` |
| `TEXT_VALUE` | `string` |
| `THEME` | extends [`DThemeDropdownBase`](../interfaces/DThemeDropdownBase.md)<`TEXT_VALUE`, `THEME`\> = [`DThemeDropdownBase`](../interfaces/DThemeDropdownBase.md)<`TEXT_VALUE`\> |
| `OPTIONS` | extends [`DDropdownBaseOptions`](../interfaces/DDropdownBaseOptions.md)<`VALUE`, `TEXT_VALUE`, `THEME`, `any`, `OPTIONS`\> = [`DDropdownBaseOptions`](../interfaces/DDropdownBaseOptions.md)<`VALUE`, `TEXT_VALUE`, `THEME`, `any`\> |
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:83](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L83)
...
• `Protected` **\_textFormatter**: (`value`: `TEXT_VALUE`, `caller`: `any`) => `string`
...
• `Protected` `Optional` **\_textValue**: [`DStateAwareOrValueMightBe`](../index.md#dstateawareorvaluemightbe)<`TEXT_VALUE`\>
...
• `Protected` `Optional` **\_textValueComputed**: `TEXT_VALUE`
...
▸ **addListener**(`event`, `fn`, `context?`): [`DDropdownBase`](DDropdownBase.md)<`VALUE`, `TEXT_VALUE`, `THEME`, `OPTIONS`\>
...
▸ **blur**(`recursively?`): [`DDropdownBase`](DDropdownBase.md)<`VALUE`, `TEXT_VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **computeTextValue**(): `undefined` \| `TEXT_VALUE`
...
▸ **focus**(): [`DDropdownBase`](DDropdownBase.md)<`VALUE`, `TEXT_VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:150](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L150)
...
▸ **hide**(): [`DDropdownBase`](DDropdownBase.md)<`VALUE`, `TEXT_VALUE`, `THEME`, `OPTIONS`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DDropdownBase`](DDropdownBase.md)<`VALUE`, `TEXT_VALUE`, `THEME`, `OPTIONS`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DDropdownBase`](DDropdownBase.md)<`VALUE`, `TEXT_VALUE`, `THEME`, `OPTIONS`\>
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:87](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L87)
...
▸ **once**(`event`, `fn`, `context?`): [`DDropdownBase`](DDropdownBase.md)<`VALUE`, `TEXT_VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeAllListeners**(`event?`): [`DDropdownBase`](DDropdownBase.md)<`VALUE`, `TEXT_VALUE`, `THEME`, `OPTIONS`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DDropdownBase`](DDropdownBase.md)<`VALUE`, `TEXT_VALUE`, `THEME`, `OPTIONS`\>
...
▸ `Protected` **setFocused**(`isFocused`): [`DDropdownBase`](DDropdownBase.md)<`VALUE`, `TEXT_VALUE`, `THEME`, `OPTIONS`\>
...
▸ **show**(): [`DDropdownBase`](DDropdownBase.md)<`VALUE`, `TEXT_VALUE`, `THEME`, `OPTIONS`\>
