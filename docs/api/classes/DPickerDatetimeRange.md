[Winter Cardinal UI - v0.160.0](../index.md) / DPickerDatetimeRange
...
• **new DPickerDatetimeRange**<`THEME`, `OPTIONS`\>(`options?`)
...
| :------ | :------ |
| `THEME` | extends [`DThemePickerDatetimeRange`](../interfaces/DThemePickerDatetimeRange.md) = [`DThemePickerDatetimeRange`](../interfaces/DThemePickerDatetimeRange.md) |
| `OPTIONS` | extends [`DPickerDatetimeRangeOptions`](../interfaces/DPickerDatetimeRangeOptions.md)<`THEME`, `OPTIONS`\> = [`DPickerDatetimeRangeOptions`](../interfaces/DPickerDatetimeRangeOptions.md)<`THEME`\> |
...
▸ `Protected` **setFocused**(`isFocused`): [`DPickerDatetimeRange`](DPickerDatetimeRange.md)<`THEME`, `OPTIONS`\>
