[Winter Cardinal UI - v0.407.0](../index.md) / DDialogLayered
...
[src/main/typescript/wcardinal/ui/d-dialog-layered.ts:253](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-layered.ts#L253)
...
▸ **setFocused**(`isFocused`): [`DDialogLayered`](DDialogLayered.md)\<`VALUE`, `THEME`, `OPTIONS`\>
