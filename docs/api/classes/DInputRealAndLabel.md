[Winter Cardinal UI - v0.414.0](../index.md) / DInputRealAndLabel
...
[src/main/typescript/wcardinal/ui/d-input-real-and-label.ts:16](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-input-real-and-label.ts#L16)
