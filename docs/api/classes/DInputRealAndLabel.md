[Winter Cardinal UI - v0.155.0](../index.md) / DInputRealAndLabel
...
- [\_isChildrenDirty](DInputRealAndLabel.md#_ischildrendirty)
...
- [isChildrenDirty](DInputRealAndLabel.md#ischildrendirty)
...
- [onChildrenDirty](DInputRealAndLabel.md#onchildrendirty)
...
- [refit](DInputRealAndLabel.md#refit)
...
- [toChildrenDirty](DInputRealAndLabel.md#tochildrendirty)
...
- [toParentChildrenDirty](DInputRealAndLabel.md#toparentchildrendirty)
...
[src/main/typescript/wcardinal/ui/d-input-real-and-label.ts:16](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-input-real-and-label.ts#L16)
