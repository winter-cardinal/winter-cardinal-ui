[Winter Cardinal UI - v0.310.1](../index.md) / DTableBodyCellInputTreeInputOptions
...
A renderability.
Unlike [visible](DTableBodyCellInputTreeInputOptions.md#visible), non-renderable element occupies a space.
