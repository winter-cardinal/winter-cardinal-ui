[Winter Cardinal UI - v0.310.1](../index.md) / DLayoutHorizontalOptions
...
- [renderable](DLayoutHorizontalOptions.md#renderable)
...
A renderability.
Unlike [visible](DLayoutHorizontalOptions.md#visible), non-renderable element occupies a space.
