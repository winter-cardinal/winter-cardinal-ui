[Winter Cardinal UI - v0.310.1](../index.md) / DImageOptions

# Interface: DImageOptions<VALUE, THEME\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeImage`](DThemeImage.md)<`VALUE`\> = [`DThemeImage`](DThemeImage.md)<`VALUE`\> |
...
- [`DImageBaseOptions`](DImageBaseOptions.md)<`VALUE`, `THEME`\>
  ...
  ↳↳ [`DDialogConfirmMessageOptions`](DDialogConfirmMessageOptions.md)

  ↳↳ [`DExpandableHeaderOptions`](DExpandableHeaderOptions.md)

  ↳↳ [`DMenuItemBaseOptions`](DMenuItemBaseOptions.md)

  ↳↳ [`DTableCategoryCellOptions`](DTableCategoryCellOptions.md)

  ↳↳ [`DTableHeaderCellOptions`](DTableHeaderCellOptions.md)

## Table of contents

### Properties

- [background](DImageOptions.md#background)
- [border](DImageOptions.md#border)
- [children](DImageOptions.md#children)
- [clear](DImageOptions.md#clear)
- [corner](DImageOptions.md#corner)
- [cursor](DImageOptions.md#cursor)
- [height](DImageOptions.md#height)
- [image](DImageOptions.md#image)
- [interactive](DImageOptions.md#interactive)
- [mask](DImageOptions.md#mask)
- [name](DImageOptions.md#name)
- [on](DImageOptions.md#on)
- [outline](DImageOptions.md#outline)
- [padding](DImageOptions.md#padding)
- [parent](DImageOptions.md#parent)
- [renderable](DImageOptions.md#renderable)
- [shadow](DImageOptions.md#shadow)
- [shortcut](DImageOptions.md#shortcut)
- [shortcuts](DImageOptions.md#shortcuts)
- [state](DImageOptions.md#state)
- [text](DImageOptions.md#text)
- [theme](DImageOptions.md#theme)
- [title](DImageOptions.md#title)
- [visible](DImageOptions.md#visible)
- [weight](DImageOptions.md#weight)
- [width](DImageOptions.md#width)
- [x](DImageOptions.md#x)
- [y](DImageOptions.md#y)
...
A renderability.
Unlike [visible](DImageOptions.md#visible), non-renderable element occupies a space.
