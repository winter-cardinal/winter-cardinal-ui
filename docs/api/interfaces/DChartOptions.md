[Winter Cardinal UI - v0.442.0](../index.md) / DChartOptions

# Interface: DChartOptions\<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeChart`](DThemeChart.md) |
...
- [background](DChartOptions.md#background)
- [border](DChartOptions.md#border)
- [children](DChartOptions.md#children)
- [clear](DChartOptions.md#clear)
- [corner](DChartOptions.md#corner)
- [cursor](DChartOptions.md#cursor)
- [height](DChartOptions.md#height)
- [interactive](DChartOptions.md#interactive)
- [mask](DChartOptions.md#mask)
- [name](DChartOptions.md#name)
- [on](DChartOptions.md#on)
- [outline](DChartOptions.md#outline)
- [padding](DChartOptions.md#padding)
- [parent](DChartOptions.md#parent)
- [plotArea](DChartOptions.md#plotarea)
- [renderable](DChartOptions.md#renderable)
- [shadow](DChartOptions.md#shadow)
- [shortcut](DChartOptions.md#shortcut)
- [shortcuts](DChartOptions.md#shortcuts)
- [state](DChartOptions.md#state)
- [theme](DChartOptions.md#theme)
- [title](DChartOptions.md#title)
- [visible](DChartOptions.md#visible)
- [weight](DChartOptions.md#weight)
- [width](DChartOptions.md#width)
- [x](DChartOptions.md#x)
- [y](DChartOptions.md#y)
...
[src/main/typescript/wcardinal/ui/d-chart.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/d-chart.ts#L17)
...
• **plotArea**: [`DChartPlotAreaSingleOptions`](DChartPlotAreaSingleOptions.md)\<[`DChart`](../classes/DChart.md)\<[`DThemeChart`](DThemeChart.md), [`DChartOptions`](DChartOptions.md)\<[`DThemeChart`](DThemeChart.md)\>\>, [`DThemeChartPlotArea`](DThemeChartPlotArea.md)\> \| [`DChartPlotAreaTwofoldOptions`](DChartPlotAreaTwofoldOptions.md)\<[`DChart`](../classes/DChart.md)\<[`DThemeChart`](DThemeChart.md), [`DChartOptions`](DChartOptions.md)\<[`DThemeChart`](DThemeChart.md)\>\>, [`DThemeChartPlotArea`](DThemeChartPlotArea.md)\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-chart.ts:16](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/d-chart.ts#L16)
