[Winter Cardinal UI - v0.310.1](../index.md) / DChartOptions
...
[src/main/typescript/wcardinal/ui/d-chart.ts:13](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-chart.ts#L13)
...
• **plotArea**: [`DChartPlotAreaOptions`](DChartPlotAreaOptions.md)<[`DChart`](../classes/DChart.md)<[`DThemeChart`](DThemeChart.md), [`DChartOptions`](DChartOptions.md)<[`DThemeChart`](DThemeChart.md)\>\>, [`DThemeChartPlotArea`](DThemeChartPlotArea.md)\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-chart.ts:12](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-chart.ts#L12)
...
A renderability.
Unlike [visible](DChartOptions.md#visible), non-renderable element occupies a space.
