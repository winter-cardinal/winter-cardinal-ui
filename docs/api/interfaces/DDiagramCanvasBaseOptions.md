[Winter Cardinal UI - v0.310.1](../index.md) / DDiagramCanvasBaseOptions
...
A renderability.
Unlike [visible](DDiagramCanvasBaseOptions.md#visible), non-renderable element occupies a space.
