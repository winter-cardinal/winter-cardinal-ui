[Winter Cardinal UI - v0.205.1](../index.md) / DDialogConfirmOptions

# Interface: DDialogConfirmOptions<THEME\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeDialogConfirm`](DThemeDialogConfirm.md) = [`DThemeDialogConfirm`](DThemeDialogConfirm.md) |

## Hierarchy

- [`DDialogLayeredOptions`](DDialogLayeredOptions.md)<`void`, `THEME`\>

  ↳ **`DDialogConfirmOptions`**

  ↳↳ [`DDialogConfirmDeleteOptions`](DDialogConfirmDeleteOptions.md)

  ↳↳ [`DDialogConfirmDiscardOptions`](DDialogConfirmDiscardOptions.md)

  ↳↳ [`DDialogMessageOptions`](DDialogMessageOptions.md)

  ↳↳ [`DDialogProcessingOptions`](DDialogProcessingOptions.md)

## Table of contents

### Properties

- [align](DDialogConfirmOptions.md#align)
- [animation](DDialogConfirmOptions.md#animation)
- [background](DDialogConfirmOptions.md#background)
- [border](DDialogConfirmOptions.md#border)
- [children](DDialogConfirmOptions.md#children)
- [clear](DDialogConfirmOptions.md#clear)
- [closeOn](DDialogConfirmOptions.md#closeon)
- [content](DDialogConfirmOptions.md#content)
- [corner](DDialogConfirmOptions.md#corner)
- [cursor](DDialogConfirmOptions.md#cursor)
- [footer](DDialogConfirmOptions.md#footer)
- [gesture](DDialogConfirmOptions.md#gesture)
- [header](DDialogConfirmOptions.md#header)
- [height](DDialogConfirmOptions.md#height)
- [interactive](DDialogConfirmOptions.md#interactive)
- [layout](DDialogConfirmOptions.md#layout)
- [message](DDialogConfirmOptions.md#message)
- [mode](DDialogConfirmOptions.md#mode)
- [name](DDialogConfirmOptions.md#name)
- [on](DDialogConfirmOptions.md#on)
- [outline](DDialogConfirmOptions.md#outline)
- [padding](DDialogConfirmOptions.md#padding)
- [parent](DDialogConfirmOptions.md#parent)
- [shadow](DDialogConfirmOptions.md#shadow)
- [shortcut](DDialogConfirmOptions.md#shortcut)
- [shortcuts](DDialogConfirmOptions.md#shortcuts)
- [state](DDialogConfirmOptions.md#state)
- [sticky](DDialogConfirmOptions.md#sticky)
- [theme](DDialogConfirmOptions.md#theme)
- [title](DDialogConfirmOptions.md#title)
- [visible](DDialogConfirmOptions.md#visible)
- [weight](DDialogConfirmOptions.md#weight)
- [width](DDialogConfirmOptions.md#width)
- [x](DDialogConfirmOptions.md#x)
- [y](DDialogConfirmOptions.md#y)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:72](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog.ts#L72)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:61](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog.ts#L61)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:59](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog.ts#L59)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered.ts:64](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-layered.ts#L64)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered.ts:69](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-layered.ts#L69)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:70](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog.ts#L70)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered.ts:59](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-layered.ts#L59)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered.ts:54](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-layered.ts#L54)
...
[src/main/typescript/wcardinal/ui/d-dialog-confirm.ts:16](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-confirm.ts#L16)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:66](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog.ts#L66)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered.ts:74](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-layered.ts#L74)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:68](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog.ts#L68)
