[Winter Cardinal UI - v0.165.0](../index.md) / DThemeDialogSelecList

# Interface: DThemeDialogSelecList

## Hierarchy

- [`DThemeList`](DThemeList.md)

  ↳ **`DThemeDialogSelecList`**
...
- [getAlpha](DThemeDialogSelecList.md#getalpha)
- [getBackgroundAlpha](DThemeDialogSelecList.md#getbackgroundalpha)
- [getBackgroundColor](DThemeDialogSelecList.md#getbackgroundcolor)
- [getBackgroundTexture](DThemeDialogSelecList.md#getbackgroundtexture)
- [getBorderAlign](DThemeDialogSelecList.md#getborderalign)
- [getBorderAlpha](DThemeDialogSelecList.md#getborderalpha)
- [getBorderColor](DThemeDialogSelecList.md#getbordercolor)
- [getBorderMask](DThemeDialogSelecList.md#getbordermask)
- [getBorderTexture](DThemeDialogSelecList.md#getbordertexture)
- [getBorderWidth](DThemeDialogSelecList.md#getborderwidth)
- [getClearType](DThemeDialogSelecList.md#getcleartype)
- [getColor](DThemeDialogSelecList.md#getcolor)
- [getCornerMask](DThemeDialogSelecList.md#getcornermask)
- [getCornerRadius](DThemeDialogSelecList.md#getcornerradius)
- [getCursor](DThemeDialogSelecList.md#getcursor)
- [getFontFamilly](DThemeDialogSelecList.md#getfontfamilly)
- [getFontSize](DThemeDialogSelecList.md#getfontsize)
- [getFontStyle](DThemeDialogSelecList.md#getfontstyle)
- [getFontVariant](DThemeDialogSelecList.md#getfontvariant)
- [getFontWeight](DThemeDialogSelecList.md#getfontweight)
- [getGestureMode](DThemeDialogSelecList.md#getgesturemode)
- [getHeight](DThemeDialogSelecList.md#getheight)
- [getInteractive](DThemeDialogSelecList.md#getinteractive)
- [getLineHeight](DThemeDialogSelecList.md#getlineheight)
- [getOutlineAlign](DThemeDialogSelecList.md#getoutlinealign)
- [getOutlineAlpha](DThemeDialogSelecList.md#getoutlinealpha)
- [getOutlineColor](DThemeDialogSelecList.md#getoutlinecolor)
- [getOutlineMask](DThemeDialogSelecList.md#getoutlinemask)
- [getOutlineOffset](DThemeDialogSelecList.md#getoutlineoffset)
- [getOutlineWidth](DThemeDialogSelecList.md#getoutlinewidth)
- [getPaddingBottom](DThemeDialogSelecList.md#getpaddingbottom)
- [getPaddingLeft](DThemeDialogSelecList.md#getpaddingleft)
- [getPaddingRight](DThemeDialogSelecList.md#getpaddingright)
- [getPaddingTop](DThemeDialogSelecList.md#getpaddingtop)
- [getShadow](DThemeDialogSelecList.md#getshadow)
- [getTitle](DThemeDialogSelecList.md#gettitle)
- [getWeight](DThemeDialogSelecList.md#getweight)
- [getWheelSpeed](DThemeDialogSelecList.md#getwheelspeed)
- [getWidth](DThemeDialogSelecList.md#getwidth)
- [getX](DThemeDialogSelecList.md#getx)
- [getY](DThemeDialogSelecList.md#gety)
- [isOverflowMaskEnabled](DThemeDialogSelecList.md#isoverflowmaskenabled)
- [newShadow](DThemeDialogSelecList.md#newshadow)
- [newShadowWeak](DThemeDialogSelecList.md#newshadowweak)
- [newState](DThemeDialogSelecList.md#newstate)
...
[DThemeList](DThemeList.md).[getAlpha](DThemeList.md#getalpha)
...
[DThemeList](DThemeList.md).[getBackgroundAlpha](DThemeList.md#getbackgroundalpha)
...
[DThemeList](DThemeList.md).[getBackgroundColor](DThemeList.md#getbackgroundcolor)
...
[DThemeList](DThemeList.md).[getBackgroundTexture](DThemeList.md#getbackgroundtexture)
...
[DThemeList](DThemeList.md).[getBorderAlign](DThemeList.md#getborderalign)
...
[DThemeList](DThemeList.md).[getBorderAlpha](DThemeList.md#getborderalpha)
...
[DThemeList](DThemeList.md).[getBorderColor](DThemeList.md#getbordercolor)
...
[DThemeList](DThemeList.md).[getBorderMask](DThemeList.md#getbordermask)
...
[DThemeList](DThemeList.md).[getBorderTexture](DThemeList.md#getbordertexture)
...
[DThemeList](DThemeList.md).[getBorderWidth](DThemeList.md#getborderwidth)
...
[DThemeList](DThemeList.md).[getClearType](DThemeList.md#getcleartype)
...
[DThemeList](DThemeList.md).[getColor](DThemeList.md#getcolor)
...
[DThemeList](DThemeList.md).[getCornerMask](DThemeList.md#getcornermask)
...
[DThemeList](DThemeList.md).[getCornerRadius](DThemeList.md#getcornerradius)
...
[DThemeList](DThemeList.md).[getCursor](DThemeList.md#getcursor)
...
[DThemeList](DThemeList.md).[getFontFamilly](DThemeList.md#getfontfamilly)
...
[DThemeList](DThemeList.md).[getFontSize](DThemeList.md#getfontsize)
...
[DThemeList](DThemeList.md).[getFontStyle](DThemeList.md#getfontstyle)
...
[DThemeList](DThemeList.md).[getFontVariant](DThemeList.md#getfontvariant)
...
[DThemeList](DThemeList.md).[getFontWeight](DThemeList.md#getfontweight)
...
[DThemeList](DThemeList.md).[getGestureMode](DThemeList.md#getgesturemode)

#### Defined in

[src/main/typescript/wcardinal/ui/d-pane.ts:56](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/d-pane.ts#L56)
...
[DThemeList](DThemeList.md).[getHeight](DThemeList.md#getheight)
...
[DThemeList](DThemeList.md).[getInteractive](DThemeList.md#getinteractive)
...
[DThemeList](DThemeList.md).[getLineHeight](DThemeList.md#getlineheight)
...
[DThemeList](DThemeList.md).[getOutlineAlign](DThemeList.md#getoutlinealign)
...
[DThemeList](DThemeList.md).[getOutlineAlpha](DThemeList.md#getoutlinealpha)
...
[DThemeList](DThemeList.md).[getOutlineColor](DThemeList.md#getoutlinecolor)
...
[DThemeList](DThemeList.md).[getOutlineMask](DThemeList.md#getoutlinemask)
...
[DThemeList](DThemeList.md).[getOutlineOffset](DThemeList.md#getoutlineoffset)
...
[DThemeList](DThemeList.md).[getOutlineWidth](DThemeList.md#getoutlinewidth)
...
[DThemeList](DThemeList.md).[getPaddingBottom](DThemeList.md#getpaddingbottom)
...
[DThemeList](DThemeList.md).[getPaddingLeft](DThemeList.md#getpaddingleft)
...
[DThemeList](DThemeList.md).[getPaddingRight](DThemeList.md#getpaddingright)
...
[DThemeList](DThemeList.md).[getPaddingTop](DThemeList.md#getpaddingtop)
...
[DThemeList](DThemeList.md).[getShadow](DThemeList.md#getshadow)
...
[DThemeList](DThemeList.md).[getTitle](DThemeList.md#gettitle)
...
[DThemeList](DThemeList.md).[getWeight](DThemeList.md#getweight)
...
[DThemeList](DThemeList.md).[getWheelSpeed](DThemeList.md#getwheelspeed)

#### Defined in

[src/main/typescript/wcardinal/ui/d-pane.ts:55](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/d-pane.ts#L55)
...
[DThemeList](DThemeList.md).[getWidth](DThemeList.md#getwidth)
...
[DThemeList](DThemeList.md).[getX](DThemeList.md#getx)
...
[DThemeList](DThemeList.md).[getY](DThemeList.md#gety)
...
[DThemeList](DThemeList.md).[isOverflowMaskEnabled](DThemeList.md#isoverflowmaskenabled)

#### Defined in

[src/main/typescript/wcardinal/ui/d-pane.ts:54](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.165.0/src/main/typescript/wcardinal/ui/d-pane.ts#L54)
...
[DThemeList](DThemeList.md).[newShadow](DThemeList.md#newshadow)
...
[DThemeList](DThemeList.md).[newShadowWeak](DThemeList.md#newshadowweak)
...
[DThemeList](DThemeList.md).[newState](DThemeList.md#newstate)
