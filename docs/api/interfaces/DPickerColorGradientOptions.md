[Winter Cardinal UI - v0.310.1](../index.md) / DPickerColorGradientOptions
...
- [renderable](DPickerColorGradientOptions.md#renderable)
...
A renderability.
Unlike [visible](DPickerColorGradientOptions.md#visible), non-renderable element occupies a space.
