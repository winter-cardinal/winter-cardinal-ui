[Winter Cardinal UI - v0.310.1](../index.md) / DTableBodyCellLinkOptions

# Interface: DTableBodyCellLinkOptions<ROW, VALUE, THEME\>
...
| `ROW` | `ROW` |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeTableBodyCellLink`](DThemeTableBodyCellLink.md)<`VALUE`\> = [`DThemeTableBodyCellLink`](DThemeTableBodyCellLink.md)<`VALUE`\> |

## Hierarchy

- [`DTableBodyCellButtonOptions`](DTableBodyCellButtonOptions.md)<`ROW`, `VALUE`, `THEME`\>

  ↳ **`DTableBodyCellLinkOptions`**

## Table of contents

### Properties

- [background](DTableBodyCellLinkOptions.md#background)
- [border](DTableBodyCellLinkOptions.md#border)
- [children](DTableBodyCellLinkOptions.md#children)
- [clear](DTableBodyCellLinkOptions.md#clear)
- [corner](DTableBodyCellLinkOptions.md#corner)
- [cursor](DTableBodyCellLinkOptions.md#cursor)
- [height](DTableBodyCellLinkOptions.md#height)
- [image](DTableBodyCellLinkOptions.md#image)
- [interactive](DTableBodyCellLinkOptions.md#interactive)
- [link](DTableBodyCellLinkOptions.md#link)
- [mask](DTableBodyCellLinkOptions.md#mask)
- [name](DTableBodyCellLinkOptions.md#name)
- [on](DTableBodyCellLinkOptions.md#on)
- [outline](DTableBodyCellLinkOptions.md#outline)
- [padding](DTableBodyCellLinkOptions.md#padding)
- [parent](DTableBodyCellLinkOptions.md#parent)
- [renderable](DTableBodyCellLinkOptions.md#renderable)
- [shadow](DTableBodyCellLinkOptions.md#shadow)
- [shortcut](DTableBodyCellLinkOptions.md#shortcut)
- [shortcuts](DTableBodyCellLinkOptions.md#shortcuts)
- [state](DTableBodyCellLinkOptions.md#state)
- [text](DTableBodyCellLinkOptions.md#text)
- [theme](DTableBodyCellLinkOptions.md#theme)
- [title](DTableBodyCellLinkOptions.md#title)
- [visible](DTableBodyCellLinkOptions.md#visible)
- [weight](DTableBodyCellLinkOptions.md#weight)
- [when](DTableBodyCellLinkOptions.md#when)
- [width](DTableBodyCellLinkOptions.md#width)
- [x](DTableBodyCellLinkOptions.md#x)
- [y](DTableBodyCellLinkOptions.md#y)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-link.ts:47](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-table-body-cell-link.ts#L47)
...
A renderability.
Unlike [visible](DTableBodyCellLinkOptions.md#visible), non-renderable element occupies a space.
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-button.ts:24](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-table-body-cell-button.ts#L24)
