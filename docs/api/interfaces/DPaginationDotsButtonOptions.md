[Winter Cardinal UI - v0.154.0](../index.md) / DPaginationDotsButtonOptions

# Interface: DPaginationDotsButtonOptions<THEME\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemePaginationDotsButton`](DThemePaginationDotsButton.md) = [`DThemePaginationDotsButton`](DThemePaginationDotsButton.md) |

## Hierarchy

- [`DButtonAmbientOptions`](DButtonAmbientOptions.md)<`string`, `THEME`\>

  ↳ **`DPaginationDotsButtonOptions`**

## Table of contents

### Properties

- [background](DPaginationDotsButtonOptions.md#background)
- [border](DPaginationDotsButtonOptions.md#border)
- [children](DPaginationDotsButtonOptions.md#children)
- [clear](DPaginationDotsButtonOptions.md#clear)
- [corner](DPaginationDotsButtonOptions.md#corner)
- [cursor](DPaginationDotsButtonOptions.md#cursor)
- [group](DPaginationDotsButtonOptions.md#group)
- [height](DPaginationDotsButtonOptions.md#height)
- [image](DPaginationDotsButtonOptions.md#image)
- [interactive](DPaginationDotsButtonOptions.md#interactive)
- [mask](DPaginationDotsButtonOptions.md#mask)
- [name](DPaginationDotsButtonOptions.md#name)
- [on](DPaginationDotsButtonOptions.md#on)
- [outline](DPaginationDotsButtonOptions.md#outline)
- [padding](DPaginationDotsButtonOptions.md#padding)
- [parent](DPaginationDotsButtonOptions.md#parent)
- [shadow](DPaginationDotsButtonOptions.md#shadow)
- [shortcut](DPaginationDotsButtonOptions.md#shortcut)
- [shortcuts](DPaginationDotsButtonOptions.md#shortcuts)
- [state](DPaginationDotsButtonOptions.md#state)
- [text](DPaginationDotsButtonOptions.md#text)
- [theme](DPaginationDotsButtonOptions.md#theme)
- [title](DPaginationDotsButtonOptions.md#title)
- [toggle](DPaginationDotsButtonOptions.md#toggle)
- [visible](DPaginationDotsButtonOptions.md#visible)
- [weight](DPaginationDotsButtonOptions.md#weight)
- [when](DPaginationDotsButtonOptions.md#when)
- [width](DPaginationDotsButtonOptions.md#width)
- [x](DPaginationDotsButtonOptions.md#x)
- [y](DPaginationDotsButtonOptions.md#y)
