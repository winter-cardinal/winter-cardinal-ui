[Winter Cardinal UI - v0.407.0](../index.md) / DDropdownBaseOptions
...
- [images](DDropdownBaseOptions.md#images)
...
- [renderable](DDropdownBaseOptions.md#renderable)
...
• `Optional` **text**: [`DTextPieceOptions`](DTextPieceOptions.md)\<`TEXT_VALUE`\>
