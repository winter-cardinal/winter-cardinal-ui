[Winter Cardinal UI - v0.310.1](../index.md) / DChartLegendOptions

# Interface: DChartLegendOptions<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeChartLegend`](DThemeChartLegend.md) |
...
- [background](DChartLegendOptions.md#background)
- [border](DChartLegendOptions.md#border)
- [children](DChartLegendOptions.md#children)
- [clear](DChartLegendOptions.md#clear)
- [corner](DChartLegendOptions.md#corner)
- [cursor](DChartLegendOptions.md#cursor)
- [height](DChartLegendOptions.md#height)
- [interactive](DChartLegendOptions.md#interactive)
- [name](DChartLegendOptions.md#name)
- [on](DChartLegendOptions.md#on)
- [outline](DChartLegendOptions.md#outline)
- [padding](DChartLegendOptions.md#padding)
- [parent](DChartLegendOptions.md#parent)
- [renderable](DChartLegendOptions.md#renderable)
- [shadow](DChartLegendOptions.md#shadow)
- [shortcut](DChartLegendOptions.md#shortcut)
- [shortcuts](DChartLegendOptions.md#shortcuts)
- [state](DChartLegendOptions.md#state)
- [theme](DChartLegendOptions.md#theme)
- [title](DChartLegendOptions.md#title)
- [visible](DChartLegendOptions.md#visible)
- [weight](DChartLegendOptions.md#weight)
- [width](DChartLegendOptions.md#width)
- [x](DChartLegendOptions.md#x)
- [y](DChartLegendOptions.md#y)
...
A renderability.
Unlike [visible](DChartLegendOptions.md#visible), non-renderable element occupies a space.
