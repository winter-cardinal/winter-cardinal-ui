[Winter Cardinal UI - v0.407.0](../index.md) / DPickerTimeOptions
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemePickerTime`](DThemePickerTime.md) = [`DThemePickerTime`](DThemePickerTime.md) |
...
- [`DBaseOptions`](DBaseOptions.md)\<`THEME`\>
  ...
  ↳↳ [`DPickerDatetimeOptions`](DPickerDatetimeOptions.md)

## Table of contents

### Properties

- [background](DPickerTimeOptions.md#background)
- [border](DPickerTimeOptions.md#border)
- [bounds](DPickerTimeOptions.md#bounds)
- [children](DPickerTimeOptions.md#children)
- [clear](DPickerTimeOptions.md#clear)
- [corner](DPickerTimeOptions.md#corner)
- [cursor](DPickerTimeOptions.md#cursor)
- [height](DPickerTimeOptions.md#height)
- [hours](DPickerTimeOptions.md#hours)
- [interactive](DPickerTimeOptions.md#interactive)
- [margin](DPickerTimeOptions.md#margin)
- [mask](DPickerTimeOptions.md#mask)
- [minutes](DPickerTimeOptions.md#minutes)
- [name](DPickerTimeOptions.md#name)
- [on](DPickerTimeOptions.md#on)
- [outline](DPickerTimeOptions.md#outline)
- [padding](DPickerTimeOptions.md#padding)
- [parent](DPickerTimeOptions.md#parent)
- [renderable](DPickerTimeOptions.md#renderable)
- [seconds](DPickerTimeOptions.md#seconds)
- [shadow](DPickerTimeOptions.md#shadow)
- [shortcut](DPickerTimeOptions.md#shortcut)
- [shortcuts](DPickerTimeOptions.md#shortcuts)
- [state](DPickerTimeOptions.md#state)
- [theme](DPickerTimeOptions.md#theme)
- [title](DPickerTimeOptions.md#title)
- [visible](DPickerTimeOptions.md#visible)
- [weight](DPickerTimeOptions.md#weight)
- [width](DPickerTimeOptions.md#width)
- [x](DPickerTimeOptions.md#x)
- [y](DPickerTimeOptions.md#y)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:28](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L28)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:21](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L21)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L20)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:24](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L24)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L22)
...
[src/main/typescript/wcardinal/ui/d-picker-time.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-picker-time.ts#L23)
