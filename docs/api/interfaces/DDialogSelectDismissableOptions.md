[Winter Cardinal UI - v0.407.0](../index.md) / DDialogSelectDismissableOptions

# Interface: DDialogSelectDismissableOptions

[DDialogSelect](../classes/DDialogSelect.md) "dismiss" options.

## Hierarchy

- [`DButtonOptions`](DButtonOptions.md)\<`string`\>
...
- [background](DDialogSelectDismissableOptions.md#background)
- [border](DDialogSelectDismissableOptions.md#border)
- [children](DDialogSelectDismissableOptions.md#children)
- [clear](DDialogSelectDismissableOptions.md#clear)
- [corner](DDialogSelectDismissableOptions.md#corner)
- [cursor](DDialogSelectDismissableOptions.md#cursor)
- [enabled](DDialogSelectDismissableOptions.md#enabled)
- [group](DDialogSelectDismissableOptions.md#group)
- [height](DDialogSelectDismissableOptions.md#height)
- [image](DDialogSelectDismissableOptions.md#image)
- [images](DDialogSelectDismissableOptions.md#images)
- [interactive](DDialogSelectDismissableOptions.md#interactive)
- [mask](DDialogSelectDismissableOptions.md#mask)
- [name](DDialogSelectDismissableOptions.md#name)
- [on](DDialogSelectDismissableOptions.md#on)
- [outline](DDialogSelectDismissableOptions.md#outline)
- [padding](DDialogSelectDismissableOptions.md#padding)
- [parent](DDialogSelectDismissableOptions.md#parent)
- [renderable](DDialogSelectDismissableOptions.md#renderable)
- [shadow](DDialogSelectDismissableOptions.md#shadow)
- [shortcut](DDialogSelectDismissableOptions.md#shortcut)
- [shortcuts](DDialogSelectDismissableOptions.md#shortcuts)
- [state](DDialogSelectDismissableOptions.md#state)
- [text](DDialogSelectDismissableOptions.md#text)
- [theme](DDialogSelectDismissableOptions.md#theme)
- [title](DDialogSelectDismissableOptions.md#title)
- [toggle](DDialogSelectDismissableOptions.md#toggle)
- [visible](DDialogSelectDismissableOptions.md#visible)
- [weight](DDialogSelectDismissableOptions.md#weight)
- [when](DDialogSelectDismissableOptions.md#when)
- [width](DDialogSelectDismissableOptions.md#width)
- [x](DDialogSelectDismissableOptions.md#x)
- [y](DDialogSelectDismissableOptions.md#y)
...
[src/main/typescript/wcardinal/ui/d-dialog-select.ts:99](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-select.ts#L99)
...
• `Optional` **theme**: `string` \| [`DThemeButton`](DThemeButton.md)\<`string`\>
