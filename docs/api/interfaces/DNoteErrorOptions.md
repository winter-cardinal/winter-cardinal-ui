[Winter Cardinal UI - v0.310.1](../index.md) / DNoteErrorOptions
...
- [renderable](DNoteErrorOptions.md#renderable)
...
A renderability.
Unlike [visible](DNoteErrorOptions.md#visible), non-renderable element occupies a space.
