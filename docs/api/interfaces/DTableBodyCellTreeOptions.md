[Winter Cardinal UI - v0.155.0](../index.md) / DTableBodyCellTreeOptions
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-tree.ts:29](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.155.0/src/main/typescript/wcardinal/ui/d-table-body-cell-tree.ts#L29)
