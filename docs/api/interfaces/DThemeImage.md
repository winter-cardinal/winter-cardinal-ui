[Winter Cardinal UI - v0.407.0](../index.md) / DThemeImage
...
- [`DThemeImageBase`](DThemeImageBase.md)\<`VALUE`\>
  ...
  ↳↳ [`DThemeDialogConfirmMessage`](DThemeDialogConfirmMessage.md)

  ↳↳ [`DThemeExpandableHeader`](DThemeExpandableHeader.md)

  ↳↳ [`DThemeMenuItemBase`](DThemeMenuItemBase.md)

  ↳↳ [`DThemeTableCategoryCell`](DThemeTableCategoryCell.md)

  ↳↳ [`DThemeTableHeaderCell`](DThemeTableHeaderCell.md)
...
- [getAlpha](DThemeImage.md#getalpha)
- [getBackgroundAlpha](DThemeImage.md#getbackgroundalpha)
- [getBackgroundColor](DThemeImage.md#getbackgroundcolor)
- [getBackgroundTexture](DThemeImage.md#getbackgroundtexture)
- [getBorderAlign](DThemeImage.md#getborderalign)
- [getBorderAlpha](DThemeImage.md#getborderalpha)
- [getBorderColor](DThemeImage.md#getbordercolor)
- [getBorderMask](DThemeImage.md#getbordermask)
- [getBorderTexture](DThemeImage.md#getbordertexture)
- [getBorderWidth](DThemeImage.md#getborderwidth)
- [getClearType](DThemeImage.md#getcleartype)
- [getColor](DThemeImage.md#getcolor)
- [getCornerMask](DThemeImage.md#getcornermask)
- [getCornerRadius](DThemeImage.md#getcornerradius)
- [getCursor](DThemeImage.md#getcursor)
- [getFontFamilly](DThemeImage.md#getfontfamilly)
- [getFontSize](DThemeImage.md#getfontsize)
- [getFontStyle](DThemeImage.md#getfontstyle)
- [getFontVariant](DThemeImage.md#getfontvariant)
- [getFontWeight](DThemeImage.md#getfontweight)
- [getHeight](DThemeImage.md#getheight)
- [getImageAlignHorizontal](DThemeImage.md#getimagealignhorizontal)
- [getImageAlignVertical](DThemeImage.md#getimagealignvertical)
- [getImageAlignWith](DThemeImage.md#getimagealignwith)
- [getImageMarginHorizontal](DThemeImage.md#getimagemarginhorizontal)
- [getImageMarginVertial](DThemeImage.md#getimagemarginvertial)
- [getImageRotation](DThemeImage.md#getimagerotation)
- [getImageSource](DThemeImage.md#getimagesource)
- [getImageTintAlpha](DThemeImage.md#getimagetintalpha)
- [getImageTintColor](DThemeImage.md#getimagetintcolor)
- [getInteractive](DThemeImage.md#getinteractive)
- [getLineHeight](DThemeImage.md#getlineheight)
- [getOutlineAlign](DThemeImage.md#getoutlinealign)
- [getOutlineAlpha](DThemeImage.md#getoutlinealpha)
- [getOutlineColor](DThemeImage.md#getoutlinecolor)
- [getOutlineMask](DThemeImage.md#getoutlinemask)
- [getOutlineOffset](DThemeImage.md#getoutlineoffset)
- [getOutlineWidth](DThemeImage.md#getoutlinewidth)
- [getPaddingBottom](DThemeImage.md#getpaddingbottom)
- [getPaddingLeft](DThemeImage.md#getpaddingleft)
- [getPaddingRight](DThemeImage.md#getpaddingright)
- [getPaddingTop](DThemeImage.md#getpaddingtop)
- [getSecondaryImageAlignHorizontal](DThemeImage.md#getsecondaryimagealignhorizontal)
- [getSecondaryImageAlignVertical](DThemeImage.md#getsecondaryimagealignvertical)
- [getSecondaryImageAlignWith](DThemeImage.md#getsecondaryimagealignwith)
- [getSecondaryImageMarginHorizontal](DThemeImage.md#getsecondaryimagemarginhorizontal)
- [getSecondaryImageMarginVertial](DThemeImage.md#getsecondaryimagemarginvertial)
- [getSecondaryImageRotation](DThemeImage.md#getsecondaryimagerotation)
- [getSecondaryImageSource](DThemeImage.md#getsecondaryimagesource)
- [getSecondaryImageTintAlpha](DThemeImage.md#getsecondaryimagetintalpha)
- [getSecondaryImageTintColor](DThemeImage.md#getsecondaryimagetintcolor)
- [getShadow](DThemeImage.md#getshadow)
- [getTertiaryImageAlignHorizontal](DThemeImage.md#gettertiaryimagealignhorizontal)
- [getTertiaryImageAlignVertical](DThemeImage.md#gettertiaryimagealignvertical)
- [getTertiaryImageAlignWith](DThemeImage.md#gettertiaryimagealignwith)
- [getTertiaryImageMarginHorizontal](DThemeImage.md#gettertiaryimagemarginhorizontal)
- [getTertiaryImageMarginVertial](DThemeImage.md#gettertiaryimagemarginvertial)
- [getTertiaryImageRotation](DThemeImage.md#gettertiaryimagerotation)
- [getTertiaryImageSource](DThemeImage.md#gettertiaryimagesource)
- [getTertiaryImageTintAlpha](DThemeImage.md#gettertiaryimagetintalpha)
- [getTertiaryImageTintColor](DThemeImage.md#gettertiaryimagetintcolor)
- [getTextAlignHorizontal](DThemeImage.md#gettextalignhorizontal)
- [getTextAlignVertical](DThemeImage.md#gettextalignvertical)
- [getTextFormatter](DThemeImage.md#gettextformatter)
- [getTextStyleClipping](DThemeImage.md#gettextstyleclipping)
- [getTextStyleFitting](DThemeImage.md#gettextstylefitting)
- [getTextStyleWordWrap](DThemeImage.md#gettextstylewordwrap)
- [getTextValue](DThemeImage.md#gettextvalue)
- [getTitle](DThemeImage.md#gettitle)
- [getWeight](DThemeImage.md#getweight)
- [getWidth](DThemeImage.md#getwidth)
- [getX](DThemeImage.md#getx)
- [getY](DThemeImage.md#gety)
- [isOverflowMaskEnabled](DThemeImage.md#isoverflowmaskenabled)
- [newShadow](DThemeImage.md#newshadow)
- [newShadowWeak](DThemeImage.md#newshadowweak)
- [newState](DThemeImage.md#newstate)
- [newTextValue](DThemeImage.md#newtextvalue)
