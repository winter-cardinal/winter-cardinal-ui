[Winter Cardinal UI - v0.310.1](../index.md) / DNoteSmallOptions

# Interface: DNoteSmallOptions<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeNoteSmall`](DThemeNoteSmall.md) = [`DThemeNoteSmall`](DThemeNoteSmall.md) |
...
- [`DNoteOptions`](DNoteOptions.md)<`THEME`\>
  ...
  ↳↳ [`DNoteSmallErrorOptions`](DNoteSmallErrorOptions.md)

  ↳↳ [`DNoteSmallNoItemsFoundOptions`](DNoteSmallNoItemsFoundOptions.md)

  ↳↳ [`DNoteSmallSearchingOptions`](DNoteSmallSearchingOptions.md)

## Table of contents

### Properties

- [background](DNoteSmallOptions.md#background)
- [border](DNoteSmallOptions.md#border)
- [children](DNoteSmallOptions.md#children)
- [clear](DNoteSmallOptions.md#clear)
- [corner](DNoteSmallOptions.md#corner)
- [cursor](DNoteSmallOptions.md#cursor)
- [height](DNoteSmallOptions.md#height)
- [image](DNoteSmallOptions.md#image)
- [interactive](DNoteSmallOptions.md#interactive)
- [mask](DNoteSmallOptions.md#mask)
- [name](DNoteSmallOptions.md#name)
- [on](DNoteSmallOptions.md#on)
- [outline](DNoteSmallOptions.md#outline)
- [padding](DNoteSmallOptions.md#padding)
- [parent](DNoteSmallOptions.md#parent)
- [renderable](DNoteSmallOptions.md#renderable)
- [shadow](DNoteSmallOptions.md#shadow)
- [shortcut](DNoteSmallOptions.md#shortcut)
- [shortcuts](DNoteSmallOptions.md#shortcuts)
- [state](DNoteSmallOptions.md#state)
- [text](DNoteSmallOptions.md#text)
- [theme](DNoteSmallOptions.md#theme)
- [title](DNoteSmallOptions.md#title)
- [visible](DNoteSmallOptions.md#visible)
- [weight](DNoteSmallOptions.md#weight)
- [width](DNoteSmallOptions.md#width)
- [x](DNoteSmallOptions.md#x)
- [y](DNoteSmallOptions.md#y)
...
A renderability.
Unlike [visible](DNoteSmallOptions.md#visible), non-renderable element occupies a space.
