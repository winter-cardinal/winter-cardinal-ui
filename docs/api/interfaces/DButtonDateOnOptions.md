[Winter Cardinal UI - v0.179.0](../index.md) / DButtonDateOnOptions

# Interface: DButtonDateOnOptions<EMITTER\>

[DButtonDate](../classes/DButtonDate.md) "on" options.
...
- `Partial`<[`DButtonDateEvents`](DButtonDateEvents.md)<`EMITTER`\>\>

- `DOnOptions`

  ↳ **`DButtonDateOnOptions`**

## Table of contents

### Methods

- [active](DButtonDateOnOptions.md#active)
- [added](DButtonDateOnOptions.md#added)
- [change](DButtonDateOnOptions.md#change)
- [dblclick](DButtonDateOnOptions.md#dblclick)
- [down](DButtonDateOnOptions.md#down)
- [inactive](DButtonDateOnOptions.md#inactive)
- [init](DButtonDateOnOptions.md#init)
- [keydown](DButtonDateOnOptions.md#keydown)
- [keyup](DButtonDateOnOptions.md#keyup)
- [move](DButtonDateOnOptions.md#move)
- [out](DButtonDateOnOptions.md#out)
- [over](DButtonDateOnOptions.md#over)
- [removed](DButtonDateOnOptions.md#removed)
- [resize](DButtonDateOnOptions.md#resize)
- [scale](DButtonDateOnOptions.md#scale)
- [skew](DButtonDateOnOptions.md#skew)
- [statechange](DButtonDateOnOptions.md#statechange)
- [up](DButtonDateOnOptions.md#up)
- [wheel](DButtonDateOnOptions.md#wheel)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `newValue` | `Date` | a newly selected value |
| `oldValue` | `Date` | a previously selected value |
| `emitter` | `EMITTER` | an emitter |
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.179.0/src/main/typescript/wcardinal/ui/d-button-date.ts#L22)
