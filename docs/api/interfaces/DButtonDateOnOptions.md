[Winter Cardinal UI - v0.457.0](../index.md) / DButtonDateOnOptions
...
- [click](DButtonDateOnOptions.md#click)
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:22](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-button-date.ts#L22)
