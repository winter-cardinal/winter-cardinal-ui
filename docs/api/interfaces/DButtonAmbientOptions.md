[Winter Cardinal UI - v0.154.0](../index.md) / DButtonAmbientOptions
...
- [`DButtonOptions`](DButtonOptions.md)<`VALUE`, `THEME`\>
  ...
  ↳↳ [`DPaginationDotsButtonOptions`](DPaginationDotsButtonOptions.md)

  ↳↳ [`DPaginationNavigationButtonOptions`](DPaginationNavigationButtonOptions.md)
