[Winter Cardinal UI - v0.407.0](../index.md) / DTableBodyCellTimeOptions
...
- [images](DTableBodyCellTimeOptions.md#images)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:39](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-time.ts#L39)
...
[DButtonTimeOptions](DButtonTimeOptions.md).[images](DButtonTimeOptions.md#images)
...
[src/main/typescript/wcardinal/ui/d-button-time.ts:40](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button-time.ts#L40)
