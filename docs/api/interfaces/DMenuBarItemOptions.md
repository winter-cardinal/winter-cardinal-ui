[Winter Cardinal UI - v0.457.0](../index.md) / DMenuBarItemOptions
...
[src/main/typescript/wcardinal/ui/d-menu-bar-item.ts:16](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-menu-bar-item.ts#L16)
