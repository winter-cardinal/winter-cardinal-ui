[Winter Cardinal UI - v0.310.1](../index.md) / DDialogSelectListItemOptions
...
A renderability.
Unlike [visible](DDialogSelectListItemOptions.md#visible), non-renderable element occupies a space.
