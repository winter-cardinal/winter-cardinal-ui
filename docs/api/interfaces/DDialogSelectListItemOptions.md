[Winter Cardinal UI - v0.407.0](../index.md) / DDialogSelectListItemOptions

# Interface: DDialogSelectListItemOptions\<VALUE, THEME\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeDialogSelecListItem`](DThemeDialogSelecListItem.md) = [`DThemeDialogSelecListItem`](DThemeDialogSelecListItem.md) |
...
- [background](DDialogSelectListItemOptions.md#background)
- [border](DDialogSelectListItemOptions.md#border)
- [children](DDialogSelectListItemOptions.md#children)
- [clear](DDialogSelectListItemOptions.md#clear)
- [corner](DDialogSelectListItemOptions.md#corner)
- [cursor](DDialogSelectListItemOptions.md#cursor)
- [height](DDialogSelectListItemOptions.md#height)
- [image](DDialogSelectListItemOptions.md#image)
- [images](DDialogSelectListItemOptions.md#images)
- [interactive](DDialogSelectListItemOptions.md#interactive)
- [mask](DDialogSelectListItemOptions.md#mask)
- [name](DDialogSelectListItemOptions.md#name)
- [on](DDialogSelectListItemOptions.md#on)
- [outline](DDialogSelectListItemOptions.md#outline)
- [padding](DDialogSelectListItemOptions.md#padding)
- [parent](DDialogSelectListItemOptions.md#parent)
- [renderable](DDialogSelectListItemOptions.md#renderable)
- [shadow](DDialogSelectListItemOptions.md#shadow)
- [shortcut](DDialogSelectListItemOptions.md#shortcut)
- [shortcuts](DDialogSelectListItemOptions.md#shortcuts)
- [state](DDialogSelectListItemOptions.md#state)
- [text](DDialogSelectListItemOptions.md#text)
- [theme](DDialogSelectListItemOptions.md#theme)
- [title](DDialogSelectListItemOptions.md#title)
- [visible](DDialogSelectListItemOptions.md#visible)
- [weight](DDialogSelectListItemOptions.md#weight)
- [width](DDialogSelectListItemOptions.md#width)
- [x](DDialogSelectListItemOptions.md#x)
- [y](DDialogSelectListItemOptions.md#y)
...
[DListItemOptions](DListItemOptions.md).[images](DListItemOptions.md#images)
...
[src/main/typescript/wcardinal/ui/d-list-item.ts:66](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-list-item.ts#L66)
