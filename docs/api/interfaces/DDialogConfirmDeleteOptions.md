[Winter Cardinal UI - v0.205.1](../index.md) / DDialogConfirmDeleteOptions

# Interface: DDialogConfirmDeleteOptions<THEME\>
...
- [`DDialogConfirmOptions`](DDialogConfirmOptions.md)<`THEME`\>
  ...
  ↳ **`DDialogConfirmDeleteOptions`**

## Table of contents

### Properties

- [align](DDialogConfirmDeleteOptions.md#align)
- [animation](DDialogConfirmDeleteOptions.md#animation)
- [background](DDialogConfirmDeleteOptions.md#background)
- [border](DDialogConfirmDeleteOptions.md#border)
- [children](DDialogConfirmDeleteOptions.md#children)
- [clear](DDialogConfirmDeleteOptions.md#clear)
- [closeOn](DDialogConfirmDeleteOptions.md#closeon)
- [content](DDialogConfirmDeleteOptions.md#content)
- [corner](DDialogConfirmDeleteOptions.md#corner)
- [cursor](DDialogConfirmDeleteOptions.md#cursor)
- [footer](DDialogConfirmDeleteOptions.md#footer)
- [gesture](DDialogConfirmDeleteOptions.md#gesture)
- [header](DDialogConfirmDeleteOptions.md#header)
- [height](DDialogConfirmDeleteOptions.md#height)
- [interactive](DDialogConfirmDeleteOptions.md#interactive)
- [layout](DDialogConfirmDeleteOptions.md#layout)
- [message](DDialogConfirmDeleteOptions.md#message)
- [mode](DDialogConfirmDeleteOptions.md#mode)
- [name](DDialogConfirmDeleteOptions.md#name)
- [on](DDialogConfirmDeleteOptions.md#on)
- [outline](DDialogConfirmDeleteOptions.md#outline)
- [padding](DDialogConfirmDeleteOptions.md#padding)
- [parent](DDialogConfirmDeleteOptions.md#parent)
- [shadow](DDialogConfirmDeleteOptions.md#shadow)
- [shortcut](DDialogConfirmDeleteOptions.md#shortcut)
- [shortcuts](DDialogConfirmDeleteOptions.md#shortcuts)
- [state](DDialogConfirmDeleteOptions.md#state)
- [sticky](DDialogConfirmDeleteOptions.md#sticky)
- [theme](DDialogConfirmDeleteOptions.md#theme)
- [title](DDialogConfirmDeleteOptions.md#title)
- [visible](DDialogConfirmDeleteOptions.md#visible)
- [weight](DDialogConfirmDeleteOptions.md#weight)
- [width](DDialogConfirmDeleteOptions.md#width)
- [x](DDialogConfirmDeleteOptions.md#x)
- [y](DDialogConfirmDeleteOptions.md#y)
