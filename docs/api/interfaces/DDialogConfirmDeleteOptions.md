[Winter Cardinal UI - v0.310.1](../index.md) / DDialogConfirmDeleteOptions
...
A renderability.
Unlike [visible](DDialogConfirmDeleteOptions.md#visible), non-renderable element occupies a space.
