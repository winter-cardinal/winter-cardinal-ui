[Winter Cardinal UI - v0.457.0](../index.md) / DButtonSelectEvents
...
- [click](DButtonSelectEvents.md#click)
...
[src/main/typescript/wcardinal/ui/d-button-select.ts:42](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-button-select.ts#L42)
