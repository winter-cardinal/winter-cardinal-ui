[Winter Cardinal UI](../README.md) / DPaginationDynamicButtonsOptions

# Interface: DPaginationDynamicButtonsOptions<THEME\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemePaginationDynamicButtons`](DThemePaginationDynamicButtons.md) |
...
- [background](DPaginationDynamicButtonsOptions.md#background)
- [border](DPaginationDynamicButtonsOptions.md#border)
- [button](DPaginationDynamicButtonsOptions.md#button)
- [children](DPaginationDynamicButtonsOptions.md#children)
- [clear](DPaginationDynamicButtonsOptions.md#clear)
- [column](DPaginationDynamicButtonsOptions.md#column)
- [corner](DPaginationDynamicButtonsOptions.md#corner)
- [cursor](DPaginationDynamicButtonsOptions.md#cursor)
- [direction](DPaginationDynamicButtonsOptions.md#direction)
- [end](DPaginationDynamicButtonsOptions.md#end)
- [height](DPaginationDynamicButtonsOptions.md#height)
- [interactive](DPaginationDynamicButtonsOptions.md#interactive)
- [margin](DPaginationDynamicButtonsOptions.md#margin)
- [name](DPaginationDynamicButtonsOptions.md#name)
- [on](DPaginationDynamicButtonsOptions.md#on)
- [outline](DPaginationDynamicButtonsOptions.md#outline)
- [padding](DPaginationDynamicButtonsOptions.md#padding)
- [parent](DPaginationDynamicButtonsOptions.md#parent)
- [reverse](DPaginationDynamicButtonsOptions.md#reverse)
- [row](DPaginationDynamicButtonsOptions.md#row)
- [selected](DPaginationDynamicButtonsOptions.md#selected)
- [shadow](DPaginationDynamicButtonsOptions.md#shadow)
- [shortcut](DPaginationDynamicButtonsOptions.md#shortcut)
- [shortcuts](DPaginationDynamicButtonsOptions.md#shortcuts)
- [start](DPaginationDynamicButtonsOptions.md#start)
- [state](DPaginationDynamicButtonsOptions.md#state)
- [theme](DPaginationDynamicButtonsOptions.md#theme)
- [title](DPaginationDynamicButtonsOptions.md#title)
- [visible](DPaginationDynamicButtonsOptions.md#visible)
- [weight](DPaginationDynamicButtonsOptions.md#weight)
- [width](DPaginationDynamicButtonsOptions.md#width)
- [x](DPaginationDynamicButtonsOptions.md#x)
- [y](DPaginationDynamicButtonsOptions.md#y)
...
[src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts:19](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts#L19)
...
• `Optional` **direction**: ``"HORIZONTAL"`` \| ``"VERTICAL"`` \| [`DLayoutDirection`](../README.md#dlayoutdirection)
...
[src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts#L17)
...
[src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts#L18)
...
[src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts:16](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-pagination-dynamic-buttons.ts#L16)
