[Winter Cardinal UI - v0.199.0](../index.md) / DDialogLayeredContentOptions

# Interface: DDialogLayeredContentOptions<THEME\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeDialogLayeredContent`](DThemeDialogLayeredContent.md) = [`DThemeDialogLayeredContent`](DThemeDialogLayeredContent.md) |
...
- [`DLayoutVerticalOptions`](DLayoutVerticalOptions.md)<`THEME`\>
  ...
  ↳↳ [`DDialogFittedContentOptions`](DDialogFittedContentOptions.md)

## Table of contents

### Properties

- [background](DDialogLayeredContentOptions.md#background)
- [border](DDialogLayeredContentOptions.md#border)
- [children](DDialogLayeredContentOptions.md#children)
- [clear](DDialogLayeredContentOptions.md#clear)
- [column](DDialogLayeredContentOptions.md#column)
- [corner](DDialogLayeredContentOptions.md#corner)
- [cursor](DDialogLayeredContentOptions.md#cursor)
- [direction](DDialogLayeredContentOptions.md#direction)
- [height](DDialogLayeredContentOptions.md#height)
- [interactive](DDialogLayeredContentOptions.md#interactive)
- [margin](DDialogLayeredContentOptions.md#margin)
- [name](DDialogLayeredContentOptions.md#name)
- [on](DDialogLayeredContentOptions.md#on)
- [outline](DDialogLayeredContentOptions.md#outline)
- [padding](DDialogLayeredContentOptions.md#padding)
- [parent](DDialogLayeredContentOptions.md#parent)
- [reverse](DDialogLayeredContentOptions.md#reverse)
- [row](DDialogLayeredContentOptions.md#row)
- [shadow](DDialogLayeredContentOptions.md#shadow)
- [shortcut](DDialogLayeredContentOptions.md#shortcut)
- [shortcuts](DDialogLayeredContentOptions.md#shortcuts)
- [state](DDialogLayeredContentOptions.md#state)
- [theme](DDialogLayeredContentOptions.md#theme)
- [title](DDialogLayeredContentOptions.md#title)
- [visible](DDialogLayeredContentOptions.md#visible)
- [weight](DDialogLayeredContentOptions.md#weight)
- [width](DDialogLayeredContentOptions.md#width)
- [x](DDialogLayeredContentOptions.md#x)
- [y](DDialogLayeredContentOptions.md#y)
