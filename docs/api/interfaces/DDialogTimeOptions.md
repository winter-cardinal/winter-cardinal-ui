[Winter Cardinal UI - v0.227.0](../index.md) / DDialogTimeOptions
...
[src/main/typescript/wcardinal/ui/d-dialog-time.ts:12](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.227.0/src/main/typescript/wcardinal/ui/d-dialog-time.ts#L12)
