[Winter Cardinal UI - v0.167.0](../index.md) / DTextBaseOnOptions

# Interface: DTextBaseOnOptions<VALUE, EMITTER\>

[DTextBase](../classes/DTextBase.md) "on" options.
...
- `Partial`<[`DTextBaseEvents`](DTextBaseEvents.md)<`VALUE`, `EMITTER`\>\>
...
- [added](DTextBaseOnOptions.md#added)
- [dblclick](DTextBaseOnOptions.md#dblclick)
- [down](DTextBaseOnOptions.md#down)
- [init](DTextBaseOnOptions.md#init)
- [keydown](DTextBaseOnOptions.md#keydown)
- [keyup](DTextBaseOnOptions.md#keyup)
- [move](DTextBaseOnOptions.md#move)
- [out](DTextBaseOnOptions.md#out)
- [over](DTextBaseOnOptions.md#over)
- [removed](DTextBaseOnOptions.md#removed)
- [resize](DTextBaseOnOptions.md#resize)
- [scale](DTextBaseOnOptions.md#scale)
- [skew](DTextBaseOnOptions.md#skew)
- [statechange](DTextBaseOnOptions.md#statechange)
- [up](DTextBaseOnOptions.md#up)
- [wheel](DTextBaseOnOptions.md#wheel)
