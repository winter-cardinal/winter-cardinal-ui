[Winter Cardinal UI - v0.199.0](../index.md) / DDialogLayeredFooterOptions

# Interface: DDialogLayeredFooterOptions<THEME\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeDialogLayeredFooter`](DThemeDialogLayeredFooter.md) = [`DThemeDialogLayeredFooter`](DThemeDialogLayeredFooter.md) |
...
- [background](DDialogLayeredFooterOptions.md#background)
- [border](DDialogLayeredFooterOptions.md#border)
- [button](DDialogLayeredFooterOptions.md#button)
- [children](DDialogLayeredFooterOptions.md#children)
- [clear](DDialogLayeredFooterOptions.md#clear)
- [column](DDialogLayeredFooterOptions.md#column)
- [corner](DDialogLayeredFooterOptions.md#corner)
- [cursor](DDialogLayeredFooterOptions.md#cursor)
- [direction](DDialogLayeredFooterOptions.md#direction)
- [height](DDialogLayeredFooterOptions.md#height)
- [interactive](DDialogLayeredFooterOptions.md#interactive)
- [margin](DDialogLayeredFooterOptions.md#margin)
- [name](DDialogLayeredFooterOptions.md#name)
- [on](DDialogLayeredFooterOptions.md#on)
- [outline](DDialogLayeredFooterOptions.md#outline)
- [padding](DDialogLayeredFooterOptions.md#padding)
- [parent](DDialogLayeredFooterOptions.md#parent)
- [reverse](DDialogLayeredFooterOptions.md#reverse)
- [row](DDialogLayeredFooterOptions.md#row)
- [shadow](DDialogLayeredFooterOptions.md#shadow)
- [shortcut](DDialogLayeredFooterOptions.md#shortcut)
- [shortcuts](DDialogLayeredFooterOptions.md#shortcuts)
- [state](DDialogLayeredFooterOptions.md#state)
- [theme](DDialogLayeredFooterOptions.md#theme)
- [title](DDialogLayeredFooterOptions.md#title)
- [visible](DDialogLayeredFooterOptions.md#visible)
- [weight](DDialogLayeredFooterOptions.md#weight)
- [width](DDialogLayeredFooterOptions.md#width)
- [x](DDialogLayeredFooterOptions.md#x)
- [y](DDialogLayeredFooterOptions.md#y)
...
• `Optional` **button**: [`DDialogLayeredFooterButtonOptions`](DDialogLayeredFooterButtonOptions.md)

#### Defined in

[src/main/typescript/wcardinal/ui/d-dialog-layered-footer.ts:30](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.199.0/src/main/typescript/wcardinal/ui/d-dialog-layered-footer.ts#L30)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:34](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.199.0/src/main/typescript/wcardinal/ui/d-layout.ts#L34)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:32](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.199.0/src/main/typescript/wcardinal/ui/d-layout.ts#L32)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:35](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.199.0/src/main/typescript/wcardinal/ui/d-layout.ts#L35)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:31](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.199.0/src/main/typescript/wcardinal/ui/d-layout.ts#L31)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:36](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.199.0/src/main/typescript/wcardinal/ui/d-layout.ts#L36)
...
[src/main/typescript/wcardinal/ui/d-layout.ts:33](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.199.0/src/main/typescript/wcardinal/ui/d-layout.ts#L33)
