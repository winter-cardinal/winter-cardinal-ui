[Winter Cardinal UI - v0.310.1](../index.md) / DCanvasOptions

# Interface: DCanvasOptions<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeCanvas`](DThemeCanvas.md) = [`DThemeCanvas`](DThemeCanvas.md) |
...
- [`DBaseOptions`](DBaseOptions.md)<`THEME`\>
  ...
  ↳↳ [`DDiagramCanvasBaseOptions`](DDiagramCanvasBaseOptions.md)

## Table of contents

### Properties

- [background](DCanvasOptions.md#background)
- [border](DCanvasOptions.md#border)
- [children](DCanvasOptions.md#children)
- [clear](DCanvasOptions.md#clear)
- [corner](DCanvasOptions.md#corner)
- [cursor](DCanvasOptions.md#cursor)
- [height](DCanvasOptions.md#height)
- [interactive](DCanvasOptions.md#interactive)
- [name](DCanvasOptions.md#name)
- [on](DCanvasOptions.md#on)
- [outline](DCanvasOptions.md#outline)
- [padding](DCanvasOptions.md#padding)
- [parent](DCanvasOptions.md#parent)
- [renderable](DCanvasOptions.md#renderable)
- [shadow](DCanvasOptions.md#shadow)
- [shortcut](DCanvasOptions.md#shortcut)
- [shortcuts](DCanvasOptions.md#shortcuts)
- [state](DCanvasOptions.md#state)
- [theme](DCanvasOptions.md#theme)
- [title](DCanvasOptions.md#title)
- [visible](DCanvasOptions.md#visible)
- [weight](DCanvasOptions.md#weight)
- [width](DCanvasOptions.md#width)
- [x](DCanvasOptions.md#x)
- [y](DCanvasOptions.md#y)
...
A renderability.
Unlike [visible](DCanvasOptions.md#visible), non-renderable element occupies a space.
