[Winter Cardinal UI - v0.442.0](../index.md) / DThemeButtonBase

# Interface: DThemeButtonBase\<VALUE\>
...
- [`DThemeImageBase`](DThemeImageBase.md)\<`VALUE`\>
  ...
  ↳↳ [`DThemeButtonCheck`](DThemeButtonCheck.md)

  ↳↳ [`DThemeButtonLink`](DThemeButtonLink.md)

  ↳↳ [`DThemeButtonRadio`](DThemeButtonRadio.md)

  ↳↳ [`DThemeButton`](DThemeButton.md)

  ↳↳ [`DThemeDropdownBase`](DThemeDropdownBase.md)

  ↳↳ [`DThemeTableBodyCellInputTreeMarker`](DThemeTableBodyCellInputTreeMarker.md)
...
- [getAlpha](DThemeButtonBase.md#getalpha)
- [getBackgroundAlpha](DThemeButtonBase.md#getbackgroundalpha)
- [getBackgroundColor](DThemeButtonBase.md#getbackgroundcolor)
- [getBackgroundTexture](DThemeButtonBase.md#getbackgroundtexture)
- [getBorderAlign](DThemeButtonBase.md#getborderalign)
- [getBorderAlpha](DThemeButtonBase.md#getborderalpha)
- [getBorderColor](DThemeButtonBase.md#getbordercolor)
- [getBorderMask](DThemeButtonBase.md#getbordermask)
- [getBorderTexture](DThemeButtonBase.md#getbordertexture)
- [getBorderWidth](DThemeButtonBase.md#getborderwidth)
- [getClearType](DThemeButtonBase.md#getcleartype)
- [getColor](DThemeButtonBase.md#getcolor)
- [getCornerMask](DThemeButtonBase.md#getcornermask)
- [getCornerRadius](DThemeButtonBase.md#getcornerradius)
- [getCursor](DThemeButtonBase.md#getcursor)
- [getFontFamilly](DThemeButtonBase.md#getfontfamilly)
- [getFontSize](DThemeButtonBase.md#getfontsize)
- [getFontStyle](DThemeButtonBase.md#getfontstyle)
- [getFontVariant](DThemeButtonBase.md#getfontvariant)
- [getFontWeight](DThemeButtonBase.md#getfontweight)
- [getHeight](DThemeButtonBase.md#getheight)
- [getImageAlignHorizontal](DThemeButtonBase.md#getimagealignhorizontal)
- [getImageAlignVertical](DThemeButtonBase.md#getimagealignvertical)
- [getImageAlignWith](DThemeButtonBase.md#getimagealignwith)
- [getImageMarginHorizontal](DThemeButtonBase.md#getimagemarginhorizontal)
- [getImageMarginVertial](DThemeButtonBase.md#getimagemarginvertial)
- [getImageRotation](DThemeButtonBase.md#getimagerotation)
- [getImageSource](DThemeButtonBase.md#getimagesource)
- [getImageTintAlpha](DThemeButtonBase.md#getimagetintalpha)
- [getImageTintColor](DThemeButtonBase.md#getimagetintcolor)
- [getInteractive](DThemeButtonBase.md#getinteractive)
- [getLineHeight](DThemeButtonBase.md#getlineheight)
- [getOutlineAlign](DThemeButtonBase.md#getoutlinealign)
- [getOutlineAlpha](DThemeButtonBase.md#getoutlinealpha)
- [getOutlineColor](DThemeButtonBase.md#getoutlinecolor)
- [getOutlineMask](DThemeButtonBase.md#getoutlinemask)
- [getOutlineOffset](DThemeButtonBase.md#getoutlineoffset)
- [getOutlineWidth](DThemeButtonBase.md#getoutlinewidth)
- [getPaddingBottom](DThemeButtonBase.md#getpaddingbottom)
- [getPaddingLeft](DThemeButtonBase.md#getpaddingleft)
- [getPaddingRight](DThemeButtonBase.md#getpaddingright)
- [getPaddingTop](DThemeButtonBase.md#getpaddingtop)
- [getSecondaryImageAlignHorizontal](DThemeButtonBase.md#getsecondaryimagealignhorizontal)
- [getSecondaryImageAlignVertical](DThemeButtonBase.md#getsecondaryimagealignvertical)
- [getSecondaryImageAlignWith](DThemeButtonBase.md#getsecondaryimagealignwith)
- [getSecondaryImageMarginHorizontal](DThemeButtonBase.md#getsecondaryimagemarginhorizontal)
- [getSecondaryImageMarginVertial](DThemeButtonBase.md#getsecondaryimagemarginvertial)
- [getSecondaryImageRotation](DThemeButtonBase.md#getsecondaryimagerotation)
- [getSecondaryImageSource](DThemeButtonBase.md#getsecondaryimagesource)
- [getSecondaryImageTintAlpha](DThemeButtonBase.md#getsecondaryimagetintalpha)
- [getSecondaryImageTintColor](DThemeButtonBase.md#getsecondaryimagetintcolor)
- [getShadow](DThemeButtonBase.md#getshadow)
- [getTertiaryImageAlignHorizontal](DThemeButtonBase.md#gettertiaryimagealignhorizontal)
- [getTertiaryImageAlignVertical](DThemeButtonBase.md#gettertiaryimagealignvertical)
- [getTertiaryImageAlignWith](DThemeButtonBase.md#gettertiaryimagealignwith)
- [getTertiaryImageMarginHorizontal](DThemeButtonBase.md#gettertiaryimagemarginhorizontal)
- [getTertiaryImageMarginVertial](DThemeButtonBase.md#gettertiaryimagemarginvertial)
- [getTertiaryImageRotation](DThemeButtonBase.md#gettertiaryimagerotation)
- [getTertiaryImageSource](DThemeButtonBase.md#gettertiaryimagesource)
- [getTertiaryImageTintAlpha](DThemeButtonBase.md#gettertiaryimagetintalpha)
- [getTertiaryImageTintColor](DThemeButtonBase.md#gettertiaryimagetintcolor)
- [getTextAlignHorizontal](DThemeButtonBase.md#gettextalignhorizontal)
- [getTextAlignVertical](DThemeButtonBase.md#gettextalignvertical)
- [getTextFormatter](DThemeButtonBase.md#gettextformatter)
- [getTextStyleClipping](DThemeButtonBase.md#gettextstyleclipping)
- [getTextStyleFitting](DThemeButtonBase.md#gettextstylefitting)
- [getTextStyleWordWrap](DThemeButtonBase.md#gettextstylewordwrap)
- [getTextValue](DThemeButtonBase.md#gettextvalue)
- [getTitle](DThemeButtonBase.md#gettitle)
- [getWeight](DThemeButtonBase.md#getweight)
- [getWhen](DThemeButtonBase.md#getwhen)
- [getWidth](DThemeButtonBase.md#getwidth)
- [getX](DThemeButtonBase.md#getx)
- [getY](DThemeButtonBase.md#gety)
- [isOverflowMaskEnabled](DThemeButtonBase.md#isoverflowmaskenabled)
- [isToggle](DThemeButtonBase.md#istoggle)
- [newShadow](DThemeButtonBase.md#newshadow)
- [newShadowWeak](DThemeButtonBase.md#newshadowweak)
- [newState](DThemeButtonBase.md#newstate)
- [newTextValue](DThemeButtonBase.md#newtextvalue)
