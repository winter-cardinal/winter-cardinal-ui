[Winter Cardinal UI - v0.442.0](../index.md) / DMenuItemMenuOptions

# Interface: DMenuItemMenuOptions\<VALUE, THEME\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeMenuItemMenu`](DThemeMenuItemMenu.md) = [`DThemeMenuItemMenu`](DThemeMenuItemMenu.md) |

## Hierarchy

- [`DMenuItemOptions`](DMenuItemOptions.md)\<`VALUE`, `THEME`\>

  ↳ **`DMenuItemMenuOptions`**

## Table of contents

### Properties

- [background](DMenuItemMenuOptions.md#background)
- [border](DMenuItemMenuOptions.md#border)
- [children](DMenuItemMenuOptions.md#children)
- [clear](DMenuItemMenuOptions.md#clear)
- [corner](DMenuItemMenuOptions.md#corner)
- [cursor](DMenuItemMenuOptions.md#cursor)
- [height](DMenuItemMenuOptions.md#height)
- [image](DMenuItemMenuOptions.md#image)
- [images](DMenuItemMenuOptions.md#images)
- [interactive](DMenuItemMenuOptions.md#interactive)
- [mask](DMenuItemMenuOptions.md#mask)
- [menu](DMenuItemMenuOptions.md#menu)
- [name](DMenuItemMenuOptions.md#name)
- [on](DMenuItemMenuOptions.md#on)
- [outline](DMenuItemMenuOptions.md#outline)
- [padding](DMenuItemMenuOptions.md#padding)
- [parent](DMenuItemMenuOptions.md#parent)
- [renderable](DMenuItemMenuOptions.md#renderable)
- [shadow](DMenuItemMenuOptions.md#shadow)
- [shortcut](DMenuItemMenuOptions.md#shortcut)
- [shortcuts](DMenuItemMenuOptions.md#shortcuts)
- [state](DMenuItemMenuOptions.md#state)
- [text](DMenuItemMenuOptions.md#text)
- [theme](DMenuItemMenuOptions.md#theme)
- [title](DMenuItemMenuOptions.md#title)
- [value](DMenuItemMenuOptions.md#value)
- [visible](DMenuItemMenuOptions.md#visible)
- [weight](DMenuItemMenuOptions.md#weight)
- [width](DMenuItemMenuOptions.md#width)
- [x](DMenuItemMenuOptions.md#x)
- [y](DMenuItemMenuOptions.md#y)
...
[DMenuItemOptions](DMenuItemOptions.md).[images](DMenuItemOptions.md#images)
...
• **menu**: [`DMenuOptions`](DMenuOptions.md)\<`VALUE`, [`DThemeMenu`](DThemeMenu.md)\> \| [`DMenu`](../classes/DMenu.md)\<`VALUE`, [`DThemeMenu`](DThemeMenu.md), [`DMenuOptions`](DMenuOptions.md)\<`VALUE`, [`DThemeMenu`](DThemeMenu.md)\>\>

#### Defined in

[src/main/typescript/wcardinal/ui/d-menu-item-menu.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/d-menu-item-menu.ts#L17)
...
[DMenuItemOptions](DMenuItemOptions.md).[renderable](DMenuItemOptions.md#renderable)
...
[src/main/typescript/wcardinal/ui/d-menu-item-base.ts:16](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/d-menu-item-base.ts#L16)
