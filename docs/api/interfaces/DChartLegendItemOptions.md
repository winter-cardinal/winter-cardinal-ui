[Winter Cardinal UI - v0.310.1](../index.md) / DChartLegendItemOptions

# Interface: DChartLegendItemOptions<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeChartLegendItem`](DThemeChartLegendItem.md) |

## Hierarchy

- [`DBaseOptions`](DBaseOptions.md)<`THEME`\>

  ↳ **`DChartLegendItemOptions`**

## Table of contents

### Properties

- [background](DChartLegendItemOptions.md#background)
- [border](DChartLegendItemOptions.md#border)
- [children](DChartLegendItemOptions.md#children)
- [clear](DChartLegendItemOptions.md#clear)
- [corner](DChartLegendItemOptions.md#corner)
- [cursor](DChartLegendItemOptions.md#cursor)
- [height](DChartLegendItemOptions.md#height)
- [interactive](DChartLegendItemOptions.md#interactive)
- [name](DChartLegendItemOptions.md#name)
- [on](DChartLegendItemOptions.md#on)
- [outline](DChartLegendItemOptions.md#outline)
- [padding](DChartLegendItemOptions.md#padding)
- [parent](DChartLegendItemOptions.md#parent)
- [renderable](DChartLegendItemOptions.md#renderable)
- [shadow](DChartLegendItemOptions.md#shadow)
- [shortcut](DChartLegendItemOptions.md#shortcut)
- [shortcuts](DChartLegendItemOptions.md#shortcuts)
- [state](DChartLegendItemOptions.md#state)
- [theme](DChartLegendItemOptions.md#theme)
- [title](DChartLegendItemOptions.md#title)
- [visible](DChartLegendItemOptions.md#visible)
- [weight](DChartLegendItemOptions.md#weight)
- [width](DChartLegendItemOptions.md#width)
- [x](DChartLegendItemOptions.md#x)
- [y](DChartLegendItemOptions.md#y)
...
A renderability.
Unlike [visible](DChartLegendItemOptions.md#visible), non-renderable element occupies a space.
