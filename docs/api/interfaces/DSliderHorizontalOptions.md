[Winter Cardinal UI - v0.310.1](../index.md) / DSliderHorizontalOptions
...
A renderability.
Unlike [visible](DSliderHorizontalOptions.md#visible), non-renderable element occupies a space.
