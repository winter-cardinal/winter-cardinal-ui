[Winter Cardinal UI - v0.442.0](../index.md) / DCanvasContainerOptions

# Interface: DCanvasContainerOptions\<CANVAS, CANVAS_OPTIONS, THEME, EMITTER\>

[DCanvasContainer](../classes/DCanvasContainer.md) options.

## Type parameters

| Name | Type |
| :------ | :------ |
| `CANVAS` | extends [`DBase`](../classes/DBase.md) = [`DCanvas`](../classes/DCanvas.md) |
| `CANVAS_OPTIONS` | extends [`DBaseOptions`](DBaseOptions.md) = [`DBaseOptions`](DBaseOptions.md) |
| `THEME` | extends [`DThemeCanvasContainer`](DThemeCanvasContainer.md) = [`DThemeCanvasContainer`](DThemeCanvasContainer.md) |
| `EMITTER` | `any` |
...
- [`DBaseOptions`](DBaseOptions.md)\<`THEME`\>
  ...
  ↳↳ [`DDiagramBaseOptions`](DDiagramBaseOptions.md)

## Table of contents

### Properties

- [background](DCanvasContainerOptions.md#background)
- [border](DCanvasContainerOptions.md#border)
- [canvas](DCanvasContainerOptions.md#canvas)
- [children](DCanvasContainerOptions.md#children)
- [clear](DCanvasContainerOptions.md#clear)
- [corner](DCanvasContainerOptions.md#corner)
- [cursor](DCanvasContainerOptions.md#cursor)
- [height](DCanvasContainerOptions.md#height)
- [interactive](DCanvasContainerOptions.md#interactive)
- [mask](DCanvasContainerOptions.md#mask)
- [name](DCanvasContainerOptions.md#name)
- [on](DCanvasContainerOptions.md#on)
- [outline](DCanvasContainerOptions.md#outline)
- [padding](DCanvasContainerOptions.md#padding)
- [parent](DCanvasContainerOptions.md#parent)
- [renderable](DCanvasContainerOptions.md#renderable)
- [shadow](DCanvasContainerOptions.md#shadow)
- [shortcut](DCanvasContainerOptions.md#shortcut)
- [shortcuts](DCanvasContainerOptions.md#shortcuts)
- [state](DCanvasContainerOptions.md#state)
- [theme](DCanvasContainerOptions.md#theme)
- [title](DCanvasContainerOptions.md#title)
- [view](DCanvasContainerOptions.md#view)
- [visible](DCanvasContainerOptions.md#visible)
- [weight](DCanvasContainerOptions.md#weight)
- [width](DCanvasContainerOptions.md#width)
- [x](DCanvasContainerOptions.md#x)
- [y](DCanvasContainerOptions.md#y)
...
[src/main/typescript/wcardinal/ui/d-canvas-container.ts:55](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/d-canvas-container.ts#L55)
...
[src/main/typescript/wcardinal/ui/d-canvas-container.ts:53](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/d-canvas-container.ts#L53)
...
• `Optional` **on**: [`DCanvasContainerOnOptions`](DCanvasContainerOnOptions.md)\<`CANVAS`, `EMITTER`\>
...
[src/main/typescript/wcardinal/ui/d-canvas-container.ts:56](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/d-canvas-container.ts#L56)
...
[src/main/typescript/wcardinal/ui/d-canvas-container.ts:54](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/d-canvas-container.ts#L54)
