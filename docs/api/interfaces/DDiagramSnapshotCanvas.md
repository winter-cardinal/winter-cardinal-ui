[Winter Cardinal UI - v0.407.0](../index.md) / DDiagramSnapshotCanvas
...
- [\_boundsID](DDiagramSnapshotCanvas.md#_boundsid)
- [\_boundsRect](DDiagramSnapshotCanvas.md#_boundsrect)
...
- [\_enabledFilters](DDiagramSnapshotCanvas.md#_enabledfilters)
- [\_lastDownPoint](DDiagramSnapshotCanvas.md#_lastdownpoint)
- [\_lastSortedIndex](DDiagramSnapshotCanvas.md#_lastsortedindex)
- [\_localBounds](DDiagramSnapshotCanvas.md#_localbounds)
- [\_localBoundsRect](DDiagramSnapshotCanvas.md#_localboundsrect)
...
- [options](DDiagramSnapshotCanvas.md#options)
...
- [containerUpdateTransform](DDiagramSnapshotCanvas.md#containerupdatetransform)
...
- [disableTempParent](DDiagramSnapshotCanvas.md#disabletempparent)
- [displayObjectUpdateTransform](DDiagramSnapshotCanvas.md#displayobjectupdatetransform)
- [emit](DDiagramSnapshotCanvas.md#emit)
- [enableTempParent](DDiagramSnapshotCanvas.md#enabletempparent)
...
- [newPadding](DDiagramSnapshotCanvas.md#newpadding)
...
[src/main/typescript/wcardinal/ui/d-diagram-snapshot.ts:46](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-diagram-snapshot.ts#L46)
...
▸ **setFocused**(`isFocused`): [`DDiagramSnapshotCanvas`](DDiagramSnapshotCanvas.md)
