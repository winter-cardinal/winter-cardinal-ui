[Winter Cardinal UI - v0.160.0](../index.md) / DDiagramSnapshotCanvas

# Interface: DDiagramSnapshotCanvas

## Hierarchy

- [`DBase`](../classes/DBase.md)

  ↳ **`DDiagramSnapshotCanvas`**

## Table of contents

### Properties

- [\_accessibleActive](DDiagramSnapshotCanvas.md#_accessibleactive)
- [\_accessibleDiv](DDiagramSnapshotCanvas.md#_accessiblediv)
- [\_auto](DDiagramSnapshotCanvas.md#_auto)
- [\_background](DDiagramSnapshotCanvas.md#_background)
- [\_border](DDiagramSnapshotCanvas.md#_border)
- [\_bounds](DDiagramSnapshotCanvas.md#_bounds)
- [\_clearType](DDiagramSnapshotCanvas.md#_cleartype)
- [\_corner](DDiagramSnapshotCanvas.md#_corner)
- [\_cursor](DDiagramSnapshotCanvas.md#_cursor)
- [\_destroyed](DDiagramSnapshotCanvas.md#_destroyed)
- [\_lastDownPoint](DDiagramSnapshotCanvas.md#_lastdownpoint)
- [\_lastSortedIndex](DDiagramSnapshotCanvas.md#_lastsortedindex)
- [\_mask](DDiagramSnapshotCanvas.md#_mask)
- [\_options](DDiagramSnapshotCanvas.md#_options)
- [\_outline](DDiagramSnapshotCanvas.md#_outline)
- [\_padding](DDiagramSnapshotCanvas.md#_padding)
- [\_reflowable](DDiagramSnapshotCanvas.md#_reflowable)
- [\_shortcuts](DDiagramSnapshotCanvas.md#_shortcuts)
- [\_snippet](DDiagramSnapshotCanvas.md#_snippet)
- [\_tempDisplayObjectParent](DDiagramSnapshotCanvas.md#_tempdisplayobjectparent)
- [\_title](DDiagramSnapshotCanvas.md#_title)
- [\_zIndex](DDiagramSnapshotCanvas.md#_zindex)
- [accessible](DDiagramSnapshotCanvas.md#accessible)
- [accessibleChildren](DDiagramSnapshotCanvas.md#accessiblechildren)
- [accessibleHint](DDiagramSnapshotCanvas.md#accessiblehint)
- [accessiblePointerEvents](DDiagramSnapshotCanvas.md#accessiblepointerevents)
- [accessibleTitle](DDiagramSnapshotCanvas.md#accessibletitle)
- [accessibleType](DDiagramSnapshotCanvas.md#accessibletype)
- [alpha](DDiagramSnapshotCanvas.md#alpha)
- [angle](DDiagramSnapshotCanvas.md#angle)
- [buttonMode](DDiagramSnapshotCanvas.md#buttonmode)
- [cacheAsBitmap](DDiagramSnapshotCanvas.md#cacheasbitmap)
- [children](DDiagramSnapshotCanvas.md#children)
- [cursor](DDiagramSnapshotCanvas.md#cursor)
- [filterArea](DDiagramSnapshotCanvas.md#filterarea)
- [filters](DDiagramSnapshotCanvas.md#filters)
- [hitArea](DDiagramSnapshotCanvas.md#hitarea)
- [interactive](DDiagramSnapshotCanvas.md#interactive)
- [interactiveChildren](DDiagramSnapshotCanvas.md#interactivechildren)
- [isMask](DDiagramSnapshotCanvas.md#ismask)
- [isSprite](DDiagramSnapshotCanvas.md#issprite)
- [localTransform](DDiagramSnapshotCanvas.md#localtransform)
- [mask](DDiagramSnapshotCanvas.md#mask)
- [name](DDiagramSnapshotCanvas.md#name)
- [parent](DDiagramSnapshotCanvas.md#parent)
- [pivot](DDiagramSnapshotCanvas.md#pivot)
- [renderable](DDiagramSnapshotCanvas.md#renderable)
- [rotation](DDiagramSnapshotCanvas.md#rotation)
- [snap](DDiagramSnapshotCanvas.md#snap)
- [sortDirty](DDiagramSnapshotCanvas.md#sortdirty)
- [sortableChildren](DDiagramSnapshotCanvas.md#sortablechildren)
- [transform](DDiagramSnapshotCanvas.md#transform)
- [visible](DDiagramSnapshotCanvas.md#visible)
- [worldAlpha](DDiagramSnapshotCanvas.md#worldalpha)
- [worldTransform](DDiagramSnapshotCanvas.md#worldtransform)
- [worldVisible](DDiagramSnapshotCanvas.md#worldvisible)
- [zIndex](DDiagramSnapshotCanvas.md#zindex)

### Accessors

- [background](DDiagramSnapshotCanvas.md#background)
- [border](DDiagramSnapshotCanvas.md#border)
- [corner](DDiagramSnapshotCanvas.md#corner)
- [height](DDiagramSnapshotCanvas.md#height)
- [outline](DDiagramSnapshotCanvas.md#outline)
- [padding](DDiagramSnapshotCanvas.md#padding)
- [position](DDiagramSnapshotCanvas.md#position)
- [reflowable](DDiagramSnapshotCanvas.md#reflowable)
- [scale](DDiagramSnapshotCanvas.md#scale)
- [shadow](DDiagramSnapshotCanvas.md#shadow)
- [skew](DDiagramSnapshotCanvas.md#skew)
- [snippet](DDiagramSnapshotCanvas.md#snippet)
- [state](DDiagramSnapshotCanvas.md#state)
- [theme](DDiagramSnapshotCanvas.md#theme)
- [title](DDiagramSnapshotCanvas.md#title)
- [type](DDiagramSnapshotCanvas.md#type)
- [unsafe](DDiagramSnapshotCanvas.md#unsafe)
- [weight](DDiagramSnapshotCanvas.md#weight)
- [width](DDiagramSnapshotCanvas.md#width)
- [x](DDiagramSnapshotCanvas.md#x)
- [y](DDiagramSnapshotCanvas.md#y)

### Methods

- [\_calculateBounds](DDiagramSnapshotCanvas.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DDiagramSnapshotCanvas.md#_recursivepostupdatetransform)
- [\_render](DDiagramSnapshotCanvas.md#_render)
- [addChild](DDiagramSnapshotCanvas.md#addchild)
- [addChildAt](DDiagramSnapshotCanvas.md#addchildat)
- [addListener](DDiagramSnapshotCanvas.md#addlistener)
- [applyTitle](DDiagramSnapshotCanvas.md#applytitle)
- [blur](DDiagramSnapshotCanvas.md#blur)
- [calculateBounds](DDiagramSnapshotCanvas.md#calculatebounds)
- [containsGlobalPoint](DDiagramSnapshotCanvas.md#containsglobalpoint)
- [containsLocalPoint](DDiagramSnapshotCanvas.md#containslocalpoint)
- [containsPoint](DDiagramSnapshotCanvas.md#containspoint)
- [destroy](DDiagramSnapshotCanvas.md#destroy)
- [displayObjectUpdateTransform](DDiagramSnapshotCanvas.md#displayobjectupdatetransform)
- [emit](DDiagramSnapshotCanvas.md#emit)
- [eventNames](DDiagramSnapshotCanvas.md#eventnames)
- [focus](DDiagramSnapshotCanvas.md#focus)
- [focusOnClosest](DDiagramSnapshotCanvas.md#focusonclosest)
- [getBounds](DDiagramSnapshotCanvas.md#getbounds)
- [getChildAt](DDiagramSnapshotCanvas.md#getchildat)
- [getChildByName](DDiagramSnapshotCanvas.md#getchildbyname)
- [getChildIndex](DDiagramSnapshotCanvas.md#getchildindex)
- [getClearType](DDiagramSnapshotCanvas.md#getcleartype)
- [getClippingRect](DDiagramSnapshotCanvas.md#getclippingrect)
- [getGlobalPosition](DDiagramSnapshotCanvas.md#getglobalposition)
- [getHeight](DDiagramSnapshotCanvas.md#getheight)
- [getLocalBounds](DDiagramSnapshotCanvas.md#getlocalbounds)
- [getParentOfSize](DDiagramSnapshotCanvas.md#getparentofsize)
- [getThemeDefault](DDiagramSnapshotCanvas.md#getthemedefault)
- [getType](DDiagramSnapshotCanvas.md#gettype)
- [getWidth](DDiagramSnapshotCanvas.md#getwidth)
- [getX](DDiagramSnapshotCanvas.md#getx)
- [getY](DDiagramSnapshotCanvas.md#gety)
- [hasDirty](DDiagramSnapshotCanvas.md#hasdirty)
- [hasRefitableHeight](DDiagramSnapshotCanvas.md#hasrefitableheight)
- [hasRefitableWidth](DDiagramSnapshotCanvas.md#hasrefitablewidth)
- [hide](DDiagramSnapshotCanvas.md#hide)
- [init](DDiagramSnapshotCanvas.md#init)
- [initReflowable](DDiagramSnapshotCanvas.md#initreflowable)
- [isDirty](DDiagramSnapshotCanvas.md#isdirty)
- [isEventTarget](DDiagramSnapshotCanvas.md#iseventtarget)
- [isHidden](DDiagramSnapshotCanvas.md#ishidden)
- [isHierarchyDirty](DDiagramSnapshotCanvas.md#ishierarchydirty)
- [isRefitable](DDiagramSnapshotCanvas.md#isrefitable)
- [isShown](DDiagramSnapshotCanvas.md#isshown)
- [listenerCount](DDiagramSnapshotCanvas.md#listenercount)
- [listeners](DDiagramSnapshotCanvas.md#listeners)
- [off](DDiagramSnapshotCanvas.md#off)
- [on](DDiagramSnapshotCanvas.md#on)
- [onBlur](DDiagramSnapshotCanvas.md#onblur)
- [onChildBlur](DDiagramSnapshotCanvas.md#onchildblur)
- [onChildFocus](DDiagramSnapshotCanvas.md#onchildfocus)
- [onChildrenChange](DDiagramSnapshotCanvas.md#onchildrenchange)
- [onDblClick](DDiagramSnapshotCanvas.md#ondblclick)
- [onDown](DDiagramSnapshotCanvas.md#ondown)
- [onDownThis](DDiagramSnapshotCanvas.md#ondownthis)
- [onFocus](DDiagramSnapshotCanvas.md#onfocus)
- [onHierarchyDirty](DDiagramSnapshotCanvas.md#onhierarchydirty)
- [onKeyDown](DDiagramSnapshotCanvas.md#onkeydown)
- [onKeyUp](DDiagramSnapshotCanvas.md#onkeyup)
- [onMove](DDiagramSnapshotCanvas.md#onmove)
- [onOut](DDiagramSnapshotCanvas.md#onout)
- [onOver](DDiagramSnapshotCanvas.md#onover)
- [onParentMove](DDiagramSnapshotCanvas.md#onparentmove)
- [onParentResize](DDiagramSnapshotCanvas.md#onparentresize)
- [onRefit](DDiagramSnapshotCanvas.md#onrefit)
- [onReflow](DDiagramSnapshotCanvas.md#onreflow)
- [onResize](DDiagramSnapshotCanvas.md#onresize)
- [onScale](DDiagramSnapshotCanvas.md#onscale)
- [onShortcut](DDiagramSnapshotCanvas.md#onshortcut)
- [onSkew](DDiagramSnapshotCanvas.md#onskew)
- [onStateChange](DDiagramSnapshotCanvas.md#onstatechange)
- [onUp](DDiagramSnapshotCanvas.md#onup)
- [onUpThis](DDiagramSnapshotCanvas.md#onupthis)
- [onWheel](DDiagramSnapshotCanvas.md#onwheel)
- [once](DDiagramSnapshotCanvas.md#once)
- [reflow](DDiagramSnapshotCanvas.md#reflow)
- [removeAllListeners](DDiagramSnapshotCanvas.md#removealllisteners)
- [removeChild](DDiagramSnapshotCanvas.md#removechild)
- [removeChildAt](DDiagramSnapshotCanvas.md#removechildat)
- [removeChildren](DDiagramSnapshotCanvas.md#removechildren)
- [removeListener](DDiagramSnapshotCanvas.md#removelistener)
- [render](DDiagramSnapshotCanvas.md#render)
- [renderAdvanced](DDiagramSnapshotCanvas.md#renderadvanced)
- [resize](DDiagramSnapshotCanvas.md#resize)
- [setChildIndex](DDiagramSnapshotCanvas.md#setchildindex)
- [setFocused](DDiagramSnapshotCanvas.md#setfocused)
- [setHeight](DDiagramSnapshotCanvas.md#setheight)
- [setParent](DDiagramSnapshotCanvas.md#setparent)
- [setTransform](DDiagramSnapshotCanvas.md#settransform)
- [setWidth](DDiagramSnapshotCanvas.md#setwidth)
- [setX](DDiagramSnapshotCanvas.md#setx)
- [setY](DDiagramSnapshotCanvas.md#sety)
- [show](DDiagramSnapshotCanvas.md#show)
- [sortChildren](DDiagramSnapshotCanvas.md#sortchildren)
- [swapChildren](DDiagramSnapshotCanvas.md#swapchildren)
- [toCursor](DDiagramSnapshotCanvas.md#tocursor)
- [toDirty](DDiagramSnapshotCanvas.md#todirty)
- [toGlobal](DDiagramSnapshotCanvas.md#toglobal)
- [toHasDirty](DDiagramSnapshotCanvas.md#tohasdirty)
- [toHierarchyDirty](DDiagramSnapshotCanvas.md#tohierarchydirty)
- [toLocal](DDiagramSnapshotCanvas.md#tolocal)
- [toParentHasDirty](DDiagramSnapshotCanvas.md#toparenthasdirty)
- [toParentHierarchyDirty](DDiagramSnapshotCanvas.md#toparenthierarchydirty)
- [toParentResized](DDiagramSnapshotCanvas.md#toparentresized)
- [updateTransform](DDiagramSnapshotCanvas.md#updatetransform)
...
• `Optional` **snap**: ``null`` \| [`DDiagramSnapshotCanvasSnap`](DDiagramSnapshotCanvasSnap.md)

#### Defined in

[src/main/typescript/wcardinal/ui/d-diagram-snapshot.ts:46](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-diagram-snapshot.ts#L46)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DDiagramSnapshotCanvas`](DDiagramSnapshotCanvas.md)
...
[`DDiagramSnapshotCanvas`](DDiagramSnapshotCanvas.md)
...
▸ **blur**(`recursively?`): [`DDiagramSnapshotCanvas`](DDiagramSnapshotCanvas.md)
...
▸ **focus**(): [`DDiagramSnapshotCanvas`](DDiagramSnapshotCanvas.md)
...
[src/main/typescript/wcardinal/ui/d-base.ts:1897](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-base.ts#L1897)
...
▸ **hide**(): [`DDiagramSnapshotCanvas`](DDiagramSnapshotCanvas.md)
...
▸ **off**(`event`, `fn?`, `context?`): [`DDiagramSnapshotCanvas`](DDiagramSnapshotCanvas.md)
...
▸ **on**(`event`, `fn`, `context?`): [`DDiagramSnapshotCanvas`](DDiagramSnapshotCanvas.md)
...
▸ **once**(`event`, `fn`, `context?`): [`DDiagramSnapshotCanvas`](DDiagramSnapshotCanvas.md)
...
▸ **removeAllListeners**(`event?`): [`DDiagramSnapshotCanvas`](DDiagramSnapshotCanvas.md)
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DDiagramSnapshotCanvas`](DDiagramSnapshotCanvas.md)
...
▸ `Protected` **setFocused**(`isFocused`): [`DDiagramSnapshotCanvas`](DDiagramSnapshotCanvas.md)
...
▸ **show**(): [`DDiagramSnapshotCanvas`](DDiagramSnapshotCanvas.md)
