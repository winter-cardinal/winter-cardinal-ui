[Winter Cardinal UI - v0.407.0](../index.md) / DDialogGestureParent

# Interface: DDialogGestureParent
...
- [\_accessibleActive](DDialogGestureParent.md#_accessibleactive)
- [\_accessibleDiv](DDialogGestureParent.md#_accessiblediv)
- [\_auto](DDialogGestureParent.md#_auto)
- [\_background](DDialogGestureParent.md#_background)
- [\_border](DDialogGestureParent.md#_border)
- [\_bounds](DDialogGestureParent.md#_bounds)
- [\_boundsID](DDialogGestureParent.md#_boundsid)
- [\_boundsRect](DDialogGestureParent.md#_boundsrect)
- [\_clearType](DDialogGestureParent.md#_cleartype)
- [\_corner](DDialogGestureParent.md#_corner)
- [\_cursor](DDialogGestureParent.md#_cursor)
- [\_destroyed](DDialogGestureParent.md#_destroyed)
- [\_enabledFilters](DDialogGestureParent.md#_enabledfilters)
- [\_lastDownPoint](DDialogGestureParent.md#_lastdownpoint)
- [\_lastSortedIndex](DDialogGestureParent.md#_lastsortedindex)
- [\_localBounds](DDialogGestureParent.md#_localbounds)
- [\_localBoundsRect](DDialogGestureParent.md#_localboundsrect)
- [\_mask](DDialogGestureParent.md#_mask)
- [\_options](DDialogGestureParent.md#_options)
- [\_outline](DDialogGestureParent.md#_outline)
- [\_padding](DDialogGestureParent.md#_padding)
- [\_reflowable](DDialogGestureParent.md#_reflowable)
- [\_shortcuts](DDialogGestureParent.md#_shortcuts)
- [\_snippet](DDialogGestureParent.md#_snippet)
- [\_tempDisplayObjectParent](DDialogGestureParent.md#_tempdisplayobjectparent)
- [\_title](DDialogGestureParent.md#_title)
- [\_zIndex](DDialogGestureParent.md#_zindex)
- [accessible](DDialogGestureParent.md#accessible)
- [accessibleChildren](DDialogGestureParent.md#accessiblechildren)
- [accessibleHint](DDialogGestureParent.md#accessiblehint)
- [accessiblePointerEvents](DDialogGestureParent.md#accessiblepointerevents)
- [accessibleTitle](DDialogGestureParent.md#accessibletitle)
- [accessibleType](DDialogGestureParent.md#accessibletype)
- [alpha](DDialogGestureParent.md#alpha)
- [angle](DDialogGestureParent.md#angle)
- [buttonMode](DDialogGestureParent.md#buttonmode)
- [cacheAsBitmap](DDialogGestureParent.md#cacheasbitmap)
- [children](DDialogGestureParent.md#children)
- [cursor](DDialogGestureParent.md#cursor)
- [filterArea](DDialogGestureParent.md#filterarea)
- [filters](DDialogGestureParent.md#filters)
- [hitArea](DDialogGestureParent.md#hitarea)
- [interactive](DDialogGestureParent.md#interactive)
- [interactiveChildren](DDialogGestureParent.md#interactivechildren)
- [isMask](DDialogGestureParent.md#ismask)
- [isSprite](DDialogGestureParent.md#issprite)
- [layer](DDialogGestureParent.md#layer)
- [localTransform](DDialogGestureParent.md#localtransform)
- [mask](DDialogGestureParent.md#mask)
- [name](DDialogGestureParent.md#name)
- [parent](DDialogGestureParent.md#parent)
- [pivot](DDialogGestureParent.md#pivot)
- [renderable](DDialogGestureParent.md#renderable)
- [rotation](DDialogGestureParent.md#rotation)
- [sortDirty](DDialogGestureParent.md#sortdirty)
- [sortableChildren](DDialogGestureParent.md#sortablechildren)
- [transform](DDialogGestureParent.md#transform)
- [visible](DDialogGestureParent.md#visible)
- [worldAlpha](DDialogGestureParent.md#worldalpha)
- [worldTransform](DDialogGestureParent.md#worldtransform)
- [worldVisible](DDialogGestureParent.md#worldvisible)
- [zIndex](DDialogGestureParent.md#zindex)

### Accessors

- [background](DDialogGestureParent.md#background)
- [border](DDialogGestureParent.md#border)
- [corner](DDialogGestureParent.md#corner)
- [height](DDialogGestureParent.md#height)
- [options](DDialogGestureParent.md#options)
- [outline](DDialogGestureParent.md#outline)
- [padding](DDialogGestureParent.md#padding)
- [position](DDialogGestureParent.md#position)
- [reflowable](DDialogGestureParent.md#reflowable)
- [scale](DDialogGestureParent.md#scale)
- [shadow](DDialogGestureParent.md#shadow)
- [skew](DDialogGestureParent.md#skew)
- [snippet](DDialogGestureParent.md#snippet)
- [state](DDialogGestureParent.md#state)
- [theme](DDialogGestureParent.md#theme)
- [title](DDialogGestureParent.md#title)
- [type](DDialogGestureParent.md#type)
- [unsafe](DDialogGestureParent.md#unsafe)
- [weight](DDialogGestureParent.md#weight)
- [width](DDialogGestureParent.md#width)
- [x](DDialogGestureParent.md#x)
- [y](DDialogGestureParent.md#y)

### Methods

- [\_calculateBounds](DDialogGestureParent.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DDialogGestureParent.md#_recursivepostupdatetransform)
- [\_render](DDialogGestureParent.md#_render)
- [addChild](DDialogGestureParent.md#addchild)
- [addChildAt](DDialogGestureParent.md#addchildat)
- [addListener](DDialogGestureParent.md#addlistener)
- [applyTitle](DDialogGestureParent.md#applytitle)
- [blur](DDialogGestureParent.md#blur)
- [calculateBounds](DDialogGestureParent.md#calculatebounds)
- [containerUpdateTransform](DDialogGestureParent.md#containerupdatetransform)
- [containsGlobalPoint](DDialogGestureParent.md#containsglobalpoint)
- [containsLocalPoint](DDialogGestureParent.md#containslocalpoint)
- [containsPoint](DDialogGestureParent.md#containspoint)
- [destroy](DDialogGestureParent.md#destroy)
- [disableTempParent](DDialogGestureParent.md#disabletempparent)
- [displayObjectUpdateTransform](DDialogGestureParent.md#displayobjectupdatetransform)
- [emit](DDialogGestureParent.md#emit)
- [enableTempParent](DDialogGestureParent.md#enabletempparent)
- [eventNames](DDialogGestureParent.md#eventnames)
- [focus](DDialogGestureParent.md#focus)
- [focusOnClosest](DDialogGestureParent.md#focusonclosest)
- [getBounds](DDialogGestureParent.md#getbounds)
- [getChildAt](DDialogGestureParent.md#getchildat)
- [getChildByName](DDialogGestureParent.md#getchildbyname)
- [getChildIndex](DDialogGestureParent.md#getchildindex)
- [getClearType](DDialogGestureParent.md#getcleartype)
- [getClippingRect](DDialogGestureParent.md#getclippingrect)
- [getGlobalPosition](DDialogGestureParent.md#getglobalposition)
- [getHeight](DDialogGestureParent.md#getheight)
- [getLocalBounds](DDialogGestureParent.md#getlocalbounds)
- [getParentOfSize](DDialogGestureParent.md#getparentofsize)
- [getThemeDefault](DDialogGestureParent.md#getthemedefault)
- [getType](DDialogGestureParent.md#gettype)
- [getWidth](DDialogGestureParent.md#getwidth)
- [getX](DDialogGestureParent.md#getx)
- [getY](DDialogGestureParent.md#gety)
- [hasDirty](DDialogGestureParent.md#hasdirty)
- [hasRefitableHeight](DDialogGestureParent.md#hasrefitableheight)
- [hasRefitableWidth](DDialogGestureParent.md#hasrefitablewidth)
- [hide](DDialogGestureParent.md#hide)
- [init](DDialogGestureParent.md#init)
- [initReflowable](DDialogGestureParent.md#initreflowable)
- [isDirty](DDialogGestureParent.md#isdirty)
- [isEventTarget](DDialogGestureParent.md#iseventtarget)
- [isHidden](DDialogGestureParent.md#ishidden)
- [isHierarchyDirty](DDialogGestureParent.md#ishierarchydirty)
- [isRefitable](DDialogGestureParent.md#isrefitable)
- [isShown](DDialogGestureParent.md#isshown)
- [listenerCount](DDialogGestureParent.md#listenercount)
- [listeners](DDialogGestureParent.md#listeners)
- [newPadding](DDialogGestureParent.md#newpadding)
- [off](DDialogGestureParent.md#off)
- [on](DDialogGestureParent.md#on)
- [onBlur](DDialogGestureParent.md#onblur)
- [onChildBlur](DDialogGestureParent.md#onchildblur)
- [onChildFocus](DDialogGestureParent.md#onchildfocus)
- [onChildrenChange](DDialogGestureParent.md#onchildrenchange)
- [onDblClick](DDialogGestureParent.md#ondblclick)
- [onDown](DDialogGestureParent.md#ondown)
- [onDownThis](DDialogGestureParent.md#ondownthis)
- [onFocus](DDialogGestureParent.md#onfocus)
- [onHierarchyDirty](DDialogGestureParent.md#onhierarchydirty)
- [onKeyDown](DDialogGestureParent.md#onkeydown)
- [onKeyUp](DDialogGestureParent.md#onkeyup)
- [onMove](DDialogGestureParent.md#onmove)
- [onOut](DDialogGestureParent.md#onout)
- [onOver](DDialogGestureParent.md#onover)
- [onParentMove](DDialogGestureParent.md#onparentmove)
- [onParentResize](DDialogGestureParent.md#onparentresize)
- [onRefit](DDialogGestureParent.md#onrefit)
- [onReflow](DDialogGestureParent.md#onreflow)
- [onResize](DDialogGestureParent.md#onresize)
- [onScale](DDialogGestureParent.md#onscale)
- [onShortcut](DDialogGestureParent.md#onshortcut)
- [onSkew](DDialogGestureParent.md#onskew)
- [onStateChange](DDialogGestureParent.md#onstatechange)
- [onUp](DDialogGestureParent.md#onup)
- [onUpThis](DDialogGestureParent.md#onupthis)
- [onWheel](DDialogGestureParent.md#onwheel)
- [once](DDialogGestureParent.md#once)
- [reflow](DDialogGestureParent.md#reflow)
- [removeAllListeners](DDialogGestureParent.md#removealllisteners)
- [removeChild](DDialogGestureParent.md#removechild)
- [removeChildAt](DDialogGestureParent.md#removechildat)
- [removeChildren](DDialogGestureParent.md#removechildren)
- [removeListener](DDialogGestureParent.md#removelistener)
- [render](DDialogGestureParent.md#render)
- [renderAdvanced](DDialogGestureParent.md#renderadvanced)
- [resize](DDialogGestureParent.md#resize)
- [setChildIndex](DDialogGestureParent.md#setchildindex)
- [setFocused](DDialogGestureParent.md#setfocused)
- [setHeight](DDialogGestureParent.md#setheight)
- [setParent](DDialogGestureParent.md#setparent)
- [setTransform](DDialogGestureParent.md#settransform)
- [setWidth](DDialogGestureParent.md#setwidth)
- [setX](DDialogGestureParent.md#setx)
- [setY](DDialogGestureParent.md#sety)
- [show](DDialogGestureParent.md#show)
- [sortChildren](DDialogGestureParent.md#sortchildren)
- [swapChildren](DDialogGestureParent.md#swapchildren)
- [toCursor](DDialogGestureParent.md#tocursor)
- [toDirty](DDialogGestureParent.md#todirty)
- [toGlobal](DDialogGestureParent.md#toglobal)
- [toHasDirty](DDialogGestureParent.md#tohasdirty)
- [toHierarchyDirty](DDialogGestureParent.md#tohierarchydirty)
- [toLocal](DDialogGestureParent.md#tolocal)
- [toParentHasDirty](DDialogGestureParent.md#toparenthasdirty)
- [toParentHierarchyDirty](DDialogGestureParent.md#toparenthierarchydirty)
- [toParentResized](DDialogGestureParent.md#toparentresized)
- [updateTransform](DDialogGestureParent.md#updatetransform)
...
• `Readonly` **layer**: ``null`` \| [`DApplicationLayerLike`](DApplicationLayerLike.md)

#### Defined in

[src/main/typescript/wcardinal/ui/d-dialog-gesture.ts:24](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-dialog-gesture.ts#L24)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DDialogGestureParent`](DDialogGestureParent.md)
...
[`DDialogGestureParent`](DDialogGestureParent.md)
...
▸ **blur**(`recursively?`): [`DDialogGestureParent`](DDialogGestureParent.md)
...
▸ **focus**(): [`DDialogGestureParent`](DDialogGestureParent.md)
...
▸ **hide**(): [`DDialogGestureParent`](DDialogGestureParent.md)
...
▸ **off**(`event`, `fn?`, `context?`): [`DDialogGestureParent`](DDialogGestureParent.md)
...
▸ **on**(`event`, `fn`, `context?`): [`DDialogGestureParent`](DDialogGestureParent.md)
...
▸ **once**(`event`, `fn`, `context?`): [`DDialogGestureParent`](DDialogGestureParent.md)
...
▸ **removeAllListeners**(`event?`): [`DDialogGestureParent`](DDialogGestureParent.md)
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DDialogGestureParent`](DDialogGestureParent.md)
...
▸ **setFocused**(`isFocused`): [`DDialogGestureParent`](DDialogGestureParent.md)
...
▸ **show**(): [`DDialogGestureParent`](DDialogGestureParent.md)
