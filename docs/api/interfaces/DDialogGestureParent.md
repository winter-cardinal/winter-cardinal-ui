[Winter Cardinal UI - v0.179.0](../index.md) / DDialogGestureParent
...
[src/main/typescript/wcardinal/ui/d-dialog-gesture.ts:24](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.179.0/src/main/typescript/wcardinal/ui/d-dialog-gesture.ts#L24)
...
▸ `Protected` **setFocused**(`isFocused`): [`DDialogGestureParent`](DDialogGestureParent.md)
