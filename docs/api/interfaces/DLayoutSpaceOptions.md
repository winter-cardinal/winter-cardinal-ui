[Winter Cardinal UI - v0.310.1](../index.md) / DLayoutSpaceOptions

# Interface: DLayoutSpaceOptions<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeLayoutSpace`](DThemeLayoutSpace.md) = [`DThemeLayoutSpace`](DThemeLayoutSpace.md) |
...
- [`DBaseOptions`](DBaseOptions.md)<`THEME`\>
  ...
  ↳↳ [`DMenuBarItemSpaceOptions`](DMenuBarItemSpaceOptions.md)

  ↳↳ [`DMenuItemSpaceOptions`](DMenuItemSpaceOptions.md)

## Table of contents

### Properties

- [background](DLayoutSpaceOptions.md#background)
- [border](DLayoutSpaceOptions.md#border)
- [children](DLayoutSpaceOptions.md#children)
- [clear](DLayoutSpaceOptions.md#clear)
- [corner](DLayoutSpaceOptions.md#corner)
- [cursor](DLayoutSpaceOptions.md#cursor)
- [height](DLayoutSpaceOptions.md#height)
- [interactive](DLayoutSpaceOptions.md#interactive)
- [name](DLayoutSpaceOptions.md#name)
- [on](DLayoutSpaceOptions.md#on)
- [outline](DLayoutSpaceOptions.md#outline)
- [padding](DLayoutSpaceOptions.md#padding)
- [parent](DLayoutSpaceOptions.md#parent)
- [renderable](DLayoutSpaceOptions.md#renderable)
- [shadow](DLayoutSpaceOptions.md#shadow)
- [shortcut](DLayoutSpaceOptions.md#shortcut)
- [shortcuts](DLayoutSpaceOptions.md#shortcuts)
- [state](DLayoutSpaceOptions.md#state)
- [theme](DLayoutSpaceOptions.md#theme)
- [title](DLayoutSpaceOptions.md#title)
- [visible](DLayoutSpaceOptions.md#visible)
- [weight](DLayoutSpaceOptions.md#weight)
- [width](DLayoutSpaceOptions.md#width)
- [x](DLayoutSpaceOptions.md#x)
- [y](DLayoutSpaceOptions.md#y)
...
A renderability.
Unlike [visible](DLayoutSpaceOptions.md#visible), non-renderable element occupies a space.
