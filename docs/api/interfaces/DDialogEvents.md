[Winter Cardinal UI - v0.442.0](../index.md) / DDialogEvents
...
- [`DBaseEvents`](DBaseEvents.md)\<`EMITTER`\>
  ...
  ↳↳ [`DDialogLayeredEvents`](DDialogLayeredEvents.md)
...
- [shortcut](DDialogEvents.md#shortcut)
