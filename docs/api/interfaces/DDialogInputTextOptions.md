[Winter Cardinal UI - v0.205.1](../index.md) / DDialogInputTextOptions

# Interface: DDialogInputTextOptions<THEME\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeDialogInputText`](DThemeDialogInputText.md) |

## Hierarchy

- [`DDialogInputOptions`](DDialogInputOptions.md)<`string`, [`DDialogInputTextInputOptions`](DDialogInputTextInputOptions.md), `THEME`\>

  ↳ **`DDialogInputTextOptions`**

  ↳↳ [`DDialogSaveAsOptions`](DDialogSaveAsOptions.md)

## Table of contents

### Properties

- [align](DDialogInputTextOptions.md#align)
- [animation](DDialogInputTextOptions.md#animation)
- [background](DDialogInputTextOptions.md#background)
- [border](DDialogInputTextOptions.md#border)
- [children](DDialogInputTextOptions.md#children)
- [clear](DDialogInputTextOptions.md#clear)
- [closeOn](DDialogInputTextOptions.md#closeon)
- [content](DDialogInputTextOptions.md#content)
- [corner](DDialogInputTextOptions.md#corner)
- [cursor](DDialogInputTextOptions.md#cursor)
- [footer](DDialogInputTextOptions.md#footer)
- [gesture](DDialogInputTextOptions.md#gesture)
- [header](DDialogInputTextOptions.md#header)
- [height](DDialogInputTextOptions.md#height)
- [input](DDialogInputTextOptions.md#input)
- [interactive](DDialogInputTextOptions.md#interactive)
- [layout](DDialogInputTextOptions.md#layout)
- [mode](DDialogInputTextOptions.md#mode)
- [name](DDialogInputTextOptions.md#name)
- [on](DDialogInputTextOptions.md#on)
- [outline](DDialogInputTextOptions.md#outline)
- [padding](DDialogInputTextOptions.md#padding)
- [parent](DDialogInputTextOptions.md#parent)
- [shadow](DDialogInputTextOptions.md#shadow)
- [shortcut](DDialogInputTextOptions.md#shortcut)
- [shortcuts](DDialogInputTextOptions.md#shortcuts)
- [state](DDialogInputTextOptions.md#state)
- [sticky](DDialogInputTextOptions.md#sticky)
- [theme](DDialogInputTextOptions.md#theme)
- [title](DDialogInputTextOptions.md#title)
- [visible](DDialogInputTextOptions.md#visible)
- [weight](DDialogInputTextOptions.md#weight)
- [width](DDialogInputTextOptions.md#width)
- [x](DDialogInputTextOptions.md#x)
- [y](DDialogInputTextOptions.md#y)
...
[src/main/typescript/wcardinal/ui/d-dialog-input.ts:21](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input.ts#L21)
