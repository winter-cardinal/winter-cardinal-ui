[Winter Cardinal UI - v0.160.0](../index.md) / DDialogColorOptions
...
- [`DDialogCommandOptions`](DDialogCommandOptions.md)<[`DColorAndAlpha`](DColorAndAlpha.md), `THEME`\>
...
- [cancel](DDialogColorOptions.md#cancel)
...
• `Optional` **on**: [`DDialogCommandOnOptions`](DDialogCommandOnOptions.md)<[`DColorAndAlpha`](DColorAndAlpha.md), `any`\>
...
[src/main/typescript/wcardinal/ui/d-dialog-color.ts:14](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-color.ts#L14)
