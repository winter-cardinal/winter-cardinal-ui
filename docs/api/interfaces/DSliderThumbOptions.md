[Winter Cardinal UI - v0.199.0](../index.md) / DSliderThumbOptions

# Interface: DSliderThumbOptions<VALUE, THEME\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeSliderThumb`](DThemeSliderThumb.md)<`VALUE`\> = [`DThemeSliderThumb`](DThemeSliderThumb.md)<`VALUE`\> |
...
- [background](DSliderThumbOptions.md#background)
- [border](DSliderThumbOptions.md#border)
- [children](DSliderThumbOptions.md#children)
- [clear](DSliderThumbOptions.md#clear)
- [corner](DSliderThumbOptions.md#corner)
- [cursor](DSliderThumbOptions.md#cursor)
- [group](DSliderThumbOptions.md#group)
- [height](DSliderThumbOptions.md#height)
- [image](DSliderThumbOptions.md#image)
- [interactive](DSliderThumbOptions.md#interactive)
- [mask](DSliderThumbOptions.md#mask)
- [name](DSliderThumbOptions.md#name)
- [on](DSliderThumbOptions.md#on)
- [outline](DSliderThumbOptions.md#outline)
- [padding](DSliderThumbOptions.md#padding)
- [parent](DSliderThumbOptions.md#parent)
- [shadow](DSliderThumbOptions.md#shadow)
- [shortcut](DSliderThumbOptions.md#shortcut)
- [shortcuts](DSliderThumbOptions.md#shortcuts)
- [state](DSliderThumbOptions.md#state)
- [text](DSliderThumbOptions.md#text)
- [theme](DSliderThumbOptions.md#theme)
- [title](DSliderThumbOptions.md#title)
- [toggle](DSliderThumbOptions.md#toggle)
- [visible](DSliderThumbOptions.md#visible)
- [weight](DSliderThumbOptions.md#weight)
- [when](DSliderThumbOptions.md#when)
- [width](DSliderThumbOptions.md#width)
- [x](DSliderThumbOptions.md#x)
- [y](DSliderThumbOptions.md#y)
