[Winter Cardinal UI - v0.310.1](../index.md) / DMenuSidedContentOptions
...
A renderability.
Unlike [visible](DMenuSidedContentOptions.md#visible), non-renderable element occupies a space.
