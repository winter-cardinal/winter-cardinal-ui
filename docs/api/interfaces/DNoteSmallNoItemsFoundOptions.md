[Winter Cardinal UI - v0.442.0](../index.md) / DNoteSmallNoItemsFoundOptions

# Interface: DNoteSmallNoItemsFoundOptions\<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeNoteSmallNoItemsFound`](DThemeNoteSmallNoItemsFound.md) = [`DThemeNoteSmallNoItemsFound`](DThemeNoteSmallNoItemsFound.md) |

## Hierarchy

- [`DNoteSmallOptions`](DNoteSmallOptions.md)\<`THEME`\>

  ↳ **`DNoteSmallNoItemsFoundOptions`**

## Table of contents

### Properties

- [background](DNoteSmallNoItemsFoundOptions.md#background)
- [border](DNoteSmallNoItemsFoundOptions.md#border)
- [children](DNoteSmallNoItemsFoundOptions.md#children)
- [clear](DNoteSmallNoItemsFoundOptions.md#clear)
- [corner](DNoteSmallNoItemsFoundOptions.md#corner)
- [cursor](DNoteSmallNoItemsFoundOptions.md#cursor)
- [height](DNoteSmallNoItemsFoundOptions.md#height)
- [image](DNoteSmallNoItemsFoundOptions.md#image)
- [images](DNoteSmallNoItemsFoundOptions.md#images)
- [interactive](DNoteSmallNoItemsFoundOptions.md#interactive)
- [mask](DNoteSmallNoItemsFoundOptions.md#mask)
- [name](DNoteSmallNoItemsFoundOptions.md#name)
- [on](DNoteSmallNoItemsFoundOptions.md#on)
- [outline](DNoteSmallNoItemsFoundOptions.md#outline)
- [padding](DNoteSmallNoItemsFoundOptions.md#padding)
- [parent](DNoteSmallNoItemsFoundOptions.md#parent)
- [renderable](DNoteSmallNoItemsFoundOptions.md#renderable)
- [shadow](DNoteSmallNoItemsFoundOptions.md#shadow)
- [shortcut](DNoteSmallNoItemsFoundOptions.md#shortcut)
- [shortcuts](DNoteSmallNoItemsFoundOptions.md#shortcuts)
- [state](DNoteSmallNoItemsFoundOptions.md#state)
- [text](DNoteSmallNoItemsFoundOptions.md#text)
- [theme](DNoteSmallNoItemsFoundOptions.md#theme)
- [title](DNoteSmallNoItemsFoundOptions.md#title)
- [visible](DNoteSmallNoItemsFoundOptions.md#visible)
- [weight](DNoteSmallNoItemsFoundOptions.md#weight)
- [width](DNoteSmallNoItemsFoundOptions.md#width)
- [x](DNoteSmallNoItemsFoundOptions.md#x)
- [y](DNoteSmallNoItemsFoundOptions.md#y)
...
[DNoteSmallOptions](DNoteSmallOptions.md).[images](DNoteSmallOptions.md#images)
...
[DNoteSmallOptions](DNoteSmallOptions.md).[renderable](DNoteSmallOptions.md#renderable)
