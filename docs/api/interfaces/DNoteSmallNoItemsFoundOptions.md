[Winter Cardinal UI - v0.310.1](../index.md) / DNoteSmallNoItemsFoundOptions
...
A renderability.
Unlike [visible](DNoteSmallNoItemsFoundOptions.md#visible), non-renderable element occupies a space.
