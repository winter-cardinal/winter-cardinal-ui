[Winter Cardinal UI - v0.199.0](../index.md) / DSliderTrackVerticalOptions

# Interface: DSliderTrackVerticalOptions<VALUE, THEME\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeSliderTrackVertical`](DThemeSliderTrackVertical.md)<`VALUE`\> = [`DThemeSliderTrackVertical`](DThemeSliderTrackVertical.md)<`VALUE`\> |

## Hierarchy

- [`DSliderTrackOptions`](DSliderTrackOptions.md)<`VALUE`, `THEME`\>

  ↳ **`DSliderTrackVerticalOptions`**

## Table of contents

### Properties

- [background](DSliderTrackVerticalOptions.md#background)
- [border](DSliderTrackVerticalOptions.md#border)
- [children](DSliderTrackVerticalOptions.md#children)
- [clear](DSliderTrackVerticalOptions.md#clear)
- [corner](DSliderTrackVerticalOptions.md#corner)
- [cursor](DSliderTrackVerticalOptions.md#cursor)
- [group](DSliderTrackVerticalOptions.md#group)
- [height](DSliderTrackVerticalOptions.md#height)
- [image](DSliderTrackVerticalOptions.md#image)
- [interactive](DSliderTrackVerticalOptions.md#interactive)
- [mask](DSliderTrackVerticalOptions.md#mask)
- [name](DSliderTrackVerticalOptions.md#name)
- [on](DSliderTrackVerticalOptions.md#on)
- [outline](DSliderTrackVerticalOptions.md#outline)
- [padding](DSliderTrackVerticalOptions.md#padding)
- [parent](DSliderTrackVerticalOptions.md#parent)
- [shadow](DSliderTrackVerticalOptions.md#shadow)
- [shortcut](DSliderTrackVerticalOptions.md#shortcut)
- [shortcuts](DSliderTrackVerticalOptions.md#shortcuts)
- [state](DSliderTrackVerticalOptions.md#state)
- [text](DSliderTrackVerticalOptions.md#text)
- [theme](DSliderTrackVerticalOptions.md#theme)
- [title](DSliderTrackVerticalOptions.md#title)
- [toggle](DSliderTrackVerticalOptions.md#toggle)
- [visible](DSliderTrackVerticalOptions.md#visible)
- [weight](DSliderTrackVerticalOptions.md#weight)
- [when](DSliderTrackVerticalOptions.md#when)
- [width](DSliderTrackVerticalOptions.md#width)
- [x](DSliderTrackVerticalOptions.md#x)
- [y](DSliderTrackVerticalOptions.md#y)
