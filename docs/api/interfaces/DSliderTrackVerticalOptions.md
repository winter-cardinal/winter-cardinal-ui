[Winter Cardinal UI - v0.310.1](../index.md) / DSliderTrackVerticalOptions
...
A renderability.
Unlike [visible](DSliderTrackVerticalOptions.md#visible), non-renderable element occupies a space.
