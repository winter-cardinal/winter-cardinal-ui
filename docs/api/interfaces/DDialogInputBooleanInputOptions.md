[Winter Cardinal UI - v0.310.1](../index.md) / DDialogInputBooleanInputOptions
...
A renderability.
Unlike [visible](DDialogInputBooleanInputOptions.md#visible), non-renderable element occupies a space.
