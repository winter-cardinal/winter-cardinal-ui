[Winter Cardinal UI - v0.200.0](../index.md) / DThemeDialogInputInteger
...
- [getContent](DThemeDialogInputInteger.md#getcontent)
...
- [getFooter](DThemeDialogInputInteger.md#getfooter)
- [getGestureMode](DThemeDialogInputInteger.md#getgesturemode)
- [getHeader](DThemeDialogInputInteger.md#getheader)
- [getHeight](DThemeDialogInputInteger.md#getheight)
- [getInputMargin](DThemeDialogInputInteger.md#getinputmargin)
- [getInteractive](DThemeDialogInputInteger.md#getinteractive)
- [getLayout](DThemeDialogInputInteger.md#getlayout)
