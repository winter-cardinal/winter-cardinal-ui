[Winter Cardinal UI - v0.205.1](../index.md) / DDialogInputTextInputOptions

# Interface: DDialogInputTextInputOptions

## Hierarchy

- [`DInputTextOptions`](DInputTextOptions.md)

  ↳ **`DDialogInputTextInputOptions`**

## Table of contents

### Properties

- [after](DDialogInputTextInputOptions.md#after)
- [background](DDialogInputTextInputOptions.md#background)
- [before](DDialogInputTextInputOptions.md#before)
- [border](DDialogInputTextInputOptions.md#border)
- [children](DDialogInputTextInputOptions.md#children)
- [clear](DDialogInputTextInputOptions.md#clear)
- [clipper](DDialogInputTextInputOptions.md#clipper)
- [corner](DDialogInputTextInputOptions.md#corner)
- [cursor](DDialogInputTextInputOptions.md#cursor)
- [description](DDialogInputTextInputOptions.md#description)
- [editing](DDialogInputTextInputOptions.md#editing)
- [element](DDialogInputTextInputOptions.md#element)
- [height](DDialogInputTextInputOptions.md#height)
- [image](DDialogInputTextInputOptions.md#image)
- [interactive](DDialogInputTextInputOptions.md#interactive)
- [margin](DDialogInputTextInputOptions.md#margin)
- [mask](DDialogInputTextInputOptions.md#mask)
- [name](DDialogInputTextInputOptions.md#name)
- [on](DDialogInputTextInputOptions.md#on)
- [outline](DDialogInputTextInputOptions.md#outline)
- [padding](DDialogInputTextInputOptions.md#padding)
- [parent](DDialogInputTextInputOptions.md#parent)
- [select](DDialogInputTextInputOptions.md#select)
- [shadow](DDialogInputTextInputOptions.md#shadow)
- [shortcut](DDialogInputTextInputOptions.md#shortcut)
- [shortcuts](DDialogInputTextInputOptions.md#shortcuts)
- [state](DDialogInputTextInputOptions.md#state)
- [text](DDialogInputTextInputOptions.md#text)
- [theme](DDialogInputTextInputOptions.md#theme)
- [title](DDialogInputTextInputOptions.md#title)
- [visible](DDialogInputTextInputOptions.md#visible)
- [weight](DDialogInputTextInputOptions.md#weight)
- [when](DDialogInputTextInputOptions.md#when)
- [width](DDialogInputTextInputOptions.md#width)
- [x](DDialogInputTextInputOptions.md#x)
- [y](DDialogInputTextInputOptions.md#y)
...
[src/main/typescript/wcardinal/ui/d-dialog-input-text.ts:10](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input-text.ts#L10)
...
• `Optional` **theme**: `string` \| [`DThemeInputText`](DThemeInputText.md)
