[Winter Cardinal UI - v0.407.0](../index.md) / DThemeTableBodyCellSelectDialog

# Interface: DThemeTableBodyCellSelectDialog\<VALUE\>
...
- [`DThemeButton`](DThemeButton.md)\<`VALUE` \| ``null``\>
  ...
  ↳↳ [`DThemeTableBodyCellActionDialog`](DThemeTableBodyCellActionDialog.md)
...
- [getAlpha](DThemeTableBodyCellSelectDialog.md#getalpha)
- [getBackgroundAlpha](DThemeTableBodyCellSelectDialog.md#getbackgroundalpha)
- [getBackgroundColor](DThemeTableBodyCellSelectDialog.md#getbackgroundcolor)
- [getBackgroundTexture](DThemeTableBodyCellSelectDialog.md#getbackgroundtexture)
- [getBorderAlign](DThemeTableBodyCellSelectDialog.md#getborderalign)
- [getBorderAlpha](DThemeTableBodyCellSelectDialog.md#getborderalpha)
- [getBorderColor](DThemeTableBodyCellSelectDialog.md#getbordercolor)
- [getBorderMask](DThemeTableBodyCellSelectDialog.md#getbordermask)
- [getBorderTexture](DThemeTableBodyCellSelectDialog.md#getbordertexture)
- [getBorderWidth](DThemeTableBodyCellSelectDialog.md#getborderwidth)
- [getClearType](DThemeTableBodyCellSelectDialog.md#getcleartype)
- [getColor](DThemeTableBodyCellSelectDialog.md#getcolor)
- [getCornerMask](DThemeTableBodyCellSelectDialog.md#getcornermask)
- [getCornerRadius](DThemeTableBodyCellSelectDialog.md#getcornerradius)
- [getCursor](DThemeTableBodyCellSelectDialog.md#getcursor)
- [getFontFamilly](DThemeTableBodyCellSelectDialog.md#getfontfamilly)
- [getFontSize](DThemeTableBodyCellSelectDialog.md#getfontsize)
- [getFontStyle](DThemeTableBodyCellSelectDialog.md#getfontstyle)
- [getFontVariant](DThemeTableBodyCellSelectDialog.md#getfontvariant)
- [getFontWeight](DThemeTableBodyCellSelectDialog.md#getfontweight)
- [getHeight](DThemeTableBodyCellSelectDialog.md#getheight)
- [getImageAlignHorizontal](DThemeTableBodyCellSelectDialog.md#getimagealignhorizontal)
- [getImageAlignVertical](DThemeTableBodyCellSelectDialog.md#getimagealignvertical)
- [getImageAlignWith](DThemeTableBodyCellSelectDialog.md#getimagealignwith)
- [getImageMarginHorizontal](DThemeTableBodyCellSelectDialog.md#getimagemarginhorizontal)
- [getImageMarginVertial](DThemeTableBodyCellSelectDialog.md#getimagemarginvertial)
- [getImageRotation](DThemeTableBodyCellSelectDialog.md#getimagerotation)
- [getImageSource](DThemeTableBodyCellSelectDialog.md#getimagesource)
- [getImageTintAlpha](DThemeTableBodyCellSelectDialog.md#getimagetintalpha)
- [getImageTintColor](DThemeTableBodyCellSelectDialog.md#getimagetintcolor)
- [getInteractive](DThemeTableBodyCellSelectDialog.md#getinteractive)
- [getLineHeight](DThemeTableBodyCellSelectDialog.md#getlineheight)
- [getOutlineAlign](DThemeTableBodyCellSelectDialog.md#getoutlinealign)
- [getOutlineAlpha](DThemeTableBodyCellSelectDialog.md#getoutlinealpha)
- [getOutlineColor](DThemeTableBodyCellSelectDialog.md#getoutlinecolor)
- [getOutlineMask](DThemeTableBodyCellSelectDialog.md#getoutlinemask)
- [getOutlineOffset](DThemeTableBodyCellSelectDialog.md#getoutlineoffset)
- [getOutlineWidth](DThemeTableBodyCellSelectDialog.md#getoutlinewidth)
- [getPaddingBottom](DThemeTableBodyCellSelectDialog.md#getpaddingbottom)
- [getPaddingLeft](DThemeTableBodyCellSelectDialog.md#getpaddingleft)
- [getPaddingRight](DThemeTableBodyCellSelectDialog.md#getpaddingright)
- [getPaddingTop](DThemeTableBodyCellSelectDialog.md#getpaddingtop)
- [getSecondaryImageAlignHorizontal](DThemeTableBodyCellSelectDialog.md#getsecondaryimagealignhorizontal)
- [getSecondaryImageAlignVertical](DThemeTableBodyCellSelectDialog.md#getsecondaryimagealignvertical)
- [getSecondaryImageAlignWith](DThemeTableBodyCellSelectDialog.md#getsecondaryimagealignwith)
- [getSecondaryImageMarginHorizontal](DThemeTableBodyCellSelectDialog.md#getsecondaryimagemarginhorizontal)
- [getSecondaryImageMarginVertial](DThemeTableBodyCellSelectDialog.md#getsecondaryimagemarginvertial)
- [getSecondaryImageRotation](DThemeTableBodyCellSelectDialog.md#getsecondaryimagerotation)
- [getSecondaryImageSource](DThemeTableBodyCellSelectDialog.md#getsecondaryimagesource)
- [getSecondaryImageTintAlpha](DThemeTableBodyCellSelectDialog.md#getsecondaryimagetintalpha)
- [getSecondaryImageTintColor](DThemeTableBodyCellSelectDialog.md#getsecondaryimagetintcolor)
- [getShadow](DThemeTableBodyCellSelectDialog.md#getshadow)
- [getTertiaryImageAlignHorizontal](DThemeTableBodyCellSelectDialog.md#gettertiaryimagealignhorizontal)
- [getTertiaryImageAlignVertical](DThemeTableBodyCellSelectDialog.md#gettertiaryimagealignvertical)
- [getTertiaryImageAlignWith](DThemeTableBodyCellSelectDialog.md#gettertiaryimagealignwith)
- [getTertiaryImageMarginHorizontal](DThemeTableBodyCellSelectDialog.md#gettertiaryimagemarginhorizontal)
- [getTertiaryImageMarginVertial](DThemeTableBodyCellSelectDialog.md#gettertiaryimagemarginvertial)
- [getTertiaryImageRotation](DThemeTableBodyCellSelectDialog.md#gettertiaryimagerotation)
- [getTertiaryImageSource](DThemeTableBodyCellSelectDialog.md#gettertiaryimagesource)
- [getTertiaryImageTintAlpha](DThemeTableBodyCellSelectDialog.md#gettertiaryimagetintalpha)
- [getTertiaryImageTintColor](DThemeTableBodyCellSelectDialog.md#gettertiaryimagetintcolor)
- [getTextAlignHorizontal](DThemeTableBodyCellSelectDialog.md#gettextalignhorizontal)
- [getTextAlignVertical](DThemeTableBodyCellSelectDialog.md#gettextalignvertical)
- [getTextFormatter](DThemeTableBodyCellSelectDialog.md#gettextformatter)
- [getTextStyleClipping](DThemeTableBodyCellSelectDialog.md#gettextstyleclipping)
- [getTextStyleFitting](DThemeTableBodyCellSelectDialog.md#gettextstylefitting)
- [getTextStyleWordWrap](DThemeTableBodyCellSelectDialog.md#gettextstylewordwrap)
- [getTextValue](DThemeTableBodyCellSelectDialog.md#gettextvalue)
- [getTitle](DThemeTableBodyCellSelectDialog.md#gettitle)
- [getWeight](DThemeTableBodyCellSelectDialog.md#getweight)
- [getWhen](DThemeTableBodyCellSelectDialog.md#getwhen)
- [getWidth](DThemeTableBodyCellSelectDialog.md#getwidth)
- [getX](DThemeTableBodyCellSelectDialog.md#getx)
- [getY](DThemeTableBodyCellSelectDialog.md#gety)
- [isOverflowMaskEnabled](DThemeTableBodyCellSelectDialog.md#isoverflowmaskenabled)
- [isSyncEnabled](DThemeTableBodyCellSelectDialog.md#issyncenabled)
- [isToggle](DThemeTableBodyCellSelectDialog.md#istoggle)
- [newShadow](DThemeTableBodyCellSelectDialog.md#newshadow)
- [newShadowWeak](DThemeTableBodyCellSelectDialog.md#newshadowweak)
- [newState](DThemeTableBodyCellSelectDialog.md#newstate)
- [newTextValue](DThemeTableBodyCellSelectDialog.md#newtextvalue)
