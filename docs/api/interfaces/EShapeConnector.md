[Winter Cardinal UI - v0.407.0](../index.md) / EShapeConnector
...
[src/main/typescript/wcardinal/ui/shape/e-shape-connector.ts:10](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/shape/e-shape-connector.ts#L10)
...
[src/main/typescript/wcardinal/ui/shape/e-shape.ts:41](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/shape/e-shape.ts#L41)
...
▸ **detach**(`exceptions?`): [`EShapeConnector`](EShapeConnector.md)
...
▸ **lock**(`part`): [`EShapeConnector`](EShapeConnector.md)
...
▸ **unlock**(`part`, `invoke`): [`EShapeConnector`](EShapeConnector.md)
