[Winter Cardinal UI - v0.205.1](../index.md) / DDialogInputIntegerInputOptions

# Interface: DDialogInputIntegerInputOptions
...
- [after](DDialogInputIntegerInputOptions.md#after)
- [background](DDialogInputIntegerInputOptions.md#background)
- [before](DDialogInputIntegerInputOptions.md#before)
- [border](DDialogInputIntegerInputOptions.md#border)
- [children](DDialogInputIntegerInputOptions.md#children)
- [clear](DDialogInputIntegerInputOptions.md#clear)
- [clipper](DDialogInputIntegerInputOptions.md#clipper)
- [corner](DDialogInputIntegerInputOptions.md#corner)
- [cursor](DDialogInputIntegerInputOptions.md#cursor)
- [description](DDialogInputIntegerInputOptions.md#description)
- [editing](DDialogInputIntegerInputOptions.md#editing)
- [element](DDialogInputIntegerInputOptions.md#element)
- [height](DDialogInputIntegerInputOptions.md#height)
- [image](DDialogInputIntegerInputOptions.md#image)
- [interactive](DDialogInputIntegerInputOptions.md#interactive)
- [margin](DDialogInputIntegerInputOptions.md#margin)
- [mask](DDialogInputIntegerInputOptions.md#mask)
- [max](DDialogInputIntegerInputOptions.md#max)
- [min](DDialogInputIntegerInputOptions.md#min)
- [name](DDialogInputIntegerInputOptions.md#name)
- [on](DDialogInputIntegerInputOptions.md#on)
- [outline](DDialogInputIntegerInputOptions.md#outline)
- [padding](DDialogInputIntegerInputOptions.md#padding)
- [parent](DDialogInputIntegerInputOptions.md#parent)
- [select](DDialogInputIntegerInputOptions.md#select)
- [shadow](DDialogInputIntegerInputOptions.md#shadow)
- [shortcut](DDialogInputIntegerInputOptions.md#shortcut)
- [shortcuts](DDialogInputIntegerInputOptions.md#shortcuts)
- [state](DDialogInputIntegerInputOptions.md#state)
- [step](DDialogInputIntegerInputOptions.md#step)
- [text](DDialogInputIntegerInputOptions.md#text)
- [theme](DDialogInputIntegerInputOptions.md#theme)
- [title](DDialogInputIntegerInputOptions.md#title)
- [visible](DDialogInputIntegerInputOptions.md#visible)
- [weight](DDialogInputIntegerInputOptions.md#weight)
- [when](DDialogInputIntegerInputOptions.md#when)
- [width](DDialogInputIntegerInputOptions.md#width)
- [x](DDialogInputIntegerInputOptions.md#x)
- [y](DDialogInputIntegerInputOptions.md#y)
...
[src/main/typescript/wcardinal/ui/util/util-input.ts:37](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/util/util-input.ts#L37)
...
[DInputIntegerOptions](DInputIntegerOptions.md).[editing](DInputIntegerOptions.md#editing)

#### Defined in

[src/main/typescript/wcardinal/ui/util/util-input.ts:38](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/util/util-input.ts#L38)
...
[src/main/typescript/wcardinal/ui/d-dialog-input-integer.ts:10](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-dialog-input-integer.ts#L10)
...
[src/main/typescript/wcardinal/ui/util/util-input-number.ts:21](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/util/util-input-number.ts#L21)
...
[DInputIntegerOptions](DInputIntegerOptions.md).[min](DInputIntegerOptions.md#min)

#### Defined in

[src/main/typescript/wcardinal/ui/util/util-input-number.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/util/util-input-number.ts#L20)
...
[src/main/typescript/wcardinal/ui/util/util-input-number.ts:19](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/util/util-input-number.ts#L19)
...
• `Optional` **theme**: `string` \| [`DThemeInputInteger`](DThemeInputInteger.md)
