[Winter Cardinal UI - v0.407.0](../index.md) / DTableBodyCellSelectPromiseOptions
...
- [images](DTableBodyCellSelectPromiseOptions.md#images)
...
- [renderable](DTableBodyCellSelectPromiseOptions.md#renderable)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-select-promise.ts:21](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-table-body-cell-select-promise.ts#L21)
