[Winter Cardinal UI - v0.160.0](../index.md) / DTableBodyCell
...
- [background](DTableBodyCell.md#background)
...
- [toDirty](DTableBodyCell.md#todirty)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell.ts:44](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-table-body-cell.ts#L44)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell.ts:39](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-table-body-cell.ts#L39)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell.ts:26](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-table-body-cell.ts#L26)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell.ts:34](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-table-body-cell.ts#L34)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DTableBodyCell`](DTableBodyCell.md)<`ROW`, `VALUE`\>
...
[`DTableBodyCell`](DTableBodyCell.md)<`ROW`, `VALUE`\>
...
▸ **blur**(`recursively?`): [`DTableBodyCell`](DTableBodyCell.md)<`ROW`, `VALUE`\>
...
▸ **focus**(): [`DTableBodyCell`](DTableBodyCell.md)<`ROW`, `VALUE`\>
...
▸ **hide**(): [`DTableBodyCell`](DTableBodyCell.md)<`ROW`, `VALUE`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DTableBodyCell`](DTableBodyCell.md)<`ROW`, `VALUE`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DTableBodyCell`](DTableBodyCell.md)<`ROW`, `VALUE`\>
...
▸ `Optional` **onRowSelect**(`e`, `local`): `boolean`
...
[src/main/typescript/wcardinal/ui/d-table-body-cell.ts:65](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-table-body-cell.ts#L65)
...
▸ **once**(`event`, `fn`, `context?`): [`DTableBodyCell`](DTableBodyCell.md)<`ROW`, `VALUE`\>
...
▸ **removeAllListeners**(`event?`): [`DTableBodyCell`](DTableBodyCell.md)<`ROW`, `VALUE`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DTableBodyCell`](DTableBodyCell.md)<`ROW`, `VALUE`\>
...
[src/main/typescript/wcardinal/ui/d-table-body-cell.ts:46](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-table-body-cell.ts#L46)
...
▸ `Protected` **setFocused**(`isFocused`): [`DTableBodyCell`](DTableBodyCell.md)<`ROW`, `VALUE`\>
...
▸ **show**(): [`DTableBodyCell`](DTableBodyCell.md)<`ROW`, `VALUE`\>
...
[src/main/typescript/wcardinal/ui/d-table-body-cell.ts:54](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-table-body-cell.ts#L54)
