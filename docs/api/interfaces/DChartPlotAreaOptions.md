[Winter Cardinal UI - v0.442.0](../index.md) / DChartPlotAreaOptions
...
- [`DBaseOptions`](DBaseOptions.md)\<`THEME`\>
  ...
  ↳↳ [`DChartPlotAreaSingleOptions`](DChartPlotAreaSingleOptions.md)

  ↳↳ [`DChartPlotAreaTwofoldOptions`](DChartPlotAreaTwofoldOptions.md)
