[Winter Cardinal UI - v0.160.0](../index.md) / DDialogOptions
...
- [`DBaseOptions`](DBaseOptions.md)<`THEME`\>
  ...
  ↳↳ [`DDialogCommandOptions`](DDialogCommandOptions.md)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:67](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L67)
