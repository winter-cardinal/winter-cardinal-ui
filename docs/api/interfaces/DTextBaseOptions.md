[Winter Cardinal UI - v0.414.0](../index.md) / DTextBaseOptions
...
- [`DBaseOptions`](DBaseOptions.md)\<`THEME`, `EMITTER`\>
  ...
  ↳↳ [`DImageBaseOptions`](DImageBaseOptions.md)

  ↳↳ [`DSliderLabelOptions`](DSliderLabelOptions.md)

  ↳↳ [`DSliderValueOptions`](DSliderValueOptions.md)

  ↳↳ [`DTextOptions`](DTextOptions.md)

## Table of contents

### Properties

- [background](DTextBaseOptions.md#background)
- [border](DTextBaseOptions.md#border)
- [children](DTextBaseOptions.md#children)
- [clear](DTextBaseOptions.md#clear)
- [corner](DTextBaseOptions.md#corner)
- [cursor](DTextBaseOptions.md#cursor)
- [height](DTextBaseOptions.md#height)
- [interactive](DTextBaseOptions.md#interactive)
- [mask](DTextBaseOptions.md#mask)
- [name](DTextBaseOptions.md#name)
- [on](DTextBaseOptions.md#on)
- [outline](DTextBaseOptions.md#outline)
- [padding](DTextBaseOptions.md#padding)
- [parent](DTextBaseOptions.md#parent)
- [renderable](DTextBaseOptions.md#renderable)
- [shadow](DTextBaseOptions.md#shadow)
- [shortcut](DTextBaseOptions.md#shortcut)
- [shortcuts](DTextBaseOptions.md#shortcuts)
- [state](DTextBaseOptions.md#state)
- [text](DTextBaseOptions.md#text)
- [theme](DTextBaseOptions.md#theme)
- [title](DTextBaseOptions.md#title)
- [visible](DTextBaseOptions.md#visible)
- [weight](DTextBaseOptions.md#weight)
- [width](DTextBaseOptions.md#width)
- [x](DTextBaseOptions.md#x)
- [y](DTextBaseOptions.md#y)
