[Winter Cardinal UI - v0.205.1](../index.md) / DPickerDatetimeButtonDateOptions

# Interface: DPickerDatetimeButtonDateOptions<VALUE, THEME\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemePickerDatetimeButtonDate`](DThemePickerDatetimeButtonDate.md)<`VALUE`\> = [`DThemePickerDatetimeButtonDate`](DThemePickerDatetimeButtonDate.md)<`VALUE`\> |

## Hierarchy

- [`DButtonAmbientOptions`](DButtonAmbientOptions.md)<`VALUE`, `THEME`\>

  ↳ **`DPickerDatetimeButtonDateOptions`**

## Table of contents

### Properties

- [background](DPickerDatetimeButtonDateOptions.md#background)
- [border](DPickerDatetimeButtonDateOptions.md#border)
- [children](DPickerDatetimeButtonDateOptions.md#children)
- [clear](DPickerDatetimeButtonDateOptions.md#clear)
- [corner](DPickerDatetimeButtonDateOptions.md#corner)
- [cursor](DPickerDatetimeButtonDateOptions.md#cursor)
- [group](DPickerDatetimeButtonDateOptions.md#group)
- [height](DPickerDatetimeButtonDateOptions.md#height)
- [image](DPickerDatetimeButtonDateOptions.md#image)
- [interactive](DPickerDatetimeButtonDateOptions.md#interactive)
- [mask](DPickerDatetimeButtonDateOptions.md#mask)
- [name](DPickerDatetimeButtonDateOptions.md#name)
- [on](DPickerDatetimeButtonDateOptions.md#on)
- [outline](DPickerDatetimeButtonDateOptions.md#outline)
- [padding](DPickerDatetimeButtonDateOptions.md#padding)
- [parent](DPickerDatetimeButtonDateOptions.md#parent)
- [shadow](DPickerDatetimeButtonDateOptions.md#shadow)
- [shortcut](DPickerDatetimeButtonDateOptions.md#shortcut)
- [shortcuts](DPickerDatetimeButtonDateOptions.md#shortcuts)
- [state](DPickerDatetimeButtonDateOptions.md#state)
- [text](DPickerDatetimeButtonDateOptions.md#text)
- [theme](DPickerDatetimeButtonDateOptions.md#theme)
- [title](DPickerDatetimeButtonDateOptions.md#title)
- [toggle](DPickerDatetimeButtonDateOptions.md#toggle)
- [visible](DPickerDatetimeButtonDateOptions.md#visible)
- [weight](DPickerDatetimeButtonDateOptions.md#weight)
- [when](DPickerDatetimeButtonDateOptions.md#when)
- [width](DPickerDatetimeButtonDateOptions.md#width)
- [x](DPickerDatetimeButtonDateOptions.md#x)
- [y](DPickerDatetimeButtonDateOptions.md#y)
