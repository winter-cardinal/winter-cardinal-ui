[Winter Cardinal UI - v0.200.0](../index.md) / DThemeDialogInputBoolean
...
- [getContent](DThemeDialogInputBoolean.md#getcontent)
...
- [getFooter](DThemeDialogInputBoolean.md#getfooter)
- [getGestureMode](DThemeDialogInputBoolean.md#getgesturemode)
- [getHeader](DThemeDialogInputBoolean.md#getheader)
- [getHeight](DThemeDialogInputBoolean.md#getheight)
- [getInputMargin](DThemeDialogInputBoolean.md#getinputmargin)
- [getInteractive](DThemeDialogInputBoolean.md#getinteractive)
- [getLayout](DThemeDialogInputBoolean.md#getlayout)
