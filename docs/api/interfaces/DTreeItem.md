[Winter Cardinal UI - v0.160.0](../index.md) / DTreeItem

# Interface: DTreeItem<NODE\>
...
- [\_accessibleActive](DTreeItem.md#_accessibleactive)
- [\_accessibleDiv](DTreeItem.md#_accessiblediv)
- [\_auto](DTreeItem.md#_auto)
- [\_background](DTreeItem.md#_background)
- [\_border](DTreeItem.md#_border)
- [\_bounds](DTreeItem.md#_bounds)
- [\_clearType](DTreeItem.md#_cleartype)
- [\_corner](DTreeItem.md#_corner)
- [\_cursor](DTreeItem.md#_cursor)
- [\_destroyed](DTreeItem.md#_destroyed)
- [\_lastDownPoint](DTreeItem.md#_lastdownpoint)
- [\_lastSortedIndex](DTreeItem.md#_lastsortedindex)
- [\_mask](DTreeItem.md#_mask)
- [\_options](DTreeItem.md#_options)
- [\_outline](DTreeItem.md#_outline)
- [\_padding](DTreeItem.md#_padding)
- [\_reflowable](DTreeItem.md#_reflowable)
- [\_shortcuts](DTreeItem.md#_shortcuts)
- [\_snippet](DTreeItem.md#_snippet)
- [\_tempDisplayObjectParent](DTreeItem.md#_tempdisplayobjectparent)
- [\_title](DTreeItem.md#_title)
- [\_zIndex](DTreeItem.md#_zindex)
- [accessible](DTreeItem.md#accessible)
- [accessibleChildren](DTreeItem.md#accessiblechildren)
- [accessibleHint](DTreeItem.md#accessiblehint)
- [accessiblePointerEvents](DTreeItem.md#accessiblepointerevents)
- [accessibleTitle](DTreeItem.md#accessibletitle)
- [accessibleType](DTreeItem.md#accessibletype)
- [alpha](DTreeItem.md#alpha)
- [angle](DTreeItem.md#angle)
- [buttonMode](DTreeItem.md#buttonmode)
- [cacheAsBitmap](DTreeItem.md#cacheasbitmap)
- [children](DTreeItem.md#children)
- [cursor](DTreeItem.md#cursor)
- [filterArea](DTreeItem.md#filterarea)
- [filters](DTreeItem.md#filters)
- [hitArea](DTreeItem.md#hitarea)
- [index](DTreeItem.md#index)
- [interactive](DTreeItem.md#interactive)
- [interactiveChildren](DTreeItem.md#interactivechildren)
- [isMask](DTreeItem.md#ismask)
- [isSprite](DTreeItem.md#issprite)
- [localTransform](DTreeItem.md#localtransform)
- [mask](DTreeItem.md#mask)
- [name](DTreeItem.md#name)
- [node](DTreeItem.md#node)
- [parent](DTreeItem.md#parent)
- [pivot](DTreeItem.md#pivot)
- [renderable](DTreeItem.md#renderable)
- [rotation](DTreeItem.md#rotation)
- [sortDirty](DTreeItem.md#sortdirty)
- [sortableChildren](DTreeItem.md#sortablechildren)
- [transform](DTreeItem.md#transform)
- [value](DTreeItem.md#value)
- [visible](DTreeItem.md#visible)
- [worldAlpha](DTreeItem.md#worldalpha)
- [worldTransform](DTreeItem.md#worldtransform)
- [worldVisible](DTreeItem.md#worldvisible)
- [zIndex](DTreeItem.md#zindex)

### Accessors

- [background](DTreeItem.md#background)
- [border](DTreeItem.md#border)
- [corner](DTreeItem.md#corner)
- [height](DTreeItem.md#height)
- [outline](DTreeItem.md#outline)
- [padding](DTreeItem.md#padding)
- [position](DTreeItem.md#position)
- [reflowable](DTreeItem.md#reflowable)
- [scale](DTreeItem.md#scale)
- [shadow](DTreeItem.md#shadow)
- [skew](DTreeItem.md#skew)
- [snippet](DTreeItem.md#snippet)
- [state](DTreeItem.md#state)
- [theme](DTreeItem.md#theme)
- [title](DTreeItem.md#title)
- [type](DTreeItem.md#type)
- [unsafe](DTreeItem.md#unsafe)
- [weight](DTreeItem.md#weight)
- [width](DTreeItem.md#width)
- [x](DTreeItem.md#x)
- [y](DTreeItem.md#y)

### Methods

- [\_calculateBounds](DTreeItem.md#_calculatebounds)
- [\_recursivePostUpdateTransform](DTreeItem.md#_recursivepostupdatetransform)
- [\_render](DTreeItem.md#_render)
- [addChild](DTreeItem.md#addchild)
- [addChildAt](DTreeItem.md#addchildat)
- [addListener](DTreeItem.md#addlistener)
- [applyTitle](DTreeItem.md#applytitle)
- [blur](DTreeItem.md#blur)
- [calculateBounds](DTreeItem.md#calculatebounds)
- [containsGlobalPoint](DTreeItem.md#containsglobalpoint)
- [containsLocalPoint](DTreeItem.md#containslocalpoint)
- [containsPoint](DTreeItem.md#containspoint)
- [destroy](DTreeItem.md#destroy)
- [displayObjectUpdateTransform](DTreeItem.md#displayobjectupdatetransform)
- [emit](DTreeItem.md#emit)
- [eventNames](DTreeItem.md#eventnames)
- [focus](DTreeItem.md#focus)
- [focusOnClosest](DTreeItem.md#focusonclosest)
- [getBounds](DTreeItem.md#getbounds)
- [getChildAt](DTreeItem.md#getchildat)
- [getChildByName](DTreeItem.md#getchildbyname)
- [getChildIndex](DTreeItem.md#getchildindex)
- [getClearType](DTreeItem.md#getcleartype)
- [getClippingRect](DTreeItem.md#getclippingrect)
- [getGlobalPosition](DTreeItem.md#getglobalposition)
- [getHeight](DTreeItem.md#getheight)
- [getLocalBounds](DTreeItem.md#getlocalbounds)
- [getParentOfSize](DTreeItem.md#getparentofsize)
- [getThemeDefault](DTreeItem.md#getthemedefault)
- [getType](DTreeItem.md#gettype)
- [getWidth](DTreeItem.md#getwidth)
- [getX](DTreeItem.md#getx)
- [getY](DTreeItem.md#gety)
- [hasDirty](DTreeItem.md#hasdirty)
- [hasRefitableHeight](DTreeItem.md#hasrefitableheight)
- [hasRefitableWidth](DTreeItem.md#hasrefitablewidth)
- [hide](DTreeItem.md#hide)
- [init](DTreeItem.md#init)
- [initReflowable](DTreeItem.md#initreflowable)
- [isDirty](DTreeItem.md#isdirty)
- [isEventTarget](DTreeItem.md#iseventtarget)
- [isHidden](DTreeItem.md#ishidden)
- [isHierarchyDirty](DTreeItem.md#ishierarchydirty)
- [isRefitable](DTreeItem.md#isrefitable)
- [isShown](DTreeItem.md#isshown)
- [listenerCount](DTreeItem.md#listenercount)
- [listeners](DTreeItem.md#listeners)
- [off](DTreeItem.md#off)
- [on](DTreeItem.md#on)
- [onBlur](DTreeItem.md#onblur)
- [onChildBlur](DTreeItem.md#onchildblur)
- [onChildFocus](DTreeItem.md#onchildfocus)
- [onChildrenChange](DTreeItem.md#onchildrenchange)
- [onDblClick](DTreeItem.md#ondblclick)
- [onDown](DTreeItem.md#ondown)
- [onDownThis](DTreeItem.md#ondownthis)
- [onFocus](DTreeItem.md#onfocus)
- [onHierarchyDirty](DTreeItem.md#onhierarchydirty)
- [onKeyDown](DTreeItem.md#onkeydown)
- [onKeyUp](DTreeItem.md#onkeyup)
- [onMove](DTreeItem.md#onmove)
- [onOut](DTreeItem.md#onout)
- [onOver](DTreeItem.md#onover)
- [onParentMove](DTreeItem.md#onparentmove)
- [onParentResize](DTreeItem.md#onparentresize)
- [onRefit](DTreeItem.md#onrefit)
- [onReflow](DTreeItem.md#onreflow)
- [onResize](DTreeItem.md#onresize)
- [onScale](DTreeItem.md#onscale)
- [onShortcut](DTreeItem.md#onshortcut)
- [onSkew](DTreeItem.md#onskew)
- [onStateChange](DTreeItem.md#onstatechange)
- [onUp](DTreeItem.md#onup)
- [onUpThis](DTreeItem.md#onupthis)
- [onWheel](DTreeItem.md#onwheel)
- [once](DTreeItem.md#once)
- [reflow](DTreeItem.md#reflow)
- [removeAllListeners](DTreeItem.md#removealllisteners)
- [removeChild](DTreeItem.md#removechild)
- [removeChildAt](DTreeItem.md#removechildat)
- [removeChildren](DTreeItem.md#removechildren)
- [removeListener](DTreeItem.md#removelistener)
- [render](DTreeItem.md#render)
- [renderAdvanced](DTreeItem.md#renderadvanced)
- [resize](DTreeItem.md#resize)
- [set](DTreeItem.md#set)
- [setChildIndex](DTreeItem.md#setchildindex)
- [setFocused](DTreeItem.md#setfocused)
- [setHeight](DTreeItem.md#setheight)
- [setParent](DTreeItem.md#setparent)
- [setTransform](DTreeItem.md#settransform)
- [setWidth](DTreeItem.md#setwidth)
- [setX](DTreeItem.md#setx)
- [setY](DTreeItem.md#sety)
- [show](DTreeItem.md#show)
- [sortChildren](DTreeItem.md#sortchildren)
- [swapChildren](DTreeItem.md#swapchildren)
- [toCursor](DTreeItem.md#tocursor)
- [toDirty](DTreeItem.md#todirty)
- [toGlobal](DTreeItem.md#toglobal)
- [toHasDirty](DTreeItem.md#tohasdirty)
- [toHierarchyDirty](DTreeItem.md#tohierarchydirty)
- [toLocal](DTreeItem.md#tolocal)
- [toParentHasDirty](DTreeItem.md#toparenthasdirty)
- [toParentHierarchyDirty](DTreeItem.md#toparenthierarchydirty)
- [toParentResized](DTreeItem.md#toparentresized)
- [unset](DTreeItem.md#unset)
- [updateTransform](DTreeItem.md#updatetransform)
...
[src/main/typescript/wcardinal/ui/d-tree-item.ts:12](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-tree-item.ts#L12)
...
• `Optional` `Readonly` **node**: `NODE`

#### Defined in

[src/main/typescript/wcardinal/ui/d-tree-item.ts:10](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-tree-item.ts#L10)
...
• `Optional` `Readonly` **value**: `NODE`

#### Defined in

[src/main/typescript/wcardinal/ui/d-tree-item.ts:11](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-tree-item.ts#L11)
...
▸ **addListener**(`event`, `fn`, `context?`): [`DTreeItem`](DTreeItem.md)<`NODE`\>
...
▸ **blur**(`recursively?`): [`DTreeItem`](DTreeItem.md)<`NODE`\>
...
▸ **focus**(): [`DTreeItem`](DTreeItem.md)<`NODE`\>
...
▸ **hide**(): [`DTreeItem`](DTreeItem.md)<`NODE`\>
...
▸ **off**(`event`, `fn?`, `context?`): [`DTreeItem`](DTreeItem.md)<`NODE`\>
...
▸ **on**(`event`, `fn`, `context?`): [`DTreeItem`](DTreeItem.md)<`NODE`\>
...
▸ **once**(`event`, `fn`, `context?`): [`DTreeItem`](DTreeItem.md)<`NODE`\>
...
▸ **removeAllListeners**(`event?`): [`DTreeItem`](DTreeItem.md)<`NODE`\>
...
▸ **removeListener**(`event`, `fn?`, `context?`): [`DTreeItem`](DTreeItem.md)<`NODE`\>
...
[src/main/typescript/wcardinal/ui/d-tree-item.ts:14](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-tree-item.ts#L14)
...
▸ `Protected` **setFocused**(`isFocused`): [`DTreeItem`](DTreeItem.md)<`NODE`\>
...
▸ **show**(): [`DTreeItem`](DTreeItem.md)<`NODE`\>
...
[src/main/typescript/wcardinal/ui/d-tree-item.ts:15](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-tree-item.ts#L15)
