[Winter Cardinal UI - v0.407.0](../index.md) / DTreeItem
...
- [\_boundsID](DTreeItem.md#_boundsid)
- [\_boundsRect](DTreeItem.md#_boundsrect)
...
- [\_enabledFilters](DTreeItem.md#_enabledfilters)
- [\_lastDownPoint](DTreeItem.md#_lastdownpoint)
- [\_lastSortedIndex](DTreeItem.md#_lastsortedindex)
- [\_localBounds](DTreeItem.md#_localbounds)
- [\_localBoundsRect](DTreeItem.md#_localboundsrect)
...
- [containerUpdateTransform](DTreeItem.md#containerupdatetransform)
...
- [disableTempParent](DTreeItem.md#disabletempparent)
- [displayObjectUpdateTransform](DTreeItem.md#displayobjectupdatetransform)
- [emit](DTreeItem.md#emit)
- [enableTempParent](DTreeItem.md#enabletempparent)
...
- [newPadding](DTreeItem.md#newpadding)
...
[src/main/typescript/wcardinal/ui/d-tree-item.ts:12](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-tree-item.ts#L12)
...
[src/main/typescript/wcardinal/ui/d-tree-item.ts:10](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-tree-item.ts#L10)
...
[src/main/typescript/wcardinal/ui/d-tree-item.ts:11](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-tree-item.ts#L11)
...
[src/main/typescript/wcardinal/ui/d-tree-item.ts:14](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-tree-item.ts#L14)
...
▸ **setFocused**(`isFocused`): [`DTreeItem`](DTreeItem.md)\<`NODE`\>
...
[src/main/typescript/wcardinal/ui/d-tree-item.ts:15](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-tree-item.ts#L15)
