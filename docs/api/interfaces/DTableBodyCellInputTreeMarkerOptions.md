[Winter Cardinal UI - v0.205.1](../index.md) / DTableBodyCellInputTreeMarkerOptions
...
- [background](DTableBodyCellInputTreeMarkerOptions.md#background)
- [border](DTableBodyCellInputTreeMarkerOptions.md#border)
- [children](DTableBodyCellInputTreeMarkerOptions.md#children)
- [clear](DTableBodyCellInputTreeMarkerOptions.md#clear)
- [corner](DTableBodyCellInputTreeMarkerOptions.md#corner)
- [cursor](DTableBodyCellInputTreeMarkerOptions.md#cursor)
- [group](DTableBodyCellInputTreeMarkerOptions.md#group)
- [height](DTableBodyCellInputTreeMarkerOptions.md#height)
- [image](DTableBodyCellInputTreeMarkerOptions.md#image)
- [interactive](DTableBodyCellInputTreeMarkerOptions.md#interactive)
- [mask](DTableBodyCellInputTreeMarkerOptions.md#mask)
- [name](DTableBodyCellInputTreeMarkerOptions.md#name)
- [on](DTableBodyCellInputTreeMarkerOptions.md#on)
- [outline](DTableBodyCellInputTreeMarkerOptions.md#outline)
- [padding](DTableBodyCellInputTreeMarkerOptions.md#padding)
- [parent](DTableBodyCellInputTreeMarkerOptions.md#parent)
- [shadow](DTableBodyCellInputTreeMarkerOptions.md#shadow)
- [shortcut](DTableBodyCellInputTreeMarkerOptions.md#shortcut)
- [shortcuts](DTableBodyCellInputTreeMarkerOptions.md#shortcuts)
- [state](DTableBodyCellInputTreeMarkerOptions.md#state)
- [text](DTableBodyCellInputTreeMarkerOptions.md#text)
- [theme](DTableBodyCellInputTreeMarkerOptions.md#theme)
- [title](DTableBodyCellInputTreeMarkerOptions.md#title)
- [toggle](DTableBodyCellInputTreeMarkerOptions.md#toggle)
- [visible](DTableBodyCellInputTreeMarkerOptions.md#visible)
- [weight](DTableBodyCellInputTreeMarkerOptions.md#weight)
- [when](DTableBodyCellInputTreeMarkerOptions.md#when)
- [width](DTableBodyCellInputTreeMarkerOptions.md#width)
- [x](DTableBodyCellInputTreeMarkerOptions.md#x)
- [y](DTableBodyCellInputTreeMarkerOptions.md#y)
...
[src/main/typescript/wcardinal/ui/d-button-base.ts:68](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-button-base.ts#L68)
