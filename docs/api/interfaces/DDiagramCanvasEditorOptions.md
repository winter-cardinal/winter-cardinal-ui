[Winter Cardinal UI - v0.310.1](../index.md) / DDiagramCanvasEditorOptions
...
A renderability.
Unlike [visible](DDiagramCanvasEditorOptions.md#visible), non-renderable element occupies a space.
