[Winter Cardinal UI - v0.457.0](../index.md) / DTableBodyCellIndexOptions
...
- [images](DTableBodyCellIndexOptions.md#images)
...
- [renderable](DTableBodyCellIndexOptions.md#renderable)
