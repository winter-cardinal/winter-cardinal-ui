[Winter Cardinal UI - v0.199.0](../index.md) / DInputBooleanOptions

# Interface: DInputBooleanOptions<THEME\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeInputBoolean`](DThemeInputBoolean.md) = [`DThemeInputBoolean`](DThemeInputBoolean.md) |

## Hierarchy

- [`DLayoutOptions`](DLayoutOptions.md)<`THEME`\>

  ↳ **`DInputBooleanOptions`**

  ↳↳ [`DDialogInputBooleanInputOptions`](DDialogInputBooleanInputOptions.md)

## Table of contents

### Properties

- [background](DInputBooleanOptions.md#background)
- [border](DInputBooleanOptions.md#border)
- [children](DInputBooleanOptions.md#children)
- [clear](DInputBooleanOptions.md#clear)
- [column](DInputBooleanOptions.md#column)
- [corner](DInputBooleanOptions.md#corner)
- [cursor](DInputBooleanOptions.md#cursor)
- [direction](DInputBooleanOptions.md#direction)
- [height](DInputBooleanOptions.md#height)
- [interactive](DInputBooleanOptions.md#interactive)
- [margin](DInputBooleanOptions.md#margin)
- [name](DInputBooleanOptions.md#name)
- [on](DInputBooleanOptions.md#on)
- [outline](DInputBooleanOptions.md#outline)
- [padding](DInputBooleanOptions.md#padding)
- [parent](DInputBooleanOptions.md#parent)
- [reverse](DInputBooleanOptions.md#reverse)
- [row](DInputBooleanOptions.md#row)
- [shadow](DInputBooleanOptions.md#shadow)
- [shortcut](DInputBooleanOptions.md#shortcut)
- [shortcuts](DInputBooleanOptions.md#shortcuts)
- [state](DInputBooleanOptions.md#state)
- [theme](DInputBooleanOptions.md#theme)
- [title](DInputBooleanOptions.md#title)
- [value](DInputBooleanOptions.md#value)
- [visible](DInputBooleanOptions.md#visible)
- [weight](DInputBooleanOptions.md#weight)
- [width](DInputBooleanOptions.md#width)
- [x](DInputBooleanOptions.md#x)
- [y](DInputBooleanOptions.md#y)
...
[src/main/typescript/wcardinal/ui/d-input-boolean.ts:15](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.199.0/src/main/typescript/wcardinal/ui/d-input-boolean.ts#L15)
