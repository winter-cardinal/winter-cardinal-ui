[Winter Cardinal UI - v0.199.0](../index.md) / DButtonPrimaryOptions

# Interface: DButtonPrimaryOptions<VALUE, THEME\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeButtonPrimary`](DThemeButtonPrimary.md)<`VALUE`\> = [`DThemeButtonPrimary`](DThemeButtonPrimary.md)<`VALUE`\> |

## Hierarchy

- [`DButtonOptions`](DButtonOptions.md)<`VALUE`, `THEME`\>

  ↳ **`DButtonPrimaryOptions`**

## Table of contents

### Properties

- [background](DButtonPrimaryOptions.md#background)
- [border](DButtonPrimaryOptions.md#border)
- [children](DButtonPrimaryOptions.md#children)
- [clear](DButtonPrimaryOptions.md#clear)
- [corner](DButtonPrimaryOptions.md#corner)
- [cursor](DButtonPrimaryOptions.md#cursor)
- [group](DButtonPrimaryOptions.md#group)
- [height](DButtonPrimaryOptions.md#height)
- [image](DButtonPrimaryOptions.md#image)
- [interactive](DButtonPrimaryOptions.md#interactive)
- [mask](DButtonPrimaryOptions.md#mask)
- [name](DButtonPrimaryOptions.md#name)
- [on](DButtonPrimaryOptions.md#on)
- [outline](DButtonPrimaryOptions.md#outline)
- [padding](DButtonPrimaryOptions.md#padding)
- [parent](DButtonPrimaryOptions.md#parent)
- [shadow](DButtonPrimaryOptions.md#shadow)
- [shortcut](DButtonPrimaryOptions.md#shortcut)
- [shortcuts](DButtonPrimaryOptions.md#shortcuts)
- [state](DButtonPrimaryOptions.md#state)
- [text](DButtonPrimaryOptions.md#text)
- [theme](DButtonPrimaryOptions.md#theme)
- [title](DButtonPrimaryOptions.md#title)
- [toggle](DButtonPrimaryOptions.md#toggle)
- [visible](DButtonPrimaryOptions.md#visible)
- [weight](DButtonPrimaryOptions.md#weight)
- [when](DButtonPrimaryOptions.md#when)
- [width](DButtonPrimaryOptions.md#width)
- [x](DButtonPrimaryOptions.md#x)
- [y](DButtonPrimaryOptions.md#y)
