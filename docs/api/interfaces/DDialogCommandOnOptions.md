[Winter Cardinal UI - v0.167.0](../index.md) / DDialogCommandOnOptions

# Interface: DDialogCommandOnOptions<VALUE, EMITTER\>

[DDialogCommand](../classes/DDialogCommand.md) "on" options.
...
- `Partial`<[`DDialogCommandEvents`](DDialogCommandEvents.md)<`VALUE`, `EMITTER`\>\>

- `DOnOptions`

  ↳ **`DDialogCommandOnOptions`**

## Table of contents

### Methods

- [added](DDialogCommandOnOptions.md#added)
- [cancel](DDialogCommandOnOptions.md#cancel)
- [close](DDialogCommandOnOptions.md#close)
- [dblclick](DDialogCommandOnOptions.md#dblclick)
- [down](DDialogCommandOnOptions.md#down)
- [init](DDialogCommandOnOptions.md#init)
- [keydown](DDialogCommandOnOptions.md#keydown)
- [keyup](DDialogCommandOnOptions.md#keyup)
- [move](DDialogCommandOnOptions.md#move)
- [ok](DDialogCommandOnOptions.md#ok)
- [open](DDialogCommandOnOptions.md#open)
- [out](DDialogCommandOnOptions.md#out)
- [over](DDialogCommandOnOptions.md#over)
- [removed](DDialogCommandOnOptions.md#removed)
- [resize](DDialogCommandOnOptions.md#resize)
- [scale](DDialogCommandOnOptions.md#scale)
- [skew](DDialogCommandOnOptions.md#skew)
- [statechange](DDialogCommandOnOptions.md#statechange)
- [up](DDialogCommandOnOptions.md#up)
- [wheel](DDialogCommandOnOptions.md#wheel)
...
[src/main/typescript/wcardinal/ui/d-dialog-command.ts:34](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dialog-command.ts#L34)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:45](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L45)
...
[src/main/typescript/wcardinal/ui/d-dialog-command.ts:26](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dialog-command.ts#L26)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:38](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.167.0/src/main/typescript/wcardinal/ui/d-dialog.ts#L38)
