[Winter Cardinal UI - v0.407.0](../index.md) / DTreeItemTextOptions

# Interface: DTreeItemTextOptions\<NODE, THEME, EMITTER\>
...
| `THEME` | extends [`DThemeTreeItemText`](DThemeTreeItemText.md) = [`DThemeTreeItemText`](DThemeTreeItemText.md) |
| `EMITTER` | `any` |
...
- [`DImageBaseOptions`](DImageBaseOptions.md)\<`string`, `THEME`\>
  ...
  ↳ **`DTreeItemTextOptions`**

  ↳↳ [`DTreeItemButtonOptions`](DTreeItemButtonOptions.md)

## Table of contents

### Properties

- [background](DTreeItemTextOptions.md#background)
- [border](DTreeItemTextOptions.md#border)
- [children](DTreeItemTextOptions.md#children)
- [clear](DTreeItemTextOptions.md#clear)
- [corner](DTreeItemTextOptions.md#corner)
- [cursor](DTreeItemTextOptions.md#cursor)
- [height](DTreeItemTextOptions.md#height)
- [image](DTreeItemTextOptions.md#image)
- [images](DTreeItemTextOptions.md#images)
- [interactive](DTreeItemTextOptions.md#interactive)
- [mask](DTreeItemTextOptions.md#mask)
- [name](DTreeItemTextOptions.md#name)
- [on](DTreeItemTextOptions.md#on)
- [outline](DTreeItemTextOptions.md#outline)
- [padding](DTreeItemTextOptions.md#padding)
- [parent](DTreeItemTextOptions.md#parent)
- [renderable](DTreeItemTextOptions.md#renderable)
- [shadow](DTreeItemTextOptions.md#shadow)
- [shortcut](DTreeItemTextOptions.md#shortcut)
- [shortcuts](DTreeItemTextOptions.md#shortcuts)
- [state](DTreeItemTextOptions.md#state)
- [text](DTreeItemTextOptions.md#text)
- [theme](DTreeItemTextOptions.md#theme)
- [title](DTreeItemTextOptions.md#title)
- [visible](DTreeItemTextOptions.md#visible)
- [weight](DTreeItemTextOptions.md#weight)
- [width](DTreeItemTextOptions.md#width)
- [x](DTreeItemTextOptions.md#x)
- [y](DTreeItemTextOptions.md#y)
...
[src/main/typescript/wcardinal/ui/d-tree-item-text.ts:54](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-tree-item-text.ts#L54)
