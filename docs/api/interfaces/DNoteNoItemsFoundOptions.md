[Winter Cardinal UI - v0.310.1](../index.md) / DNoteNoItemsFoundOptions
...
A renderability.
Unlike [visible](DNoteNoItemsFoundOptions.md#visible), non-renderable element occupies a space.
