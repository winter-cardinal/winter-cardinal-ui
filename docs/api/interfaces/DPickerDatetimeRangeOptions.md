[Winter Cardinal UI - v0.310.1](../index.md) / DPickerDatetimeRangeOptions

# Interface: DPickerDatetimeRangeOptions<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemePickerDatetimeRange`](DThemePickerDatetimeRange.md) |

## Hierarchy

- [`DBaseOptions`](DBaseOptions.md)<`THEME`\>

  ↳ **`DPickerDatetimeRangeOptions`**

## Table of contents

### Properties

- [background](DPickerDatetimeRangeOptions.md#background)
- [border](DPickerDatetimeRangeOptions.md#border)
- [children](DPickerDatetimeRangeOptions.md#children)
- [clear](DPickerDatetimeRangeOptions.md#clear)
- [corner](DPickerDatetimeRangeOptions.md#corner)
- [cursor](DPickerDatetimeRangeOptions.md#cursor)
- [height](DPickerDatetimeRangeOptions.md#height)
- [interactive](DPickerDatetimeRangeOptions.md#interactive)
- [name](DPickerDatetimeRangeOptions.md#name)
- [on](DPickerDatetimeRangeOptions.md#on)
- [outline](DPickerDatetimeRangeOptions.md#outline)
- [padding](DPickerDatetimeRangeOptions.md#padding)
- [parent](DPickerDatetimeRangeOptions.md#parent)
- [renderable](DPickerDatetimeRangeOptions.md#renderable)
- [shadow](DPickerDatetimeRangeOptions.md#shadow)
- [shortcut](DPickerDatetimeRangeOptions.md#shortcut)
- [shortcuts](DPickerDatetimeRangeOptions.md#shortcuts)
- [state](DPickerDatetimeRangeOptions.md#state)
- [theme](DPickerDatetimeRangeOptions.md#theme)
- [title](DPickerDatetimeRangeOptions.md#title)
- [visible](DPickerDatetimeRangeOptions.md#visible)
- [weight](DPickerDatetimeRangeOptions.md#weight)
- [width](DPickerDatetimeRangeOptions.md#width)
- [x](DPickerDatetimeRangeOptions.md#x)
- [y](DPickerDatetimeRangeOptions.md#y)
...
A renderability.
Unlike [visible](DPickerDatetimeRangeOptions.md#visible), non-renderable element occupies a space.
