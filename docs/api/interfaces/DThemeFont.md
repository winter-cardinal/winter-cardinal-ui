[Winter Cardinal UI - v0.442.0](../index.md) / DThemeFont

# Interface: DThemeFont
...
- **`DThemeFont`**
  ...
  ↳ [`DThemeDynamicTextStyle`](DThemeDynamicTextStyle.md)

  ↳ [`DThemeTextPiece`](DThemeTextPiece.md)
...
- [getAlpha](DThemeFont.md#getalpha)
- [getColor](DThemeFont.md#getcolor)
- [getFontFamilly](DThemeFont.md#getfontfamilly)
- [getFontSize](DThemeFont.md#getfontsize)
- [getFontStyle](DThemeFont.md#getfontstyle)
- [getFontVariant](DThemeFont.md#getfontvariant)
- [getFontWeight](DThemeFont.md#getfontweight)
- [getLineHeight](DThemeFont.md#getlineheight)
