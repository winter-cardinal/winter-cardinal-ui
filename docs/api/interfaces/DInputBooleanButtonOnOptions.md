[Winter Cardinal UI - v0.310.1](../index.md) / DInputBooleanButtonOnOptions
...
A renderability.
Unlike [visible](DInputBooleanButtonOnOptions.md#visible), non-renderable element occupies a space.
