[Winter Cardinal UI - v0.199.0](../index.md) / DInputBooleanButtonOnOptions

# Interface: DInputBooleanButtonOnOptions<THEME, EMITTER\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeInputBooleanButtonOn`](DThemeInputBooleanButtonOn.md) = [`DThemeInputBooleanButtonOn`](DThemeInputBooleanButtonOn.md) |
| `EMITTER` | `any` |
...
- [`DButtonOptions`](DButtonOptions.md)<`string`, `THEME`, `EMITTER`\>
  ...
  ↳ **`DInputBooleanButtonOnOptions`**

## Table of contents

### Properties

- [background](DInputBooleanButtonOnOptions.md#background)
- [border](DInputBooleanButtonOnOptions.md#border)
- [children](DInputBooleanButtonOnOptions.md#children)
- [clear](DInputBooleanButtonOnOptions.md#clear)
- [corner](DInputBooleanButtonOnOptions.md#corner)
- [cursor](DInputBooleanButtonOnOptions.md#cursor)
- [group](DInputBooleanButtonOnOptions.md#group)
- [height](DInputBooleanButtonOnOptions.md#height)
- [image](DInputBooleanButtonOnOptions.md#image)
- [interactive](DInputBooleanButtonOnOptions.md#interactive)
- [mask](DInputBooleanButtonOnOptions.md#mask)
- [name](DInputBooleanButtonOnOptions.md#name)
- [on](DInputBooleanButtonOnOptions.md#on)
- [outline](DInputBooleanButtonOnOptions.md#outline)
- [padding](DInputBooleanButtonOnOptions.md#padding)
- [parent](DInputBooleanButtonOnOptions.md#parent)
- [shadow](DInputBooleanButtonOnOptions.md#shadow)
- [shortcut](DInputBooleanButtonOnOptions.md#shortcut)
- [shortcuts](DInputBooleanButtonOnOptions.md#shortcuts)
- [state](DInputBooleanButtonOnOptions.md#state)
- [text](DInputBooleanButtonOnOptions.md#text)
- [theme](DInputBooleanButtonOnOptions.md#theme)
- [title](DInputBooleanButtonOnOptions.md#title)
- [toggle](DInputBooleanButtonOnOptions.md#toggle)
- [visible](DInputBooleanButtonOnOptions.md#visible)
- [weight](DInputBooleanButtonOnOptions.md#weight)
- [when](DInputBooleanButtonOnOptions.md#when)
- [width](DInputBooleanButtonOnOptions.md#width)
- [x](DInputBooleanButtonOnOptions.md#x)
- [y](DInputBooleanButtonOnOptions.md#y)
