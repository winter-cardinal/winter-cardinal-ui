[Winter Cardinal UI - v0.457.0](../index.md) / DSelectOnOptions
...
- [click](DSelectOnOptions.md#click)
...
- [open](DSelectOnOptions.md#open)
- [out](DSelectOnOptions.md#out)
- [over](DSelectOnOptions.md#over)
- [press](DSelectOnOptions.md#press)
...
- [shortcut](DSelectOnOptions.md#shortcut)
- [skew](DSelectOnOptions.md#skew)
- [statechange](DSelectOnOptions.md#statechange)
- [unpress](DSelectOnOptions.md#unpress)
...
[src/main/typescript/wcardinal/ui/d-select.ts:30](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-select.ts#L30)
