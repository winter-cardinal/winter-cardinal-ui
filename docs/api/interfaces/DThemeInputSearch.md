[Winter Cardinal UI - v0.199.0](../index.md) / DThemeInputSearch
...
- [getOutlineWidth](DThemeInputSearch.md#getoutlinewidth)
...
- [isClipperExEnabled](DThemeInputSearch.md#isclipperexenabled)
