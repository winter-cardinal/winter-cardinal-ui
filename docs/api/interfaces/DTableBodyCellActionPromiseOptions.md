[Winter Cardinal UI - v0.310.1](../index.md) / DTableBodyCellActionPromiseOptions
...
A renderability.
Unlike [visible](DTableBodyCellActionPromiseOptions.md#visible), non-renderable element occupies a space.
