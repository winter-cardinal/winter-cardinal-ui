[Winter Cardinal UI - v0.310.1](../index.md) / DTableCategoryCellOptions
...
- [renderable](DTableCategoryCellOptions.md#renderable)
...
A renderability.
Unlike [visible](DTableCategoryCellOptions.md#visible), non-renderable element occupies a space.
