[Winter Cardinal UI - v0.457.0](../index.md) / DDropdownBaseEvents
...
- [`DButtonBaseEvents`](DButtonBaseEvents.md)\<`VALUE`, `EMITTER`\>
  ...
  ↳↳ [`DSelectMultipleEvents`](DSelectMultipleEvents.md)

  ↳↳ [`DSelectEvents`](DSelectEvents.md)

## Table of contents

### Methods

- [active](DDropdownBaseEvents.md#active)
- [added](DDropdownBaseEvents.md#added)
- [click](DDropdownBaseEvents.md#click)
- [dblclick](DDropdownBaseEvents.md#dblclick)
- [down](DDropdownBaseEvents.md#down)
- [inactive](DDropdownBaseEvents.md#inactive)
- [init](DDropdownBaseEvents.md#init)
- [keydown](DDropdownBaseEvents.md#keydown)
- [keyup](DDropdownBaseEvents.md#keyup)
- [move](DDropdownBaseEvents.md#move)
- [open](DDropdownBaseEvents.md#open)
- [out](DDropdownBaseEvents.md#out)
- [over](DDropdownBaseEvents.md#over)
- [press](DDropdownBaseEvents.md#press)
- [removed](DDropdownBaseEvents.md#removed)
- [resize](DDropdownBaseEvents.md#resize)
- [scale](DDropdownBaseEvents.md#scale)
- [select](DDropdownBaseEvents.md#select)
- [shortcut](DDropdownBaseEvents.md#shortcut)
- [skew](DDropdownBaseEvents.md#skew)
- [statechange](DDropdownBaseEvents.md#statechange)
- [unpress](DDropdownBaseEvents.md#unpress)
- [up](DDropdownBaseEvents.md#up)
- [wheel](DDropdownBaseEvents.md#wheel)
...
[DButtonBaseEvents](DButtonBaseEvents.md).[press](DButtonBaseEvents.md#press)
...
[DButtonBaseEvents](DButtonBaseEvents.md).[unpress](DButtonBaseEvents.md#unpress)
