[Winter Cardinal UI - v0.310.1](../index.md) / DPickerDatetimeSpaceOptions

# Interface: DPickerDatetimeSpaceOptions<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemePickerDatetimeSpace`](DThemePickerDatetimeSpace.md) = [`DThemePickerDatetimeSpace`](DThemePickerDatetimeSpace.md) |
...
- [background](DPickerDatetimeSpaceOptions.md#background)
- [border](DPickerDatetimeSpaceOptions.md#border)
- [children](DPickerDatetimeSpaceOptions.md#children)
- [clear](DPickerDatetimeSpaceOptions.md#clear)
- [corner](DPickerDatetimeSpaceOptions.md#corner)
- [cursor](DPickerDatetimeSpaceOptions.md#cursor)
- [height](DPickerDatetimeSpaceOptions.md#height)
- [interactive](DPickerDatetimeSpaceOptions.md#interactive)
- [name](DPickerDatetimeSpaceOptions.md#name)
- [on](DPickerDatetimeSpaceOptions.md#on)
- [outline](DPickerDatetimeSpaceOptions.md#outline)
- [padding](DPickerDatetimeSpaceOptions.md#padding)
- [parent](DPickerDatetimeSpaceOptions.md#parent)
- [renderable](DPickerDatetimeSpaceOptions.md#renderable)
- [shadow](DPickerDatetimeSpaceOptions.md#shadow)
- [shortcut](DPickerDatetimeSpaceOptions.md#shortcut)
- [shortcuts](DPickerDatetimeSpaceOptions.md#shortcuts)
- [state](DPickerDatetimeSpaceOptions.md#state)
- [theme](DPickerDatetimeSpaceOptions.md#theme)
- [title](DPickerDatetimeSpaceOptions.md#title)
- [visible](DPickerDatetimeSpaceOptions.md#visible)
- [weight](DPickerDatetimeSpaceOptions.md#weight)
- [width](DPickerDatetimeSpaceOptions.md#width)
- [x](DPickerDatetimeSpaceOptions.md#x)
- [y](DPickerDatetimeSpaceOptions.md#y)
...
A renderability.
Unlike [visible](DPickerDatetimeSpaceOptions.md#visible), non-renderable element occupies a space.
