[Winter Cardinal UI - v0.310.1](../index.md) / DPickerTimeRangeOptions

# Interface: DPickerTimeRangeOptions<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemePickerTimeRange`](DThemePickerTimeRange.md) |

## Hierarchy

- [`DBaseOptions`](DBaseOptions.md)<`THEME`\>

  ↳ **`DPickerTimeRangeOptions`**

## Table of contents

### Properties

- [background](DPickerTimeRangeOptions.md#background)
- [border](DPickerTimeRangeOptions.md#border)
- [children](DPickerTimeRangeOptions.md#children)
- [clear](DPickerTimeRangeOptions.md#clear)
- [corner](DPickerTimeRangeOptions.md#corner)
- [cursor](DPickerTimeRangeOptions.md#cursor)
- [height](DPickerTimeRangeOptions.md#height)
- [interactive](DPickerTimeRangeOptions.md#interactive)
- [name](DPickerTimeRangeOptions.md#name)
- [on](DPickerTimeRangeOptions.md#on)
- [outline](DPickerTimeRangeOptions.md#outline)
- [padding](DPickerTimeRangeOptions.md#padding)
- [parent](DPickerTimeRangeOptions.md#parent)
- [renderable](DPickerTimeRangeOptions.md#renderable)
- [shadow](DPickerTimeRangeOptions.md#shadow)
- [shortcut](DPickerTimeRangeOptions.md#shortcut)
- [shortcuts](DPickerTimeRangeOptions.md#shortcuts)
- [state](DPickerTimeRangeOptions.md#state)
- [theme](DPickerTimeRangeOptions.md#theme)
- [title](DPickerTimeRangeOptions.md#title)
- [visible](DPickerTimeRangeOptions.md#visible)
- [weight](DPickerTimeRangeOptions.md#weight)
- [width](DPickerTimeRangeOptions.md#width)
- [x](DPickerTimeRangeOptions.md#x)
- [y](DPickerTimeRangeOptions.md#y)
...
A renderability.
Unlike [visible](DPickerTimeRangeOptions.md#visible), non-renderable element occupies a space.
