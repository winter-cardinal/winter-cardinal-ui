[Winter Cardinal UI - v0.407.0](../index.md) / DThemeButton

# Interface: DThemeButton\<VALUE\>
...
- [`DThemeButtonBase`](DThemeButtonBase.md)\<`VALUE`\>
  ...
  ↳↳ [`DThemeButtonAmbient`](DThemeButtonAmbient.md)

  ↳↳ [`DThemeButtonColorGradient`](DThemeButtonColorGradient.md)

  ↳↳ [`DThemeButtonColor`](DThemeButtonColor.md)

  ↳↳ [`DThemeButtonDanger`](DThemeButtonDanger.md)

  ↳↳ [`DThemeButtonDate`](DThemeButtonDate.md)

  ↳↳ [`DThemeButtonDatetime`](DThemeButtonDatetime.md)

  ↳↳ [`DThemeButtonFile`](DThemeButtonFile.md)

  ↳↳ [`DThemeButtonPrimary`](DThemeButtonPrimary.md)

  ↳↳ [`DThemeButtonSecondary`](DThemeButtonSecondary.md)

  ↳↳ [`DThemeButtonSelect`](DThemeButtonSelect.md)

  ↳↳ [`DThemeButtonTime`](DThemeButtonTime.md)

  ↳↳ [`DThemeInputBooleanButtonOff`](DThemeInputBooleanButtonOff.md)

  ↳↳ [`DThemeInputBooleanButtonOn`](DThemeInputBooleanButtonOn.md)

  ↳↳ [`DThemeMenuBarItem`](DThemeMenuBarItem.md)

  ↳↳ [`DThemeSliderThumb`](DThemeSliderThumb.md)

  ↳↳ [`DThemeSliderTrack`](DThemeSliderTrack.md)

  ↳↳ [`DThemeTableBodyCellSelectDialog`](DThemeTableBodyCellSelectDialog.md)

  ↳↳ [`DThemeTableBodyCellSelectPromise`](DThemeTableBodyCellSelectPromise.md)
...
- [getAlpha](DThemeButton.md#getalpha)
- [getBackgroundAlpha](DThemeButton.md#getbackgroundalpha)
- [getBackgroundColor](DThemeButton.md#getbackgroundcolor)
- [getBackgroundTexture](DThemeButton.md#getbackgroundtexture)
- [getBorderAlign](DThemeButton.md#getborderalign)
- [getBorderAlpha](DThemeButton.md#getborderalpha)
- [getBorderColor](DThemeButton.md#getbordercolor)
- [getBorderMask](DThemeButton.md#getbordermask)
- [getBorderTexture](DThemeButton.md#getbordertexture)
- [getBorderWidth](DThemeButton.md#getborderwidth)
- [getClearType](DThemeButton.md#getcleartype)
- [getColor](DThemeButton.md#getcolor)
- [getCornerMask](DThemeButton.md#getcornermask)
- [getCornerRadius](DThemeButton.md#getcornerradius)
- [getCursor](DThemeButton.md#getcursor)
- [getFontFamilly](DThemeButton.md#getfontfamilly)
- [getFontSize](DThemeButton.md#getfontsize)
- [getFontStyle](DThemeButton.md#getfontstyle)
- [getFontVariant](DThemeButton.md#getfontvariant)
- [getFontWeight](DThemeButton.md#getfontweight)
- [getHeight](DThemeButton.md#getheight)
- [getImageAlignHorizontal](DThemeButton.md#getimagealignhorizontal)
- [getImageAlignVertical](DThemeButton.md#getimagealignvertical)
- [getImageAlignWith](DThemeButton.md#getimagealignwith)
- [getImageMarginHorizontal](DThemeButton.md#getimagemarginhorizontal)
- [getImageMarginVertial](DThemeButton.md#getimagemarginvertial)
- [getImageRotation](DThemeButton.md#getimagerotation)
- [getImageSource](DThemeButton.md#getimagesource)
- [getImageTintAlpha](DThemeButton.md#getimagetintalpha)
- [getImageTintColor](DThemeButton.md#getimagetintcolor)
- [getInteractive](DThemeButton.md#getinteractive)
- [getLineHeight](DThemeButton.md#getlineheight)
- [getOutlineAlign](DThemeButton.md#getoutlinealign)
- [getOutlineAlpha](DThemeButton.md#getoutlinealpha)
- [getOutlineColor](DThemeButton.md#getoutlinecolor)
- [getOutlineMask](DThemeButton.md#getoutlinemask)
- [getOutlineOffset](DThemeButton.md#getoutlineoffset)
- [getOutlineWidth](DThemeButton.md#getoutlinewidth)
- [getPaddingBottom](DThemeButton.md#getpaddingbottom)
- [getPaddingLeft](DThemeButton.md#getpaddingleft)
- [getPaddingRight](DThemeButton.md#getpaddingright)
- [getPaddingTop](DThemeButton.md#getpaddingtop)
- [getSecondaryImageAlignHorizontal](DThemeButton.md#getsecondaryimagealignhorizontal)
- [getSecondaryImageAlignVertical](DThemeButton.md#getsecondaryimagealignvertical)
- [getSecondaryImageAlignWith](DThemeButton.md#getsecondaryimagealignwith)
- [getSecondaryImageMarginHorizontal](DThemeButton.md#getsecondaryimagemarginhorizontal)
- [getSecondaryImageMarginVertial](DThemeButton.md#getsecondaryimagemarginvertial)
- [getSecondaryImageRotation](DThemeButton.md#getsecondaryimagerotation)
- [getSecondaryImageSource](DThemeButton.md#getsecondaryimagesource)
- [getSecondaryImageTintAlpha](DThemeButton.md#getsecondaryimagetintalpha)
- [getSecondaryImageTintColor](DThemeButton.md#getsecondaryimagetintcolor)
- [getShadow](DThemeButton.md#getshadow)
- [getTertiaryImageAlignHorizontal](DThemeButton.md#gettertiaryimagealignhorizontal)
- [getTertiaryImageAlignVertical](DThemeButton.md#gettertiaryimagealignvertical)
- [getTertiaryImageAlignWith](DThemeButton.md#gettertiaryimagealignwith)
- [getTertiaryImageMarginHorizontal](DThemeButton.md#gettertiaryimagemarginhorizontal)
- [getTertiaryImageMarginVertial](DThemeButton.md#gettertiaryimagemarginvertial)
- [getTertiaryImageRotation](DThemeButton.md#gettertiaryimagerotation)
- [getTertiaryImageSource](DThemeButton.md#gettertiaryimagesource)
- [getTertiaryImageTintAlpha](DThemeButton.md#gettertiaryimagetintalpha)
- [getTertiaryImageTintColor](DThemeButton.md#gettertiaryimagetintcolor)
- [getTextAlignHorizontal](DThemeButton.md#gettextalignhorizontal)
- [getTextAlignVertical](DThemeButton.md#gettextalignvertical)
- [getTextFormatter](DThemeButton.md#gettextformatter)
- [getTextStyleClipping](DThemeButton.md#gettextstyleclipping)
- [getTextStyleFitting](DThemeButton.md#gettextstylefitting)
- [getTextStyleWordWrap](DThemeButton.md#gettextstylewordwrap)
- [getTextValue](DThemeButton.md#gettextvalue)
- [getTitle](DThemeButton.md#gettitle)
- [getWeight](DThemeButton.md#getweight)
- [getWhen](DThemeButton.md#getwhen)
- [getWidth](DThemeButton.md#getwidth)
- [getX](DThemeButton.md#getx)
- [getY](DThemeButton.md#gety)
- [isOverflowMaskEnabled](DThemeButton.md#isoverflowmaskenabled)
- [isToggle](DThemeButton.md#istoggle)
- [newShadow](DThemeButton.md#newshadow)
- [newShadowWeak](DThemeButton.md#newshadowweak)
- [newState](DThemeButton.md#newstate)
- [newTextValue](DThemeButton.md#newtextvalue)
