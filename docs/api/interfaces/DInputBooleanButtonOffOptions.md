[Winter Cardinal UI - v0.199.0](../index.md) / DInputBooleanButtonOffOptions

# Interface: DInputBooleanButtonOffOptions<THEME, EMITTER\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeInputBooleanButtonOff`](DThemeInputBooleanButtonOff.md) = [`DThemeInputBooleanButtonOff`](DThemeInputBooleanButtonOff.md) |
| `EMITTER` | `any` |

## Hierarchy

- [`DButtonOptions`](DButtonOptions.md)<`string`, `THEME`, `EMITTER`\>

  ↳ **`DInputBooleanButtonOffOptions`**

## Table of contents

### Properties

- [background](DInputBooleanButtonOffOptions.md#background)
- [border](DInputBooleanButtonOffOptions.md#border)
- [children](DInputBooleanButtonOffOptions.md#children)
- [clear](DInputBooleanButtonOffOptions.md#clear)
- [corner](DInputBooleanButtonOffOptions.md#corner)
- [cursor](DInputBooleanButtonOffOptions.md#cursor)
- [group](DInputBooleanButtonOffOptions.md#group)
- [height](DInputBooleanButtonOffOptions.md#height)
- [image](DInputBooleanButtonOffOptions.md#image)
- [interactive](DInputBooleanButtonOffOptions.md#interactive)
- [mask](DInputBooleanButtonOffOptions.md#mask)
- [name](DInputBooleanButtonOffOptions.md#name)
- [on](DInputBooleanButtonOffOptions.md#on)
- [outline](DInputBooleanButtonOffOptions.md#outline)
- [padding](DInputBooleanButtonOffOptions.md#padding)
- [parent](DInputBooleanButtonOffOptions.md#parent)
- [shadow](DInputBooleanButtonOffOptions.md#shadow)
- [shortcut](DInputBooleanButtonOffOptions.md#shortcut)
- [shortcuts](DInputBooleanButtonOffOptions.md#shortcuts)
- [state](DInputBooleanButtonOffOptions.md#state)
- [text](DInputBooleanButtonOffOptions.md#text)
- [theme](DInputBooleanButtonOffOptions.md#theme)
- [title](DInputBooleanButtonOffOptions.md#title)
- [toggle](DInputBooleanButtonOffOptions.md#toggle)
- [visible](DInputBooleanButtonOffOptions.md#visible)
- [weight](DInputBooleanButtonOffOptions.md#weight)
- [when](DInputBooleanButtonOffOptions.md#when)
- [width](DInputBooleanButtonOffOptions.md#width)
- [x](DInputBooleanButtonOffOptions.md#x)
- [y](DInputBooleanButtonOffOptions.md#y)
...
• `Optional` **on**: [`DButtonOnOptions`](DButtonOnOptions.md)<`string`, `EMITTER`\>
