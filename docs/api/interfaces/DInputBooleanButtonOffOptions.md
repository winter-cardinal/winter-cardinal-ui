[Winter Cardinal UI - v0.310.1](../index.md) / DInputBooleanButtonOffOptions
...
A renderability.
Unlike [visible](DInputBooleanButtonOffOptions.md#visible), non-renderable element occupies a space.
