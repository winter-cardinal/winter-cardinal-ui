[Winter Cardinal UI - v0.457.0](../index.md) / DSelectMultipleEvents
...
- [click](DSelectMultipleEvents.md#click)
...
- [open](DSelectMultipleEvents.md#open)
- [out](DSelectMultipleEvents.md#out)
- [over](DSelectMultipleEvents.md#over)
- [press](DSelectMultipleEvents.md#press)
...
- [shortcut](DSelectMultipleEvents.md#shortcut)
- [skew](DSelectMultipleEvents.md#skew)
- [statechange](DSelectMultipleEvents.md#statechange)
- [unpress](DSelectMultipleEvents.md#unpress)
