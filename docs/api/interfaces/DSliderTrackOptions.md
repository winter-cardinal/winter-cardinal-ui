[Winter Cardinal UI - v0.205.1](../index.md) / DSliderTrackOptions

# Interface: DSliderTrackOptions<VALUE, THEME\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeSliderTrack`](DThemeSliderTrack.md)<`VALUE`\> = [`DThemeSliderTrack`](DThemeSliderTrack.md)<`VALUE`\> |
...
- [`DButtonOptions`](DButtonOptions.md)<`VALUE`, `THEME`\>
  ...
  ↳↳ [`DSliderTrackHorizontalOptions`](DSliderTrackHorizontalOptions.md)

  ↳↳ [`DSliderTrackVerticalOptions`](DSliderTrackVerticalOptions.md)

## Table of contents

### Properties

- [background](DSliderTrackOptions.md#background)
- [border](DSliderTrackOptions.md#border)
- [children](DSliderTrackOptions.md#children)
- [clear](DSliderTrackOptions.md#clear)
- [corner](DSliderTrackOptions.md#corner)
- [cursor](DSliderTrackOptions.md#cursor)
- [group](DSliderTrackOptions.md#group)
- [height](DSliderTrackOptions.md#height)
- [image](DSliderTrackOptions.md#image)
- [interactive](DSliderTrackOptions.md#interactive)
- [mask](DSliderTrackOptions.md#mask)
- [name](DSliderTrackOptions.md#name)
- [on](DSliderTrackOptions.md#on)
- [outline](DSliderTrackOptions.md#outline)
- [padding](DSliderTrackOptions.md#padding)
- [parent](DSliderTrackOptions.md#parent)
- [shadow](DSliderTrackOptions.md#shadow)
- [shortcut](DSliderTrackOptions.md#shortcut)
- [shortcuts](DSliderTrackOptions.md#shortcuts)
- [state](DSliderTrackOptions.md#state)
- [text](DSliderTrackOptions.md#text)
- [theme](DSliderTrackOptions.md#theme)
- [title](DSliderTrackOptions.md#title)
- [toggle](DSliderTrackOptions.md#toggle)
- [visible](DSliderTrackOptions.md#visible)
- [weight](DSliderTrackOptions.md#weight)
- [when](DSliderTrackOptions.md#when)
- [width](DSliderTrackOptions.md#width)
- [x](DSliderTrackOptions.md#x)
- [y](DSliderTrackOptions.md#y)
