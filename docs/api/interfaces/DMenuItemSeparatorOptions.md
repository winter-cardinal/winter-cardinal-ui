[Winter Cardinal UI - v0.407.0](../index.md) / DMenuItemSeparatorOptions

# Interface: DMenuItemSeparatorOptions\<VALUE, THEME\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeMenuItemSeparator`](DThemeMenuItemSeparator.md) = [`DThemeMenuItemSeparator`](DThemeMenuItemSeparator.md) |
...
- [background](DMenuItemSeparatorOptions.md#background)
- [border](DMenuItemSeparatorOptions.md#border)
- [children](DMenuItemSeparatorOptions.md#children)
- [clear](DMenuItemSeparatorOptions.md#clear)
- [corner](DMenuItemSeparatorOptions.md#corner)
- [cursor](DMenuItemSeparatorOptions.md#cursor)
- [height](DMenuItemSeparatorOptions.md#height)
- [image](DMenuItemSeparatorOptions.md#image)
- [images](DMenuItemSeparatorOptions.md#images)
- [interactive](DMenuItemSeparatorOptions.md#interactive)
- [mask](DMenuItemSeparatorOptions.md#mask)
- [name](DMenuItemSeparatorOptions.md#name)
- [on](DMenuItemSeparatorOptions.md#on)
- [outline](DMenuItemSeparatorOptions.md#outline)
- [padding](DMenuItemSeparatorOptions.md#padding)
- [parent](DMenuItemSeparatorOptions.md#parent)
- [renderable](DMenuItemSeparatorOptions.md#renderable)
- [separator](DMenuItemSeparatorOptions.md#separator)
- [shadow](DMenuItemSeparatorOptions.md#shadow)
- [shortcut](DMenuItemSeparatorOptions.md#shortcut)
- [shortcuts](DMenuItemSeparatorOptions.md#shortcuts)
- [state](DMenuItemSeparatorOptions.md#state)
- [text](DMenuItemSeparatorOptions.md#text)
- [theme](DMenuItemSeparatorOptions.md#theme)
- [title](DMenuItemSeparatorOptions.md#title)
- [value](DMenuItemSeparatorOptions.md#value)
- [visible](DMenuItemSeparatorOptions.md#visible)
- [weight](DMenuItemSeparatorOptions.md#weight)
- [width](DMenuItemSeparatorOptions.md#width)
- [x](DMenuItemSeparatorOptions.md#x)
- [y](DMenuItemSeparatorOptions.md#y)
...
• `Optional` **separator**: ``true``

#### Defined in

[src/main/typescript/wcardinal/ui/d-menu-item-separator.ts:14](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-menu-item-separator.ts#L14)
