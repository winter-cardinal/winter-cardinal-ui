[Winter Cardinal UI - v0.205.1](../index.md) / DButtonDateOptions

# Interface: DButtonDateOptions<THEME, EMITTER\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeButtonDate`](DThemeButtonDate.md) = [`DThemeButtonDate`](DThemeButtonDate.md) |
| `EMITTER` | `any` |
...
- [`DButtonOptions`](DButtonOptions.md)<`Date`, `THEME`, `EMITTER`\>
  ...
  ↳↳ [`DTableBodyCellDateOptions`](DTableBodyCellDateOptions.md)

## Table of contents

### Properties

- [background](DButtonDateOptions.md#background)
- [border](DButtonDateOptions.md#border)
- [children](DButtonDateOptions.md#children)
- [clear](DButtonDateOptions.md#clear)
- [corner](DButtonDateOptions.md#corner)
- [cursor](DButtonDateOptions.md#cursor)
- [dialog](DButtonDateOptions.md#dialog)
- [group](DButtonDateOptions.md#group)
- [height](DButtonDateOptions.md#height)
- [image](DButtonDateOptions.md#image)
- [interactive](DButtonDateOptions.md#interactive)
- [mask](DButtonDateOptions.md#mask)
- [name](DButtonDateOptions.md#name)
- [on](DButtonDateOptions.md#on)
- [outline](DButtonDateOptions.md#outline)
- [padding](DButtonDateOptions.md#padding)
- [parent](DButtonDateOptions.md#parent)
- [shadow](DButtonDateOptions.md#shadow)
- [shortcut](DButtonDateOptions.md#shortcut)
- [shortcuts](DButtonDateOptions.md#shortcuts)
- [state](DButtonDateOptions.md#state)
- [text](DButtonDateOptions.md#text)
- [theme](DButtonDateOptions.md#theme)
- [title](DButtonDateOptions.md#title)
- [toggle](DButtonDateOptions.md#toggle)
- [visible](DButtonDateOptions.md#visible)
- [weight](DButtonDateOptions.md#weight)
- [when](DButtonDateOptions.md#when)
- [width](DButtonDateOptions.md#width)
- [x](DButtonDateOptions.md#x)
- [y](DButtonDateOptions.md#y)
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:39](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-button-date.ts#L39)
...
• `Optional` **on**: [`DButtonDateOnOptions`](DButtonDateOnOptions.md)<`EMITTER`\>
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:40](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.205.1/src/main/typescript/wcardinal/ui/d-button-date.ts#L40)
