[Winter Cardinal UI - v0.310.1](../index.md) / DButtonDateOptions
...
- [renderable](DButtonDateOptions.md#renderable)
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:39](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-date.ts#L39)
...
[src/main/typescript/wcardinal/ui/d-button-date.ts:40](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-button-date.ts#L40)
...
A renderability.
Unlike [visible](DButtonDateOptions.md#visible), non-renderable element occupies a space.
