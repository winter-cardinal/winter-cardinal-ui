[Winter Cardinal UI - v0.310.1](../index.md) / DContentOptions

# Interface: DContentOptions

[DBase](../classes/DBase.md) options.

## Hierarchy

- [`DBaseOptions`](DBaseOptions.md)<[`DThemeContent`](DThemeContent.md)\>
...
- [background](DContentOptions.md#background)
- [border](DContentOptions.md#border)
- [children](DContentOptions.md#children)
- [clear](DContentOptions.md#clear)
- [corner](DContentOptions.md#corner)
- [cursor](DContentOptions.md#cursor)
- [height](DContentOptions.md#height)
- [interactive](DContentOptions.md#interactive)
- [name](DContentOptions.md#name)
- [on](DContentOptions.md#on)
- [outline](DContentOptions.md#outline)
- [padding](DContentOptions.md#padding)
- [parent](DContentOptions.md#parent)
- [renderable](DContentOptions.md#renderable)
- [shadow](DContentOptions.md#shadow)
- [shortcut](DContentOptions.md#shortcut)
- [shortcuts](DContentOptions.md#shortcuts)
- [state](DContentOptions.md#state)
- [theme](DContentOptions.md#theme)
- [title](DContentOptions.md#title)
- [visible](DContentOptions.md#visible)
- [weight](DContentOptions.md#weight)
- [width](DContentOptions.md#width)
- [x](DContentOptions.md#x)
- [y](DContentOptions.md#y)
...
A renderability.
Unlike [visible](DContentOptions.md#visible), non-renderable element occupies a space.
...
• `Optional` **theme**: `string` \| [`DThemeContent`](DThemeContent.md)
