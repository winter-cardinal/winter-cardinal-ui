[Winter Cardinal UI - v0.310.1](../index.md) / DNoteSearchingOptions

# Interface: DNoteSearchingOptions<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeNoteSearching`](DThemeNoteSearching.md) = [`DThemeNoteSearching`](DThemeNoteSearching.md) |

## Hierarchy

- [`DNoteOptions`](DNoteOptions.md)<`THEME`\>

  ↳ **`DNoteSearchingOptions`**

## Table of contents

### Properties

- [background](DNoteSearchingOptions.md#background)
- [border](DNoteSearchingOptions.md#border)
- [children](DNoteSearchingOptions.md#children)
- [clear](DNoteSearchingOptions.md#clear)
- [corner](DNoteSearchingOptions.md#corner)
- [cursor](DNoteSearchingOptions.md#cursor)
- [height](DNoteSearchingOptions.md#height)
- [image](DNoteSearchingOptions.md#image)
- [interactive](DNoteSearchingOptions.md#interactive)
- [mask](DNoteSearchingOptions.md#mask)
- [name](DNoteSearchingOptions.md#name)
- [on](DNoteSearchingOptions.md#on)
- [outline](DNoteSearchingOptions.md#outline)
- [padding](DNoteSearchingOptions.md#padding)
- [parent](DNoteSearchingOptions.md#parent)
- [renderable](DNoteSearchingOptions.md#renderable)
- [shadow](DNoteSearchingOptions.md#shadow)
- [shortcut](DNoteSearchingOptions.md#shortcut)
- [shortcuts](DNoteSearchingOptions.md#shortcuts)
- [state](DNoteSearchingOptions.md#state)
- [text](DNoteSearchingOptions.md#text)
- [theme](DNoteSearchingOptions.md#theme)
- [title](DNoteSearchingOptions.md#title)
- [visible](DNoteSearchingOptions.md#visible)
- [weight](DNoteSearchingOptions.md#weight)
- [width](DNoteSearchingOptions.md#width)
- [x](DNoteSearchingOptions.md#x)
- [y](DNoteSearchingOptions.md#y)
...
A renderability.
Unlike [visible](DNoteSearchingOptions.md#visible), non-renderable element occupies a space.
