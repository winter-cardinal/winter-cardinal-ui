[Winter Cardinal UI - v0.310.1](../index.md) / DLayoutVerticalOptions
...
- [renderable](DLayoutVerticalOptions.md#renderable)
...
A renderability.
Unlike [visible](DLayoutVerticalOptions.md#visible), non-renderable element occupies a space.
