[Winter Cardinal UI - v0.310.1](../index.md) / DNotificationOptions

# Interface: DNotificationOptions<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeNotification`](DThemeNotification.md) |
...
- [background](DNotificationOptions.md#background)
- [border](DNotificationOptions.md#border)
- [children](DNotificationOptions.md#children)
- [clear](DNotificationOptions.md#clear)
- [corner](DNotificationOptions.md#corner)
- [cursor](DNotificationOptions.md#cursor)
- [height](DNotificationOptions.md#height)
- [interactive](DNotificationOptions.md#interactive)
- [name](DNotificationOptions.md#name)
- [on](DNotificationOptions.md#on)
- [outline](DNotificationOptions.md#outline)
- [padding](DNotificationOptions.md#padding)
- [parent](DNotificationOptions.md#parent)
- [renderable](DNotificationOptions.md#renderable)
- [shadow](DNotificationOptions.md#shadow)
- [shortcut](DNotificationOptions.md#shortcut)
- [shortcuts](DNotificationOptions.md#shortcuts)
- [state](DNotificationOptions.md#state)
- [theme](DNotificationOptions.md#theme)
- [title](DNotificationOptions.md#title)
- [visible](DNotificationOptions.md#visible)
- [weight](DNotificationOptions.md#weight)
- [width](DNotificationOptions.md#width)
- [x](DNotificationOptions.md#x)
- [y](DNotificationOptions.md#y)
...
A renderability.
Unlike [visible](DNotificationOptions.md#visible), non-renderable element occupies a space.
