[Winter Cardinal UI - v0.310.1](../index.md) / DDialogColorGradientOptions
...
[src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts:16](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-color-gradient.ts#L16)
...
A renderability.
Unlike [visible](DDialogColorGradientOptions.md#visible), non-renderable element occupies a space.
