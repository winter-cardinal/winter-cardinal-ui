[Winter Cardinal UI - v0.442.0](../index.md) / DDialogInputRealInputOptions

# Interface: DDialogInputRealInputOptions
...
- [`DInputRealOptions`](DInputRealOptions.md)
  ...
  ↳ **`DDialogInputRealInputOptions`**

## Table of contents

### Properties

- [after](DDialogInputRealInputOptions.md#after)
- [background](DDialogInputRealInputOptions.md#background)
- [before](DDialogInputRealInputOptions.md#before)
- [border](DDialogInputRealInputOptions.md#border)
- [children](DDialogInputRealInputOptions.md#children)
- [clear](DDialogInputRealInputOptions.md#clear)
- [clipper](DDialogInputRealInputOptions.md#clipper)
- [corner](DDialogInputRealInputOptions.md#corner)
- [cursor](DDialogInputRealInputOptions.md#cursor)
- [description](DDialogInputRealInputOptions.md#description)
- [editing](DDialogInputRealInputOptions.md#editing)
- [element](DDialogInputRealInputOptions.md#element)
- [height](DDialogInputRealInputOptions.md#height)
- [image](DDialogInputRealInputOptions.md#image)
- [images](DDialogInputRealInputOptions.md#images)
- [interactive](DDialogInputRealInputOptions.md#interactive)
- [margin](DDialogInputRealInputOptions.md#margin)
- [mask](DDialogInputRealInputOptions.md#mask)
- [max](DDialogInputRealInputOptions.md#max)
- [min](DDialogInputRealInputOptions.md#min)
- [name](DDialogInputRealInputOptions.md#name)
- [on](DDialogInputRealInputOptions.md#on)
- [outline](DDialogInputRealInputOptions.md#outline)
- [padding](DDialogInputRealInputOptions.md#padding)
- [parent](DDialogInputRealInputOptions.md#parent)
- [renderable](DDialogInputRealInputOptions.md#renderable)
- [select](DDialogInputRealInputOptions.md#select)
- [shadow](DDialogInputRealInputOptions.md#shadow)
- [shortcut](DDialogInputRealInputOptions.md#shortcut)
- [shortcuts](DDialogInputRealInputOptions.md#shortcuts)
- [state](DDialogInputRealInputOptions.md#state)
- [step](DDialogInputRealInputOptions.md#step)
- [text](DDialogInputRealInputOptions.md#text)
- [theme](DDialogInputRealInputOptions.md#theme)
- [title](DDialogInputRealInputOptions.md#title)
- [visible](DDialogInputRealInputOptions.md#visible)
- [weight](DDialogInputRealInputOptions.md#weight)
- [when](DDialogInputRealInputOptions.md#when)
- [width](DDialogInputRealInputOptions.md#width)
- [x](DDialogInputRealInputOptions.md#x)
- [y](DDialogInputRealInputOptions.md#y)
...
[DInputRealOptions](DInputRealOptions.md).[images](DInputRealOptions.md#images)
...
[src/main/typescript/wcardinal/ui/d-dialog-input-real.ts:10](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/d-dialog-input-real.ts#L10)
...
[DInputRealOptions](DInputRealOptions.md).[renderable](DInputRealOptions.md#renderable)
...
• `Optional` **theme**: `string` \| [`DThemeInputReal`](DThemeInputReal.md)
