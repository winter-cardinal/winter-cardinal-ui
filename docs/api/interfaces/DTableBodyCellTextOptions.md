[Winter Cardinal UI - v0.457.0](../index.md) / DTableBodyCellTextOptions
...
- [background](DTableBodyCellTextOptions.md#background)
- [border](DTableBodyCellTextOptions.md#border)
- [children](DTableBodyCellTextOptions.md#children)
- [clear](DTableBodyCellTextOptions.md#clear)
- [corner](DTableBodyCellTextOptions.md#corner)
- [cursor](DTableBodyCellTextOptions.md#cursor)
- [height](DTableBodyCellTextOptions.md#height)
- [image](DTableBodyCellTextOptions.md#image)
- [images](DTableBodyCellTextOptions.md#images)
- [interactive](DTableBodyCellTextOptions.md#interactive)
- [mask](DTableBodyCellTextOptions.md#mask)
- [name](DTableBodyCellTextOptions.md#name)
- [on](DTableBodyCellTextOptions.md#on)
- [outline](DTableBodyCellTextOptions.md#outline)
- [padding](DTableBodyCellTextOptions.md#padding)
- [parent](DTableBodyCellTextOptions.md#parent)
- [renderable](DTableBodyCellTextOptions.md#renderable)
- [shadow](DTableBodyCellTextOptions.md#shadow)
- [shortcut](DTableBodyCellTextOptions.md#shortcut)
- [shortcuts](DTableBodyCellTextOptions.md#shortcuts)
- [state](DTableBodyCellTextOptions.md#state)
- [text](DTableBodyCellTextOptions.md#text)
- [theme](DTableBodyCellTextOptions.md#theme)
- [title](DTableBodyCellTextOptions.md#title)
- [visible](DTableBodyCellTextOptions.md#visible)
- [weight](DTableBodyCellTextOptions.md#weight)
- [width](DTableBodyCellTextOptions.md#width)
- [x](DTableBodyCellTextOptions.md#x)
- [y](DTableBodyCellTextOptions.md#y)
