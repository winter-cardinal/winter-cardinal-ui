[Winter Cardinal UI - v0.310.1](../index.md) / DDialogFittedContentOptions
...
A renderability.
Unlike [visible](DDialogFittedContentOptions.md#visible), non-renderable element occupies a space.
