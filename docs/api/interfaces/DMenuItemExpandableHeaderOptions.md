[Winter Cardinal UI - v0.310.1](../index.md) / DMenuItemExpandableHeaderOptions
...
A renderability.
Unlike [visible](DMenuItemExpandableHeaderOptions.md#visible), non-renderable element occupies a space.
