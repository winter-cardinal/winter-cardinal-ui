[Winter Cardinal UI - v0.442.0](../index.md) / DTableHeaderOptions
...
[src/main/typescript/wcardinal/ui/d-table-header.ts:23](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/d-table-header.ts#L23)
