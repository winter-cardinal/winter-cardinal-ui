[Winter Cardinal UI - v0.407.0](../index.md) / DThemeDropdownBase
...
- [`DThemeButtonBase`](DThemeButtonBase.md)\<`TEXT_VALUE`\>
  ...
  ↳↳ [`DThemeSelectMultiple`](DThemeSelectMultiple.md)

  ↳↳ [`DThemeSelect`](DThemeSelect.md)
...
- [getAlpha](DThemeDropdownBase.md#getalpha)
- [getBackgroundAlpha](DThemeDropdownBase.md#getbackgroundalpha)
- [getBackgroundColor](DThemeDropdownBase.md#getbackgroundcolor)
- [getBackgroundTexture](DThemeDropdownBase.md#getbackgroundtexture)
- [getBorderAlign](DThemeDropdownBase.md#getborderalign)
- [getBorderAlpha](DThemeDropdownBase.md#getborderalpha)
- [getBorderColor](DThemeDropdownBase.md#getbordercolor)
- [getBorderMask](DThemeDropdownBase.md#getbordermask)
- [getBorderTexture](DThemeDropdownBase.md#getbordertexture)
- [getBorderWidth](DThemeDropdownBase.md#getborderwidth)
- [getClearType](DThemeDropdownBase.md#getcleartype)
- [getColor](DThemeDropdownBase.md#getcolor)
- [getCornerMask](DThemeDropdownBase.md#getcornermask)
- [getCornerRadius](DThemeDropdownBase.md#getcornerradius)
- [getCursor](DThemeDropdownBase.md#getcursor)
- [getFontFamilly](DThemeDropdownBase.md#getfontfamilly)
- [getFontSize](DThemeDropdownBase.md#getfontsize)
- [getFontStyle](DThemeDropdownBase.md#getfontstyle)
- [getFontVariant](DThemeDropdownBase.md#getfontvariant)
- [getFontWeight](DThemeDropdownBase.md#getfontweight)
- [getHeight](DThemeDropdownBase.md#getheight)
- [getImageAlignHorizontal](DThemeDropdownBase.md#getimagealignhorizontal)
- [getImageAlignVertical](DThemeDropdownBase.md#getimagealignvertical)
- [getImageAlignWith](DThemeDropdownBase.md#getimagealignwith)
- [getImageMarginHorizontal](DThemeDropdownBase.md#getimagemarginhorizontal)
- [getImageMarginVertial](DThemeDropdownBase.md#getimagemarginvertial)
- [getImageRotation](DThemeDropdownBase.md#getimagerotation)
- [getImageSource](DThemeDropdownBase.md#getimagesource)
- [getImageTintAlpha](DThemeDropdownBase.md#getimagetintalpha)
- [getImageTintColor](DThemeDropdownBase.md#getimagetintcolor)
- [getInteractive](DThemeDropdownBase.md#getinteractive)
- [getLineHeight](DThemeDropdownBase.md#getlineheight)
- [getOutlineAlign](DThemeDropdownBase.md#getoutlinealign)
- [getOutlineAlpha](DThemeDropdownBase.md#getoutlinealpha)
- [getOutlineColor](DThemeDropdownBase.md#getoutlinecolor)
- [getOutlineMask](DThemeDropdownBase.md#getoutlinemask)
- [getOutlineOffset](DThemeDropdownBase.md#getoutlineoffset)
- [getOutlineWidth](DThemeDropdownBase.md#getoutlinewidth)
- [getPaddingBottom](DThemeDropdownBase.md#getpaddingbottom)
- [getPaddingLeft](DThemeDropdownBase.md#getpaddingleft)
- [getPaddingRight](DThemeDropdownBase.md#getpaddingright)
- [getPaddingTop](DThemeDropdownBase.md#getpaddingtop)
- [getSecondaryImageAlignHorizontal](DThemeDropdownBase.md#getsecondaryimagealignhorizontal)
- [getSecondaryImageAlignVertical](DThemeDropdownBase.md#getsecondaryimagealignvertical)
- [getSecondaryImageAlignWith](DThemeDropdownBase.md#getsecondaryimagealignwith)
- [getSecondaryImageMarginHorizontal](DThemeDropdownBase.md#getsecondaryimagemarginhorizontal)
- [getSecondaryImageMarginVertial](DThemeDropdownBase.md#getsecondaryimagemarginvertial)
- [getSecondaryImageRotation](DThemeDropdownBase.md#getsecondaryimagerotation)
- [getSecondaryImageSource](DThemeDropdownBase.md#getsecondaryimagesource)
- [getSecondaryImageTintAlpha](DThemeDropdownBase.md#getsecondaryimagetintalpha)
- [getSecondaryImageTintColor](DThemeDropdownBase.md#getsecondaryimagetintcolor)
- [getShadow](DThemeDropdownBase.md#getshadow)
- [getTertiaryImageAlignHorizontal](DThemeDropdownBase.md#gettertiaryimagealignhorizontal)
- [getTertiaryImageAlignVertical](DThemeDropdownBase.md#gettertiaryimagealignvertical)
- [getTertiaryImageAlignWith](DThemeDropdownBase.md#gettertiaryimagealignwith)
- [getTertiaryImageMarginHorizontal](DThemeDropdownBase.md#gettertiaryimagemarginhorizontal)
- [getTertiaryImageMarginVertial](DThemeDropdownBase.md#gettertiaryimagemarginvertial)
- [getTertiaryImageRotation](DThemeDropdownBase.md#gettertiaryimagerotation)
- [getTertiaryImageSource](DThemeDropdownBase.md#gettertiaryimagesource)
- [getTertiaryImageTintAlpha](DThemeDropdownBase.md#gettertiaryimagetintalpha)
- [getTertiaryImageTintColor](DThemeDropdownBase.md#gettertiaryimagetintcolor)
- [getTextAlignHorizontal](DThemeDropdownBase.md#gettextalignhorizontal)
- [getTextAlignVertical](DThemeDropdownBase.md#gettextalignvertical)
- [getTextFormatter](DThemeDropdownBase.md#gettextformatter)
- [getTextStyleClipping](DThemeDropdownBase.md#gettextstyleclipping)
- [getTextStyleFitting](DThemeDropdownBase.md#gettextstylefitting)
- [getTextStyleWordWrap](DThemeDropdownBase.md#gettextstylewordwrap)
- [getTextValue](DThemeDropdownBase.md#gettextvalue)
- [getTitle](DThemeDropdownBase.md#gettitle)
- [getWeight](DThemeDropdownBase.md#getweight)
- [getWhen](DThemeDropdownBase.md#getwhen)
- [getWidth](DThemeDropdownBase.md#getwidth)
- [getX](DThemeDropdownBase.md#getx)
- [getY](DThemeDropdownBase.md#gety)
- [isOverflowMaskEnabled](DThemeDropdownBase.md#isoverflowmaskenabled)
- [isToggle](DThemeDropdownBase.md#istoggle)
- [newShadow](DThemeDropdownBase.md#newshadow)
- [newShadowWeak](DThemeDropdownBase.md#newshadowweak)
- [newState](DThemeDropdownBase.md#newstate)
- [newTextValue](DThemeDropdownBase.md#newtextvalue)
...
▸ **getTextFormatter**(): [`DTextPieceFormatter`](../index.md#dtextpieceformatter)\<`TEXT_VALUE`\>

#### Returns

[`DTextPieceFormatter`](../index.md#dtextpieceformatter)\<`TEXT_VALUE`\>
