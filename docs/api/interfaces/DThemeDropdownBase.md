[Winter Cardinal UI](../README.md) / DThemeDropdownBase
...
▸ **newTextValue**(): [`DStateAwareOrValueMightBe`](../README.md#dstateawareorvaluemightbe)<`TEXT_VALUE`\>
...
[`DStateAwareOrValueMightBe`](../README.md#dstateawareorvaluemightbe)<`TEXT_VALUE`\>
