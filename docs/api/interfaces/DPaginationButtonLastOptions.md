[Winter Cardinal UI - v0.310.1](../index.md) / DPaginationButtonLastOptions
...
A renderability.
Unlike [visible](DPaginationButtonLastOptions.md#visible), non-renderable element occupies a space.
