[Winter Cardinal UI - v0.205.1](../index.md) / DPaginationButtonLastOptions

# Interface: DPaginationButtonLastOptions<THEME\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemePaginationButtonLast`](DThemePaginationButtonLast.md) = [`DThemePaginationButtonLast`](DThemePaginationButtonLast.md) |

## Hierarchy

- [`DButtonAmbientOptions`](DButtonAmbientOptions.md)<`string`, `THEME`\>

  ↳ **`DPaginationButtonLastOptions`**

## Table of contents

### Properties

- [background](DPaginationButtonLastOptions.md#background)
- [border](DPaginationButtonLastOptions.md#border)
- [children](DPaginationButtonLastOptions.md#children)
- [clear](DPaginationButtonLastOptions.md#clear)
- [corner](DPaginationButtonLastOptions.md#corner)
- [cursor](DPaginationButtonLastOptions.md#cursor)
- [group](DPaginationButtonLastOptions.md#group)
- [height](DPaginationButtonLastOptions.md#height)
- [image](DPaginationButtonLastOptions.md#image)
- [interactive](DPaginationButtonLastOptions.md#interactive)
- [mask](DPaginationButtonLastOptions.md#mask)
- [name](DPaginationButtonLastOptions.md#name)
- [on](DPaginationButtonLastOptions.md#on)
- [outline](DPaginationButtonLastOptions.md#outline)
- [padding](DPaginationButtonLastOptions.md#padding)
- [parent](DPaginationButtonLastOptions.md#parent)
- [shadow](DPaginationButtonLastOptions.md#shadow)
- [shortcut](DPaginationButtonLastOptions.md#shortcut)
- [shortcuts](DPaginationButtonLastOptions.md#shortcuts)
- [state](DPaginationButtonLastOptions.md#state)
- [text](DPaginationButtonLastOptions.md#text)
- [theme](DPaginationButtonLastOptions.md#theme)
- [title](DPaginationButtonLastOptions.md#title)
- [toggle](DPaginationButtonLastOptions.md#toggle)
- [visible](DPaginationButtonLastOptions.md#visible)
- [weight](DPaginationButtonLastOptions.md#weight)
- [when](DPaginationButtonLastOptions.md#when)
- [width](DPaginationButtonLastOptions.md#width)
- [x](DPaginationButtonLastOptions.md#x)
- [y](DPaginationButtonLastOptions.md#y)
