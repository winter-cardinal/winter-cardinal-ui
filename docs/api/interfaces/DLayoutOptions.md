[Winter Cardinal UI - v0.310.1](../index.md) / DLayoutOptions
...
- [renderable](DLayoutOptions.md#renderable)
...
A renderability.
Unlike [visible](DLayoutOptions.md#visible), non-renderable element occupies a space.
