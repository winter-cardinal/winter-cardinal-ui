[Winter Cardinal UI - v0.199.0](../index.md) / DLayoutOptions

# Interface: DLayoutOptions<THEME\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeLayout`](DThemeLayout.md) = [`DThemeLayout`](DThemeLayout.md) |
...
- [`DBaseOptions`](DBaseOptions.md)<`THEME`\>
  ...
  ↳↳ [`DInputAndLabelOptions`](DInputAndLabelOptions.md)

  ↳↳ [`DInputBooleanOptions`](DInputBooleanOptions.md)

  ↳↳ [`DLayoutHorizontalOptions`](DLayoutHorizontalOptions.md)

  ↳↳ [`DLayoutVerticalOptions`](DLayoutVerticalOptions.md)

## Table of contents

### Properties

- [background](DLayoutOptions.md#background)
- [border](DLayoutOptions.md#border)
- [children](DLayoutOptions.md#children)
- [clear](DLayoutOptions.md#clear)
- [column](DLayoutOptions.md#column)
- [corner](DLayoutOptions.md#corner)
- [cursor](DLayoutOptions.md#cursor)
- [direction](DLayoutOptions.md#direction)
- [height](DLayoutOptions.md#height)
- [interactive](DLayoutOptions.md#interactive)
- [margin](DLayoutOptions.md#margin)
- [name](DLayoutOptions.md#name)
- [on](DLayoutOptions.md#on)
- [outline](DLayoutOptions.md#outline)
- [padding](DLayoutOptions.md#padding)
- [parent](DLayoutOptions.md#parent)
- [reverse](DLayoutOptions.md#reverse)
- [row](DLayoutOptions.md#row)
- [shadow](DLayoutOptions.md#shadow)
- [shortcut](DLayoutOptions.md#shortcut)
- [shortcuts](DLayoutOptions.md#shortcuts)
- [state](DLayoutOptions.md#state)
- [theme](DLayoutOptions.md#theme)
- [title](DLayoutOptions.md#title)
- [visible](DLayoutOptions.md#visible)
- [weight](DLayoutOptions.md#weight)
- [width](DLayoutOptions.md#width)
- [x](DLayoutOptions.md#x)
- [y](DLayoutOptions.md#y)
