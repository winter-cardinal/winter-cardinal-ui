[Winter Cardinal UI - v0.310.1](../index.md) / DHtmlElementOptions
...
- [renderable](DHtmlElementOptions.md#renderable)
...
A renderability.
Unlike [visible](DHtmlElementOptions.md#visible), non-renderable element occupies a space.
