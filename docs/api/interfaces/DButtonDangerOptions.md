[Winter Cardinal UI - v0.199.0](../index.md) / DButtonDangerOptions

# Interface: DButtonDangerOptions<VALUE, THEME\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeButtonDanger`](DThemeButtonDanger.md)<`VALUE`\> = [`DThemeButtonDanger`](DThemeButtonDanger.md)<`VALUE`\> |

## Hierarchy

- [`DButtonOptions`](DButtonOptions.md)<`VALUE`, `THEME`\>

  ↳ **`DButtonDangerOptions`**

## Table of contents

### Properties

- [background](DButtonDangerOptions.md#background)
- [border](DButtonDangerOptions.md#border)
- [children](DButtonDangerOptions.md#children)
- [clear](DButtonDangerOptions.md#clear)
- [corner](DButtonDangerOptions.md#corner)
- [cursor](DButtonDangerOptions.md#cursor)
- [group](DButtonDangerOptions.md#group)
- [height](DButtonDangerOptions.md#height)
- [image](DButtonDangerOptions.md#image)
- [interactive](DButtonDangerOptions.md#interactive)
- [mask](DButtonDangerOptions.md#mask)
- [name](DButtonDangerOptions.md#name)
- [on](DButtonDangerOptions.md#on)
- [outline](DButtonDangerOptions.md#outline)
- [padding](DButtonDangerOptions.md#padding)
- [parent](DButtonDangerOptions.md#parent)
- [shadow](DButtonDangerOptions.md#shadow)
- [shortcut](DButtonDangerOptions.md#shortcut)
- [shortcuts](DButtonDangerOptions.md#shortcuts)
- [state](DButtonDangerOptions.md#state)
- [text](DButtonDangerOptions.md#text)
- [theme](DButtonDangerOptions.md#theme)
- [title](DButtonDangerOptions.md#title)
- [toggle](DButtonDangerOptions.md#toggle)
- [visible](DButtonDangerOptions.md#visible)
- [weight](DButtonDangerOptions.md#weight)
- [when](DButtonDangerOptions.md#when)
- [width](DButtonDangerOptions.md#width)
- [x](DButtonDangerOptions.md#x)
- [y](DButtonDangerOptions.md#y)
