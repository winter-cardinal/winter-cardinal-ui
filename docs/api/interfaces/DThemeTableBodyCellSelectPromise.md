[Winter Cardinal UI - v0.407.0](../index.md) / DThemeTableBodyCellSelectPromise

# Interface: DThemeTableBodyCellSelectPromise\<VALUE\>
...
- [`DThemeButton`](DThemeButton.md)\<`VALUE` \| ``null``\>

  ↳ **`DThemeTableBodyCellSelectPromise`**

  ↳↳ [`DThemeTableBodyCellActionPromise`](DThemeTableBodyCellActionPromise.md)
...
- [getAlpha](DThemeTableBodyCellSelectPromise.md#getalpha)
- [getBackgroundAlpha](DThemeTableBodyCellSelectPromise.md#getbackgroundalpha)
- [getBackgroundColor](DThemeTableBodyCellSelectPromise.md#getbackgroundcolor)
- [getBackgroundTexture](DThemeTableBodyCellSelectPromise.md#getbackgroundtexture)
- [getBorderAlign](DThemeTableBodyCellSelectPromise.md#getborderalign)
- [getBorderAlpha](DThemeTableBodyCellSelectPromise.md#getborderalpha)
- [getBorderColor](DThemeTableBodyCellSelectPromise.md#getbordercolor)
- [getBorderMask](DThemeTableBodyCellSelectPromise.md#getbordermask)
- [getBorderTexture](DThemeTableBodyCellSelectPromise.md#getbordertexture)
- [getBorderWidth](DThemeTableBodyCellSelectPromise.md#getborderwidth)
- [getClearType](DThemeTableBodyCellSelectPromise.md#getcleartype)
- [getColor](DThemeTableBodyCellSelectPromise.md#getcolor)
- [getCornerMask](DThemeTableBodyCellSelectPromise.md#getcornermask)
- [getCornerRadius](DThemeTableBodyCellSelectPromise.md#getcornerradius)
- [getCursor](DThemeTableBodyCellSelectPromise.md#getcursor)
- [getFontFamilly](DThemeTableBodyCellSelectPromise.md#getfontfamilly)
- [getFontSize](DThemeTableBodyCellSelectPromise.md#getfontsize)
- [getFontStyle](DThemeTableBodyCellSelectPromise.md#getfontstyle)
- [getFontVariant](DThemeTableBodyCellSelectPromise.md#getfontvariant)
- [getFontWeight](DThemeTableBodyCellSelectPromise.md#getfontweight)
- [getHeight](DThemeTableBodyCellSelectPromise.md#getheight)
- [getImageAlignHorizontal](DThemeTableBodyCellSelectPromise.md#getimagealignhorizontal)
- [getImageAlignVertical](DThemeTableBodyCellSelectPromise.md#getimagealignvertical)
- [getImageAlignWith](DThemeTableBodyCellSelectPromise.md#getimagealignwith)
- [getImageMarginHorizontal](DThemeTableBodyCellSelectPromise.md#getimagemarginhorizontal)
- [getImageMarginVertial](DThemeTableBodyCellSelectPromise.md#getimagemarginvertial)
- [getImageRotation](DThemeTableBodyCellSelectPromise.md#getimagerotation)
- [getImageSource](DThemeTableBodyCellSelectPromise.md#getimagesource)
- [getImageTintAlpha](DThemeTableBodyCellSelectPromise.md#getimagetintalpha)
- [getImageTintColor](DThemeTableBodyCellSelectPromise.md#getimagetintcolor)
- [getInteractive](DThemeTableBodyCellSelectPromise.md#getinteractive)
- [getLineHeight](DThemeTableBodyCellSelectPromise.md#getlineheight)
- [getOutlineAlign](DThemeTableBodyCellSelectPromise.md#getoutlinealign)
- [getOutlineAlpha](DThemeTableBodyCellSelectPromise.md#getoutlinealpha)
- [getOutlineColor](DThemeTableBodyCellSelectPromise.md#getoutlinecolor)
- [getOutlineMask](DThemeTableBodyCellSelectPromise.md#getoutlinemask)
- [getOutlineOffset](DThemeTableBodyCellSelectPromise.md#getoutlineoffset)
- [getOutlineWidth](DThemeTableBodyCellSelectPromise.md#getoutlinewidth)
- [getPaddingBottom](DThemeTableBodyCellSelectPromise.md#getpaddingbottom)
- [getPaddingLeft](DThemeTableBodyCellSelectPromise.md#getpaddingleft)
- [getPaddingRight](DThemeTableBodyCellSelectPromise.md#getpaddingright)
- [getPaddingTop](DThemeTableBodyCellSelectPromise.md#getpaddingtop)
- [getSecondaryImageAlignHorizontal](DThemeTableBodyCellSelectPromise.md#getsecondaryimagealignhorizontal)
- [getSecondaryImageAlignVertical](DThemeTableBodyCellSelectPromise.md#getsecondaryimagealignvertical)
- [getSecondaryImageAlignWith](DThemeTableBodyCellSelectPromise.md#getsecondaryimagealignwith)
- [getSecondaryImageMarginHorizontal](DThemeTableBodyCellSelectPromise.md#getsecondaryimagemarginhorizontal)
- [getSecondaryImageMarginVertial](DThemeTableBodyCellSelectPromise.md#getsecondaryimagemarginvertial)
- [getSecondaryImageRotation](DThemeTableBodyCellSelectPromise.md#getsecondaryimagerotation)
- [getSecondaryImageSource](DThemeTableBodyCellSelectPromise.md#getsecondaryimagesource)
- [getSecondaryImageTintAlpha](DThemeTableBodyCellSelectPromise.md#getsecondaryimagetintalpha)
- [getSecondaryImageTintColor](DThemeTableBodyCellSelectPromise.md#getsecondaryimagetintcolor)
- [getShadow](DThemeTableBodyCellSelectPromise.md#getshadow)
- [getTertiaryImageAlignHorizontal](DThemeTableBodyCellSelectPromise.md#gettertiaryimagealignhorizontal)
- [getTertiaryImageAlignVertical](DThemeTableBodyCellSelectPromise.md#gettertiaryimagealignvertical)
- [getTertiaryImageAlignWith](DThemeTableBodyCellSelectPromise.md#gettertiaryimagealignwith)
- [getTertiaryImageMarginHorizontal](DThemeTableBodyCellSelectPromise.md#gettertiaryimagemarginhorizontal)
- [getTertiaryImageMarginVertial](DThemeTableBodyCellSelectPromise.md#gettertiaryimagemarginvertial)
- [getTertiaryImageRotation](DThemeTableBodyCellSelectPromise.md#gettertiaryimagerotation)
- [getTertiaryImageSource](DThemeTableBodyCellSelectPromise.md#gettertiaryimagesource)
- [getTertiaryImageTintAlpha](DThemeTableBodyCellSelectPromise.md#gettertiaryimagetintalpha)
- [getTertiaryImageTintColor](DThemeTableBodyCellSelectPromise.md#gettertiaryimagetintcolor)
- [getTextAlignHorizontal](DThemeTableBodyCellSelectPromise.md#gettextalignhorizontal)
- [getTextAlignVertical](DThemeTableBodyCellSelectPromise.md#gettextalignvertical)
- [getTextFormatter](DThemeTableBodyCellSelectPromise.md#gettextformatter)
- [getTextStyleClipping](DThemeTableBodyCellSelectPromise.md#gettextstyleclipping)
- [getTextStyleFitting](DThemeTableBodyCellSelectPromise.md#gettextstylefitting)
- [getTextStyleWordWrap](DThemeTableBodyCellSelectPromise.md#gettextstylewordwrap)
- [getTextValue](DThemeTableBodyCellSelectPromise.md#gettextvalue)
- [getTitle](DThemeTableBodyCellSelectPromise.md#gettitle)
- [getWeight](DThemeTableBodyCellSelectPromise.md#getweight)
- [getWhen](DThemeTableBodyCellSelectPromise.md#getwhen)
- [getWidth](DThemeTableBodyCellSelectPromise.md#getwidth)
- [getX](DThemeTableBodyCellSelectPromise.md#getx)
- [getY](DThemeTableBodyCellSelectPromise.md#gety)
- [isOverflowMaskEnabled](DThemeTableBodyCellSelectPromise.md#isoverflowmaskenabled)
- [isSyncEnabled](DThemeTableBodyCellSelectPromise.md#issyncenabled)
- [isToggle](DThemeTableBodyCellSelectPromise.md#istoggle)
- [newShadow](DThemeTableBodyCellSelectPromise.md#newshadow)
- [newShadowWeak](DThemeTableBodyCellSelectPromise.md#newshadowweak)
- [newState](DThemeTableBodyCellSelectPromise.md#newstate)
- [newTextValue](DThemeTableBodyCellSelectPromise.md#newtextvalue)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-select-promise.ts:26](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-table-body-cell-select-promise.ts#L26)
