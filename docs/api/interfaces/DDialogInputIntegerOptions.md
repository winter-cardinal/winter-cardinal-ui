[Winter Cardinal UI - v0.310.1](../index.md) / DDialogInputIntegerOptions
...
A renderability.
Unlike [visible](DDialogInputIntegerOptions.md#visible), non-renderable element occupies a space.
