[Winter Cardinal UI - v0.310.1](../index.md) / DPaginationDotsOptions

# Interface: DPaginationDotsOptions<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemePaginationDots`](DThemePaginationDots.md) = [`DThemePaginationDots`](DThemePaginationDots.md) |

## Hierarchy

- [`DImageBaseOptions`](DImageBaseOptions.md)<`string`, `THEME`\>

  ↳ **`DPaginationDotsOptions`**

## Table of contents

### Properties

- [background](DPaginationDotsOptions.md#background)
- [border](DPaginationDotsOptions.md#border)
- [children](DPaginationDotsOptions.md#children)
- [clear](DPaginationDotsOptions.md#clear)
- [corner](DPaginationDotsOptions.md#corner)
- [cursor](DPaginationDotsOptions.md#cursor)
- [height](DPaginationDotsOptions.md#height)
- [image](DPaginationDotsOptions.md#image)
- [interactive](DPaginationDotsOptions.md#interactive)
- [mask](DPaginationDotsOptions.md#mask)
- [name](DPaginationDotsOptions.md#name)
- [on](DPaginationDotsOptions.md#on)
- [outline](DPaginationDotsOptions.md#outline)
- [padding](DPaginationDotsOptions.md#padding)
- [parent](DPaginationDotsOptions.md#parent)
- [renderable](DPaginationDotsOptions.md#renderable)
- [shadow](DPaginationDotsOptions.md#shadow)
- [shortcut](DPaginationDotsOptions.md#shortcut)
- [shortcuts](DPaginationDotsOptions.md#shortcuts)
- [state](DPaginationDotsOptions.md#state)
- [text](DPaginationDotsOptions.md#text)
- [theme](DPaginationDotsOptions.md#theme)
- [title](DPaginationDotsOptions.md#title)
- [visible](DPaginationDotsOptions.md#visible)
- [weight](DPaginationDotsOptions.md#weight)
- [width](DPaginationDotsOptions.md#width)
- [x](DPaginationDotsOptions.md#x)
- [y](DPaginationDotsOptions.md#y)
...
A renderability.
Unlike [visible](DPaginationDotsOptions.md#visible), non-renderable element occupies a space.
