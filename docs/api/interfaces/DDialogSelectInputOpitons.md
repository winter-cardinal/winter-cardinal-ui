[Winter Cardinal UI - v0.310.1](../index.md) / DDialogSelectInputOpitons
...
[src/main/typescript/wcardinal/ui/d-dialog-select.ts:32](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-select.ts#L32)
...
A renderability.
Unlike [visible](DDialogSelectInputOpitons.md#visible), non-renderable element occupies a space.
