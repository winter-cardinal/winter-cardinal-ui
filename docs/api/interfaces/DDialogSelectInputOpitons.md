[Winter Cardinal UI - v0.160.0](../index.md) / DDialogSelectInputOpitons
...
• `Optional` **margin**: [`DDialogSelectInputMarginOptions`](DDialogSelectInputMarginOptions.md)

#### Defined in

[src/main/typescript/wcardinal/ui/d-dialog-select.ts:37](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-select.ts#L37)
