[Winter Cardinal UI - v0.407.0](../index.md) / DTableBodyCellSelectDialogOptions
...
- [images](DTableBodyCellSelectDialogOptions.md#images)
...
- [renderable](DTableBodyCellSelectDialogOptions.md#renderable)
...
[src/main/typescript/wcardinal/ui/d-button.ts:34](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-button.ts#L34)
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-select-dialog.ts:21](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.407.0/src/main/typescript/wcardinal/ui/d-table-body-cell-select-dialog.ts#L21)
