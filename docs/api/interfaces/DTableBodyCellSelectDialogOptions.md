[Winter Cardinal UI - v0.310.1](../index.md) / DTableBodyCellSelectDialogOptions
...
A renderability.
Unlike [visible](DTableBodyCellSelectDialogOptions.md#visible), non-renderable element occupies a space.
