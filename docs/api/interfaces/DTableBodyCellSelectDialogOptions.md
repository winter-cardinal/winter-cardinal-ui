[Winter Cardinal UI - v0.442.0](../index.md) / DTableBodyCellSelectDialogOptions
...
[src/main/typescript/wcardinal/ui/d-table-body-cell-select-dialog.ts:21](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.442.0/src/main/typescript/wcardinal/ui/d-table-body-cell-select-dialog.ts#L21)
