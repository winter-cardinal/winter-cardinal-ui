[Winter Cardinal UI - v0.310.1](../index.md) / DDialogLayeredOnOptions

# Interface: DDialogLayeredOnOptions<VALUE, EMITTER\>

[DDialogLayered](../classes/DDialogLayered.md) "on" options.
...
- `Partial`<[`DDialogLayeredEvents`](DDialogLayeredEvents.md)<`VALUE`, `EMITTER`\>\>

- `DOnOptions`

  ↳ **`DDialogLayeredOnOptions`**

## Table of contents

### Methods

- [added](DDialogLayeredOnOptions.md#added)
- [cancel](DDialogLayeredOnOptions.md#cancel)
- [click](DDialogLayeredOnOptions.md#click)
- [close](DDialogLayeredOnOptions.md#close)
- [dblclick](DDialogLayeredOnOptions.md#dblclick)
- [down](DDialogLayeredOnOptions.md#down)
- [init](DDialogLayeredOnOptions.md#init)
- [keydown](DDialogLayeredOnOptions.md#keydown)
- [keyup](DDialogLayeredOnOptions.md#keyup)
- [move](DDialogLayeredOnOptions.md#move)
- [ok](DDialogLayeredOnOptions.md#ok)
- [open](DDialogLayeredOnOptions.md#open)
- [out](DDialogLayeredOnOptions.md#out)
- [over](DDialogLayeredOnOptions.md#over)
- [removed](DDialogLayeredOnOptions.md#removed)
- [resize](DDialogLayeredOnOptions.md#resize)
- [scale](DDialogLayeredOnOptions.md#scale)
- [shortcut](DDialogLayeredOnOptions.md#shortcut)
- [skew](DDialogLayeredOnOptions.md#skew)
- [statechange](DDialogLayeredOnOptions.md#statechange)
- [up](DDialogLayeredOnOptions.md#up)
- [wheel](DDialogLayeredOnOptions.md#wheel)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered.ts:33](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-layered.ts#L33)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:46](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog.ts#L46)
...
[src/main/typescript/wcardinal/ui/d-dialog-layered.ts:25](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-layered.ts#L25)
...
[src/main/typescript/wcardinal/ui/d-dialog.ts:39](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog.ts#L39)
