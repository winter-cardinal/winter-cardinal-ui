[Winter Cardinal UI - v0.414.0](../index.md) / DButtonColorGradientOptions
...
- [images](DButtonColorGradientOptions.md#images)
...
- [renderable](DButtonColorGradientOptions.md#renderable)
...
[src/main/typescript/wcardinal/ui/d-button-color-gradient.ts:47](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-button-color-gradient.ts#L47)
...
[src/main/typescript/wcardinal/ui/d-button-color-gradient.ts:48](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.414.0/src/main/typescript/wcardinal/ui/d-button-color-gradient.ts#L48)
...
• `Optional` **text**: [`DTextPieceOptions`](DTextPieceOptions.md)\<[`DColorGradientObservable`](../classes/DColorGradientObservable.md)\>
