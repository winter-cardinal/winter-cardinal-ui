[Winter Cardinal UI - v0.205.1](../index.md) / DButtonSecondaryOptions

# Interface: DButtonSecondaryOptions<VALUE, THEME\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeButtonSecondary`](DThemeButtonSecondary.md)<`VALUE`\> = [`DThemeButtonSecondary`](DThemeButtonSecondary.md)<`VALUE`\> |

## Hierarchy

- [`DButtonOptions`](DButtonOptions.md)<`VALUE`, `THEME`\>

  ↳ **`DButtonSecondaryOptions`**

## Table of contents

### Properties

- [background](DButtonSecondaryOptions.md#background)
- [border](DButtonSecondaryOptions.md#border)
- [children](DButtonSecondaryOptions.md#children)
- [clear](DButtonSecondaryOptions.md#clear)
- [corner](DButtonSecondaryOptions.md#corner)
- [cursor](DButtonSecondaryOptions.md#cursor)
- [group](DButtonSecondaryOptions.md#group)
- [height](DButtonSecondaryOptions.md#height)
- [image](DButtonSecondaryOptions.md#image)
- [interactive](DButtonSecondaryOptions.md#interactive)
- [mask](DButtonSecondaryOptions.md#mask)
- [name](DButtonSecondaryOptions.md#name)
- [on](DButtonSecondaryOptions.md#on)
- [outline](DButtonSecondaryOptions.md#outline)
- [padding](DButtonSecondaryOptions.md#padding)
- [parent](DButtonSecondaryOptions.md#parent)
- [shadow](DButtonSecondaryOptions.md#shadow)
- [shortcut](DButtonSecondaryOptions.md#shortcut)
- [shortcuts](DButtonSecondaryOptions.md#shortcuts)
- [state](DButtonSecondaryOptions.md#state)
- [text](DButtonSecondaryOptions.md#text)
- [theme](DButtonSecondaryOptions.md#theme)
- [title](DButtonSecondaryOptions.md#title)
- [toggle](DButtonSecondaryOptions.md#toggle)
- [visible](DButtonSecondaryOptions.md#visible)
- [weight](DButtonSecondaryOptions.md#weight)
- [when](DButtonSecondaryOptions.md#when)
- [width](DButtonSecondaryOptions.md#width)
- [x](DButtonSecondaryOptions.md#x)
- [y](DButtonSecondaryOptions.md#y)
