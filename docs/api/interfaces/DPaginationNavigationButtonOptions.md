[Winter Cardinal UI - v0.154.0](../index.md) / DPaginationNavigationButtonOptions

# Interface: DPaginationNavigationButtonOptions<VALUE, THEME\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemePaginationNavigationButton`](DThemePaginationNavigationButton.md)<`VALUE`\> = [`DThemePaginationNavigationButton`](DThemePaginationNavigationButton.md)<`VALUE`\> |

## Hierarchy

- [`DButtonAmbientOptions`](DButtonAmbientOptions.md)<`VALUE`, `THEME`\>

  ↳ **`DPaginationNavigationButtonOptions`**

## Table of contents

### Properties

- [background](DPaginationNavigationButtonOptions.md#background)
- [border](DPaginationNavigationButtonOptions.md#border)
- [children](DPaginationNavigationButtonOptions.md#children)
- [clear](DPaginationNavigationButtonOptions.md#clear)
- [corner](DPaginationNavigationButtonOptions.md#corner)
- [cursor](DPaginationNavigationButtonOptions.md#cursor)
- [group](DPaginationNavigationButtonOptions.md#group)
- [height](DPaginationNavigationButtonOptions.md#height)
- [image](DPaginationNavigationButtonOptions.md#image)
- [interactive](DPaginationNavigationButtonOptions.md#interactive)
- [mask](DPaginationNavigationButtonOptions.md#mask)
- [name](DPaginationNavigationButtonOptions.md#name)
- [on](DPaginationNavigationButtonOptions.md#on)
- [outline](DPaginationNavigationButtonOptions.md#outline)
- [padding](DPaginationNavigationButtonOptions.md#padding)
- [parent](DPaginationNavigationButtonOptions.md#parent)
- [shadow](DPaginationNavigationButtonOptions.md#shadow)
- [shortcut](DPaginationNavigationButtonOptions.md#shortcut)
- [shortcuts](DPaginationNavigationButtonOptions.md#shortcuts)
- [state](DPaginationNavigationButtonOptions.md#state)
- [text](DPaginationNavigationButtonOptions.md#text)
- [theme](DPaginationNavigationButtonOptions.md#theme)
- [title](DPaginationNavigationButtonOptions.md#title)
- [toggle](DPaginationNavigationButtonOptions.md#toggle)
- [visible](DPaginationNavigationButtonOptions.md#visible)
- [weight](DPaginationNavigationButtonOptions.md#weight)
- [when](DPaginationNavigationButtonOptions.md#when)
- [width](DPaginationNavigationButtonOptions.md#width)
- [x](DPaginationNavigationButtonOptions.md#x)
- [y](DPaginationNavigationButtonOptions.md#y)
