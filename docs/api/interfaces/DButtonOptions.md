[Winter Cardinal UI - v0.199.0](../index.md) / DButtonOptions

# Interface: DButtonOptions<VALUE, THEME, EMITTER\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemeButton`](DThemeButton.md)<`VALUE`\> = [`DThemeButton`](DThemeButton.md)<`VALUE`\> |
| `EMITTER` | `any` |

## Hierarchy

- [`DButtonBaseOptions`](DButtonBaseOptions.md)<`VALUE`, `THEME`, `EMITTER`\>

  ↳ **`DButtonOptions`**

  ↳↳ [`DButtonAmbientOptions`](DButtonAmbientOptions.md)

  ↳↳ [`DButtonColorGradientOptions`](DButtonColorGradientOptions.md)

  ↳↳ [`DButtonColorOptions`](DButtonColorOptions.md)

  ↳↳ [`DButtonDangerOptions`](DButtonDangerOptions.md)

  ↳↳ [`DButtonDateOptions`](DButtonDateOptions.md)

  ↳↳ [`DButtonDatetimeOptions`](DButtonDatetimeOptions.md)

  ↳↳ [`DButtonFileOptions`](DButtonFileOptions.md)

  ↳↳ [`DButtonPrimaryOptions`](DButtonPrimaryOptions.md)

  ↳↳ [`DButtonSecondaryOptions`](DButtonSecondaryOptions.md)

  ↳↳ [`DButtonSelectOptions`](DButtonSelectOptions.md)

  ↳↳ [`DButtonTimeOptions`](DButtonTimeOptions.md)

  ↳↳ [`DInputBooleanButtonOffOptions`](DInputBooleanButtonOffOptions.md)

  ↳↳ [`DInputBooleanButtonOnOptions`](DInputBooleanButtonOnOptions.md)

  ↳↳ [`DMenuBarItemOptions`](DMenuBarItemOptions.md)

  ↳↳ [`DSliderThumbOptions`](DSliderThumbOptions.md)

  ↳↳ [`DSliderTrackOptions`](DSliderTrackOptions.md)

  ↳↳ [`DTableBodyCellSelectDialogOptions`](DTableBodyCellSelectDialogOptions.md)

  ↳↳ [`DTableBodyCellSelectPromiseOptions`](DTableBodyCellSelectPromiseOptions.md)

## Table of contents

### Properties

- [background](DButtonOptions.md#background)
- [border](DButtonOptions.md#border)
- [children](DButtonOptions.md#children)
- [clear](DButtonOptions.md#clear)
- [corner](DButtonOptions.md#corner)
- [cursor](DButtonOptions.md#cursor)
- [group](DButtonOptions.md#group)
- [height](DButtonOptions.md#height)
- [image](DButtonOptions.md#image)
- [interactive](DButtonOptions.md#interactive)
- [mask](DButtonOptions.md#mask)
- [name](DButtonOptions.md#name)
- [on](DButtonOptions.md#on)
- [outline](DButtonOptions.md#outline)
- [padding](DButtonOptions.md#padding)
- [parent](DButtonOptions.md#parent)
- [shadow](DButtonOptions.md#shadow)
- [shortcut](DButtonOptions.md#shortcut)
- [shortcuts](DButtonOptions.md#shortcuts)
- [state](DButtonOptions.md#state)
- [text](DButtonOptions.md#text)
- [theme](DButtonOptions.md#theme)
- [title](DButtonOptions.md#title)
- [toggle](DButtonOptions.md#toggle)
- [visible](DButtonOptions.md#visible)
- [weight](DButtonOptions.md#weight)
- [when](DButtonOptions.md#when)
- [width](DButtonOptions.md#width)
- [x](DButtonOptions.md#x)
- [y](DButtonOptions.md#y)
...
• `Optional` **on**: [`DButtonOnOptions`](DButtonOnOptions.md)<`VALUE`, `EMITTER`\>
