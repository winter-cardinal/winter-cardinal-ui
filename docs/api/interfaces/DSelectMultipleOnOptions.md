[Winter Cardinal UI - v0.457.0](../index.md) / DSelectMultipleOnOptions

# Interface: DSelectMultipleOnOptions\<VALUE, EMITTER\>

[DSelectMultiple](../classes/DSelectMultiple.md) "on" options.
...
- `Partial`\<[`DSelectMultipleEvents`](DSelectMultipleEvents.md)\<`VALUE`, `EMITTER`\>\>

- `DOnOptions`

  ↳ **`DSelectMultipleOnOptions`**

## Table of contents

### Methods

- [active](DSelectMultipleOnOptions.md#active)
- [added](DSelectMultipleOnOptions.md#added)
- [change](DSelectMultipleOnOptions.md#change)
- [click](DSelectMultipleOnOptions.md#click)
- [dblclick](DSelectMultipleOnOptions.md#dblclick)
- [down](DSelectMultipleOnOptions.md#down)
- [inactive](DSelectMultipleOnOptions.md#inactive)
- [init](DSelectMultipleOnOptions.md#init)
- [keydown](DSelectMultipleOnOptions.md#keydown)
- [keyup](DSelectMultipleOnOptions.md#keyup)
- [move](DSelectMultipleOnOptions.md#move)
- [open](DSelectMultipleOnOptions.md#open)
- [out](DSelectMultipleOnOptions.md#out)
- [over](DSelectMultipleOnOptions.md#over)
- [press](DSelectMultipleOnOptions.md#press)
- [removed](DSelectMultipleOnOptions.md#removed)
- [resize](DSelectMultipleOnOptions.md#resize)
- [scale](DSelectMultipleOnOptions.md#scale)
- [select](DSelectMultipleOnOptions.md#select)
- [shortcut](DSelectMultipleOnOptions.md#shortcut)
- [skew](DSelectMultipleOnOptions.md#skew)
- [statechange](DSelectMultipleOnOptions.md#statechange)
- [unpress](DSelectMultipleOnOptions.md#unpress)
- [up](DSelectMultipleOnOptions.md#up)
- [wheel](DSelectMultipleOnOptions.md#wheel)
...
[src/main/typescript/wcardinal/ui/d-select-multiple.ts:31](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-select-multiple.ts#L31)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:35](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L35)
...
[src/main/typescript/wcardinal/ui/d-button-base.ts:40](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-button-base.ts#L40)
...
[src/main/typescript/wcardinal/ui/d-dropdown-base.ts:30](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dropdown-base.ts#L30)
