[Winter Cardinal UI - v0.310.1](../index.md) / DDialogConfirmDiscardOptions
...
A renderability.
Unlike [visible](DDialogConfirmDiscardOptions.md#visible), non-renderable element occupies a space.
