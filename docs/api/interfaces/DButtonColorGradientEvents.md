[Winter Cardinal UI - v0.457.0](../index.md) / DButtonColorGradientEvents
...
- [active](DButtonColorGradientEvents.md#active)
- [added](DButtonColorGradientEvents.md#added)
- [change](DButtonColorGradientEvents.md#change)
- [click](DButtonColorGradientEvents.md#click)
- [dblclick](DButtonColorGradientEvents.md#dblclick)
- [down](DButtonColorGradientEvents.md#down)
- [inactive](DButtonColorGradientEvents.md#inactive)
- [init](DButtonColorGradientEvents.md#init)
- [keydown](DButtonColorGradientEvents.md#keydown)
- [keyup](DButtonColorGradientEvents.md#keyup)
- [move](DButtonColorGradientEvents.md#move)
- [out](DButtonColorGradientEvents.md#out)
- [over](DButtonColorGradientEvents.md#over)
- [press](DButtonColorGradientEvents.md#press)
- [removed](DButtonColorGradientEvents.md#removed)
- [resize](DButtonColorGradientEvents.md#resize)
- [scale](DButtonColorGradientEvents.md#scale)
- [shortcut](DButtonColorGradientEvents.md#shortcut)
- [skew](DButtonColorGradientEvents.md#skew)
- [statechange](DButtonColorGradientEvents.md#statechange)
- [unpress](DButtonColorGradientEvents.md#unpress)
- [up](DButtonColorGradientEvents.md#up)
- [wheel](DButtonColorGradientEvents.md#wheel)
...
[src/main/typescript/wcardinal/ui/d-button-color-gradient.ts:26](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-button-color-gradient.ts#L26)
