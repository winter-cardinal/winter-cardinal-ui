[Winter Cardinal UI - v0.310.1](../index.md) / DMenuItemExpandableBodyOptions
...
A renderability.
Unlike [visible](DMenuItemExpandableBodyOptions.md#visible), non-renderable element occupies a space.
