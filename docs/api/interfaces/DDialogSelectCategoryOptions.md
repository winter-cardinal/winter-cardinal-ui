[Winter Cardinal UI - v0.374.0](../index.md) / DDialogSelectCategoryOptions
...
• `Optional` **text**: [`DTextBaseTextOptions`](DTextBaseTextOptions.md)\<``null`` \| [`DMenuItem`](../classes/DMenuItem.md)\<``null`` \| `CATEGORY_ID`, [`DThemeMenuItem`](DThemeMenuItem.md), [`DMenuItemOptions`](DMenuItemOptions.md)\<``null`` \| `CATEGORY_ID`, [`DThemeMenuItem`](DThemeMenuItem.md)\>\>\>
