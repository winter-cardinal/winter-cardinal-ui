[Winter Cardinal UI - v0.310.1](../index.md) / DTableBodyCellCheckOptions
...
A renderability.
Unlike [visible](DTableBodyCellCheckOptions.md#visible), non-renderable element occupies a space.
