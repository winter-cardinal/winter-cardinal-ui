[Winter Cardinal UI - v0.414.0](../index.md) / DTableBodyCellCheckOptions
...
- [images](DTableBodyCellCheckOptions.md#images)
...
- [renderable](DTableBodyCellCheckOptions.md#renderable)
...
• `Optional` **text**: [`DTextPieceOptions`](DTextPieceOptions.md)\<`boolean`\>
