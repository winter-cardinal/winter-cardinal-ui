[Winter Cardinal UI - v0.310.1](../index.md) / DDialogDateOptions
...
[src/main/typescript/wcardinal/ui/d-dialog-date.ts:12](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-dialog-date.ts#L12)
...
A renderability.
Unlike [visible](DDialogDateOptions.md#visible), non-renderable element occupies a space.
