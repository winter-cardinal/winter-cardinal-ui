[Winter Cardinal UI - v0.457.0](../index.md) / DDialogDateOptions
...
- [alwaysOnTop](DDialogDateOptions.md#alwaysontop)
...
- [renderable](DDialogDateOptions.md#renderable)
...
[src/main/typescript/wcardinal/ui/d-dialog-date.ts:12](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.457.0/src/main/typescript/wcardinal/ui/d-dialog-date.ts#L12)
