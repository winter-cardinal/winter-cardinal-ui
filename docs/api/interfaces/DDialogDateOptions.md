[Winter Cardinal UI - v0.160.0](../index.md) / DDialogDateOptions
...
- [cancel](DDialogDateOptions.md#cancel)
...
[src/main/typescript/wcardinal/ui/d-dialog-date.ts:12](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.160.0/src/main/typescript/wcardinal/ui/d-dialog-date.ts#L12)
