[Winter Cardinal UI - v0.310.1](../index.md) / DDialogLayeredHeaderSeparatorOptions
...
A renderability.
Unlike [visible](DDialogLayeredHeaderSeparatorOptions.md#visible), non-renderable element occupies a space.
