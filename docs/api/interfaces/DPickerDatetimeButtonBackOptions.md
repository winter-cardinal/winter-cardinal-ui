[Winter Cardinal UI - v0.205.1](../index.md) / DPickerDatetimeButtonBackOptions

# Interface: DPickerDatetimeButtonBackOptions<VALUE, THEME\>
...
| :------ | :------ |
| `VALUE` | `unknown` |
| `THEME` | extends [`DThemePickerDatetimeButtonBack`](DThemePickerDatetimeButtonBack.md)<`VALUE`\> = [`DThemePickerDatetimeButtonBack`](DThemePickerDatetimeButtonBack.md)<`VALUE`\> |
...
- [background](DPickerDatetimeButtonBackOptions.md#background)
- [border](DPickerDatetimeButtonBackOptions.md#border)
- [children](DPickerDatetimeButtonBackOptions.md#children)
- [clear](DPickerDatetimeButtonBackOptions.md#clear)
- [corner](DPickerDatetimeButtonBackOptions.md#corner)
- [cursor](DPickerDatetimeButtonBackOptions.md#cursor)
- [group](DPickerDatetimeButtonBackOptions.md#group)
- [height](DPickerDatetimeButtonBackOptions.md#height)
- [image](DPickerDatetimeButtonBackOptions.md#image)
- [interactive](DPickerDatetimeButtonBackOptions.md#interactive)
- [mask](DPickerDatetimeButtonBackOptions.md#mask)
- [name](DPickerDatetimeButtonBackOptions.md#name)
- [on](DPickerDatetimeButtonBackOptions.md#on)
- [outline](DPickerDatetimeButtonBackOptions.md#outline)
- [padding](DPickerDatetimeButtonBackOptions.md#padding)
- [parent](DPickerDatetimeButtonBackOptions.md#parent)
- [shadow](DPickerDatetimeButtonBackOptions.md#shadow)
- [shortcut](DPickerDatetimeButtonBackOptions.md#shortcut)
- [shortcuts](DPickerDatetimeButtonBackOptions.md#shortcuts)
- [state](DPickerDatetimeButtonBackOptions.md#state)
- [text](DPickerDatetimeButtonBackOptions.md#text)
- [theme](DPickerDatetimeButtonBackOptions.md#theme)
- [title](DPickerDatetimeButtonBackOptions.md#title)
- [toggle](DPickerDatetimeButtonBackOptions.md#toggle)
- [visible](DPickerDatetimeButtonBackOptions.md#visible)
- [weight](DPickerDatetimeButtonBackOptions.md#weight)
- [when](DPickerDatetimeButtonBackOptions.md#when)
- [width](DPickerDatetimeButtonBackOptions.md#width)
- [x](DPickerDatetimeButtonBackOptions.md#x)
- [y](DPickerDatetimeButtonBackOptions.md#y)
