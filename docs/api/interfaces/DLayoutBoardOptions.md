[Winter Cardinal UI - v0.442.0](../index.md) / DLayoutBoardOptions

# Interface: DLayoutBoardOptions\<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeLayoutBoard`](DThemeLayoutBoard.md) = [`DThemeLayoutBoard`](DThemeLayoutBoard.md) |
...
- [background](DLayoutBoardOptions.md#background)
- [border](DLayoutBoardOptions.md#border)
- [children](DLayoutBoardOptions.md#children)
- [clear](DLayoutBoardOptions.md#clear)
- [corner](DLayoutBoardOptions.md#corner)
- [cursor](DLayoutBoardOptions.md#cursor)
- [height](DLayoutBoardOptions.md#height)
- [interactive](DLayoutBoardOptions.md#interactive)
- [name](DLayoutBoardOptions.md#name)
- [on](DLayoutBoardOptions.md#on)
- [outline](DLayoutBoardOptions.md#outline)
- [padding](DLayoutBoardOptions.md#padding)
- [parent](DLayoutBoardOptions.md#parent)
- [renderable](DLayoutBoardOptions.md#renderable)
- [shadow](DLayoutBoardOptions.md#shadow)
- [shortcut](DLayoutBoardOptions.md#shortcut)
- [shortcuts](DLayoutBoardOptions.md#shortcuts)
- [state](DLayoutBoardOptions.md#state)
- [theme](DLayoutBoardOptions.md#theme)
- [title](DLayoutBoardOptions.md#title)
- [visible](DLayoutBoardOptions.md#visible)
- [weight](DLayoutBoardOptions.md#weight)
- [width](DLayoutBoardOptions.md#width)
- [x](DLayoutBoardOptions.md#x)
- [y](DLayoutBoardOptions.md#y)
