[Winter Cardinal UI - v0.179.0](../index.md) / DThemeDialogInput
...
- [getAlign](DThemeDialogInput.md#getalign)
...
- [getGestureMode](DThemeDialogInput.md#getgesturemode)
...
- [getOutlineAlign](DThemeDialogInput.md#getoutlinealign)
...
- [isGestureEnabled](DThemeDialogInput.md#isgestureenabled)
- [isSticky](DThemeDialogInput.md#issticky)
- [newAnimation](DThemeDialogInput.md#newanimation)
