[Winter Cardinal UI](../README.md) / DTableDataTreeSelectionParent
...
[src/main/typescript/wcardinal/ui/d-table-data-tree-selection.ts:20](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.154.0/src/main/typescript/wcardinal/ui/d-table-data-tree-selection.ts#L20)
...
| :------ | :------ | :------ |
| `iteratee` | [`DTableDataEachIteratee`](../README.md#dtabledataeachiteratee)<`NODE`\> | an function called on each datum |
