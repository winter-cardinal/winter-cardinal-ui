[Winter Cardinal UI - v0.310.1](../index.md) / DButtonCheckOptions
...
- [renderable](DButtonCheckOptions.md#renderable)
...
A renderability.
Unlike [visible](DButtonCheckOptions.md#visible), non-renderable element occupies a space.
