[Winter Cardinal UI - v0.310.1](../index.md) / DPaginationButtonPreviousOptions
...
A renderability.
Unlike [visible](DPaginationButtonPreviousOptions.md#visible), non-renderable element occupies a space.
