[Winter Cardinal UI - v0.310.1](../index.md) / DInputSearchOptions
...
- [renderable](DInputSearchOptions.md#renderable)
...
A renderability.
Unlike [visible](DInputSearchOptions.md#visible), non-renderable element occupies a space.
