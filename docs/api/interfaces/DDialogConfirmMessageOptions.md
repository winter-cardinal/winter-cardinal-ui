[Winter Cardinal UI - v0.310.1](../index.md) / DDialogConfirmMessageOptions

# Interface: DDialogConfirmMessageOptions<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeDialogConfirmMessage`](DThemeDialogConfirmMessage.md) = [`DThemeDialogConfirmMessage`](DThemeDialogConfirmMessage.md) |
...
- [background](DDialogConfirmMessageOptions.md#background)
- [border](DDialogConfirmMessageOptions.md#border)
- [children](DDialogConfirmMessageOptions.md#children)
- [clear](DDialogConfirmMessageOptions.md#clear)
- [corner](DDialogConfirmMessageOptions.md#corner)
- [cursor](DDialogConfirmMessageOptions.md#cursor)
- [height](DDialogConfirmMessageOptions.md#height)
- [image](DDialogConfirmMessageOptions.md#image)
- [interactive](DDialogConfirmMessageOptions.md#interactive)
- [mask](DDialogConfirmMessageOptions.md#mask)
- [name](DDialogConfirmMessageOptions.md#name)
- [on](DDialogConfirmMessageOptions.md#on)
- [outline](DDialogConfirmMessageOptions.md#outline)
- [padding](DDialogConfirmMessageOptions.md#padding)
- [parent](DDialogConfirmMessageOptions.md#parent)
- [renderable](DDialogConfirmMessageOptions.md#renderable)
- [shadow](DDialogConfirmMessageOptions.md#shadow)
- [shortcut](DDialogConfirmMessageOptions.md#shortcut)
- [shortcuts](DDialogConfirmMessageOptions.md#shortcuts)
- [state](DDialogConfirmMessageOptions.md#state)
- [text](DDialogConfirmMessageOptions.md#text)
- [theme](DDialogConfirmMessageOptions.md#theme)
- [title](DDialogConfirmMessageOptions.md#title)
- [visible](DDialogConfirmMessageOptions.md#visible)
- [weight](DDialogConfirmMessageOptions.md#weight)
- [width](DDialogConfirmMessageOptions.md#width)
- [x](DDialogConfirmMessageOptions.md#x)
- [y](DDialogConfirmMessageOptions.md#y)
...
A renderability.
Unlike [visible](DDialogConfirmMessageOptions.md#visible), non-renderable element occupies a space.
