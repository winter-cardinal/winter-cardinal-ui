[Winter Cardinal UI - v0.310.1](../index.md) / DNoteSmallSearchingOptions
...
A renderability.
Unlike [visible](DNoteSmallSearchingOptions.md#visible), non-renderable element occupies a space.
