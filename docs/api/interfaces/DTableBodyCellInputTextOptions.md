[Winter Cardinal UI - v0.310.1](../index.md) / DTableBodyCellInputTextOptions
...
- [renderable](DTableBodyCellInputTextOptions.md#renderable)
...
A renderability.
Unlike [visible](DTableBodyCellInputTextOptions.md#visible), non-renderable element occupies a space.
