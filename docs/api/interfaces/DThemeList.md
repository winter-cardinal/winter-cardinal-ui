[Winter Cardinal UI - v0.194.0](../index.md) / DThemeList

# Interface: DThemeList
...
- [`DThemePane`](DThemePane.md)
  ...
  ↳↳ [`DThemeDialogSelecList`](DThemeDialogSelecList.md)
...
- [getAlpha](DThemeList.md#getalpha)
- [getBackgroundAlpha](DThemeList.md#getbackgroundalpha)
- [getBackgroundColor](DThemeList.md#getbackgroundcolor)
- [getBackgroundTexture](DThemeList.md#getbackgroundtexture)
- [getBorderAlign](DThemeList.md#getborderalign)
- [getBorderAlpha](DThemeList.md#getborderalpha)
- [getBorderColor](DThemeList.md#getbordercolor)
- [getBorderMask](DThemeList.md#getbordermask)
- [getBorderTexture](DThemeList.md#getbordertexture)
- [getBorderWidth](DThemeList.md#getborderwidth)
- [getClearType](DThemeList.md#getcleartype)
- [getColor](DThemeList.md#getcolor)
- [getCornerMask](DThemeList.md#getcornermask)
- [getCornerRadius](DThemeList.md#getcornerradius)
- [getCursor](DThemeList.md#getcursor)
- [getFontFamilly](DThemeList.md#getfontfamilly)
- [getFontSize](DThemeList.md#getfontsize)
- [getFontStyle](DThemeList.md#getfontstyle)
- [getFontVariant](DThemeList.md#getfontvariant)
- [getFontWeight](DThemeList.md#getfontweight)
- [getGestureMode](DThemeList.md#getgesturemode)
- [getHeight](DThemeList.md#getheight)
- [getInteractive](DThemeList.md#getinteractive)
- [getLineHeight](DThemeList.md#getlineheight)
- [getOutlineAlign](DThemeList.md#getoutlinealign)
- [getOutlineAlpha](DThemeList.md#getoutlinealpha)
- [getOutlineColor](DThemeList.md#getoutlinecolor)
- [getOutlineMask](DThemeList.md#getoutlinemask)
- [getOutlineOffset](DThemeList.md#getoutlineoffset)
- [getOutlineWidth](DThemeList.md#getoutlinewidth)
- [getPaddingBottom](DThemeList.md#getpaddingbottom)
- [getPaddingLeft](DThemeList.md#getpaddingleft)
- [getPaddingRight](DThemeList.md#getpaddingright)
- [getPaddingTop](DThemeList.md#getpaddingtop)
- [getShadow](DThemeList.md#getshadow)
- [getTitle](DThemeList.md#gettitle)
- [getWeight](DThemeList.md#getweight)
- [getWheelSpeed](DThemeList.md#getwheelspeed)
- [getWidth](DThemeList.md#getwidth)
- [getX](DThemeList.md#getx)
- [getY](DThemeList.md#gety)
- [isOverflowMaskEnabled](DThemeList.md#isoverflowmaskenabled)
- [newShadow](DThemeList.md#newshadow)
- [newShadowWeak](DThemeList.md#newshadowweak)
- [newState](DThemeList.md#newstate)
