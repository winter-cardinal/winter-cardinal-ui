[Winter Cardinal UI - v0.310.1](../index.md) / DPaginationButtonPageOptions
...
A renderability.
Unlike [visible](DPaginationButtonPageOptions.md#visible), non-renderable element occupies a space.
