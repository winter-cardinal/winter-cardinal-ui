[Winter Cardinal UI - v0.199.0](../index.md) / DDialogLayeredHeaderButtonCloseOptions

# Interface: DDialogLayeredHeaderButtonCloseOptions<THEME\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeDialogLayeredHeaderButtonClose`](DThemeDialogLayeredHeaderButtonClose.md) = [`DThemeDialogLayeredHeaderButtonClose`](DThemeDialogLayeredHeaderButtonClose.md) |

## Hierarchy

- [`DButtonAmbientOptions`](DButtonAmbientOptions.md)<`string`, `THEME`\>

  ↳ **`DDialogLayeredHeaderButtonCloseOptions`**

## Table of contents

### Properties

- [background](DDialogLayeredHeaderButtonCloseOptions.md#background)
- [border](DDialogLayeredHeaderButtonCloseOptions.md#border)
- [children](DDialogLayeredHeaderButtonCloseOptions.md#children)
- [clear](DDialogLayeredHeaderButtonCloseOptions.md#clear)
- [corner](DDialogLayeredHeaderButtonCloseOptions.md#corner)
- [cursor](DDialogLayeredHeaderButtonCloseOptions.md#cursor)
- [group](DDialogLayeredHeaderButtonCloseOptions.md#group)
- [height](DDialogLayeredHeaderButtonCloseOptions.md#height)
- [image](DDialogLayeredHeaderButtonCloseOptions.md#image)
- [interactive](DDialogLayeredHeaderButtonCloseOptions.md#interactive)
- [mask](DDialogLayeredHeaderButtonCloseOptions.md#mask)
- [name](DDialogLayeredHeaderButtonCloseOptions.md#name)
- [on](DDialogLayeredHeaderButtonCloseOptions.md#on)
- [outline](DDialogLayeredHeaderButtonCloseOptions.md#outline)
- [padding](DDialogLayeredHeaderButtonCloseOptions.md#padding)
- [parent](DDialogLayeredHeaderButtonCloseOptions.md#parent)
- [shadow](DDialogLayeredHeaderButtonCloseOptions.md#shadow)
- [shortcut](DDialogLayeredHeaderButtonCloseOptions.md#shortcut)
- [shortcuts](DDialogLayeredHeaderButtonCloseOptions.md#shortcuts)
- [state](DDialogLayeredHeaderButtonCloseOptions.md#state)
- [text](DDialogLayeredHeaderButtonCloseOptions.md#text)
- [theme](DDialogLayeredHeaderButtonCloseOptions.md#theme)
- [title](DDialogLayeredHeaderButtonCloseOptions.md#title)
- [toggle](DDialogLayeredHeaderButtonCloseOptions.md#toggle)
- [visible](DDialogLayeredHeaderButtonCloseOptions.md#visible)
- [weight](DDialogLayeredHeaderButtonCloseOptions.md#weight)
- [when](DDialogLayeredHeaderButtonCloseOptions.md#when)
- [width](DDialogLayeredHeaderButtonCloseOptions.md#width)
- [x](DDialogLayeredHeaderButtonCloseOptions.md#x)
- [y](DDialogLayeredHeaderButtonCloseOptions.md#y)
