[Winter Cardinal UI - v0.310.1](../index.md) / DDialogLayeredHeaderButtonCloseOptions
...
A renderability.
Unlike [visible](DDialogLayeredHeaderButtonCloseOptions.md#visible), non-renderable element occupies a space.
