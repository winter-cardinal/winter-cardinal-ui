[Winter Cardinal UI - v0.310.1](../index.md) / DScrollBarOptions

# Interface: DScrollBarOptions<THEME\>
...
| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemeScrollBar`](DThemeScrollBar.md) = [`DThemeScrollBar`](DThemeScrollBar.md) |
...
- [background](DScrollBarOptions.md#background)
- [border](DScrollBarOptions.md#border)
- [children](DScrollBarOptions.md#children)
- [clear](DScrollBarOptions.md#clear)
- [corner](DScrollBarOptions.md#corner)
- [cursor](DScrollBarOptions.md#cursor)
- [fadeOut](DScrollBarOptions.md#fadeout)
- [height](DScrollBarOptions.md#height)
- [interactive](DScrollBarOptions.md#interactive)
- [name](DScrollBarOptions.md#name)
- [on](DScrollBarOptions.md#on)
- [outline](DScrollBarOptions.md#outline)
- [padding](DScrollBarOptions.md#padding)
- [parent](DScrollBarOptions.md#parent)
- [renderable](DScrollBarOptions.md#renderable)
- [shadow](DScrollBarOptions.md#shadow)
- [shortcut](DScrollBarOptions.md#shortcut)
- [shortcuts](DScrollBarOptions.md#shortcuts)
- [state](DScrollBarOptions.md#state)
- [theme](DScrollBarOptions.md#theme)
- [thumb](DScrollBarOptions.md#thumb)
- [title](DScrollBarOptions.md#title)
- [visible](DScrollBarOptions.md#visible)
- [weight](DScrollBarOptions.md#weight)
- [width](DScrollBarOptions.md#width)
- [x](DScrollBarOptions.md#x)
- [y](DScrollBarOptions.md#y)
...
• `Optional` **fadeOut**: [`DScrollBarFadeOutOpiotns`](DScrollBarFadeOutOpiotns.md)

#### Defined in

[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:18](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L18)
...
A renderability.
Unlike [visible](DScrollBarOptions.md#visible), non-renderable element occupies a space.
...
• `Optional` **thumb**: [`DScrollBarThumbOptions`](DScrollBarThumbOptions.md)

#### Defined in

[src/main/typescript/wcardinal/ui/d-scroll-bar.ts:17](https://github.com/winter-cardinal/winter-cardinal-ui/blob/v0.310.1/src/main/typescript/wcardinal/ui/d-scroll-bar.ts#L17)
