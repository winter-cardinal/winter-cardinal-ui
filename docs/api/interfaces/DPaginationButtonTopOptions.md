[Winter Cardinal UI - v0.310.1](../index.md) / DPaginationButtonTopOptions
...
A renderability.
Unlike [visible](DPaginationButtonTopOptions.md#visible), non-renderable element occupies a space.
