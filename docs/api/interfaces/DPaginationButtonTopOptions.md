[Winter Cardinal UI - v0.205.1](../index.md) / DPaginationButtonTopOptions

# Interface: DPaginationButtonTopOptions<THEME\>

## Type parameters

| Name | Type |
| :------ | :------ |
| `THEME` | extends [`DThemePaginationButtonTop`](DThemePaginationButtonTop.md) = [`DThemePaginationButtonTop`](DThemePaginationButtonTop.md) |

## Hierarchy

- [`DButtonAmbientOptions`](DButtonAmbientOptions.md)<`string`, `THEME`\>

  ↳ **`DPaginationButtonTopOptions`**

## Table of contents

### Properties

- [background](DPaginationButtonTopOptions.md#background)
- [border](DPaginationButtonTopOptions.md#border)
- [children](DPaginationButtonTopOptions.md#children)
- [clear](DPaginationButtonTopOptions.md#clear)
- [corner](DPaginationButtonTopOptions.md#corner)
- [cursor](DPaginationButtonTopOptions.md#cursor)
- [group](DPaginationButtonTopOptions.md#group)
- [height](DPaginationButtonTopOptions.md#height)
- [image](DPaginationButtonTopOptions.md#image)
- [interactive](DPaginationButtonTopOptions.md#interactive)
- [mask](DPaginationButtonTopOptions.md#mask)
- [name](DPaginationButtonTopOptions.md#name)
- [on](DPaginationButtonTopOptions.md#on)
- [outline](DPaginationButtonTopOptions.md#outline)
- [padding](DPaginationButtonTopOptions.md#padding)
- [parent](DPaginationButtonTopOptions.md#parent)
- [shadow](DPaginationButtonTopOptions.md#shadow)
- [shortcut](DPaginationButtonTopOptions.md#shortcut)
- [shortcuts](DPaginationButtonTopOptions.md#shortcuts)
- [state](DPaginationButtonTopOptions.md#state)
- [text](DPaginationButtonTopOptions.md#text)
- [theme](DPaginationButtonTopOptions.md#theme)
- [title](DPaginationButtonTopOptions.md#title)
- [toggle](DPaginationButtonTopOptions.md#toggle)
- [visible](DPaginationButtonTopOptions.md#visible)
- [weight](DPaginationButtonTopOptions.md#weight)
- [when](DPaginationButtonTopOptions.md#when)
- [width](DPaginationButtonTopOptions.md#width)
- [x](DPaginationButtonTopOptions.md#x)
- [y](DPaginationButtonTopOptions.md#y)
