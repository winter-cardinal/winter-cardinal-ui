[Winter Cardinal UI - v0.310.1](../index.md) / DInputTextAndLabelOptions
...
A renderability.
Unlike [visible](DInputTextAndLabelOptions.md#visible), non-renderable element occupies a space.
