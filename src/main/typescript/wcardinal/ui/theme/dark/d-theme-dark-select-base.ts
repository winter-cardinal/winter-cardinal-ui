...
DThemeDarkAtlas.add( "select_mark", 20, 14,
	`<g>` +
		`<polyline fill="none" stroke="#fff" stroke-width="1" points="16 5 10 11 4 5"></polyline>` +
	`</g>`
);

export class DThemeDarkSelectBase extends DThemeDarkButtonBase implements DThemeSelectBase {
	...
	getSecondaryImageSource( state: DBaseState ): Texture | DisplayObject | null {
		return DThemeDarkAtlas.mappings.select_mark;
	}
