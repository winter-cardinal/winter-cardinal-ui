...
import { loadThemeWhiteSliderHorizontal } from "./load-theme-white-slider-horizontal";
...
import { loadThemeWhiteSliderRange } from "./load-theme-white-slider-range-horizontal";
import { loadThemeWhiteSliderRangeVertical } from "./load-theme-white-slider-range-vertical";
import { loadThemeWhiteSliderThumb } from "./load-theme-white-slider-thumb";
import { loadThemeWhiteSliderTrackHorizontal } from "./load-theme-white-slider-track-horizontal";
import { loadThemeWhiteSliderTrackSelectedHorizontal } from "./load-theme-white-slider-track-selected-horizontal";
import { loadThemeWhiteSliderTrackSelectedVertical } from "./load-theme-white-slider-track-selected-vertical";
import { loadThemeWhiteSliderTrackVertical } from "./load-theme-white-slider-track-vertical";
import { loadThemeWhiteSliderValue } from "./load-theme-white-slider-value";
import { loadThemeWhiteSliderVertical } from "./load-theme-white-slider-vertical";
...
export const loadThemeWhiteAll = () => {
	...
	loadThemeWhiteTable();
	loadThemeWhiteText();
	loadThemeWhiteSliderHorizontal();
	loadThemeWhiteSliderRange();
	loadThemeWhiteSliderTrackHorizontal();
	loadThemeWhiteSliderTrackSelectedHorizontal();
	loadThemeWhiteSliderThumb();
	loadThemeWhiteSliderMax();
	loadThemeWhiteSliderMin();
	loadThemeWhiteSliderValue();
	loadThemeWhiteSliderVertical();
	loadThemeWhiteSliderRangeVertical();
	loadThemeWhiteSliderTrackVertical();
	loadThemeWhiteSliderTrackSelectedVertical();
};
