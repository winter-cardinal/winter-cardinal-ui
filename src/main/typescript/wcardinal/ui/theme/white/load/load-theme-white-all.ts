...
import { loadThemeWhiteSliderBarChosenVertical } from "./load-theme-white-slider-bar-chosen-vertical";
import { loadThemeWhiteSliderBarVertical } from "./load-theme-white-slider-bar-vertical";
...
export const loadThemeWhiteAll = () => {
	...
	loadThemeWhiteSliderBarVertical();
	loadThemeWhiteSliderBarChosenVertical();
};
