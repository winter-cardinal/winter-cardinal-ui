...
export const toBaseFill = ( shape: EShape, runtime: EShapeRuntime ): EShapeFillLike => {
	return ( runtime.written & EShapeRuntimeReset.COLOR_FILL ? shape : runtime ).fill;
};

export const toBaseStroke = ( shape: EShape, runtime: EShapeRuntime ): EShapeStrokeLike => {
	return ( runtime.written & EShapeRuntimeReset.COLOR_STROKE ? shape : runtime ).stroke;
};

export const toBaseText = ( shape: EShape, runtime: EShapeRuntime ): EShapeTextLike => {
	return ( runtime.written & EShapeRuntimeReset.COLOR_TEXT ? shape : runtime ).text;
};

export const toBaseTextOutline = ( shape: EShape, runtime: EShapeRuntime ): EShapeTextOutlineLike => {
