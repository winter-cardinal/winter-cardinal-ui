...
import { DTableDataSelection, DTableDataSelectionOptions, DTableDataSelectionParent } from "./d-table-data-selection";
...
export type DTableDataTreeSelectionCreator<NODE> = ( parent: DTableDataTreeSelectionParent<NODE> ) => DTableDataTreeSelection<NODE>;
